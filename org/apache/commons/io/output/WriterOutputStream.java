...
/* 315 */       return;  String TEST_STRING_2 = "vés";
/* 316 */     byte[] bytes = "vés".getBytes(charset);
/*     */     
/* 318 */     CharsetDecoder charsetDecoder2 = charset.newDecoder();
/* 319 */     ByteBuffer bb2 = ByteBuffer.allocate(16);
/* 320 */     CharBuffer cb2 = CharBuffer.allocate("vés".length());
...
/*     */     } 
/* 333 */     cb2.rewind();
/* 334 */     if (!"vés".equals(cb2.toString()))
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\org\apache\commons\io\output\WriterOutputStream.class
