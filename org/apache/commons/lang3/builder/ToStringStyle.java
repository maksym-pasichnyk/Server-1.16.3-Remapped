...
/*      */     
/*      */     JsonToStringStyle() {
/* 2384 */       setUseClassName(false);
/* 2385 */       setUseIdentityHashCode(false);
/*      */       
/* 2387 */       setContentStart("{");
/* 2388 */       setContentEnd("}");
/*      */       
/* 2390 */       setArrayStart("[");
/* 2391 */       setArrayEnd("]");
/*      */       
/* 2393 */       setFieldSeparator(",");
/* 2394 */       setFieldNameValueSeparator(":");
/*      */       
/* 2396 */       setNullText("null");
/*      */       
/* 2398 */       setSummaryObjectStartText("\"<");
/* 2399 */       setSummaryObjectEndText(">\"");
/*      */       
/* 2401 */       setSizeStartText("\"<size=");
/* 2402 */       setSizeEndText(">\"");
/*      */     }
/*      */ 
/*      */ 
...
/* 2410 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2413 */       if (!isFullDetail(fullDetail)) {
/* 2414 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/* 2426 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2429 */       if (!isFullDetail(fullDetail)) {
/* 2430 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/* 2442 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2445 */       if (!isFullDetail(fullDetail)) {
/* 2446 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/* 2458 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2461 */       if (!isFullDetail(fullDetail)) {
/* 2462 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/* 2474 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2477 */       if (!isFullDetail(fullDetail)) {
/* 2478 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/* 2490 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2493 */       if (!isFullDetail(fullDetail)) {
/* 2494 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/* 2506 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2509 */       if (!isFullDetail(fullDetail)) {
/* 2510 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/* 2522 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2525 */       if (!isFullDetail(fullDetail)) {
/* 2526 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/* 2538 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2541 */       if (!isFullDetail(fullDetail)) {
/* 2542 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/* 2554 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */       
/* 2557 */       if (!isFullDetail(fullDetail)) {
/* 2558 */         throw new UnsupportedOperationException("FullDetail must be true when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
...
/*      */         return;
/*      */       } 
/* 2588 */       String valueAsString = value.toString();
...
/* 2598 */       return (valueAsString.startsWith(getArrayStart()) && valueAsString
/* 2599 */         .startsWith(getArrayEnd()));
/*      */     }
/*      */     
/*      */     private boolean isJsonObject(String valueAsString) {
/* 2603 */       return (valueAsString.startsWith(getContentStart()) && valueAsString
/* 2604 */         .endsWith(getContentEnd()));
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 2621 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
/* 2625 */       super.appendFieldStart(buffer, this.FIELD_NAME_PREFIX + fieldName + this.FIELD_NAME_PREFIX);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\org\apache\commons\lang3\builder\ToStringStyle.class
