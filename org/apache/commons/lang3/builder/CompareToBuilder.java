...
/*  476 */       return this;
/*      */     }
/*  478 */     this.comparison = (lhs < rhs) ? -1 : ((lhs > rhs) ? 1 : 0);
/*  479 */     return this;
/*      */   }
/*      */ 
/*      */ 
...
/*  492 */       return this;
/*      */     }
/*  494 */     this.comparison = (lhs < rhs) ? -1 : ((lhs > rhs) ? 1 : 0);
/*  495 */     return this;
/*      */   }
/*      */ 
/*      */ 
...
/*  508 */       return this;
/*      */     }
/*  510 */     this.comparison = (lhs < rhs) ? -1 : ((lhs > rhs) ? 1 : 0);
/*  511 */     return this;
/*      */   }
/*      */ 
/*      */ 
...
/*  524 */       return this;
/*      */     }
/*  526 */     this.comparison = (lhs < rhs) ? -1 : ((lhs > rhs) ? 1 : 0);
/*  527 */     return this;
/*      */   }
/*      */ 
/*      */ 
...
/*  540 */       return this;
/*      */     }
/*  542 */     this.comparison = (lhs < rhs) ? -1 : ((lhs > rhs) ? 1 : 0);
/*  543 */     return this;
/*      */   }
/*      */ 
/*      */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\org\apache\commons\lang3\builder\CompareToBuilder.class
