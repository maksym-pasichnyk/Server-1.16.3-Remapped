...
/* 1055 */       throw new IllegalArgumentException(String.format(message, new Object[0]));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1099 */       throw new IllegalArgumentException(String.format(message, new Object[0]));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1193 */       throw new IllegalArgumentException(String.format(message, new Object[0]));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1237 */       throw new IllegalArgumentException(String.format(message, new Object[0]));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1263 */       throw new IllegalArgumentException(String.format("Expected type: %s, actual: %s", new Object[] { type.getName(), (obj == null) ? "null" : obj
/* 1264 */               .getClass().getName() }));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\org\apache\commons\lang3\Validate.class
