...
/*   81 */   private static final int[][] fields = new int[][] { { 14 }, { 13 }, { 12 }, { 11, 10 }, { 5, 5, 9 }, { 2, 1001 }, { 1 }, { 0 } };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  165 */     if (date1 == null || date2 == null) {
/*  166 */       throw new IllegalArgumentException("The date must not be null");
/*      */     }
/*  168 */     Calendar cal1 = Calendar.getInstance();
/*  169 */     cal1.setTime(date1);
/*  170 */     Calendar cal2 = Calendar.getInstance();
/*  171 */     cal2.setTime(date2);
/*  172 */     return isSameDay(cal1, cal2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  189 */     if (cal1 == null || cal2 == null) {
/*  190 */       throw new IllegalArgumentException("The date must not be null");
/*      */     }
/*  192 */     return (cal1.get(0) == cal2.get(0) && cal1
/*  193 */       .get(1) == cal2.get(1) && cal1
/*  194 */       .get(6) == cal2.get(6));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  211 */       throw new IllegalArgumentException("The date must not be null");
/*      */     }
/*  213 */     return (date1.getTime() == date2.getTime());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  228 */     if (cal1 == null || cal2 == null) {
/*  229 */       throw new IllegalArgumentException("The date must not be null");
/*      */     }
/*  231 */     return (cal1.getTime().getTime() == cal2.getTime().getTime());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  248 */     if (cal1 == null || cal2 == null) {
/*  249 */       throw new IllegalArgumentException("The date must not be null");
/*      */     }
/*  251 */     return (cal1.get(14) == cal2.get(14) && cal1
/*  252 */       .get(13) == cal2.get(13) && cal1
/*  253 */       .get(12) == cal2.get(12) && cal1
/*  254 */       .get(11) == cal2.get(11) && cal1
/*  255 */       .get(6) == cal2.get(6) && cal1
/*  256 */       .get(1) == cal2.get(1) && cal1
/*  257 */       .get(0) == cal2.get(0) && cal1
/*  258 */       .getClass() == cal2.getClass());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  277 */     return parseDate(str, null, parsePatterns);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  300 */     return parseDateWithLeniency(str, locale, parsePatterns, true);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  320 */     return parseDateStrictly(str, null, parsePatterns);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  342 */     return parseDateWithLeniency(str, locale, parsePatterns, false);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  364 */     if (str == null || parsePatterns == null) {
/*  365 */       throw new IllegalArgumentException("Date and Patterns must not be null");
/*      */     }
/*      */     
/*  368 */     TimeZone tz = TimeZone.getDefault();
/*  369 */     Locale lcl = (locale == null) ? Locale.getDefault() : locale;
/*  370 */     ParsePosition pos = new ParsePosition(0);
/*  371 */     Calendar calendar = Calendar.getInstance(tz, lcl);
/*  372 */     calendar.setLenient(lenient);
/*      */     
/*  374 */     for (String parsePattern : parsePatterns) {
/*  375 */       FastDateParser fdp = new FastDateParser(parsePattern, tz, lcl);
/*  376 */       calendar.clear();
/*      */       try {
/*  378 */         if (fdp.parse(str, pos, calendar) && pos.getIndex() == str.length()) {
/*  379 */           return calendar.getTime();
/*      */         }
/*      */       }
/*  382 */       catch (IllegalArgumentException illegalArgumentException) {}
/*      */ 
/*      */       
/*  385 */       pos.setIndex(0);
/*      */     } 
/*  387 */     throw new ParseException("Unable to parse the date: " + str, -1);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  518 */     c.setTime(date);
/*  519 */     c.add(calendarField, amount);
/*  520 */     return c.getTime();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  643 */     if (date == null) {
/*  644 */       throw new IllegalArgumentException("The date must not be null");
/*      */     }
/*      */     
/*  647 */     Calendar c = Calendar.getInstance();
/*  648 */     c.setLenient(false);
/*  649 */     c.setTime(date);
/*  650 */     c.set(calendarField, amount);
/*  651 */     return c.getTime();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  678 */     Calendar c = Calendar.getInstance(tz);
/*  679 */     c.setTime(date);
/*  680 */     return c;
/*      */   }
/*      */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\org\apache\commons\lang3\time\DateUtils.class
