...
/*   87 */       return new TypeUtils.WildcardTypeImpl(this.upperBounds, this.lowerBounds);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     public int hashCode() {
/*  135 */       int result = 1072;
/*  136 */       result |= this.componentType.hashCode();
/*  137 */       return result;
/*      */     }
/*      */   }
/*      */ 
...
/*  159 */       this.typeArguments = (Type[])typeArguments.clone();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  183 */       return (Type[])this.typeArguments.clone();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     } else {
/*      */       
/*  867 */       typeVarAssigns = (subtypeVarAssigns == null) ? new HashMap<TypeVariable<?>, Type>() : new HashMap<TypeVariable<?>, Type>(subtypeVarAssigns);
/*      */     } 
/*      */ 
/*      */ 
/*      */     
...
/*  879 */       typeVarAssigns.put(arrayOfTypeVariable[i], typeVarAssigns.containsKey(typeArg) ? typeVarAssigns
...
/*      */ 
/*      */     
/*  921 */     HashMap<TypeVariable<?>, Type> typeVarAssigns = (subtypeVarAssigns == null) ? new HashMap<TypeVariable<?>, Type>() : new HashMap<TypeVariable<?>, Type>(subtypeVarAssigns);
/*      */ 
/*      */ 
/*      */     
...
/*      */     }
/*      */     
/* 1135 */     Set<Type> types = new HashSet<Type>(bounds.length);
/*      */     
...
/* 1599 */       ParameterizedType other = (ParameterizedType)t;
...
/* 1628 */       WildcardType other = (WildcardType)t;
...
/* 1689 */     Validate.notNull(var, "var is null", new Object[0]);
/* 1690 */     StringBuilder buf = new StringBuilder();
/* 1691 */     GenericDeclaration d = (GenericDeclaration)var.getGenericDeclaration();
...
/*      */       } 
/* 1702 */     } else if (d instanceof Type) {
...
/* 1746 */     StringBuilder buf = new StringBuilder();
/*      */     
...
/* 1754 */       buf.append('<');
/* 1755 */       appendAllTo(buf, ", ", (Type[])c.getTypeParameters());
/* 1756 */       buf.append('>');
/*      */     } 
...
/* 1768 */     StringBuilder buf = new StringBuilder(v.getName());
/* 1769 */     Type[] bounds = v.getBounds();
...
/* 1784 */     StringBuilder buf = new StringBuilder();
/*      */     
/* 1786 */     Type useOwner = p.getOwnerType();
/* 1787 */     Class<?> raw = (Class)p.getRawType();
/* 1788 */     Type[] typeArguments = p.getActualTypeArguments();
...
/* 1811 */     StringBuilder buf = (new StringBuilder()).append('?');
/* 1812 */     Type[] lowerBounds = w.getLowerBounds();
/* 1813 */     Type[] upperBounds = w.getUpperBounds();
...
/* 1829 */     return String.format("%s[]", new Object[] { toString(g.getGenericComponentType()) });
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1841 */     Validate.notEmpty(Validate.noNullElements((Object[])types));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\org\apache\commons\lang3\reflect\TypeUtils.class
