...
/*  75 */     this.loggerContext = Objects.<LoggerContext>requireNonNull(loggerContext, "loggerContext");
/*     */     try {
...
/*     */     } 
/* 135 */     Configuration config = ConfigurationFactory.getInstance().getConfiguration(this.loggerContext, configSource);
...
/* 200 */       Configuration updated = ConfigurationFactory.getInstance().getConfiguration(this.loggerContext, source);
...
/* 238 */     return this.objectName;
/*     */   }
/*     */   
/*     */   private long nextSeqNo() {
/* 242 */     return this.sequenceNo.getAndIncrement();
/*     */   }
/*     */   
/*     */   private long now() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\org\apache\logging\log4j\core\jmx\LoggerContextAdmin.class
