...
/*  75 */         LOGGER.error("Attempted to assign attribute {} to list of type {} which is incompatible with {}.", name, values.get(0).getClass(), this.conversionType);
/*     */         
/*  77 */         return null;
/*     */       } 
...
/*  89 */       log.append(name).append("=null");
/*  90 */       return null;
/*     */     } 
...
/* 100 */       if (childType == null);
/*     */ 
/*     */       
/* 103 */       if (name.equalsIgnoreCase(childType.getElementName()) || this.conversionType.isAssignableFrom(childType.getPluginClass()))
/*     */       {
/*     */ 
/*     */         
/* 107 */         return child;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\org\apache\logging\log4j\core\config\plugins\visitors\PluginElementVisitor.class
