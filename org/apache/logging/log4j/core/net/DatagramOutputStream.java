...
/*     */     try {
/*  64 */       this.inetAddress = InetAddress.getByName(host);
...
/*     */     
/*     */     try {
/*  72 */       this.datagramSocket = new DatagramSocket();
...
/*     */     try {
/*  98 */       if (this.data != null && this.datagramSocket != null && this.inetAddress != null) {
/*  99 */         if (this.footer != null) {
/* 100 */           copy(this.footer, 0, this.footer.length);
/*     */         }
/* 102 */         DatagramPacket packet = new DatagramPacket(this.data, this.data.length, this.inetAddress, this.port);
/* 103 */         this.datagramSocket.send(packet);
/*     */       } 
/*     */     } finally {
/* 106 */       this.data = null;
...
/* 115 */     if (this.datagramSocket != null) {
/* 116 */       if (this.data != null) {
/* 117 */         flush();
/*     */       }
/* 119 */       this.datagramSocket.close();
/* 120 */       this.datagramSocket = null;
/*     */     } 
/*     */   }
/*     */   
