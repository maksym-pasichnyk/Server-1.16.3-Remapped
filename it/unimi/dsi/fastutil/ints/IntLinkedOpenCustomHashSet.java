...
/*      */   
/*      */   public boolean trim() {
/* 1072 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1105 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1106 */       return true; 
/*      */     try {
/* 1108 */       rehash(l);
...
/* 1128 */     int[] key = this.key;
/* 1129 */     int mask = newN - 1;
/* 1130 */     int[] newKey = new int[newN + 1];
...
/* 1136 */       int pos; if (this.strategy.equals(key[i], 0)) {
/* 1137 */         pos = newN;
/*      */       } else {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\IntLinkedOpenCustomHashSet.class
