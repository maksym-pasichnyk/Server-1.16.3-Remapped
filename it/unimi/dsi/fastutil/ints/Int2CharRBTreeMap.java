...
/*  910 */         return false; 
/*  911 */       Map.Entry<Integer, Character> e = (Map.Entry<Integer, Character>)o;
/*  912 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  998 */     int index = 0;
/*      */     TreeIterator() {
/* 1000 */       this.next = Int2CharRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(int k) {
/* 1003 */       if ((this.next = Int2CharRBTreeMap.this.locateKey(k)) != null)
/* 1004 */         if (Int2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1055 */       updatePrevious();
/* 1056 */       updateNext();
/* 1057 */       Int2CharRBTreeMap.this.remove(this.curr.key);
/* 1058 */       this.curr = null;
/*      */     }
...
/* 1097 */       this.entries = (ObjectSortedSet<Int2CharMap.Entry>)new AbstractObjectSortedSet<Int2CharMap.Entry>()
/*      */         {
...
/* 1106 */             return (ObjectBidirectionalIterator<Int2CharMap.Entry>)new Int2CharRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator(Int2CharMap.Entry from) {
/* 1110 */             return (ObjectBidirectionalIterator<Int2CharMap.Entry>)new Int2CharRBTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1121 */               return false; 
/* 1122 */             Int2CharRBTreeMap.Entry f = Int2CharRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1134 */               return false; 
/* 1135 */             Int2CharRBTreeMap.Entry f = Int2CharRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1136 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1137 */               return false; 
/* 1138 */             Int2CharRBTreeMap.this.remove(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Int2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Int2CharRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Int2CharMap.Entry first() {
/* 1151 */             return Int2CharRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Int2CharMap.Entry last() {
/* 1155 */             return Int2CharRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2CharMap.Entry> subSet(Int2CharMap.Entry from, Int2CharMap.Entry to) {
/* 1159 */             return Int2CharRBTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry to) {
/* 1163 */             return Int2CharRBTreeMap.this.headMap(to.getIntKey()).int2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry from) {
/* 1167 */             return Int2CharRBTreeMap.this.tailMap(from.getIntKey()).int2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1201 */       return new Int2CharRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1205 */       return new Int2CharRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1260 */             return (CharIterator)new Int2CharRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1264 */             return Int2CharRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Int2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1272 */             Int2CharRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1335 */       if (!bottom && !top && Int2CharRBTreeMap.this.compare(from, to) > 0)
/* 1336 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1337 */       this.from = from;
/* 1338 */       this.bottom = bottom;
/* 1339 */       this.to = to;
/* 1340 */       this.top = top;
/* 1341 */       this.defRetValue = Int2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1359 */       return ((this.bottom || Int2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2CharRBTreeMap.this
/* 1360 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
/* 1364 */       if (this.entries == null)
/* 1365 */         this.entries = (ObjectSortedSet<Int2CharMap.Entry>)new AbstractObjectSortedSet<Int2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator() {
/* 1368 */               return (ObjectBidirectionalIterator<Int2CharMap.Entry>)new Int2CharRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator(Int2CharMap.Entry from) {
/* 1372 */               return (ObjectBidirectionalIterator<Int2CharMap.Entry>)new Int2CharRBTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Int2CharMap.Entry> comparator() {
/* 1376 */               return Int2CharRBTreeMap.this.int2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Int2CharRBTreeMap.Entry f = Int2CharRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1389 */               return (f != null && Int2CharRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1400 */                 return false; 
/* 1401 */               Int2CharRBTreeMap.Entry f = Int2CharRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1402 */               if (f != null && Int2CharRBTreeMap.Submap.this.in(f.key))
/* 1403 */                 Int2CharRBTreeMap.Submap.this.remove(f.key); 
/* 1404 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1408 */               int c = 0;
/* 1409 */               for (ObjectBidirectionalIterator<Int2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1410 */                 c++; 
/* 1411 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1415 */               return !(new Int2CharRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1419 */               Int2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Int2CharMap.Entry first() {
/* 1423 */               return Int2CharRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Int2CharMap.Entry last() {
/* 1427 */               return Int2CharRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2CharMap.Entry> subSet(Int2CharMap.Entry from, Int2CharMap.Entry to) {
/* 1431 */               return Int2CharRBTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry to) {
/* 1435 */               return Int2CharRBTreeMap.Submap.this.headMap(to.getIntKey()).int2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry from) {
/* 1439 */               return Int2CharRBTreeMap.Submap.this.tailMap(from.getIntKey()).int2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractInt2CharSortedMap.KeySet {
/*      */       public IntBidirectionalIterator iterator() {
/* 1447 */         return new Int2CharRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1451 */         return new Int2CharRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public IntSortedSet keySet() {
...
/*      */           {
/*      */             public CharIterator iterator() {
/* 1466 */               return (CharIterator)new Int2CharRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1470 */               return Int2CharRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1474 */               return Int2CharRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1478 */               Int2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1486 */       return (in(k) && Int2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(int k) {
/* 1503 */       int kk = k; Int2CharRBTreeMap.Entry e;
/* 1504 */       return (in(kk) && (e = Int2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(int k, char v) {
/* 1508 */       Int2CharRBTreeMap.this.modified = false;
/* 1509 */       if (!in(k))
...
/* 1512 */       char oldValue = Int2CharRBTreeMap.this.put(k, v);
/* 1513 */       return Int2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(int k) {
/* 1518 */       Int2CharRBTreeMap.this.modified = false;
/* 1519 */       if (!in(k))
/* 1520 */         return this.defRetValue; 
/* 1521 */       char oldValue = Int2CharRBTreeMap.this.remove(k);
/* 1522 */       return Int2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1540 */       return Int2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Int2CharSortedMap headMap(int to) {
/* 1544 */       if (this.top)
/* 1545 */         return new Submap(this.from, this.bottom, to, false); 
/* 1546 */       return (Int2CharRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Int2CharSortedMap tailMap(int from) {
/* 1550 */       if (this.bottom)
/* 1551 */         return new Submap(from, false, this.to, this.top); 
/* 1552 */       return (Int2CharRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Int2CharSortedMap subMap(int from, int to) {
...
/* 1558 */       if (!this.top)
/* 1559 */         to = (Int2CharRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1560 */       if (!this.bottom)
/* 1561 */         from = (Int2CharRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1573 */       if (Int2CharRBTreeMap.this.tree == null) {
/* 1574 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1578 */       if (this.bottom) {
/* 1579 */         e = Int2CharRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1581 */         e = Int2CharRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1583 */         if (Int2CharRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1584 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1588 */       if (e == null || (!this.top && Int2CharRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1589 */         return null; 
/* 1590 */       return e;
/*      */     }
/*      */ 
...
/*      */       Int2CharRBTreeMap.Entry e;
/* 1599 */       if (Int2CharRBTreeMap.this.tree == null) {
/* 1600 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1604 */       if (this.top) {
/* 1605 */         e = Int2CharRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1607 */         e = Int2CharRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1609 */         if (Int2CharRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1610 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Int2CharRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1615 */         return null; 
/* 1616 */       return e;
/*      */     }
/*      */     
/*      */     public int firstIntKey() {
/* 1620 */       Int2CharRBTreeMap.Entry e = firstEntry();
/* 1621 */       if (e == null)
...
/*      */     
/*      */     public int lastIntKey() {
/* 1627 */       Int2CharRBTreeMap.Entry e = lastEntry();
/* 1628 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Int2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1646 */         this();
/* 1647 */         if (this.next != null)
/* 1648 */           if (!Int2CharRBTreeMap.Submap.this.bottom && Int2CharRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1649 */             this.prev = null;
/* 1650 */           } else if (!Int2CharRBTreeMap.Submap.this.top && Int2CharRBTreeMap.this.compare(k, (this.prev = Int2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1651 */             this.next = null;
/*      */           } else {
/* 1653 */             this.next = Int2CharRBTreeMap.this.locateKey(k);
/* 1654 */             if (Int2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1665 */         if (!Int2CharRBTreeMap.Submap.this.bottom && this.prev != null && Int2CharRBTreeMap.this.compare(this.prev.key, Int2CharRBTreeMap.Submap.this.from) < 0)
/* 1666 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1670 */         this.next = this.next.next();
/* 1671 */         if (!Int2CharRBTreeMap.Submap.this.top && this.next != null && Int2CharRBTreeMap.this.compare(this.next.key, Int2CharRBTreeMap.Submap.this.to) >= 0)
/* 1672 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     Int2CharRBTreeMap c;
/*      */     try {
/* 1752 */       c = (Int2CharRBTreeMap)super.clone();
...
/* 1833 */     if (n == 1) {
/* 1834 */       Entry entry = new Entry(s.readInt(), s.readChar());
...
/*      */ 
/*      */       
/* 1845 */       Entry entry = new Entry(s.readInt(), s.readChar());
/* 1846 */       entry.black(true);
/* 1847 */       entry.right(new Entry(s.readInt(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2CharRBTreeMap.class
