...
/*  954 */         return false; 
/*  955 */       Map.Entry<Integer, Double> e = (Map.Entry<Integer, Double>)o;
/*  956 */       return (this.key == ((Integer)e.getKey()).intValue() && 
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Int2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(int k) {
/* 1048 */       if ((this.next = Int2DoubleAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Int2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Int2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Int2DoubleMap.Entry>)new AbstractObjectSortedSet<Int2DoubleMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Int2DoubleMap.Entry>)new Int2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Int2DoubleMap.Entry>)new Int2DoubleAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1171 */             if (e.getKey() == null || !(e.getKey() instanceof Integer))
/* 1172 */               return false; 
/* 1173 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1174 */               return false; 
/* 1175 */             Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1184 */             if (e.getKey() == null || !(e.getKey() instanceof Integer))
/* 1185 */               return false; 
/* 1186 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1187 */               return false; 
/* 1188 */             Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1189 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != 
/* 1190 */               Double.doubleToLongBits(((Double)e.getValue()).doubleValue()))
/* 1191 */               return false; 
/* 1192 */             Int2DoubleAVLTreeMap.this.remove(f.key);
/* 1193 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1197 */             return Int2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1201 */             Int2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Int2DoubleMap.Entry first() {
/* 1205 */             return Int2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Int2DoubleMap.Entry last() {
/* 1209 */             return Int2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) {
/* 1213 */             return Int2DoubleAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry to) {
/* 1217 */             return Int2DoubleAVLTreeMap.this.headMap(to.getIntKey()).int2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from) {
/* 1221 */             return Int2DoubleAVLTreeMap.this.tailMap(from.getIntKey()).int2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1255 */       return new Int2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1259 */       return new Int2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1311 */       this.values = (DoubleCollection)new AbstractDoubleCollection()
/*      */         {
/*      */           public DoubleIterator iterator() {
/* 1314 */             return (DoubleIterator)new Int2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(double k) {
/* 1318 */             return Int2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1322 */             return Int2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1326 */             Int2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1337 */     return new Submap(0, true, to, false);
/*      */   }
/*      */   
/*      */   public Int2DoubleSortedMap tailMap(int from) {
/* 1341 */     return new Submap(from, false, 0, true);
/*      */   }
/*      */   
...
/* 1389 */       if (!bottom && !top && Int2DoubleAVLTreeMap.this.compare(from, to) > 0)
/* 1390 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1391 */       this.from = from;
/* 1392 */       this.bottom = bottom;
/* 1393 */       this.to = to;
/* 1394 */       this.top = top;
/* 1395 */       this.defRetValue = Int2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1413 */       return ((this.bottom || Int2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2DoubleAVLTreeMap.this
/* 1414 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
/* 1418 */       if (this.entries == null)
/* 1419 */         this.entries = (ObjectSortedSet<Int2DoubleMap.Entry>)new AbstractObjectSortedSet<Int2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator() {
/* 1422 */               return (ObjectBidirectionalIterator<Int2DoubleMap.Entry>)new Int2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from) {
/* 1426 */               return (ObjectBidirectionalIterator<Int2DoubleMap.Entry>)new Int2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Int2DoubleMap.Entry> comparator() {
/* 1430 */               return Int2DoubleAVLTreeMap.this.int2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1438 */               if (e.getKey() == null || !(e.getKey() instanceof Integer))
/* 1439 */                 return false; 
/* 1440 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1441 */                 return false; 
/* 1442 */               Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1443 */               return (f != null && Int2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1451 */               if (e.getKey() == null || !(e.getKey() instanceof Integer))
/* 1452 */                 return false; 
/* 1453 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1454 */                 return false; 
/* 1455 */               Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1456 */               if (f != null && Int2DoubleAVLTreeMap.Submap.this.in(f.key))
/* 1457 */                 Int2DoubleAVLTreeMap.Submap.this.remove(f.key); 
/* 1458 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1462 */               int c = 0;
/* 1463 */               for (ObjectBidirectionalIterator<Int2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1464 */                 c++; 
/* 1465 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1469 */               return !(new Int2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1473 */               Int2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Int2DoubleMap.Entry first() {
/* 1477 */               return Int2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Int2DoubleMap.Entry last() {
/* 1481 */               return Int2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) {
/* 1486 */               return Int2DoubleAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry to) {
/* 1490 */               return Int2DoubleAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from) {
/* 1494 */               return Int2DoubleAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractInt2DoubleSortedMap.KeySet {
/*      */       public IntBidirectionalIterator iterator() {
/* 1502 */         return new Int2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1506 */         return new Int2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public IntSortedSet keySet() {
...
/* 1518 */         this.values = (DoubleCollection)new AbstractDoubleCollection()
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1521 */               return (DoubleIterator)new Int2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(double k) {
/* 1525 */               return Int2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1529 */               return Int2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1533 */               Int2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1541 */       return (in(k) && Int2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(double v) {
...
/* 1548 */         double ev = (i.nextEntry()).value;
/* 1549 */         if (Double.doubleToLongBits(ev) == Double.doubleToLongBits(v))
/* 1550 */           return true; 
/*      */       } 
/* 1552 */       return false;
/*      */     }
...
/*      */     
/*      */     public double get(int k) {
/* 1558 */       int kk = k; Int2DoubleAVLTreeMap.Entry e;
/* 1559 */       return (in(kk) && (e = Int2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public double put(int k, double v) {
/* 1563 */       Int2DoubleAVLTreeMap.this.modified = false;
/* 1564 */       if (!in(k))
...
/* 1567 */       double oldValue = Int2DoubleAVLTreeMap.this.put(k, v);
/* 1568 */       return Int2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double remove(int k) {
/* 1573 */       Int2DoubleAVLTreeMap.this.modified = false;
/* 1574 */       if (!in(k))
/* 1575 */         return this.defRetValue; 
/* 1576 */       double oldValue = Int2DoubleAVLTreeMap.this.remove(k);
/* 1577 */       return Int2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1595 */       return Int2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Int2DoubleSortedMap headMap(int to) {
/* 1599 */       if (this.top)
/* 1600 */         return new Submap(this.from, this.bottom, to, false); 
/* 1601 */       return (Int2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Int2DoubleSortedMap tailMap(int from) {
/* 1605 */       if (this.bottom)
/* 1606 */         return new Submap(from, false, this.to, this.top); 
/* 1607 */       return (Int2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Int2DoubleSortedMap subMap(int from, int to) {
...
/* 1613 */       if (!this.top)
/* 1614 */         to = (Int2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1615 */       if (!this.bottom)
/* 1616 */         from = (Int2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1628 */       if (Int2DoubleAVLTreeMap.this.tree == null) {
/* 1629 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1633 */       if (this.bottom) {
/* 1634 */         e = Int2DoubleAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1636 */         e = Int2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1638 */         if (Int2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1639 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1643 */       if (e == null || (!this.top && Int2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1644 */         return null; 
/* 1645 */       return e;
/*      */     }
/*      */ 
...
/*      */       Int2DoubleAVLTreeMap.Entry e;
/* 1654 */       if (Int2DoubleAVLTreeMap.this.tree == null) {
/* 1655 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1659 */       if (this.top) {
/* 1660 */         e = Int2DoubleAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1662 */         e = Int2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1664 */         if (Int2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1665 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1669 */       if (e == null || (!this.bottom && Int2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1670 */         return null; 
/* 1671 */       return e;
/*      */     }
/*      */     
/*      */     public int firstIntKey() {
/* 1675 */       Int2DoubleAVLTreeMap.Entry e = firstEntry();
/* 1676 */       if (e == null)
...
/*      */     
/*      */     public int lastIntKey() {
/* 1682 */       Int2DoubleAVLTreeMap.Entry e = lastEntry();
/* 1683 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1698 */         this.next = Int2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1701 */         this();
/* 1702 */         if (this.next != null)
/* 1703 */           if (!Int2DoubleAVLTreeMap.Submap.this.bottom && Int2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1704 */             this.prev = null;
/* 1705 */           } else if (!Int2DoubleAVLTreeMap.Submap.this.top && Int2DoubleAVLTreeMap.this.compare(k, (this.prev = Int2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1706 */             this.next = null;
/*      */           } else {
/* 1708 */             this.next = Int2DoubleAVLTreeMap.this.locateKey(k);
/* 1709 */             if (Int2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1720 */         if (!Int2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Int2DoubleAVLTreeMap.this.compare(this.prev.key, Int2DoubleAVLTreeMap.Submap.this.from) < 0)
/* 1721 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1725 */         this.next = this.next.next();
/* 1726 */         if (!Int2DoubleAVLTreeMap.Submap.this.top && this.next != null && Int2DoubleAVLTreeMap.this.compare(this.next.key, Int2DoubleAVLTreeMap.Submap.this.to) >= 0)
/* 1727 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1807 */       c = (Int2DoubleAVLTreeMap)super.clone();
...
/* 1866 */       s.writeInt(e.key);
/* 1867 */       s.writeDouble(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1888 */     if (n == 1) {
/* 1889 */       Entry entry = new Entry(s.readInt(), s.readDouble());
...
/*      */ 
/*      */       
/* 1899 */       Entry entry = new Entry(s.readInt(), s.readDouble());
/* 1900 */       entry.right(new Entry(s.readInt(), s.readDouble()));
...
/* 1911 */     top.key = s.readInt();
/* 1912 */     top.value = s.readDouble();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleAVLTreeMap.class
