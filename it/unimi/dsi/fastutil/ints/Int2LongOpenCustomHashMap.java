...
/*      */   
/*      */   public boolean trim() {
/* 1114 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1147 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1148 */       return true; 
/*      */     try {
/* 1150 */       rehash(l);
...
/* 1171 */     long[] value = this.value;
/* 1172 */     int mask = newN - 1;
/* 1173 */     int[] newKey = new int[newN + 1];
/* 1174 */     long[] newValue = new long[newN + 1];
/* 1175 */     int i = this.n;
...
/*      */     try {
/* 1205 */       c = (Int2LongOpenCustomHashMap)super.clone();
...
/* 1213 */     c.key = (int[])this.key.clone();
/* 1214 */     c.value = (long[])this.value.clone();
...
/* 1234 */       t ^= HashCommon.long2int(this.value[i]);
/* 1235 */       h += t;
/* 1236 */       i++;
/*      */     } 
/*      */     
/* 1239 */     if (this.containsNullKey)
/* 1240 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1241 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1244 */     int[] key = this.key;
/* 1245 */     long[] value = this.value;
...
/* 1260 */     int[] key = this.key = new int[this.n + 1];
/* 1261 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1264 */     for (int i = this.size; i-- != 0; ) {
/* 1265 */       int pos, k = s.readInt();
/* 1266 */       long v = s.readLong();
/* 1267 */       if (this.strategy.equals(k, 0)) {
/* 1268 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2LongOpenCustomHashMap.class
