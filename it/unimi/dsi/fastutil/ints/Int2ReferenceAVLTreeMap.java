...
/*  934 */         return false; 
/*  935 */       Map.Entry<Integer, V> e = (Map.Entry<Integer, V>)o;
/*  936 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1022 */     int index = 0;
/*      */     TreeIterator() {
/* 1024 */       this.next = Int2ReferenceAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(int k) {
/* 1027 */       if ((this.next = Int2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/* 1028 */         if (Int2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1079 */       updatePrevious();
/* 1080 */       updateNext();
/* 1081 */       Int2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1082 */       this.curr = null;
/*      */     }
...
/* 1129 */       this.entries = (ObjectSortedSet<Int2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1138 */             return (ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>>)new Int2ReferenceAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from) {
/* 1143 */             return (ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>>)new Int2ReferenceAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1151 */             if (e.getKey() == null || !(e.getKey() instanceof Integer))
/* 1152 */               return false; 
/* 1153 */             Int2ReferenceAVLTreeMap.Entry<V> f = Int2ReferenceAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1162 */             if (e.getKey() == null || !(e.getKey() instanceof Integer))
/* 1163 */               return false; 
/* 1164 */             Int2ReferenceAVLTreeMap.Entry<V> f = Int2ReferenceAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1165 */             if (f == null || f.getValue() != e.getValue())
/* 1166 */               return false; 
/* 1167 */             Int2ReferenceAVLTreeMap.this.remove(f.key);
/* 1168 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1172 */             return Int2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1176 */             Int2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Int2ReferenceMap.Entry<V> first() {
/* 1180 */             return Int2ReferenceAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Int2ReferenceMap.Entry<V> last() {
/* 1184 */             return Int2ReferenceAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Int2ReferenceMap.Entry<V>> subSet(Int2ReferenceMap.Entry<V> from, Int2ReferenceMap.Entry<V> to) {
/* 1189 */             return Int2ReferenceAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> to) {
/* 1193 */             return Int2ReferenceAVLTreeMap.this.headMap(to.getIntKey()).int2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> from) {
/* 1197 */             return Int2ReferenceAVLTreeMap.this.tailMap(from.getIntKey()).int2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1231 */       return new Int2ReferenceAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1235 */       return new Int2ReferenceAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1290 */             return (ObjectIterator<V>)new Int2ReferenceAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1294 */             return Int2ReferenceAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1298 */             return Int2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1302 */             Int2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1313 */     return new Submap(0, true, to, false);
/*      */   }
/*      */   
/*      */   public Int2ReferenceSortedMap<V> tailMap(int from) {
/* 1317 */     return new Submap(from, false, 0, true);
/*      */   }
/*      */   
...
/* 1365 */       if (!bottom && !top && Int2ReferenceAVLTreeMap.this.compare(from, to) > 0)
/* 1366 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Int2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1389 */       return ((this.bottom || Int2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ReferenceAVLTreeMap.this
/* 1390 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
/* 1394 */       if (this.entries == null)
/* 1395 */         this.entries = (ObjectSortedSet<Int2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator() {
/* 1398 */               return (ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>>)new Int2ReferenceAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from) {
/* 1403 */               return (ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>>)new Int2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Int2ReferenceMap.Entry<V>> comparator() {
/* 1407 */               return Int2ReferenceAVLTreeMap.this.int2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1416 */                 return false; 
/* 1417 */               Int2ReferenceAVLTreeMap.Entry<V> f = Int2ReferenceAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1418 */               return (f != null && Int2ReferenceAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1427 */                 return false; 
/* 1428 */               Int2ReferenceAVLTreeMap.Entry<V> f = Int2ReferenceAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1429 */               if (f != null && Int2ReferenceAVLTreeMap.Submap.this.in(f.key))
/* 1430 */                 Int2ReferenceAVLTreeMap.Submap.this.remove(f.key); 
/* 1431 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1435 */               int c = 0;
/* 1436 */               for (ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1437 */                 c++; 
/* 1438 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1442 */               return !(new Int2ReferenceAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1446 */               Int2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Int2ReferenceMap.Entry<V> first() {
/* 1450 */               return Int2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Int2ReferenceMap.Entry<V> last() {
/* 1454 */               return Int2ReferenceAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Int2ReferenceMap.Entry<V>> subSet(Int2ReferenceMap.Entry<V> from, Int2ReferenceMap.Entry<V> to) {
/* 1459 */               return Int2ReferenceAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> to) {
/* 1463 */               return Int2ReferenceAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> from) {
/* 1467 */               return Int2ReferenceAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2ReferenceEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractInt2ReferenceSortedMap<V>.KeySet {
/*      */       public IntBidirectionalIterator iterator() {
/* 1475 */         return new Int2ReferenceAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1479 */         return new Int2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public IntSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1494 */               return (ObjectIterator<V>)new Int2ReferenceAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1498 */               return Int2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1502 */               return Int2ReferenceAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1506 */               Int2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1514 */       return (in(k) && Int2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(int k) {
/* 1531 */       int kk = k; Int2ReferenceAVLTreeMap.Entry<V> e;
/* 1532 */       return (in(kk) && (e = Int2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(int k, V v) {
/* 1536 */       Int2ReferenceAVLTreeMap.this.modified = false;
/* 1537 */       if (!in(k))
...
/* 1540 */       V oldValue = Int2ReferenceAVLTreeMap.this.put(k, v);
/* 1541 */       return Int2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(int k) {
/* 1546 */       Int2ReferenceAVLTreeMap.this.modified = false;
/* 1547 */       if (!in(k))
/* 1548 */         return this.defRetValue; 
/* 1549 */       V oldValue = Int2ReferenceAVLTreeMap.this.remove(k);
/* 1550 */       return Int2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1568 */       return Int2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Int2ReferenceSortedMap<V> headMap(int to) {
/* 1572 */       if (this.top)
/* 1573 */         return new Submap(this.from, this.bottom, to, false); 
/* 1574 */       return (Int2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Int2ReferenceSortedMap<V> tailMap(int from) {
/* 1578 */       if (this.bottom)
/* 1579 */         return new Submap(from, false, this.to, this.top); 
/* 1580 */       return (Int2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Int2ReferenceSortedMap<V> subMap(int from, int to) {
...
/* 1586 */       if (!this.top)
/* 1587 */         to = (Int2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1588 */       if (!this.bottom)
/* 1589 */         from = (Int2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1601 */       if (Int2ReferenceAVLTreeMap.this.tree == null) {
/* 1602 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1606 */       if (this.bottom) {
/* 1607 */         e = Int2ReferenceAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1609 */         e = Int2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1611 */         if (Int2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1612 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1616 */       if (e == null || (!this.top && Int2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1617 */         return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
...
/*      */       Int2ReferenceAVLTreeMap.Entry<V> e;
/* 1627 */       if (Int2ReferenceAVLTreeMap.this.tree == null) {
/* 1628 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1632 */       if (this.top) {
/* 1633 */         e = Int2ReferenceAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1635 */         e = Int2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1637 */         if (Int2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1638 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1642 */       if (e == null || (!this.bottom && Int2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1643 */         return null; 
/* 1644 */       return e;
/*      */     }
/*      */     
/*      */     public int firstIntKey() {
/* 1648 */       Int2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
/* 1649 */       if (e == null)
...
/*      */     
/*      */     public int lastIntKey() {
/* 1655 */       Int2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
/* 1656 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1671 */         this.next = Int2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1674 */         this();
/* 1675 */         if (this.next != null)
/* 1676 */           if (!Int2ReferenceAVLTreeMap.Submap.this.bottom && Int2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1677 */             this.prev = null;
/* 1678 */           } else if (!Int2ReferenceAVLTreeMap.Submap.this.top && Int2ReferenceAVLTreeMap.this.compare(k, (this.prev = Int2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1679 */             this.next = null;
/*      */           } else {
/* 1681 */             this.next = Int2ReferenceAVLTreeMap.this.locateKey(k);
/* 1682 */             if (Int2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1693 */         if (!Int2ReferenceAVLTreeMap.Submap.this.bottom && this.prev != null && Int2ReferenceAVLTreeMap.this.compare(this.prev.key, Int2ReferenceAVLTreeMap.Submap.this.from) < 0)
/* 1694 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1698 */         this.next = this.next.next();
/* 1699 */         if (!Int2ReferenceAVLTreeMap.Submap.this.top && this.next != null && Int2ReferenceAVLTreeMap.this.compare(this.next.key, Int2ReferenceAVLTreeMap.Submap.this.to) >= 0)
/* 1700 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1782 */       c = (Int2ReferenceAVLTreeMap<V>)super.clone();
...
/* 1863 */     if (n == 1) {
/* 1864 */       Entry<V> entry = new Entry<>(s.readInt(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1874 */       Entry<V> entry = new Entry<>(s.readInt(), (V)s.readObject());
/* 1875 */       entry.right(new Entry<>(s.readInt(), (V)s.readObject()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ReferenceAVLTreeMap.class
