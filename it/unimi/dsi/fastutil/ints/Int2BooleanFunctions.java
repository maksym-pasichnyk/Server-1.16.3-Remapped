...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Int2BooleanFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Int2BooleanFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 161 */     return new Singleton(key.intValue(), value.booleanValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Int2BooleanFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractInt2BooleanFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2BooleanFunction function;
/*     */     
...
/* 462 */       Boolean v = this.function.apply(Integer.valueOf(key));
/* 463 */       if (v == null)
...
/* 506 */     if (f instanceof Int2BooleanFunction)
/* 507 */       return (Int2BooleanFunction)f; 
/* 508 */     if (f instanceof IntPredicate) {
/* 509 */       Objects.requireNonNull((IntPredicate)f); return (IntPredicate)f::test;
/* 510 */     }  return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2BooleanFunctions.class
