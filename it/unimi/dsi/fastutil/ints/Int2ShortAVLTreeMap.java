...
/*  954 */         return false; 
/*  955 */       Map.Entry<Integer, Short> e = (Map.Entry<Integer, Short>)o;
/*  956 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Int2ShortAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(int k) {
/* 1047 */       if ((this.next = Int2ShortAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Int2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Int2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Int2ShortMap.Entry>)new AbstractObjectSortedSet<Int2ShortMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Int2ShortAVLTreeMap.Entry f = Int2ShortAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1186 */               return false; 
/* 1187 */             Int2ShortAVLTreeMap.Entry f = Int2ShortAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1188 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue())
/* 1189 */               return false; 
/* 1190 */             Int2ShortAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Int2ShortAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Int2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Int2ShortMap.Entry first() {
/* 1203 */             return Int2ShortAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Int2ShortMap.Entry last() {
/* 1207 */             return Int2ShortAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2ShortMap.Entry> subSet(Int2ShortMap.Entry from, Int2ShortMap.Entry to) {
/* 1211 */             return Int2ShortAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2ShortEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2ShortMap.Entry> headSet(Int2ShortMap.Entry to) {
/* 1215 */             return Int2ShortAVLTreeMap.this.headMap(to.getIntKey()).int2ShortEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2ShortMap.Entry> tailSet(Int2ShortMap.Entry from) {
/* 1219 */             return Int2ShortAVLTreeMap.this.tailMap(from.getIntKey()).int2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Int2ShortAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1257 */       return new Int2ShortAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (ShortIterator)new Int2ShortAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(short k) {
/* 1316 */             return Int2ShortAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Int2ShortAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Int2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Int2ShortAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Int2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Int2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ShortAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Int2ShortMap.Entry>)new AbstractObjectSortedSet<Int2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Int2ShortMap.Entry>)new Int2ShortAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Int2ShortMap.Entry> comparator() {
/* 1428 */               return Int2ShortAVLTreeMap.this.int2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Int2ShortAVLTreeMap.Entry f = Int2ShortAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1441 */               return (f != null && Int2ShortAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Int2ShortAVLTreeMap.Entry f = Int2ShortAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1454 */               if (f != null && Int2ShortAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Int2ShortAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Int2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Int2ShortAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Int2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Int2ShortMap.Entry first() {
/* 1475 */               return Int2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Int2ShortMap.Entry last() {
/* 1479 */               return Int2ShortAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2ShortMap.Entry> subSet(Int2ShortMap.Entry from, Int2ShortMap.Entry to) {
/* 1483 */               return Int2ShortAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2ShortEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2ShortMap.Entry> headSet(Int2ShortMap.Entry to) {
/* 1487 */               return Int2ShortAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2ShortEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2ShortMap.Entry> tailSet(Int2ShortMap.Entry from) {
/* 1491 */               return Int2ShortAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractInt2ShortSortedMap.KeySet {
/*      */       public IntBidirectionalIterator iterator() {
/* 1499 */         return new Int2ShortAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1503 */         return new Int2ShortAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public IntSortedSet keySet() {
...
/* 1515 */         this.values = (ShortCollection)new AbstractShortCollection()
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1518 */               return (ShortIterator)new Int2ShortAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(short k) {
/* 1522 */               return Int2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Int2ShortAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Int2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1538 */       return (in(k) && Int2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(short v) {
...
/* 1545 */         short ev = (i.nextEntry()).value;
/* 1546 */         if (ev == v)
/* 1547 */           return true; 
/*      */       } 
/* 1549 */       return false;
...
/*      */     
/*      */     public short get(int k) {
/* 1555 */       int kk = k; Int2ShortAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Int2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public short put(int k, short v) {
/* 1560 */       Int2ShortAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       short oldValue = Int2ShortAVLTreeMap.this.put(k, v);
/* 1565 */       return Int2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short remove(int k) {
/* 1570 */       Int2ShortAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       short oldValue = Int2ShortAVLTreeMap.this.remove(k);
/* 1574 */       return Int2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1592 */       return Int2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Int2ShortSortedMap headMap(int to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Int2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Int2ShortSortedMap tailMap(int from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Int2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Int2ShortSortedMap subMap(int from, int to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Int2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Int2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Int2ShortAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Int2ShortAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Int2ShortAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Int2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Int2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Int2ShortAVLTreeMap.Entry e;
/* 1651 */       if (Int2ShortAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Int2ShortAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Int2ShortAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Int2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Int2ShortAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public int firstIntKey() {
/* 1672 */       Int2ShortAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public int lastIntKey() {
/* 1679 */       Int2ShortAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Int2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Int2ShortAVLTreeMap.Submap.this.bottom && Int2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Int2ShortAVLTreeMap.Submap.this.top && Int2ShortAVLTreeMap.this.compare(k, (this.prev = Int2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Int2ShortAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Int2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Int2ShortAVLTreeMap.Submap.this.bottom && this.prev != null && Int2ShortAVLTreeMap.this.compare(this.prev.key, Int2ShortAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Int2ShortAVLTreeMap.Submap.this.top && this.next != null && Int2ShortAVLTreeMap.this.compare(this.next.key, Int2ShortAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1804 */       c = (Int2ShortAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readInt(), s.readShort());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readInt(), s.readShort());
/* 1897 */       entry.right(new Entry(s.readInt(), s.readShort()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ShortAVLTreeMap.class
