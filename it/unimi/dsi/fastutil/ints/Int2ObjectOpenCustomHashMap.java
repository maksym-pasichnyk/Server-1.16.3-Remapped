...
/* 1095 */     int[] key = this.key;
/* 1096 */     V[] value = this.value;
/* 1097 */     int mask = newN - 1;
/* 1098 */     int[] newKey = new int[newN + 1];
/* 1099 */     V[] newValue = (V[])new Object[newN + 1];
/* 1100 */     int i = this.n;
/* 1101 */     for (int j = realSize(); j-- != 0; ) {
/* 1102 */       while (key[--i] == 0); int pos;
/* 1103 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
/* 1104 */         while (newKey[pos = pos + 1 & mask] != 0); 
...
/*      */     try {
/* 1130 */       c = (Int2ObjectOpenCustomHashMap<V>)super.clone();
...
/* 1138 */     c.key = (int[])this.key.clone();
/* 1139 */     c.value = (V[])this.value.clone();
...
/* 1156 */       while (this.key[i] == 0)
/* 1157 */         i++; 
/* 1158 */       t = this.strategy.hashCode(this.key[i]);
/* 1159 */       if (this != this.value[i])
/* 1160 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1161 */       h += t;
/* 1162 */       i++;
/*      */     } 
/*      */     
/* 1165 */     if (this.containsNullKey)
/* 1166 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1167 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1170 */     int[] key = this.key;
/* 1171 */     V[] value = this.value;
/* 1172 */     MapIterator i = new MapIterator();
/* 1173 */     s.defaultWriteObject();
/* 1174 */     for (int j = this.size; j-- != 0; ) {
/* 1175 */       int e = i.nextEntry();
/* 1176 */       s.writeInt(key[e]);
/* 1177 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1186 */     int[] key = this.key = new int[this.n + 1];
/* 1187 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1190 */     for (int i = this.size; i-- != 0; ) {
/* 1191 */       int pos, k = s.readInt();
/* 1192 */       V v = (V)s.readObject();
/* 1193 */       if (this.strategy.equals(k, 0)) {
/* 1194 */         pos = this.n;
/* 1195 */         this.containsNullKey = true;
/*      */       } else {
/* 1197 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1198 */         while (key[pos] != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ObjectOpenCustomHashMap.class
