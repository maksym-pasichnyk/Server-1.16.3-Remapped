...
/* 1056 */     int[] key = this.key;
/* 1057 */     V[] value = this.value;
/* 1058 */     int mask = newN - 1;
/* 1059 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1091 */       c = (Int2ObjectOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ObjectOpenHashMap.class
