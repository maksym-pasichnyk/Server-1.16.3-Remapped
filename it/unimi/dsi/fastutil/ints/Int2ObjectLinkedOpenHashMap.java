...
/* 1736 */     int[] key = this.key;
/* 1737 */     V[] value = this.value;
/* 1738 */     int mask = newN - 1;
/* 1739 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1794 */       c = (Int2ObjectLinkedOpenHashMap<V>)super.clone();
...
/* 1850 */     int[] key = this.key = new int[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ObjectLinkedOpenHashMap.class
