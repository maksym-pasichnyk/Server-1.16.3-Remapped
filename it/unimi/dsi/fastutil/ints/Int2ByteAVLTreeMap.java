...
/*  954 */         return false; 
/*  955 */       Map.Entry<Integer, Byte> e = (Map.Entry<Integer, Byte>)o;
/*  956 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Int2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(int k) {
/* 1047 */       if ((this.next = Int2ByteAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Int2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Int2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Int2ByteMap.Entry>)new AbstractObjectSortedSet<Int2ByteMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Int2ByteMap.Entry>)new Int2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Int2ByteMap.Entry>)new Int2ByteAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1186 */               return false; 
/* 1187 */             Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1188 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue())
/* 1189 */               return false; 
/* 1190 */             Int2ByteAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Int2ByteAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Int2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Int2ByteMap.Entry first() {
/* 1203 */             return Int2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Int2ByteMap.Entry last() {
/* 1207 */             return Int2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2ByteMap.Entry> subSet(Int2ByteMap.Entry from, Int2ByteMap.Entry to) {
/* 1211 */             return Int2ByteAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry to) {
/* 1215 */             return Int2ByteAVLTreeMap.this.headMap(to.getIntKey()).int2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry from) {
/* 1219 */             return Int2ByteAVLTreeMap.this.tailMap(from.getIntKey()).int2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Int2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1257 */       return new Int2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (ByteIterator)new Int2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(byte k) {
/* 1316 */             return Int2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Int2ByteAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Int2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Int2ByteAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Int2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Int2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ByteAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Int2ByteMap.Entry>)new AbstractObjectSortedSet<Int2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Int2ByteMap.Entry>)new Int2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Int2ByteMap.Entry>)new Int2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Int2ByteMap.Entry> comparator() {
/* 1428 */               return Int2ByteAVLTreeMap.this.int2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1441 */               return (f != null && Int2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1454 */               if (f != null && Int2ByteAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Int2ByteAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Int2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Int2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Int2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Int2ByteMap.Entry first() {
/* 1475 */               return Int2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Int2ByteMap.Entry last() {
/* 1479 */               return Int2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2ByteMap.Entry> subSet(Int2ByteMap.Entry from, Int2ByteMap.Entry to) {
/* 1483 */               return Int2ByteAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry to) {
/* 1487 */               return Int2ByteAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry from) {
/* 1491 */               return Int2ByteAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractInt2ByteSortedMap.KeySet {
/*      */       public IntBidirectionalIterator iterator() {
/* 1499 */         return new Int2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1503 */         return new Int2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public IntSortedSet keySet() {
...
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1518 */               return (ByteIterator)new Int2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(byte k) {
/* 1522 */               return Int2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Int2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Int2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1538 */       return (in(k) && Int2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(int k) {
/* 1555 */       int kk = k; Int2ByteAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Int2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public byte put(int k, byte v) {
/* 1560 */       Int2ByteAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       byte oldValue = Int2ByteAVLTreeMap.this.put(k, v);
/* 1565 */       return Int2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte remove(int k) {
/* 1570 */       Int2ByteAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       byte oldValue = Int2ByteAVLTreeMap.this.remove(k);
/* 1574 */       return Int2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1592 */       return Int2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Int2ByteSortedMap headMap(int to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Int2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Int2ByteSortedMap tailMap(int from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Int2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Int2ByteSortedMap subMap(int from, int to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Int2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Int2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Int2ByteAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Int2ByteAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Int2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Int2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Int2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Int2ByteAVLTreeMap.Entry e;
/* 1651 */       if (Int2ByteAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Int2ByteAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Int2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Int2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Int2ByteAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public int firstIntKey() {
/* 1672 */       Int2ByteAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public int lastIntKey() {
/* 1679 */       Int2ByteAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Int2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Int2ByteAVLTreeMap.Submap.this.bottom && Int2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Int2ByteAVLTreeMap.Submap.this.top && Int2ByteAVLTreeMap.this.compare(k, (this.prev = Int2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Int2ByteAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Int2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Int2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Int2ByteAVLTreeMap.this.compare(this.prev.key, Int2ByteAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Int2ByteAVLTreeMap.Submap.this.top && this.next != null && Int2ByteAVLTreeMap.this.compare(this.next.key, Int2ByteAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1804 */       c = (Int2ByteAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readInt(), s.readByte());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readInt(), s.readByte());
/* 1897 */       entry.right(new Entry(s.readInt(), s.readByte()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ByteAVLTreeMap.class
