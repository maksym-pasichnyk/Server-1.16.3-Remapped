...
/* 1130 */     int[] key = this.key;
/* 1131 */     boolean[] value = this.value;
/* 1132 */     int mask = newN - 1;
/* 1133 */     int[] newKey = new int[newN + 1];
...
/* 1139 */         while (newKey[pos = pos + 1 & mask] != 0); 
...
/*      */     try {
/* 1165 */       c = (Int2BooleanOpenCustomHashMap)super.clone();
...
/* 1227 */       if (this.strategy.equals(k, 0)) {
/* 1228 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2BooleanOpenCustomHashMap.class
