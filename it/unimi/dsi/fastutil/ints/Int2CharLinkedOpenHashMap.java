...
/*      */   
/*      */   public boolean trim() {
/* 1707 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1708 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1709 */       return true; 
/*      */     try {
/* 1711 */       rehash(l);
/* 1712 */     } catch (OutOfMemoryError cantDoIt) {
/* 1713 */       return false;
/*      */     } 
/* 1715 */     return true;
/*      */   }
...
/* 1739 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1740 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1741 */       return true; 
/*      */     try {
/* 1743 */       rehash(l);
/* 1744 */     } catch (OutOfMemoryError cantDoIt) {
/* 1745 */       return false;
/*      */     } 
/* 1747 */     return true;
/*      */   }
...
/* 1763 */     int[] key = this.key;
/* 1764 */     char[] value = this.value;
/* 1765 */     int mask = newN - 1;
/* 1766 */     int[] newKey = new int[newN + 1];
/* 1767 */     char[] newValue = new char[newN + 1];
/* 1768 */     int i = this.first, prev = -1, newPrev = -1;
/* 1769 */     long[] link = this.link;
/* 1770 */     long[] newLink = new long[newN + 1];
/* 1771 */     this.first = -1;
/* 1772 */     for (int j = this.size; j-- != 0; ) {
/* 1773 */       int pos; if (key[i] == 0) {
/* 1774 */         pos = newN;
/*      */       } else {
/* 1776 */         pos = HashCommon.mix(key[i]) & mask;
/* 1777 */         while (newKey[pos] != 0)
/* 1778 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1780 */       newKey[pos] = key[i];
/* 1781 */       newValue[pos] = value[i];
/* 1782 */       if (prev != -1) {
/* 1783 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1784 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1785 */         newPrev = pos;
/*      */       } else {
/* 1787 */         newPrev = this.first = pos;
/*      */         
/* 1789 */         newLink[pos] = -1L;
/*      */       } 
/* 1791 */       int t = i;
...
/* 1793 */       prev = t;
/*      */     } 
/* 1795 */     this.link = newLink;
/* 1796 */     this.last = newPrev;
/* 1797 */     if (newPrev != -1)
/*      */     {
/* 1799 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1800 */     this.n = newN;
/* 1801 */     this.mask = mask;
/* 1802 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1803 */     this.key = newKey;
/* 1804 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1821 */       c = (Int2CharLinkedOpenHashMap)super.clone();
/* 1822 */     } catch (CloneNotSupportedException cantHappen) {
/* 1823 */       throw new InternalError();
/*      */     } 
/* 1825 */     c.keys = null;
/* 1826 */     c.values = null;
/* 1827 */     c.entries = null;
/* 1828 */     c.containsNullKey = this.containsNullKey;
/* 1829 */     c.key = (int[])this.key.clone();
/* 1830 */     c.value = (char[])this.value.clone();
/* 1831 */     c.link = (long[])this.link.clone();
/* 1832 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1845 */     int h = 0;
/* 1846 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1847 */       while (this.key[i] == 0)
/* 1848 */         i++; 
/* 1849 */       t = this.key[i];
/* 1850 */       t ^= this.value[i];
/* 1851 */       h += t;
...
/* 1876 */     int[] key = this.key = new int[this.n + 1];
/* 1877 */     char[] value = this.value = new char[this.n + 1];
...
/* 1884 */       int pos, k = s.readInt();
/* 1885 */       char v = s.readChar();
/* 1886 */       if (k == 0) {
/* 1887 */         pos = this.n;
/* 1888 */         this.containsNullKey = true;
/*      */       } else {
/* 1890 */         pos = HashCommon.mix(k) & this.mask;
/* 1891 */         while (key[pos] != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2CharLinkedOpenHashMap.class
