...
/*  954 */         return false; 
/*  955 */       Map.Entry<Integer, Integer> e = (Map.Entry<Integer, Integer>)o;
/*  956 */       return (this.key == ((Integer)e.getKey()).intValue() && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Int2IntAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(int k) {
/* 1047 */       if ((this.next = Int2IntAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Int2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Int2IntAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Int2IntMap.Entry>)new AbstractObjectSortedSet<Int2IntMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Int2IntMap.Entry>)new Int2IntAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator(Int2IntMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Int2IntMap.Entry>)new Int2IntAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Int2IntAVLTreeMap.Entry f = Int2IntAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1186 */               return false; 
/* 1187 */             Int2IntAVLTreeMap.Entry f = Int2IntAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1188 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue())
/* 1189 */               return false; 
/* 1190 */             Int2IntAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Int2IntAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Int2IntAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Int2IntMap.Entry first() {
/* 1203 */             return Int2IntAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Int2IntMap.Entry last() {
/* 1207 */             return Int2IntAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry from, Int2IntMap.Entry to) {
/* 1211 */             return Int2IntAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2IntEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry to) {
/* 1215 */             return Int2IntAVLTreeMap.this.headMap(to.getIntKey()).int2IntEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry from) {
/* 1219 */             return Int2IntAVLTreeMap.this.tailMap(from.getIntKey()).int2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Int2IntAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1257 */       return new Int2IntAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1309 */       this.values = new AbstractIntCollection()
/*      */         {
/*      */           public IntIterator iterator() {
/* 1312 */             return new Int2IntAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(int k) {
/* 1316 */             return Int2IntAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Int2IntAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Int2IntAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Int2IntAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Int2IntAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Int2IntAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2IntAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Int2IntMap.Entry>)new AbstractObjectSortedSet<Int2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Int2IntMap.Entry>)new Int2IntAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator(Int2IntMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Int2IntMap.Entry>)new Int2IntAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Int2IntMap.Entry> comparator() {
/* 1428 */               return Int2IntAVLTreeMap.this.int2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Int2IntAVLTreeMap.Entry f = Int2IntAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1441 */               return (f != null && Int2IntAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Int2IntAVLTreeMap.Entry f = Int2IntAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1454 */               if (f != null && Int2IntAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Int2IntAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Int2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Int2IntAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Int2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Int2IntMap.Entry first() {
/* 1475 */               return Int2IntAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Int2IntMap.Entry last() {
/* 1479 */               return Int2IntAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry from, Int2IntMap.Entry to) {
/* 1483 */               return Int2IntAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2IntEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry to) {
/* 1487 */               return Int2IntAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2IntEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry from) {
/* 1491 */               return Int2IntAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2IntEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractInt2IntSortedMap.KeySet {
/*      */       public IntBidirectionalIterator iterator() {
/* 1499 */         return new Int2IntAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1503 */         return new Int2IntAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public IntSortedSet keySet() {
...
/* 1515 */         this.values = new AbstractIntCollection()
/*      */           {
/*      */             public IntIterator iterator() {
/* 1518 */               return new Int2IntAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(int k) {
/* 1522 */               return Int2IntAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Int2IntAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Int2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1538 */       return (in(k) && Int2IntAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(int k) {
/* 1555 */       int kk = k; Int2IntAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Int2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int put(int k, int v) {
/* 1560 */       Int2IntAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       int oldValue = Int2IntAVLTreeMap.this.put(k, v);
/* 1565 */       return Int2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int remove(int k) {
/* 1570 */       Int2IntAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       int oldValue = Int2IntAVLTreeMap.this.remove(k);
/* 1574 */       return Int2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1592 */       return Int2IntAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Int2IntSortedMap headMap(int to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Int2IntAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Int2IntSortedMap tailMap(int from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Int2IntAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Int2IntSortedMap subMap(int from, int to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Int2IntAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Int2IntAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Int2IntAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Int2IntAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Int2IntAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Int2IntAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Int2IntAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Int2IntAVLTreeMap.Entry e;
/* 1651 */       if (Int2IntAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Int2IntAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Int2IntAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Int2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Int2IntAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public int firstIntKey() {
/* 1672 */       Int2IntAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public int lastIntKey() {
/* 1679 */       Int2IntAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Int2IntAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Int2IntAVLTreeMap.Submap.this.bottom && Int2IntAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Int2IntAVLTreeMap.Submap.this.top && Int2IntAVLTreeMap.this.compare(k, (this.prev = Int2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Int2IntAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Int2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Int2IntAVLTreeMap.Submap.this.bottom && this.prev != null && Int2IntAVLTreeMap.this.compare(this.prev.key, Int2IntAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Int2IntAVLTreeMap.Submap.this.top && this.next != null && Int2IntAVLTreeMap.this.compare(this.next.key, Int2IntAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
/*      */     private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Int2IntMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     Int2IntAVLTreeMap c;
/*      */     try {
/* 1804 */       c = (Int2IntAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readInt(), s.readInt());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readInt(), s.readInt());
/* 1897 */       entry.right(new Entry(s.readInt(), s.readInt()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2IntAVLTreeMap.class
