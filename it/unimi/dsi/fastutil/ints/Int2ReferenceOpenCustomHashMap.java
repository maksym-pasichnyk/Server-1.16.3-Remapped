...
/* 1096 */     int[] key = this.key;
/* 1097 */     V[] value = this.value;
/* 1098 */     int mask = newN - 1;
/* 1099 */     int[] newKey = new int[newN + 1];
...
/* 1105 */         while (newKey[pos = pos + 1 & mask] != 0); 
...
/*      */     try {
/* 1131 */       c = (Int2ReferenceOpenCustomHashMap<V>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ReferenceOpenCustomHashMap.class
