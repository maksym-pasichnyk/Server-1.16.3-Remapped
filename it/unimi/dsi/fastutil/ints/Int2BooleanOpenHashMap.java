...
/* 1085 */     int[] key = this.key;
/* 1086 */     boolean[] value = this.value;
/* 1087 */     int mask = newN - 1;
/* 1088 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1120 */       c = (Int2BooleanOpenHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2BooleanOpenHashMap.class
