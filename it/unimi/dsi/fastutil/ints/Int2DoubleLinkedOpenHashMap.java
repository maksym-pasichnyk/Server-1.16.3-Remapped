...
/*  903 */     Double newValue = remappingFunction.apply(Integer.valueOf(k), Double.valueOf(this.value[pos]));
...
/*  918 */     int pos = find(k);
/*  919 */     Double newValue = remappingFunction.apply(Integer.valueOf(k), 
...
/*  997 */       return Int2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public double getDoubleValue() {
/* 1001 */       return Int2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public double setValue(double v) {
/* 1005 */       double oldValue = Int2DoubleLinkedOpenHashMap.this.value[this.index];
/* 1006 */       Int2DoubleLinkedOpenHashMap.this.value[this.index] = v;
...
/* 1017 */       return Integer.valueOf(Int2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1027 */       return Double.valueOf(Int2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1043 */         return false; 
/* 1044 */       Map.Entry<Integer, Double> e = (Map.Entry<Integer, Double>)o;
/* 1045 */       return (Int2DoubleLinkedOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue() && 
/* 1046 */         Double.doubleToLongBits(Int2DoubleLinkedOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1050 */       return Int2DoubleLinkedOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Int2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1054 */       return Int2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Int2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1217 */       this.next = Int2DoubleLinkedOpenHashMap.this.first;
/* 1218 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(int from) {
/* 1221 */       if (from == 0) {
/* 1222 */         if (Int2DoubleLinkedOpenHashMap.this.containsNullKey) {
/* 1223 */           this.next = (int)Int2DoubleLinkedOpenHashMap.this.link[Int2DoubleLinkedOpenHashMap.this.n];
/* 1224 */           this.prev = Int2DoubleLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1227 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1229 */       if (Int2DoubleLinkedOpenHashMap.this.key[Int2DoubleLinkedOpenHashMap.this.last] == from) {
/* 1230 */         this.prev = Int2DoubleLinkedOpenHashMap.this.last;
/* 1231 */         this.index = Int2DoubleLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1235 */       int pos = HashCommon.mix(from) & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */       
/* 1237 */       while (Int2DoubleLinkedOpenHashMap.this.key[pos] != 0) {
/* 1238 */         if (Int2DoubleLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1240 */           this.next = (int)Int2DoubleLinkedOpenHashMap.this.link[pos];
/* 1241 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1244 */         pos = pos + 1 & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1261 */       if (this.next == -1) {
/* 1262 */         this.index = Int2DoubleLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1265 */       int pos = Int2DoubleLinkedOpenHashMap.this.first;
/* 1266 */       this.index = 1;
/* 1267 */       while (pos != this.prev) {
/* 1268 */         pos = (int)Int2DoubleLinkedOpenHashMap.this.link[pos];
/* 1269 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1284 */       this.next = (int)Int2DoubleLinkedOpenHashMap.this.link[this.curr];
...
/* 1294 */       this.prev = (int)(Int2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1309 */         this.index--;
/* 1310 */         this.prev = (int)(Int2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1312 */         this.next = (int)Int2DoubleLinkedOpenHashMap.this.link[this.curr];
/* 1313 */       }  Int2DoubleLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1318 */       if (this.prev == -1) {
/* 1319 */         Int2DoubleLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1321 */         Int2DoubleLinkedOpenHashMap.this.link[this.prev] = Int2DoubleLinkedOpenHashMap.this.link[this.prev] ^ (Int2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1322 */       }  if (this.next == -1) {
/* 1323 */         Int2DoubleLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1325 */         Int2DoubleLinkedOpenHashMap.this.link[this.next] = Int2DoubleLinkedOpenHashMap.this.link[this.next] ^ (Int2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1326 */       }  int pos = this.curr;
/* 1327 */       this.curr = -1;
/* 1328 */       if (pos == Int2DoubleLinkedOpenHashMap.this.n) {
/* 1329 */         Int2DoubleLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1332 */         int[] key = Int2DoubleLinkedOpenHashMap.this.key;
/*      */         
/*      */         while (true) {
/*      */           int curr, last;
/* 1336 */           pos = (last = pos) + 1 & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1338 */             if ((curr = key[pos]) == 0) {
/* 1339 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1342 */             int slot = HashCommon.mix(curr) & Int2DoubleLinkedOpenHashMap.this.mask;
/* 1343 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1345 */             pos = pos + 1 & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1347 */           key[last] = curr;
/* 1348 */           Int2DoubleLinkedOpenHashMap.this.value[last] = Int2DoubleLinkedOpenHashMap.this.value[pos];
/* 1349 */           if (this.next == pos)
/* 1350 */             this.next = last; 
/* 1351 */           if (this.prev == pos)
/* 1352 */             this.prev = last; 
/* 1353 */           Int2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/* 1385 */       return this.entry = new Int2DoubleLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     public EntryIterator() {}
/*      */     public Int2DoubleLinkedOpenHashMap.MapEntry previous() {
/* 1389 */       return this.entry = new Int2DoubleLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1393 */       super.remove();
...
/*      */   }
/*      */   
/* 1398 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Int2DoubleMap.Entry> { final Int2DoubleLinkedOpenHashMap.MapEntry entry = new Int2DoubleLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Int2DoubleMap.Entry> implements Int2DoubleSortedMap.FastSortedEntrySet { public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator() {
/* 1418 */       return (ObjectBidirectionalIterator<Int2DoubleMap.Entry>)new Int2DoubleLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     private MapEntrySet() {}
...
/* 1439 */       if (Int2DoubleLinkedOpenHashMap.this.size == 0)
/* 1440 */         throw new NoSuchElementException(); 
/* 1441 */       return new Int2DoubleLinkedOpenHashMap.MapEntry(Int2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Int2DoubleMap.Entry last() {
/* 1445 */       if (Int2DoubleLinkedOpenHashMap.this.size == 0)
/* 1446 */         throw new NoSuchElementException(); 
/* 1447 */       return new Int2DoubleLinkedOpenHashMap.MapEntry(Int2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1455 */       if (e.getKey() == null || !(e.getKey() instanceof Integer))
/* 1456 */         return false; 
/* 1457 */       if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1458 */         return false; 
/* 1459 */       int k = ((Integer)e.getKey()).intValue();
/* 1460 */       double v = ((Double)e.getValue()).doubleValue();
/* 1461 */       if (k == 0) {
/* 1462 */         return (Int2DoubleLinkedOpenHashMap.this.containsNullKey && 
/* 1463 */           Double.doubleToLongBits(Int2DoubleLinkedOpenHashMap.this.value[Int2DoubleLinkedOpenHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       }
/* 1465 */       int[] key = Int2DoubleLinkedOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1468 */       if ((curr = key[pos = HashCommon.mix(k) & Int2DoubleLinkedOpenHashMap.this.mask]) == 0)
/* 1469 */         return false; 
/* 1470 */       if (k == curr) {
/* 1471 */         return (Double.doubleToLongBits(Int2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       }
/*      */       while (true) {
/* 1474 */         if ((curr = key[pos = pos + 1 & Int2DoubleLinkedOpenHashMap.this.mask]) == 0)
/* 1475 */           return false; 
/* 1476 */         if (k == curr) {
/* 1477 */           return (Double.doubleToLongBits(Int2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1486 */       if (e.getKey() == null || !(e.getKey() instanceof Integer))
/* 1487 */         return false; 
/* 1488 */       if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1489 */         return false; 
/* 1490 */       int k = ((Integer)e.getKey()).intValue();
/* 1491 */       double v = ((Double)e.getValue()).doubleValue();
/* 1492 */       if (k == 0) {
/* 1493 */         if (Int2DoubleLinkedOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Int2DoubleLinkedOpenHashMap.this.value[Int2DoubleLinkedOpenHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1494 */           Int2DoubleLinkedOpenHashMap.this.removeNullEntry();
/* 1495 */           return true;
/*      */         } 
/* 1497 */         return false;
/*      */       } 
/*      */       
/* 1500 */       int[] key = Int2DoubleLinkedOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1503 */       if ((curr = key[pos = HashCommon.mix(k) & Int2DoubleLinkedOpenHashMap.this.mask]) == 0)
/* 1504 */         return false; 
/* 1505 */       if (curr == k) {
/* 1506 */         if (Double.doubleToLongBits(Int2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1507 */           Int2DoubleLinkedOpenHashMap.this.removeEntry(pos);
/* 1508 */           return true;
/*      */         } 
/* 1510 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1513 */         if ((curr = key[pos = pos + 1 & Int2DoubleLinkedOpenHashMap.this.mask]) == 0)
/* 1514 */           return false; 
/* 1515 */         if (curr == k && 
/* 1516 */           Double.doubleToLongBits(Int2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1517 */           Int2DoubleLinkedOpenHashMap.this.removeEntry(pos);
/* 1518 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1525 */       return Int2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1529 */       Int2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1544 */       return new Int2DoubleLinkedOpenHashMap.EntryIterator(from.getIntKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1555 */       return new Int2DoubleLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1570 */       return new Int2DoubleLinkedOpenHashMap.FastEntryIterator(from.getIntKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
/* 1575 */       for (int i = Int2DoubleLinkedOpenHashMap.this.size, next = Int2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1576 */         int curr = next;
/* 1577 */         next = (int)Int2DoubleLinkedOpenHashMap.this.link[curr];
/* 1578 */         consumer.accept(new AbstractInt2DoubleMap.BasicEntry(Int2DoubleLinkedOpenHashMap.this.key[curr], Int2DoubleLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
/* 1584 */       AbstractInt2DoubleMap.BasicEntry entry = new AbstractInt2DoubleMap.BasicEntry();
/* 1585 */       for (int i = Int2DoubleLinkedOpenHashMap.this.size, next = Int2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1586 */         int curr = next;
/* 1587 */         next = (int)Int2DoubleLinkedOpenHashMap.this.link[curr];
/* 1588 */         entry.key = Int2DoubleLinkedOpenHashMap.this.key[curr];
/* 1589 */         entry.value = Int2DoubleLinkedOpenHashMap.this.value[curr];
...
/* 1615 */       return Int2DoubleLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
/*      */     
/*      */     public int nextInt() {
/* 1622 */       return Int2DoubleLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractIntSortedSet { private KeySet() {}
/*      */     
/*      */     public IntListIterator iterator(int from) {
/* 1628 */       return new Int2DoubleLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public IntListIterator iterator() {
/* 1632 */       return new Int2DoubleLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1637 */       if (Int2DoubleLinkedOpenHashMap.this.containsNullKey)
/* 1638 */         consumer.accept(Int2DoubleLinkedOpenHashMap.this.key[Int2DoubleLinkedOpenHashMap.this.n]); 
/* 1639 */       for (int pos = Int2DoubleLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1640 */         int k = Int2DoubleLinkedOpenHashMap.this.key[pos];
/* 1641 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/* 1647 */       return Int2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(int k) {
/* 1651 */       return Int2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(int k) {
/* 1655 */       int oldSize = Int2DoubleLinkedOpenHashMap.this.size;
/* 1656 */       Int2DoubleLinkedOpenHashMap.this.remove(k);
/* 1657 */       return (Int2DoubleLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1661 */       Int2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public int firstInt() {
/* 1665 */       if (Int2DoubleLinkedOpenHashMap.this.size == 0)
/* 1666 */         throw new NoSuchElementException(); 
/* 1667 */       return Int2DoubleLinkedOpenHashMap.this.key[Int2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public int lastInt() {
/* 1671 */       if (Int2DoubleLinkedOpenHashMap.this.size == 0)
/* 1672 */         throw new NoSuchElementException(); 
/* 1673 */       return Int2DoubleLinkedOpenHashMap.this.key[Int2DoubleLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public IntComparator comparator() {
/* 1677 */       return null;
...
/* 1710 */       return Int2DoubleLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1717 */       return Int2DoubleLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public DoubleCollection values() {
/* 1722 */     if (this.values == null)
/* 1723 */       this.values = (DoubleCollection)new AbstractDoubleCollection()
/*      */         {
/*      */           public DoubleIterator iterator() {
/* 1726 */             return (DoubleIterator)new Int2DoubleLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1730 */             return Int2DoubleLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(double v) {
/* 1734 */             return Int2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1738 */             Int2DoubleLinkedOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(DoubleConsumer consumer)
/*      */           {
/* 1743 */             if (Int2DoubleLinkedOpenHashMap.this.containsNullKey)
/* 1744 */               consumer.accept(Int2DoubleLinkedOpenHashMap.this.value[Int2DoubleLinkedOpenHashMap.this.n]); 
/* 1745 */             for (int pos = Int2DoubleLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1746 */               if (Int2DoubleLinkedOpenHashMap.this.key[pos] != 0)
/* 1747 */                 consumer.accept(Int2DoubleLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */   
/*      */   public boolean trim() {
/* 1767 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1800 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1801 */       return true; 
/*      */     try {
/* 1803 */       rehash(l);
...
/* 1823 */     int[] key = this.key;
/* 1824 */     double[] value = this.value;
/* 1825 */     int mask = newN - 1;
/* 1826 */     int[] newKey = new int[newN + 1];
/* 1827 */     double[] newValue = new double[newN + 1];
...
/* 1833 */       int pos; if (key[i] == 0) {
/* 1834 */         pos = newN;
/*      */       } else {
/* 1836 */         pos = HashCommon.mix(key[i]) & mask;
/* 1837 */         while (newKey[pos] != 0)
/* 1838 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1881 */       c = (Int2DoubleLinkedOpenHashMap)super.clone();
...
/* 1889 */     c.key = (int[])this.key.clone();
/* 1890 */     c.value = (double[])this.value.clone();
...
/*      */   public int hashCode() {
/* 1905 */     int h = 0;
/* 1906 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1907 */       while (this.key[i] == 0)
/* 1908 */         i++; 
/* 1909 */       t = this.key[i];
/* 1910 */       t ^= HashCommon.double2int(this.value[i]);
/* 1911 */       h += t;
/* 1912 */       i++;
/*      */     } 
/*      */     
/* 1915 */     if (this.containsNullKey)
/* 1916 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1917 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1920 */     int[] key = this.key;
/* 1921 */     double[] value = this.value;
/* 1922 */     MapIterator i = new MapIterator();
/* 1923 */     s.defaultWriteObject();
/* 1924 */     for (int j = this.size; j-- != 0; ) {
/* 1925 */       int e = i.nextEntry();
/* 1926 */       s.writeInt(key[e]);
/* 1927 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1932 */     s.defaultReadObject();
/* 1933 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1934 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1935 */     this.mask = this.n - 1;
/* 1936 */     int[] key = this.key = new int[this.n + 1];
/* 1937 */     double[] value = this.value = new double[this.n + 1];
/* 1938 */     long[] link = this.link = new long[this.n + 1];
/* 1939 */     int prev = -1;
/* 1940 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1943 */     for (int i = this.size; i-- != 0; ) {
/* 1944 */       int pos, k = s.readInt();
/* 1945 */       double v = s.readDouble();
/* 1946 */       if (k == 0) {
/* 1947 */         pos = this.n;
/* 1948 */         this.containsNullKey = true;
/*      */       } else {
/* 1950 */         pos = HashCommon.mix(k) & this.mask;
/* 1951 */         while (key[pos] != 0)
/* 1952 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1954 */       key[pos] = k;
/* 1955 */       value[pos] = v;
/* 1956 */       if (this.first != -1) {
/* 1957 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1958 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1959 */         prev = pos; continue;
/*      */       } 
/* 1961 */       prev = this.first = pos;
/*      */       
/* 1963 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1966 */     this.last = prev;
/* 1967 */     if (prev != -1)
/*      */     {
/* 1969 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleLinkedOpenHashMap.class
