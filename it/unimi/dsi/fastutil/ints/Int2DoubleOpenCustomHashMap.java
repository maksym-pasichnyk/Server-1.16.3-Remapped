...
/* 1177 */     int[] key = this.key;
/* 1178 */     double[] value = this.value;
/* 1179 */     int mask = newN - 1;
/* 1180 */     int[] newKey = new int[newN + 1];
/* 1181 */     double[] newValue = new double[newN + 1];
/* 1182 */     int i = this.n;
/* 1183 */     for (int j = realSize(); j-- != 0; ) {
/* 1184 */       while (key[--i] == 0); int pos;
/* 1185 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
...
/*      */     try {
/* 1212 */       c = (Int2DoubleOpenCustomHashMap)super.clone();
...
/* 1272 */       int pos, k = s.readInt();
/* 1273 */       double v = s.readDouble();
/* 1274 */       if (this.strategy.equals(k, 0)) {
/* 1275 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleOpenCustomHashMap.class
