...
/*  954 */         return false; 
/*  955 */       Map.Entry<Integer, Float> e = (Map.Entry<Integer, Float>)o;
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Int2FloatAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(int k) {
/* 1048 */       if ((this.next = Int2FloatAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Int2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Int2FloatAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Int2FloatMap.Entry>)new AbstractObjectSortedSet<Int2FloatMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Int2FloatMap.Entry>)new Int2FloatAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Int2FloatMap.Entry>)new Int2FloatAVLTreeMap.EntryIterator(from.getIntKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1174 */               return false; 
/* 1175 */             Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1187 */               return false; 
/* 1188 */             Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1189 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != 
/* 1190 */               Float.floatToIntBits(((Float)e.getValue()).floatValue()))
/* 1191 */               return false; 
/* 1192 */             Int2FloatAVLTreeMap.this.remove(f.key);
/* 1193 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1197 */             return Int2FloatAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1201 */             Int2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Int2FloatMap.Entry first() {
/* 1205 */             return Int2FloatAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Int2FloatMap.Entry last() {
/* 1209 */             return Int2FloatAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry from, Int2FloatMap.Entry to) {
/* 1213 */             return Int2FloatAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry to) {
/* 1217 */             return Int2FloatAVLTreeMap.this.headMap(to.getIntKey()).int2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from) {
/* 1221 */             return Int2FloatAVLTreeMap.this.tailMap(from.getIntKey()).int2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1255 */       return new Int2FloatAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public IntBidirectionalIterator iterator(int from) {
/* 1259 */       return new Int2FloatAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1314 */             return (FloatIterator)new Int2FloatAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(float k) {
/* 1318 */             return Int2FloatAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1322 */             return Int2FloatAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1326 */             Int2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1389 */       if (!bottom && !top && Int2FloatAVLTreeMap.this.compare(from, to) > 0)
/* 1390 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1391 */       this.from = from;
/* 1392 */       this.bottom = bottom;
/* 1393 */       this.to = to;
/* 1394 */       this.top = top;
/* 1395 */       this.defRetValue = Int2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1413 */       return ((this.bottom || Int2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2FloatAVLTreeMap.this
/* 1414 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
/* 1418 */       if (this.entries == null)
/* 1419 */         this.entries = (ObjectSortedSet<Int2FloatMap.Entry>)new AbstractObjectSortedSet<Int2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator() {
/* 1422 */               return (ObjectBidirectionalIterator<Int2FloatMap.Entry>)new Int2FloatAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from) {
/* 1426 */               return (ObjectBidirectionalIterator<Int2FloatMap.Entry>)new Int2FloatAVLTreeMap.Submap.SubmapEntryIterator(from.getIntKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Int2FloatMap.Entry> comparator() {
/* 1430 */               return Int2FloatAVLTreeMap.this.int2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1441 */                 return false; 
/* 1442 */               Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1443 */               return (f != null && Int2FloatAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1454 */                 return false; 
/* 1455 */               Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1456 */               if (f != null && Int2FloatAVLTreeMap.Submap.this.in(f.key))
/* 1457 */                 Int2FloatAVLTreeMap.Submap.this.remove(f.key); 
/* 1458 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1462 */               int c = 0;
/* 1463 */               for (ObjectBidirectionalIterator<Int2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1464 */                 c++; 
/* 1465 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1469 */               return !(new Int2FloatAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1473 */               Int2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Int2FloatMap.Entry first() {
/* 1477 */               return Int2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Int2FloatMap.Entry last() {
/* 1481 */               return Int2FloatAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry from, Int2FloatMap.Entry to) {
/* 1485 */               return Int2FloatAVLTreeMap.Submap.this.subMap(from.getIntKey(), to.getIntKey()).int2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry to) {
/* 1489 */               return Int2FloatAVLTreeMap.Submap.this.headMap(to.getIntKey()).int2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from) {
/* 1493 */               return Int2FloatAVLTreeMap.Submap.this.tailMap(from.getIntKey()).int2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractInt2FloatSortedMap.KeySet {
/*      */       public IntBidirectionalIterator iterator() {
/* 1501 */         return new Int2FloatAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public IntBidirectionalIterator iterator(int from) {
/* 1505 */         return new Int2FloatAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public IntSortedSet keySet() {
...
/* 1517 */         this.values = (FloatCollection)new AbstractFloatCollection()
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1520 */               return (FloatIterator)new Int2FloatAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(float k) {
/* 1524 */               return Int2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1528 */               return Int2FloatAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1532 */               Int2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(int k) {
/* 1540 */       return (in(k) && Int2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(float v) {
...
/* 1547 */         float ev = (i.nextEntry()).value;
/* 1548 */         if (Float.floatToIntBits(ev) == Float.floatToIntBits(v))
/* 1549 */           return true; 
/*      */       } 
/* 1551 */       return false;
/*      */     }
...
/*      */     
/*      */     public float get(int k) {
/* 1557 */       int kk = k; Int2FloatAVLTreeMap.Entry e;
/* 1558 */       return (in(kk) && (e = Int2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public float put(int k, float v) {
/* 1562 */       Int2FloatAVLTreeMap.this.modified = false;
/* 1563 */       if (!in(k))
...
/* 1566 */       float oldValue = Int2FloatAVLTreeMap.this.put(k, v);
/* 1567 */       return Int2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float remove(int k) {
/* 1572 */       Int2FloatAVLTreeMap.this.modified = false;
/* 1573 */       if (!in(k))
/* 1574 */         return this.defRetValue; 
/* 1575 */       float oldValue = Int2FloatAVLTreeMap.this.remove(k);
/* 1576 */       return Int2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public IntComparator comparator() {
/* 1594 */       return Int2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Int2FloatSortedMap headMap(int to) {
/* 1598 */       if (this.top)
/* 1599 */         return new Submap(this.from, this.bottom, to, false); 
/* 1600 */       return (Int2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Int2FloatSortedMap tailMap(int from) {
/* 1604 */       if (this.bottom)
/* 1605 */         return new Submap(from, false, this.to, this.top); 
/* 1606 */       return (Int2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Int2FloatSortedMap subMap(int from, int to) {
...
/* 1612 */       if (!this.top)
/* 1613 */         to = (Int2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1614 */       if (!this.bottom)
/* 1615 */         from = (Int2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1627 */       if (Int2FloatAVLTreeMap.this.tree == null) {
/* 1628 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1632 */       if (this.bottom) {
/* 1633 */         e = Int2FloatAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1635 */         e = Int2FloatAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1637 */         if (Int2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1638 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1642 */       if (e == null || (!this.top && Int2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1643 */         return null; 
/* 1644 */       return e;
/*      */     }
/*      */ 
...
/*      */       Int2FloatAVLTreeMap.Entry e;
/* 1653 */       if (Int2FloatAVLTreeMap.this.tree == null) {
/* 1654 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1658 */       if (this.top) {
/* 1659 */         e = Int2FloatAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1661 */         e = Int2FloatAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1663 */         if (Int2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1664 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1668 */       if (e == null || (!this.bottom && Int2FloatAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1669 */         return null; 
/* 1670 */       return e;
/*      */     }
/*      */     
/*      */     public int firstIntKey() {
/* 1674 */       Int2FloatAVLTreeMap.Entry e = firstEntry();
/* 1675 */       if (e == null)
...
/*      */     
/*      */     public int lastIntKey() {
/* 1681 */       Int2FloatAVLTreeMap.Entry e = lastEntry();
/* 1682 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1697 */         this.next = Int2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1700 */         this();
/* 1701 */         if (this.next != null)
/* 1702 */           if (!Int2FloatAVLTreeMap.Submap.this.bottom && Int2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1703 */             this.prev = null;
/* 1704 */           } else if (!Int2FloatAVLTreeMap.Submap.this.top && Int2FloatAVLTreeMap.this.compare(k, (this.prev = Int2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1705 */             this.next = null;
/*      */           } else {
/* 1707 */             this.next = Int2FloatAVLTreeMap.this.locateKey(k);
/* 1708 */             if (Int2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1719 */         if (!Int2FloatAVLTreeMap.Submap.this.bottom && this.prev != null && Int2FloatAVLTreeMap.this.compare(this.prev.key, Int2FloatAVLTreeMap.Submap.this.from) < 0)
/* 1720 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1724 */         this.next = this.next.next();
/* 1725 */         if (!Int2FloatAVLTreeMap.Submap.this.top && this.next != null && Int2FloatAVLTreeMap.this.compare(this.next.key, Int2FloatAVLTreeMap.Submap.this.to) >= 0)
/* 1726 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1806 */       c = (Int2FloatAVLTreeMap)super.clone();
...
/* 1865 */       s.writeInt(e.key);
/* 1866 */       s.writeFloat(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1887 */     if (n == 1) {
/* 1888 */       Entry entry = new Entry(s.readInt(), s.readFloat());
...
/*      */ 
/*      */       
/* 1898 */       Entry entry = new Entry(s.readInt(), s.readFloat());
/* 1899 */       entry.right(new Entry(s.readInt(), s.readFloat()));
...
/* 1910 */     top.key = s.readInt();
/* 1911 */     top.value = s.readFloat();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2FloatAVLTreeMap.class
