...
/*      */   
/*      */   public boolean trim() {
/* 1115 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1116 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1117 */       return true; 
/*      */     try {
/* 1119 */       rehash(l);
...
/* 1148 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1149 */       return true; 
/*      */     try {
/* 1151 */       rehash(l);
...
/* 1172 */     int[] value = this.value;
/* 1173 */     int mask = newN - 1;
/* 1174 */     int[] newKey = new int[newN + 1];
/* 1175 */     int[] newValue = new int[newN + 1];
/* 1176 */     int i = this.n;
...
/*      */     try {
/* 1206 */       c = (Int2IntOpenCustomHashMap)super.clone();
...
/* 1214 */     c.key = (int[])this.key.clone();
/* 1215 */     c.value = (int[])this.value.clone();
...
/* 1261 */     int[] key = this.key = new int[this.n + 1];
/* 1262 */     int[] value = this.value = new int[this.n + 1];
/*      */ 
/*      */     
/* 1265 */     for (int i = this.size; i-- != 0; ) {
/* 1266 */       int pos, k = s.readInt();
/* 1267 */       int v = s.readInt();
/* 1268 */       if (this.strategy.equals(k, 0)) {
/* 1269 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2IntOpenCustomHashMap.class
