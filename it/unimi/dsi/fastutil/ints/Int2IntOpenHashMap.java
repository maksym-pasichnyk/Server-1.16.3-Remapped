...
/* 1132 */     int[] key = this.key;
/* 1133 */     int[] value = this.value;
/* 1134 */     int mask = newN - 1;
/* 1135 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1167 */       c = (Int2IntOpenHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2IntOpenHashMap.class
