...
/* 1822 */     int[] key = this.key;
/* 1823 */     float[] value = this.value;
/* 1824 */     int mask = newN - 1;
/* 1825 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1880 */       c = (Int2FloatLinkedOpenHashMap)super.clone();
...
/* 1935 */     int[] key = this.key = new int[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2FloatLinkedOpenHashMap.class
