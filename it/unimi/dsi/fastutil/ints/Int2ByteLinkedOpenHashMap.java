...
/* 1820 */     byte[] value = this.value;
/* 1821 */     int mask = newN - 1;
/* 1822 */     int[] newKey = new int[newN + 1];
/* 1823 */     byte[] newValue = new byte[newN + 1];
...
/*      */     try {
/* 1877 */       c = (Int2ByteLinkedOpenHashMap)super.clone();
...
/* 1886 */     c.value = (byte[])this.value.clone();
...
/* 1912 */       h += this.value[this.n]; 
/* 1913 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1916 */     int[] key = this.key;
/* 1917 */     byte[] value = this.value;
...
/* 1933 */     byte[] value = this.value = new byte[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ByteLinkedOpenHashMap.class
