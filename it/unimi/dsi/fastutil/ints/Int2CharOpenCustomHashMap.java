...
/*      */   
/*      */   public boolean trim() {
/* 1067 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1068 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1069 */       return true; 
/*      */     try {
/* 1071 */       rehash(l);
/* 1072 */     } catch (OutOfMemoryError cantDoIt) {
/* 1073 */       return false;
/*      */     } 
/* 1075 */     return true;
/*      */   }
...
/* 1100 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1101 */       return true; 
/*      */     try {
/* 1103 */       rehash(l);
...
/*      */     try {
/* 1158 */       c = (Int2CharOpenCustomHashMap)super.clone();
...
/* 1167 */     c.value = (char[])this.value.clone();
/* 1168 */     c.strategy = this.strategy;
/* 1169 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1185 */         i++; 
/* 1186 */       t = this.strategy.hashCode(this.key[i]);
/* 1187 */       t ^= this.value[i];
/* 1188 */       h += t;
/* 1189 */       i++;
/*      */     } 
...
/* 1214 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1217 */     for (int i = this.size; i-- != 0; ) {
/* 1218 */       int pos, k = s.readInt();
/* 1219 */       char v = s.readChar();
/* 1220 */       if (this.strategy.equals(k, 0)) {
/* 1221 */         pos = this.n;
/* 1222 */         this.containsNullKey = true;
/*      */       } else {
/* 1224 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2CharOpenCustomHashMap.class
