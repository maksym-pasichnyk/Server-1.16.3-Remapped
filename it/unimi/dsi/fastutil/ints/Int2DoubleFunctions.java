...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Int2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Int2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 161 */     return new Singleton(key.intValue(), value.doubleValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Int2DoubleFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractInt2DoubleFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2DoubleFunction function;
/*     */     
...
/* 462 */       Double v = this.function.apply(Integer.valueOf(key));
/* 463 */       if (v == null)
...
/* 505 */     if (f instanceof Int2DoubleFunction)
/* 506 */       return (Int2DoubleFunction)f; 
/* 507 */     if (f instanceof IntToDoubleFunction) {
/* 508 */       Objects.requireNonNull((IntToDoubleFunction)f); return (IntToDoubleFunction)f::applyAsDouble;
/* 509 */     }  return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleFunctions.class
