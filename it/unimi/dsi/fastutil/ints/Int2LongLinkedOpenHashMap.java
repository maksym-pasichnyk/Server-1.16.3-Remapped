...
/*  903 */     Long newValue = remappingFunction.apply(Integer.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  918 */     int pos = find(k);
/*  919 */     Long newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  996 */       return Int2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public long getLongValue() {
/* 1000 */       return Int2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public long setValue(long v) {
/* 1004 */       long oldValue = Int2LongLinkedOpenHashMap.this.value[this.index];
/* 1005 */       Int2LongLinkedOpenHashMap.this.value[this.index] = v;
...
/* 1016 */       return Integer.valueOf(Int2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       return Long.valueOf(Int2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1042 */         return false; 
/* 1043 */       Map.Entry<Integer, Long> e = (Map.Entry<Integer, Long>)o;
/* 1044 */       return (Int2LongLinkedOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue() && Int2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1048 */       return Int2LongLinkedOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Int2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1052 */       return Int2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Int2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */       this.next = Int2LongLinkedOpenHashMap.this.first;
/* 1216 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(int from) {
/* 1219 */       if (from == 0) {
/* 1220 */         if (Int2LongLinkedOpenHashMap.this.containsNullKey) {
/* 1221 */           this.next = (int)Int2LongLinkedOpenHashMap.this.link[Int2LongLinkedOpenHashMap.this.n];
/* 1222 */           this.prev = Int2LongLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1225 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1227 */       if (Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.last] == from) {
/* 1228 */         this.prev = Int2LongLinkedOpenHashMap.this.last;
/* 1229 */         this.index = Int2LongLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1233 */       int pos = HashCommon.mix(from) & Int2LongLinkedOpenHashMap.this.mask;
/*      */       
/* 1235 */       while (Int2LongLinkedOpenHashMap.this.key[pos] != 0) {
/* 1236 */         if (Int2LongLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1238 */           this.next = (int)Int2LongLinkedOpenHashMap.this.link[pos];
/* 1239 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1242 */         pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1259 */       if (this.next == -1) {
/* 1260 */         this.index = Int2LongLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1263 */       int pos = Int2LongLinkedOpenHashMap.this.first;
/* 1264 */       this.index = 1;
/* 1265 */       while (pos != this.prev) {
/* 1266 */         pos = (int)Int2LongLinkedOpenHashMap.this.link[pos];
/* 1267 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1292 */       this.prev = (int)(Int2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1307 */         this.index--;
/* 1308 */         this.prev = (int)(Int2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1310 */         this.next = (int)Int2LongLinkedOpenHashMap.this.link[this.curr];
/* 1311 */       }  Int2LongLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1316 */       if (this.prev == -1) {
/* 1317 */         Int2LongLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1319 */         Int2LongLinkedOpenHashMap.this.link[this.prev] = Int2LongLinkedOpenHashMap.this.link[this.prev] ^ (Int2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1320 */       }  if (this.next == -1) {
/* 1321 */         Int2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1323 */         Int2LongLinkedOpenHashMap.this.link[this.next] = Int2LongLinkedOpenHashMap.this.link[this.next] ^ (Int2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1324 */       }  int pos = this.curr;
/* 1325 */       this.curr = -1;
/* 1326 */       if (pos == Int2LongLinkedOpenHashMap.this.n) {
/* 1327 */         Int2LongLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1330 */         int[] key = Int2LongLinkedOpenHashMap.this.key;
/*      */         
/*      */         while (true) {
/*      */           int curr, last;
/* 1334 */           pos = (last = pos) + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1336 */             if ((curr = key[pos]) == 0) {
/* 1337 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1340 */             int slot = HashCommon.mix(curr) & Int2LongLinkedOpenHashMap.this.mask;
/* 1341 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1343 */             pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1345 */           key[last] = curr;
/* 1346 */           Int2LongLinkedOpenHashMap.this.value[last] = Int2LongLinkedOpenHashMap.this.value[pos];
/* 1347 */           if (this.next == pos)
/* 1348 */             this.next = last; 
/* 1349 */           if (this.prev == pos)
/* 1350 */             this.prev = last; 
/* 1351 */           Int2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/* 1383 */       return this.entry = new Int2LongLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     public EntryIterator() {}
/*      */     public Int2LongLinkedOpenHashMap.MapEntry previous() {
/* 1387 */       return this.entry = new Int2LongLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1391 */       super.remove();
...
/*      */   }
/*      */   
/* 1396 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Int2LongMap.Entry> { final Int2LongLinkedOpenHashMap.MapEntry entry = new Int2LongLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Int2LongMap.Entry> implements Int2LongSortedMap.FastSortedEntrySet { public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator() {
/* 1416 */       return (ObjectBidirectionalIterator<Int2LongMap.Entry>)new Int2LongLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     private MapEntrySet() {}
...
/* 1436 */       if (Int2LongLinkedOpenHashMap.this.size == 0)
/* 1437 */         throw new NoSuchElementException(); 
/* 1438 */       return new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Int2LongMap.Entry last() {
/* 1442 */       if (Int2LongLinkedOpenHashMap.this.size == 0)
/* 1443 */         throw new NoSuchElementException(); 
/* 1444 */       return new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1453 */         return false; 
/* 1454 */       if (e.getValue() == null || !(e.getValue() instanceof Long))
/* 1455 */         return false; 
/* 1456 */       int k = ((Integer)e.getKey()).intValue();
/* 1457 */       long v = ((Long)e.getValue()).longValue();
/* 1458 */       if (k == 0) {
/* 1459 */         return (Int2LongLinkedOpenHashMap.this.containsNullKey && Int2LongLinkedOpenHashMap.this.value[Int2LongLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1461 */       int[] key = Int2LongLinkedOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1464 */       if ((curr = key[pos = HashCommon.mix(k) & Int2LongLinkedOpenHashMap.this.mask]) == 0)
/* 1465 */         return false; 
/* 1466 */       if (k == curr) {
/* 1467 */         return (Int2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1470 */         if ((curr = key[pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask]) == 0)
/* 1471 */           return false; 
/* 1472 */         if (k == curr) {
/* 1473 */           return (Int2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1483 */         return false; 
/* 1484 */       if (e.getValue() == null || !(e.getValue() instanceof Long))
/* 1485 */         return false; 
/* 1486 */       int k = ((Integer)e.getKey()).intValue();
/* 1487 */       long v = ((Long)e.getValue()).longValue();
/* 1488 */       if (k == 0) {
/* 1489 */         if (Int2LongLinkedOpenHashMap.this.containsNullKey && Int2LongLinkedOpenHashMap.this.value[Int2LongLinkedOpenHashMap.this.n] == v) {
/* 1490 */           Int2LongLinkedOpenHashMap.this.removeNullEntry();
/* 1491 */           return true;
/*      */         } 
/* 1493 */         return false;
/*      */       } 
/*      */       
/* 1496 */       int[] key = Int2LongLinkedOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/* 1499 */       if ((curr = key[pos = HashCommon.mix(k) & Int2LongLinkedOpenHashMap.this.mask]) == 0)
/* 1500 */         return false; 
/* 1501 */       if (curr == k) {
/* 1502 */         if (Int2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1503 */           Int2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1504 */           return true;
/*      */         } 
/* 1506 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1509 */         if ((curr = key[pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask]) == 0)
/* 1510 */           return false; 
/* 1511 */         if (curr == k && 
/* 1512 */           Int2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1513 */           Int2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1514 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1521 */       return Int2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1525 */       Int2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1540 */       return new Int2LongLinkedOpenHashMap.EntryIterator(from.getIntKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1551 */       return new Int2LongLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1566 */       return new Int2LongLinkedOpenHashMap.FastEntryIterator(from.getIntKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2LongMap.Entry> consumer) {
/* 1571 */       for (int i = Int2LongLinkedOpenHashMap.this.size, next = Int2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1572 */         int curr = next;
/* 1573 */         next = (int)Int2LongLinkedOpenHashMap.this.link[curr];
/* 1574 */         consumer.accept(new AbstractInt2LongMap.BasicEntry(Int2LongLinkedOpenHashMap.this.key[curr], Int2LongLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2LongMap.Entry> consumer) {
/* 1580 */       AbstractInt2LongMap.BasicEntry entry = new AbstractInt2LongMap.BasicEntry();
/* 1581 */       for (int i = Int2LongLinkedOpenHashMap.this.size, next = Int2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1582 */         int curr = next;
/* 1583 */         next = (int)Int2LongLinkedOpenHashMap.this.link[curr];
/* 1584 */         entry.key = Int2LongLinkedOpenHashMap.this.key[curr];
/* 1585 */         entry.value = Int2LongLinkedOpenHashMap.this.value[curr];
...
/* 1611 */       return Int2LongLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
/*      */     
/*      */     public int nextInt() {
/* 1618 */       return Int2LongLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractIntSortedSet { private KeySet() {}
/*      */     
/*      */     public IntListIterator iterator(int from) {
/* 1624 */       return new Int2LongLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public IntListIterator iterator() {
/* 1628 */       return new Int2LongLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1633 */       if (Int2LongLinkedOpenHashMap.this.containsNullKey)
/* 1634 */         consumer.accept(Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.n]); 
/* 1635 */       for (int pos = Int2LongLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1636 */         int k = Int2LongLinkedOpenHashMap.this.key[pos];
/* 1637 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/* 1643 */       return Int2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(int k) {
/* 1647 */       return Int2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(int k) {
/* 1651 */       int oldSize = Int2LongLinkedOpenHashMap.this.size;
/* 1652 */       Int2LongLinkedOpenHashMap.this.remove(k);
/* 1653 */       return (Int2LongLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1657 */       Int2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public int firstInt() {
/* 1661 */       if (Int2LongLinkedOpenHashMap.this.size == 0)
/* 1662 */         throw new NoSuchElementException(); 
/* 1663 */       return Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public int lastInt() {
/* 1667 */       if (Int2LongLinkedOpenHashMap.this.size == 0)
/* 1668 */         throw new NoSuchElementException(); 
/* 1669 */       return Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public IntComparator comparator() {
/* 1673 */       return null;
...
/* 1706 */       return Int2LongLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1713 */       return Int2LongLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public LongCollection values() {
/* 1718 */     if (this.values == null)
/* 1719 */       this.values = (LongCollection)new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1722 */             return (LongIterator)new Int2LongLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1726 */             return Int2LongLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(long v) {
/* 1730 */             return Int2LongLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1734 */             Int2LongLinkedOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(LongConsumer consumer)
/*      */           {
/* 1739 */             if (Int2LongLinkedOpenHashMap.this.containsNullKey)
/* 1740 */               consumer.accept(Int2LongLinkedOpenHashMap.this.value[Int2LongLinkedOpenHashMap.this.n]); 
/* 1741 */             for (int pos = Int2LongLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1742 */               if (Int2LongLinkedOpenHashMap.this.key[pos] != 0)
/* 1743 */                 consumer.accept(Int2LongLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */   
/*      */   public boolean trim() {
/* 1763 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1764 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1765 */       return true; 
/*      */     try {
/* 1767 */       rehash(l);
/* 1768 */     } catch (OutOfMemoryError cantDoIt) {
/* 1769 */       return false;
/*      */     } 
/* 1771 */     return true;
/*      */   }
...
/* 1795 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1796 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1797 */       return true; 
/*      */     try {
/* 1799 */       rehash(l);
/* 1800 */     } catch (OutOfMemoryError cantDoIt) {
/* 1801 */       return false;
/*      */     } 
/* 1803 */     return true;
/*      */   }
...
/* 1819 */     int[] key = this.key;
/* 1820 */     long[] value = this.value;
/* 1821 */     int mask = newN - 1;
/* 1822 */     int[] newKey = new int[newN + 1];
/* 1823 */     long[] newValue = new long[newN + 1];
/* 1824 */     int i = this.first, prev = -1, newPrev = -1;
/* 1825 */     long[] link = this.link;
/* 1826 */     long[] newLink = new long[newN + 1];
/* 1827 */     this.first = -1;
/* 1828 */     for (int j = this.size; j-- != 0; ) {
/* 1829 */       int pos; if (key[i] == 0) {
/* 1830 */         pos = newN;
/*      */       } else {
/* 1832 */         pos = HashCommon.mix(key[i]) & mask;
/* 1833 */         while (newKey[pos] != 0)
/* 1834 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1836 */       newKey[pos] = key[i];
/* 1837 */       newValue[pos] = value[i];
/* 1838 */       if (prev != -1) {
/* 1839 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1840 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1841 */         newPrev = pos;
/*      */       } else {
/* 1843 */         newPrev = this.first = pos;
/*      */         
/* 1845 */         newLink[pos] = -1L;
/*      */       } 
/* 1847 */       int t = i;
...
/* 1849 */       prev = t;
/*      */     } 
/* 1851 */     this.link = newLink;
/* 1852 */     this.last = newPrev;
/* 1853 */     if (newPrev != -1)
/*      */     {
/* 1855 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1856 */     this.n = newN;
/* 1857 */     this.mask = mask;
/* 1858 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1859 */     this.key = newKey;
/* 1860 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1877 */       c = (Int2LongLinkedOpenHashMap)super.clone();
/* 1878 */     } catch (CloneNotSupportedException cantHappen) {
/* 1879 */       throw new InternalError();
/*      */     } 
/* 1881 */     c.keys = null;
/* 1882 */     c.values = null;
/* 1883 */     c.entries = null;
/* 1884 */     c.containsNullKey = this.containsNullKey;
/* 1885 */     c.key = (int[])this.key.clone();
/* 1886 */     c.value = (long[])this.value.clone();
/* 1887 */     c.link = (long[])this.link.clone();
/* 1888 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1901 */     int h = 0;
/* 1902 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1903 */       while (this.key[i] == 0)
/* 1904 */         i++; 
/* 1905 */       t = this.key[i];
/* 1906 */       t ^= HashCommon.long2int(this.value[i]);
/* 1907 */       h += t;
/* 1908 */       i++;
/*      */     } 
/*      */     
/* 1911 */     if (this.containsNullKey)
/* 1912 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1913 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1916 */     int[] key = this.key;
/* 1917 */     long[] value = this.value;
/* 1918 */     MapIterator i = new MapIterator();
/* 1919 */     s.defaultWriteObject();
/* 1920 */     for (int j = this.size; j-- != 0; ) {
/* 1921 */       int e = i.nextEntry();
/* 1922 */       s.writeInt(key[e]);
/* 1923 */       s.writeLong(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1928 */     s.defaultReadObject();
/* 1929 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1930 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1931 */     this.mask = this.n - 1;
/* 1932 */     int[] key = this.key = new int[this.n + 1];
/* 1933 */     long[] value = this.value = new long[this.n + 1];
/* 1934 */     long[] link = this.link = new long[this.n + 1];
/* 1935 */     int prev = -1;
/* 1936 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1939 */     for (int i = this.size; i-- != 0; ) {
/* 1940 */       int pos, k = s.readInt();
/* 1941 */       long v = s.readLong();
/* 1942 */       if (k == 0) {
/* 1943 */         pos = this.n;
/* 1944 */         this.containsNullKey = true;
/*      */       } else {
/* 1946 */         pos = HashCommon.mix(k) & this.mask;
/* 1947 */         while (key[pos] != 0)
/* 1948 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1950 */       key[pos] = k;
/* 1951 */       value[pos] = v;
/* 1952 */       if (this.first != -1) {
/* 1953 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1954 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1955 */         prev = pos; continue;
/*      */       } 
/* 1957 */       prev = this.first = pos;
/*      */       
/* 1959 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1962 */     this.last = prev;
/* 1963 */     if (prev != -1)
/*      */     {
/* 1965 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2LongLinkedOpenHashMap.class
