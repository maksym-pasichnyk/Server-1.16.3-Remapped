...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Int2ShortFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Int2ShortFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 161 */     return new Singleton(key.intValue(), value.shortValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Int2ShortFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractInt2ShortFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2ShortFunction function;
/*     */     
...
/* 462 */       Short v = this.function.apply(Integer.valueOf(key));
/* 463 */       if (v == null)
...
/* 505 */     if (f instanceof Int2ShortFunction)
/* 506 */       return (Int2ShortFunction)f; 
/* 507 */     if (f instanceof IntUnaryOperator) {
/* 508 */       return key -> SafeMath.safeIntToShort(((IntUnaryOperator)f).applyAsInt(key));
/*     */     }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ShortFunctions.class
