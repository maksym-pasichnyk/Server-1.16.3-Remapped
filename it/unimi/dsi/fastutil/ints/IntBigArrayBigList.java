...
/* 130 */     this(a, 0L, IntBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 151 */     this(length);
/* 152 */     IntBigArrays.copy(a, offset, this.a, 0L, length);
...
/* 213 */     return wrap(a, IntBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       return; 
/* 226 */     this.a = IntBigArrays.forceCapacity(this.a, capacity, this.size);
/* 227 */     assert this.size <= IntBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 239 */     long oldLength = IntBigArrays.length(this.a);
...
/* 245 */       capacity = 10L;
/* 246 */     }  this.a = IntBigArrays.forceCapacity(this.a, capacity, this.size);
/* 247 */     assert this.size <= IntBigArrays.length(this.a);
/*     */   }
/*     */   
...
/* 254 */       IntBigArrays.copy(this.a, index, this.a, index + 1L, this.size - index); 
/* 255 */     IntBigArrays.set(this.a, index, k);
/* 256 */     this.size++;
/* 257 */     assert this.size <= IntBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public boolean add(int k) {
/* 261 */     grow(this.size + 1L);
/* 262 */     IntBigArrays.set(this.a, this.size++, k);
/* 263 */     if (!$assertionsDisabled && this.size > IntBigArrays.length(this.a)) throw new AssertionError(); 
/* 264 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 271 */     return IntBigArrays.get(this.a, index);
/*     */   }
/*     */   
/*     */   public long indexOf(int k) {
/* 275 */     for (long i = 0L; i < this.size; i++) {
/* 276 */       if (k == IntBigArrays.get(this.a, i))
/* 277 */         return i; 
/* 278 */     }  return -1L;
/*     */   }
/*     */   
...
/* 283 */       if (k == IntBigArrays.get(this.a, i))
/* 284 */         return i; 
/* 285 */     }  return -1L;
/*     */   }
/*     */   
...
/*     */     }
/* 292 */     int old = IntBigArrays.get(this.a, index);
/* 293 */     this.size--;
/* 294 */     if (index != this.size)
/* 295 */       IntBigArrays.copy(this.a, index + 1L, this.a, index, this.size - index); 
/* 296 */     assert this.size <= IntBigArrays.length(this.a);
/* 297 */     return old;
/*     */   }
/*     */   
...
/* 303 */       return false; 
/* 304 */     removeInt(index);
/* 305 */     assert this.size <= IntBigArrays.length(this.a);
/* 306 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 313 */     int old = IntBigArrays.get(this.a, index);
/* 314 */     IntBigArrays.set(this.a, index, k);
/* 315 */     return old;
/*     */   }
/*     */   
...
/*     */   public void clear() {
/* 365 */     this.size = 0L;
/* 366 */     assert this.size <= IntBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public long size64() {
...
/* 374 */     if (size > IntBigArrays.length(this.a))
/* 375 */       ensureCapacity(size); 
/* 376 */     if (size > this.size)
/* 377 */       IntBigArrays.fill(this.a, this.size, size, 0); 
/* 378 */     this.size = size;
/*     */   }
/*     */   
...
/* 410 */     long arrayLength = IntBigArrays.length(this.a);
/* 411 */     if (n >= arrayLength || this.size == arrayLength)
/*     */       return; 
/* 413 */     this.a = IntBigArrays.trim(this.a, Math.max(n, this.size));
/* 414 */     assert this.size <= IntBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 432 */     IntBigArrays.copy(this.a, from, a, offset, length);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 445 */     IntBigArrays.copy(this.a, to, this.a, from, this.size - to);
...
/* 463 */     IntBigArrays.ensureOffsetLength(a, offset, length);
/* 464 */     grow(this.size + length);
/* 465 */     IntBigArrays.copy(this.a, index, this.a, index + length, this.size - index);
/* 466 */     IntBigArrays.copy(a, offset, this.a, index, length);
...
/* 486 */           return IntBigArrays.get(IntBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public int previousInt() {
/* 490 */           if (!hasPrevious())
/* 491 */             throw new NoSuchElementException(); 
/* 492 */           return IntBigArrays.get(IntBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 531 */     IntBigArrays.copy(this.a, 0L, c.a, 0L, this.size);
...
/* 554 */     int[][] a2 = l.a;
/* 555 */     while (s-- != 0L) {
/* 556 */       if (IntBigArrays.get(a1, s) != IntBigArrays.get(a2, s))
/* 557 */         return false; 
/* 558 */     }  return true;
/*     */   }
/*     */ 
...
/* 579 */       int e1 = IntBigArrays.get(a1, i);
/* 580 */       int e2 = IntBigArrays.get(a2, i); int r;
...
/* 589 */       s.writeInt(IntBigArrays.get(this.a, i)); 
/*     */   }
/*     */   
...
/* 596 */       IntBigArrays.set(this.a, i, s.readInt()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\IntBigArrayBigList.class
