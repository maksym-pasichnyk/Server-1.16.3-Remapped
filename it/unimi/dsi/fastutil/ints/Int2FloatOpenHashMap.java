...
/*  548 */     Float newValue = remappingFunction.apply(Integer.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  563 */     int pos = find(k);
/*  564 */     Float newValue = remappingFunction.apply(Integer.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  640 */       return Int2FloatOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public float getFloatValue() {
/*  644 */       return Int2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public float setValue(float v) {
/*  648 */       float oldValue = Int2FloatOpenHashMap.this.value[this.index];
/*  649 */       Int2FloatOpenHashMap.this.value[this.index] = v;
/*  650 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  660 */       return Integer.valueOf(Int2FloatOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  670 */       return Float.valueOf(Int2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */         return false; 
/*  687 */       Map.Entry<Integer, Float> e = (Map.Entry<Integer, Float>)o;
/*  688 */       return (Int2FloatOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue() && 
/*  689 */         Float.floatToIntBits(Int2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  693 */       return Int2FloatOpenHashMap.this.key[this.index] ^ HashCommon.float2int(Int2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/*  697 */       return Int2FloatOpenHashMap.this.key[this.index] + "=>" + Int2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  707 */     int pos = Int2FloatOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  714 */     int last = -1;
/*      */     
/*  716 */     int c = Int2FloatOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  720 */     boolean mustReturnNullKey = Int2FloatOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  735 */         return this.last = Int2FloatOpenHashMap.this.n;
/*      */       } 
/*  737 */       int[] key = Int2FloatOpenHashMap.this.key;
/*      */       while (true) {
/*  739 */         if (--this.pos < 0) {
/*      */           
/*  741 */           this.last = Integer.MIN_VALUE;
/*  742 */           int k = this.wrapped.getInt(-this.pos - 1);
/*  743 */           int p = HashCommon.mix(k) & Int2FloatOpenHashMap.this.mask;
/*  744 */           while (k != key[p])
/*  745 */             p = p + 1 & Int2FloatOpenHashMap.this.mask; 
/*  746 */           return p;
/*      */         } 
...
/*  763 */       int[] key = Int2FloatOpenHashMap.this.key; while (true) {
/*      */         int curr, last;
/*  765 */         pos = (last = pos) + 1 & Int2FloatOpenHashMap.this.mask;
/*      */         while (true) {
/*  767 */           if ((curr = key[pos]) == 0) {
/*  768 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  771 */           int slot = HashCommon.mix(curr) & Int2FloatOpenHashMap.this.mask;
/*  772 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  774 */           pos = pos + 1 & Int2FloatOpenHashMap.this.mask;
/*      */         } 
/*  776 */         if (pos < last) {
...
/*      */         } 
/*  781 */         key[last] = curr;
/*  782 */         Int2FloatOpenHashMap.this.value[last] = Int2FloatOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  786 */       if (this.last == -1)
/*  787 */         throw new IllegalStateException(); 
/*  788 */       if (this.last == Int2FloatOpenHashMap.this.n) {
/*  789 */         Int2FloatOpenHashMap.this.containsNullKey = false;
/*  790 */       } else if (this.pos >= 0) {
/*  791 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  794 */         Int2FloatOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 1));
/*  795 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  798 */       Int2FloatOpenHashMap.this.size--;
/*  799 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Int2FloatMap.Entry> { private Int2FloatOpenHashMap.MapEntry entry;
/*      */     
/*      */     public Int2FloatOpenHashMap.MapEntry next() {
/*  814 */       return this.entry = new Int2FloatOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  823 */       this.entry = new Int2FloatOpenHashMap.MapEntry();
...
/*  833 */       return new Int2FloatOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Int2FloatMap.Entry> fastIterator() {
/*  837 */       return new Int2FloatOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  851 */       if (k == 0) {
/*  852 */         return (Int2FloatOpenHashMap.this.containsNullKey && 
/*  853 */           Float.floatToIntBits(Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       }
/*  855 */       int[] key = Int2FloatOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/*  858 */       if ((curr = key[pos = HashCommon.mix(k) & Int2FloatOpenHashMap.this.mask]) == 0)
/*  859 */         return false; 
/*  860 */       if (k == curr) {
/*  861 */         return (Float.floatToIntBits(Int2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       }
/*      */       while (true) {
/*  864 */         if ((curr = key[pos = pos + 1 & Int2FloatOpenHashMap.this.mask]) == 0)
/*  865 */           return false; 
/*  866 */         if (k == curr) {
/*  867 */           return (Float.floatToIntBits(Int2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  876 */       if (e.getKey() == null || !(e.getKey() instanceof Integer))
/*  877 */         return false; 
/*  878 */       if (e.getValue() == null || !(e.getValue() instanceof Float))
/*  879 */         return false; 
/*  880 */       int k = ((Integer)e.getKey()).intValue();
/*  881 */       float v = ((Float)e.getValue()).floatValue();
/*  882 */       if (k == 0) {
/*  883 */         if (Int2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
/*  884 */           Int2FloatOpenHashMap.this.removeNullEntry();
/*  885 */           return true;
/*      */         } 
/*  887 */         return false;
/*      */       } 
/*      */       
/*  890 */       int[] key = Int2FloatOpenHashMap.this.key;
/*      */       
/*      */       int curr, pos;
/*  893 */       if ((curr = key[pos = HashCommon.mix(k) & Int2FloatOpenHashMap.this.mask]) == 0)
/*  894 */         return false; 
/*  895 */       if (curr == k) {
/*  896 */         if (Float.floatToIntBits(Int2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/*  897 */           Int2FloatOpenHashMap.this.removeEntry(pos);
/*  898 */           return true;
/*      */         } 
/*  900 */         return false;
/*      */       } 
/*      */       while (true) {
/*  903 */         if ((curr = key[pos = pos + 1 & Int2FloatOpenHashMap.this.mask]) == 0)
/*  904 */           return false; 
/*  905 */         if (curr == k && 
/*  906 */           Float.floatToIntBits(Int2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/*  907 */           Int2FloatOpenHashMap.this.removeEntry(pos);
/*  908 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  915 */       return Int2FloatOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  919 */       Int2FloatOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
/*  924 */       if (Int2FloatOpenHashMap.this.containsNullKey)
/*  925 */         consumer.accept(new AbstractInt2FloatMap.BasicEntry(Int2FloatOpenHashMap.this.key[Int2FloatOpenHashMap.this.n], Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n])); 
/*  926 */       for (int pos = Int2FloatOpenHashMap.this.n; pos-- != 0;) {
/*  927 */         if (Int2FloatOpenHashMap.this.key[pos] != 0)
/*  928 */           consumer.accept(new AbstractInt2FloatMap.BasicEntry(Int2FloatOpenHashMap.this.key[pos], Int2FloatOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Int2FloatMap.Entry> consumer) {
/*  933 */       AbstractInt2FloatMap.BasicEntry entry = new AbstractInt2FloatMap.BasicEntry();
/*  934 */       if (Int2FloatOpenHashMap.this.containsNullKey) {
/*  935 */         entry.key = Int2FloatOpenHashMap.this.key[Int2FloatOpenHashMap.this.n];
/*  936 */         entry.value = Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n];
/*  937 */         consumer.accept(entry);
/*      */       } 
/*  939 */       for (int pos = Int2FloatOpenHashMap.this.n; pos-- != 0;) {
/*  940 */         if (Int2FloatOpenHashMap.this.key[pos] != 0) {
/*  941 */           entry.key = Int2FloatOpenHashMap.this.key[pos];
/*  942 */           entry.value = Int2FloatOpenHashMap.this.value[pos];
...
/*      */   {
/*      */     public int nextInt() {
/*  968 */       return Int2FloatOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractIntSet { private KeySet() {}
/*      */     
/*      */     public IntIterator iterator() {
/*  974 */       return new Int2FloatOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  979 */       if (Int2FloatOpenHashMap.this.containsNullKey)
/*  980 */         consumer.accept(Int2FloatOpenHashMap.this.key[Int2FloatOpenHashMap.this.n]); 
/*  981 */       for (int pos = Int2FloatOpenHashMap.this.n; pos-- != 0; ) {
/*  982 */         int k = Int2FloatOpenHashMap.this.key[pos];
/*  983 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/*  989 */       return Int2FloatOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(int k) {
/*  993 */       return Int2FloatOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(int k) {
/*  997 */       int oldSize = Int2FloatOpenHashMap.this.size;
/*  998 */       Int2FloatOpenHashMap.this.remove(k);
/*  999 */       return (Int2FloatOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1003 */       Int2FloatOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1027 */       return Int2FloatOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1036 */             return new Int2FloatOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1040 */             return Int2FloatOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(float v) {
/* 1044 */             return Int2FloatOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1048 */             Int2FloatOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(DoubleConsumer consumer)
/*      */           {
/* 1053 */             if (Int2FloatOpenHashMap.this.containsNullKey)
/* 1054 */               consumer.accept(Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n]); 
/* 1055 */             for (int pos = Int2FloatOpenHashMap.this.n; pos-- != 0;) {
/* 1056 */               if (Int2FloatOpenHashMap.this.key[pos] != 0)
/* 1057 */                 consumer.accept(Int2FloatOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1133 */     int[] key = this.key;
/* 1134 */     float[] value = this.value;
/* 1135 */     int mask = newN - 1;
/* 1136 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1168 */       c = (Int2FloatOpenHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2FloatOpenHashMap.class
