...
/* 1171 */     byte[] value = this.value;
/* 1172 */     int mask = newN - 1;
/* 1173 */     int[] newKey = new int[newN + 1];
/* 1174 */     byte[] newValue = new byte[newN + 1];
/* 1175 */     int i = this.n;
...
/*      */     try {
/* 1205 */       c = (Int2ByteOpenCustomHashMap)super.clone();
...
/* 1214 */     c.value = (byte[])this.value.clone();
...
/* 1261 */     byte[] value = this.value = new byte[this.n + 1];
/*      */ 
/*      */     
/* 1264 */     for (int i = this.size; i-- != 0; ) {
/* 1265 */       int pos, k = s.readInt();
/* 1266 */       byte v = s.readByte();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\Int2ByteOpenCustomHashMap.class
