...
/* 598 */     int[] key = this.key;
/* 599 */     int mask = newN - 1;
/* 600 */     int[] newKey = new int[newN + 1];
/* 601 */     int i = this.n;
...
/* 669 */     int[] key = this.key = new int[this.n + 1];
/*     */     
/* 671 */     for (int i = this.size; i-- != 0; ) {
/* 672 */       int pos, k = s.readInt();
/* 673 */       if (k == 0) {
/* 674 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\ints\IntOpenHashSet.class
