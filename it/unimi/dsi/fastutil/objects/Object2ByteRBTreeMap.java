...
/*  273 */     Entry<K> e = add(k);
/*  274 */     byte oldValue = e.value;
/*  275 */     e.value = (byte)(e.value + incr);
/*  276 */     return oldValue;
/*      */   }
/*      */   
/*      */   public byte put(K k, byte v) {
/*  280 */     Entry<K> e = add(k);
/*  281 */     byte oldValue = e.value;
/*  282 */     e.value = v;
/*  283 */     return oldValue;
/*      */   }
/*      */ 
...
/*  913 */         return false; 
/*  914 */       Map.Entry<K, Byte> e = (Map.Entry<K, Byte>)o;
/*  915 */       return (Objects.equals(this.key, e.getKey()) && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1001 */     int index = 0;
/*      */     TreeIterator() {
/* 1003 */       this.next = Object2ByteRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(K k) {
/* 1006 */       if ((this.next = Object2ByteRBTreeMap.this.locateKey(k)) != null)
/* 1007 */         if (Object2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1058 */       updatePrevious();
/* 1059 */       updateNext();
/* 1060 */       Object2ByteRBTreeMap.this.removeByte(this.curr.key);
/* 1061 */       this.curr = null;
/*      */     }
...
/* 1100 */       this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ByteMap.Entry<Object2ByteMap.Entry<K>>>()
/*      */         {
...
/* 1109 */             return new Object2ByteRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator(Object2ByteMap.Entry<K> from) {
/* 1114 */             return new Object2ByteRBTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1122 */             if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1123 */               return false; 
/* 1124 */             Object2ByteRBTreeMap.Entry<K> f = Object2ByteRBTreeMap.this.findKey((K)e.getKey());
...
/* 1134 */               return false; 
/* 1135 */             Object2ByteRBTreeMap.Entry<K> f = Object2ByteRBTreeMap.this.findKey((K)e.getKey());
/* 1136 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue())
/* 1137 */               return false; 
/* 1138 */             Object2ByteRBTreeMap.this.removeByte(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Object2ByteRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Object2ByteRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Object2ByteMap.Entry<K> first() {
/* 1151 */             return Object2ByteRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Object2ByteMap.Entry<K> last() {
/* 1155 */             return Object2ByteRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> from, Object2ByteMap.Entry<K> to) {
/* 1160 */             return Object2ByteRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> to) {
/* 1164 */             return Object2ByteRBTreeMap.this.headMap(to.getKey()).object2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2ByteMap.Entry<K>> tailSet(Object2ByteMap.Entry<K> from) {
/* 1168 */             return Object2ByteRBTreeMap.this.tailMap(from.getKey()).object2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1202 */       return new Object2ByteRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1206 */       return new Object2ByteRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1261 */             return (ByteIterator)new Object2ByteRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(byte k) {
/* 1265 */             return Object2ByteRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1269 */             return Object2ByteRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1273 */             Object2ByteRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1336 */       if (!bottom && !top && Object2ByteRBTreeMap.this.compare(from, to) > 0)
/* 1337 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1338 */       this.from = from;
/* 1339 */       this.bottom = bottom;
/* 1340 */       this.to = to;
/* 1341 */       this.top = top;
/* 1342 */       this.defRetValue = Object2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1360 */       return ((this.bottom || Object2ByteRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2ByteRBTreeMap.this
/* 1361 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
/* 1365 */       if (this.entries == null)
/* 1366 */         this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ByteMap.Entry<Object2ByteMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator() {
/* 1369 */               return new Object2ByteRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator(Object2ByteMap.Entry<K> from) {
/* 1374 */               return new Object2ByteRBTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Object2ByteMap.Entry<K>> comparator() {
/* 1378 */               return Object2ByteRBTreeMap.this.object2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Object2ByteRBTreeMap.Entry<K> f = Object2ByteRBTreeMap.this.findKey((K)e.getKey());
/* 1389 */               return (f != null && Object2ByteRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1397 */               if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1398 */                 return false; 
/* 1399 */               Object2ByteRBTreeMap.Entry<K> f = Object2ByteRBTreeMap.this.findKey((K)e.getKey());
/* 1400 */               if (f != null && Object2ByteRBTreeMap.Submap.this.in(f.key))
/* 1401 */                 Object2ByteRBTreeMap.Submap.this.removeByte(f.key); 
/* 1402 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1413 */               return !(new Object2ByteRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1417 */               Object2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Object2ByteMap.Entry<K> first() {
/* 1421 */               return Object2ByteRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Object2ByteMap.Entry<K> last() {
/* 1425 */               return Object2ByteRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> from, Object2ByteMap.Entry<K> to) {
/* 1430 */               return Object2ByteRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> to) {
/* 1434 */               return Object2ByteRBTreeMap.Submap.this.headMap(to.getKey()).object2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2ByteMap.Entry<K>> tailSet(Object2ByteMap.Entry<K> from) {
/* 1438 */               return Object2ByteRBTreeMap.Submap.this.tailMap(from.getKey()).object2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractObject2ByteSortedMap<K>.KeySet {
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1446 */         return new Object2ByteRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1450 */         return new Object2ByteRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<K> keySet() {
...
/* 1462 */         this.values = (ByteCollection)new AbstractByteCollection()
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1465 */               return (ByteIterator)new Object2ByteRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(byte k) {
/* 1469 */               return Object2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1473 */               return Object2ByteRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1477 */               Object2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(Object k) {
/* 1485 */       return (in((K)k) && Object2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/* 1492 */         byte ev = (i.nextEntry()).value;
/* 1493 */         if (ev == v)
/* 1494 */           return true; 
/*      */       } 
/* 1496 */       return false;
...
/*      */     
/*      */     public byte getByte(Object k) {
/* 1502 */       K kk = (K)k; Object2ByteRBTreeMap.Entry<K> e;
/* 1503 */       return (in(kk) && (e = Object2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public byte put(K k, byte v) {
/* 1507 */       Object2ByteRBTreeMap.this.modified = false;
/* 1508 */       if (!in(k))
...
/* 1511 */       byte oldValue = Object2ByteRBTreeMap.this.put(k, v);
/* 1512 */       return Object2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte removeByte(Object k) {
/* 1517 */       Object2ByteRBTreeMap.this.modified = false;
/* 1518 */       if (!in((K)k))
/* 1519 */         return this.defRetValue; 
/* 1520 */       byte oldValue = Object2ByteRBTreeMap.this.removeByte(k);
/* 1521 */       return Object2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1539 */       return Object2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Object2ByteSortedMap<K> headMap(K to) {
/* 1543 */       if (this.top)
/* 1544 */         return new Submap(this.from, this.bottom, to, false); 
/* 1545 */       return (Object2ByteRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Object2ByteSortedMap<K> tailMap(K from) {
/* 1549 */       if (this.bottom)
/* 1550 */         return new Submap(from, false, this.to, this.top); 
/* 1551 */       return (Object2ByteRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Object2ByteSortedMap<K> subMap(K from, K to) {
...
/* 1557 */       if (!this.top)
/* 1558 */         to = (Object2ByteRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1559 */       if (!this.bottom)
/* 1560 */         from = (Object2ByteRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1572 */       if (Object2ByteRBTreeMap.this.tree == null) {
/* 1573 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1577 */       if (this.bottom) {
/* 1578 */         e = Object2ByteRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1580 */         e = Object2ByteRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1582 */         if (Object2ByteRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1583 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1587 */       if (e == null || (!this.top && Object2ByteRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1588 */         return null; 
/* 1589 */       return e;
/*      */     }
/*      */ 
...
/*      */       Object2ByteRBTreeMap.Entry<K> e;
/* 1598 */       if (Object2ByteRBTreeMap.this.tree == null) {
/* 1599 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1603 */       if (this.top) {
/* 1604 */         e = Object2ByteRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1606 */         e = Object2ByteRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1608 */         if (Object2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1609 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1613 */       if (e == null || (!this.bottom && Object2ByteRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1614 */         return null; 
/* 1615 */       return e;
/*      */     }
/*      */     
/*      */     public K firstKey() {
/* 1619 */       Object2ByteRBTreeMap.Entry<K> e = firstEntry();
/* 1620 */       if (e == null)
...
/*      */     
/*      */     public K lastKey() {
/* 1626 */       Object2ByteRBTreeMap.Entry<K> e = lastEntry();
/* 1627 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1642 */         this.next = Object2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(K k) {
/* 1645 */         this();
/* 1646 */         if (this.next != null)
/* 1647 */           if (!Object2ByteRBTreeMap.Submap.this.bottom && Object2ByteRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1648 */             this.prev = null;
/* 1649 */           } else if (!Object2ByteRBTreeMap.Submap.this.top && Object2ByteRBTreeMap.this.compare(k, (this.prev = Object2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1650 */             this.next = null;
/*      */           } else {
/* 1652 */             this.next = Object2ByteRBTreeMap.this.locateKey(k);
/* 1653 */             if (Object2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1664 */         if (!Object2ByteRBTreeMap.Submap.this.bottom && this.prev != null && Object2ByteRBTreeMap.this.compare(this.prev.key, Object2ByteRBTreeMap.Submap.this.from) < 0)
/* 1665 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Object2ByteRBTreeMap.Submap.this.top && this.next != null && Object2ByteRBTreeMap.this.compare(this.next.key, Object2ByteRBTreeMap.Submap.this.to) >= 0)
/* 1671 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1753 */       c = (Object2ByteRBTreeMap<K>)super.clone();
...
/* 1834 */     if (n == 1) {
/* 1835 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readByte());
...
/*      */ 
/*      */       
/* 1846 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readByte());
/* 1847 */       entry.black(true);
/* 1848 */       entry.right(new Entry<>((K)s.readObject(), s.readByte()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ByteRBTreeMap.class
