...
/*      */       } 
/*  393 */     }  this.key[pos] = k;
/*  394 */     this.value[pos] = (byte)(this.defRetValue + incr);
/*  395 */     if (this.size == 0) {
...
/*  463 */     byte oldValue = this.value[pos];
...
/*  871 */     byte oldValue = this.value[pos];
...
/*  882 */     byte newValue = SafeMath.safeIntToByte(mappingFunction.applyAsInt(k));
...
/*  894 */     Byte newValue = remappingFunction.apply(k, Byte.valueOf(this.value[pos]));
...
/*      */     } 
/*  902 */     this.value[pos] = newValue.byteValue(); return newValue.byteValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  909 */     int pos = find(k);
/*  910 */     Byte newValue = remappingFunction.apply(k, (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  920 */     byte newVal = newValue.byteValue();
/*  921 */     if (pos < 0) {
...
/*  935 */       return v;
/*      */     } 
/*  937 */     Byte newValue = remappingFunction.apply(Byte.valueOf(this.value[pos]), Byte.valueOf(v));
...
/*      */     } 
/*  945 */     this.value[pos] = newValue.byteValue(); return newValue.byteValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  987 */       return Reference2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/*  991 */       return Reference2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/*  995 */       byte oldValue = Reference2ByteLinkedOpenHashMap.this.value[this.index];
/*  996 */       Reference2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  997 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/* 1007 */       return Byte.valueOf(Reference2ByteLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte setValue(Byte v) {
/* 1017 */       return Byte.valueOf(setValue(v.byteValue()));
/*      */     }
/*      */ 
/*      */     
...
/* 1023 */         return false; 
/* 1024 */       Map.Entry<K, Byte> e = (Map.Entry<K, Byte>)o;
/* 1025 */       return (Reference2ByteLinkedOpenHashMap.this.key[this.index] == e.getKey() && Reference2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1029 */       return System.identityHashCode(Reference2ByteLinkedOpenHashMap.this.key[this.index]) ^ Reference2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1033 */       return (new StringBuilder()).append(Reference2ByteLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2ByteLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1196 */       this.next = Reference2ByteLinkedOpenHashMap.this.first;
/* 1197 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(K from) {
/* 1200 */       if (from == null) {
/* 1201 */         if (Reference2ByteLinkedOpenHashMap.this.containsNullKey) {
/* 1202 */           this.next = (int)Reference2ByteLinkedOpenHashMap.this.link[Reference2ByteLinkedOpenHashMap.this.n];
/* 1203 */           this.prev = Reference2ByteLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1206 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1208 */       if (Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.last] == from) {
/* 1209 */         this.prev = Reference2ByteLinkedOpenHashMap.this.last;
/* 1210 */         this.index = Reference2ByteLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1214 */       int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */       
/* 1216 */       while (Reference2ByteLinkedOpenHashMap.this.key[pos] != null) {
/* 1217 */         if (Reference2ByteLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1219 */           this.next = (int)Reference2ByteLinkedOpenHashMap.this.link[pos];
/* 1220 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1223 */         pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1240 */       if (this.next == -1) {
/* 1241 */         this.index = Reference2ByteLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1244 */       int pos = Reference2ByteLinkedOpenHashMap.this.first;
/* 1245 */       this.index = 1;
/* 1246 */       while (pos != this.prev) {
/* 1247 */         pos = (int)Reference2ByteLinkedOpenHashMap.this.link[pos];
/* 1248 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1263 */       this.next = (int)Reference2ByteLinkedOpenHashMap.this.link[this.curr];
...
/* 1273 */       this.prev = (int)(Reference2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1288 */         this.index--;
/* 1289 */         this.prev = (int)(Reference2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1291 */         this.next = (int)Reference2ByteLinkedOpenHashMap.this.link[this.curr];
/* 1292 */       }  Reference2ByteLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1297 */       if (this.prev == -1) {
/* 1298 */         Reference2ByteLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1300 */         Reference2ByteLinkedOpenHashMap.this.link[this.prev] = Reference2ByteLinkedOpenHashMap.this.link[this.prev] ^ (Reference2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1301 */       }  if (this.next == -1) {
/* 1302 */         Reference2ByteLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1304 */         Reference2ByteLinkedOpenHashMap.this.link[this.next] = Reference2ByteLinkedOpenHashMap.this.link[this.next] ^ (Reference2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1305 */       }  int pos = this.curr;
/* 1306 */       this.curr = -1;
/* 1307 */       if (pos == Reference2ByteLinkedOpenHashMap.this.n) {
/* 1308 */         Reference2ByteLinkedOpenHashMap.this.containsNullKey = false;
/* 1309 */         Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1312 */         K[] key = Reference2ByteLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           K curr;
/*      */           int last;
/* 1316 */           pos = (last = pos) + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1318 */             if ((curr = key[pos]) == null) {
/* 1319 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1322 */             int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ByteLinkedOpenHashMap.this.mask;
/* 1323 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1325 */             pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1327 */           key[last] = curr;
/* 1328 */           Reference2ByteLinkedOpenHashMap.this.value[last] = Reference2ByteLinkedOpenHashMap.this.value[pos];
/* 1329 */           if (this.next == pos)
/* 1330 */             this.next = last; 
/* 1331 */           if (this.prev == pos)
/* 1332 */             this.prev = last; 
/* 1333 */           Reference2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Reference2ByteMap.Entry<K>> { private Reference2ByteLinkedOpenHashMap<K>.MapEntry entry;
/*      */     
...
/* 1365 */       return this.entry = new Reference2ByteLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Reference2ByteLinkedOpenHashMap<K>.MapEntry previous() {
/* 1369 */       return this.entry = new Reference2ByteLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1373 */       super.remove();
...
/*      */ 
/*      */   
/* 1378 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Reference2ByteMap.Entry<K>> { final Reference2ByteLinkedOpenHashMap<K>.MapEntry entry = new Reference2ByteLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ByteMap.Entry<K>> implements Reference2ByteSortedMap.FastSortedEntrySet<K> { private MapEntrySet() {}
/*      */     
/*      */     public ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> iterator() {
/* 1400 */       return new Reference2ByteLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     
...
/* 1421 */       if (Reference2ByteLinkedOpenHashMap.this.size == 0)
/* 1422 */         throw new NoSuchElementException(); 
/* 1423 */       return new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Reference2ByteMap.Entry<K> last() {
/* 1427 */       if (Reference2ByteLinkedOpenHashMap.this.size == 0)
/* 1428 */         throw new NoSuchElementException(); 
/* 1429 */       return new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1437 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1438 */         return false; 
/* 1439 */       K k = (K)e.getKey();
/* 1440 */       byte v = ((Byte)e.getValue()).byteValue();
/* 1441 */       if (k == null) {
/* 1442 */         return (Reference2ByteLinkedOpenHashMap.this.containsNullKey && Reference2ByteLinkedOpenHashMap.this.value[Reference2ByteLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1444 */       K[] key = Reference2ByteLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1447 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ByteLinkedOpenHashMap.this.mask]) == null)
/*      */       {
/* 1449 */         return false; } 
/* 1450 */       if (k == curr) {
/* 1451 */         return (Reference2ByteLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1454 */         if ((curr = key[pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask]) == null)
/* 1455 */           return false; 
/* 1456 */         if (k == curr) {
/* 1457 */           return (Reference2ByteLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1466 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1467 */         return false; 
/* 1468 */       K k = (K)e.getKey();
/* 1469 */       byte v = ((Byte)e.getValue()).byteValue();
/* 1470 */       if (k == null) {
/* 1471 */         if (Reference2ByteLinkedOpenHashMap.this.containsNullKey && Reference2ByteLinkedOpenHashMap.this.value[Reference2ByteLinkedOpenHashMap.this.n] == v) {
/* 1472 */           Reference2ByteLinkedOpenHashMap.this.removeNullEntry();
/* 1473 */           return true;
/*      */         } 
/* 1475 */         return false;
/*      */       } 
/*      */       
/* 1478 */       K[] key = Reference2ByteLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1481 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ByteLinkedOpenHashMap.this.mask]) == null)
/*      */       {
/* 1483 */         return false; } 
/* 1484 */       if (curr == k) {
/* 1485 */         if (Reference2ByteLinkedOpenHashMap.this.value[pos] == v) {
/* 1486 */           Reference2ByteLinkedOpenHashMap.this.removeEntry(pos);
/* 1487 */           return true;
/*      */         } 
/* 1489 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1492 */         if ((curr = key[pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask]) == null)
/* 1493 */           return false; 
/* 1494 */         if (curr == k && 
/* 1495 */           Reference2ByteLinkedOpenHashMap.this.value[pos] == v) {
/* 1496 */           Reference2ByteLinkedOpenHashMap.this.removeEntry(pos);
/* 1497 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1504 */       return Reference2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1508 */       Reference2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1523 */       return new Reference2ByteLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1534 */       return new Reference2ByteLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1549 */       return new Reference2ByteLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/* 1554 */       for (int i = Reference2ByteLinkedOpenHashMap.this.size, next = Reference2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1555 */         int curr = next;
/* 1556 */         next = (int)Reference2ByteLinkedOpenHashMap.this.link[curr];
/* 1557 */         consumer.accept(new AbstractReference2ByteMap.BasicEntry<>(Reference2ByteLinkedOpenHashMap.this.key[curr], Reference2ByteLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/* 1563 */       AbstractReference2ByteMap.BasicEntry<K> entry = new AbstractReference2ByteMap.BasicEntry<>();
/* 1564 */       for (int i = Reference2ByteLinkedOpenHashMap.this.size, next = Reference2ByteLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1565 */         int curr = next;
/* 1566 */         next = (int)Reference2ByteLinkedOpenHashMap.this.link[curr];
/* 1567 */         entry.key = Reference2ByteLinkedOpenHashMap.this.key[curr];
/* 1568 */         entry.value = Reference2ByteLinkedOpenHashMap.this.value[curr];
...
/*      */     
/*      */     public K previous() {
/* 1594 */       return Reference2ByteLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
/*      */     
/*      */     public K next() {
/* 1601 */       return Reference2ByteLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractReferenceSortedSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectListIterator<K> iterator(K from) {
/* 1607 */       return new Reference2ByteLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1611 */       return new Reference2ByteLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1616 */       if (Reference2ByteLinkedOpenHashMap.this.containsNullKey)
/* 1617 */         consumer.accept(Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.n]); 
/* 1618 */       for (int pos = Reference2ByteLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1619 */         K k = Reference2ByteLinkedOpenHashMap.this.key[pos];
/* 1620 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/* 1626 */       return Reference2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1630 */       return Reference2ByteLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1634 */       int oldSize = Reference2ByteLinkedOpenHashMap.this.size;
/* 1635 */       Reference2ByteLinkedOpenHashMap.this.removeByte(k);
/* 1636 */       return (Reference2ByteLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1640 */       Reference2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public K first() {
/* 1644 */       if (Reference2ByteLinkedOpenHashMap.this.size == 0)
/* 1645 */         throw new NoSuchElementException(); 
/* 1646 */       return Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public K last() {
/* 1650 */       if (Reference2ByteLinkedOpenHashMap.this.size == 0)
/* 1651 */         throw new NoSuchElementException(); 
/* 1652 */       return Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1656 */       return null;
...
/* 1689 */       return Reference2ByteLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1696 */       return Reference2ByteLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public ByteCollection values() {
/* 1701 */     if (this.values == null)
/* 1702 */       this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1705 */             return (ByteIterator)new Reference2ByteLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1709 */             return Reference2ByteLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1713 */             return Reference2ByteLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1717 */             Reference2ByteLinkedOpenHashMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1722 */             if (Reference2ByteLinkedOpenHashMap.this.containsNullKey)
/* 1723 */               consumer.accept(Reference2ByteLinkedOpenHashMap.this.value[Reference2ByteLinkedOpenHashMap.this.n]); 
/* 1724 */             for (int pos = Reference2ByteLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1725 */               if (Reference2ByteLinkedOpenHashMap.this.key[pos] != null)
/* 1726 */                 consumer.accept(Reference2ByteLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1802 */     K[] key = this.key;
/* 1803 */     byte[] value = this.value;
/* 1804 */     int mask = newN - 1;
/* 1805 */     K[] newKey = (K[])new Object[newN + 1];
/* 1806 */     byte[] newValue = new byte[newN + 1];
...
/*      */     try {
/* 1860 */       c = (Reference2ByteLinkedOpenHashMap<K>)super.clone();
...
/* 1869 */     c.value = (byte[])this.value.clone();
...
/* 1917 */     byte[] value = this.value = new byte[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2ByteLinkedOpenHashMap.class
