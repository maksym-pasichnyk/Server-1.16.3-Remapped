...
/*  49 */     ObjectSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
/*  50 */     return (entries instanceof Reference2LongMap.FastEntrySet) ? (
/*  51 */       (Reference2LongMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  71 */     ObjectSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
/*  72 */     if (entries instanceof Reference2LongMap.FastEntrySet) {
/*  73 */       ((Reference2LongMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  91 */     final ObjectSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
/*  92 */     return (entries instanceof Reference2LongMap.FastEntrySet) ? (ObjectIterable)new ObjectIterable<Reference2LongMap.Entry<Reference2LongMap.Entry<K>>>() {
/*     */         public ObjectIterator<Reference2LongMap.Entry<K>> iterator() {
/*  94 */           return ((Reference2LongMap.FastEntrySet<K>)entries).fastIterator();
/*     */         }
/*     */         public void forEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
/*  97 */           ((Reference2LongMap.FastEntrySet<K>)entries).fastForEach(consumer);
/*     */         }
/*  99 */       } : entries;
/*     */   }
/*     */ 
...
/*     */     
/*     */     public Object clone() {
/* 151 */       return Reference2LongMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 229 */         this.entries = ObjectSets.singleton(new AbstractReference2LongMap.BasicEntry<>(this.key, this.value)); 
...
/* 241 */       return (ObjectSet)reference2LongEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/*     */     
/*     */     public int hashCode() {
/* 261 */       return System.identityHashCode(this.key) ^ HashCommon.long2int(this.value);
/*     */     }
/*     */     
/*     */     public boolean equals(Object o) {
/* 265 */       if (o == this)
...
/* 361 */           this.entries = ObjectSets.synchronize(this.map.reference2LongEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Long>> entrySet() {
/* 374 */       return (ObjectSet)reference2LongEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/* 650 */         this.entries = ObjectSets.unmodifiable(this.map.reference2LongEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Long>> entrySet() {
/* 662 */       return (ObjectSet)reference2LongEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2LongMaps.class
