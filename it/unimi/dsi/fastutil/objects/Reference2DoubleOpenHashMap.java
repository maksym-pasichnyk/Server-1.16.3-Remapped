...
/*      */   
/*      */   public boolean trim() {
/* 1058 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1059 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1060 */       return true; 
/*      */     try {
/* 1062 */       rehash(l);
...
/* 1090 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1091 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1092 */       return true; 
/*      */     try {
/* 1094 */       rehash(l);
...
/* 1114 */     K[] key = this.key;
/* 1115 */     double[] value = this.value;
/* 1116 */     int mask = newN - 1;
/* 1117 */     K[] newKey = (K[])new Object[newN + 1];
/* 1118 */     double[] newValue = new double[newN + 1];
/* 1119 */     int i = this.n;
/* 1120 */     for (int j = realSize(); j-- != 0; ) {
/* 1121 */       while (key[--i] == null); int pos;
/* 1122 */       if (newKey[pos = HashCommon.mix(System.identityHashCode(key[i])) & mask] != null)
/*      */       {
/* 1124 */         while (newKey[pos = pos + 1 & mask] != null); } 
...
/*      */     try {
/* 1150 */       c = (Reference2DoubleOpenHashMap<K>)super.clone();
...
/* 1158 */     c.key = (K[])this.key.clone();
/* 1159 */     c.value = (double[])this.value.clone();
/* 1160 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1173 */     int h = 0;
/* 1174 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1175 */       while (this.key[i] == null)
/* 1176 */         i++; 
/* 1177 */       if (this != this.key[i])
/* 1178 */         t = System.identityHashCode(this.key[i]); 
/* 1179 */       t ^= HashCommon.double2int(this.value[i]);
/* 1180 */       h += t;
/* 1181 */       i++;
/*      */     } 
/*      */     
/* 1184 */     if (this.containsNullKey)
/* 1185 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1186 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1189 */     K[] key = this.key;
/* 1190 */     double[] value = this.value;
/* 1191 */     MapIterator i = new MapIterator();
/* 1192 */     s.defaultWriteObject();
/* 1193 */     for (int j = this.size; j-- != 0; ) {
/* 1194 */       int e = i.nextEntry();
/* 1195 */       s.writeObject(key[e]);
/* 1196 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1205 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1206 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1209 */     for (int i = this.size; i-- != 0; ) {
/* 1210 */       int pos; K k = (K)s.readObject();
/* 1211 */       double v = s.readDouble();
/* 1212 */       if (k == null) {
/* 1213 */         pos = this.n;
/* 1214 */         this.containsNullKey = true;
/*      */       } else {
/* 1216 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1217 */         while (key[pos] != null)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2DoubleOpenHashMap.class
