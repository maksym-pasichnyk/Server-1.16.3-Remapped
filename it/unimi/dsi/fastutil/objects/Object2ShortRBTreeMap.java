...
/*  273 */     Entry<K> e = add(k);
/*  274 */     short oldValue = e.value;
/*  275 */     e.value = (short)(e.value + incr);
/*  276 */     return oldValue;
/*      */   }
/*      */   
/*      */   public short put(K k, short v) {
/*  280 */     Entry<K> e = add(k);
/*  281 */     short oldValue = e.value;
/*  282 */     e.value = v;
/*  283 */     return oldValue;
/*      */   }
/*      */ 
...
/*  913 */         return false; 
/*  914 */       Map.Entry<K, Short> e = (Map.Entry<K, Short>)o;
/*  915 */       return (Objects.equals(this.key, e.getKey()) && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1001 */     int index = 0;
/*      */     TreeIterator() {
/* 1003 */       this.next = Object2ShortRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(K k) {
/* 1006 */       if ((this.next = Object2ShortRBTreeMap.this.locateKey(k)) != null)
/* 1007 */         if (Object2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1058 */       updatePrevious();
/* 1059 */       updateNext();
/* 1060 */       Object2ShortRBTreeMap.this.removeShort(this.curr.key);
/* 1061 */       this.curr = null;
/*      */     }
...
/* 1100 */       this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ShortMap.Entry<Object2ShortMap.Entry<K>>>()
/*      */         {
...
/* 1109 */             return new Object2ShortRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> from) {
/* 1114 */             return new Object2ShortRBTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1122 */             if (e.getValue() == null || !(e.getValue() instanceof Short))
/* 1123 */               return false; 
/* 1124 */             Object2ShortRBTreeMap.Entry<K> f = Object2ShortRBTreeMap.this.findKey((K)e.getKey());
...
/* 1134 */               return false; 
/* 1135 */             Object2ShortRBTreeMap.Entry<K> f = Object2ShortRBTreeMap.this.findKey((K)e.getKey());
/* 1136 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue())
/* 1137 */               return false; 
/* 1138 */             Object2ShortRBTreeMap.this.removeShort(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Object2ShortRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Object2ShortRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Object2ShortMap.Entry<K> first() {
/* 1151 */             return Object2ShortRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Object2ShortMap.Entry<K> last() {
/* 1155 */             return Object2ShortRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> from, Object2ShortMap.Entry<K> to) {
/* 1160 */             return Object2ShortRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2ShortEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> to) {
/* 1164 */             return Object2ShortRBTreeMap.this.headMap(to.getKey()).object2ShortEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(Object2ShortMap.Entry<K> from) {
/* 1168 */             return Object2ShortRBTreeMap.this.tailMap(from.getKey()).object2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1202 */       return new Object2ShortRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1206 */       return new Object2ShortRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1258 */       this.values = (ShortCollection)new AbstractShortCollection()
/*      */         {
/*      */           public ShortIterator iterator() {
/* 1261 */             return (ShortIterator)new Object2ShortRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(short k) {
/* 1265 */             return Object2ShortRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1269 */             return Object2ShortRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1273 */             Object2ShortRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1336 */       if (!bottom && !top && Object2ShortRBTreeMap.this.compare(from, to) > 0)
/* 1337 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1338 */       this.from = from;
/* 1339 */       this.bottom = bottom;
/* 1340 */       this.to = to;
/* 1341 */       this.top = top;
/* 1342 */       this.defRetValue = Object2ShortRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1360 */       return ((this.bottom || Object2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2ShortRBTreeMap.this
/* 1361 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
/* 1365 */       if (this.entries == null)
/* 1366 */         this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ShortMap.Entry<Object2ShortMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator() {
/* 1369 */               return new Object2ShortRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> from) {
/* 1374 */               return new Object2ShortRBTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Object2ShortMap.Entry<K>> comparator() {
/* 1378 */               return Object2ShortRBTreeMap.this.object2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Object2ShortRBTreeMap.Entry<K> f = Object2ShortRBTreeMap.this.findKey((K)e.getKey());
/* 1389 */               return (f != null && Object2ShortRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1397 */               if (e.getValue() == null || !(e.getValue() instanceof Short))
/* 1398 */                 return false; 
/* 1399 */               Object2ShortRBTreeMap.Entry<K> f = Object2ShortRBTreeMap.this.findKey((K)e.getKey());
/* 1400 */               if (f != null && Object2ShortRBTreeMap.Submap.this.in(f.key))
/* 1401 */                 Object2ShortRBTreeMap.Submap.this.removeShort(f.key); 
/* 1402 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1413 */               return !(new Object2ShortRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1417 */               Object2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Object2ShortMap.Entry<K> first() {
/* 1421 */               return Object2ShortRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Object2ShortMap.Entry<K> last() {
/* 1425 */               return Object2ShortRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> from, Object2ShortMap.Entry<K> to) {
/* 1430 */               return Object2ShortRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2ShortEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> to) {
/* 1434 */               return Object2ShortRBTreeMap.Submap.this.headMap(to.getKey()).object2ShortEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(Object2ShortMap.Entry<K> from) {
/* 1438 */               return Object2ShortRBTreeMap.Submap.this.tailMap(from.getKey()).object2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractObject2ShortSortedMap<K>.KeySet {
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1446 */         return new Object2ShortRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1450 */         return new Object2ShortRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<K> keySet() {
...
/* 1462 */         this.values = (ShortCollection)new AbstractShortCollection()
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1465 */               return (ShortIterator)new Object2ShortRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(short k) {
/* 1469 */               return Object2ShortRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1473 */               return Object2ShortRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1477 */               Object2ShortRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(Object k) {
/* 1485 */       return (in((K)k) && Object2ShortRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(short v) {
...
/* 1492 */         short ev = (i.nextEntry()).value;
/* 1493 */         if (ev == v)
/* 1494 */           return true; 
/*      */       } 
/* 1496 */       return false;
...
/*      */     
/*      */     public short getShort(Object k) {
/* 1502 */       K kk = (K)k; Object2ShortRBTreeMap.Entry<K> e;
/* 1503 */       return (in(kk) && (e = Object2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public short put(K k, short v) {
/* 1507 */       Object2ShortRBTreeMap.this.modified = false;
/* 1508 */       if (!in(k))
...
/* 1511 */       short oldValue = Object2ShortRBTreeMap.this.put(k, v);
/* 1512 */       return Object2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short removeShort(Object k) {
/* 1517 */       Object2ShortRBTreeMap.this.modified = false;
/* 1518 */       if (!in((K)k))
/* 1519 */         return this.defRetValue; 
/* 1520 */       short oldValue = Object2ShortRBTreeMap.this.removeShort(k);
/* 1521 */       return Object2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1539 */       return Object2ShortRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Object2ShortSortedMap<K> headMap(K to) {
/* 1543 */       if (this.top)
/* 1544 */         return new Submap(this.from, this.bottom, to, false); 
/* 1545 */       return (Object2ShortRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Object2ShortSortedMap<K> tailMap(K from) {
/* 1549 */       if (this.bottom)
/* 1550 */         return new Submap(from, false, this.to, this.top); 
/* 1551 */       return (Object2ShortRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Object2ShortSortedMap<K> subMap(K from, K to) {
...
/* 1557 */       if (!this.top)
/* 1558 */         to = (Object2ShortRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1559 */       if (!this.bottom)
/* 1560 */         from = (Object2ShortRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1572 */       if (Object2ShortRBTreeMap.this.tree == null) {
/* 1573 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1577 */       if (this.bottom) {
/* 1578 */         e = Object2ShortRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1580 */         e = Object2ShortRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1582 */         if (Object2ShortRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1583 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1587 */       if (e == null || (!this.top && Object2ShortRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1588 */         return null; 
/* 1589 */       return e;
/*      */     }
/*      */ 
...
/*      */       Object2ShortRBTreeMap.Entry<K> e;
/* 1598 */       if (Object2ShortRBTreeMap.this.tree == null) {
/* 1599 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1603 */       if (this.top) {
/* 1604 */         e = Object2ShortRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1606 */         e = Object2ShortRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1608 */         if (Object2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1609 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1613 */       if (e == null || (!this.bottom && Object2ShortRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1614 */         return null; 
/* 1615 */       return e;
/*      */     }
/*      */     
/*      */     public K firstKey() {
/* 1619 */       Object2ShortRBTreeMap.Entry<K> e = firstEntry();
/* 1620 */       if (e == null)
...
/*      */     
/*      */     public K lastKey() {
/* 1626 */       Object2ShortRBTreeMap.Entry<K> e = lastEntry();
/* 1627 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1642 */         this.next = Object2ShortRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(K k) {
/* 1645 */         this();
/* 1646 */         if (this.next != null)
/* 1647 */           if (!Object2ShortRBTreeMap.Submap.this.bottom && Object2ShortRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1648 */             this.prev = null;
/* 1649 */           } else if (!Object2ShortRBTreeMap.Submap.this.top && Object2ShortRBTreeMap.this.compare(k, (this.prev = Object2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1650 */             this.next = null;
/*      */           } else {
/* 1652 */             this.next = Object2ShortRBTreeMap.this.locateKey(k);
/* 1653 */             if (Object2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1664 */         if (!Object2ShortRBTreeMap.Submap.this.bottom && this.prev != null && Object2ShortRBTreeMap.this.compare(this.prev.key, Object2ShortRBTreeMap.Submap.this.from) < 0)
/* 1665 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1669 */         this.next = this.next.next();
/* 1670 */         if (!Object2ShortRBTreeMap.Submap.this.top && this.next != null && Object2ShortRBTreeMap.this.compare(this.next.key, Object2ShortRBTreeMap.Submap.this.to) >= 0)
/* 1671 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1753 */       c = (Object2ShortRBTreeMap<K>)super.clone();
...
/* 1834 */     if (n == 1) {
/* 1835 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readShort());
...
/*      */ 
/*      */       
/* 1846 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readShort());
/* 1847 */       entry.black(true);
/* 1848 */       entry.right(new Entry<>((K)s.readObject(), s.readShort()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ShortRBTreeMap.class
