...
/*  516 */     long oldValue = this.value[pos];
...
/*  527 */     long newValue = mappingFunction.applyAsLong(k);
...
/*  539 */     Long newValue = remappingFunction.apply(k, Long.valueOf(this.value[pos]));
...
/*      */     } 
/*  547 */     this.value[pos] = newValue.longValue(); return newValue.longValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  554 */     int pos = find(k);
/*  555 */     Long newValue = remappingFunction.apply(k, (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  565 */     long newVal = newValue.longValue();
/*  566 */     if (pos < 0) {
...
/*  580 */       return v;
/*      */     } 
/*  582 */     Long newValue = remappingFunction.apply(Long.valueOf(this.value[pos]), Long.valueOf(v));
...
/*      */     } 
/*  590 */     this.value[pos] = newValue.longValue(); return newValue.longValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  631 */       return Reference2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public long getLongValue() {
/*  635 */       return Reference2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public long setValue(long v) {
/*  639 */       long oldValue = Reference2LongOpenHashMap.this.value[this.index];
/*  640 */       Reference2LongOpenHashMap.this.value[this.index] = v;
/*  641 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  651 */       return Long.valueOf(Reference2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long setValue(Long v) {
/*  661 */       return Long.valueOf(setValue(v.longValue()));
/*      */     }
/*      */ 
/*      */     
...
/*  667 */         return false; 
/*  668 */       Map.Entry<K, Long> e = (Map.Entry<K, Long>)o;
/*  669 */       return (Reference2LongOpenHashMap.this.key[this.index] == e.getKey() && Reference2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  673 */       return System.identityHashCode(Reference2LongOpenHashMap.this.key[this.index]) ^ HashCommon.long2int(Reference2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/*  677 */       return (new StringBuilder()).append(Reference2LongOpenHashMap.this.key[this.index]).append("=>").append(Reference2LongOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  687 */     int pos = Reference2LongOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  694 */     int last = -1;
/*      */     
/*  696 */     int c = Reference2LongOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  700 */     boolean mustReturnNullKey = Reference2LongOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  715 */         return this.last = Reference2LongOpenHashMap.this.n;
/*      */       } 
/*  717 */       K[] key = Reference2LongOpenHashMap.this.key;
/*      */       while (true) {
/*  719 */         if (--this.pos < 0) {
/*      */           
/*  721 */           this.last = Integer.MIN_VALUE;
/*  722 */           K k = this.wrapped.get(-this.pos - 1);
/*  723 */           int p = HashCommon.mix(System.identityHashCode(k)) & Reference2LongOpenHashMap.this.mask;
/*  724 */           while (k != key[p])
/*  725 */             p = p + 1 & Reference2LongOpenHashMap.this.mask; 
/*  726 */           return p;
/*      */         } 
...
/*  743 */       K[] key = Reference2LongOpenHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  745 */         pos = (last = pos) + 1 & Reference2LongOpenHashMap.this.mask;
/*      */         while (true) {
/*  747 */           if ((curr = key[pos]) == null) {
/*  748 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  751 */           int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2LongOpenHashMap.this.mask;
/*  752 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  754 */           pos = pos + 1 & Reference2LongOpenHashMap.this.mask;
/*      */         } 
/*  756 */         if (pos < last) {
...
/*      */         } 
/*  761 */         key[last] = curr;
/*  762 */         Reference2LongOpenHashMap.this.value[last] = Reference2LongOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  766 */       if (this.last == -1)
/*  767 */         throw new IllegalStateException(); 
/*  768 */       if (this.last == Reference2LongOpenHashMap.this.n) {
/*  769 */         Reference2LongOpenHashMap.this.containsNullKey = false;
/*  770 */         Reference2LongOpenHashMap.this.key[Reference2LongOpenHashMap.this.n] = null;
/*  771 */       } else if (this.pos >= 0) {
/*  772 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  775 */         Reference2LongOpenHashMap.this.removeLong(this.wrapped.set(-this.pos - 1, null));
/*  776 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  779 */       Reference2LongOpenHashMap.this.size--;
/*  780 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Reference2LongMap.Entry<K>> { private Reference2LongOpenHashMap<K>.MapEntry entry;
/*      */     
/*      */     public Reference2LongOpenHashMap<K>.MapEntry next() {
/*  795 */       return this.entry = new Reference2LongOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  804 */       this.entry = new Reference2LongOpenHashMap.MapEntry();
...
/*  814 */       return new Reference2LongOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Reference2LongMap.Entry<K>> fastIterator() {
/*  818 */       return new Reference2LongOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  826 */       if (e.getValue() == null || !(e.getValue() instanceof Long))
/*  827 */         return false; 
/*  828 */       K k = (K)e.getKey();
/*  829 */       long v = ((Long)e.getValue()).longValue();
/*  830 */       if (k == null) {
/*  831 */         return (Reference2LongOpenHashMap.this.containsNullKey && Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n] == v);
/*      */       }
/*  833 */       K[] key = Reference2LongOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  836 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2LongOpenHashMap.this.mask]) == null)
/*      */       {
/*  838 */         return false; } 
/*  839 */       if (k == curr) {
/*  840 */         return (Reference2LongOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  843 */         if ((curr = key[pos = pos + 1 & Reference2LongOpenHashMap.this.mask]) == null)
/*  844 */           return false; 
/*  845 */         if (k == curr) {
/*  846 */           return (Reference2LongOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  859 */       if (k == null) {
/*  860 */         if (Reference2LongOpenHashMap.this.containsNullKey && Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n] == v) {
/*  861 */           Reference2LongOpenHashMap.this.removeNullEntry();
/*  862 */           return true;
/*      */         } 
/*  864 */         return false;
/*      */       } 
/*      */       
/*  867 */       K[] key = Reference2LongOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  870 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2LongOpenHashMap.this.mask]) == null)
/*      */       {
/*  872 */         return false; } 
/*  873 */       if (curr == k) {
/*  874 */         if (Reference2LongOpenHashMap.this.value[pos] == v) {
/*  875 */           Reference2LongOpenHashMap.this.removeEntry(pos);
/*  876 */           return true;
/*      */         } 
/*  878 */         return false;
/*      */       } 
/*      */       while (true) {
/*  881 */         if ((curr = key[pos = pos + 1 & Reference2LongOpenHashMap.this.mask]) == null)
/*  882 */           return false; 
/*  883 */         if (curr == k && 
/*  884 */           Reference2LongOpenHashMap.this.value[pos] == v) {
/*  885 */           Reference2LongOpenHashMap.this.removeEntry(pos);
/*  886 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  893 */       return Reference2LongOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  897 */       Reference2LongOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
/*  902 */       if (Reference2LongOpenHashMap.this.containsNullKey)
/*  903 */         consumer.accept(new AbstractReference2LongMap.BasicEntry<>(Reference2LongOpenHashMap.this.key[Reference2LongOpenHashMap.this.n], Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n])); 
/*  904 */       for (int pos = Reference2LongOpenHashMap.this.n; pos-- != 0;) {
/*  905 */         if (Reference2LongOpenHashMap.this.key[pos] != null)
/*  906 */           consumer.accept(new AbstractReference2LongMap.BasicEntry<>(Reference2LongOpenHashMap.this.key[pos], Reference2LongOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
/*  911 */       AbstractReference2LongMap.BasicEntry<K> entry = new AbstractReference2LongMap.BasicEntry<>();
/*  912 */       if (Reference2LongOpenHashMap.this.containsNullKey) {
/*  913 */         entry.key = Reference2LongOpenHashMap.this.key[Reference2LongOpenHashMap.this.n];
/*  914 */         entry.value = Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n];
/*  915 */         consumer.accept(entry);
/*      */       } 
/*  917 */       for (int pos = Reference2LongOpenHashMap.this.n; pos-- != 0;) {
/*  918 */         if (Reference2LongOpenHashMap.this.key[pos] != null) {
/*  919 */           entry.key = Reference2LongOpenHashMap.this.key[pos];
/*  920 */           entry.value = Reference2LongOpenHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  946 */       return Reference2LongOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  952 */       return new Reference2LongOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  957 */       if (Reference2LongOpenHashMap.this.containsNullKey)
/*  958 */         consumer.accept(Reference2LongOpenHashMap.this.key[Reference2LongOpenHashMap.this.n]); 
/*  959 */       for (int pos = Reference2LongOpenHashMap.this.n; pos-- != 0; ) {
/*  960 */         K k = Reference2LongOpenHashMap.this.key[pos];
/*  961 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/*  967 */       return Reference2LongOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/*  971 */       return Reference2LongOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/*  975 */       int oldSize = Reference2LongOpenHashMap.this.size;
/*  976 */       Reference2LongOpenHashMap.this.removeLong(k);
/*  977 */       return (Reference2LongOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  981 */       Reference2LongOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1005 */       return Reference2LongOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public LongCollection values() {
/* 1010 */     if (this.values == null)
/* 1011 */       this.values = (LongCollection)new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1014 */             return new Reference2LongOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1018 */             return Reference2LongOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(long v) {
/* 1022 */             return Reference2LongOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1026 */             Reference2LongOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(LongConsumer consumer)
/*      */           {
/* 1031 */             if (Reference2LongOpenHashMap.this.containsNullKey)
/* 1032 */               consumer.accept(Reference2LongOpenHashMap.this.value[Reference2LongOpenHashMap.this.n]); 
/* 1033 */             for (int pos = Reference2LongOpenHashMap.this.n; pos-- != 0;) {
/* 1034 */               if (Reference2LongOpenHashMap.this.key[pos] != null)
/* 1035 */                 consumer.accept(Reference2LongOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1111 */     K[] key = this.key;
/* 1112 */     long[] value = this.value;
/* 1113 */     int mask = newN - 1;
/* 1114 */     K[] newKey = (K[])new Object[newN + 1];
/* 1115 */     long[] newValue = new long[newN + 1];
/* 1116 */     int i = this.n;
...
/*      */     try {
/* 1147 */       c = (Reference2LongOpenHashMap<K>)super.clone();
...
/* 1156 */     c.value = (long[])this.value.clone();
/* 1157 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1176 */       t ^= HashCommon.long2int(this.value[i]);
/* 1177 */       h += t;
/* 1178 */       i++;
/*      */     } 
/*      */     
/* 1181 */     if (this.containsNullKey)
/* 1182 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1183 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1186 */     K[] key = this.key;
/* 1187 */     long[] value = this.value;
...
/* 1203 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1206 */     for (int i = this.size; i-- != 0; ) {
/* 1207 */       int pos; K k = (K)s.readObject();
/* 1208 */       long v = s.readLong();
/* 1209 */       if (k == null) {
/* 1210 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2LongOpenHashMap.class
