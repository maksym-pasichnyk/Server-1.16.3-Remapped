...
/*     */   
/*     */   public boolean trim() {
/* 836 */     int l = HashCommon.arraySize(this.size, this.f);
/* 837 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 838 */       return true; 
/*     */     try {
/* 840 */       rehash(l);
/* 841 */     } catch (OutOfMemoryError cantDoIt) {
/* 842 */       return false;
/*     */     } 
/* 844 */     return true;
/*     */   }
...
/* 868 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 869 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 870 */       return true; 
/*     */     try {
/* 872 */       rehash(l);
/* 873 */     } catch (OutOfMemoryError cantDoIt) {
/* 874 */       return false;
/*     */     } 
/* 876 */     return true;
/*     */   }
...
/* 892 */     K[] key = this.key;
/* 893 */     V[] value = this.value;
/* 894 */     int mask = newN - 1;
/* 895 */     K[] newKey = (K[])new Object[newN + 1];
/* 896 */     V[] newValue = (V[])new Object[newN + 1];
/* 897 */     int i = this.n;
/* 898 */     for (int j = realSize(); j-- != 0; ) {
/* 899 */       while (key[--i] == null); int pos;
/* 900 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null)
/* 901 */         while (newKey[pos = pos + 1 & mask] != null); 
/* 902 */       newKey[pos] = key[i];
/* 903 */       newValue[pos] = value[i];
/*     */     } 
/* 905 */     newValue[newN] = value[this.n];
/* 906 */     this.n = newN;
/* 907 */     this.mask = mask;
/* 908 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 909 */     this.key = newKey;
/* 910 */     this.value = newValue;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     try {
/* 927 */       c = (Object2ReferenceOpenHashMap<K, V>)super.clone();
/* 928 */     } catch (CloneNotSupportedException cantHappen) {
/* 929 */       throw new InternalError();
/*     */     } 
/* 931 */     c.keys = null;
/* 932 */     c.values = null;
/* 933 */     c.entries = null;
/* 934 */     c.containsNullKey = this.containsNullKey;
/* 935 */     c.key = (K[])this.key.clone();
/* 936 */     c.value = (V[])this.value.clone();
/* 937 */     return c;
/*     */   }
/*     */ 
/*     */ 
...
/*     */   public int hashCode() {
/* 950 */     int h = 0;
/* 951 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 952 */       while (this.key[i] == null)
/* 953 */         i++; 
/* 954 */       if (this != this.key[i])
/* 955 */         t = this.key[i].hashCode(); 
/* 956 */       if (this != this.value[i])
/* 957 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 958 */       h += t;
/* 959 */       i++;
/*     */     } 
/*     */     
/* 962 */     if (this.containsNullKey)
/* 963 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 964 */     return h;
/*     */   }
/*     */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 967 */     K[] key = this.key;
/* 968 */     V[] value = this.value;
/* 969 */     MapIterator i = new MapIterator();
/* 970 */     s.defaultWriteObject();
/* 971 */     for (int j = this.size; j-- != 0; ) {
/* 972 */       int e = i.nextEntry();
/* 973 */       s.writeObject(key[e]);
/* 974 */       s.writeObject(value[e]);
/*     */     } 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 979 */     s.defaultReadObject();
/* 980 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 981 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 982 */     this.mask = this.n - 1;
/* 983 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 984 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*     */ 
/*     */     
/* 987 */     for (int i = this.size; i-- != 0; ) {
/* 988 */       int pos; K k = (K)s.readObject();
/* 989 */       V v = (V)s.readObject();
/* 990 */       if (k == null) {
/* 991 */         pos = this.n;
/* 992 */         this.containsNullKey = true;
/*     */       } else {
/* 994 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 995 */         while (key[pos] != null)
/* 996 */           pos = pos + 1 & this.mask; 
/*     */       } 
/* 998 */       key[pos] = k;
/* 999 */       value[pos] = v;
/*     */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ReferenceOpenHashMap.class
