...
/*  52 */     ObjectIterator<Object2IntMap.Entry<K>> i = object2IntEntrySet().iterator();
/*  53 */     while (i.hasNext()) {
/*  54 */       if (((Object2IntMap.Entry)i.next()).getKey() == k)
/*  55 */         return true; 
/*  56 */     }  return false;
/*     */   }
/*     */   
...
/* 100 */         return false; 
/* 101 */       if (o instanceof Object2IntMap.Entry) {
/* 102 */         Object2IntMap.Entry<K> entry = (Object2IntMap.Entry<K>)o;
/* 103 */         return (Objects.equals(this.key, entry.getKey()) && this.value == entry.getIntValue());
/*     */       } 
...
/* 109 */         return false; 
/* 110 */       return (Objects.equals(this.key, key) && this.value == ((Integer)value).intValue());
/*     */     }
/*     */     
/*     */     public int hashCode() {
...
/* 134 */         return false; 
/* 135 */       if (o instanceof Object2IntMap.Entry) {
/* 136 */         Object2IntMap.Entry<K> entry = (Object2IntMap.Entry<K>)o;
...
/* 151 */         return false; 
/* 152 */       if (o instanceof Object2IntMap.Entry) {
/* 153 */         Object2IntMap.Entry<K> entry = (Object2IntMap.Entry<K>)o;
...
/* 188 */           return AbstractObject2IntMap.this.containsKey(k);
/*     */         }
/*     */         
/*     */         public int size() {
/* 192 */           return AbstractObject2IntMap.this.size();
/*     */         }
/*     */         
/*     */         public void clear() {
/* 196 */           AbstractObject2IntMap.this.clear();
/*     */         }
/*     */         
/*     */         public ObjectIterator<K> iterator() {
/* 200 */           return new ObjectIterator<K>()
/*     */             {
/* 202 */               private final ObjectIterator<Object2IntMap.Entry<K>> i = Object2IntMaps.fastIterator(AbstractObject2IntMap.this);
/*     */               
/*     */               public K next() {
/* 205 */                 return ((Object2IntMap.Entry<K>)this.i.next()).getKey();
/*     */               }
/*     */               
...
/* 238 */           return AbstractObject2IntMap.this.containsValue(k);
/*     */         }
/*     */         
/*     */         public int size() {
/* 242 */           return AbstractObject2IntMap.this.size();
/*     */         }
/*     */         
/*     */         public void clear() {
/* 246 */           AbstractObject2IntMap.this.clear();
/*     */         }
/*     */         
/*     */         public IntIterator iterator() {
/* 250 */           return new IntIterator()
/*     */             {
/* 252 */               private final ObjectIterator<Object2IntMap.Entry<K>> i = Object2IntMaps.fastIterator(AbstractObject2IntMap.this);
/*     */               
/*     */               public int nextInt() {
/* 255 */                 return ((Object2IntMap.Entry)this.i.next()).getIntValue();
/*     */               }
/*     */               
/*     */               public boolean hasNext() {
...
/* 269 */     if (m instanceof Object2IntMap) {
/* 270 */       ObjectIterator<Object2IntMap.Entry<K>> i = Object2IntMaps.fastIterator((Object2IntMap)m);
/* 271 */       while (i.hasNext()) {
/* 272 */         Object2IntMap.Entry<? extends K> e = i.next();
...
/*     */   public int hashCode() {
/* 294 */     int h = 0, n = size();
/* 295 */     ObjectIterator<Object2IntMap.Entry<K>> i = Object2IntMaps.fastIterator(this);
/* 296 */     while (n-- != 0)
/* 297 */       h += ((Object2IntMap.Entry)i.next()).hashCode(); 
/* 298 */     return h;
/*     */   }
/*     */   
/*     */   public boolean equals(Object o) {
...
/* 307 */     if (m.size() != size())
/* 308 */       return false; 
/* 309 */     return object2IntEntrySet().containsAll(m.entrySet());
/*     */   }
/*     */   
/*     */   public String toString() {
/* 313 */     StringBuilder s = new StringBuilder();
/* 314 */     ObjectIterator<Object2IntMap.Entry<K>> i = Object2IntMaps.fastIterator(this);
/* 315 */     int n = size();
/*     */     
...
/*     */       } else {
/* 323 */         s.append(", ");
/* 324 */       }  Object2IntMap.Entry<K> e = i.next();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\AbstractObject2IntMap.class
