...
/*      */     
/*      */     public K getKey() {
/*  663 */       return Object2IntOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public int getIntValue() {
/*  667 */       return Object2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public int setValue(int v) {
/*  671 */       int oldValue = Object2IntOpenCustomHashMap.this.value[this.index];
/*  672 */       Object2IntOpenCustomHashMap.this.value[this.index] = v;
/*  673 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  683 */       return Integer.valueOf(Object2IntOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  701 */       return (Object2IntOpenCustomHashMap.this.strategy.equals(Object2IntOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  705 */       return Object2IntOpenCustomHashMap.this.strategy.hashCode(Object2IntOpenCustomHashMap.this.key[this.index]) ^ Object2IntOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  709 */       return (new StringBuilder()).append(Object2IntOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2IntOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  719 */     int pos = Object2IntOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  726 */     int last = -1;
/*      */     
/*  728 */     int c = Object2IntOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  732 */     boolean mustReturnNullKey = Object2IntOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  747 */         return this.last = Object2IntOpenCustomHashMap.this.n;
/*      */       } 
...
/*  756 */           while (!Object2IntOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  757 */             p = p + 1 & Object2IntOpenCustomHashMap.this.mask; 
/*  758 */           return p;
/*      */         } 
...
/*  775 */       K[] key = Object2IntOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  777 */         pos = (last = pos) + 1 & Object2IntOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  779 */           if ((curr = key[pos]) == null) {
/*  780 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  783 */           int slot = HashCommon.mix(Object2IntOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2IntOpenCustomHashMap.this.mask;
/*  784 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  786 */           pos = pos + 1 & Object2IntOpenCustomHashMap.this.mask;
/*      */         } 
/*  788 */         if (pos < last) {
...
/*      */         } 
/*  793 */         key[last] = curr;
/*  794 */         Object2IntOpenCustomHashMap.this.value[last] = Object2IntOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  798 */       if (this.last == -1)
/*  799 */         throw new IllegalStateException(); 
/*  800 */       if (this.last == Object2IntOpenCustomHashMap.this.n) {
/*  801 */         Object2IntOpenCustomHashMap.this.containsNullKey = false;
/*  802 */         Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.n] = null;
/*  803 */       } else if (this.pos >= 0) {
/*  804 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  807 */         Object2IntOpenCustomHashMap.this.removeInt(this.wrapped.set(-this.pos - 1, null));
/*  808 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  811 */       Object2IntOpenCustomHashMap.this.size--;
/*  812 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*  827 */       return this.entry = new Object2IntOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  836 */       this.entry = new Object2IntOpenCustomHashMap.MapEntry();
...
/*  846 */       return new Object2IntOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Object2IntMap.Entry<K>> fastIterator() {
/*  850 */       return new Object2IntOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  862 */       if (Object2IntOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  863 */         return (Object2IntOpenCustomHashMap.this.containsNullKey && Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n] == v);
/*      */       }
/*  865 */       K[] key = Object2IntOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  868 */       if ((curr = key[pos = HashCommon.mix(Object2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Object2IntOpenCustomHashMap.this.mask]) == null)
/*  869 */         return false; 
/*  870 */       if (Object2IntOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  871 */         return (Object2IntOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  874 */         if ((curr = key[pos = pos + 1 & Object2IntOpenCustomHashMap.this.mask]) == null)
/*  875 */           return false; 
/*  876 */         if (Object2IntOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  877 */           return (Object2IntOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  890 */       if (Object2IntOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  891 */         if (Object2IntOpenCustomHashMap.this.containsNullKey && Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n] == v) {
/*  892 */           Object2IntOpenCustomHashMap.this.removeNullEntry();
/*  893 */           return true;
/*      */         } 
/*  895 */         return false;
/*      */       } 
/*      */       
/*  898 */       K[] key = Object2IntOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  901 */       if ((curr = key[pos = HashCommon.mix(Object2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Object2IntOpenCustomHashMap.this.mask]) == null)
/*  902 */         return false; 
/*  903 */       if (Object2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  904 */         if (Object2IntOpenCustomHashMap.this.value[pos] == v) {
/*  905 */           Object2IntOpenCustomHashMap.this.removeEntry(pos);
/*  906 */           return true;
/*      */         } 
/*  908 */         return false;
/*      */       } 
/*      */       while (true) {
/*  911 */         if ((curr = key[pos = pos + 1 & Object2IntOpenCustomHashMap.this.mask]) == null)
/*  912 */           return false; 
/*  913 */         if (Object2IntOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  914 */           Object2IntOpenCustomHashMap.this.value[pos] == v) {
/*  915 */           Object2IntOpenCustomHashMap.this.removeEntry(pos);
/*  916 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  923 */       return Object2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  927 */       Object2IntOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
/*  932 */       if (Object2IntOpenCustomHashMap.this.containsNullKey)
/*  933 */         consumer.accept(new AbstractObject2IntMap.BasicEntry<>(Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.n], Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n])); 
/*  934 */       for (int pos = Object2IntOpenCustomHashMap.this.n; pos-- != 0;) {
/*  935 */         if (Object2IntOpenCustomHashMap.this.key[pos] != null)
/*  936 */           consumer.accept(new AbstractObject2IntMap.BasicEntry<>(Object2IntOpenCustomHashMap.this.key[pos], Object2IntOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
/*  941 */       AbstractObject2IntMap.BasicEntry<K> entry = new AbstractObject2IntMap.BasicEntry<>();
/*  942 */       if (Object2IntOpenCustomHashMap.this.containsNullKey) {
/*  943 */         entry.key = Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.n];
/*  944 */         entry.value = Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n];
/*  945 */         consumer.accept(entry);
/*      */       } 
/*  947 */       for (int pos = Object2IntOpenCustomHashMap.this.n; pos-- != 0;) {
/*  948 */         if (Object2IntOpenCustomHashMap.this.key[pos] != null) {
/*  949 */           entry.key = Object2IntOpenCustomHashMap.this.key[pos];
/*  950 */           entry.value = Object2IntOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  976 */       return Object2IntOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  982 */       return new Object2IntOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  987 */       if (Object2IntOpenCustomHashMap.this.containsNullKey)
/*  988 */         consumer.accept(Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.n]); 
/*  989 */       for (int pos = Object2IntOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  990 */         K k = Object2IntOpenCustomHashMap.this.key[pos];
/*  991 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/*  997 */       return Object2IntOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1001 */       return Object2IntOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1005 */       int oldSize = Object2IntOpenCustomHashMap.this.size;
/* 1006 */       Object2IntOpenCustomHashMap.this.removeInt(k);
/* 1007 */       return (Object2IntOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1011 */       Object2IntOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*      */   {
/*      */     public int nextInt() {
/* 1035 */       return Object2IntOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1044 */             return new Object2IntOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1048 */             return Object2IntOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(int v) {
/* 1052 */             return Object2IntOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1056 */             Object2IntOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1061 */             if (Object2IntOpenCustomHashMap.this.containsNullKey)
/* 1062 */               consumer.accept(Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.n]); 
/* 1063 */             for (int pos = Object2IntOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1064 */               if (Object2IntOpenCustomHashMap.this.key[pos] != null)
/* 1065 */                 consumer.accept(Object2IntOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1176 */       c = (Object2IntOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2IntOpenCustomHashMap.class
