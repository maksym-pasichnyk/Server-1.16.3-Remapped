...
/* 116 */           return (this.next < ReferenceArraySet.this.size);
/*     */         }
/*     */         
/*     */         public K next() {
/* 120 */           if (!hasNext())
/* 121 */             throw new NoSuchElementException(); 
/* 122 */           return (K)ReferenceArraySet.this.a[this.next++];
/*     */         }
/*     */         
/*     */         public void remove() {
/* 126 */           int tail = ReferenceArraySet.this.size-- - this.next--;
/* 127 */           System.arraycopy(ReferenceArraySet.this.a, this.next + 1, ReferenceArraySet.this.a, this.next, tail);
/* 128 */           ReferenceArraySet.this.a[ReferenceArraySet.this.size] = null;
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/*     */     try {
/* 190 */       c = (ReferenceArraySet<K>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\ReferenceArraySet.class
