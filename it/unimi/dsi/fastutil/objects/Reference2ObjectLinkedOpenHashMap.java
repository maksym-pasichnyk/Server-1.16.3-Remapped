...
/*      */   
/*      */   public boolean trim() {
/* 1521 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1522 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1523 */       return true; 
/*      */     try {
/* 1525 */       rehash(l);
/* 1526 */     } catch (OutOfMemoryError cantDoIt) {
/* 1527 */       return false;
/*      */     } 
/* 1529 */     return true;
/*      */   }
...
/* 1553 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1554 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1555 */       return true; 
/*      */     try {
/* 1557 */       rehash(l);
/* 1558 */     } catch (OutOfMemoryError cantDoIt) {
/* 1559 */       return false;
/*      */     } 
/* 1561 */     return true;
/*      */   }
...
/* 1577 */     K[] key = this.key;
/* 1578 */     V[] value = this.value;
/* 1579 */     int mask = newN - 1;
/* 1580 */     K[] newKey = (K[])new Object[newN + 1];
/* 1581 */     V[] newValue = (V[])new Object[newN + 1];
/* 1582 */     int i = this.first, prev = -1, newPrev = -1;
/* 1583 */     long[] link = this.link;
/* 1584 */     long[] newLink = new long[newN + 1];
/* 1585 */     this.first = -1;
/* 1586 */     for (int j = this.size; j-- != 0; ) {
/* 1587 */       int pos; if (key[i] == null) {
/* 1588 */         pos = newN;
/*      */       } else {
/* 1590 */         pos = HashCommon.mix(System.identityHashCode(key[i])) & mask;
/* 1591 */         while (newKey[pos] != null)
/* 1592 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1594 */       newKey[pos] = key[i];
/* 1595 */       newValue[pos] = value[i];
/* 1596 */       if (prev != -1) {
/* 1597 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1598 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1599 */         newPrev = pos;
/*      */       } else {
/* 1601 */         newPrev = this.first = pos;
/*      */         
/* 1603 */         newLink[pos] = -1L;
/*      */       } 
/* 1605 */       int t = i;
...
/* 1607 */       prev = t;
/*      */     } 
/* 1609 */     this.link = newLink;
/* 1610 */     this.last = newPrev;
/* 1611 */     if (newPrev != -1)
/*      */     {
/* 1613 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1614 */     this.n = newN;
/* 1615 */     this.mask = mask;
/* 1616 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1617 */     this.key = newKey;
/* 1618 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1635 */       c = (Reference2ObjectLinkedOpenHashMap<K, V>)super.clone();
/* 1636 */     } catch (CloneNotSupportedException cantHappen) {
/* 1637 */       throw new InternalError();
/*      */     } 
/* 1639 */     c.keys = null;
/* 1640 */     c.values = null;
/* 1641 */     c.entries = null;
/* 1642 */     c.containsNullKey = this.containsNullKey;
/* 1643 */     c.key = (K[])this.key.clone();
/* 1644 */     c.value = (V[])this.value.clone();
/* 1645 */     c.link = (long[])this.link.clone();
/* 1646 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1659 */     int h = 0;
/* 1660 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1661 */       while (this.key[i] == null)
/* 1662 */         i++; 
/* 1663 */       if (this != this.key[i])
/* 1664 */         t = System.identityHashCode(this.key[i]); 
/* 1665 */       if (this != this.value[i])
/* 1666 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1667 */       h += t;
/* 1668 */       i++;
/*      */     } 
/*      */     
/* 1671 */     if (this.containsNullKey)
/* 1672 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1673 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1676 */     K[] key = this.key;
/* 1677 */     V[] value = this.value;
/* 1678 */     MapIterator i = new MapIterator();
/* 1679 */     s.defaultWriteObject();
/* 1680 */     for (int j = this.size; j-- != 0; ) {
/* 1681 */       int e = i.nextEntry();
/* 1682 */       s.writeObject(key[e]);
/* 1683 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1688 */     s.defaultReadObject();
/* 1689 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1690 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1691 */     this.mask = this.n - 1;
/* 1692 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1693 */     V[] value = this.value = (V[])new Object[this.n + 1];
/* 1694 */     long[] link = this.link = new long[this.n + 1];
/* 1695 */     int prev = -1;
/* 1696 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1699 */     for (int i = this.size; i-- != 0; ) {
/* 1700 */       int pos; K k = (K)s.readObject();
/* 1701 */       V v = (V)s.readObject();
/* 1702 */       if (k == null) {
/* 1703 */         pos = this.n;
/* 1704 */         this.containsNullKey = true;
/*      */       } else {
/* 1706 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1707 */         while (key[pos] != null)
/* 1708 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1710 */       key[pos] = k;
/* 1711 */       value[pos] = v;
/* 1712 */       if (this.first != -1) {
/* 1713 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1714 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1715 */         prev = pos; continue;
/*      */       } 
/* 1717 */       prev = this.first = pos;
/*      */       
/* 1719 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1722 */     this.last = prev;
/* 1723 */     if (prev != -1)
/*      */     {
/* 1725 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2ObjectLinkedOpenHashMap.class
