...
/* 1111 */     K[] key = this.key;
/* 1112 */     int[] value = this.value;
/* 1113 */     int mask = newN - 1;
/* 1114 */     K[] newKey = (K[])new Object[newN + 1];
/* 1115 */     int[] newValue = new int[newN + 1];
/* 1116 */     int i = this.n;
...
/*      */     try {
/* 1147 */       c = (Reference2IntOpenHashMap<K>)super.clone();
...
/* 1156 */     c.value = (int[])this.value.clone();
/* 1157 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1203 */     int[] value = this.value = new int[this.n + 1];
/*      */ 
/*      */     
/* 1206 */     for (int i = this.size; i-- != 0; ) {
/* 1207 */       int pos; K k = (K)s.readObject();
/* 1208 */       int v = s.readInt();
/* 1209 */       if (k == null) {
/* 1210 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2IntOpenHashMap.class
