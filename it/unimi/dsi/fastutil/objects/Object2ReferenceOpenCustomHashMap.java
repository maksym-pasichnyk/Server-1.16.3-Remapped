...
/*      */     
/*      */     public K getKey() {
/*  467 */       return Object2ReferenceOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public V getValue() {
/*  471 */       return Object2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public V setValue(V v) {
/*  475 */       V oldValue = Object2ReferenceOpenCustomHashMap.this.value[this.index];
/*  476 */       Object2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/*  477 */       return oldValue;
/*      */     }
/*      */ 
/*      */     
...
/*  485 */       return (Object2ReferenceOpenCustomHashMap.this.strategy.equals(Object2ReferenceOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  489 */       return Object2ReferenceOpenCustomHashMap.this.strategy.hashCode(Object2ReferenceOpenCustomHashMap.this.key[this.index]) ^ (
/*  490 */         (Object2ReferenceOpenCustomHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Object2ReferenceOpenCustomHashMap.this.value[this.index]));
/*      */     }
/*      */     
/*      */     public String toString() {
/*  494 */       return (new StringBuilder()).append(Object2ReferenceOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2ReferenceOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  504 */     int pos = Object2ReferenceOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  511 */     int last = -1;
/*      */     
/*  513 */     int c = Object2ReferenceOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  517 */     boolean mustReturnNullKey = Object2ReferenceOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  532 */         return this.last = Object2ReferenceOpenCustomHashMap.this.n;
/*      */       } 
/*  534 */       K[] key = Object2ReferenceOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  536 */         if (--this.pos < 0) {
/*      */           
/*  538 */           this.last = Integer.MIN_VALUE;
/*  539 */           K k = this.wrapped.get(-this.pos - 1);
/*  540 */           int p = HashCommon.mix(Object2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ReferenceOpenCustomHashMap.this.mask;
/*  541 */           while (!Object2ReferenceOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  542 */             p = p + 1 & Object2ReferenceOpenCustomHashMap.this.mask; 
/*  543 */           return p;
/*      */         } 
...
/*  560 */       K[] key = Object2ReferenceOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  562 */         pos = (last = pos) + 1 & Object2ReferenceOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  564 */           if ((curr = key[pos]) == null) {
/*  565 */             key[last] = null;
/*  566 */             Object2ReferenceOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  569 */           int slot = HashCommon.mix(Object2ReferenceOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ReferenceOpenCustomHashMap.this.mask;
/*  570 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  572 */           pos = pos + 1 & Object2ReferenceOpenCustomHashMap.this.mask;
/*      */         } 
/*  574 */         if (pos < last) {
...
/*      */         } 
/*  579 */         key[last] = curr;
/*  580 */         Object2ReferenceOpenCustomHashMap.this.value[last] = Object2ReferenceOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  584 */       if (this.last == -1)
/*  585 */         throw new IllegalStateException(); 
/*  586 */       if (this.last == Object2ReferenceOpenCustomHashMap.this.n) {
/*  587 */         Object2ReferenceOpenCustomHashMap.this.containsNullKey = false;
/*  588 */         Object2ReferenceOpenCustomHashMap.this.key[Object2ReferenceOpenCustomHashMap.this.n] = null;
/*  589 */         Object2ReferenceOpenCustomHashMap.this.value[Object2ReferenceOpenCustomHashMap.this.n] = null;
/*  590 */       } else if (this.pos >= 0) {
/*  591 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  594 */         Object2ReferenceOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, null));
/*  595 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  598 */       Object2ReferenceOpenCustomHashMap.this.size--;
/*  599 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*  614 */       return this.entry = new Object2ReferenceOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  623 */       this.entry = new Object2ReferenceOpenCustomHashMap.MapEntry();
...
/*  635 */       return new Object2ReferenceOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Object2ReferenceMap.Entry<K, V>> fastIterator() {
/*  639 */       return new Object2ReferenceOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  649 */       if (Object2ReferenceOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  650 */         return (Object2ReferenceOpenCustomHashMap.this.containsNullKey && Object2ReferenceOpenCustomHashMap.this.value[Object2ReferenceOpenCustomHashMap.this.n] == v);
/*      */       }
/*  652 */       K[] key = Object2ReferenceOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  655 */       if ((curr = key[pos = HashCommon.mix(Object2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ReferenceOpenCustomHashMap.this.mask]) == null)
/*  656 */         return false; 
/*  657 */       if (Object2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  658 */         return (Object2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  661 */         if ((curr = key[pos = pos + 1 & Object2ReferenceOpenCustomHashMap.this.mask]) == null)
/*  662 */           return false; 
/*  663 */         if (Object2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  664 */           return (Object2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  675 */       if (Object2ReferenceOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  676 */         if (Object2ReferenceOpenCustomHashMap.this.containsNullKey && Object2ReferenceOpenCustomHashMap.this.value[Object2ReferenceOpenCustomHashMap.this.n] == v) {
/*  677 */           Object2ReferenceOpenCustomHashMap.this.removeNullEntry();
/*  678 */           return true;
/*      */         } 
/*  680 */         return false;
/*      */       } 
/*      */       
/*  683 */       K[] key = Object2ReferenceOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  686 */       if ((curr = key[pos = HashCommon.mix(Object2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ReferenceOpenCustomHashMap.this.mask]) == null)
/*  687 */         return false; 
/*  688 */       if (Object2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  689 */         if (Object2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/*  690 */           Object2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/*  691 */           return true;
/*      */         } 
/*  693 */         return false;
/*      */       } 
/*      */       while (true) {
/*  696 */         if ((curr = key[pos = pos + 1 & Object2ReferenceOpenCustomHashMap.this.mask]) == null)
/*  697 */           return false; 
/*  698 */         if (Object2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  699 */           Object2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/*  700 */           Object2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/*  701 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  708 */       return Object2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  712 */       Object2ReferenceOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
/*  717 */       if (Object2ReferenceOpenCustomHashMap.this.containsNullKey)
/*  718 */         consumer.accept(new AbstractObject2ReferenceMap.BasicEntry<>(Object2ReferenceOpenCustomHashMap.this.key[Object2ReferenceOpenCustomHashMap.this.n], Object2ReferenceOpenCustomHashMap.this.value[Object2ReferenceOpenCustomHashMap.this.n])); 
/*  719 */       for (int pos = Object2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) {
/*  720 */         if (Object2ReferenceOpenCustomHashMap.this.key[pos] != null)
/*  721 */           consumer.accept(new AbstractObject2ReferenceMap.BasicEntry<>(Object2ReferenceOpenCustomHashMap.this.key[pos], Object2ReferenceOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
/*  726 */       AbstractObject2ReferenceMap.BasicEntry<K, V> entry = new AbstractObject2ReferenceMap.BasicEntry<>();
/*  727 */       if (Object2ReferenceOpenCustomHashMap.this.containsNullKey) {
/*  728 */         entry.key = Object2ReferenceOpenCustomHashMap.this.key[Object2ReferenceOpenCustomHashMap.this.n];
/*  729 */         entry.value = Object2ReferenceOpenCustomHashMap.this.value[Object2ReferenceOpenCustomHashMap.this.n];
/*  730 */         consumer.accept(entry);
/*      */       } 
/*  732 */       for (int pos = Object2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) {
/*  733 */         if (Object2ReferenceOpenCustomHashMap.this.key[pos] != null) {
/*  734 */           entry.key = Object2ReferenceOpenCustomHashMap.this.key[pos];
/*  735 */           entry.value = Object2ReferenceOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  761 */       return Object2ReferenceOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  767 */       return new Object2ReferenceOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  772 */       if (Object2ReferenceOpenCustomHashMap.this.containsNullKey)
/*  773 */         consumer.accept(Object2ReferenceOpenCustomHashMap.this.key[Object2ReferenceOpenCustomHashMap.this.n]); 
/*  774 */       for (int pos = Object2ReferenceOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  775 */         K k = Object2ReferenceOpenCustomHashMap.this.key[pos];
/*  776 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/*  782 */       return Object2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/*  786 */       return Object2ReferenceOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/*  790 */       int oldSize = Object2ReferenceOpenCustomHashMap.this.size;
/*  791 */       Object2ReferenceOpenCustomHashMap.this.remove(k);
/*  792 */       return (Object2ReferenceOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  796 */       Object2ReferenceOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*      */   {
/*      */     public V next() {
/*  820 */       return Object2ReferenceOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*  829 */             return new Object2ReferenceOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/*  833 */             return Object2ReferenceOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(Object v) {
/*  837 */             return Object2ReferenceOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/*  841 */             Object2ReferenceOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer)
/*      */           {
/*  846 */             if (Object2ReferenceOpenCustomHashMap.this.containsNullKey)
/*  847 */               consumer.accept(Object2ReferenceOpenCustomHashMap.this.value[Object2ReferenceOpenCustomHashMap.this.n]); 
/*  848 */             for (int pos = Object2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) {
/*  849 */               if (Object2ReferenceOpenCustomHashMap.this.key[pos] != null)
/*  850 */                 consumer.accept(Object2ReferenceOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/*  961 */       c = (Object2ReferenceOpenCustomHashMap<K, V>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ReferenceOpenCustomHashMap.class
