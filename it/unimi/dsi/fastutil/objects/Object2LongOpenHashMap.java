...
/*      */   
/*      */   public boolean trim() {
/* 1054 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1055 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1056 */       return true; 
/*      */     try {
/* 1058 */       rehash(l);
/* 1059 */     } catch (OutOfMemoryError cantDoIt) {
/* 1060 */       return false;
/*      */     } 
/* 1062 */     return true;
/*      */   }
...
/* 1086 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1087 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1088 */       return true; 
/*      */     try {
/* 1090 */       rehash(l);
/* 1091 */     } catch (OutOfMemoryError cantDoIt) {
/* 1092 */       return false;
/*      */     } 
/* 1094 */     return true;
/*      */   }
...
/* 1110 */     K[] key = this.key;
/* 1111 */     long[] value = this.value;
/* 1112 */     int mask = newN - 1;
/* 1113 */     K[] newKey = (K[])new Object[newN + 1];
/* 1114 */     long[] newValue = new long[newN + 1];
/* 1115 */     int i = this.n;
/* 1116 */     for (int j = realSize(); j-- != 0; ) {
/* 1117 */       while (key[--i] == null); int pos;
/* 1118 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null)
/* 1119 */         while (newKey[pos = pos + 1 & mask] != null); 
/* 1120 */       newKey[pos] = key[i];
/* 1121 */       newValue[pos] = value[i];
/*      */     } 
/* 1123 */     newValue[newN] = value[this.n];
/* 1124 */     this.n = newN;
/* 1125 */     this.mask = mask;
/* 1126 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1127 */     this.key = newKey;
/* 1128 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1145 */       c = (Object2LongOpenHashMap<K>)super.clone();
/* 1146 */     } catch (CloneNotSupportedException cantHappen) {
/* 1147 */       throw new InternalError();
/*      */     } 
/* 1149 */     c.keys = null;
/* 1150 */     c.values = null;
/* 1151 */     c.entries = null;
/* 1152 */     c.containsNullKey = this.containsNullKey;
/* 1153 */     c.key = (K[])this.key.clone();
/* 1154 */     c.value = (long[])this.value.clone();
/* 1155 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1168 */     int h = 0;
/* 1169 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1170 */       while (this.key[i] == null)
/* 1171 */         i++; 
/* 1172 */       if (this != this.key[i])
/* 1173 */         t = this.key[i].hashCode(); 
/* 1174 */       t ^= HashCommon.long2int(this.value[i]);
/* 1175 */       h += t;
/* 1176 */       i++;
/*      */     } 
/*      */     
/* 1179 */     if (this.containsNullKey)
/* 1180 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1181 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1184 */     K[] key = this.key;
/* 1185 */     long[] value = this.value;
/* 1186 */     MapIterator i = new MapIterator();
/* 1187 */     s.defaultWriteObject();
/* 1188 */     for (int j = this.size; j-- != 0; ) {
/* 1189 */       int e = i.nextEntry();
/* 1190 */       s.writeObject(key[e]);
/* 1191 */       s.writeLong(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1196 */     s.defaultReadObject();
/* 1197 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1198 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1199 */     this.mask = this.n - 1;
/* 1200 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1201 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1204 */     for (int i = this.size; i-- != 0; ) {
/* 1205 */       int pos; K k = (K)s.readObject();
/* 1206 */       long v = s.readLong();
/* 1207 */       if (k == null) {
/* 1208 */         pos = this.n;
/* 1209 */         this.containsNullKey = true;
/*      */       } else {
/* 1211 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1212 */         while (key[pos] != null)
/* 1213 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1215 */       key[pos] = k;
/* 1216 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2LongOpenHashMap.class
