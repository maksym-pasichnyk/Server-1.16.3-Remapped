...
/*      */   
/*      */   public boolean trim() {
/* 1056 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1057 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1058 */       return true; 
/*      */     try {
/* 1060 */       rehash(l);
/* 1061 */     } catch (OutOfMemoryError cantDoIt) {
/* 1062 */       return false;
/*      */     } 
/* 1064 */     return true;
/*      */   }
...
/* 1088 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1089 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1090 */       return true; 
/*      */     try {
/* 1092 */       rehash(l);
...
/* 1112 */     K[] key = this.key;
/* 1113 */     double[] value = this.value;
/* 1114 */     int mask = newN - 1;
/* 1115 */     K[] newKey = (K[])new Object[newN + 1];
/* 1116 */     double[] newValue = new double[newN + 1];
/* 1117 */     int i = this.n;
/* 1118 */     for (int j = realSize(); j-- != 0; ) {
/* 1119 */       while (key[--i] == null); int pos;
/* 1120 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null)
...
/*      */     try {
/* 1147 */       c = (Object2DoubleOpenHashMap<K>)super.clone();
...
/* 1156 */     c.value = (double[])this.value.clone();
/* 1157 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1175 */         t = this.key[i].hashCode(); 
/* 1176 */       t ^= HashCommon.double2int(this.value[i]);
/* 1177 */       h += t;
/* 1178 */       i++;
/*      */     } 
/*      */     
/* 1181 */     if (this.containsNullKey)
/* 1182 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1183 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1186 */     K[] key = this.key;
/* 1187 */     double[] value = this.value;
...
/* 1203 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1206 */     for (int i = this.size; i-- != 0; ) {
/* 1207 */       int pos; K k = (K)s.readObject();
/* 1208 */       double v = s.readDouble();
/* 1209 */       if (k == null) {
/* 1210 */         pos = this.n;
/* 1211 */         this.containsNullKey = true;
/*      */       } else {
/* 1213 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2DoubleOpenHashMap.class
