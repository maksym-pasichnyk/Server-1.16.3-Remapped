...
/*      */   
/*      */   public boolean trim() {
/* 1749 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1750 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1751 */       return true; 
/*      */     try {
/* 1753 */       rehash(l);
/* 1754 */     } catch (OutOfMemoryError cantDoIt) {
/* 1755 */       return false;
/*      */     } 
/* 1757 */     return true;
/*      */   }
...
/* 1781 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1782 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1783 */       return true; 
/*      */     try {
/* 1785 */       rehash(l);
...
/* 1805 */     K[] key = this.key;
/* 1806 */     double[] value = this.value;
/* 1807 */     int mask = newN - 1;
/* 1808 */     K[] newKey = (K[])new Object[newN + 1];
/* 1809 */     double[] newValue = new double[newN + 1];
/* 1810 */     int i = this.first, prev = -1, newPrev = -1;
/* 1811 */     long[] link = this.link;
/* 1812 */     long[] newLink = new long[newN + 1];
/* 1813 */     this.first = -1;
/* 1814 */     for (int j = this.size; j-- != 0; ) {
/* 1815 */       int pos; if (key[i] == null) {
/* 1816 */         pos = newN;
/*      */       } else {
/* 1818 */         pos = HashCommon.mix(System.identityHashCode(key[i])) & mask;
/* 1819 */         while (newKey[pos] != null)
/* 1820 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1822 */       newKey[pos] = key[i];
/* 1823 */       newValue[pos] = value[i];
/* 1824 */       if (prev != -1) {
/* 1825 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1826 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1827 */         newPrev = pos;
/*      */       } else {
/* 1829 */         newPrev = this.first = pos;
/*      */         
/* 1831 */         newLink[pos] = -1L;
/*      */       } 
/* 1833 */       int t = i;
...
/* 1835 */       prev = t;
/*      */     } 
/* 1837 */     this.link = newLink;
/* 1838 */     this.last = newPrev;
/* 1839 */     if (newPrev != -1)
/*      */     {
/* 1841 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1842 */     this.n = newN;
/* 1843 */     this.mask = mask;
/* 1844 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1845 */     this.key = newKey;
/* 1846 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1863 */       c = (Reference2DoubleLinkedOpenHashMap<K>)super.clone();
/* 1864 */     } catch (CloneNotSupportedException cantHappen) {
/* 1865 */       throw new InternalError();
/*      */     } 
/* 1867 */     c.keys = null;
/* 1868 */     c.values = null;
/* 1869 */     c.entries = null;
/* 1870 */     c.containsNullKey = this.containsNullKey;
/* 1871 */     c.key = (K[])this.key.clone();
/* 1872 */     c.value = (double[])this.value.clone();
/* 1873 */     c.link = (long[])this.link.clone();
/* 1874 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1887 */     int h = 0;
/* 1888 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1889 */       while (this.key[i] == null)
/* 1890 */         i++; 
/* 1891 */       if (this != this.key[i])
/* 1892 */         t = System.identityHashCode(this.key[i]); 
/* 1893 */       t ^= HashCommon.double2int(this.value[i]);
/* 1894 */       h += t;
/* 1895 */       i++;
/*      */     } 
/*      */     
/* 1898 */     if (this.containsNullKey)
/* 1899 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1900 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1903 */     K[] key = this.key;
/* 1904 */     double[] value = this.value;
/* 1905 */     MapIterator i = new MapIterator();
/* 1906 */     s.defaultWriteObject();
/* 1907 */     for (int j = this.size; j-- != 0; ) {
/* 1908 */       int e = i.nextEntry();
/* 1909 */       s.writeObject(key[e]);
/* 1910 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1915 */     s.defaultReadObject();
/* 1916 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1917 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1918 */     this.mask = this.n - 1;
/* 1919 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1920 */     double[] value = this.value = new double[this.n + 1];
/* 1921 */     long[] link = this.link = new long[this.n + 1];
/* 1922 */     int prev = -1;
/* 1923 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1926 */     for (int i = this.size; i-- != 0; ) {
/* 1927 */       int pos; K k = (K)s.readObject();
/* 1928 */       double v = s.readDouble();
/* 1929 */       if (k == null) {
/* 1930 */         pos = this.n;
/* 1931 */         this.containsNullKey = true;
/*      */       } else {
/* 1933 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1934 */         while (key[pos] != null)
/* 1935 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1937 */       key[pos] = k;
/* 1938 */       value[pos] = v;
/* 1939 */       if (this.first != -1) {
/* 1940 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1941 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1942 */         prev = pos; continue;
/*      */       } 
/* 1944 */       prev = this.first = pos;
/*      */       
/* 1946 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1949 */     this.last = prev;
/* 1950 */     if (prev != -1)
/*      */     {
/* 1952 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2DoubleLinkedOpenHashMap.class
