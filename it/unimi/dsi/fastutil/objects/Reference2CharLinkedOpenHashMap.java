...
/*      */   
/*      */   public boolean trim() {
/* 1688 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1689 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1690 */       return true; 
/*      */     try {
/* 1692 */       rehash(l);
/* 1693 */     } catch (OutOfMemoryError cantDoIt) {
/* 1694 */       return false;
/*      */     } 
/* 1696 */     return true;
/*      */   }
...
/* 1720 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1721 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1722 */       return true; 
/*      */     try {
/* 1724 */       rehash(l);
...
/* 1744 */     K[] key = this.key;
/* 1745 */     char[] value = this.value;
/* 1746 */     int mask = newN - 1;
/* 1747 */     K[] newKey = (K[])new Object[newN + 1];
/* 1748 */     char[] newValue = new char[newN + 1];
/* 1749 */     int i = this.first, prev = -1, newPrev = -1;
/* 1750 */     long[] link = this.link;
/* 1751 */     long[] newLink = new long[newN + 1];
/* 1752 */     this.first = -1;
/* 1753 */     for (int j = this.size; j-- != 0; ) {
/* 1754 */       int pos; if (key[i] == null) {
/* 1755 */         pos = newN;
/*      */       } else {
/* 1757 */         pos = HashCommon.mix(System.identityHashCode(key[i])) & mask;
/* 1758 */         while (newKey[pos] != null)
/* 1759 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1761 */       newKey[pos] = key[i];
/* 1762 */       newValue[pos] = value[i];
/* 1763 */       if (prev != -1) {
/* 1764 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1765 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1766 */         newPrev = pos;
/*      */       } else {
/* 1768 */         newPrev = this.first = pos;
/*      */         
/* 1770 */         newLink[pos] = -1L;
/*      */       } 
/* 1772 */       int t = i;
...
/* 1774 */       prev = t;
/*      */     } 
/* 1776 */     this.link = newLink;
/* 1777 */     this.last = newPrev;
/* 1778 */     if (newPrev != -1)
/*      */     {
/* 1780 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1781 */     this.n = newN;
/* 1782 */     this.mask = mask;
/* 1783 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1784 */     this.key = newKey;
/* 1785 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1802 */       c = (Reference2CharLinkedOpenHashMap<K>)super.clone();
/* 1803 */     } catch (CloneNotSupportedException cantHappen) {
/* 1804 */       throw new InternalError();
/*      */     } 
/* 1806 */     c.keys = null;
/* 1807 */     c.values = null;
/* 1808 */     c.entries = null;
/* 1809 */     c.containsNullKey = this.containsNullKey;
/* 1810 */     c.key = (K[])this.key.clone();
/* 1811 */     c.value = (char[])this.value.clone();
/* 1812 */     c.link = (long[])this.link.clone();
/* 1813 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1826 */     int h = 0;
/* 1827 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1828 */       while (this.key[i] == null)
/* 1829 */         i++; 
/* 1830 */       if (this != this.key[i])
/* 1831 */         t = System.identityHashCode(this.key[i]); 
/* 1832 */       t ^= this.value[i];
/* 1833 */       h += t;
/* 1834 */       i++;
/*      */     } 
/*      */     
/* 1837 */     if (this.containsNullKey)
/* 1838 */       h += this.value[this.n]; 
/* 1839 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1842 */     K[] key = this.key;
/* 1843 */     char[] value = this.value;
/* 1844 */     MapIterator i = new MapIterator();
/* 1845 */     s.defaultWriteObject();
/* 1846 */     for (int j = this.size; j-- != 0; ) {
/* 1847 */       int e = i.nextEntry();
/* 1848 */       s.writeObject(key[e]);
/* 1849 */       s.writeChar(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1854 */     s.defaultReadObject();
/* 1855 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1856 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1857 */     this.mask = this.n - 1;
/* 1858 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1859 */     char[] value = this.value = new char[this.n + 1];
/* 1860 */     long[] link = this.link = new long[this.n + 1];
/* 1861 */     int prev = -1;
/* 1862 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1865 */     for (int i = this.size; i-- != 0; ) {
/* 1866 */       int pos; K k = (K)s.readObject();
/* 1867 */       char v = s.readChar();
/* 1868 */       if (k == null) {
/* 1869 */         pos = this.n;
/* 1870 */         this.containsNullKey = true;
/*      */       } else {
/* 1872 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1873 */         while (key[pos] != null)
/* 1874 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1876 */       key[pos] = k;
/* 1877 */       value[pos] = v;
/* 1878 */       if (this.first != -1) {
/* 1879 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1880 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1881 */         prev = pos; continue;
/*      */       } 
/* 1883 */       prev = this.first = pos;
/*      */       
/* 1885 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1888 */     this.last = prev;
/* 1889 */     if (prev != -1)
/*      */     {
/* 1891 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2CharLinkedOpenHashMap.class
