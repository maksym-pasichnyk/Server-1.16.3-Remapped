...
/*  268 */     Entry<K> e = add(k);
/*  269 */     char oldValue = e.value;
/*  270 */     e.value = (char)(e.value + incr);
/*  271 */     return oldValue;
/*      */   }
/*      */   
/*      */   public char put(K k, char v) {
/*  275 */     Entry<K> e = add(k);
/*  276 */     char oldValue = e.value;
/*  277 */     e.value = v;
/*  278 */     return oldValue;
/*      */   }
/*      */ 
...
/*  957 */         return false; 
/*  958 */       Map.Entry<K, Character> e = (Map.Entry<K, Character>)o;
/*  959 */       return (Objects.equals(this.key, e.getKey()) && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1045 */     int index = 0;
/*      */     TreeIterator() {
/* 1047 */       this.next = Object2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(K k) {
/* 1050 */       if ((this.next = Object2CharAVLTreeMap.this.locateKey(k)) != null)
/* 1051 */         if (Object2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1102 */       updatePrevious();
/* 1103 */       updateNext();
/* 1104 */       Object2CharAVLTreeMap.this.removeChar(this.curr.key);
/* 1105 */       this.curr = null;
/*      */     }
...
/* 1152 */       this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2CharMap.Entry<Object2CharMap.Entry<K>>>()
/*      */         {
...
/* 1161 */             return new Object2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator(Object2CharMap.Entry<K> from) {
/* 1166 */             return new Object2CharAVLTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1174 */             if (e.getValue() == null || !(e.getValue() instanceof Character))
/* 1175 */               return false; 
/* 1176 */             Object2CharAVLTreeMap.Entry<K> f = Object2CharAVLTreeMap.this.findKey((K)e.getKey());
...
/* 1186 */               return false; 
/* 1187 */             Object2CharAVLTreeMap.Entry<K> f = Object2CharAVLTreeMap.this.findKey((K)e.getKey());
/* 1188 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1189 */               return false; 
/* 1190 */             Object2CharAVLTreeMap.this.removeChar(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Object2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Object2CharAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Object2CharMap.Entry<K> first() {
/* 1203 */             return Object2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Object2CharMap.Entry<K> last() {
/* 1207 */             return Object2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> from, Object2CharMap.Entry<K> to) {
/* 1212 */             return Object2CharAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> to) {
/* 1216 */             return Object2CharAVLTreeMap.this.headMap(to.getKey()).object2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2CharMap.Entry<K>> tailSet(Object2CharMap.Entry<K> from) {
/* 1220 */             return Object2CharAVLTreeMap.this.tailMap(from.getKey()).object2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1254 */       return new Object2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1258 */       return new Object2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1313 */             return (CharIterator)new Object2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1317 */             return Object2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1321 */             return Object2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1325 */             Object2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1388 */       if (!bottom && !top && Object2CharAVLTreeMap.this.compare(from, to) > 0)
/* 1389 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1390 */       this.from = from;
/* 1391 */       this.bottom = bottom;
/* 1392 */       this.to = to;
/* 1393 */       this.top = top;
/* 1394 */       this.defRetValue = Object2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1412 */       return ((this.bottom || Object2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2CharAVLTreeMap.this
/* 1413 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
/* 1417 */       if (this.entries == null)
/* 1418 */         this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2CharMap.Entry<Object2CharMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator() {
/* 1421 */               return new Object2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator(Object2CharMap.Entry<K> from) {
/* 1426 */               return new Object2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Object2CharMap.Entry<K>> comparator() {
/* 1430 */               return Object2CharAVLTreeMap.this.object2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Object2CharAVLTreeMap.Entry<K> f = Object2CharAVLTreeMap.this.findKey((K)e.getKey());
/* 1441 */               return (f != null && Object2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1449 */               if (e.getValue() == null || !(e.getValue() instanceof Character))
/* 1450 */                 return false; 
/* 1451 */               Object2CharAVLTreeMap.Entry<K> f = Object2CharAVLTreeMap.this.findKey((K)e.getKey());
/* 1452 */               if (f != null && Object2CharAVLTreeMap.Submap.this.in(f.key))
/* 1453 */                 Object2CharAVLTreeMap.Submap.this.removeChar(f.key); 
/* 1454 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1465 */               return !(new Object2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1469 */               Object2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Object2CharMap.Entry<K> first() {
/* 1473 */               return Object2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Object2CharMap.Entry<K> last() {
/* 1477 */               return Object2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> from, Object2CharMap.Entry<K> to) {
/* 1482 */               return Object2CharAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> to) {
/* 1486 */               return Object2CharAVLTreeMap.Submap.this.headMap(to.getKey()).object2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2CharMap.Entry<K>> tailSet(Object2CharMap.Entry<K> from) {
/* 1490 */               return Object2CharAVLTreeMap.Submap.this.tailMap(from.getKey()).object2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractObject2CharSortedMap<K>.KeySet {
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1498 */         return new Object2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1502 */         return new Object2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<K> keySet() {
...
/* 1514 */         this.values = (CharCollection)new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1517 */               return (CharIterator)new Object2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1521 */               return Object2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1525 */               return Object2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1529 */               Object2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(Object k) {
/* 1537 */       return (in((K)k) && Object2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/* 1544 */         char ev = (i.nextEntry()).value;
/* 1545 */         if (ev == v)
/* 1546 */           return true; 
/*      */       } 
/* 1548 */       return false;
...
/*      */     
/*      */     public char getChar(Object k) {
/* 1554 */       K kk = (K)k; Object2CharAVLTreeMap.Entry<K> e;
/* 1555 */       return (in(kk) && (e = Object2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(K k, char v) {
/* 1559 */       Object2CharAVLTreeMap.this.modified = false;
/* 1560 */       if (!in(k))
...
/* 1563 */       char oldValue = Object2CharAVLTreeMap.this.put(k, v);
/* 1564 */       return Object2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char removeChar(Object k) {
/* 1569 */       Object2CharAVLTreeMap.this.modified = false;
/* 1570 */       if (!in((K)k))
/* 1571 */         return this.defRetValue; 
/* 1572 */       char oldValue = Object2CharAVLTreeMap.this.removeChar(k);
/* 1573 */       return Object2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1591 */       return Object2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Object2CharSortedMap<K> headMap(K to) {
/* 1595 */       if (this.top)
/* 1596 */         return new Submap(this.from, this.bottom, to, false); 
/* 1597 */       return (Object2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Object2CharSortedMap<K> tailMap(K from) {
/* 1601 */       if (this.bottom)
/* 1602 */         return new Submap(from, false, this.to, this.top); 
/* 1603 */       return (Object2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Object2CharSortedMap<K> subMap(K from, K to) {
...
/* 1609 */       if (!this.top)
/* 1610 */         to = (Object2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1611 */       if (!this.bottom)
/* 1612 */         from = (Object2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1624 */       if (Object2CharAVLTreeMap.this.tree == null) {
/* 1625 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1629 */       if (this.bottom) {
/* 1630 */         e = Object2CharAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1632 */         e = Object2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1634 */         if (Object2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1635 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1639 */       if (e == null || (!this.top && Object2CharAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1640 */         return null; 
/* 1641 */       return e;
/*      */     }
/*      */ 
...
/*      */       Object2CharAVLTreeMap.Entry<K> e;
/* 1650 */       if (Object2CharAVLTreeMap.this.tree == null) {
/* 1651 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1655 */       if (this.top) {
/* 1656 */         e = Object2CharAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1658 */         e = Object2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1660 */         if (Object2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1661 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1665 */       if (e == null || (!this.bottom && Object2CharAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1666 */         return null; 
/* 1667 */       return e;
/*      */     }
/*      */     
/*      */     public K firstKey() {
/* 1671 */       Object2CharAVLTreeMap.Entry<K> e = firstEntry();
/* 1672 */       if (e == null)
...
/*      */     
/*      */     public K lastKey() {
/* 1678 */       Object2CharAVLTreeMap.Entry<K> e = lastEntry();
/* 1679 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1694 */         this.next = Object2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(K k) {
/* 1697 */         this();
/* 1698 */         if (this.next != null)
/* 1699 */           if (!Object2CharAVLTreeMap.Submap.this.bottom && Object2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1700 */             this.prev = null;
/* 1701 */           } else if (!Object2CharAVLTreeMap.Submap.this.top && Object2CharAVLTreeMap.this.compare(k, (this.prev = Object2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1702 */             this.next = null;
/*      */           } else {
/* 1704 */             this.next = Object2CharAVLTreeMap.this.locateKey(k);
/* 1705 */             if (Object2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1716 */         if (!Object2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Object2CharAVLTreeMap.this.compare(this.prev.key, Object2CharAVLTreeMap.Submap.this.from) < 0)
/* 1717 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1721 */         this.next = this.next.next();
/* 1722 */         if (!Object2CharAVLTreeMap.Submap.this.top && this.next != null && Object2CharAVLTreeMap.this.compare(this.next.key, Object2CharAVLTreeMap.Submap.this.to) >= 0)
/* 1723 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1805 */       c = (Object2CharAVLTreeMap<K>)super.clone();
...
/* 1886 */     if (n == 1) {
/* 1887 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readChar());
...
/*      */ 
/*      */       
/* 1897 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readChar());
/* 1898 */       entry.right(new Entry<>((K)s.readObject(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2CharAVLTreeMap.class
