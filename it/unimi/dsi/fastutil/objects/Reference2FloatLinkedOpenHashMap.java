...
/*      */   
/*      */   public boolean trim() {
/* 1748 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1749 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1750 */       return true; 
/*      */     try {
/* 1752 */       rehash(l);
...
/* 1780 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1781 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1782 */       return true; 
/*      */     try {
/* 1784 */       rehash(l);
/* 1785 */     } catch (OutOfMemoryError cantDoIt) {
/* 1786 */       return false;
/*      */     } 
/* 1788 */     return true;
/*      */   }
...
/* 1804 */     K[] key = this.key;
/* 1805 */     float[] value = this.value;
/* 1806 */     int mask = newN - 1;
/* 1807 */     K[] newKey = (K[])new Object[newN + 1];
/* 1808 */     float[] newValue = new float[newN + 1];
...
/* 1814 */       int pos; if (key[i] == null) {
/* 1815 */         pos = newN;
/*      */       } else {
/* 1817 */         pos = HashCommon.mix(System.identityHashCode(key[i])) & mask;
/* 1818 */         while (newKey[pos] != null)
/* 1819 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1821 */       newKey[pos] = key[i];
/* 1822 */       newValue[pos] = value[i];
/* 1823 */       if (prev != -1) {
/* 1824 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1825 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1826 */         newPrev = pos;
/*      */       } else {
/* 1828 */         newPrev = this.first = pos;
/*      */         
/* 1830 */         newLink[pos] = -1L;
/*      */       } 
/* 1832 */       int t = i;
...
/* 1834 */       prev = t;
/*      */     } 
/* 1836 */     this.link = newLink;
/* 1837 */     this.last = newPrev;
/* 1838 */     if (newPrev != -1)
/*      */     {
/* 1840 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1841 */     this.n = newN;
/* 1842 */     this.mask = mask;
/* 1843 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1844 */     this.key = newKey;
/* 1845 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1862 */       c = (Reference2FloatLinkedOpenHashMap<K>)super.clone();
/* 1863 */     } catch (CloneNotSupportedException cantHappen) {
/* 1864 */       throw new InternalError();
/*      */     } 
/* 1866 */     c.keys = null;
/* 1867 */     c.values = null;
/* 1868 */     c.entries = null;
/* 1869 */     c.containsNullKey = this.containsNullKey;
/* 1870 */     c.key = (K[])this.key.clone();
/* 1871 */     c.value = (float[])this.value.clone();
/* 1872 */     c.link = (long[])this.link.clone();
/* 1873 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1886 */     int h = 0;
/* 1887 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1888 */       while (this.key[i] == null)
/* 1889 */         i++; 
/* 1890 */       if (this != this.key[i])
/* 1891 */         t = System.identityHashCode(this.key[i]); 
/* 1892 */       t ^= HashCommon.float2int(this.value[i]);
/* 1893 */       h += t;
/* 1894 */       i++;
/*      */     } 
/*      */     
/* 1897 */     if (this.containsNullKey)
/* 1898 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1899 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1902 */     K[] key = this.key;
/* 1903 */     float[] value = this.value;
/* 1904 */     MapIterator i = new MapIterator();
/* 1905 */     s.defaultWriteObject();
/* 1906 */     for (int j = this.size; j-- != 0; ) {
/* 1907 */       int e = i.nextEntry();
/* 1908 */       s.writeObject(key[e]);
/* 1909 */       s.writeFloat(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1914 */     s.defaultReadObject();
/* 1915 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1916 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1917 */     this.mask = this.n - 1;
/* 1918 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1919 */     float[] value = this.value = new float[this.n + 1];
/* 1920 */     long[] link = this.link = new long[this.n + 1];
/* 1921 */     int prev = -1;
/* 1922 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1925 */     for (int i = this.size; i-- != 0; ) {
/* 1926 */       int pos; K k = (K)s.readObject();
/* 1927 */       float v = s.readFloat();
/* 1928 */       if (k == null) {
/* 1929 */         pos = this.n;
/* 1930 */         this.containsNullKey = true;
/*      */       } else {
/* 1932 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1933 */         while (key[pos] != null)
/* 1934 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1936 */       key[pos] = k;
/* 1937 */       value[pos] = v;
/* 1938 */       if (this.first != -1) {
/* 1939 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1940 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1941 */         prev = pos; continue;
/*      */       } 
/* 1943 */       prev = this.first = pos;
/*      */       
/* 1945 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1948 */     this.last = prev;
/* 1949 */     if (prev != -1)
/*      */     {
/* 1951 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2FloatLinkedOpenHashMap.class
