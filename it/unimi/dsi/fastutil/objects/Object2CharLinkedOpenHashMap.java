...
/*      */   
/*      */   public boolean trim() {
/* 1685 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1686 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1687 */       return true; 
/*      */     try {
/* 1689 */       rehash(l);
/* 1690 */     } catch (OutOfMemoryError cantDoIt) {
/* 1691 */       return false;
/*      */     } 
/* 1693 */     return true;
/*      */   }
...
/* 1717 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1718 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1719 */       return true; 
/*      */     try {
/* 1721 */       rehash(l);
/* 1722 */     } catch (OutOfMemoryError cantDoIt) {
/* 1723 */       return false;
/*      */     } 
/* 1725 */     return true;
/*      */   }
...
/* 1741 */     K[] key = this.key;
/* 1742 */     char[] value = this.value;
/* 1743 */     int mask = newN - 1;
/* 1744 */     K[] newKey = (K[])new Object[newN + 1];
/* 1745 */     char[] newValue = new char[newN + 1];
/* 1746 */     int i = this.first, prev = -1, newPrev = -1;
/* 1747 */     long[] link = this.link;
/* 1748 */     long[] newLink = new long[newN + 1];
/* 1749 */     this.first = -1;
/* 1750 */     for (int j = this.size; j-- != 0; ) {
/* 1751 */       int pos; if (key[i] == null) {
/* 1752 */         pos = newN;
/*      */       } else {
/* 1754 */         pos = HashCommon.mix(key[i].hashCode()) & mask;
/* 1755 */         while (newKey[pos] != null)
/* 1756 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1758 */       newKey[pos] = key[i];
/* 1759 */       newValue[pos] = value[i];
/* 1760 */       if (prev != -1) {
/* 1761 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1762 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1763 */         newPrev = pos;
/*      */       } else {
/* 1765 */         newPrev = this.first = pos;
/*      */         
/* 1767 */         newLink[pos] = -1L;
/*      */       } 
/* 1769 */       int t = i;
...
/* 1771 */       prev = t;
/*      */     } 
/* 1773 */     this.link = newLink;
/* 1774 */     this.last = newPrev;
/* 1775 */     if (newPrev != -1)
/*      */     {
/* 1777 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1778 */     this.n = newN;
/* 1779 */     this.mask = mask;
/* 1780 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1781 */     this.key = newKey;
/* 1782 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1799 */       c = (Object2CharLinkedOpenHashMap<K>)super.clone();
...
/* 1804 */     c.values = null;
/* 1805 */     c.entries = null;
/* 1806 */     c.containsNullKey = this.containsNullKey;
/* 1807 */     c.key = (K[])this.key.clone();
/* 1808 */     c.value = (char[])this.value.clone();
/* 1809 */     c.link = (long[])this.link.clone();
/* 1810 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1823 */     int h = 0;
/* 1824 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1825 */       while (this.key[i] == null)
/* 1826 */         i++; 
/* 1827 */       if (this != this.key[i])
/* 1828 */         t = this.key[i].hashCode(); 
/* 1829 */       t ^= this.value[i];
/* 1830 */       h += t;
/* 1831 */       i++;
/*      */     } 
/*      */     
/* 1834 */     if (this.containsNullKey)
/* 1835 */       h += this.value[this.n]; 
/* 1836 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1839 */     K[] key = this.key;
/* 1840 */     char[] value = this.value;
/* 1841 */     MapIterator i = new MapIterator();
/* 1842 */     s.defaultWriteObject();
/* 1843 */     for (int j = this.size; j-- != 0; ) {
/* 1844 */       int e = i.nextEntry();
/* 1845 */       s.writeObject(key[e]);
/* 1846 */       s.writeChar(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1851 */     s.defaultReadObject();
/* 1852 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1853 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1854 */     this.mask = this.n - 1;
/* 1855 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1856 */     char[] value = this.value = new char[this.n + 1];
/* 1857 */     long[] link = this.link = new long[this.n + 1];
/* 1858 */     int prev = -1;
/* 1859 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1862 */     for (int i = this.size; i-- != 0; ) {
/* 1863 */       int pos; K k = (K)s.readObject();
/* 1864 */       char v = s.readChar();
/* 1865 */       if (k == null) {
/* 1866 */         pos = this.n;
/* 1867 */         this.containsNullKey = true;
/*      */       } else {
/* 1869 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1870 */         while (key[pos] != null)
/* 1871 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1873 */       key[pos] = k;
/* 1874 */       value[pos] = v;
/* 1875 */       if (this.first != -1) {
/* 1876 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1877 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1878 */         prev = pos; continue;
/*      */       } 
/* 1880 */       prev = this.first = pos;
/*      */       
/* 1882 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1885 */     this.last = prev;
/* 1886 */     if (prev != -1)
/*      */     {
/* 1888 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2CharLinkedOpenHashMap.class
