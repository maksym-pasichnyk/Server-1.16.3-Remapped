...
/* 1568 */     int len = to - from;
/*      */     
/* 1570 */     if (len < 16) {
/* 1571 */       insertionSort(a, from, to);
/*      */       
/*      */       return;
/*      */     } 
/* 1575 */     int mid = from + to >>> 1;
/* 1576 */     mergeSort(supp, from, mid, a);
/* 1577 */     mergeSort(supp, mid, to, a);
/*      */ 
/*      */     
/* 1580 */     if (((Comparable<K>)supp[mid - 1]).compareTo(supp[mid]) <= 0) {
/* 1581 */       System.arraycopy(supp, from, a, from, len);
/*      */       
/*      */       return;
/*      */     } 
/* 1585 */     for (int i = from, p = from, q = mid; i < to; i++) {
/* 1586 */       if (q >= to || (p < mid && ((Comparable<K>)supp[p]).compareTo(supp[q]) <= 0)) {
/* 1587 */         a[i] = supp[p++];
/*      */       } else {
/* 1589 */         a[i] = supp[q++];
/*      */       } 
...
/* 1609 */     mergeSort(a, from, to, (K[])a.clone());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1648 */     int len = to - from;
/*      */     
/* 1650 */     if (len < 16) {
/* 1651 */       insertionSort(a, from, to, comp);
/*      */       
/*      */       return;
/*      */     } 
/* 1655 */     int mid = from + to >>> 1;
/* 1656 */     mergeSort(supp, from, mid, comp, a);
/* 1657 */     mergeSort(supp, mid, to, comp, a);
/*      */ 
/*      */     
/* 1660 */     if (comp.compare(supp[mid - 1], supp[mid]) <= 0) {
/* 1661 */       System.arraycopy(supp, from, a, from, len);
/*      */       
/*      */       return;
/*      */     } 
/* 1665 */     for (int i = from, p = from, q = mid; i < to; i++) {
/* 1666 */       if (q >= to || (p < mid && comp.compare(supp[p], supp[q]) <= 0)) {
/* 1667 */         a[i] = supp[p++];
/*      */       } else {
/* 1669 */         a[i] = supp[q++];
/*      */       } 
...
/* 1691 */     mergeSort(a, from, to, comp, (K[])a.clone());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1708 */     mergeSort(a, 0, a.length, comp);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1737 */     to--;
/* 1738 */     while (from <= to) {
/* 1739 */       int mid = from + to >>> 1;
/* 1740 */       K midVal = a[mid];
/* 1741 */       int cmp = ((Comparable<K>)midVal).compareTo(key);
/* 1742 */       if (cmp < 0) {
/* 1743 */         from = mid + 1; continue;
/* 1744 */       }  if (cmp > 0) {
/* 1745 */         to = mid - 1; continue;
/*      */       } 
/* 1747 */       return mid;
/*      */     } 
/* 1749 */     return -(from + 1);
...
/* 1771 */     return binarySearch(a, 0, a.length, key);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1801 */     to--;
/* 1802 */     while (from <= to) {
/* 1803 */       int mid = from + to >>> 1;
/* 1804 */       K midVal = a[mid];
/* 1805 */       int cmp = c.compare(midVal, key);
/* 1806 */       if (cmp < 0) {
/* 1807 */         from = mid + 1; continue;
/* 1808 */       }  if (cmp > 0) {
/* 1809 */         to = mid - 1; continue;
/*      */       } 
/* 1811 */       return mid;
/*      */     } 
/* 1813 */     return -(from + 1);
...
/* 1838 */     return binarySearch(a, 0, a.length, key, c);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1855 */     for (int i = to - from; i-- != 0; ) {
/* 1856 */       int p = random.nextInt(i + 1);
/* 1857 */       K t = a[from + i];
/* 1858 */       a[from + i] = a[from + p];
/* 1859 */       a[from + p] = t;
/*      */     } 
/* 1861 */     return a;
/*      */   }
...
/* 1874 */     for (int i = a.length; i-- != 0; ) {
/* 1875 */       int p = random.nextInt(i + 1);
/* 1876 */       K t = a[i];
/* 1877 */       a[i] = a[p];
/* 1878 */       a[p] = t;
/*      */     } 
...
/* 1890 */     int length = a.length;
/* 1891 */     for (int i = length / 2; i-- != 0; ) {
/* 1892 */       K t = a[length - i - 1];
/* 1893 */       a[length - i - 1] = a[i];
/* 1894 */       a[i] = t;
/*      */     } 
/* 1896 */     return a;
/*      */   }
...
/* 1910 */     int length = to - from;
/* 1911 */     for (int i = length / 2; i-- != 0; ) {
/* 1912 */       K t = a[from + length - i - 1];
/* 1913 */       a[from + length - i - 1] = a[from + i];
/* 1914 */       a[from + i] = t;
/*      */     } 
/* 1916 */     return a;
/*      */   }
...
/* 1923 */       return Arrays.hashCode((Object[])o);
/*      */     }
/*      */     
/*      */     public boolean equals(K[] a, K[] b) {
/* 1927 */       return Arrays.equals((Object[])a, (Object[])b);
/*      */     } }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1939 */   public static final Hash.Strategy HASH_STRATEGY = new ArrayHashStrategy();
/*      */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\ObjectArrays.class
