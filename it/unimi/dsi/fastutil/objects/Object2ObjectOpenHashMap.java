...
/*  901 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null)
/*  902 */         while (newKey[pos = pos + 1 & mask] != null); 
/*  903 */       newKey[pos] = key[i];
/*  904 */       newValue[pos] = value[i];
/*      */     } 
/*  906 */     newValue[newN] = value[this.n];
/*  907 */     this.n = newN;
/*  908 */     this.mask = mask;
/*  909 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/*  910 */     this.key = newKey;
/*  911 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/*  928 */       c = (Object2ObjectOpenHashMap<K, V>)super.clone();
/*  929 */     } catch (CloneNotSupportedException cantHappen) {
/*  930 */       throw new InternalError();
/*      */     } 
/*  932 */     c.keys = null;
/*  933 */     c.values = null;
/*  934 */     c.entries = null;
/*  935 */     c.containsNullKey = this.containsNullKey;
/*  936 */     c.key = (K[])this.key.clone();
/*  937 */     c.value = (V[])this.value.clone();
/*  938 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/*  951 */     int h = 0;
/*  952 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/*  953 */       while (this.key[i] == null)
/*  954 */         i++; 
/*  955 */       if (this != this.key[i])
/*  956 */         t = this.key[i].hashCode(); 
/*  957 */       if (this != this.value[i])
/*  958 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/*  959 */       h += t;
/*  960 */       i++;
/*      */     } 
/*      */     
/*  963 */     if (this.containsNullKey)
/*  964 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/*  965 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/*  968 */     K[] key = this.key;
/*  969 */     V[] value = this.value;
/*  970 */     MapIterator i = new MapIterator();
/*  971 */     s.defaultWriteObject();
/*  972 */     for (int j = this.size; j-- != 0; ) {
/*  973 */       int e = i.nextEntry();
/*  974 */       s.writeObject(key[e]);
/*  975 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/*  980 */     s.defaultReadObject();
/*  981 */     this.n = HashCommon.arraySize(this.size, this.f);
/*  982 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/*  983 */     this.mask = this.n - 1;
/*  984 */     K[] key = this.key = (K[])new Object[this.n + 1];
/*  985 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/*  988 */     for (int i = this.size; i-- != 0; ) {
/*  989 */       int pos; K k = (K)s.readObject();
/*  990 */       V v = (V)s.readObject();
/*  991 */       if (k == null) {
/*  992 */         pos = this.n;
/*  993 */         this.containsNullKey = true;
/*      */       } else {
/*  995 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/*  996 */         while (key[pos] != null)
/*  997 */           pos = pos + 1 & this.mask; 
/*      */       } 
/*  999 */       key[pos] = k;
/* 1000 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ObjectOpenHashMap.class
