...
/* 1802 */     K[] key = this.key;
/* 1803 */     short[] value = this.value;
/* 1804 */     int mask = newN - 1;
/* 1805 */     K[] newKey = (K[])new Object[newN + 1];
/* 1806 */     short[] newValue = new short[newN + 1];
...
/*      */     try {
/* 1860 */       c = (Reference2ShortLinkedOpenHashMap<K>)super.clone();
...
/* 1869 */     c.value = (short[])this.value.clone();
...
/* 1917 */     short[] value = this.value = new short[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2ShortLinkedOpenHashMap.class
