...
/*      */   
/*      */   public boolean trim() {
/* 1006 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1007 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1008 */       return true; 
/*      */     try {
/* 1010 */       rehash(l);
/* 1011 */     } catch (OutOfMemoryError cantDoIt) {
/* 1012 */       return false;
/*      */     } 
/* 1014 */     return true;
/*      */   }
...
/* 1038 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1039 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1040 */       return true; 
/*      */     try {
/* 1042 */       rehash(l);
/* 1043 */     } catch (OutOfMemoryError cantDoIt) {
/* 1044 */       return false;
/*      */     } 
/* 1046 */     return true;
/*      */   }
...
/* 1062 */     K[] key = this.key;
/* 1063 */     char[] value = this.value;
/* 1064 */     int mask = newN - 1;
/* 1065 */     K[] newKey = (K[])new Object[newN + 1];
/* 1066 */     char[] newValue = new char[newN + 1];
/* 1067 */     int i = this.n;
/* 1068 */     for (int j = realSize(); j-- != 0; ) {
/* 1069 */       while (key[--i] == null); int pos;
/* 1070 */       if (newKey[pos = HashCommon.mix(System.identityHashCode(key[i])) & mask] != null)
/*      */       {
/* 1072 */         while (newKey[pos = pos + 1 & mask] != null); } 
/* 1073 */       newKey[pos] = key[i];
/* 1074 */       newValue[pos] = value[i];
/*      */     } 
/* 1076 */     newValue[newN] = value[this.n];
/* 1077 */     this.n = newN;
/* 1078 */     this.mask = mask;
...
/*      */     try {
/* 1098 */       c = (Reference2CharOpenHashMap<K>)super.clone();
/* 1099 */     } catch (CloneNotSupportedException cantHappen) {
/* 1100 */       throw new InternalError();
/*      */     } 
/* 1102 */     c.keys = null;
/* 1103 */     c.values = null;
/* 1104 */     c.entries = null;
/* 1105 */     c.containsNullKey = this.containsNullKey;
/* 1106 */     c.key = (K[])this.key.clone();
/* 1107 */     c.value = (char[])this.value.clone();
/* 1108 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1121 */     int h = 0;
/* 1122 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1123 */       while (this.key[i] == null)
/* 1124 */         i++; 
/* 1125 */       if (this != this.key[i])
/* 1126 */         t = System.identityHashCode(this.key[i]); 
/* 1127 */       t ^= this.value[i];
/* 1128 */       h += t;
/* 1129 */       i++;
/*      */     } 
/*      */     
/* 1132 */     if (this.containsNullKey)
/* 1133 */       h += this.value[this.n]; 
/* 1134 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1137 */     K[] key = this.key;
/* 1138 */     char[] value = this.value;
/* 1139 */     MapIterator i = new MapIterator();
/* 1140 */     s.defaultWriteObject();
/* 1141 */     for (int j = this.size; j-- != 0; ) {
/* 1142 */       int e = i.nextEntry();
/* 1143 */       s.writeObject(key[e]);
/* 1144 */       s.writeChar(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1149 */     s.defaultReadObject();
/* 1150 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1151 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1152 */     this.mask = this.n - 1;
/* 1153 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1154 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1157 */     for (int i = this.size; i-- != 0; ) {
/* 1158 */       int pos; K k = (K)s.readObject();
/* 1159 */       char v = s.readChar();
/* 1160 */       if (k == null) {
/* 1161 */         pos = this.n;
/* 1162 */         this.containsNullKey = true;
/*      */       } else {
/* 1164 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1165 */         while (key[pos] != null)
/* 1166 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1168 */       key[pos] = k;
/* 1169 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2CharOpenHashMap.class
