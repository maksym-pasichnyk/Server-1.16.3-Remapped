...
/*  52 */     ObjectIterator<Reference2CharMap.Entry<K>> i = reference2CharEntrySet().iterator();
/*  53 */     while (i.hasNext()) {
/*  54 */       if (((Reference2CharMap.Entry)i.next()).getKey() == k)
/*  55 */         return true; 
/*  56 */     }  return false;
/*     */   }
/*     */   
...
/* 100 */         return false; 
/* 101 */       if (o instanceof Reference2CharMap.Entry) {
/* 102 */         Reference2CharMap.Entry<K> entry = (Reference2CharMap.Entry<K>)o;
/* 103 */         return (this.key == entry.getKey() && this.value == entry.getCharValue());
/*     */       } 
...
/* 109 */         return false; 
/* 110 */       return (this.key == key && this.value == ((Character)value).charValue());
/*     */     }
/*     */     
/*     */     public int hashCode() {
...
/* 134 */         return false; 
/* 135 */       if (o instanceof Reference2CharMap.Entry) {
/* 136 */         Reference2CharMap.Entry<K> entry = (Reference2CharMap.Entry<K>)o;
...
/* 151 */         return false; 
/* 152 */       if (o instanceof Reference2CharMap.Entry) {
/* 153 */         Reference2CharMap.Entry<K> entry = (Reference2CharMap.Entry<K>)o;
...
/* 188 */           return AbstractReference2CharMap.this.containsKey(k);
/*     */         }
/*     */         
/*     */         public int size() {
/* 192 */           return AbstractReference2CharMap.this.size();
/*     */         }
/*     */         
/*     */         public void clear() {
/* 196 */           AbstractReference2CharMap.this.clear();
/*     */         }
/*     */         
/*     */         public ObjectIterator<K> iterator() {
/* 200 */           return new ObjectIterator<K>()
/*     */             {
/* 202 */               private final ObjectIterator<Reference2CharMap.Entry<K>> i = Reference2CharMaps.fastIterator(AbstractReference2CharMap.this);
/*     */               
/*     */               public K next() {
/* 205 */                 return ((Reference2CharMap.Entry<K>)this.i.next()).getKey();
/*     */               }
/*     */               
...
/* 238 */           return AbstractReference2CharMap.this.containsValue(k);
/*     */         }
/*     */         
/*     */         public int size() {
/* 242 */           return AbstractReference2CharMap.this.size();
/*     */         }
/*     */         
/*     */         public void clear() {
/* 246 */           AbstractReference2CharMap.this.clear();
/*     */         }
/*     */         
/*     */         public CharIterator iterator() {
/* 250 */           return new CharIterator()
/*     */             {
/* 252 */               private final ObjectIterator<Reference2CharMap.Entry<K>> i = Reference2CharMaps.fastIterator(AbstractReference2CharMap.this);
/*     */               
/*     */               public char nextChar() {
/* 255 */                 return ((Reference2CharMap.Entry)this.i.next()).getCharValue();
/*     */               }
/*     */               
/*     */               public boolean hasNext() {
...
/* 269 */     if (m instanceof Reference2CharMap) {
/* 270 */       ObjectIterator<Reference2CharMap.Entry<K>> i = Reference2CharMaps.fastIterator((Reference2CharMap)m);
/* 271 */       while (i.hasNext()) {
/* 272 */         Reference2CharMap.Entry<? extends K> e = i.next();
...
/*     */   public int hashCode() {
/* 294 */     int h = 0, n = size();
/* 295 */     ObjectIterator<Reference2CharMap.Entry<K>> i = Reference2CharMaps.fastIterator(this);
/* 296 */     while (n-- != 0)
/* 297 */       h += ((Reference2CharMap.Entry)i.next()).hashCode(); 
/* 298 */     return h;
/*     */   }
/*     */   
/*     */   public boolean equals(Object o) {
...
/* 307 */     if (m.size() != size())
/* 308 */       return false; 
/* 309 */     return reference2CharEntrySet().containsAll(m.entrySet());
/*     */   }
/*     */   
/*     */   public String toString() {
/* 313 */     StringBuilder s = new StringBuilder();
/* 314 */     ObjectIterator<Reference2CharMap.Entry<K>> i = Reference2CharMaps.fastIterator(this);
/* 315 */     int n = size();
/*     */     
...
/*     */       } else {
/* 323 */         s.append(", ");
/* 324 */       }  Reference2CharMap.Entry<K> e = i.next();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\AbstractReference2CharMap.class
