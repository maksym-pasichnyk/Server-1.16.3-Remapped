...
/*  936 */       return (Objects.equals(this.key, e.getKey()) && this.value == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  940 */       return this.key.hashCode() ^ ((this.value == null) ? 0 : System.identityHashCode(this.value));
/*      */     }
/*      */     
...
/* 1022 */     int index = 0;
/*      */     TreeIterator() {
/* 1024 */       this.next = Object2ReferenceAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(K k) {
/* 1027 */       if ((this.next = Object2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/* 1028 */         if (Object2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1079 */       updatePrevious();
/* 1080 */       updateNext();
/* 1081 */       Object2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1082 */       this.curr = null;
/*      */     }
...
/* 1129 */       this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ReferenceMap.Entry<Object2ReferenceMap.Entry<K, V>, V>>()
/*      */         {
...
/* 1138 */             return new Object2ReferenceAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> from) {
/* 1143 */             return new Object2ReferenceAVLTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1151 */             Object2ReferenceAVLTreeMap.Entry<K, V> f = Object2ReferenceAVLTreeMap.this.findKey((K)e.getKey());
...
/* 1160 */             Object2ReferenceAVLTreeMap.Entry<K, V> f = Object2ReferenceAVLTreeMap.this.findKey((K)e.getKey());
/* 1161 */             if (f == null || f.getValue() != e.getValue())
/* 1162 */               return false; 
/* 1163 */             Object2ReferenceAVLTreeMap.this.remove(f.key);
/* 1164 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1168 */             return Object2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1172 */             Object2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Object2ReferenceMap.Entry<K, V> first() {
/* 1176 */             return Object2ReferenceAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Object2ReferenceMap.Entry<K, V> last() {
/* 1180 */             return Object2ReferenceAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
...
/* 1185 */             return Object2ReferenceAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> to) {
/* 1189 */             return Object2ReferenceAVLTreeMap.this.headMap(to.getKey()).object2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> from) {
/* 1193 */             return Object2ReferenceAVLTreeMap.this.tailMap(from.getKey()).object2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1227 */       return new Object2ReferenceAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1231 */       return new Object2ReferenceAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1283 */       this.values = new AbstractReferenceCollection<V>()
/*      */         {
/*      */           public ObjectIterator<V> iterator() {
/* 1286 */             return new Object2ReferenceAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1290 */             return Object2ReferenceAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1294 */             return Object2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1298 */             Object2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1361 */       if (!bottom && !top && Object2ReferenceAVLTreeMap.this.compare(from, to) > 0)
/* 1362 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1363 */       this.from = from;
/* 1364 */       this.bottom = bottom;
/* 1365 */       this.to = to;
/* 1366 */       this.top = top;
/* 1367 */       this.defRetValue = Object2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1385 */       return ((this.bottom || Object2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2ReferenceAVLTreeMap.this
/* 1386 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
/* 1390 */       if (this.entries == null)
/* 1391 */         this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2ReferenceMap.Entry<Object2ReferenceMap.Entry<K, V>, V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator() {
/* 1394 */               return new Object2ReferenceAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> from) {
/* 1399 */               return new Object2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator() {
/* 1403 */               return Object2ReferenceAVLTreeMap.this.object2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1411 */               Object2ReferenceAVLTreeMap.Entry<K, V> f = Object2ReferenceAVLTreeMap.this.findKey((K)e.getKey());
/* 1412 */               return (f != null && Object2ReferenceAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1420 */               Object2ReferenceAVLTreeMap.Entry<K, V> f = Object2ReferenceAVLTreeMap.this.findKey((K)e.getKey());
/* 1421 */               if (f != null && Object2ReferenceAVLTreeMap.Submap.this.in(f.key))
/* 1422 */                 Object2ReferenceAVLTreeMap.Submap.this.remove(f.key); 
/* 1423 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1434 */               return !(new Object2ReferenceAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1438 */               Object2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Object2ReferenceMap.Entry<K, V> first() {
/* 1442 */               return Object2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Object2ReferenceMap.Entry<K, V> last() {
/* 1446 */               return Object2ReferenceAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> from, Object2ReferenceMap.Entry<K, V> to) {
/* 1451 */               return Object2ReferenceAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> to) {
/* 1456 */               return Object2ReferenceAVLTreeMap.Submap.this.headMap(to.getKey()).object2ReferenceEntrySet();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> from) {
/* 1461 */               return Object2ReferenceAVLTreeMap.Submap.this.tailMap(from.getKey()).object2ReferenceEntrySet();
/*      */             }
/*      */           }; 
/* 1464 */       return this.entries;
/*      */     }
/*      */     
/*      */     private class KeySet extends AbstractObject2ReferenceSortedMap<K, V>.KeySet {
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1469 */         return new Object2ReferenceAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1473 */         return new Object2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<K> keySet() {
...
/*      */     
/*      */     public ReferenceCollection<V> values() {
/* 1484 */       if (this.values == null)
/* 1485 */         this.values = new AbstractReferenceCollection<V>()
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1488 */               return new Object2ReferenceAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1492 */               return Object2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1496 */               return Object2ReferenceAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1500 */               Object2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
/* 1503 */       return this.values;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean containsKey(Object k) {
/* 1508 */       return (in((K)k) && Object2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/* 1515 */         Object ev = (i.nextEntry()).value;
/* 1516 */         if (ev == v)
/* 1517 */           return true; 
/*      */       } 
/* 1519 */       return false;
...
/*      */     
/*      */     public V get(Object k) {
/* 1525 */       K kk = (K)k; Object2ReferenceAVLTreeMap.Entry<K, V> e;
/* 1526 */       return (in(kk) && (e = Object2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(K k, V v) {
/* 1530 */       Object2ReferenceAVLTreeMap.this.modified = false;
/* 1531 */       if (!in(k))
/* 1532 */         throw new IllegalArgumentException("Key (" + k + ") out of range [" + (
/* 1533 */             this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.to)) + ")"); 
/* 1534 */       V oldValue = Object2ReferenceAVLTreeMap.this.put(k, v);
/* 1535 */       return Object2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(Object k) {
/* 1540 */       Object2ReferenceAVLTreeMap.this.modified = false;
/* 1541 */       if (!in((K)k))
/* 1542 */         return this.defRetValue; 
/* 1543 */       V oldValue = (V)Object2ReferenceAVLTreeMap.this.remove(k);
/* 1544 */       return Object2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public boolean isEmpty() {
/* 1558 */       return !(new SubmapIterator()).hasNext();
/*      */     }
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1562 */       return Object2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Object2ReferenceSortedMap<K, V> headMap(K to) {
/* 1566 */       if (this.top)
/* 1567 */         return new Submap(this.from, this.bottom, to, false); 
/* 1568 */       return (Object2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Object2ReferenceSortedMap<K, V> tailMap(K from) {
/* 1572 */       if (this.bottom)
/* 1573 */         return new Submap(from, false, this.to, this.top); 
/* 1574 */       return (Object2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Object2ReferenceSortedMap<K, V> subMap(K from, K to) {
/* 1578 */       if (this.top && this.bottom)
/* 1579 */         return new Submap(from, false, to, false); 
/* 1580 */       if (!this.top)
/* 1581 */         to = (Object2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1582 */       if (!this.bottom)
/* 1583 */         from = (Object2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
/* 1584 */       if (!this.top && !this.bottom && from == this.from && to == this.to)
/* 1585 */         return this; 
...
/* 1595 */       if (Object2ReferenceAVLTreeMap.this.tree == null) {
/* 1596 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1600 */       if (this.bottom) {
/* 1601 */         e = Object2ReferenceAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1603 */         e = Object2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1605 */         if (Object2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1606 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1610 */       if (e == null || (!this.top && Object2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1611 */         return null; 
/* 1612 */       return e;
/*      */     }
/*      */ 
...
/*      */       Object2ReferenceAVLTreeMap.Entry<K, V> e;
/* 1621 */       if (Object2ReferenceAVLTreeMap.this.tree == null) {
/* 1622 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1626 */       if (this.top) {
/* 1627 */         e = Object2ReferenceAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1629 */         e = Object2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1631 */         if (Object2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1632 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1636 */       if (e == null || (!this.bottom && Object2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1637 */         return null; 
/* 1638 */       return e;
/*      */     }
/*      */     
/*      */     public K firstKey() {
/* 1642 */       Object2ReferenceAVLTreeMap.Entry<K, V> e = firstEntry();
/* 1643 */       if (e == null)
...
/*      */     
/*      */     public K lastKey() {
/* 1649 */       Object2ReferenceAVLTreeMap.Entry<K, V> e = lastEntry();
/* 1650 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1665 */         this.next = Object2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(K k) {
/* 1668 */         this();
/* 1669 */         if (this.next != null)
/* 1670 */           if (!Object2ReferenceAVLTreeMap.Submap.this.bottom && Object2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1671 */             this.prev = null;
/* 1672 */           } else if (!Object2ReferenceAVLTreeMap.Submap.this.top && Object2ReferenceAVLTreeMap.this.compare(k, (this.prev = Object2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1673 */             this.next = null;
/*      */           } else {
/* 1675 */             this.next = Object2ReferenceAVLTreeMap.this.locateKey(k);
/* 1676 */             if (Object2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
/* 1677 */               this.prev = this.next;
/* 1678 */               this.next = this.next.next();
/*      */             } else {
/* 1680 */               this.prev = this.next.prev();
/*      */             } 
/*      */           }  
/*      */       }
/*      */       
/*      */       void updatePrevious() {
/* 1686 */         this.prev = this.prev.prev();
/* 1687 */         if (!Object2ReferenceAVLTreeMap.Submap.this.bottom && this.prev != null && Object2ReferenceAVLTreeMap.this.compare(this.prev.key, Object2ReferenceAVLTreeMap.Submap.this.from) < 0)
/* 1688 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1692 */         this.next = this.next.next();
/* 1693 */         if (!Object2ReferenceAVLTreeMap.Submap.this.top && this.next != null && Object2ReferenceAVLTreeMap.this.compare(this.next.key, Object2ReferenceAVLTreeMap.Submap.this.to) >= 0)
/* 1694 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1776 */       c = (Object2ReferenceAVLTreeMap<K, V>)super.clone();
...
/*      */       
/* 1786 */       Entry<K, V> rp = new Entry<>(), rq = new Entry<>();
/* 1787 */       Entry<K, V> p = rp;
/* 1788 */       rp.left(this.tree);
/* 1789 */       Entry<K, V> q = rq;
/* 1790 */       rq.pred((Entry<K, V>)null);
/*      */       while (true) {
/* 1792 */         if (!p.pred()) {
/* 1793 */           Entry<K, V> e = p.left.clone();
/* 1794 */           e.pred(q.left);
/* 1795 */           e.succ(q);
/* 1796 */           q.left(e);
/* 1797 */           p = p.left;
...
/*      */         } 
/* 1818 */         if (!p.succ()) {
/* 1819 */           Entry<K, V> e = p.right.clone();
/* 1820 */           e.succ(q.right);
/* 1821 */           e.pred(q);
/* 1822 */           q.right(e);
/*      */         } 
...
/* 1857 */     if (n == 1) {
/* 1858 */       Entry<K, V> entry = new Entry<>((K)s.readObject(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1868 */       Entry<K, V> entry = new Entry<>((K)s.readObject(), (V)s.readObject());
/* 1869 */       entry.right(new Entry<>((K)s.readObject(), (V)s.readObject()));
...
/* 1878 */     Entry<K, V> top = new Entry<>();
/* 1879 */     top.left(readTree(s, leftN, pred, top));
/* 1880 */     top.key = (K)s.readObject();
...
/* 1896 */       this.tree = readTree(s, this.count, (Entry<K, V>)null, (Entry<K, V>)null);
/*      */       
/* 1898 */       Entry<K, V> e = this.tree;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ReferenceAVLTreeMap.class
