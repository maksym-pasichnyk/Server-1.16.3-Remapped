...
/* 1062 */     K[] key = this.key;
/* 1063 */     boolean[] value = this.value;
/* 1064 */     int mask = newN - 1;
/* 1065 */     K[] newKey = (K[])new Object[newN + 1];
/* 1066 */     boolean[] newValue = new boolean[newN + 1];
/* 1067 */     int i = this.n;
/* 1068 */     for (int j = realSize(); j-- != 0; ) {
/* 1069 */       while (key[--i] == null); int pos;
/* 1070 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null)
/* 1071 */         while (newKey[pos = pos + 1 & mask] != null); 
/* 1072 */       newKey[pos] = key[i];
/* 1073 */       newValue[pos] = value[i];
/*      */     } 
/* 1075 */     newValue[newN] = value[this.n];
/* 1076 */     this.n = newN;
/* 1077 */     this.mask = mask;
/* 1078 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1079 */     this.key = newKey;
/* 1080 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1097 */       c = (Object2BooleanOpenHashMap<K>)super.clone();
...
/* 1102 */     c.values = null;
/* 1103 */     c.entries = null;
/* 1104 */     c.containsNullKey = this.containsNullKey;
/* 1105 */     c.key = (K[])this.key.clone();
/* 1106 */     c.value = (boolean[])this.value.clone();
/* 1107 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1120 */     int h = 0;
/* 1121 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1122 */       while (this.key[i] == null)
/* 1123 */         i++; 
/* 1124 */       if (this != this.key[i])
/* 1125 */         t = this.key[i].hashCode(); 
/* 1126 */       t ^= this.value[i] ? 1231 : 1237;
/* 1127 */       h += t;
/* 1128 */       i++;
/*      */     } 
/*      */     
/* 1131 */     if (this.containsNullKey)
/* 1132 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1133 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1136 */     K[] key = this.key;
/* 1137 */     boolean[] value = this.value;
/* 1138 */     MapIterator i = new MapIterator();
/* 1139 */     s.defaultWriteObject();
/* 1140 */     for (int j = this.size; j-- != 0; ) {
/* 1141 */       int e = i.nextEntry();
/* 1142 */       s.writeObject(key[e]);
/* 1143 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1148 */     s.defaultReadObject();
/* 1149 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1150 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1151 */     this.mask = this.n - 1;
/* 1152 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1153 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1156 */     for (int i = this.size; i-- != 0; ) {
/* 1157 */       int pos; K k = (K)s.readObject();
/* 1158 */       boolean v = s.readBoolean();
/* 1159 */       if (k == null) {
/* 1160 */         pos = this.n;
/* 1161 */         this.containsNullKey = true;
/*      */       } else {
/* 1163 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1164 */         while (key[pos] != null)
/* 1165 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1167 */       key[pos] = k;
/* 1168 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2BooleanOpenHashMap.class
