...
/*      */   
/*      */   public boolean trim() {
/* 1526 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1527 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1528 */       return true; 
/*      */     try {
/* 1530 */       rehash(l);
/* 1531 */     } catch (OutOfMemoryError cantDoIt) {
/* 1532 */       return false;
/*      */     } 
/* 1534 */     return true;
/*      */   }
...
/* 1558 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1559 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1560 */       return true; 
/*      */     try {
/* 1562 */       rehash(l);
/* 1563 */     } catch (OutOfMemoryError cantDoIt) {
/* 1564 */       return false;
/*      */     } 
/* 1566 */     return true;
/*      */   }
...
/* 1582 */     K[] key = this.key;
/* 1583 */     V[] value = this.value;
/* 1584 */     int mask = newN - 1;
/* 1585 */     K[] newKey = (K[])new Object[newN + 1];
/* 1586 */     V[] newValue = (V[])new Object[newN + 1];
/* 1587 */     int i = this.first, prev = -1, newPrev = -1;
/* 1588 */     long[] link = this.link;
/* 1589 */     long[] newLink = new long[newN + 1];
/* 1590 */     this.first = -1;
/* 1591 */     for (int j = this.size; j-- != 0; ) {
/* 1592 */       int pos; if (key[i] == null) {
/* 1593 */         pos = newN;
/*      */       } else {
/* 1595 */         pos = HashCommon.mix(System.identityHashCode(key[i])) & mask;
/* 1596 */         while (newKey[pos] != null)
/* 1597 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1599 */       newKey[pos] = key[i];
/* 1600 */       newValue[pos] = value[i];
/* 1601 */       if (prev != -1) {
/* 1602 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1603 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1604 */         newPrev = pos;
/*      */       } else {
/* 1606 */         newPrev = this.first = pos;
/*      */         
/* 1608 */         newLink[pos] = -1L;
/*      */       } 
/* 1610 */       int t = i;
...
/* 1612 */       prev = t;
/*      */     } 
/* 1614 */     this.link = newLink;
/* 1615 */     this.last = newPrev;
/* 1616 */     if (newPrev != -1)
/*      */     {
/* 1618 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1619 */     this.n = newN;
/* 1620 */     this.mask = mask;
/* 1621 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1622 */     this.key = newKey;
/* 1623 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1640 */       c = (Reference2ReferenceLinkedOpenHashMap<K, V>)super.clone();
/* 1641 */     } catch (CloneNotSupportedException cantHappen) {
/* 1642 */       throw new InternalError();
/*      */     } 
/* 1644 */     c.keys = null;
/* 1645 */     c.values = null;
/* 1646 */     c.entries = null;
/* 1647 */     c.containsNullKey = this.containsNullKey;
/* 1648 */     c.key = (K[])this.key.clone();
/* 1649 */     c.value = (V[])this.value.clone();
/* 1650 */     c.link = (long[])this.link.clone();
/* 1651 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1664 */     int h = 0;
/* 1665 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1666 */       while (this.key[i] == null)
/* 1667 */         i++; 
/* 1668 */       if (this != this.key[i])
/* 1669 */         t = System.identityHashCode(this.key[i]); 
/* 1670 */       if (this != this.value[i])
/* 1671 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1672 */       h += t;
/* 1673 */       i++;
/*      */     } 
/*      */     
/* 1676 */     if (this.containsNullKey)
/* 1677 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1678 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1681 */     K[] key = this.key;
/* 1682 */     V[] value = this.value;
/* 1683 */     MapIterator i = new MapIterator();
/* 1684 */     s.defaultWriteObject();
/* 1685 */     for (int j = this.size; j-- != 0; ) {
/* 1686 */       int e = i.nextEntry();
/* 1687 */       s.writeObject(key[e]);
/* 1688 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1693 */     s.defaultReadObject();
/* 1694 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1695 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1696 */     this.mask = this.n - 1;
/* 1697 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1698 */     V[] value = this.value = (V[])new Object[this.n + 1];
/* 1699 */     long[] link = this.link = new long[this.n + 1];
/* 1700 */     int prev = -1;
/* 1701 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1704 */     for (int i = this.size; i-- != 0; ) {
/* 1705 */       int pos; K k = (K)s.readObject();
/* 1706 */       V v = (V)s.readObject();
/* 1707 */       if (k == null) {
/* 1708 */         pos = this.n;
/* 1709 */         this.containsNullKey = true;
/*      */       } else {
/* 1711 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1712 */         while (key[pos] != null)
/* 1713 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1715 */       key[pos] = k;
/* 1716 */       value[pos] = v;
/* 1717 */       if (this.first != -1) {
/* 1718 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1719 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1720 */         prev = pos; continue;
/*      */       } 
/* 1722 */       prev = this.first = pos;
/*      */       
/* 1724 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1727 */     this.last = prev;
/* 1728 */     if (prev != -1)
/*      */     {
/* 1730 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2ReferenceLinkedOpenHashMap.class
