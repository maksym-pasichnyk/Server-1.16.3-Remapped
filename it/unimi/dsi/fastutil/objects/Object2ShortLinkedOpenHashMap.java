...
/*      */       } 
/*  392 */     }  this.key[pos] = k;
/*  393 */     this.value[pos] = (short)(this.defRetValue + incr);
/*  394 */     if (this.size == 0) {
...
/*  462 */     short oldValue = this.value[pos];
...
/*  868 */     short oldValue = this.value[pos];
...
/*  879 */     short newValue = SafeMath.safeIntToShort(mappingFunction.applyAsInt(k));
...
/*  891 */     Short newValue = remappingFunction.apply(k, Short.valueOf(this.value[pos]));
...
/*      */     } 
/*  899 */     this.value[pos] = newValue.shortValue(); return newValue.shortValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  906 */     int pos = find(k);
/*  907 */     Short newValue = remappingFunction.apply(k, (pos >= 0) ? Short.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  917 */     short newVal = newValue.shortValue();
/*  918 */     if (pos < 0) {
...
/*  932 */       return v;
/*      */     } 
/*  934 */     Short newValue = remappingFunction.apply(Short.valueOf(this.value[pos]), Short.valueOf(v));
...
/*      */     } 
/*  942 */     this.value[pos] = newValue.shortValue(); return newValue.shortValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  984 */       return Object2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public short getShortValue() {
/*  988 */       return Object2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public short setValue(short v) {
/*  992 */       short oldValue = Object2ShortLinkedOpenHashMap.this.value[this.index];
/*  993 */       Object2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  994 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/* 1004 */       return Short.valueOf(Object2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short setValue(Short v) {
/* 1014 */       return Short.valueOf(setValue(v.shortValue()));
/*      */     }
/*      */ 
/*      */     
...
/* 1020 */         return false; 
/* 1021 */       Map.Entry<K, Short> e = (Map.Entry<K, Short>)o;
/* 1022 */       return (Objects.equals(Object2ShortLinkedOpenHashMap.this.key[this.index], e.getKey()) && Object2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e
/* 1023 */         .getValue()).shortValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1027 */       return ((Object2ShortLinkedOpenHashMap.this.key[this.index] == null) ? 0 : Object2ShortLinkedOpenHashMap.this.key[this.index].hashCode()) ^ Object2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1031 */       return (new StringBuilder()).append(Object2ShortLinkedOpenHashMap.this.key[this.index]).append("=>").append(Object2ShortLinkedOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */       this.next = Object2ShortLinkedOpenHashMap.this.first;
/* 1195 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(K from) {
/* 1198 */       if (from == null) {
/* 1199 */         if (Object2ShortLinkedOpenHashMap.this.containsNullKey) {
/* 1200 */           this.next = (int)Object2ShortLinkedOpenHashMap.this.link[Object2ShortLinkedOpenHashMap.this.n];
/* 1201 */           this.prev = Object2ShortLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1204 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1206 */       if (Objects.equals(Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last], from)) {
/* 1207 */         this.prev = Object2ShortLinkedOpenHashMap.this.last;
/* 1208 */         this.index = Object2ShortLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1212 */       int pos = HashCommon.mix(from.hashCode()) & Object2ShortLinkedOpenHashMap.this.mask;
/*      */       
/* 1214 */       while (Object2ShortLinkedOpenHashMap.this.key[pos] != null) {
/* 1215 */         if (Object2ShortLinkedOpenHashMap.this.key[pos].equals(from)) {
/*      */           
/* 1217 */           this.next = (int)Object2ShortLinkedOpenHashMap.this.link[pos];
/* 1218 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1221 */         pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1238 */       if (this.next == -1) {
/* 1239 */         this.index = Object2ShortLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1242 */       int pos = Object2ShortLinkedOpenHashMap.this.first;
/* 1243 */       this.index = 1;
/* 1244 */       while (pos != this.prev) {
/* 1245 */         pos = (int)Object2ShortLinkedOpenHashMap.this.link[pos];
/* 1246 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1261 */       this.next = (int)Object2ShortLinkedOpenHashMap.this.link[this.curr];
...
/*      */         
/* 1286 */         this.index--;
/* 1287 */         this.prev = (int)(Object2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1289 */         this.next = (int)Object2ShortLinkedOpenHashMap.this.link[this.curr];
/* 1290 */       }  Object2ShortLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1295 */       if (this.prev == -1) {
/* 1296 */         Object2ShortLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1298 */         Object2ShortLinkedOpenHashMap.this.link[this.prev] = Object2ShortLinkedOpenHashMap.this.link[this.prev] ^ (Object2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1299 */       }  if (this.next == -1) {
/* 1300 */         Object2ShortLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1302 */         Object2ShortLinkedOpenHashMap.this.link[this.next] = Object2ShortLinkedOpenHashMap.this.link[this.next] ^ (Object2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1303 */       }  int pos = this.curr;
/* 1304 */       this.curr = -1;
/* 1305 */       if (pos == Object2ShortLinkedOpenHashMap.this.n) {
/* 1306 */         Object2ShortLinkedOpenHashMap.this.containsNullKey = false;
/* 1307 */         Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1310 */         K[] key = Object2ShortLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           K curr;
/*      */           int last;
/* 1314 */           pos = (last = pos) + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1316 */             if ((curr = key[pos]) == null) {
/* 1317 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1320 */             int slot = HashCommon.mix(curr.hashCode()) & Object2ShortLinkedOpenHashMap.this.mask;
/* 1321 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1323 */             pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1325 */           key[last] = curr;
/* 1326 */           Object2ShortLinkedOpenHashMap.this.value[last] = Object2ShortLinkedOpenHashMap.this.value[pos];
/* 1327 */           if (this.next == pos)
/* 1328 */             this.next = last; 
/* 1329 */           if (this.prev == pos)
/* 1330 */             this.prev = last; 
/* 1331 */           Object2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Object2ShortMap.Entry<K>> { private Object2ShortLinkedOpenHashMap<K>.MapEntry entry;
/*      */     
...
/* 1363 */       return this.entry = new Object2ShortLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Object2ShortLinkedOpenHashMap<K>.MapEntry previous() {
/* 1367 */       return this.entry = new Object2ShortLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1371 */       super.remove();
...
/*      */ 
/*      */   
/* 1376 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Object2ShortMap.Entry<K>> { final Object2ShortLinkedOpenHashMap<K>.MapEntry entry = new Object2ShortLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/* 1419 */       if (Object2ShortLinkedOpenHashMap.this.size == 0)
/* 1420 */         throw new NoSuchElementException(); 
/* 1421 */       return new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Object2ShortMap.Entry<K> last() {
/* 1425 */       if (Object2ShortLinkedOpenHashMap.this.size == 0)
/* 1426 */         throw new NoSuchElementException(); 
/* 1427 */       return new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1435 */       if (e.getValue() == null || !(e.getValue() instanceof Short))
/* 1436 */         return false; 
/* 1437 */       K k = (K)e.getKey();
/* 1438 */       short v = ((Short)e.getValue()).shortValue();
/* 1439 */       if (k == null) {
/* 1440 */         return (Object2ShortLinkedOpenHashMap.this.containsNullKey && Object2ShortLinkedOpenHashMap.this.value[Object2ShortLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1442 */       K[] key = Object2ShortLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1445 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2ShortLinkedOpenHashMap.this.mask]) == null)
/* 1446 */         return false; 
/* 1447 */       if (k.equals(curr)) {
/* 1448 */         return (Object2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1451 */         if ((curr = key[pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask]) == null)
/* 1452 */           return false; 
/* 1453 */         if (k.equals(curr)) {
/* 1454 */           return (Object2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1463 */       if (e.getValue() == null || !(e.getValue() instanceof Short))
/* 1464 */         return false; 
/* 1465 */       K k = (K)e.getKey();
/* 1466 */       short v = ((Short)e.getValue()).shortValue();
/* 1467 */       if (k == null) {
/* 1468 */         if (Object2ShortLinkedOpenHashMap.this.containsNullKey && Object2ShortLinkedOpenHashMap.this.value[Object2ShortLinkedOpenHashMap.this.n] == v) {
/* 1469 */           Object2ShortLinkedOpenHashMap.this.removeNullEntry();
/* 1470 */           return true;
/*      */         } 
/* 1472 */         return false;
/*      */       } 
/*      */       
/* 1475 */       K[] key = Object2ShortLinkedOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1478 */       if ((curr = key[pos = HashCommon.mix(k.hashCode()) & Object2ShortLinkedOpenHashMap.this.mask]) == null)
/* 1479 */         return false; 
/* 1480 */       if (curr.equals(k)) {
/* 1481 */         if (Object2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1482 */           Object2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1483 */           return true;
/*      */         } 
/* 1485 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1488 */         if ((curr = key[pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask]) == null)
/* 1489 */           return false; 
/* 1490 */         if (curr.equals(k) && 
/* 1491 */           Object2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1492 */           Object2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1493 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1500 */       return Object2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1504 */       Object2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1519 */       return new Object2ShortLinkedOpenHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1530 */       return new Object2ShortLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1545 */       return new Object2ShortLinkedOpenHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
/* 1550 */       for (int i = Object2ShortLinkedOpenHashMap.this.size, next = Object2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1551 */         int curr = next;
/* 1552 */         next = (int)Object2ShortLinkedOpenHashMap.this.link[curr];
/* 1553 */         consumer.accept(new AbstractObject2ShortMap.BasicEntry<>(Object2ShortLinkedOpenHashMap.this.key[curr], Object2ShortLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
/* 1559 */       AbstractObject2ShortMap.BasicEntry<K> entry = new AbstractObject2ShortMap.BasicEntry<>();
/* 1560 */       for (int i = Object2ShortLinkedOpenHashMap.this.size, next = Object2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1561 */         int curr = next;
/* 1562 */         next = (int)Object2ShortLinkedOpenHashMap.this.link[curr];
/* 1563 */         entry.key = Object2ShortLinkedOpenHashMap.this.key[curr];
/* 1564 */         entry.value = Object2ShortLinkedOpenHashMap.this.value[curr];
...
/*      */     
/*      */     public K previous() {
/* 1590 */       return Object2ShortLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
/*      */     
/*      */     public K next() {
/* 1597 */       return Object2ShortLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectListIterator<K> iterator(K from) {
/* 1603 */       return new Object2ShortLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1607 */       return new Object2ShortLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1612 */       if (Object2ShortLinkedOpenHashMap.this.containsNullKey)
/* 1613 */         consumer.accept(Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.n]); 
/* 1614 */       for (int pos = Object2ShortLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1615 */         K k = Object2ShortLinkedOpenHashMap.this.key[pos];
/* 1616 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/* 1622 */       return Object2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1626 */       return Object2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1630 */       int oldSize = Object2ShortLinkedOpenHashMap.this.size;
/* 1631 */       Object2ShortLinkedOpenHashMap.this.removeShort(k);
/* 1632 */       return (Object2ShortLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1636 */       Object2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public K first() {
/* 1640 */       if (Object2ShortLinkedOpenHashMap.this.size == 0)
/* 1641 */         throw new NoSuchElementException(); 
/* 1642 */       return Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public K last() {
/* 1646 */       if (Object2ShortLinkedOpenHashMap.this.size == 0)
/* 1647 */         throw new NoSuchElementException(); 
/* 1648 */       return Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1652 */       return null;
...
/* 1685 */       return Object2ShortLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1692 */       return Object2ShortLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public ShortCollection values() {
/* 1697 */     if (this.values == null)
/* 1698 */       this.values = (ShortCollection)new AbstractShortCollection()
/*      */         {
/*      */           public ShortIterator iterator() {
/* 1701 */             return (ShortIterator)new Object2ShortLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1705 */             return Object2ShortLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(short v) {
/* 1709 */             return Object2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1713 */             Object2ShortLinkedOpenHashMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1718 */             if (Object2ShortLinkedOpenHashMap.this.containsNullKey)
/* 1719 */               consumer.accept(Object2ShortLinkedOpenHashMap.this.value[Object2ShortLinkedOpenHashMap.this.n]); 
/* 1720 */             for (int pos = Object2ShortLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1721 */               if (Object2ShortLinkedOpenHashMap.this.key[pos] != null)
/* 1722 */                 consumer.accept(Object2ShortLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */   
/*      */   public boolean trim() {
/* 1742 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1774 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1775 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1776 */       return true; 
/*      */     try {
/* 1778 */       rehash(l);
/* 1779 */     } catch (OutOfMemoryError cantDoIt) {
/* 1780 */       return false;
/*      */     } 
/* 1782 */     return true;
/*      */   }
...
/* 1798 */     K[] key = this.key;
/* 1799 */     short[] value = this.value;
/* 1800 */     int mask = newN - 1;
/* 1801 */     K[] newKey = (K[])new Object[newN + 1];
/* 1802 */     short[] newValue = new short[newN + 1];
/* 1803 */     int i = this.first, prev = -1, newPrev = -1;
/* 1804 */     long[] link = this.link;
/* 1805 */     long[] newLink = new long[newN + 1];
/* 1806 */     this.first = -1;
/* 1807 */     for (int j = this.size; j-- != 0; ) {
/* 1808 */       int pos; if (key[i] == null) {
/* 1809 */         pos = newN;
/*      */       } else {
/* 1811 */         pos = HashCommon.mix(key[i].hashCode()) & mask;
/* 1812 */         while (newKey[pos] != null)
/* 1813 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1815 */       newKey[pos] = key[i];
/* 1816 */       newValue[pos] = value[i];
/* 1817 */       if (prev != -1) {
/* 1818 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1819 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1820 */         newPrev = pos;
/*      */       } else {
/* 1822 */         newPrev = this.first = pos;
/*      */         
/* 1824 */         newLink[pos] = -1L;
/*      */       } 
/* 1826 */       int t = i;
...
/* 1828 */       prev = t;
/*      */     } 
/* 1830 */     this.link = newLink;
/* 1831 */     this.last = newPrev;
/* 1832 */     if (newPrev != -1)
/*      */     {
/* 1834 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1835 */     this.n = newN;
/* 1836 */     this.mask = mask;
/* 1837 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1838 */     this.key = newKey;
/* 1839 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1856 */       c = (Object2ShortLinkedOpenHashMap<K>)super.clone();
/* 1857 */     } catch (CloneNotSupportedException cantHappen) {
/* 1858 */       throw new InternalError();
/*      */     } 
/* 1860 */     c.keys = null;
/* 1861 */     c.values = null;
/* 1862 */     c.entries = null;
/* 1863 */     c.containsNullKey = this.containsNullKey;
/* 1864 */     c.key = (K[])this.key.clone();
/* 1865 */     c.value = (short[])this.value.clone();
/* 1866 */     c.link = (long[])this.link.clone();
/* 1867 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1882 */       while (this.key[i] == null)
/* 1883 */         i++; 
/* 1884 */       if (this != this.key[i])
/* 1885 */         t = this.key[i].hashCode(); 
/* 1886 */       t ^= this.value[i];
/* 1887 */       h += t;
/* 1888 */       i++;
/*      */     } 
/*      */     
/* 1891 */     if (this.containsNullKey)
/* 1892 */       h += this.value[this.n]; 
/* 1893 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1896 */     K[] key = this.key;
/* 1897 */     short[] value = this.value;
/* 1898 */     MapIterator i = new MapIterator();
/* 1899 */     s.defaultWriteObject();
/* 1900 */     for (int j = this.size; j-- != 0; ) {
/* 1901 */       int e = i.nextEntry();
/* 1902 */       s.writeObject(key[e]);
/* 1903 */       s.writeShort(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1908 */     s.defaultReadObject();
/* 1909 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1910 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1911 */     this.mask = this.n - 1;
/* 1912 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1913 */     short[] value = this.value = new short[this.n + 1];
/* 1914 */     long[] link = this.link = new long[this.n + 1];
/* 1915 */     int prev = -1;
/* 1916 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1919 */     for (int i = this.size; i-- != 0; ) {
/* 1920 */       int pos; K k = (K)s.readObject();
/* 1921 */       short v = s.readShort();
/* 1922 */       if (k == null) {
/* 1923 */         pos = this.n;
/* 1924 */         this.containsNullKey = true;
/*      */       } else {
/* 1926 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1927 */         while (key[pos] != null)
/* 1928 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1930 */       key[pos] = k;
/* 1931 */       value[pos] = v;
/* 1932 */       if (this.first != -1) {
/* 1933 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1934 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1935 */         prev = pos; continue;
/*      */       } 
/* 1937 */       prev = this.first = pos;
/*      */       
/* 1939 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1942 */     this.last = prev;
/* 1943 */     if (prev != -1)
/*      */     {
/* 1945 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ShortLinkedOpenHashMap.class
