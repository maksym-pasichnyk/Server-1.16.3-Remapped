...
/*      */   
/*      */   public Object2LongOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy) {
...
/*      */ 
/*      */   
/*      */   public Object2LongOpenCustomHashMap(Map<? extends K, ? extends Long> m, float f, Hash.Strategy<K> strategy) {
...
/*      */ 
/*      */   
/*      */   public Object2LongOpenCustomHashMap(Map<? extends K, ? extends Long> m, Hash.Strategy<K> strategy) {
...
/*      */ 
/*      */   
/*      */   public Object2LongOpenCustomHashMap(Object2LongMap<K> m, float f, Hash.Strategy<K> strategy) {
...
/*      */ 
/*      */   
/*      */   public Object2LongOpenCustomHashMap(Object2LongMap<K> m, Hash.Strategy<K> strategy) {
...
/*      */ 
/*      */   
/*      */   public Object2LongOpenCustomHashMap(K[] k, long[] v, float f, Hash.Strategy<K> strategy) {
...
/*      */ 
/*      */   
/*      */   public Object2LongOpenCustomHashMap(K[] k, long[] v, Hash.Strategy<K> strategy) {
...
/*      */     
/*      */     public K getKey() {
/*  663 */       return Object2LongOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public long getLongValue() {
/*  667 */       return Object2LongOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public long setValue(long v) {
/*  671 */       long oldValue = Object2LongOpenCustomHashMap.this.value[this.index];
/*  672 */       Object2LongOpenCustomHashMap.this.value[this.index] = v;
/*  673 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  683 */       return Long.valueOf(Object2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  701 */       return (Object2LongOpenCustomHashMap.this.strategy.equals(Object2LongOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2LongOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  705 */       return Object2LongOpenCustomHashMap.this.strategy.hashCode(Object2LongOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Object2LongOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/*  709 */       return (new StringBuilder()).append(Object2LongOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2LongOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  719 */     int pos = Object2LongOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  726 */     int last = -1;
/*      */     
/*  728 */     int c = Object2LongOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  732 */     boolean mustReturnNullKey = Object2LongOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  747 */         return this.last = Object2LongOpenCustomHashMap.this.n;
/*      */       } 
...
/*  756 */           while (!Object2LongOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  757 */             p = p + 1 & Object2LongOpenCustomHashMap.this.mask; 
/*  758 */           return p;
/*      */         } 
...
/*  775 */       K[] key = Object2LongOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  777 */         pos = (last = pos) + 1 & Object2LongOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  779 */           if ((curr = key[pos]) == null) {
/*  780 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  783 */           int slot = HashCommon.mix(Object2LongOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2LongOpenCustomHashMap.this.mask;
/*  784 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  786 */           pos = pos + 1 & Object2LongOpenCustomHashMap.this.mask;
/*      */         } 
/*  788 */         if (pos < last) {
...
/*      */         } 
/*  793 */         key[last] = curr;
/*  794 */         Object2LongOpenCustomHashMap.this.value[last] = Object2LongOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  798 */       if (this.last == -1)
/*  799 */         throw new IllegalStateException(); 
/*  800 */       if (this.last == Object2LongOpenCustomHashMap.this.n) {
/*  801 */         Object2LongOpenCustomHashMap.this.containsNullKey = false;
/*  802 */         Object2LongOpenCustomHashMap.this.key[Object2LongOpenCustomHashMap.this.n] = null;
/*  803 */       } else if (this.pos >= 0) {
/*  804 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  807 */         Object2LongOpenCustomHashMap.this.removeLong(this.wrapped.set(-this.pos - 1, null));
/*  808 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  811 */       Object2LongOpenCustomHashMap.this.size--;
/*  812 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*  827 */       return this.entry = new Object2LongOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  836 */       this.entry = new Object2LongOpenCustomHashMap.MapEntry();
...
/*  846 */       return new Object2LongOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Object2LongMap.Entry<K>> fastIterator() {
/*  850 */       return new Object2LongOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  862 */       if (Object2LongOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  863 */         return (Object2LongOpenCustomHashMap.this.containsNullKey && Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n] == v);
/*      */       }
/*  865 */       K[] key = Object2LongOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  868 */       if ((curr = key[pos = HashCommon.mix(Object2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongOpenCustomHashMap.this.mask]) == null)
/*  869 */         return false; 
/*  870 */       if (Object2LongOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  871 */         return (Object2LongOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  874 */         if ((curr = key[pos = pos + 1 & Object2LongOpenCustomHashMap.this.mask]) == null)
/*  875 */           return false; 
/*  876 */         if (Object2LongOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  877 */           return (Object2LongOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  890 */       if (Object2LongOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  891 */         if (Object2LongOpenCustomHashMap.this.containsNullKey && Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n] == v) {
/*  892 */           Object2LongOpenCustomHashMap.this.removeNullEntry();
/*  893 */           return true;
/*      */         } 
/*  895 */         return false;
/*      */       } 
/*      */       
/*  898 */       K[] key = Object2LongOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  901 */       if ((curr = key[pos = HashCommon.mix(Object2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongOpenCustomHashMap.this.mask]) == null)
/*  902 */         return false; 
/*  903 */       if (Object2LongOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  904 */         if (Object2LongOpenCustomHashMap.this.value[pos] == v) {
/*  905 */           Object2LongOpenCustomHashMap.this.removeEntry(pos);
/*  906 */           return true;
/*      */         } 
/*  908 */         return false;
/*      */       } 
/*      */       while (true) {
/*  911 */         if ((curr = key[pos = pos + 1 & Object2LongOpenCustomHashMap.this.mask]) == null)
/*  912 */           return false; 
/*  913 */         if (Object2LongOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  914 */           Object2LongOpenCustomHashMap.this.value[pos] == v) {
/*  915 */           Object2LongOpenCustomHashMap.this.removeEntry(pos);
/*  916 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  923 */       return Object2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  927 */       Object2LongOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
/*  932 */       if (Object2LongOpenCustomHashMap.this.containsNullKey)
/*  933 */         consumer.accept(new AbstractObject2LongMap.BasicEntry<>(Object2LongOpenCustomHashMap.this.key[Object2LongOpenCustomHashMap.this.n], Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n])); 
/*  934 */       for (int pos = Object2LongOpenCustomHashMap.this.n; pos-- != 0;) {
/*  935 */         if (Object2LongOpenCustomHashMap.this.key[pos] != null)
/*  936 */           consumer.accept(new AbstractObject2LongMap.BasicEntry<>(Object2LongOpenCustomHashMap.this.key[pos], Object2LongOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2LongMap.Entry<K>> consumer) {
/*  941 */       AbstractObject2LongMap.BasicEntry<K> entry = new AbstractObject2LongMap.BasicEntry<>();
/*  942 */       if (Object2LongOpenCustomHashMap.this.containsNullKey) {
/*  943 */         entry.key = Object2LongOpenCustomHashMap.this.key[Object2LongOpenCustomHashMap.this.n];
/*  944 */         entry.value = Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n];
/*  945 */         consumer.accept(entry);
/*      */       } 
/*  947 */       for (int pos = Object2LongOpenCustomHashMap.this.n; pos-- != 0;) {
/*  948 */         if (Object2LongOpenCustomHashMap.this.key[pos] != null) {
/*  949 */           entry.key = Object2LongOpenCustomHashMap.this.key[pos];
/*  950 */           entry.value = Object2LongOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  976 */       return Object2LongOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  982 */       return new Object2LongOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  987 */       if (Object2LongOpenCustomHashMap.this.containsNullKey)
/*  988 */         consumer.accept(Object2LongOpenCustomHashMap.this.key[Object2LongOpenCustomHashMap.this.n]); 
/*  989 */       for (int pos = Object2LongOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  990 */         K k = Object2LongOpenCustomHashMap.this.key[pos];
/*  991 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/*  997 */       return Object2LongOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1001 */       return Object2LongOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1005 */       int oldSize = Object2LongOpenCustomHashMap.this.size;
/* 1006 */       Object2LongOpenCustomHashMap.this.removeLong(k);
/* 1007 */       return (Object2LongOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1011 */       Object2LongOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1035 */       return Object2LongOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1044 */             return new Object2LongOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1048 */             return Object2LongOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(long v) {
/* 1052 */             return Object2LongOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1056 */             Object2LongOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(LongConsumer consumer)
/*      */           {
/* 1061 */             if (Object2LongOpenCustomHashMap.this.containsNullKey)
/* 1062 */               consumer.accept(Object2LongOpenCustomHashMap.this.value[Object2LongOpenCustomHashMap.this.n]); 
/* 1063 */             for (int pos = Object2LongOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1064 */               if (Object2LongOpenCustomHashMap.this.key[pos] != null)
/* 1065 */                 consumer.accept(Object2LongOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1176 */       c = (Object2LongOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2LongOpenCustomHashMap.class
