...
/*  728 */     while (j-- != 0) {
/*  729 */       double ev = i.nextDouble();
/*  730 */       if (Double.doubleToLongBits(ev) == Double.doubleToLongBits(v))
/*  731 */         return true; 
/*      */     } 
/*  733 */     return false;
/*      */   }
...
/*  935 */       double oldValue = this.value;
...
/*  957 */         return false; 
/*  958 */       Map.Entry<K, Double> e = (Map.Entry<K, Double>)o;
/*  959 */       return (Objects.equals(this.key, e.getKey()) && 
/*  960 */         Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  964 */       return this.key.hashCode() ^ HashCommon.double2int(this.value);
/*      */     }
/*      */     
...
/* 1046 */     int index = 0;
/*      */     TreeIterator() {
/* 1048 */       this.next = Object2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(K k) {
/* 1051 */       if ((this.next = Object2DoubleAVLTreeMap.this.locateKey(k)) != null)
/* 1052 */         if (Object2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1103 */       updatePrevious();
/* 1104 */       updateNext();
/* 1105 */       Object2DoubleAVLTreeMap.this.removeDouble(this.curr.key);
/* 1106 */       this.curr = null;
/*      */     }
...
/* 1153 */       this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2DoubleMap.Entry<Object2DoubleMap.Entry<K>>>()
/*      */         {
...
/* 1162 */             return new Object2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) {
/* 1167 */             return new Object2DoubleAVLTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1175 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1176 */               return false; 
/* 1177 */             Object2DoubleAVLTreeMap.Entry<K> f = Object2DoubleAVLTreeMap.this.findKey((K)e.getKey());
...
/* 1187 */               return false; 
/* 1188 */             Object2DoubleAVLTreeMap.Entry<K> f = Object2DoubleAVLTreeMap.this.findKey((K)e.getKey());
/* 1189 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != 
/* 1190 */               Double.doubleToLongBits(((Double)e.getValue()).doubleValue()))
/* 1191 */               return false; 
/* 1192 */             Object2DoubleAVLTreeMap.this.removeDouble(f.key);
/* 1193 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1197 */             return Object2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1201 */             Object2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Object2DoubleMap.Entry<K> first() {
/* 1205 */             return Object2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Object2DoubleMap.Entry<K> last() {
/* 1209 */             return Object2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) {
/* 1214 */             return Object2DoubleAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) {
/* 1218 */             return Object2DoubleAVLTreeMap.this.headMap(to.getKey()).object2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) {
/* 1222 */             return Object2DoubleAVLTreeMap.this.tailMap(from.getKey()).object2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1256 */       return new Object2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1260 */       return new Object2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1315 */             return (DoubleIterator)new Object2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(double k) {
/* 1319 */             return Object2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1323 */             return Object2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1327 */             Object2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1390 */       if (!bottom && !top && Object2DoubleAVLTreeMap.this.compare(from, to) > 0)
/* 1391 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1392 */       this.from = from;
/* 1393 */       this.bottom = bottom;
/* 1394 */       this.to = to;
/* 1395 */       this.top = top;
/* 1396 */       this.defRetValue = Object2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1414 */       return ((this.bottom || Object2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2DoubleAVLTreeMap.this
/* 1415 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
/* 1419 */       if (this.entries == null)
/* 1420 */         this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2DoubleMap.Entry<Object2DoubleMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator() {
/* 1423 */               return new Object2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) {
/* 1428 */               return new Object2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Object2DoubleMap.Entry<K>> comparator() {
/* 1432 */               return Object2DoubleAVLTreeMap.this.object2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1441 */                 return false; 
/* 1442 */               Object2DoubleAVLTreeMap.Entry<K> f = Object2DoubleAVLTreeMap.this.findKey((K)e.getKey());
/* 1443 */               return (f != null && Object2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1451 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1452 */                 return false; 
/* 1453 */               Object2DoubleAVLTreeMap.Entry<K> f = Object2DoubleAVLTreeMap.this.findKey((K)e.getKey());
/* 1454 */               if (f != null && Object2DoubleAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Object2DoubleAVLTreeMap.Submap.this.removeDouble(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Object2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Object2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Object2DoubleMap.Entry<K> first() {
/* 1475 */               return Object2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Object2DoubleMap.Entry<K> last() {
/* 1479 */               return Object2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) {
/* 1484 */               return Object2DoubleAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) {
/* 1488 */               return Object2DoubleAVLTreeMap.Submap.this.headMap(to.getKey()).object2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) {
/* 1492 */               return Object2DoubleAVLTreeMap.Submap.this.tailMap(from.getKey()).object2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractObject2DoubleSortedMap<K>.KeySet {
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1500 */         return new Object2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1504 */         return new Object2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<K> keySet() {
...
/* 1516 */         this.values = (DoubleCollection)new AbstractDoubleCollection()
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1519 */               return (DoubleIterator)new Object2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(double k) {
/* 1523 */               return Object2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1527 */               return Object2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1531 */               Object2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(Object k) {
/* 1539 */       return (in((K)k) && Object2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(double v) {
...
/* 1546 */         double ev = (i.nextEntry()).value;
/* 1547 */         if (Double.doubleToLongBits(ev) == Double.doubleToLongBits(v))
/* 1548 */           return true; 
/*      */       } 
/* 1550 */       return false;
/*      */     }
...
/*      */     
/*      */     public double getDouble(Object k) {
/* 1556 */       K kk = (K)k; Object2DoubleAVLTreeMap.Entry<K> e;
/* 1557 */       return (in(kk) && (e = Object2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public double put(K k, double v) {
/* 1561 */       Object2DoubleAVLTreeMap.this.modified = false;
/* 1562 */       if (!in(k))
...
/* 1565 */       double oldValue = Object2DoubleAVLTreeMap.this.put(k, v);
/* 1566 */       return Object2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double removeDouble(Object k) {
/* 1571 */       Object2DoubleAVLTreeMap.this.modified = false;
/* 1572 */       if (!in((K)k))
/* 1573 */         return this.defRetValue; 
/* 1574 */       double oldValue = Object2DoubleAVLTreeMap.this.removeDouble(k);
/* 1575 */       return Object2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1593 */       return Object2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Object2DoubleSortedMap<K> headMap(K to) {
/* 1597 */       if (this.top)
/* 1598 */         return new Submap(this.from, this.bottom, to, false); 
/* 1599 */       return (Object2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Object2DoubleSortedMap<K> tailMap(K from) {
/* 1603 */       if (this.bottom)
/* 1604 */         return new Submap(from, false, this.to, this.top); 
/* 1605 */       return (Object2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Object2DoubleSortedMap<K> subMap(K from, K to) {
...
/* 1611 */       if (!this.top)
/* 1612 */         to = (Object2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1613 */       if (!this.bottom)
/* 1614 */         from = (Object2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1626 */       if (Object2DoubleAVLTreeMap.this.tree == null) {
/* 1627 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1631 */       if (this.bottom) {
/* 1632 */         e = Object2DoubleAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1634 */         e = Object2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1636 */         if (Object2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1637 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1641 */       if (e == null || (!this.top && Object2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1642 */         return null; 
/* 1643 */       return e;
/*      */     }
/*      */ 
...
/*      */       Object2DoubleAVLTreeMap.Entry<K> e;
/* 1652 */       if (Object2DoubleAVLTreeMap.this.tree == null) {
/* 1653 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1657 */       if (this.top) {
/* 1658 */         e = Object2DoubleAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1660 */         e = Object2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1662 */         if (Object2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1663 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1667 */       if (e == null || (!this.bottom && Object2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1668 */         return null; 
/* 1669 */       return e;
/*      */     }
/*      */     
/*      */     public K firstKey() {
/* 1673 */       Object2DoubleAVLTreeMap.Entry<K> e = firstEntry();
/* 1674 */       if (e == null)
...
/*      */     
/*      */     public K lastKey() {
/* 1680 */       Object2DoubleAVLTreeMap.Entry<K> e = lastEntry();
/* 1681 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1696 */         this.next = Object2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(K k) {
/* 1699 */         this();
/* 1700 */         if (this.next != null)
/* 1701 */           if (!Object2DoubleAVLTreeMap.Submap.this.bottom && Object2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1702 */             this.prev = null;
/* 1703 */           } else if (!Object2DoubleAVLTreeMap.Submap.this.top && Object2DoubleAVLTreeMap.this.compare(k, (this.prev = Object2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1704 */             this.next = null;
/*      */           } else {
/* 1706 */             this.next = Object2DoubleAVLTreeMap.this.locateKey(k);
/* 1707 */             if (Object2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1718 */         if (!Object2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Object2DoubleAVLTreeMap.this.compare(this.prev.key, Object2DoubleAVLTreeMap.Submap.this.from) < 0)
/* 1719 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1723 */         this.next = this.next.next();
/* 1724 */         if (!Object2DoubleAVLTreeMap.Submap.this.top && this.next != null && Object2DoubleAVLTreeMap.this.compare(this.next.key, Object2DoubleAVLTreeMap.Submap.this.to) >= 0)
/* 1725 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1807 */       c = (Object2DoubleAVLTreeMap<K>)super.clone();
...
/* 1888 */     if (n == 1) {
/* 1889 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readDouble());
...
/*      */ 
/*      */       
/* 1899 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readDouble());
/* 1900 */       entry.right(new Entry<>((K)s.readObject(), s.readDouble()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2DoubleAVLTreeMap.class
