...
/*  52 */     ObjectIterator<Object2ShortMap.Entry<K>> i = object2ShortEntrySet().iterator();
/*  53 */     while (i.hasNext()) {
/*  54 */       if (((Object2ShortMap.Entry)i.next()).getKey() == k)
/*  55 */         return true; 
/*  56 */     }  return false;
/*     */   }
/*     */   
...
/* 100 */         return false; 
/* 101 */       if (o instanceof Object2ShortMap.Entry) {
/* 102 */         Object2ShortMap.Entry<K> entry = (Object2ShortMap.Entry<K>)o;
/* 103 */         return (Objects.equals(this.key, entry.getKey()) && this.value == entry.getShortValue());
/*     */       } 
...
/* 109 */         return false; 
/* 110 */       return (Objects.equals(this.key, key) && this.value == ((Short)value).shortValue());
/*     */     }
/*     */     
/*     */     public int hashCode() {
...
/* 134 */         return false; 
/* 135 */       if (o instanceof Object2ShortMap.Entry) {
/* 136 */         Object2ShortMap.Entry<K> entry = (Object2ShortMap.Entry<K>)o;
...
/* 151 */         return false; 
/* 152 */       if (o instanceof Object2ShortMap.Entry) {
/* 153 */         Object2ShortMap.Entry<K> entry = (Object2ShortMap.Entry<K>)o;
...
/* 188 */           return AbstractObject2ShortMap.this.containsKey(k);
/*     */         }
/*     */         
/*     */         public int size() {
/* 192 */           return AbstractObject2ShortMap.this.size();
/*     */         }
/*     */         
/*     */         public void clear() {
/* 196 */           AbstractObject2ShortMap.this.clear();
/*     */         }
/*     */         
/*     */         public ObjectIterator<K> iterator() {
/* 200 */           return new ObjectIterator<K>()
/*     */             {
/* 202 */               private final ObjectIterator<Object2ShortMap.Entry<K>> i = Object2ShortMaps.fastIterator(AbstractObject2ShortMap.this);
/*     */               
/*     */               public K next() {
/* 205 */                 return ((Object2ShortMap.Entry<K>)this.i.next()).getKey();
/*     */               }
/*     */               
...
/* 238 */           return AbstractObject2ShortMap.this.containsValue(k);
/*     */         }
/*     */         
/*     */         public int size() {
/* 242 */           return AbstractObject2ShortMap.this.size();
/*     */         }
/*     */         
/*     */         public void clear() {
/* 246 */           AbstractObject2ShortMap.this.clear();
/*     */         }
/*     */         
/*     */         public ShortIterator iterator() {
/* 250 */           return new ShortIterator()
/*     */             {
/* 252 */               private final ObjectIterator<Object2ShortMap.Entry<K>> i = Object2ShortMaps.fastIterator(AbstractObject2ShortMap.this);
/*     */               
/*     */               public short nextShort() {
/* 255 */                 return ((Object2ShortMap.Entry)this.i.next()).getShortValue();
/*     */               }
/*     */               
/*     */               public boolean hasNext() {
...
/* 269 */     if (m instanceof Object2ShortMap) {
/* 270 */       ObjectIterator<Object2ShortMap.Entry<K>> i = Object2ShortMaps.fastIterator((Object2ShortMap)m);
/* 271 */       while (i.hasNext()) {
/* 272 */         Object2ShortMap.Entry<? extends K> e = i.next();
...
/*     */   public int hashCode() {
/* 294 */     int h = 0, n = size();
/* 295 */     ObjectIterator<Object2ShortMap.Entry<K>> i = Object2ShortMaps.fastIterator(this);
/* 296 */     while (n-- != 0)
/* 297 */       h += ((Object2ShortMap.Entry)i.next()).hashCode(); 
/* 298 */     return h;
/*     */   }
/*     */   
/*     */   public boolean equals(Object o) {
...
/* 307 */     if (m.size() != size())
/* 308 */       return false; 
/* 309 */     return object2ShortEntrySet().containsAll(m.entrySet());
/*     */   }
/*     */   
/*     */   public String toString() {
/* 313 */     StringBuilder s = new StringBuilder();
/* 314 */     ObjectIterator<Object2ShortMap.Entry<K>> i = Object2ShortMaps.fastIterator(this);
/* 315 */     int n = size();
/*     */     
...
/*     */       } else {
/* 323 */         s.append(", ");
/* 324 */       }  Object2ShortMap.Entry<K> e = i.next();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\AbstractObject2ShortMap.class
