...
/* 1111 */     K[] key = this.key;
/* 1112 */     float[] value = this.value;
/* 1113 */     int mask = newN - 1;
/* 1114 */     K[] newKey = (K[])new Object[newN + 1];
/* 1115 */     float[] newValue = new float[newN + 1];
/* 1116 */     int i = this.n;
/* 1117 */     for (int j = realSize(); j-- != 0; ) {
/* 1118 */       while (key[--i] == null); int pos;
/* 1119 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null)
/* 1120 */         while (newKey[pos = pos + 1 & mask] != null); 
/* 1121 */       newKey[pos] = key[i];
/* 1122 */       newValue[pos] = value[i];
/*      */     } 
/* 1124 */     newValue[newN] = value[this.n];
/* 1125 */     this.n = newN;
/* 1126 */     this.mask = mask;
/* 1127 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1128 */     this.key = newKey;
/* 1129 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1146 */       c = (Object2FloatOpenHashMap<K>)super.clone();
/* 1147 */     } catch (CloneNotSupportedException cantHappen) {
/* 1148 */       throw new InternalError();
/*      */     } 
/* 1150 */     c.keys = null;
/* 1151 */     c.values = null;
/* 1152 */     c.entries = null;
/* 1153 */     c.containsNullKey = this.containsNullKey;
/* 1154 */     c.key = (K[])this.key.clone();
/* 1155 */     c.value = (float[])this.value.clone();
/* 1156 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1169 */     int h = 0;
/* 1170 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1171 */       while (this.key[i] == null)
/* 1172 */         i++; 
/* 1173 */       if (this != this.key[i])
/* 1174 */         t = this.key[i].hashCode(); 
/* 1175 */       t ^= HashCommon.float2int(this.value[i]);
/* 1176 */       h += t;
/* 1177 */       i++;
/*      */     } 
/*      */     
/* 1180 */     if (this.containsNullKey)
/* 1181 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1182 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1185 */     K[] key = this.key;
/* 1186 */     float[] value = this.value;
/* 1187 */     MapIterator i = new MapIterator();
/* 1188 */     s.defaultWriteObject();
/* 1189 */     for (int j = this.size; j-- != 0; ) {
/* 1190 */       int e = i.nextEntry();
/* 1191 */       s.writeObject(key[e]);
/* 1192 */       s.writeFloat(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1197 */     s.defaultReadObject();
/* 1198 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1199 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1200 */     this.mask = this.n - 1;
/* 1201 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1202 */     float[] value = this.value = new float[this.n + 1];
/*      */ 
/*      */     
/* 1205 */     for (int i = this.size; i-- != 0; ) {
/* 1206 */       int pos; K k = (K)s.readObject();
/* 1207 */       float v = s.readFloat();
/* 1208 */       if (k == null) {
/* 1209 */         pos = this.n;
/* 1210 */         this.containsNullKey = true;
/*      */       } else {
/* 1212 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1213 */         while (key[pos] != null)
/* 1214 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1216 */       key[pos] = k;
/* 1217 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2FloatOpenHashMap.class
