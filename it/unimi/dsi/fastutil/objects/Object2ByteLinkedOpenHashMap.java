...
/* 1798 */     K[] key = this.key;
/* 1799 */     byte[] value = this.value;
/* 1800 */     int mask = newN - 1;
/* 1801 */     K[] newKey = (K[])new Object[newN + 1];
/* 1802 */     byte[] newValue = new byte[newN + 1];
...
/*      */     try {
/* 1856 */       c = (Object2ByteLinkedOpenHashMap<K>)super.clone();
...
/* 1865 */     c.value = (byte[])this.value.clone();
...
/* 1913 */     byte[] value = this.value = new byte[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ByteLinkedOpenHashMap.class
