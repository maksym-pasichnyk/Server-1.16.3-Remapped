...
/*      */   
/*      */   public boolean trim() {
/* 1690 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1691 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1692 */       return true; 
/*      */     try {
/* 1694 */       rehash(l);
/* 1695 */     } catch (OutOfMemoryError cantDoIt) {
/* 1696 */       return false;
/*      */     } 
/* 1698 */     return true;
/*      */   }
...
/* 1722 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1723 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1724 */       return true; 
/*      */     try {
/* 1726 */       rehash(l);
/* 1727 */     } catch (OutOfMemoryError cantDoIt) {
/* 1728 */       return false;
/*      */     } 
/* 1730 */     return true;
/*      */   }
...
/* 1746 */     K[] key = this.key;
/* 1747 */     boolean[] value = this.value;
/* 1748 */     int mask = newN - 1;
/* 1749 */     K[] newKey = (K[])new Object[newN + 1];
/* 1750 */     boolean[] newValue = new boolean[newN + 1];
/* 1751 */     int i = this.first, prev = -1, newPrev = -1;
/* 1752 */     long[] link = this.link;
/* 1753 */     long[] newLink = new long[newN + 1];
/* 1754 */     this.first = -1;
/* 1755 */     for (int j = this.size; j-- != 0; ) {
/* 1756 */       int pos; if (key[i] == null) {
/* 1757 */         pos = newN;
/*      */       } else {
/* 1759 */         pos = HashCommon.mix(System.identityHashCode(key[i])) & mask;
/* 1760 */         while (newKey[pos] != null)
/* 1761 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1763 */       newKey[pos] = key[i];
/* 1764 */       newValue[pos] = value[i];
/* 1765 */       if (prev != -1) {
/* 1766 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1767 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1768 */         newPrev = pos;
/*      */       } else {
/* 1770 */         newPrev = this.first = pos;
/*      */         
/* 1772 */         newLink[pos] = -1L;
/*      */       } 
/* 1774 */       int t = i;
...
/* 1776 */       prev = t;
/*      */     } 
/* 1778 */     this.link = newLink;
/* 1779 */     this.last = newPrev;
/* 1780 */     if (newPrev != -1)
/*      */     {
/* 1782 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1783 */     this.n = newN;
/* 1784 */     this.mask = mask;
/* 1785 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1786 */     this.key = newKey;
/* 1787 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1804 */       c = (Reference2BooleanLinkedOpenHashMap<K>)super.clone();
...
/* 1809 */     c.values = null;
/* 1810 */     c.entries = null;
/* 1811 */     c.containsNullKey = this.containsNullKey;
/* 1812 */     c.key = (K[])this.key.clone();
/* 1813 */     c.value = (boolean[])this.value.clone();
/* 1814 */     c.link = (long[])this.link.clone();
/* 1815 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1828 */     int h = 0;
/* 1829 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1830 */       while (this.key[i] == null)
/* 1831 */         i++; 
/* 1832 */       if (this != this.key[i])
/* 1833 */         t = System.identityHashCode(this.key[i]); 
/* 1834 */       t ^= this.value[i] ? 1231 : 1237;
/* 1835 */       h += t;
/* 1836 */       i++;
/*      */     } 
/*      */     
/* 1839 */     if (this.containsNullKey)
/* 1840 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1841 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1844 */     K[] key = this.key;
/* 1845 */     boolean[] value = this.value;
/* 1846 */     MapIterator i = new MapIterator();
/* 1847 */     s.defaultWriteObject();
/* 1848 */     for (int j = this.size; j-- != 0; ) {
/* 1849 */       int e = i.nextEntry();
/* 1850 */       s.writeObject(key[e]);
/* 1851 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1856 */     s.defaultReadObject();
/* 1857 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1858 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1859 */     this.mask = this.n - 1;
/* 1860 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1861 */     boolean[] value = this.value = new boolean[this.n + 1];
/* 1862 */     long[] link = this.link = new long[this.n + 1];
/* 1863 */     int prev = -1;
/* 1864 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1867 */     for (int i = this.size; i-- != 0; ) {
/* 1868 */       int pos; K k = (K)s.readObject();
/* 1869 */       boolean v = s.readBoolean();
/* 1870 */       if (k == null) {
/* 1871 */         pos = this.n;
/* 1872 */         this.containsNullKey = true;
/*      */       } else {
/* 1874 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1875 */         while (key[pos] != null)
/* 1876 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1878 */       key[pos] = k;
/* 1879 */       value[pos] = v;
/* 1880 */       if (this.first != -1) {
/* 1881 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1882 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1883 */         prev = pos; continue;
/*      */       } 
/* 1885 */       prev = this.first = pos;
/*      */       
/* 1887 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1890 */     this.last = prev;
/* 1891 */     if (prev != -1)
/*      */     {
/* 1893 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2BooleanLinkedOpenHashMap.class
