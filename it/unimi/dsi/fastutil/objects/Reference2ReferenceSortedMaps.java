...
/*  60 */     ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> entries = map.reference2ReferenceEntrySet();
/*  61 */     return (entries instanceof Reference2ReferenceSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Reference2ReferenceSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  80 */     ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> entries = map.reference2ReferenceEntrySet();
/*     */     
/*  82 */     Objects.requireNonNull((Reference2ReferenceSortedMap.FastSortedEntrySet)entries); return (entries instanceof Reference2ReferenceSortedMap.FastSortedEntrySet) ? (Reference2ReferenceSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  83 */       entries;
/*     */   }
/*     */ 
/*     */ 
...
/* 123 */       return Reference2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Reference2ReferenceSortedMap<K, V> headMap(K to) {
/* 128 */       return Reference2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Reference2ReferenceSortedMap<K, V> tailMap(K from) {
/* 133 */       return Reference2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public K firstKey() {
...
/* 194 */         this.entries = ObjectSortedSets.singleton(new AbstractReference2ReferenceMap.BasicEntry<>(this.key, this.value), 
/* 195 */             (Comparator)Reference2ReferenceSortedMaps.entryComparator(this.comparator)); 
/* 196 */       return (ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() {
/* 202 */       return (ObjectSortedSet)reference2ReferenceEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* 214 */         return this; 
/* 215 */       return Reference2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Reference2ReferenceSortedMap<K, V> headMap(K to) {
...
/* 221 */         return this; 
/* 222 */       return Reference2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Reference2ReferenceSortedMap<K, V> tailMap(K from) {
...
/* 228 */         return this; 
/* 229 */       return Reference2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public K firstKey() {
/* 233 */       return this.key;
...
/* 303 */         this.entries = ObjectSortedSets.synchronize(this.sortedMap.reference2ReferenceEntrySet(), this.sync); 
/* 304 */       return (ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() {
/* 310 */       return (ObjectSortedSet)reference2ReferenceEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* 389 */         this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.reference2ReferenceEntrySet()); 
/* 390 */       return (ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() {
/* 396 */       return (ObjectSortedSet)reference2ReferenceEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSortedSet<K> keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2ReferenceSortedMaps.class
