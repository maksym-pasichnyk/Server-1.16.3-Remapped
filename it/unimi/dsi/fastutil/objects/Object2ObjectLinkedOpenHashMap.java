...
/*      */   
/*      */   public boolean trim() {
/* 1517 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1518 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1519 */       return true; 
/*      */     try {
/* 1521 */       rehash(l);
/* 1522 */     } catch (OutOfMemoryError cantDoIt) {
/* 1523 */       return false;
/*      */     } 
/* 1525 */     return true;
/*      */   }
...
/* 1549 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1550 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1551 */       return true; 
/*      */     try {
/* 1553 */       rehash(l);
...
/* 1573 */     K[] key = this.key;
/* 1574 */     V[] value = this.value;
/* 1575 */     int mask = newN - 1;
/* 1576 */     K[] newKey = (K[])new Object[newN + 1];
/* 1577 */     V[] newValue = (V[])new Object[newN + 1];
/* 1578 */     int i = this.first, prev = -1, newPrev = -1;
/* 1579 */     long[] link = this.link;
/* 1580 */     long[] newLink = new long[newN + 1];
/* 1581 */     this.first = -1;
/* 1582 */     for (int j = this.size; j-- != 0; ) {
/* 1583 */       int pos; if (key[i] == null) {
/* 1584 */         pos = newN;
/*      */       } else {
/* 1586 */         pos = HashCommon.mix(key[i].hashCode()) & mask;
/* 1587 */         while (newKey[pos] != null)
/* 1588 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1590 */       newKey[pos] = key[i];
/* 1591 */       newValue[pos] = value[i];
/* 1592 */       if (prev != -1) {
/* 1593 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1594 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1595 */         newPrev = pos;
/*      */       } else {
/* 1597 */         newPrev = this.first = pos;
/*      */         
/* 1599 */         newLink[pos] = -1L;
/*      */       } 
/* 1601 */       int t = i;
...
/* 1603 */       prev = t;
/*      */     } 
/* 1605 */     this.link = newLink;
/* 1606 */     this.last = newPrev;
/* 1607 */     if (newPrev != -1)
/*      */     {
/* 1609 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1610 */     this.n = newN;
/* 1611 */     this.mask = mask;
/* 1612 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1613 */     this.key = newKey;
/* 1614 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1631 */       c = (Object2ObjectLinkedOpenHashMap<K, V>)super.clone();
/* 1632 */     } catch (CloneNotSupportedException cantHappen) {
/* 1633 */       throw new InternalError();
/*      */     } 
/* 1635 */     c.keys = null;
/* 1636 */     c.values = null;
/* 1637 */     c.entries = null;
/* 1638 */     c.containsNullKey = this.containsNullKey;
/* 1639 */     c.key = (K[])this.key.clone();
/* 1640 */     c.value = (V[])this.value.clone();
/* 1641 */     c.link = (long[])this.link.clone();
/* 1642 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1655 */     int h = 0;
/* 1656 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1657 */       while (this.key[i] == null)
/* 1658 */         i++; 
/* 1659 */       if (this != this.key[i])
/* 1660 */         t = this.key[i].hashCode(); 
/* 1661 */       if (this != this.value[i])
/* 1662 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1663 */       h += t;
/* 1664 */       i++;
/*      */     } 
/*      */     
/* 1667 */     if (this.containsNullKey)
/* 1668 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1669 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1672 */     K[] key = this.key;
/* 1673 */     V[] value = this.value;
/* 1674 */     MapIterator i = new MapIterator();
/* 1675 */     s.defaultWriteObject();
/* 1676 */     for (int j = this.size; j-- != 0; ) {
/* 1677 */       int e = i.nextEntry();
/* 1678 */       s.writeObject(key[e]);
/* 1679 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1684 */     s.defaultReadObject();
/* 1685 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1686 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1687 */     this.mask = this.n - 1;
/* 1688 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1689 */     V[] value = this.value = (V[])new Object[this.n + 1];
/* 1690 */     long[] link = this.link = new long[this.n + 1];
/* 1691 */     int prev = -1;
/* 1692 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1695 */     for (int i = this.size; i-- != 0; ) {
/* 1696 */       int pos; K k = (K)s.readObject();
/* 1697 */       V v = (V)s.readObject();
/* 1698 */       if (k == null) {
/* 1699 */         pos = this.n;
/* 1700 */         this.containsNullKey = true;
/*      */       } else {
/* 1702 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1703 */         while (key[pos] != null)
/* 1704 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1706 */       key[pos] = k;
/* 1707 */       value[pos] = v;
/* 1708 */       if (this.first != -1) {
/* 1709 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1710 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1711 */         prev = pos; continue;
/*      */       } 
/* 1713 */       prev = this.first = pos;
/*      */       
/* 1715 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1718 */     this.last = prev;
/* 1719 */     if (prev != -1)
/*      */     {
/* 1721 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ObjectLinkedOpenHashMap.class
