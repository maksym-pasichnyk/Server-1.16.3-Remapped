...
/*  49 */     ObjectSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
/*  50 */     return (entries instanceof Reference2CharMap.FastEntrySet) ? (
/*  51 */       (Reference2CharMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  71 */     ObjectSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
/*  72 */     if (entries instanceof Reference2CharMap.FastEntrySet) {
/*  73 */       ((Reference2CharMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  91 */     final ObjectSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
/*  92 */     return (entries instanceof Reference2CharMap.FastEntrySet) ? (ObjectIterable)new ObjectIterable<Reference2CharMap.Entry<Reference2CharMap.Entry<K>>>() {
/*     */         public ObjectIterator<Reference2CharMap.Entry<K>> iterator() {
/*  94 */           return ((Reference2CharMap.FastEntrySet<K>)entries).fastIterator();
/*     */         }
/*     */         public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
/*  97 */           ((Reference2CharMap.FastEntrySet<K>)entries).fastForEach(consumer);
/*     */         }
/*  99 */       } : entries;
/*     */   }
/*     */ 
...
/*     */     
/*     */     public Object clone() {
/* 151 */       return Reference2CharMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 229 */         this.entries = ObjectSets.singleton(new AbstractReference2CharMap.BasicEntry<>(this.key, this.value)); 
...
/* 241 */       return (ObjectSet)reference2CharEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/* 361 */           this.entries = ObjectSets.synchronize(this.map.reference2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Character>> entrySet() {
/* 374 */       return (ObjectSet)reference2CharEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/* 651 */         this.entries = ObjectSets.unmodifiable(this.map.reference2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Character>> entrySet() {
/* 663 */       return (ObjectSet)reference2CharEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSet<K> keySet() {
/* 667 */       if (this.keys == null)
/* 668 */         this.keys = ReferenceSets.unmodifiable(this.map.keySet()); 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2CharMaps.class
