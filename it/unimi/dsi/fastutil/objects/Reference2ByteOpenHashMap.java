...
/*  516 */     byte oldValue = this.value[pos];
...
/*  527 */     byte newValue = SafeMath.safeIntToByte(mappingFunction.applyAsInt(k));
...
/*  539 */     Byte newValue = remappingFunction.apply(k, Byte.valueOf(this.value[pos]));
...
/*      */     } 
/*  547 */     this.value[pos] = newValue.byteValue(); return newValue.byteValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  554 */     int pos = find(k);
/*  555 */     Byte newValue = remappingFunction.apply(k, (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  580 */       return v;
/*      */     } 
/*  582 */     Byte newValue = remappingFunction.apply(Byte.valueOf(this.value[pos]), Byte.valueOf(v));
...
/*      */     
/*      */     public K getKey() {
/*  631 */       return Reference2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/*  635 */       return Reference2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/*  639 */       byte oldValue = Reference2ByteOpenHashMap.this.value[this.index];
/*  640 */       Reference2ByteOpenHashMap.this.value[this.index] = v;
/*  641 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  651 */       return Byte.valueOf(Reference2ByteOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte setValue(Byte v) {
/*  661 */       return Byte.valueOf(setValue(v.byteValue()));
/*      */     }
/*      */ 
/*      */     
...
/*  667 */         return false; 
/*  668 */       Map.Entry<K, Byte> e = (Map.Entry<K, Byte>)o;
/*  669 */       return (Reference2ByteOpenHashMap.this.key[this.index] == e.getKey() && Reference2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  673 */       return System.identityHashCode(Reference2ByteOpenHashMap.this.key[this.index]) ^ Reference2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  677 */       return (new StringBuilder()).append(Reference2ByteOpenHashMap.this.key[this.index]).append("=>").append(Reference2ByteOpenHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  687 */     int pos = Reference2ByteOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  694 */     int last = -1;
/*      */     
/*  696 */     int c = Reference2ByteOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  700 */     boolean mustReturnNullKey = Reference2ByteOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  715 */         return this.last = Reference2ByteOpenHashMap.this.n;
/*      */       } 
/*  717 */       K[] key = Reference2ByteOpenHashMap.this.key;
/*      */       while (true) {
/*  719 */         if (--this.pos < 0) {
/*      */           
/*  721 */           this.last = Integer.MIN_VALUE;
/*  722 */           K k = this.wrapped.get(-this.pos - 1);
/*  723 */           int p = HashCommon.mix(System.identityHashCode(k)) & Reference2ByteOpenHashMap.this.mask;
/*  724 */           while (k != key[p])
/*  725 */             p = p + 1 & Reference2ByteOpenHashMap.this.mask; 
/*  726 */           return p;
/*      */         } 
...
/*  743 */       K[] key = Reference2ByteOpenHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  745 */         pos = (last = pos) + 1 & Reference2ByteOpenHashMap.this.mask;
/*      */         while (true) {
/*  747 */           if ((curr = key[pos]) == null) {
/*  748 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  751 */           int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ByteOpenHashMap.this.mask;
/*  752 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  754 */           pos = pos + 1 & Reference2ByteOpenHashMap.this.mask;
/*      */         } 
/*  756 */         if (pos < last) {
...
/*      */         } 
/*  761 */         key[last] = curr;
/*  762 */         Reference2ByteOpenHashMap.this.value[last] = Reference2ByteOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  766 */       if (this.last == -1)
/*  767 */         throw new IllegalStateException(); 
/*  768 */       if (this.last == Reference2ByteOpenHashMap.this.n) {
/*  769 */         Reference2ByteOpenHashMap.this.containsNullKey = false;
/*  770 */         Reference2ByteOpenHashMap.this.key[Reference2ByteOpenHashMap.this.n] = null;
/*  771 */       } else if (this.pos >= 0) {
/*  772 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  775 */         Reference2ByteOpenHashMap.this.removeByte(this.wrapped.set(-this.pos - 1, null));
/*  776 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  779 */       Reference2ByteOpenHashMap.this.size--;
/*  780 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Reference2ByteMap.Entry<K>> { private Reference2ByteOpenHashMap<K>.MapEntry entry;
/*      */     
/*      */     public Reference2ByteOpenHashMap<K>.MapEntry next() {
/*  795 */       return this.entry = new Reference2ByteOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  804 */       this.entry = new Reference2ByteOpenHashMap.MapEntry();
...
/*  814 */       return new Reference2ByteOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Reference2ByteMap.Entry<K>> fastIterator() {
/*  818 */       return new Reference2ByteOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  830 */       if (k == null) {
/*  831 */         return (Reference2ByteOpenHashMap.this.containsNullKey && Reference2ByteOpenHashMap.this.value[Reference2ByteOpenHashMap.this.n] == v);
/*      */       }
/*  833 */       K[] key = Reference2ByteOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  836 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ByteOpenHashMap.this.mask]) == null)
/*      */       {
/*  838 */         return false; } 
/*  839 */       if (k == curr) {
/*  840 */         return (Reference2ByteOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  843 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenHashMap.this.mask]) == null)
/*  844 */           return false; 
/*  845 */         if (k == curr) {
/*  846 */           return (Reference2ByteOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  855 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/*  856 */         return false; 
/*  857 */       K k = (K)e.getKey();
/*  858 */       byte v = ((Byte)e.getValue()).byteValue();
/*  859 */       if (k == null) {
/*  860 */         if (Reference2ByteOpenHashMap.this.containsNullKey && Reference2ByteOpenHashMap.this.value[Reference2ByteOpenHashMap.this.n] == v) {
/*  861 */           Reference2ByteOpenHashMap.this.removeNullEntry();
/*  862 */           return true;
/*      */         } 
/*  864 */         return false;
/*      */       } 
/*      */       
/*  867 */       K[] key = Reference2ByteOpenHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  870 */       if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ByteOpenHashMap.this.mask]) == null)
/*      */       {
/*  872 */         return false; } 
/*  873 */       if (curr == k) {
/*  874 */         if (Reference2ByteOpenHashMap.this.value[pos] == v) {
/*  875 */           Reference2ByteOpenHashMap.this.removeEntry(pos);
/*  876 */           return true;
/*      */         } 
/*  878 */         return false;
/*      */       } 
/*      */       while (true) {
/*  881 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenHashMap.this.mask]) == null)
/*  882 */           return false; 
/*  883 */         if (curr == k && 
/*  884 */           Reference2ByteOpenHashMap.this.value[pos] == v) {
/*  885 */           Reference2ByteOpenHashMap.this.removeEntry(pos);
/*  886 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  893 */       return Reference2ByteOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  897 */       Reference2ByteOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/*  902 */       if (Reference2ByteOpenHashMap.this.containsNullKey)
/*  903 */         consumer.accept(new AbstractReference2ByteMap.BasicEntry<>(Reference2ByteOpenHashMap.this.key[Reference2ByteOpenHashMap.this.n], Reference2ByteOpenHashMap.this.value[Reference2ByteOpenHashMap.this.n])); 
/*  904 */       for (int pos = Reference2ByteOpenHashMap.this.n; pos-- != 0;) {
/*  905 */         if (Reference2ByteOpenHashMap.this.key[pos] != null)
/*  906 */           consumer.accept(new AbstractReference2ByteMap.BasicEntry<>(Reference2ByteOpenHashMap.this.key[pos], Reference2ByteOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/*  911 */       AbstractReference2ByteMap.BasicEntry<K> entry = new AbstractReference2ByteMap.BasicEntry<>();
/*  912 */       if (Reference2ByteOpenHashMap.this.containsNullKey) {
/*  913 */         entry.key = Reference2ByteOpenHashMap.this.key[Reference2ByteOpenHashMap.this.n];
/*  914 */         entry.value = Reference2ByteOpenHashMap.this.value[Reference2ByteOpenHashMap.this.n];
/*  915 */         consumer.accept(entry);
/*      */       } 
/*  917 */       for (int pos = Reference2ByteOpenHashMap.this.n; pos-- != 0;) {
/*  918 */         if (Reference2ByteOpenHashMap.this.key[pos] != null) {
/*  919 */           entry.key = Reference2ByteOpenHashMap.this.key[pos];
/*  920 */           entry.value = Reference2ByteOpenHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  946 */       return Reference2ByteOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  952 */       return new Reference2ByteOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  957 */       if (Reference2ByteOpenHashMap.this.containsNullKey)
/*  958 */         consumer.accept(Reference2ByteOpenHashMap.this.key[Reference2ByteOpenHashMap.this.n]); 
/*  959 */       for (int pos = Reference2ByteOpenHashMap.this.n; pos-- != 0; ) {
/*  960 */         K k = Reference2ByteOpenHashMap.this.key[pos];
/*  961 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/*  967 */       return Reference2ByteOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/*  971 */       return Reference2ByteOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/*  975 */       int oldSize = Reference2ByteOpenHashMap.this.size;
/*  976 */       Reference2ByteOpenHashMap.this.removeByte(k);
/*  977 */       return (Reference2ByteOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  981 */       Reference2ByteOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1005 */       return Reference2ByteOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public ByteCollection values() {
/* 1010 */     if (this.values == null)
/* 1011 */       this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1014 */             return new Reference2ByteOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1018 */             return Reference2ByteOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1022 */             return Reference2ByteOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1026 */             Reference2ByteOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1031 */             if (Reference2ByteOpenHashMap.this.containsNullKey)
/* 1032 */               consumer.accept(Reference2ByteOpenHashMap.this.value[Reference2ByteOpenHashMap.this.n]); 
/* 1033 */             for (int pos = Reference2ByteOpenHashMap.this.n; pos-- != 0;) {
/* 1034 */               if (Reference2ByteOpenHashMap.this.key[pos] != null)
/* 1035 */                 consumer.accept(Reference2ByteOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1111 */     K[] key = this.key;
/* 1112 */     byte[] value = this.value;
/* 1113 */     int mask = newN - 1;
/* 1114 */     K[] newKey = (K[])new Object[newN + 1];
/* 1115 */     byte[] newValue = new byte[newN + 1];
/* 1116 */     int i = this.n;
...
/*      */     try {
/* 1147 */       c = (Reference2ByteOpenHashMap<K>)super.clone();
...
/* 1156 */     c.value = (byte[])this.value.clone();
/* 1157 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1203 */     byte[] value = this.value = new byte[this.n + 1];
/*      */ 
/*      */     
/* 1206 */     for (int i = this.size; i-- != 0; ) {
/* 1207 */       int pos; K k = (K)s.readObject();
/* 1208 */       byte v = s.readByte();
/* 1209 */       if (k == null) {
/* 1210 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2ByteOpenHashMap.class
