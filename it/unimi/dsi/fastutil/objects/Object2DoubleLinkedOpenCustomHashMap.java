...
/*      */   
/*      */   public boolean trim() {
/* 1779 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1780 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1781 */       return true; 
/*      */     try {
/* 1783 */       rehash(l);
/* 1784 */     } catch (OutOfMemoryError cantDoIt) {
/* 1785 */       return false;
/*      */     } 
/* 1787 */     return true;
/*      */   }
...
/* 1811 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1812 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1813 */       return true; 
/*      */     try {
/* 1815 */       rehash(l);
/* 1816 */     } catch (OutOfMemoryError cantDoIt) {
/* 1817 */       return false;
/*      */     } 
/* 1819 */     return true;
/*      */   }
...
/* 1835 */     K[] key = this.key;
/* 1836 */     double[] value = this.value;
/* 1837 */     int mask = newN - 1;
/* 1838 */     K[] newKey = (K[])new Object[newN + 1];
/* 1839 */     double[] newValue = new double[newN + 1];
/* 1840 */     int i = this.first, prev = -1, newPrev = -1;
/* 1841 */     long[] link = this.link;
/* 1842 */     long[] newLink = new long[newN + 1];
/* 1843 */     this.first = -1;
/* 1844 */     for (int j = this.size; j-- != 0; ) {
/* 1845 */       int pos; if (this.strategy.equals(key[i], null)) {
/* 1846 */         pos = newN;
/*      */       } else {
/* 1848 */         pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask;
/* 1849 */         while (newKey[pos] != null)
/* 1850 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1852 */       newKey[pos] = key[i];
/* 1853 */       newValue[pos] = value[i];
/* 1854 */       if (prev != -1) {
/* 1855 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1856 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1857 */         newPrev = pos;
/*      */       } else {
/* 1859 */         newPrev = this.first = pos;
/*      */         
/* 1861 */         newLink[pos] = -1L;
/*      */       } 
/* 1863 */       int t = i;
...
/* 1865 */       prev = t;
/*      */     } 
/* 1867 */     this.link = newLink;
/* 1868 */     this.last = newPrev;
/* 1869 */     if (newPrev != -1)
/*      */     {
/* 1871 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1872 */     this.n = newN;
/* 1873 */     this.mask = mask;
/* 1874 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1875 */     this.key = newKey;
/* 1876 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1893 */       c = (Object2DoubleLinkedOpenCustomHashMap<K>)super.clone();
/* 1894 */     } catch (CloneNotSupportedException cantHappen) {
/* 1895 */       throw new InternalError();
/*      */     } 
/* 1897 */     c.keys = null;
/* 1898 */     c.values = null;
/* 1899 */     c.entries = null;
/* 1900 */     c.containsNullKey = this.containsNullKey;
/* 1901 */     c.key = (K[])this.key.clone();
/* 1902 */     c.value = (double[])this.value.clone();
/* 1903 */     c.link = (long[])this.link.clone();
/* 1904 */     c.strategy = this.strategy;
/* 1905 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1918 */     int h = 0;
/* 1919 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1920 */       while (this.key[i] == null)
/* 1921 */         i++; 
/* 1922 */       if (this != this.key[i])
/* 1923 */         t = this.strategy.hashCode(this.key[i]); 
/* 1924 */       t ^= HashCommon.double2int(this.value[i]);
/* 1925 */       h += t;
/* 1926 */       i++;
/*      */     } 
/*      */     
/* 1929 */     if (this.containsNullKey)
/* 1930 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1931 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1934 */     K[] key = this.key;
/* 1935 */     double[] value = this.value;
/* 1936 */     MapIterator i = new MapIterator();
/* 1937 */     s.defaultWriteObject();
/* 1938 */     for (int j = this.size; j-- != 0; ) {
/* 1939 */       int e = i.nextEntry();
/* 1940 */       s.writeObject(key[e]);
/* 1941 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1946 */     s.defaultReadObject();
/* 1947 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1948 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1949 */     this.mask = this.n - 1;
/* 1950 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1951 */     double[] value = this.value = new double[this.n + 1];
/* 1952 */     long[] link = this.link = new long[this.n + 1];
/* 1953 */     int prev = -1;
/* 1954 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1957 */     for (int i = this.size; i-- != 0; ) {
/* 1958 */       int pos; K k = (K)s.readObject();
/* 1959 */       double v = s.readDouble();
/* 1960 */       if (this.strategy.equals(k, null)) {
/* 1961 */         pos = this.n;
/* 1962 */         this.containsNullKey = true;
/*      */       } else {
/* 1964 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1965 */         while (key[pos] != null)
/* 1966 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1968 */       key[pos] = k;
/* 1969 */       value[pos] = v;
/* 1970 */       if (this.first != -1) {
/* 1971 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1972 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1973 */         prev = pos; continue;
/*      */       } 
/* 1975 */       prev = this.first = pos;
/*      */       
/* 1977 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1980 */     this.last = prev;
/* 1981 */     if (prev != -1)
/*      */     {
/* 1983 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2DoubleLinkedOpenCustomHashMap.class
