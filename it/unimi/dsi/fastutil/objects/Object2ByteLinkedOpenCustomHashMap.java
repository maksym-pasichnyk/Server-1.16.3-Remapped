...
/*  167 */     this.value = new byte[this.n + 1];
...
/*  306 */     byte oldValue = this.value[pos];
/*  307 */     this.size--;
/*  308 */     fixPointers(pos);
/*  309 */     shiftKeys(pos);
...
/*  317 */     byte oldValue = this.value[this.n];
/*  318 */     this.size--;
...
/*      */     } 
/*  379 */     byte oldValue = this.value[pos];
/*  380 */     this.value[pos] = v;
/*  381 */     return oldValue;
/*      */   }
/*      */   private byte addToValue(int pos, byte incr) {
/*  384 */     byte oldValue = this.value[pos];
/*  385 */     this.value[pos] = (byte)(oldValue + incr);
/*  386 */     return oldValue;
/*      */   }
/*      */ 
/*      */ 
...
/*      */       } 
/*  423 */     }  this.key[pos] = k;
/*  424 */     this.value[pos] = (byte)(this.defRetValue + incr);
/*  425 */     if (this.size == 0) {
...
/*  493 */     byte oldValue = this.value[pos];
...
/*  899 */     byte oldValue = this.value[pos];
...
/*  910 */     byte newValue = SafeMath.safeIntToByte(mappingFunction.applyAsInt(k));
...
/*  922 */     Byte newValue = remappingFunction.apply(k, Byte.valueOf(this.value[pos]));
...
/*      */     } 
/*  930 */     this.value[pos] = newValue.byteValue(); return newValue.byteValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  937 */     int pos = find(k);
/*  938 */     Byte newValue = remappingFunction.apply(k, (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  948 */     byte newVal = newValue.byteValue();
/*  949 */     if (pos < 0) {
...
/*  963 */       return v;
/*      */     } 
/*  965 */     Byte newValue = remappingFunction.apply(Byte.valueOf(this.value[pos]), Byte.valueOf(v));
...
/*      */     } 
/*  973 */     this.value[pos] = newValue.byteValue(); return newValue.byteValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/* 1015 */       return Object2ByteLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/* 1019 */       return Object2ByteLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/* 1023 */       byte oldValue = Object2ByteLinkedOpenCustomHashMap.this.value[this.index];
/* 1024 */       Object2ByteLinkedOpenCustomHashMap.this.value[this.index] = v;
...
/* 1035 */       return Byte.valueOf(Object2ByteLinkedOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte setValue(Byte v) {
/* 1045 */       return Byte.valueOf(setValue(v.byteValue()));
/*      */     }
/*      */ 
/*      */     
...
/* 1051 */         return false; 
/* 1052 */       Map.Entry<K, Byte> e = (Map.Entry<K, Byte>)o;
/* 1053 */       return (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(Object2ByteLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2ByteLinkedOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1057 */       return Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(Object2ByteLinkedOpenCustomHashMap.this.key[this.index]) ^ Object2ByteLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1061 */       return (new StringBuilder()).append(Object2ByteLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2ByteLinkedOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1224 */       this.next = Object2ByteLinkedOpenCustomHashMap.this.first;
/* 1225 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(K from) {
/* 1228 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
/* 1229 */         if (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey) {
/* 1230 */           this.next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[Object2ByteLinkedOpenCustomHashMap.this.n];
/* 1231 */           this.prev = Object2ByteLinkedOpenCustomHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1234 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1236 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.last], from)) {
/* 1237 */         this.prev = Object2ByteLinkedOpenCustomHashMap.this.last;
/* 1238 */         this.index = Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1242 */       int pos = HashCommon.mix(Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2ByteLinkedOpenCustomHashMap.this.mask;
/*      */       
/* 1244 */       while (Object2ByteLinkedOpenCustomHashMap.this.key[pos] != null) {
/* 1245 */         if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(Object2ByteLinkedOpenCustomHashMap.this.key[pos], from)) {
/*      */           
/* 1247 */           this.next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[pos];
/* 1248 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1251 */         pos = pos + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1268 */       if (this.next == -1) {
/* 1269 */         this.index = Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1272 */       int pos = Object2ByteLinkedOpenCustomHashMap.this.first;
/* 1273 */       this.index = 1;
/* 1274 */       while (pos != this.prev) {
/* 1275 */         pos = (int)Object2ByteLinkedOpenCustomHashMap.this.link[pos];
/* 1276 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1291 */       this.next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[this.curr];
...
/* 1301 */       this.prev = (int)(Object2ByteLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1316 */         this.index--;
/* 1317 */         this.prev = (int)(Object2ByteLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1319 */         this.next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[this.curr];
/* 1320 */       }  Object2ByteLinkedOpenCustomHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1325 */       if (this.prev == -1) {
/* 1326 */         Object2ByteLinkedOpenCustomHashMap.this.first = this.next;
/*      */       } else {
/* 1328 */         Object2ByteLinkedOpenCustomHashMap.this.link[this.prev] = Object2ByteLinkedOpenCustomHashMap.this.link[this.prev] ^ (Object2ByteLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1329 */       }  if (this.next == -1) {
/* 1330 */         Object2ByteLinkedOpenCustomHashMap.this.last = this.prev;
/*      */       } else {
/* 1332 */         Object2ByteLinkedOpenCustomHashMap.this.link[this.next] = Object2ByteLinkedOpenCustomHashMap.this.link[this.next] ^ (Object2ByteLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1333 */       }  int pos = this.curr;
/* 1334 */       this.curr = -1;
/* 1335 */       if (pos == Object2ByteLinkedOpenCustomHashMap.this.n) {
/* 1336 */         Object2ByteLinkedOpenCustomHashMap.this.containsNullKey = false;
/* 1337 */         Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1340 */         K[] key = Object2ByteLinkedOpenCustomHashMap.this.key;
/*      */         while (true) {
/*      */           K curr;
/*      */           int last;
/* 1344 */           pos = (last = pos) + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask;
/*      */           while (true) {
/* 1346 */             if ((curr = key[pos]) == null) {
/* 1347 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1350 */             int slot = HashCommon.mix(Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ByteLinkedOpenCustomHashMap.this.mask;
/* 1351 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1353 */             pos = pos + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask;
/*      */           } 
/* 1355 */           key[last] = curr;
/* 1356 */           Object2ByteLinkedOpenCustomHashMap.this.value[last] = Object2ByteLinkedOpenCustomHashMap.this.value[pos];
/* 1357 */           if (this.next == pos)
/* 1358 */             this.next = last; 
/* 1359 */           if (this.prev == pos)
/* 1360 */             this.prev = last; 
/* 1361 */           Object2ByteLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Object2ByteMap.Entry<K>> { private Object2ByteLinkedOpenCustomHashMap<K>.MapEntry entry;
/*      */     
...
/* 1393 */       return this.entry = new Object2ByteLinkedOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Object2ByteLinkedOpenCustomHashMap<K>.MapEntry previous() {
/* 1397 */       return this.entry = new Object2ByteLinkedOpenCustomHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1401 */       super.remove();
...
/*      */ 
/*      */   
/* 1406 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Object2ByteMap.Entry<K>> { final Object2ByteLinkedOpenCustomHashMap<K>.MapEntry entry = new Object2ByteLinkedOpenCustomHashMap.MapEntry();
/*      */ 
/*      */     
...
/* 1428 */       return new Object2ByteLinkedOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
...
/* 1449 */       if (Object2ByteLinkedOpenCustomHashMap.this.size == 0)
/* 1450 */         throw new NoSuchElementException(); 
/* 1451 */       return new Object2ByteLinkedOpenCustomHashMap.MapEntry(Object2ByteLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Object2ByteMap.Entry<K> last() {
/* 1455 */       if (Object2ByteLinkedOpenCustomHashMap.this.size == 0)
/* 1456 */         throw new NoSuchElementException(); 
/* 1457 */       return new Object2ByteLinkedOpenCustomHashMap.MapEntry(Object2ByteLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1465 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1466 */         return false; 
/* 1467 */       K k = (K)e.getKey();
/* 1468 */       byte v = ((Byte)e.getValue()).byteValue();
/* 1469 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1470 */         return (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey && Object2ByteLinkedOpenCustomHashMap.this.value[Object2ByteLinkedOpenCustomHashMap.this.n] == v);
/*      */       }
/* 1472 */       K[] key = Object2ByteLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1475 */       if ((curr = key[pos = HashCommon.mix(Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteLinkedOpenCustomHashMap.this.mask]) == null)
/* 1476 */         return false; 
/* 1477 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) {
/* 1478 */         return (Object2ByteLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1481 */         if ((curr = key[pos = pos + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask]) == null)
/* 1482 */           return false; 
/* 1483 */         if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) {
/* 1484 */           return (Object2ByteLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1493 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1494 */         return false; 
/* 1495 */       K k = (K)e.getKey();
/* 1496 */       byte v = ((Byte)e.getValue()).byteValue();
/* 1497 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1498 */         if (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey && Object2ByteLinkedOpenCustomHashMap.this.value[Object2ByteLinkedOpenCustomHashMap.this.n] == v) {
/* 1499 */           Object2ByteLinkedOpenCustomHashMap.this.removeNullEntry();
/* 1500 */           return true;
/*      */         } 
/* 1502 */         return false;
/*      */       } 
/*      */       
/* 1505 */       K[] key = Object2ByteLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1508 */       if ((curr = key[pos = HashCommon.mix(Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteLinkedOpenCustomHashMap.this.mask]) == null)
/* 1509 */         return false; 
/* 1510 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1511 */         if (Object2ByteLinkedOpenCustomHashMap.this.value[pos] == v) {
/* 1512 */           Object2ByteLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1513 */           return true;
/*      */         } 
/* 1515 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1518 */         if ((curr = key[pos = pos + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask]) == null)
/* 1519 */           return false; 
/* 1520 */         if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1521 */           Object2ByteLinkedOpenCustomHashMap.this.value[pos] == v) {
/* 1522 */           Object2ByteLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1523 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1530 */       return Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1534 */       Object2ByteLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1549 */       return new Object2ByteLinkedOpenCustomHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1560 */       return new Object2ByteLinkedOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1575 */       return new Object2ByteLinkedOpenCustomHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
/* 1580 */       for (int i = Object2ByteLinkedOpenCustomHashMap.this.size, next = Object2ByteLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1581 */         int curr = next;
/* 1582 */         next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[curr];
/* 1583 */         consumer.accept(new AbstractObject2ByteMap.BasicEntry<>(Object2ByteLinkedOpenCustomHashMap.this.key[curr], Object2ByteLinkedOpenCustomHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
/* 1589 */       AbstractObject2ByteMap.BasicEntry<K> entry = new AbstractObject2ByteMap.BasicEntry<>();
/* 1590 */       for (int i = Object2ByteLinkedOpenCustomHashMap.this.size, next = Object2ByteLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1591 */         int curr = next;
/* 1592 */         next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[curr];
/* 1593 */         entry.key = Object2ByteLinkedOpenCustomHashMap.this.key[curr];
/* 1594 */         entry.value = Object2ByteLinkedOpenCustomHashMap.this.value[curr];
...
/*      */     
/*      */     public K previous() {
/* 1620 */       return Object2ByteLinkedOpenCustomHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
/*      */     
/*      */     public K next() {
/* 1627 */       return Object2ByteLinkedOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectListIterator<K> iterator(K from) {
/* 1633 */       return new Object2ByteLinkedOpenCustomHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1637 */       return new Object2ByteLinkedOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1642 */       if (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey)
/* 1643 */         consumer.accept(Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.n]); 
/* 1644 */       for (int pos = Object2ByteLinkedOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1645 */         K k = Object2ByteLinkedOpenCustomHashMap.this.key[pos];
/* 1646 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/* 1652 */       return Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1656 */       return Object2ByteLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1660 */       int oldSize = Object2ByteLinkedOpenCustomHashMap.this.size;
/* 1661 */       Object2ByteLinkedOpenCustomHashMap.this.removeByte(k);
/* 1662 */       return (Object2ByteLinkedOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1666 */       Object2ByteLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public K first() {
/* 1670 */       if (Object2ByteLinkedOpenCustomHashMap.this.size == 0)
/* 1671 */         throw new NoSuchElementException(); 
/* 1672 */       return Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */     
/*      */     public K last() {
/* 1676 */       if (Object2ByteLinkedOpenCustomHashMap.this.size == 0)
/* 1677 */         throw new NoSuchElementException(); 
/* 1678 */       return Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.last];
/*      */     }
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1682 */       return null;
...
/* 1715 */       return Object2ByteLinkedOpenCustomHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1722 */       return Object2ByteLinkedOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public ByteCollection values() {
/* 1727 */     if (this.values == null)
/* 1728 */       this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1731 */             return (ByteIterator)new Object2ByteLinkedOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1735 */             return Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1739 */             return Object2ByteLinkedOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1743 */             Object2ByteLinkedOpenCustomHashMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1748 */             if (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey)
/* 1749 */               consumer.accept(Object2ByteLinkedOpenCustomHashMap.this.value[Object2ByteLinkedOpenCustomHashMap.this.n]); 
/* 1750 */             for (int pos = Object2ByteLinkedOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1751 */               if (Object2ByteLinkedOpenCustomHashMap.this.key[pos] != null)
/* 1752 */                 consumer.accept(Object2ByteLinkedOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1828 */     K[] key = this.key;
/* 1829 */     byte[] value = this.value;
/* 1830 */     int mask = newN - 1;
/* 1831 */     K[] newKey = (K[])new Object[newN + 1];
/* 1832 */     byte[] newValue = new byte[newN + 1];
...
/*      */     try {
/* 1886 */       c = (Object2ByteLinkedOpenCustomHashMap<K>)super.clone();
...
/* 1895 */     c.value = (byte[])this.value.clone();
...
/* 1944 */     byte[] value = this.value = new byte[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ByteLinkedOpenCustomHashMap.class
