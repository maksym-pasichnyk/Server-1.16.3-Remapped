...
/*     */   
/*     */   public boolean trim() {
/* 579 */     int l = HashCommon.arraySize(this.size, this.f);
/* 580 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 581 */       return true; 
/*     */     try {
/* 583 */       rehash(l);
/* 584 */     } catch (OutOfMemoryError cantDoIt) {
/* 585 */       return false;
/*     */     } 
/* 587 */     return true;
/*     */   }
...
/* 611 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 612 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 613 */       return true; 
/*     */     try {
/* 615 */       rehash(l);
/* 616 */     } catch (OutOfMemoryError cantDoIt) {
/* 617 */       return false;
/*     */     } 
/* 619 */     return true;
/*     */   }
...
/* 635 */     K[] key = this.key;
/* 636 */     int mask = newN - 1;
/* 637 */     K[] newKey = (K[])new Object[newN + 1];
/* 638 */     int i = this.n;
/* 639 */     for (int j = realSize(); j-- != 0; ) {
/* 640 */       while (key[--i] == null); int pos;
/* 641 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null)
/* 642 */         while (newKey[pos = pos + 1 & mask] != null); 
/* 643 */       newKey[pos] = key[i];
/*     */     } 
/* 645 */     this.n = newN;
/* 646 */     this.mask = mask;
/* 647 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 648 */     this.key = newKey;
/*     */   }
/*     */ 
/*     */ 
...
/*     */     try {
/* 665 */       c = (ObjectOpenHashSet<K>)super.clone();
/* 666 */     } catch (CloneNotSupportedException cantHappen) {
/* 667 */       throw new InternalError();
/*     */     } 
/* 669 */     c.key = (K[])this.key.clone();
/* 670 */     c.containsNull = this.containsNull;
/* 671 */     return c;
/*     */   }
/*     */ 
/*     */ 
...
/*     */   public int hashCode() {
/* 684 */     int h = 0;
/* 685 */     for (int j = realSize(), i = 0; j-- != 0; ) {
/* 686 */       while (this.key[i] == null)
/* 687 */         i++; 
/* 688 */       if (this != this.key[i])
/* 689 */         h += this.key[i].hashCode(); 
/* 690 */       i++;
/*     */     } 
/*     */     
/* 693 */     return h;
...
/* 696 */     ObjectIterator<K> i = iterator();
/* 697 */     s.defaultWriteObject();
/* 698 */     for (int j = this.size; j-- != 0;)
/* 699 */       s.writeObject(i.next()); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 703 */     s.defaultReadObject();
/* 704 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 705 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 706 */     this.mask = this.n - 1;
/* 707 */     K[] key = this.key = (K[])new Object[this.n + 1];
/*     */     
/* 709 */     for (int i = this.size; i-- != 0; ) {
/* 710 */       int pos; K k = (K)s.readObject();
/* 711 */       if (k == null) {
/* 712 */         pos = this.n;
/* 713 */         this.containsNull = true;
/*     */       }
/* 715 */       else if (key[pos = HashCommon.mix(k.hashCode()) & this.mask] != null) {
/* 716 */         while (key[pos = pos + 1 & this.mask] != null);
/*     */       } 
/* 718 */       key[pos] = k;
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\ObjectOpenHashSet.class
