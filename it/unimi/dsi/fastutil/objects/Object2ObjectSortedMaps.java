...
/*  60 */     ObjectSortedSet<Object2ObjectMap.Entry<K, V>> entries = map.object2ObjectEntrySet();
/*  61 */     return (entries instanceof Object2ObjectSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Object2ObjectSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  80 */     ObjectSortedSet<Object2ObjectMap.Entry<K, V>> entries = map.object2ObjectEntrySet();
/*     */     
/*  82 */     Objects.requireNonNull((Object2ObjectSortedMap.FastSortedEntrySet)entries); return (entries instanceof Object2ObjectSortedMap.FastSortedEntrySet) ? (Object2ObjectSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  83 */       entries;
/*     */   }
/*     */ 
/*     */ 
...
/* 123 */       return Object2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Object2ObjectSortedMap<K, V> headMap(K to) {
/* 128 */       return Object2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Object2ObjectSortedMap<K, V> tailMap(K from) {
/* 133 */       return Object2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public K firstKey() {
...
/* 194 */         this.entries = ObjectSortedSets.singleton(new AbstractObject2ObjectMap.BasicEntry<>(this.key, this.value), 
/* 195 */             (Comparator)Object2ObjectSortedMaps.entryComparator(this.comparator)); 
/* 196 */       return (ObjectSortedSet<Object2ObjectMap.Entry<K, V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() {
/* 202 */       return (ObjectSortedSet)object2ObjectEntrySet();
/*     */     }
/*     */     
/*     */     public ObjectSortedSet<K> keySet() {
...
/* 214 */         return this; 
/* 215 */       return Object2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Object2ObjectSortedMap<K, V> headMap(K to) {
...
/* 221 */         return this; 
/* 222 */       return Object2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Object2ObjectSortedMap<K, V> tailMap(K from) {
...
/* 228 */         return this; 
/* 229 */       return Object2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public K firstKey() {
/* 233 */       return this.key;
...
/* 303 */         this.entries = ObjectSortedSets.synchronize(this.sortedMap.object2ObjectEntrySet(), this.sync); 
/* 304 */       return (ObjectSortedSet<Object2ObjectMap.Entry<K, V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() {
/* 310 */       return (ObjectSortedSet)object2ObjectEntrySet();
/*     */     }
/*     */     
/*     */     public ObjectSortedSet<K> keySet() {
...
/* 389 */         this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.object2ObjectEntrySet()); 
/* 390 */       return (ObjectSortedSet<Object2ObjectMap.Entry<K, V>>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() {
/* 396 */       return (ObjectSortedSet)object2ObjectEntrySet();
/*     */     }
/*     */     
/*     */     public ObjectSortedSet<K> keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ObjectSortedMaps.class
