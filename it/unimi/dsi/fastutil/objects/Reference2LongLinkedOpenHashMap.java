...
/* 1802 */     K[] key = this.key;
/* 1803 */     long[] value = this.value;
/* 1804 */     int mask = newN - 1;
/* 1805 */     K[] newKey = (K[])new Object[newN + 1];
/* 1806 */     long[] newValue = new long[newN + 1];
...
/*      */     try {
/* 1860 */       c = (Reference2LongLinkedOpenHashMap<K>)super.clone();
...
/* 1869 */     c.value = (long[])this.value.clone();
...
/* 1890 */       t ^= HashCommon.long2int(this.value[i]);
/* 1891 */       h += t;
/* 1892 */       i++;
/*      */     } 
/*      */     
/* 1895 */     if (this.containsNullKey)
/* 1896 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1897 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1900 */     K[] key = this.key;
/* 1901 */     long[] value = this.value;
...
/* 1917 */     long[] value = this.value = new long[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2LongLinkedOpenHashMap.class
