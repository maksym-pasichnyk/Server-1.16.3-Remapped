...
/*      */   
/*      */   public boolean trim() {
/* 1057 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1089 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1090 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1091 */       return true; 
/*      */     try {
/* 1093 */       rehash(l);
...
/* 1113 */     K[] key = this.key;
/* 1114 */     float[] value = this.value;
/* 1115 */     int mask = newN - 1;
/* 1116 */     K[] newKey = (K[])new Object[newN + 1];
/* 1117 */     float[] newValue = new float[newN + 1];
/* 1118 */     int i = this.n;
/* 1119 */     for (int j = realSize(); j-- != 0; ) {
/* 1120 */       while (key[--i] == null); int pos;
/* 1121 */       if (newKey[pos = HashCommon.mix(System.identityHashCode(key[i])) & mask] != null)
/*      */       {
/* 1123 */         while (newKey[pos = pos + 1 & mask] != null); } 
/* 1124 */       newKey[pos] = key[i];
/* 1125 */       newValue[pos] = value[i];
/*      */     } 
/* 1127 */     newValue[newN] = value[this.n];
/* 1128 */     this.n = newN;
/* 1129 */     this.mask = mask;
/* 1130 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1131 */     this.key = newKey;
...
/*      */     try {
/* 1149 */       c = (Reference2FloatOpenHashMap<K>)super.clone();
/* 1150 */     } catch (CloneNotSupportedException cantHappen) {
/* 1151 */       throw new InternalError();
/*      */     } 
/* 1153 */     c.keys = null;
/* 1154 */     c.values = null;
/* 1155 */     c.entries = null;
/* 1156 */     c.containsNullKey = this.containsNullKey;
/* 1157 */     c.key = (K[])this.key.clone();
/* 1158 */     c.value = (float[])this.value.clone();
/* 1159 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1172 */     int h = 0;
/* 1173 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1174 */       while (this.key[i] == null)
/* 1175 */         i++; 
/* 1176 */       if (this != this.key[i])
/* 1177 */         t = System.identityHashCode(this.key[i]); 
/* 1178 */       t ^= HashCommon.float2int(this.value[i]);
/* 1179 */       h += t;
/* 1180 */       i++;
/*      */     } 
/*      */     
/* 1183 */     if (this.containsNullKey)
/* 1184 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1185 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1188 */     K[] key = this.key;
/* 1189 */     float[] value = this.value;
/* 1190 */     MapIterator i = new MapIterator();
/* 1191 */     s.defaultWriteObject();
/* 1192 */     for (int j = this.size; j-- != 0; ) {
/* 1193 */       int e = i.nextEntry();
/* 1194 */       s.writeObject(key[e]);
/* 1195 */       s.writeFloat(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1200 */     s.defaultReadObject();
/* 1201 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1202 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1203 */     this.mask = this.n - 1;
/* 1204 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1205 */     float[] value = this.value = new float[this.n + 1];
/*      */ 
/*      */     
/* 1208 */     for (int i = this.size; i-- != 0; ) {
/* 1209 */       int pos; K k = (K)s.readObject();
/* 1210 */       float v = s.readFloat();
/* 1211 */       if (k == null) {
/* 1212 */         pos = this.n;
/* 1213 */         this.containsNullKey = true;
/*      */       } else {
/* 1215 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1216 */         while (key[pos] != null)
/* 1217 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1219 */       key[pos] = k;
/* 1220 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2FloatOpenHashMap.class
