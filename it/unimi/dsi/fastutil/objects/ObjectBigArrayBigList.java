...
/* 314 */       if (Objects.equals(k, ObjectBigArrays.get(this.a, i)))
/* 315 */         return i; 
/* 316 */     }  return -1L;
/*     */   }
/*     */   
...
/* 321 */       if (Objects.equals(k, ObjectBigArrays.get(this.a, i)))
/* 322 */         return i; 
/* 323 */     }  return -1L;
/*     */   }
/*     */   
...
/* 507 */           return ObjectBigArrays.get(ObjectBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public K previous() {
/* 511 */           if (!hasPrevious())
/* 512 */             throw new NoSuchElementException(); 
/* 513 */           return ObjectBigArrays.get(ObjectBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 578 */     K[][] a2 = l.a;
/* 579 */     while (s-- != 0L) {
/* 580 */       if (!valEquals(ObjectBigArrays.get(a1, s), ObjectBigArrays.get(a2, s)))
/* 581 */         return false; 
/* 582 */     }  return true;
/*     */   }
/*     */ 
...
/* 603 */       K e1 = ObjectBigArrays.get(a1, i);
/* 604 */       K e2 = ObjectBigArrays.get(a2, i); int r;
...
/* 613 */       s.writeObject(ObjectBigArrays.get(this.a, i)); 
/*     */   }
/*     */   
...
/* 620 */       ObjectBigArrays.set(this.a, i, (K)s.readObject()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\ObjectBigArrayBigList.class
