...
/*     */     
/*     */     public Object clone() {
/*  67 */       return Reference2ByteFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  71 */       return 0;
...
/*  84 */       return Reference2ByteFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static <K> Reference2ByteFunction<K> singleton(K key, Byte value) {
/* 167 */     return new Singleton<>(key, value.byteValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction<K> implements Reference2ByteFunction<K>, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/* 237 */         return this.function.getByte(k);
/*     */       } 
/*     */     }
/*     */     
/*     */     public byte removeByte(Object k) {
/* 242 */       synchronized (this.sync) {
/* 243 */         return this.function.removeByte(k);
/*     */       } 
/*     */     }
/*     */     
/*     */     public void clear() {
...
/*     */     
/*     */     public byte getByte(Object k) {
/* 374 */       return this.function.getByte(k);
/*     */     }
/*     */     
/*     */     public byte removeByte(Object k) {
...
/* 456 */       Byte v = this.function.apply((K)key);
/* 457 */       if (v == null)
/* 458 */         return defaultReturnValue(); 
/* 459 */       return v.byteValue();
/*     */     }
/*     */ 
/*     */     
/*     */     @Deprecated
...
/* 498 */     if (f instanceof Reference2ByteFunction)
/* 499 */       return (Reference2ByteFunction)f; 
/* 500 */     if (f instanceof ToIntFunction) {
/* 501 */       return key -> SafeMath.safeIntToByte(((ToIntFunction<Object>)f).applyAsInt(key));
/*     */     }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2ByteFunctions.class
