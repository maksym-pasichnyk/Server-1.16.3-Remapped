...
/*      */   
/*      */   public boolean trim() {
/* 1744 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1745 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1746 */       return true; 
/*      */     try {
/* 1748 */       rehash(l);
/* 1749 */     } catch (OutOfMemoryError cantDoIt) {
/* 1750 */       return false;
/*      */     } 
/* 1752 */     return true;
/*      */   }
...
/* 1776 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1777 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1778 */       return true; 
/*      */     try {
/* 1780 */       rehash(l);
...
/* 1800 */     K[] key = this.key;
/* 1801 */     float[] value = this.value;
/* 1802 */     int mask = newN - 1;
/* 1803 */     K[] newKey = (K[])new Object[newN + 1];
/* 1804 */     float[] newValue = new float[newN + 1];
/* 1805 */     int i = this.first, prev = -1, newPrev = -1;
/* 1806 */     long[] link = this.link;
/* 1807 */     long[] newLink = new long[newN + 1];
/* 1808 */     this.first = -1;
/* 1809 */     for (int j = this.size; j-- != 0; ) {
/* 1810 */       int pos; if (key[i] == null) {
/* 1811 */         pos = newN;
/*      */       } else {
/* 1813 */         pos = HashCommon.mix(key[i].hashCode()) & mask;
/* 1814 */         while (newKey[pos] != null)
/* 1815 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1817 */       newKey[pos] = key[i];
/* 1818 */       newValue[pos] = value[i];
/* 1819 */       if (prev != -1) {
/* 1820 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1821 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1822 */         newPrev = pos;
/*      */       } else {
/* 1824 */         newPrev = this.first = pos;
/*      */         
/* 1826 */         newLink[pos] = -1L;
/*      */       } 
/* 1828 */       int t = i;
...
/* 1830 */       prev = t;
/*      */     } 
/* 1832 */     this.link = newLink;
/* 1833 */     this.last = newPrev;
/* 1834 */     if (newPrev != -1)
/*      */     {
/* 1836 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1837 */     this.n = newN;
/* 1838 */     this.mask = mask;
/* 1839 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1840 */     this.key = newKey;
/* 1841 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1858 */       c = (Object2FloatLinkedOpenHashMap<K>)super.clone();
/* 1859 */     } catch (CloneNotSupportedException cantHappen) {
/* 1860 */       throw new InternalError();
/*      */     } 
/* 1862 */     c.keys = null;
/* 1863 */     c.values = null;
/* 1864 */     c.entries = null;
/* 1865 */     c.containsNullKey = this.containsNullKey;
/* 1866 */     c.key = (K[])this.key.clone();
/* 1867 */     c.value = (float[])this.value.clone();
/* 1868 */     c.link = (long[])this.link.clone();
/* 1869 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1882 */     int h = 0;
/* 1883 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1884 */       while (this.key[i] == null)
/* 1885 */         i++; 
/* 1886 */       if (this != this.key[i])
/* 1887 */         t = this.key[i].hashCode(); 
/* 1888 */       t ^= HashCommon.float2int(this.value[i]);
/* 1889 */       h += t;
/* 1890 */       i++;
/*      */     } 
/*      */     
/* 1893 */     if (this.containsNullKey)
/* 1894 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1895 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1898 */     K[] key = this.key;
/* 1899 */     float[] value = this.value;
/* 1900 */     MapIterator i = new MapIterator();
/* 1901 */     s.defaultWriteObject();
/* 1902 */     for (int j = this.size; j-- != 0; ) {
/* 1903 */       int e = i.nextEntry();
/* 1904 */       s.writeObject(key[e]);
/* 1905 */       s.writeFloat(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1910 */     s.defaultReadObject();
/* 1911 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1912 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1913 */     this.mask = this.n - 1;
/* 1914 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1915 */     float[] value = this.value = new float[this.n + 1];
/* 1916 */     long[] link = this.link = new long[this.n + 1];
/* 1917 */     int prev = -1;
/* 1918 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1921 */     for (int i = this.size; i-- != 0; ) {
/* 1922 */       int pos; K k = (K)s.readObject();
/* 1923 */       float v = s.readFloat();
/* 1924 */       if (k == null) {
/* 1925 */         pos = this.n;
/* 1926 */         this.containsNullKey = true;
/*      */       } else {
/* 1928 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1929 */         while (key[pos] != null)
/* 1930 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1932 */       key[pos] = k;
/* 1933 */       value[pos] = v;
/* 1934 */       if (this.first != -1) {
/* 1935 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1936 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1937 */         prev = pos; continue;
/*      */       } 
/* 1939 */       prev = this.first = pos;
/*      */       
/* 1941 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1944 */     this.last = prev;
/* 1945 */     if (prev != -1)
/*      */     {
/* 1947 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2FloatLinkedOpenHashMap.class
