...
/*      */   
/*      */   public boolean trim() {
/* 1686 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1687 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1688 */       return true; 
/*      */     try {
/* 1690 */       rehash(l);
/* 1691 */     } catch (OutOfMemoryError cantDoIt) {
/* 1692 */       return false;
/*      */     } 
/* 1694 */     return true;
/*      */   }
...
/* 1718 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1719 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1720 */       return true; 
/*      */     try {
/* 1722 */       rehash(l);
/* 1723 */     } catch (OutOfMemoryError cantDoIt) {
/* 1724 */       return false;
/*      */     } 
/* 1726 */     return true;
/*      */   }
...
/* 1742 */     K[] key = this.key;
/* 1743 */     boolean[] value = this.value;
/* 1744 */     int mask = newN - 1;
/* 1745 */     K[] newKey = (K[])new Object[newN + 1];
/* 1746 */     boolean[] newValue = new boolean[newN + 1];
/* 1747 */     int i = this.first, prev = -1, newPrev = -1;
/* 1748 */     long[] link = this.link;
/* 1749 */     long[] newLink = new long[newN + 1];
/* 1750 */     this.first = -1;
/* 1751 */     for (int j = this.size; j-- != 0; ) {
/* 1752 */       int pos; if (key[i] == null) {
/* 1753 */         pos = newN;
/*      */       } else {
/* 1755 */         pos = HashCommon.mix(key[i].hashCode()) & mask;
/* 1756 */         while (newKey[pos] != null)
/* 1757 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1759 */       newKey[pos] = key[i];
/* 1760 */       newValue[pos] = value[i];
/* 1761 */       if (prev != -1) {
/* 1762 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1763 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1764 */         newPrev = pos;
/*      */       } else {
/* 1766 */         newPrev = this.first = pos;
/*      */         
/* 1768 */         newLink[pos] = -1L;
/*      */       } 
/* 1770 */       int t = i;
...
/* 1772 */       prev = t;
/*      */     } 
/* 1774 */     this.link = newLink;
/* 1775 */     this.last = newPrev;
/* 1776 */     if (newPrev != -1)
/*      */     {
/* 1778 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1779 */     this.n = newN;
/* 1780 */     this.mask = mask;
/* 1781 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1782 */     this.key = newKey;
/* 1783 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1800 */       c = (Object2BooleanLinkedOpenHashMap<K>)super.clone();
/* 1801 */     } catch (CloneNotSupportedException cantHappen) {
/* 1802 */       throw new InternalError();
/*      */     } 
/* 1804 */     c.keys = null;
/* 1805 */     c.values = null;
/* 1806 */     c.entries = null;
/* 1807 */     c.containsNullKey = this.containsNullKey;
/* 1808 */     c.key = (K[])this.key.clone();
/* 1809 */     c.value = (boolean[])this.value.clone();
/* 1810 */     c.link = (long[])this.link.clone();
/* 1811 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1824 */     int h = 0;
/* 1825 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1826 */       while (this.key[i] == null)
/* 1827 */         i++; 
/* 1828 */       if (this != this.key[i])
/* 1829 */         t = this.key[i].hashCode(); 
/* 1830 */       t ^= this.value[i] ? 1231 : 1237;
/* 1831 */       h += t;
/* 1832 */       i++;
/*      */     } 
/*      */     
/* 1835 */     if (this.containsNullKey)
/* 1836 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1837 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1840 */     K[] key = this.key;
/* 1841 */     boolean[] value = this.value;
/* 1842 */     MapIterator i = new MapIterator();
/* 1843 */     s.defaultWriteObject();
/* 1844 */     for (int j = this.size; j-- != 0; ) {
/* 1845 */       int e = i.nextEntry();
/* 1846 */       s.writeObject(key[e]);
/* 1847 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1852 */     s.defaultReadObject();
/* 1853 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1854 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1855 */     this.mask = this.n - 1;
/* 1856 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1857 */     boolean[] value = this.value = new boolean[this.n + 1];
/* 1858 */     long[] link = this.link = new long[this.n + 1];
/* 1859 */     int prev = -1;
/* 1860 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1863 */     for (int i = this.size; i-- != 0; ) {
/* 1864 */       int pos; K k = (K)s.readObject();
/* 1865 */       boolean v = s.readBoolean();
/* 1866 */       if (k == null) {
/* 1867 */         pos = this.n;
/* 1868 */         this.containsNullKey = true;
/*      */       } else {
/* 1870 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1871 */         while (key[pos] != null)
/* 1872 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1874 */       key[pos] = k;
/* 1875 */       value[pos] = v;
/* 1876 */       if (this.first != -1) {
/* 1877 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1878 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1879 */         prev = pos; continue;
/*      */       } 
/* 1881 */       prev = this.first = pos;
/*      */       
/* 1883 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1886 */     this.last = prev;
/* 1887 */     if (prev != -1)
/*      */     {
/* 1889 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2BooleanLinkedOpenHashMap.class
