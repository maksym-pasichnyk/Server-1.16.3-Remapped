...
/*     */     
/*     */     public Object clone() {
/*  67 */       return Reference2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  71 */       return 0;
...
/*  84 */       return Reference2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static <K> Reference2LongFunction<K> singleton(K key, Long value) {
/* 167 */     return new Singleton<>(key, value.longValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction<K> implements Reference2LongFunction<K>, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/* 237 */         return this.function.getLong(k);
/*     */       } 
/*     */     }
/*     */     
/*     */     public long removeLong(Object k) {
/* 242 */       synchronized (this.sync) {
/* 243 */         return this.function.removeLong(k);
/*     */       } 
/*     */     }
/*     */     
/*     */     public void clear() {
...
/*     */     
/*     */     public long getLong(Object k) {
/* 374 */       return this.function.getLong(k);
/*     */     }
/*     */     
/*     */     public long removeLong(Object k) {
...
/* 456 */       Long v = this.function.apply((K)key);
/* 457 */       if (v == null)
/* 458 */         return defaultReturnValue(); 
/* 459 */       return v.longValue();
/*     */     }
/*     */ 
/*     */     
/*     */     @Deprecated
...
/* 498 */     if (f instanceof Reference2LongFunction)
/* 499 */       return (Reference2LongFunction)f; 
/* 500 */     if (f instanceof ToLongFunction)
/* 501 */       return key -> ((ToLongFunction<Object>)f).applyAsLong(key); 
/* 502 */     return new PrimitiveFunction<>(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2LongFunctions.class
