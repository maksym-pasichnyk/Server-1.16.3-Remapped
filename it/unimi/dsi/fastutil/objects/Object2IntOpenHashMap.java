...
/* 1109 */     K[] key = this.key;
/* 1110 */     int[] value = this.value;
/* 1111 */     int mask = newN - 1;
/* 1112 */     K[] newKey = (K[])new Object[newN + 1];
/* 1113 */     int[] newValue = new int[newN + 1];
/* 1114 */     int i = this.n;
...
/*      */     try {
/* 1144 */       c = (Object2IntOpenHashMap<K>)super.clone();
...
/* 1153 */     c.value = (int[])this.value.clone();
/* 1154 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1200 */     int[] value = this.value = new int[this.n + 1];
/*      */ 
/*      */     
/* 1203 */     for (int i = this.size; i-- != 0; ) {
/* 1204 */       int pos; K k = (K)s.readObject();
/* 1205 */       int v = s.readInt();
/* 1206 */       if (k == null) {
/* 1207 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2IntOpenHashMap.class
