...
/*      */     
/*      */     public K getKey() {
/*  615 */       return Reference2CharOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public char getCharValue() {
/*  619 */       return Reference2CharOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public char setValue(char v) {
/*  623 */       char oldValue = Reference2CharOpenCustomHashMap.this.value[this.index];
/*  624 */       Reference2CharOpenCustomHashMap.this.value[this.index] = v;
/*  625 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  635 */       return Character.valueOf(Reference2CharOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  653 */       return (Reference2CharOpenCustomHashMap.this.strategy.equals(Reference2CharOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  657 */       return Reference2CharOpenCustomHashMap.this.strategy.hashCode(Reference2CharOpenCustomHashMap.this.key[this.index]) ^ Reference2CharOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  661 */       return (new StringBuilder()).append(Reference2CharOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2CharOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  671 */     int pos = Reference2CharOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  678 */     int last = -1;
/*      */     
/*  680 */     int c = Reference2CharOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  684 */     boolean mustReturnNullKey = Reference2CharOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  699 */         return this.last = Reference2CharOpenCustomHashMap.this.n;
/*      */       } 
/*  701 */       K[] key = Reference2CharOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  703 */         if (--this.pos < 0) {
/*      */           
/*  705 */           this.last = Integer.MIN_VALUE;
/*  706 */           K k = this.wrapped.get(-this.pos - 1);
/*  707 */           int p = HashCommon.mix(Reference2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2CharOpenCustomHashMap.this.mask;
/*  708 */           while (!Reference2CharOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  709 */             p = p + 1 & Reference2CharOpenCustomHashMap.this.mask; 
/*  710 */           return p;
/*      */         } 
...
/*  727 */       K[] key = Reference2CharOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  729 */         pos = (last = pos) + 1 & Reference2CharOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  731 */           if ((curr = key[pos]) == null) {
/*  732 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  735 */           int slot = HashCommon.mix(Reference2CharOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2CharOpenCustomHashMap.this.mask;
/*  736 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  738 */           pos = pos + 1 & Reference2CharOpenCustomHashMap.this.mask;
/*      */         } 
/*  740 */         if (pos < last) {
/*  741 */           if (this.wrapped == null)
/*  742 */             this.wrapped = new ReferenceArrayList<>(2); 
/*  743 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  745 */         key[last] = curr;
/*  746 */         Reference2CharOpenCustomHashMap.this.value[last] = Reference2CharOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  750 */       if (this.last == -1)
/*  751 */         throw new IllegalStateException(); 
/*  752 */       if (this.last == Reference2CharOpenCustomHashMap.this.n) {
/*  753 */         Reference2CharOpenCustomHashMap.this.containsNullKey = false;
/*  754 */         Reference2CharOpenCustomHashMap.this.key[Reference2CharOpenCustomHashMap.this.n] = null;
/*  755 */       } else if (this.pos >= 0) {
/*  756 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  759 */         Reference2CharOpenCustomHashMap.this.removeChar(this.wrapped.set(-this.pos - 1, null));
/*  760 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  763 */       Reference2CharOpenCustomHashMap.this.size--;
/*  764 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*  779 */       return this.entry = new Reference2CharOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  788 */       this.entry = new Reference2CharOpenCustomHashMap.MapEntry();
...
/*  798 */       return new Reference2CharOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Reference2CharMap.Entry<K>> fastIterator() {
/*  802 */       return new Reference2CharOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  814 */       if (Reference2CharOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  815 */         return (Reference2CharOpenCustomHashMap.this.containsNullKey && Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n] == v);
/*      */       }
/*  817 */       K[] key = Reference2CharOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  820 */       if ((curr = key[pos = HashCommon.mix(Reference2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2CharOpenCustomHashMap.this.mask]) == null)
/*  821 */         return false; 
/*  822 */       if (Reference2CharOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  823 */         return (Reference2CharOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  826 */         if ((curr = key[pos = pos + 1 & Reference2CharOpenCustomHashMap.this.mask]) == null)
/*  827 */           return false; 
/*  828 */         if (Reference2CharOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  829 */           return (Reference2CharOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  842 */       if (Reference2CharOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  843 */         if (Reference2CharOpenCustomHashMap.this.containsNullKey && Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n] == v) {
/*  844 */           Reference2CharOpenCustomHashMap.this.removeNullEntry();
/*  845 */           return true;
/*      */         } 
/*  847 */         return false;
/*      */       } 
/*      */       
/*  850 */       K[] key = Reference2CharOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  853 */       if ((curr = key[pos = HashCommon.mix(Reference2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2CharOpenCustomHashMap.this.mask]) == null)
/*  854 */         return false; 
/*  855 */       if (Reference2CharOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  856 */         if (Reference2CharOpenCustomHashMap.this.value[pos] == v) {
/*  857 */           Reference2CharOpenCustomHashMap.this.removeEntry(pos);
/*  858 */           return true;
/*      */         } 
/*  860 */         return false;
/*      */       } 
/*      */       while (true) {
/*  863 */         if ((curr = key[pos = pos + 1 & Reference2CharOpenCustomHashMap.this.mask]) == null)
/*  864 */           return false; 
/*  865 */         if (Reference2CharOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  866 */           Reference2CharOpenCustomHashMap.this.value[pos] == v) {
/*  867 */           Reference2CharOpenCustomHashMap.this.removeEntry(pos);
/*  868 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  875 */       return Reference2CharOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  879 */       Reference2CharOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
/*  884 */       if (Reference2CharOpenCustomHashMap.this.containsNullKey)
/*  885 */         consumer.accept(new AbstractReference2CharMap.BasicEntry<>(Reference2CharOpenCustomHashMap.this.key[Reference2CharOpenCustomHashMap.this.n], Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n])); 
/*  886 */       for (int pos = Reference2CharOpenCustomHashMap.this.n; pos-- != 0;) {
/*  887 */         if (Reference2CharOpenCustomHashMap.this.key[pos] != null)
/*  888 */           consumer.accept(new AbstractReference2CharMap.BasicEntry<>(Reference2CharOpenCustomHashMap.this.key[pos], Reference2CharOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
/*  893 */       AbstractReference2CharMap.BasicEntry<K> entry = new AbstractReference2CharMap.BasicEntry<>();
/*  894 */       if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
/*  895 */         entry.key = Reference2CharOpenCustomHashMap.this.key[Reference2CharOpenCustomHashMap.this.n];
/*  896 */         entry.value = Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n];
/*  897 */         consumer.accept(entry);
/*      */       } 
/*  899 */       for (int pos = Reference2CharOpenCustomHashMap.this.n; pos-- != 0;) {
/*  900 */         if (Reference2CharOpenCustomHashMap.this.key[pos] != null) {
/*  901 */           entry.key = Reference2CharOpenCustomHashMap.this.key[pos];
/*  902 */           entry.value = Reference2CharOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  928 */       return Reference2CharOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  934 */       return new Reference2CharOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  939 */       if (Reference2CharOpenCustomHashMap.this.containsNullKey)
/*  940 */         consumer.accept(Reference2CharOpenCustomHashMap.this.key[Reference2CharOpenCustomHashMap.this.n]); 
/*  941 */       for (int pos = Reference2CharOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  942 */         K k = Reference2CharOpenCustomHashMap.this.key[pos];
/*  943 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/*  949 */       return Reference2CharOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/*  953 */       return Reference2CharOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/*  957 */       int oldSize = Reference2CharOpenCustomHashMap.this.size;
/*  958 */       Reference2CharOpenCustomHashMap.this.removeChar(k);
/*  959 */       return (Reference2CharOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  963 */       Reference2CharOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*  987 */       return Reference2CharOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*  996 */             return new Reference2CharOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1000 */             return Reference2CharOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(char v) {
/* 1004 */             return Reference2CharOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1008 */             Reference2CharOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1013 */             if (Reference2CharOpenCustomHashMap.this.containsNullKey)
/* 1014 */               consumer.accept(Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n]); 
/* 1015 */             for (int pos = Reference2CharOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1016 */               if (Reference2CharOpenCustomHashMap.this.key[pos] != null)
/* 1017 */                 consumer.accept(Reference2CharOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1128 */       c = (Reference2CharOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2CharOpenCustomHashMap.class
