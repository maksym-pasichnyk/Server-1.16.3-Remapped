...
/*      */   
/*      */   public boolean trim() {
/* 1518 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1519 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1520 */       return true; 
/*      */     try {
/* 1522 */       rehash(l);
/* 1523 */     } catch (OutOfMemoryError cantDoIt) {
/* 1524 */       return false;
/*      */     } 
/* 1526 */     return true;
/*      */   }
...
/* 1551 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1552 */       return true; 
/*      */     try {
/* 1554 */       rehash(l);
...
/* 1585 */         pos = newN;
/*      */       } else {
/* 1587 */         pos = HashCommon.mix(key[i].hashCode()) & mask;
...
/*      */     try {
/* 1632 */       c = (Object2ReferenceLinkedOpenHashMap<K, V>)super.clone();
...
/*      */       } else {
/* 1703 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ReferenceLinkedOpenHashMap.class
