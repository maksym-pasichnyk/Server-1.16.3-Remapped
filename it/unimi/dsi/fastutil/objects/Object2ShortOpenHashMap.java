...
/*      */   
/*      */   public boolean trim() {
/* 1053 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1085 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1086 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1087 */       return true; 
/*      */     try {
/* 1089 */       rehash(l);
...
/* 1109 */     K[] key = this.key;
/* 1110 */     short[] value = this.value;
/* 1111 */     int mask = newN - 1;
/* 1112 */     K[] newKey = (K[])new Object[newN + 1];
/* 1113 */     short[] newValue = new short[newN + 1];
/* 1114 */     int i = this.n;
/* 1115 */     for (int j = realSize(); j-- != 0; ) {
/* 1116 */       while (key[--i] == null); int pos;
/* 1117 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null)
/* 1118 */         while (newKey[pos = pos + 1 & mask] != null); 
/* 1119 */       newKey[pos] = key[i];
/* 1120 */       newValue[pos] = value[i];
/*      */     } 
/* 1122 */     newValue[newN] = value[this.n];
/* 1123 */     this.n = newN;
/* 1124 */     this.mask = mask;
/* 1125 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1126 */     this.key = newKey;
/* 1127 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1144 */       c = (Object2ShortOpenHashMap<K>)super.clone();
...
/* 1149 */     c.values = null;
/* 1150 */     c.entries = null;
/* 1151 */     c.containsNullKey = this.containsNullKey;
/* 1152 */     c.key = (K[])this.key.clone();
/* 1153 */     c.value = (short[])this.value.clone();
/* 1154 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1167 */     int h = 0;
/* 1168 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1169 */       while (this.key[i] == null)
/* 1170 */         i++; 
/* 1171 */       if (this != this.key[i])
/* 1172 */         t = this.key[i].hashCode(); 
/* 1173 */       t ^= this.value[i];
/* 1174 */       h += t;
/* 1175 */       i++;
/*      */     } 
/*      */     
/* 1178 */     if (this.containsNullKey)
/* 1179 */       h += this.value[this.n]; 
/* 1180 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1183 */     K[] key = this.key;
/* 1184 */     short[] value = this.value;
/* 1185 */     MapIterator i = new MapIterator();
/* 1186 */     s.defaultWriteObject();
/* 1187 */     for (int j = this.size; j-- != 0; ) {
/* 1188 */       int e = i.nextEntry();
/* 1189 */       s.writeObject(key[e]);
/* 1190 */       s.writeShort(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1195 */     s.defaultReadObject();
/* 1196 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1197 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1198 */     this.mask = this.n - 1;
/* 1199 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1200 */     short[] value = this.value = new short[this.n + 1];
/*      */ 
/*      */     
/* 1203 */     for (int i = this.size; i-- != 0; ) {
/* 1204 */       int pos; K k = (K)s.readObject();
/* 1205 */       short v = s.readShort();
/* 1206 */       if (k == null) {
/* 1207 */         pos = this.n;
/* 1208 */         this.containsNullKey = true;
/*      */       } else {
/* 1210 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1211 */         while (key[pos] != null)
/* 1212 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1214 */       key[pos] = k;
/* 1215 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2ShortOpenHashMap.class
