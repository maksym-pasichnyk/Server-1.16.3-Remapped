...
/*      */     
/*      */     public K getKey() {
/*  663 */       return Object2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public float getFloatValue() {
/*  667 */       return Object2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public float setValue(float v) {
/*  671 */       float oldValue = Object2FloatOpenCustomHashMap.this.value[this.index];
/*  672 */       Object2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  673 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  683 */       return Float.valueOf(Object2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  701 */       return (Object2FloatOpenCustomHashMap.this.strategy.equals(Object2FloatOpenCustomHashMap.this.key[this.index], e.getKey()) && 
/*  702 */         Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  706 */       return Object2FloatOpenCustomHashMap.this.strategy.hashCode(Object2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Object2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/*  710 */       return (new StringBuilder()).append(Object2FloatOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2FloatOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  720 */     int pos = Object2FloatOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  727 */     int last = -1;
/*      */     
/*  729 */     int c = Object2FloatOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  733 */     boolean mustReturnNullKey = Object2FloatOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  748 */         return this.last = Object2FloatOpenCustomHashMap.this.n;
/*      */       } 
...
/*  757 */           while (!Object2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  758 */             p = p + 1 & Object2FloatOpenCustomHashMap.this.mask; 
/*  759 */           return p;
/*      */         } 
...
/*  776 */       K[] key = Object2FloatOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  778 */         pos = (last = pos) + 1 & Object2FloatOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  780 */           if ((curr = key[pos]) == null) {
/*  781 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  784 */           int slot = HashCommon.mix(Object2FloatOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2FloatOpenCustomHashMap.this.mask;
/*  785 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  787 */           pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask;
/*      */         } 
/*  789 */         if (pos < last) {
...
/*      */         } 
/*  794 */         key[last] = curr;
/*  795 */         Object2FloatOpenCustomHashMap.this.value[last] = Object2FloatOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  799 */       if (this.last == -1)
/*  800 */         throw new IllegalStateException(); 
/*  801 */       if (this.last == Object2FloatOpenCustomHashMap.this.n) {
/*  802 */         Object2FloatOpenCustomHashMap.this.containsNullKey = false;
/*  803 */         Object2FloatOpenCustomHashMap.this.key[Object2FloatOpenCustomHashMap.this.n] = null;
/*  804 */       } else if (this.pos >= 0) {
/*  805 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  808 */         Object2FloatOpenCustomHashMap.this.removeFloat(this.wrapped.set(-this.pos - 1, null));
/*  809 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  812 */       Object2FloatOpenCustomHashMap.this.size--;
/*  813 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Object2FloatMap.Entry<K>> { private Object2FloatOpenCustomHashMap<K>.MapEntry entry;
/*      */     
/*      */     public Object2FloatOpenCustomHashMap<K>.MapEntry next() {
/*  828 */       return this.entry = new Object2FloatOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  837 */       this.entry = new Object2FloatOpenCustomHashMap.MapEntry();
...
/*  847 */       return new Object2FloatOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Object2FloatMap.Entry<K>> fastIterator() {
/*  851 */       return new Object2FloatOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  863 */       if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  864 */         return (Object2FloatOpenCustomHashMap.this.containsNullKey && 
/*  865 */           Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       }
/*  867 */       K[] key = Object2FloatOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  870 */       if ((curr = key[pos = HashCommon.mix(Object2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Object2FloatOpenCustomHashMap.this.mask]) == null)
/*  871 */         return false; 
/*  872 */       if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  873 */         return (Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       }
/*      */       while (true) {
/*  876 */         if ((curr = key[pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask]) == null)
/*  877 */           return false; 
/*  878 */         if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  879 */           return (Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  892 */       if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  893 */         if (Object2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v)) {
/*  894 */           Object2FloatOpenCustomHashMap.this.removeNullEntry();
/*  895 */           return true;
/*      */         } 
/*  897 */         return false;
/*      */       } 
/*      */       
/*  900 */       K[] key = Object2FloatOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  903 */       if ((curr = key[pos = HashCommon.mix(Object2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Object2FloatOpenCustomHashMap.this.mask]) == null)
/*  904 */         return false; 
/*  905 */       if (Object2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  906 */         if (Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/*  907 */           Object2FloatOpenCustomHashMap.this.removeEntry(pos);
/*  908 */           return true;
/*      */         } 
/*  910 */         return false;
/*      */       } 
/*      */       while (true) {
/*  913 */         if ((curr = key[pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask]) == null)
/*  914 */           return false; 
/*  915 */         if (Object2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  916 */           Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/*  917 */           Object2FloatOpenCustomHashMap.this.removeEntry(pos);
/*  918 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  925 */       return Object2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  929 */       Object2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2FloatMap.Entry<K>> consumer) {
/*  934 */       if (Object2FloatOpenCustomHashMap.this.containsNullKey)
/*  935 */         consumer.accept(new AbstractObject2FloatMap.BasicEntry<>(Object2FloatOpenCustomHashMap.this.key[Object2FloatOpenCustomHashMap.this.n], Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n])); 
/*  936 */       for (int pos = Object2FloatOpenCustomHashMap.this.n; pos-- != 0;) {
/*  937 */         if (Object2FloatOpenCustomHashMap.this.key[pos] != null)
/*  938 */           consumer.accept(new AbstractObject2FloatMap.BasicEntry<>(Object2FloatOpenCustomHashMap.this.key[pos], Object2FloatOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2FloatMap.Entry<K>> consumer) {
/*  943 */       AbstractObject2FloatMap.BasicEntry<K> entry = new AbstractObject2FloatMap.BasicEntry<>();
/*  944 */       if (Object2FloatOpenCustomHashMap.this.containsNullKey) {
/*  945 */         entry.key = Object2FloatOpenCustomHashMap.this.key[Object2FloatOpenCustomHashMap.this.n];
/*  946 */         entry.value = Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n];
/*  947 */         consumer.accept(entry);
/*      */       } 
/*  949 */       for (int pos = Object2FloatOpenCustomHashMap.this.n; pos-- != 0;) {
/*  950 */         if (Object2FloatOpenCustomHashMap.this.key[pos] != null) {
/*  951 */           entry.key = Object2FloatOpenCustomHashMap.this.key[pos];
/*  952 */           entry.value = Object2FloatOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  978 */       return Object2FloatOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  984 */       return new Object2FloatOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  989 */       if (Object2FloatOpenCustomHashMap.this.containsNullKey)
/*  990 */         consumer.accept(Object2FloatOpenCustomHashMap.this.key[Object2FloatOpenCustomHashMap.this.n]); 
/*  991 */       for (int pos = Object2FloatOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  992 */         K k = Object2FloatOpenCustomHashMap.this.key[pos];
/*  993 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/*  999 */       return Object2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1003 */       return Object2FloatOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1007 */       int oldSize = Object2FloatOpenCustomHashMap.this.size;
/* 1008 */       Object2FloatOpenCustomHashMap.this.removeFloat(k);
/* 1009 */       return (Object2FloatOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1013 */       Object2FloatOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1037 */       return Object2FloatOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1046 */             return new Object2FloatOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1050 */             return Object2FloatOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(float v) {
/* 1054 */             return Object2FloatOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1058 */             Object2FloatOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(DoubleConsumer consumer)
/*      */           {
/* 1063 */             if (Object2FloatOpenCustomHashMap.this.containsNullKey)
/* 1064 */               consumer.accept(Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n]); 
/* 1065 */             for (int pos = Object2FloatOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1066 */               if (Object2FloatOpenCustomHashMap.this.key[pos] != null)
/* 1067 */                 consumer.accept(Object2FloatOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1178 */       c = (Object2FloatOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2FloatOpenCustomHashMap.class
