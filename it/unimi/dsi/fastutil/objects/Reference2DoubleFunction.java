...
/* 120 */     Object k = key;
/* 121 */     double v = getDouble(k);
/* 122 */     return (v != defaultReturnValue() || containsKey(k)) ? Double.valueOf(v) : null;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 132 */     Object k = key;
/* 133 */     return containsKey(k) ? Double.valueOf(removeDouble(k)) : null;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2DoubleFunction.class
