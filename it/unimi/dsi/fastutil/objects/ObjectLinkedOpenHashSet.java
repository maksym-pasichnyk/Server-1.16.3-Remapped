...
/*      */   
/*      */   public boolean trim() {
/* 1071 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1072 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1073 */       return true; 
/*      */     try {
/* 1075 */       rehash(l);
...
/* 1104 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1105 */       return true; 
/*      */     try {
/* 1107 */       rehash(l);
...
/* 1129 */     K[] newKey = (K[])new Object[newN + 1];
...
/* 1135 */       int pos; if (key[i] == null) {
/* 1136 */         pos = newN;
/*      */       } else {
/* 1138 */         pos = HashCommon.mix(key[i].hashCode()) & mask;
/* 1139 */         while (newKey[pos] != null)
/* 1140 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */   public int hashCode() {
/* 1201 */     int h = 0;
/* 1202 */     for (int j = realSize(), i = 0; j-- != 0; ) {
/* 1203 */       while (this.key[i] == null)
/* 1204 */         i++; 
/* 1205 */       if (this != this.key[i])
/* 1206 */         h += this.key[i].hashCode(); 
/* 1207 */       i++;
/*      */     } 
/*      */     
/* 1210 */     return h;
...
/* 1213 */     ObjectIterator<K> i = iterator();
/* 1214 */     s.defaultWriteObject();
/* 1215 */     for (int j = this.size; j-- != 0;)
/* 1216 */       s.writeObject(i.next()); 
/*      */   }
/*      */   
...
/* 1224 */     K[] key = this.key = (K[])new Object[this.n + 1];
...
/*      */       }
/* 1235 */       else if (key[pos = HashCommon.mix(k.hashCode()) & this.mask] != null) {
/* 1236 */         while (key[pos = pos + 1 & this.mask] != null);
/*      */       } 
/* 1238 */       key[pos] = k;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\ObjectLinkedOpenHashSet.class
