...
/*      */     
/*      */     public K getKey() {
/*  663 */       return Reference2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/*  667 */       return Reference2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/*  671 */       byte oldValue = Reference2ByteOpenCustomHashMap.this.value[this.index];
/*  672 */       Reference2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  673 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  683 */       return Byte.valueOf(Reference2ByteOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  701 */       return (Reference2ByteOpenCustomHashMap.this.strategy.equals(Reference2ByteOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  705 */       return Reference2ByteOpenCustomHashMap.this.strategy.hashCode(Reference2ByteOpenCustomHashMap.this.key[this.index]) ^ Reference2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  709 */       return (new StringBuilder()).append(Reference2ByteOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2ByteOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  719 */     int pos = Reference2ByteOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  726 */     int last = -1;
/*      */     
/*  728 */     int c = Reference2ByteOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  732 */     boolean mustReturnNullKey = Reference2ByteOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  747 */         return this.last = Reference2ByteOpenCustomHashMap.this.n;
/*      */       } 
/*  749 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  751 */         if (--this.pos < 0) {
/*      */           
/*  753 */           this.last = Integer.MIN_VALUE;
/*  754 */           K k = this.wrapped.get(-this.pos - 1);
/*  755 */           int p = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask;
/*  756 */           while (!Reference2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  757 */             p = p + 1 & Reference2ByteOpenCustomHashMap.this.mask; 
/*  758 */           return p;
/*      */         } 
...
/*  775 */       K[] key = Reference2ByteOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  777 */         pos = (last = pos) + 1 & Reference2ByteOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  779 */           if ((curr = key[pos]) == null) {
/*  780 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  783 */           int slot = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2ByteOpenCustomHashMap.this.mask;
/*  784 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  786 */           pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask;
/*      */         } 
/*  788 */         if (pos < last) {
...
/*      */       } else {
/*      */         
/*  807 */         Reference2ByteOpenCustomHashMap.this.removeByte(this.wrapped.set(-this.pos - 1, null));
/*  808 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  811 */       Reference2ByteOpenCustomHashMap.this.size--;
/*  812 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Reference2ByteMap.Entry<K>> { private Reference2ByteOpenCustomHashMap<K>.MapEntry entry;
/*      */     
...
/*      */     } }
/*      */   
/*      */   private class FastEntryIterator extends MapIterator implements ObjectIterator<Reference2ByteMap.Entry<K>> { private FastEntryIterator() {
/*  836 */       this.entry = new Reference2ByteOpenCustomHashMap.MapEntry();
...
/*      */     } }
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSet<Reference2ByteMap.Entry<K>> implements Reference2ByteMap.FastEntrySet<K> { private MapEntrySet() {}
/*      */     
/*      */     public ObjectIterator<Reference2ByteMap.Entry<K>> iterator() {
/*  846 */       return new Reference2ByteOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Reference2ByteMap.Entry<K>> fastIterator() {
/*  850 */       return new Reference2ByteOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  862 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  863 */         return (Reference2ByteOpenCustomHashMap.this.containsNullKey && Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n] == v);
/*      */       }
/*  865 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  868 */       if ((curr = key[pos = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask]) == null)
/*  869 */         return false; 
/*  870 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  871 */         return (Reference2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  874 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask]) == null)
/*  875 */           return false; 
/*  876 */         if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  877 */           return (Reference2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  890 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  891 */         if (Reference2ByteOpenCustomHashMap.this.containsNullKey && Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n] == v) {
/*  892 */           Reference2ByteOpenCustomHashMap.this.removeNullEntry();
/*  893 */           return true;
/*      */         } 
/*  895 */         return false;
/*      */       } 
/*      */       
/*  898 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  901 */       if ((curr = key[pos = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask]) == null)
/*  902 */         return false; 
/*  903 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  904 */         if (Reference2ByteOpenCustomHashMap.this.value[pos] == v) {
/*  905 */           Reference2ByteOpenCustomHashMap.this.removeEntry(pos);
/*  906 */           return true;
/*      */         } 
/*  908 */         return false;
/*      */       } 
/*      */       while (true) {
/*  911 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask]) == null)
/*  912 */           return false; 
/*  913 */         if (Reference2ByteOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  914 */           Reference2ByteOpenCustomHashMap.this.value[pos] == v) {
/*  915 */           Reference2ByteOpenCustomHashMap.this.removeEntry(pos);
/*  916 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  923 */       return Reference2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  927 */       Reference2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/*  932 */       if (Reference2ByteOpenCustomHashMap.this.containsNullKey)
/*  933 */         consumer.accept(new AbstractReference2ByteMap.BasicEntry<>(Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n], Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n])); 
/*  934 */       for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0;) {
/*  935 */         if (Reference2ByteOpenCustomHashMap.this.key[pos] != null)
/*  936 */           consumer.accept(new AbstractReference2ByteMap.BasicEntry<>(Reference2ByteOpenCustomHashMap.this.key[pos], Reference2ByteOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/*  941 */       AbstractReference2ByteMap.BasicEntry<K> entry = new AbstractReference2ByteMap.BasicEntry<>();
/*  942 */       if (Reference2ByteOpenCustomHashMap.this.containsNullKey) {
/*  943 */         entry.key = Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n];
/*  944 */         entry.value = Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n];
/*  945 */         consumer.accept(entry);
/*      */       } 
/*  947 */       for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0;) {
/*  948 */         if (Reference2ByteOpenCustomHashMap.this.key[pos] != null) {
/*  949 */           entry.key = Reference2ByteOpenCustomHashMap.this.key[pos];
/*  950 */           entry.value = Reference2ByteOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  976 */       return Reference2ByteOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  982 */       return new Reference2ByteOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  987 */       if (Reference2ByteOpenCustomHashMap.this.containsNullKey)
/*  988 */         consumer.accept(Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n]); 
/*  989 */       for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  990 */         K k = Reference2ByteOpenCustomHashMap.this.key[pos];
/*  991 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/*  997 */       return Reference2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1001 */       return Reference2ByteOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1005 */       int oldSize = Reference2ByteOpenCustomHashMap.this.size;
/* 1006 */       Reference2ByteOpenCustomHashMap.this.removeByte(k);
/* 1007 */       return (Reference2ByteOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1011 */       Reference2ByteOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1035 */       return Reference2ByteOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1044 */             return new Reference2ByteOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1048 */             return Reference2ByteOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1052 */             return Reference2ByteOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1056 */             Reference2ByteOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1061 */             if (Reference2ByteOpenCustomHashMap.this.containsNullKey)
/* 1062 */               consumer.accept(Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n]); 
/* 1063 */             for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1064 */               if (Reference2ByteOpenCustomHashMap.this.key[pos] != null)
/* 1065 */                 consumer.accept(Reference2ByteOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1176 */       c = (Reference2ByteOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2ByteOpenCustomHashMap.class
