...
/*      */   
/*      */   public boolean trim() {
/* 1745 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1778 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1779 */       return true; 
/*      */     try {
/* 1781 */       rehash(l);
/* 1782 */     } catch (OutOfMemoryError cantDoIt) {
/* 1783 */       return false;
/*      */     } 
/* 1785 */     return true;
/*      */   }
...
/* 1801 */     K[] key = this.key;
/* 1802 */     double[] value = this.value;
/* 1803 */     int mask = newN - 1;
/* 1804 */     K[] newKey = (K[])new Object[newN + 1];
/* 1805 */     double[] newValue = new double[newN + 1];
/* 1806 */     int i = this.first, prev = -1, newPrev = -1;
/* 1807 */     long[] link = this.link;
/* 1808 */     long[] newLink = new long[newN + 1];
/* 1809 */     this.first = -1;
/* 1810 */     for (int j = this.size; j-- != 0; ) {
/* 1811 */       int pos; if (key[i] == null) {
/* 1812 */         pos = newN;
/*      */       } else {
/* 1814 */         pos = HashCommon.mix(key[i].hashCode()) & mask;
/* 1815 */         while (newKey[pos] != null)
/* 1816 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1818 */       newKey[pos] = key[i];
/* 1819 */       newValue[pos] = value[i];
/* 1820 */       if (prev != -1) {
/* 1821 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1822 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1823 */         newPrev = pos;
/*      */       } else {
/* 1825 */         newPrev = this.first = pos;
/*      */         
/* 1827 */         newLink[pos] = -1L;
/*      */       } 
/* 1829 */       int t = i;
...
/* 1831 */       prev = t;
/*      */     } 
/* 1833 */     this.link = newLink;
/* 1834 */     this.last = newPrev;
/* 1835 */     if (newPrev != -1)
/*      */     {
/* 1837 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1838 */     this.n = newN;
/* 1839 */     this.mask = mask;
/* 1840 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1841 */     this.key = newKey;
/* 1842 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1859 */       c = (Object2DoubleLinkedOpenHashMap<K>)super.clone();
/* 1860 */     } catch (CloneNotSupportedException cantHappen) {
/* 1861 */       throw new InternalError();
/*      */     } 
/* 1863 */     c.keys = null;
/* 1864 */     c.values = null;
/* 1865 */     c.entries = null;
/* 1866 */     c.containsNullKey = this.containsNullKey;
/* 1867 */     c.key = (K[])this.key.clone();
/* 1868 */     c.value = (double[])this.value.clone();
/* 1869 */     c.link = (long[])this.link.clone();
/* 1870 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1883 */     int h = 0;
/* 1884 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1885 */       while (this.key[i] == null)
/* 1886 */         i++; 
/* 1887 */       if (this != this.key[i])
/* 1888 */         t = this.key[i].hashCode(); 
/* 1889 */       t ^= HashCommon.double2int(this.value[i]);
/* 1890 */       h += t;
/* 1891 */       i++;
/*      */     } 
/*      */     
/* 1894 */     if (this.containsNullKey)
/* 1895 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1896 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1899 */     K[] key = this.key;
/* 1900 */     double[] value = this.value;
/* 1901 */     MapIterator i = new MapIterator();
/* 1902 */     s.defaultWriteObject();
/* 1903 */     for (int j = this.size; j-- != 0; ) {
/* 1904 */       int e = i.nextEntry();
/* 1905 */       s.writeObject(key[e]);
/* 1906 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1911 */     s.defaultReadObject();
/* 1912 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1913 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1914 */     this.mask = this.n - 1;
/* 1915 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1916 */     double[] value = this.value = new double[this.n + 1];
/* 1917 */     long[] link = this.link = new long[this.n + 1];
/* 1918 */     int prev = -1;
/* 1919 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1922 */     for (int i = this.size; i-- != 0; ) {
/* 1923 */       int pos; K k = (K)s.readObject();
/* 1924 */       double v = s.readDouble();
/* 1925 */       if (k == null) {
/* 1926 */         pos = this.n;
/* 1927 */         this.containsNullKey = true;
/*      */       } else {
/* 1929 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1930 */         while (key[pos] != null)
/* 1931 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1933 */       key[pos] = k;
/* 1934 */       value[pos] = v;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2DoubleLinkedOpenHashMap.class
