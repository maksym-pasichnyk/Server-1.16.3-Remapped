...
/*      */   
/*      */   public boolean trim() {
/* 1005 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1006 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1007 */       return true; 
/*      */     try {
/* 1009 */       rehash(l);
/* 1010 */     } catch (OutOfMemoryError cantDoIt) {
/* 1011 */       return false;
/*      */     } 
/* 1013 */     return true;
/*      */   }
...
/* 1037 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1038 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1039 */       return true; 
/*      */     try {
/* 1041 */       rehash(l);
...
/* 1061 */     K[] key = this.key;
/* 1062 */     char[] value = this.value;
/* 1063 */     int mask = newN - 1;
/* 1064 */     K[] newKey = (K[])new Object[newN + 1];
/* 1065 */     char[] newValue = new char[newN + 1];
/* 1066 */     int i = this.n;
/* 1067 */     for (int j = realSize(); j-- != 0; ) {
/* 1068 */       while (key[--i] == null); int pos;
/* 1069 */       if (newKey[pos = HashCommon.mix(key[i].hashCode()) & mask] != null)
/* 1070 */         while (newKey[pos = pos + 1 & mask] != null); 
/* 1071 */       newKey[pos] = key[i];
/* 1072 */       newValue[pos] = value[i];
/*      */     } 
/* 1074 */     newValue[newN] = value[this.n];
/* 1075 */     this.n = newN;
/* 1076 */     this.mask = mask;
/* 1077 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1078 */     this.key = newKey;
/* 1079 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1096 */       c = (Object2CharOpenHashMap<K>)super.clone();
/* 1097 */     } catch (CloneNotSupportedException cantHappen) {
/* 1098 */       throw new InternalError();
/*      */     } 
/* 1100 */     c.keys = null;
/* 1101 */     c.values = null;
/* 1102 */     c.entries = null;
/* 1103 */     c.containsNullKey = this.containsNullKey;
/* 1104 */     c.key = (K[])this.key.clone();
/* 1105 */     c.value = (char[])this.value.clone();
/* 1106 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1119 */     int h = 0;
/* 1120 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1121 */       while (this.key[i] == null)
/* 1122 */         i++; 
/* 1123 */       if (this != this.key[i])
/* 1124 */         t = this.key[i].hashCode(); 
/* 1125 */       t ^= this.value[i];
/* 1126 */       h += t;
/* 1127 */       i++;
/*      */     } 
/*      */     
/* 1130 */     if (this.containsNullKey)
/* 1131 */       h += this.value[this.n]; 
/* 1132 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1135 */     K[] key = this.key;
/* 1136 */     char[] value = this.value;
/* 1137 */     MapIterator i = new MapIterator();
/* 1138 */     s.defaultWriteObject();
/* 1139 */     for (int j = this.size; j-- != 0; ) {
/* 1140 */       int e = i.nextEntry();
/* 1141 */       s.writeObject(key[e]);
/* 1142 */       s.writeChar(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1147 */     s.defaultReadObject();
/* 1148 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1149 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1150 */     this.mask = this.n - 1;
/* 1151 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1152 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1155 */     for (int i = this.size; i-- != 0; ) {
/* 1156 */       int pos; K k = (K)s.readObject();
/* 1157 */       char v = s.readChar();
/* 1158 */       if (k == null) {
/* 1159 */         pos = this.n;
/* 1160 */         this.containsNullKey = true;
/*      */       } else {
/* 1162 */         pos = HashCommon.mix(k.hashCode()) & this.mask;
/* 1163 */         while (key[pos] != null)
/* 1164 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1166 */       key[pos] = k;
/* 1167 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2CharOpenHashMap.class
