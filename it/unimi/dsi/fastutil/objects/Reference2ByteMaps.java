...
/*  49 */     ObjectSet<Reference2ByteMap.Entry<K>> entries = map.reference2ByteEntrySet();
/*  50 */     return (entries instanceof Reference2ByteMap.FastEntrySet) ? (
/*  51 */       (Reference2ByteMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  71 */     ObjectSet<Reference2ByteMap.Entry<K>> entries = map.reference2ByteEntrySet();
/*  72 */     if (entries instanceof Reference2ByteMap.FastEntrySet) {
/*  73 */       ((Reference2ByteMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  91 */     final ObjectSet<Reference2ByteMap.Entry<K>> entries = map.reference2ByteEntrySet();
/*  92 */     return (entries instanceof Reference2ByteMap.FastEntrySet) ? (ObjectIterable)new ObjectIterable<Reference2ByteMap.Entry<Reference2ByteMap.Entry<K>>>() {
/*     */         public ObjectIterator<Reference2ByteMap.Entry<K>> iterator() {
/*  94 */           return ((Reference2ByteMap.FastEntrySet<K>)entries).fastIterator();
/*     */         }
/*     */         public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/*  97 */           ((Reference2ByteMap.FastEntrySet<K>)entries).fastForEach(consumer);
/*     */         }
/*  99 */       } : entries;
/*     */   }
/*     */ 
...
/*     */     
/*     */     public Object clone() {
/* 151 */       return Reference2ByteMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 229 */         this.entries = ObjectSets.singleton(new AbstractReference2ByteMap.BasicEntry<>(this.key, this.value)); 
...
/* 241 */       return (ObjectSet)reference2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/* 361 */           this.entries = ObjectSets.synchronize(this.map.reference2ByteEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Byte>> entrySet() {
/* 374 */       return (ObjectSet)reference2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/* 650 */         this.entries = ObjectSets.unmodifiable(this.map.reference2ByteEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<K, Byte>> entrySet() {
/* 662 */       return (ObjectSet)reference2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public ReferenceSet<K> keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2ByteMaps.class
