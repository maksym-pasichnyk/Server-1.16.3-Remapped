...
/*  957 */         return false; 
/*  958 */       Map.Entry<K, Long> e = (Map.Entry<K, Long>)o;
/*  959 */       return (Objects.equals(this.key, e.getKey()) && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  963 */       return this.key.hashCode() ^ HashCommon.long2int(this.value);
/*      */     }
/*      */     
...
/* 1045 */     int index = 0;
/*      */     TreeIterator() {
/* 1047 */       this.next = Object2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(K k) {
/* 1050 */       if ((this.next = Object2LongAVLTreeMap.this.locateKey(k)) != null)
/* 1051 */         if (Object2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1102 */       updatePrevious();
/* 1103 */       updateNext();
/* 1104 */       Object2LongAVLTreeMap.this.removeLong(this.curr.key);
/* 1105 */       this.curr = null;
/*      */     }
...
/* 1152 */       this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2LongMap.Entry<Object2LongMap.Entry<K>>>()
/*      */         {
...
/* 1161 */             return new Object2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/* 1166 */             return new Object2LongAVLTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1174 */             if (e.getValue() == null || !(e.getValue() instanceof Long))
/* 1175 */               return false; 
/* 1176 */             Object2LongAVLTreeMap.Entry<K> f = Object2LongAVLTreeMap.this.findKey((K)e.getKey());
...
/* 1186 */               return false; 
/* 1187 */             Object2LongAVLTreeMap.Entry<K> f = Object2LongAVLTreeMap.this.findKey((K)e.getKey());
/* 1188 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue())
/* 1189 */               return false; 
/* 1190 */             Object2LongAVLTreeMap.this.removeLong(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Object2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Object2LongAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Object2LongMap.Entry<K> first() {
/* 1203 */             return Object2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Object2LongMap.Entry<K> last() {
/* 1207 */             return Object2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) {
/* 1212 */             return Object2LongAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) {
/* 1216 */             return Object2LongAVLTreeMap.this.headMap(to.getKey()).object2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) {
/* 1220 */             return Object2LongAVLTreeMap.this.tailMap(from.getKey()).object2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1254 */       return new Object2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1258 */       return new Object2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1313 */             return (LongIterator)new Object2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(long k) {
/* 1317 */             return Object2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1321 */             return Object2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1325 */             Object2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1388 */       if (!bottom && !top && Object2LongAVLTreeMap.this.compare(from, to) > 0)
/* 1389 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1390 */       this.from = from;
/* 1391 */       this.bottom = bottom;
/* 1392 */       this.to = to;
/* 1393 */       this.top = top;
/* 1394 */       this.defRetValue = Object2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1412 */       return ((this.bottom || Object2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2LongAVLTreeMap.this
/* 1413 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
/* 1417 */       if (this.entries == null)
/* 1418 */         this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2LongMap.Entry<Object2LongMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator() {
/* 1421 */               return new Object2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/* 1426 */               return new Object2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Object2LongMap.Entry<K>> comparator() {
/* 1430 */               return Object2LongAVLTreeMap.this.object2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Object2LongAVLTreeMap.Entry<K> f = Object2LongAVLTreeMap.this.findKey((K)e.getKey());
/* 1441 */               return (f != null && Object2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1449 */               if (e.getValue() == null || !(e.getValue() instanceof Long))
/* 1450 */                 return false; 
/* 1451 */               Object2LongAVLTreeMap.Entry<K> f = Object2LongAVLTreeMap.this.findKey((K)e.getKey());
/* 1452 */               if (f != null && Object2LongAVLTreeMap.Submap.this.in(f.key))
/* 1453 */                 Object2LongAVLTreeMap.Submap.this.removeLong(f.key); 
/* 1454 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1465 */               return !(new Object2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1469 */               Object2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Object2LongMap.Entry<K> first() {
/* 1473 */               return Object2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Object2LongMap.Entry<K> last() {
/* 1477 */               return Object2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) {
/* 1482 */               return Object2LongAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) {
/* 1486 */               return Object2LongAVLTreeMap.Submap.this.headMap(to.getKey()).object2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) {
/* 1490 */               return Object2LongAVLTreeMap.Submap.this.tailMap(from.getKey()).object2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractObject2LongSortedMap<K>.KeySet {
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1498 */         return new Object2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1502 */         return new Object2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<K> keySet() {
...
/* 1514 */         this.values = (LongCollection)new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1517 */               return (LongIterator)new Object2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(long k) {
/* 1521 */               return Object2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1525 */               return Object2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1529 */               Object2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(Object k) {
/* 1537 */       return (in((K)k) && Object2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(long v) {
...
/* 1544 */         long ev = (i.nextEntry()).value;
/* 1545 */         if (ev == v)
/* 1546 */           return true; 
/*      */       } 
/* 1548 */       return false;
...
/*      */     
/*      */     public long getLong(Object k) {
/* 1554 */       K kk = (K)k; Object2LongAVLTreeMap.Entry<K> e;
/* 1555 */       return (in(kk) && (e = Object2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public long put(K k, long v) {
/* 1559 */       Object2LongAVLTreeMap.this.modified = false;
/* 1560 */       if (!in(k))
...
/* 1563 */       long oldValue = Object2LongAVLTreeMap.this.put(k, v);
/* 1564 */       return Object2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long removeLong(Object k) {
/* 1569 */       Object2LongAVLTreeMap.this.modified = false;
/* 1570 */       if (!in((K)k))
/* 1571 */         return this.defRetValue; 
/* 1572 */       long oldValue = Object2LongAVLTreeMap.this.removeLong(k);
/* 1573 */       return Object2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1591 */       return Object2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Object2LongSortedMap<K> headMap(K to) {
/* 1595 */       if (this.top)
/* 1596 */         return new Submap(this.from, this.bottom, to, false); 
/* 1597 */       return (Object2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Object2LongSortedMap<K> tailMap(K from) {
/* 1601 */       if (this.bottom)
/* 1602 */         return new Submap(from, false, this.to, this.top); 
/* 1603 */       return (Object2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Object2LongSortedMap<K> subMap(K from, K to) {
...
/* 1609 */       if (!this.top)
/* 1610 */         to = (Object2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1611 */       if (!this.bottom)
/* 1612 */         from = (Object2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1624 */       if (Object2LongAVLTreeMap.this.tree == null) {
/* 1625 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1629 */       if (this.bottom) {
/* 1630 */         e = Object2LongAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1632 */         e = Object2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1634 */         if (Object2LongAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1635 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1639 */       if (e == null || (!this.top && Object2LongAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1640 */         return null; 
/* 1641 */       return e;
/*      */     }
/*      */ 
...
/*      */       Object2LongAVLTreeMap.Entry<K> e;
/* 1650 */       if (Object2LongAVLTreeMap.this.tree == null) {
/* 1651 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1655 */       if (this.top) {
/* 1656 */         e = Object2LongAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1658 */         e = Object2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1660 */         if (Object2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1661 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1665 */       if (e == null || (!this.bottom && Object2LongAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1666 */         return null; 
/* 1667 */       return e;
/*      */     }
/*      */     
/*      */     public K firstKey() {
/* 1671 */       Object2LongAVLTreeMap.Entry<K> e = firstEntry();
/* 1672 */       if (e == null)
...
/*      */     
/*      */     public K lastKey() {
/* 1678 */       Object2LongAVLTreeMap.Entry<K> e = lastEntry();
/* 1679 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1694 */         this.next = Object2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(K k) {
/* 1697 */         this();
/* 1698 */         if (this.next != null)
/* 1699 */           if (!Object2LongAVLTreeMap.Submap.this.bottom && Object2LongAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1700 */             this.prev = null;
/* 1701 */           } else if (!Object2LongAVLTreeMap.Submap.this.top && Object2LongAVLTreeMap.this.compare(k, (this.prev = Object2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1702 */             this.next = null;
/*      */           } else {
/* 1704 */             this.next = Object2LongAVLTreeMap.this.locateKey(k);
/* 1705 */             if (Object2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1716 */         if (!Object2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Object2LongAVLTreeMap.this.compare(this.prev.key, Object2LongAVLTreeMap.Submap.this.from) < 0)
/* 1717 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1721 */         this.next = this.next.next();
/* 1722 */         if (!Object2LongAVLTreeMap.Submap.this.top && this.next != null && Object2LongAVLTreeMap.this.compare(this.next.key, Object2LongAVLTreeMap.Submap.this.to) >= 0)
/* 1723 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1805 */       c = (Object2LongAVLTreeMap<K>)super.clone();
...
/* 1886 */     if (n == 1) {
/* 1887 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readLong());
...
/*      */ 
/*      */       
/* 1897 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readLong());
/* 1898 */       entry.right(new Entry<>((K)s.readObject(), s.readLong()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2LongAVLTreeMap.class
