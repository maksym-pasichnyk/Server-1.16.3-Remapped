...
/*      */   
/*      */   public boolean trim() {
/*  995 */     int l = HashCommon.arraySize(this.size, this.f);
/*  996 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/*  997 */       return true; 
/*      */     try {
/*  999 */       rehash(l);
/* 1000 */     } catch (OutOfMemoryError cantDoIt) {
/* 1001 */       return false;
/*      */     } 
/* 1003 */     return true;
/*      */   }
...
/* 1027 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1028 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1029 */       return true; 
/*      */     try {
/* 1031 */       rehash(l);
/* 1032 */     } catch (OutOfMemoryError cantDoIt) {
/* 1033 */       return false;
/*      */     } 
/* 1035 */     return true;
/*      */   }
...
/* 1051 */     K[] key = this.key;
/* 1052 */     int mask = newN - 1;
/* 1053 */     K[] newKey = (K[])new Object[newN + 1];
/* 1054 */     int i = this.first, prev = -1, newPrev = -1;
/* 1055 */     long[] link = this.link;
/* 1056 */     long[] newLink = new long[newN + 1];
/* 1057 */     this.first = -1;
/* 1058 */     for (int j = this.size; j-- != 0; ) {
/* 1059 */       int pos; if (key[i] == null) {
/* 1060 */         pos = newN;
/*      */       } else {
/* 1062 */         pos = HashCommon.mix(System.identityHashCode(key[i])) & mask;
/* 1063 */         while (newKey[pos] != null)
/* 1064 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1066 */       newKey[pos] = key[i];
/* 1067 */       if (prev != -1) {
/* 1068 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1069 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1070 */         newPrev = pos;
/*      */       } else {
/* 1072 */         newPrev = this.first = pos;
/*      */         
/* 1074 */         newLink[pos] = -1L;
/*      */       } 
/* 1076 */       int t = i;
...
/* 1078 */       prev = t;
/*      */     } 
/* 1080 */     this.link = newLink;
/* 1081 */     this.last = newPrev;
/* 1082 */     if (newPrev != -1)
/*      */     {
/* 1084 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1085 */     this.n = newN;
/* 1086 */     this.mask = mask;
/* 1087 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1088 */     this.key = newKey;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1105 */       c = (ReferenceLinkedOpenHashSet<K>)super.clone();
/* 1106 */     } catch (CloneNotSupportedException cantHappen) {
/* 1107 */       throw new InternalError();
/*      */     } 
/* 1109 */     c.key = (K[])this.key.clone();
/* 1110 */     c.containsNull = this.containsNull;
/* 1111 */     c.link = (long[])this.link.clone();
/* 1112 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1125 */     int h = 0;
/* 1126 */     for (int j = realSize(), i = 0; j-- != 0; ) {
/* 1127 */       while (this.key[i] == null)
/* 1128 */         i++; 
/* 1129 */       if (this != this.key[i])
/* 1130 */         h += System.identityHashCode(this.key[i]); 
/* 1131 */       i++;
/*      */     } 
/*      */     
/* 1134 */     return h;
...
/* 1137 */     ObjectIterator<K> i = iterator();
/* 1138 */     s.defaultWriteObject();
/* 1139 */     for (int j = this.size; j-- != 0;)
/* 1140 */       s.writeObject(i.next()); 
/*      */   }
/*      */   
...
/* 1149 */     long[] link = this.link = new long[this.n + 1];
/* 1150 */     int prev = -1;
/* 1151 */     this.first = this.last = -1;
/*      */     
/* 1153 */     for (int i = this.size; i-- != 0; ) {
/* 1154 */       int pos; K k = (K)s.readObject();
/* 1155 */       if (k == null) {
/* 1156 */         pos = this.n;
/* 1157 */         this.containsNull = true;
/*      */       }
/* 1159 */       else if (key[pos = HashCommon.mix(System.identityHashCode(k)) & this.mask] != null) {
/* 1160 */         while (key[pos = pos + 1 & this.mask] != null);
/*      */       } 
/* 1162 */       key[pos] = k;
/* 1163 */       if (this.first != -1) {
/* 1164 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1165 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1166 */         prev = pos; continue;
/*      */       } 
/* 1168 */       prev = this.first = pos;
/*      */       
/* 1170 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1173 */     this.last = prev;
/* 1174 */     if (prev != -1)
/*      */     {
/* 1176 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\ReferenceLinkedOpenHashSet.class
