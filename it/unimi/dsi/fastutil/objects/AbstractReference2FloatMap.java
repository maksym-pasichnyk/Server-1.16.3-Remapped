...
/*  52 */     ObjectIterator<Reference2FloatMap.Entry<K>> i = reference2FloatEntrySet().iterator();
/*  53 */     while (i.hasNext()) {
/*  54 */       if (((Reference2FloatMap.Entry)i.next()).getKey() == k)
/*  55 */         return true; 
/*  56 */     }  return false;
/*     */   }
/*     */   
...
/* 100 */         return false; 
/* 101 */       if (o instanceof Reference2FloatMap.Entry) {
/* 102 */         Reference2FloatMap.Entry<K> entry = (Reference2FloatMap.Entry<K>)o;
...
/* 110 */         return false; 
/* 111 */       return (this.key == key && 
/* 112 */         Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)value).floatValue()));
/*     */     }
/*     */     
/*     */     public int hashCode() {
/* 116 */       return System.identityHashCode(this.key) ^ HashCommon.float2int(this.value);
/*     */     }
/*     */     
...
/* 155 */         return false; 
/* 156 */       if (o instanceof Reference2FloatMap.Entry) {
/* 157 */         Reference2FloatMap.Entry<K> entry = (Reference2FloatMap.Entry<K>)o;
...
/* 192 */           return AbstractReference2FloatMap.this.containsKey(k);
/*     */         }
/*     */         
/*     */         public int size() {
/* 196 */           return AbstractReference2FloatMap.this.size();
/*     */         }
/*     */         
/*     */         public void clear() {
/* 200 */           AbstractReference2FloatMap.this.clear();
/*     */         }
/*     */         
/*     */         public ObjectIterator<K> iterator() {
/* 204 */           return new ObjectIterator<K>()
/*     */             {
/* 206 */               private final ObjectIterator<Reference2FloatMap.Entry<K>> i = Reference2FloatMaps.fastIterator(AbstractReference2FloatMap.this);
/*     */               
/*     */               public K next() {
/* 209 */                 return ((Reference2FloatMap.Entry<K>)this.i.next()).getKey();
/*     */               }
/*     */               
...
/* 242 */           return AbstractReference2FloatMap.this.containsValue(k);
/*     */         }
/*     */         
/*     */         public int size() {
/* 246 */           return AbstractReference2FloatMap.this.size();
/*     */         }
/*     */         
/*     */         public void clear() {
/* 250 */           AbstractReference2FloatMap.this.clear();
/*     */         }
/*     */         
/*     */         public FloatIterator iterator() {
/* 254 */           return new FloatIterator()
/*     */             {
/* 256 */               private final ObjectIterator<Reference2FloatMap.Entry<K>> i = Reference2FloatMaps.fastIterator(AbstractReference2FloatMap.this);
/*     */               
/*     */               public float nextFloat() {
/* 259 */                 return ((Reference2FloatMap.Entry)this.i.next()).getFloatValue();
/*     */               }
/*     */               
/*     */               public boolean hasNext() {
...
/* 273 */     if (m instanceof Reference2FloatMap) {
/* 274 */       ObjectIterator<Reference2FloatMap.Entry<K>> i = Reference2FloatMaps.fastIterator((Reference2FloatMap)m);
/* 275 */       while (i.hasNext()) {
/* 276 */         Reference2FloatMap.Entry<? extends K> e = i.next();
...
/*     */   public int hashCode() {
/* 298 */     int h = 0, n = size();
/* 299 */     ObjectIterator<Reference2FloatMap.Entry<K>> i = Reference2FloatMaps.fastIterator(this);
/* 300 */     while (n-- != 0)
/* 301 */       h += ((Reference2FloatMap.Entry)i.next()).hashCode(); 
/* 302 */     return h;
/*     */   }
/*     */   
/*     */   public boolean equals(Object o) {
...
/* 311 */     if (m.size() != size())
/* 312 */       return false; 
/* 313 */     return reference2FloatEntrySet().containsAll(m.entrySet());
/*     */   }
/*     */   
/*     */   public String toString() {
/* 317 */     StringBuilder s = new StringBuilder();
/* 318 */     ObjectIterator<Reference2FloatMap.Entry<K>> i = Reference2FloatMaps.fastIterator(this);
/* 319 */     int n = size();
/*     */     
...
/*     */       } else {
/* 327 */         s.append(", ");
/* 328 */       }  Reference2FloatMap.Entry<K> e = i.next();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\AbstractReference2FloatMap.class
