...
/*      */   
/*      */   public boolean trim() {
/* 1009 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1010 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1011 */       return true; 
/*      */     try {
/* 1013 */       rehash(l);
/* 1014 */     } catch (OutOfMemoryError cantDoIt) {
/* 1015 */       return false;
/*      */     } 
/* 1017 */     return true;
/*      */   }
...
/* 1042 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1043 */       return true; 
/*      */     try {
/* 1045 */       rehash(l);
...
/* 1065 */     K[] key = this.key;
/* 1066 */     boolean[] value = this.value;
/* 1067 */     int mask = newN - 1;
/* 1068 */     K[] newKey = (K[])new Object[newN + 1];
/* 1069 */     boolean[] newValue = new boolean[newN + 1];
/* 1070 */     int i = this.n;
/* 1071 */     for (int j = realSize(); j-- != 0; ) {
/* 1072 */       while (key[--i] == null); int pos;
/* 1073 */       if (newKey[pos = HashCommon.mix(System.identityHashCode(key[i])) & mask] != null)
/*      */       {
/* 1075 */         while (newKey[pos = pos + 1 & mask] != null); } 
/* 1076 */       newKey[pos] = key[i];
/* 1077 */       newValue[pos] = value[i];
/*      */     } 
/* 1079 */     newValue[newN] = value[this.n];
/* 1080 */     this.n = newN;
/* 1081 */     this.mask = mask;
/* 1082 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1083 */     this.key = newKey;
/* 1084 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1101 */       c = (Reference2BooleanOpenHashMap<K>)super.clone();
/* 1102 */     } catch (CloneNotSupportedException cantHappen) {
/* 1103 */       throw new InternalError();
/*      */     } 
/* 1105 */     c.keys = null;
/* 1106 */     c.values = null;
/* 1107 */     c.entries = null;
/* 1108 */     c.containsNullKey = this.containsNullKey;
/* 1109 */     c.key = (K[])this.key.clone();
/* 1110 */     c.value = (boolean[])this.value.clone();
/* 1111 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1124 */     int h = 0;
/* 1125 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1126 */       while (this.key[i] == null)
/* 1127 */         i++; 
/* 1128 */       if (this != this.key[i])
/* 1129 */         t = System.identityHashCode(this.key[i]); 
/* 1130 */       t ^= this.value[i] ? 1231 : 1237;
/* 1131 */       h += t;
/* 1132 */       i++;
/*      */     } 
/*      */     
/* 1135 */     if (this.containsNullKey)
/* 1136 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1137 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1140 */     K[] key = this.key;
/* 1141 */     boolean[] value = this.value;
/* 1142 */     MapIterator i = new MapIterator();
/* 1143 */     s.defaultWriteObject();
/* 1144 */     for (int j = this.size; j-- != 0; ) {
/* 1145 */       int e = i.nextEntry();
/* 1146 */       s.writeObject(key[e]);
/* 1147 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1152 */     s.defaultReadObject();
/* 1153 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1154 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1155 */     this.mask = this.n - 1;
/* 1156 */     K[] key = this.key = (K[])new Object[this.n + 1];
/* 1157 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1160 */     for (int i = this.size; i-- != 0; ) {
/* 1161 */       int pos; K k = (K)s.readObject();
/* 1162 */       boolean v = s.readBoolean();
/* 1163 */       if (k == null) {
/* 1164 */         pos = this.n;
/* 1165 */         this.containsNullKey = true;
/*      */       } else {
/* 1167 */         pos = HashCommon.mix(System.identityHashCode(k)) & this.mask;
/* 1168 */         while (key[pos] != null)
/* 1169 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1171 */       key[pos] = k;
/* 1172 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Reference2BooleanOpenHashMap.class
