...
/*  693 */     while (j-- != 0) {
/*  694 */       double ev = i.nextDouble();
/*  695 */       if (Double.doubleToLongBits(ev) == Double.doubleToLongBits(v))
/*  696 */         return true; 
/*      */     } 
/*  698 */     return false;
/*      */   }
...
/*  891 */       double oldValue = this.value;
...
/*  913 */         return false; 
/*  914 */       Map.Entry<K, Double> e = (Map.Entry<K, Double>)o;
/*  915 */       return (Objects.equals(this.key, e.getKey()) && 
/*  916 */         Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  920 */       return this.key.hashCode() ^ HashCommon.double2int(this.value);
/*      */     }
/*      */     
...
/* 1002 */     int index = 0;
/*      */     TreeIterator() {
/* 1004 */       this.next = Object2DoubleRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(K k) {
/* 1007 */       if ((this.next = Object2DoubleRBTreeMap.this.locateKey(k)) != null)
/* 1008 */         if (Object2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1059 */       updatePrevious();
/* 1060 */       updateNext();
/* 1061 */       Object2DoubleRBTreeMap.this.removeDouble(this.curr.key);
/* 1062 */       this.curr = null;
/*      */     }
...
/* 1101 */       this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2DoubleMap.Entry<Object2DoubleMap.Entry<K>>>()
/*      */         {
...
/* 1110 */             return new Object2DoubleRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) {
/* 1115 */             return new Object2DoubleRBTreeMap.EntryIterator(from.getKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1123 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1124 */               return false; 
/* 1125 */             Object2DoubleRBTreeMap.Entry<K> f = Object2DoubleRBTreeMap.this.findKey((K)e.getKey());
...
/* 1135 */               return false; 
/* 1136 */             Object2DoubleRBTreeMap.Entry<K> f = Object2DoubleRBTreeMap.this.findKey((K)e.getKey());
/* 1137 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != 
/* 1138 */               Double.doubleToLongBits(((Double)e.getValue()).doubleValue()))
/* 1139 */               return false; 
/* 1140 */             Object2DoubleRBTreeMap.this.removeDouble(f.key);
/* 1141 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1145 */             return Object2DoubleRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1149 */             Object2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Object2DoubleMap.Entry<K> first() {
/* 1153 */             return Object2DoubleRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Object2DoubleMap.Entry<K> last() {
/* 1157 */             return Object2DoubleRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) {
/* 1162 */             return Object2DoubleRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) {
/* 1166 */             return Object2DoubleRBTreeMap.this.headMap(to.getKey()).object2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) {
/* 1170 */             return Object2DoubleRBTreeMap.this.tailMap(from.getKey()).object2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1204 */       return new Object2DoubleRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1208 */       return new Object2DoubleRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1263 */             return (DoubleIterator)new Object2DoubleRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(double k) {
/* 1267 */             return Object2DoubleRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1271 */             return Object2DoubleRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1275 */             Object2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1338 */       if (!bottom && !top && Object2DoubleRBTreeMap.this.compare(from, to) > 0)
/* 1339 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1340 */       this.from = from;
/* 1341 */       this.bottom = bottom;
/* 1342 */       this.to = to;
/* 1343 */       this.top = top;
/* 1344 */       this.defRetValue = Object2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1362 */       return ((this.bottom || Object2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2DoubleRBTreeMap.this
/* 1363 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
/* 1367 */       if (this.entries == null)
/* 1368 */         this.entries = (ObjectSortedSet)new AbstractObjectSortedSet<Object2DoubleMap.Entry<Object2DoubleMap.Entry<K>>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator() {
/* 1371 */               return new Object2DoubleRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) {
/* 1376 */               return new Object2DoubleRBTreeMap.Submap.SubmapEntryIterator(from.getKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Object2DoubleMap.Entry<K>> comparator() {
/* 1380 */               return Object2DoubleRBTreeMap.this.object2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1389 */                 return false; 
/* 1390 */               Object2DoubleRBTreeMap.Entry<K> f = Object2DoubleRBTreeMap.this.findKey((K)e.getKey());
/* 1391 */               return (f != null && Object2DoubleRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1399 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1400 */                 return false; 
/* 1401 */               Object2DoubleRBTreeMap.Entry<K> f = Object2DoubleRBTreeMap.this.findKey((K)e.getKey());
/* 1402 */               if (f != null && Object2DoubleRBTreeMap.Submap.this.in(f.key))
/* 1403 */                 Object2DoubleRBTreeMap.Submap.this.removeDouble(f.key); 
/* 1404 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
...
/*      */             
/*      */             public boolean isEmpty() {
/* 1415 */               return !(new Object2DoubleRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1419 */               Object2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Object2DoubleMap.Entry<K> first() {
/* 1423 */               return Object2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Object2DoubleMap.Entry<K> last() {
/* 1427 */               return Object2DoubleRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) {
/* 1432 */               return Object2DoubleRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) {
/* 1436 */               return Object2DoubleRBTreeMap.Submap.this.headMap(to.getKey()).object2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) {
/* 1440 */               return Object2DoubleRBTreeMap.Submap.this.tailMap(from.getKey()).object2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractObject2DoubleSortedMap<K>.KeySet {
/*      */       public ObjectBidirectionalIterator<K> iterator() {
/* 1448 */         return new Object2DoubleRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ObjectBidirectionalIterator<K> iterator(K from) {
/* 1452 */         return new Object2DoubleRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<K> keySet() {
...
/* 1464 */         this.values = (DoubleCollection)new AbstractDoubleCollection()
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1467 */               return (DoubleIterator)new Object2DoubleRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(double k) {
/* 1471 */               return Object2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1475 */               return Object2DoubleRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1479 */               Object2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(Object k) {
/* 1487 */       return (in((K)k) && Object2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(double v) {
...
/* 1494 */         double ev = (i.nextEntry()).value;
/* 1495 */         if (Double.doubleToLongBits(ev) == Double.doubleToLongBits(v))
/* 1496 */           return true; 
/*      */       } 
/* 1498 */       return false;
/*      */     }
...
/*      */     
/*      */     public double getDouble(Object k) {
/* 1504 */       K kk = (K)k; Object2DoubleRBTreeMap.Entry<K> e;
/* 1505 */       return (in(kk) && (e = Object2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public double put(K k, double v) {
/* 1509 */       Object2DoubleRBTreeMap.this.modified = false;
/* 1510 */       if (!in(k))
...
/* 1513 */       double oldValue = Object2DoubleRBTreeMap.this.put(k, v);
/* 1514 */       return Object2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double removeDouble(Object k) {
/* 1519 */       Object2DoubleRBTreeMap.this.modified = false;
/* 1520 */       if (!in((K)k))
/* 1521 */         return this.defRetValue; 
/* 1522 */       double oldValue = Object2DoubleRBTreeMap.this.removeDouble(k);
/* 1523 */       return Object2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1541 */       return Object2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Object2DoubleSortedMap<K> headMap(K to) {
/* 1545 */       if (this.top)
/* 1546 */         return new Submap(this.from, this.bottom, to, false); 
/* 1547 */       return (Object2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Object2DoubleSortedMap<K> tailMap(K from) {
/* 1551 */       if (this.bottom)
/* 1552 */         return new Submap(from, false, this.to, this.top); 
/* 1553 */       return (Object2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Object2DoubleSortedMap<K> subMap(K from, K to) {
...
/* 1559 */       if (!this.top)
/* 1560 */         to = (Object2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1561 */       if (!this.bottom)
/* 1562 */         from = (Object2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1574 */       if (Object2DoubleRBTreeMap.this.tree == null) {
/* 1575 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1579 */       if (this.bottom) {
/* 1580 */         e = Object2DoubleRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1582 */         e = Object2DoubleRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1584 */         if (Object2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1585 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1589 */       if (e == null || (!this.top && Object2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1590 */         return null; 
/* 1591 */       return e;
/*      */     }
/*      */ 
...
/*      */       Object2DoubleRBTreeMap.Entry<K> e;
/* 1600 */       if (Object2DoubleRBTreeMap.this.tree == null) {
/* 1601 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1605 */       if (this.top) {
/* 1606 */         e = Object2DoubleRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1608 */         e = Object2DoubleRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Object2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1611 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1615 */       if (e == null || (!this.bottom && Object2DoubleRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1616 */         return null; 
/* 1617 */       return e;
/*      */     }
/*      */     
/*      */     public K firstKey() {
/* 1621 */       Object2DoubleRBTreeMap.Entry<K> e = firstEntry();
/* 1622 */       if (e == null)
...
/*      */     
/*      */     public K lastKey() {
/* 1628 */       Object2DoubleRBTreeMap.Entry<K> e = lastEntry();
/* 1629 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1644 */         this.next = Object2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(K k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null)
/* 1649 */           if (!Object2DoubleRBTreeMap.Submap.this.bottom && Object2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1650 */             this.prev = null;
/* 1651 */           } else if (!Object2DoubleRBTreeMap.Submap.this.top && Object2DoubleRBTreeMap.this.compare(k, (this.prev = Object2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1652 */             this.next = null;
/*      */           } else {
/* 1654 */             this.next = Object2DoubleRBTreeMap.this.locateKey(k);
/* 1655 */             if (Object2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1666 */         if (!Object2DoubleRBTreeMap.Submap.this.bottom && this.prev != null && Object2DoubleRBTreeMap.this.compare(this.prev.key, Object2DoubleRBTreeMap.Submap.this.from) < 0)
/* 1667 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1671 */         this.next = this.next.next();
/* 1672 */         if (!Object2DoubleRBTreeMap.Submap.this.top && this.next != null && Object2DoubleRBTreeMap.this.compare(this.next.key, Object2DoubleRBTreeMap.Submap.this.to) >= 0)
/* 1673 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1755 */       c = (Object2DoubleRBTreeMap<K>)super.clone();
...
/* 1836 */     if (n == 1) {
/* 1837 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readDouble());
...
/*      */ 
/*      */       
/* 1848 */       Entry<K> entry = new Entry<>((K)s.readObject(), s.readDouble());
/* 1849 */       entry.black(true);
/* 1850 */       entry.right(new Entry<>((K)s.readObject(), s.readDouble()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\objects\Object2DoubleRBTreeMap.class
