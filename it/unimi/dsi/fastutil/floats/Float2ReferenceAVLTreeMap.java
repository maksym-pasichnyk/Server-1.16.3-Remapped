...
/*  936 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == e
/*  937 */         .getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  941 */       return HashCommon.float2int(this.key) ^ (
...
/* 1024 */     int index = 0;
/*      */     TreeIterator() {
/* 1026 */       this.next = Float2ReferenceAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(float k) {
/* 1029 */       if ((this.next = Float2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/* 1030 */         if (Float2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1081 */       updatePrevious();
/* 1082 */       updateNext();
/* 1083 */       Float2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1084 */       this.curr = null;
/*      */     }
...
/* 1131 */       this.entries = (ObjectSortedSet<Float2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1141 */             return (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>>)new Float2ReferenceAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> iterator(Float2ReferenceMap.Entry<V> from) {
/* 1146 */             return (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>>)new Float2ReferenceAVLTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1154 */             if (e.getKey() == null || !(e.getKey() instanceof Float))
/* 1155 */               return false; 
/* 1156 */             Float2ReferenceAVLTreeMap.Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1165 */             if (e.getKey() == null || !(e.getKey() instanceof Float))
/* 1166 */               return false; 
/* 1167 */             Float2ReferenceAVLTreeMap.Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1168 */             if (f == null || f.getValue() != e.getValue())
/* 1169 */               return false; 
/* 1170 */             Float2ReferenceAVLTreeMap.this.remove(f.key);
/* 1171 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1175 */             return Float2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1179 */             Float2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Float2ReferenceMap.Entry<V> first() {
/* 1183 */             return Float2ReferenceAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Float2ReferenceMap.Entry<V> last() {
/* 1187 */             return Float2ReferenceAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2ReferenceMap.Entry<V>> subSet(Float2ReferenceMap.Entry<V> from, Float2ReferenceMap.Entry<V> to) {
/* 1192 */             return Float2ReferenceAVLTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2ReferenceMap.Entry<V>> headSet(Float2ReferenceMap.Entry<V> to) {
/* 1196 */             return Float2ReferenceAVLTreeMap.this.headMap(to.getFloatKey()).float2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2ReferenceMap.Entry<V>> tailSet(Float2ReferenceMap.Entry<V> from) {
/* 1200 */             return Float2ReferenceAVLTreeMap.this.tailMap(from.getFloatKey()).float2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1234 */       return new Float2ReferenceAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1238 */       return new Float2ReferenceAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1293 */             return (ObjectIterator<V>)new Float2ReferenceAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1297 */             return Float2ReferenceAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1301 */             return Float2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1305 */             Float2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1316 */     return new Submap(0.0F, true, to, false);
/*      */   }
/*      */   
/*      */   public Float2ReferenceSortedMap<V> tailMap(float from) {
/* 1320 */     return new Submap(from, false, 0.0F, true);
/*      */   }
/*      */   
...
/* 1368 */       if (!bottom && !top && Float2ReferenceAVLTreeMap.this.compare(from, to) > 0)
/* 1369 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1370 */       this.from = from;
/* 1371 */       this.bottom = bottom;
/* 1372 */       this.to = to;
/* 1373 */       this.top = top;
/* 1374 */       this.defRetValue = Float2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1392 */       return ((this.bottom || Float2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ReferenceAVLTreeMap.this
/* 1393 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
/* 1397 */       if (this.entries == null)
/* 1398 */         this.entries = (ObjectSortedSet<Float2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> iterator() {
/* 1401 */               return (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>>)new Float2ReferenceAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> iterator(Float2ReferenceMap.Entry<V> from) {
/* 1406 */               return (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>>)new Float2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Float2ReferenceMap.Entry<V>> comparator() {
/* 1410 */               return Float2ReferenceAVLTreeMap.this.float2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1418 */               if (e.getKey() == null || !(e.getKey() instanceof Float))
/* 1419 */                 return false; 
/* 1420 */               Float2ReferenceAVLTreeMap.Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1421 */               return (f != null && Float2ReferenceAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1429 */               if (e.getKey() == null || !(e.getKey() instanceof Float))
/* 1430 */                 return false; 
/* 1431 */               Float2ReferenceAVLTreeMap.Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1432 */               if (f != null && Float2ReferenceAVLTreeMap.Submap.this.in(f.key))
/* 1433 */                 Float2ReferenceAVLTreeMap.Submap.this.remove(f.key); 
/* 1434 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1438 */               int c = 0;
/* 1439 */               for (ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1440 */                 c++; 
/* 1441 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1445 */               return !(new Float2ReferenceAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1449 */               Float2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Float2ReferenceMap.Entry<V> first() {
/* 1453 */               return Float2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Float2ReferenceMap.Entry<V> last() {
/* 1457 */               return Float2ReferenceAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ReferenceMap.Entry<V>> subSet(Float2ReferenceMap.Entry<V> from, Float2ReferenceMap.Entry<V> to) {
/* 1462 */               return Float2ReferenceAVLTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2ReferenceMap.Entry<V>> headSet(Float2ReferenceMap.Entry<V> to) {
/* 1466 */               return Float2ReferenceAVLTreeMap.Submap.this.headMap(to.getFloatKey()).float2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2ReferenceMap.Entry<V>> tailSet(Float2ReferenceMap.Entry<V> from) {
/* 1470 */               return Float2ReferenceAVLTreeMap.Submap.this.tailMap(from.getFloatKey()).float2ReferenceEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractFloat2ReferenceSortedMap<V>.KeySet {
/*      */       public FloatBidirectionalIterator iterator() {
/* 1478 */         return new Float2ReferenceAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1482 */         return new Float2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public FloatSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1497 */               return (ObjectIterator<V>)new Float2ReferenceAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1501 */               return Float2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1505 */               return Float2ReferenceAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1509 */               Float2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1517 */       return (in(k) && Float2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(float k) {
/* 1534 */       float kk = k; Float2ReferenceAVLTreeMap.Entry<V> e;
/* 1535 */       return (in(kk) && (e = Float2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(float k, V v) {
/* 1539 */       Float2ReferenceAVLTreeMap.this.modified = false;
/* 1540 */       if (!in(k))
...
/* 1543 */       V oldValue = Float2ReferenceAVLTreeMap.this.put(k, v);
/* 1544 */       return Float2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(float k) {
/* 1549 */       Float2ReferenceAVLTreeMap.this.modified = false;
/* 1550 */       if (!in(k))
/* 1551 */         return this.defRetValue; 
/* 1552 */       V oldValue = Float2ReferenceAVLTreeMap.this.remove(k);
/* 1553 */       return Float2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1571 */       return Float2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Float2ReferenceSortedMap<V> headMap(float to) {
/* 1575 */       if (this.top)
/* 1576 */         return new Submap(this.from, this.bottom, to, false); 
/* 1577 */       return (Float2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Float2ReferenceSortedMap<V> tailMap(float from) {
/* 1581 */       if (this.bottom)
/* 1582 */         return new Submap(from, false, this.to, this.top); 
/* 1583 */       return (Float2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Float2ReferenceSortedMap<V> subMap(float from, float to) {
...
/* 1589 */       if (!this.top)
/* 1590 */         to = (Float2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1591 */       if (!this.bottom)
/* 1592 */         from = (Float2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1604 */       if (Float2ReferenceAVLTreeMap.this.tree == null) {
/* 1605 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1609 */       if (this.bottom) {
/* 1610 */         e = Float2ReferenceAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1612 */         e = Float2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1614 */         if (Float2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1615 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1619 */       if (e == null || (!this.top && Float2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1620 */         return null; 
/* 1621 */       return e;
/*      */     }
/*      */ 
...
/*      */       Float2ReferenceAVLTreeMap.Entry<V> e;
/* 1630 */       if (Float2ReferenceAVLTreeMap.this.tree == null) {
/* 1631 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1635 */       if (this.top) {
/* 1636 */         e = Float2ReferenceAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1638 */         e = Float2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1640 */         if (Float2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1641 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1645 */       if (e == null || (!this.bottom && Float2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1646 */         return null; 
/* 1647 */       return e;
/*      */     }
/*      */     
/*      */     public float firstFloatKey() {
/* 1651 */       Float2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
/* 1652 */       if (e == null)
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1658 */       Float2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
/* 1659 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1674 */         this.next = Float2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1677 */         this();
/* 1678 */         if (this.next != null)
/* 1679 */           if (!Float2ReferenceAVLTreeMap.Submap.this.bottom && Float2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1680 */             this.prev = null;
/* 1681 */           } else if (!Float2ReferenceAVLTreeMap.Submap.this.top && Float2ReferenceAVLTreeMap.this.compare(k, (this.prev = Float2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1682 */             this.next = null;
/*      */           } else {
/* 1684 */             this.next = Float2ReferenceAVLTreeMap.this.locateKey(k);
/* 1685 */             if (Float2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1696 */         if (!Float2ReferenceAVLTreeMap.Submap.this.bottom && this.prev != null && Float2ReferenceAVLTreeMap.this.compare(this.prev.key, Float2ReferenceAVLTreeMap.Submap.this.from) < 0)
/* 1697 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1701 */         this.next = this.next.next();
/* 1702 */         if (!Float2ReferenceAVLTreeMap.Submap.this.top && this.next != null && Float2ReferenceAVLTreeMap.this.compare(this.next.key, Float2ReferenceAVLTreeMap.Submap.this.to) >= 0)
/* 1703 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1785 */       c = (Float2ReferenceAVLTreeMap<V>)super.clone();
...
/* 1866 */     if (n == 1) {
/* 1867 */       Entry<V> entry = new Entry<>(s.readFloat(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1877 */       Entry<V> entry = new Entry<>(s.readFloat(), (V)s.readObject());
/* 1878 */       entry.right(new Entry<>(s.readFloat(), (V)s.readObject()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2ReferenceAVLTreeMap.class
