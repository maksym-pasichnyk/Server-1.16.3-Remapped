...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Float2ByteFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Float2ByteFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Float2ByteFunction singleton(Float key, Byte value) {
/* 161 */     return new Singleton(key.floatValue(), value.byteValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Float2ByteFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractFloat2ByteFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Float2ByteFunction function;
/*     */     
...
/* 468 */       Byte v = this.function.apply(Float.valueOf(key));
/* 469 */       if (v == null)
...
/* 511 */     if (f instanceof Float2ByteFunction)
/* 512 */       return (Float2ByteFunction)f; 
/* 513 */     if (f instanceof DoubleToIntFunction) {
/* 514 */       return key -> SafeMath.safeIntToByte(((DoubleToIntFunction)f).applyAsInt(key));
/*     */     }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2ByteFunctions.class
