...
/*      */     try {
/* 1140 */       c = (Float2ReferenceOpenCustomHashMap<V>)super.clone();
...
/* 1170 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1171 */       h += t;
/* 1172 */       i++;
/*      */     } 
/*      */     
/* 1175 */     if (this.containsNullKey)
/* 1176 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1177 */     return h;
/*      */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2ReferenceOpenCustomHashMap.class
