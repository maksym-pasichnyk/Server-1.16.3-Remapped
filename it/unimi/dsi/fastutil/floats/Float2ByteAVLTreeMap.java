...
/*  954 */         return false; 
/*  955 */       Map.Entry<Float, Byte> e = (Map.Entry<Float, Byte>)o;
/*  956 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Byte)e
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Float2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(float k) {
/* 1048 */       if ((this.next = Float2ByteAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Float2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Float2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Float2ByteMap.Entry>)new AbstractObjectSortedSet<Float2ByteMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteAVLTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1174 */               return false; 
/* 1175 */             Float2ByteAVLTreeMap.Entry f = Float2ByteAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1187 */               return false; 
/* 1188 */             Float2ByteAVLTreeMap.Entry f = Float2ByteAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1189 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue())
/* 1190 */               return false; 
/* 1191 */             Float2ByteAVLTreeMap.this.remove(f.key);
/* 1192 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1196 */             return Float2ByteAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1200 */             Float2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Float2ByteMap.Entry first() {
/* 1204 */             return Float2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Float2ByteMap.Entry last() {
/* 1208 */             return Float2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) {
/* 1212 */             return Float2ByteAVLTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) {
/* 1216 */             return Float2ByteAVLTreeMap.this.headMap(to.getFloatKey()).float2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) {
/* 1220 */             return Float2ByteAVLTreeMap.this.tailMap(from.getFloatKey()).float2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1254 */       return new Float2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1258 */       return new Float2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1313 */             return (ByteIterator)new Float2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(byte k) {
/* 1317 */             return Float2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1321 */             return Float2ByteAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1325 */             Float2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1388 */       if (!bottom && !top && Float2ByteAVLTreeMap.this.compare(from, to) > 0)
/* 1389 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1390 */       this.from = from;
/* 1391 */       this.bottom = bottom;
/* 1392 */       this.to = to;
/* 1393 */       this.top = top;
/* 1394 */       this.defRetValue = Float2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1412 */       return ((this.bottom || Float2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ByteAVLTreeMap.this
/* 1413 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
/* 1417 */       if (this.entries == null)
/* 1418 */         this.entries = (ObjectSortedSet<Float2ByteMap.Entry>)new AbstractObjectSortedSet<Float2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator() {
/* 1421 */               return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1425 */               return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Float2ByteMap.Entry> comparator() {
/* 1429 */               return Float2ByteAVLTreeMap.this.float2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1438 */                 return false; 
/* 1439 */               if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1440 */                 return false; 
/* 1441 */               Float2ByteAVLTreeMap.Entry f = Float2ByteAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1442 */               return (f != null && Float2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1451 */                 return false; 
/* 1452 */               if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1453 */                 return false; 
/* 1454 */               Float2ByteAVLTreeMap.Entry f = Float2ByteAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1455 */               if (f != null && Float2ByteAVLTreeMap.Submap.this.in(f.key))
/* 1456 */                 Float2ByteAVLTreeMap.Submap.this.remove(f.key); 
/* 1457 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1461 */               int c = 0;
/* 1462 */               for (ObjectBidirectionalIterator<Float2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1463 */                 c++; 
/* 1464 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1468 */               return !(new Float2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1472 */               Float2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Float2ByteMap.Entry first() {
/* 1476 */               return Float2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Float2ByteMap.Entry last() {
/* 1480 */               return Float2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) {
/* 1485 */               return Float2ByteAVLTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) {
/* 1489 */               return Float2ByteAVLTreeMap.Submap.this.headMap(to.getFloatKey()).float2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) {
/* 1493 */               return Float2ByteAVLTreeMap.Submap.this.tailMap(from.getFloatKey()).float2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractFloat2ByteSortedMap.KeySet {
/*      */       public FloatBidirectionalIterator iterator() {
/* 1501 */         return new Float2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1505 */         return new Float2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public FloatSortedSet keySet() {
...
/* 1517 */         this.values = (ByteCollection)new AbstractByteCollection()
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1520 */               return (ByteIterator)new Float2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(byte k) {
/* 1524 */               return Float2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1528 */               return Float2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1532 */               Float2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1540 */       return (in(k) && Float2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/* 1547 */         byte ev = (i.nextEntry()).value;
/* 1548 */         if (ev == v)
/* 1549 */           return true; 
/*      */       } 
/* 1551 */       return false;
...
/*      */     
/*      */     public byte get(float k) {
/* 1557 */       float kk = k; Float2ByteAVLTreeMap.Entry e;
/* 1558 */       return (in(kk) && (e = Float2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public byte put(float k, byte v) {
/* 1562 */       Float2ByteAVLTreeMap.this.modified = false;
/* 1563 */       if (!in(k))
...
/* 1566 */       byte oldValue = Float2ByteAVLTreeMap.this.put(k, v);
/* 1567 */       return Float2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte remove(float k) {
/* 1572 */       Float2ByteAVLTreeMap.this.modified = false;
/* 1573 */       if (!in(k))
/* 1574 */         return this.defRetValue; 
/* 1575 */       byte oldValue = Float2ByteAVLTreeMap.this.remove(k);
/* 1576 */       return Float2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1594 */       return Float2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Float2ByteSortedMap headMap(float to) {
/* 1598 */       if (this.top)
/* 1599 */         return new Submap(this.from, this.bottom, to, false); 
/* 1600 */       return (Float2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Float2ByteSortedMap tailMap(float from) {
/* 1604 */       if (this.bottom)
/* 1605 */         return new Submap(from, false, this.to, this.top); 
/* 1606 */       return (Float2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Float2ByteSortedMap subMap(float from, float to) {
...
/* 1612 */       if (!this.top)
/* 1613 */         to = (Float2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1614 */       if (!this.bottom)
/* 1615 */         from = (Float2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1627 */       if (Float2ByteAVLTreeMap.this.tree == null) {
/* 1628 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1632 */       if (this.bottom) {
/* 1633 */         e = Float2ByteAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1635 */         e = Float2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1637 */         if (Float2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1638 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1642 */       if (e == null || (!this.top && Float2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1643 */         return null; 
/* 1644 */       return e;
/*      */     }
/*      */ 
...
/*      */       Float2ByteAVLTreeMap.Entry e;
/* 1653 */       if (Float2ByteAVLTreeMap.this.tree == null) {
/* 1654 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1658 */       if (this.top) {
/* 1659 */         e = Float2ByteAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1661 */         e = Float2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1663 */         if (Float2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1664 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1668 */       if (e == null || (!this.bottom && Float2ByteAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1669 */         return null; 
/* 1670 */       return e;
/*      */     }
/*      */     
/*      */     public float firstFloatKey() {
/* 1674 */       Float2ByteAVLTreeMap.Entry e = firstEntry();
/* 1675 */       if (e == null)
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1681 */       Float2ByteAVLTreeMap.Entry e = lastEntry();
/* 1682 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1697 */         this.next = Float2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1700 */         this();
/* 1701 */         if (this.next != null)
/* 1702 */           if (!Float2ByteAVLTreeMap.Submap.this.bottom && Float2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1703 */             this.prev = null;
/* 1704 */           } else if (!Float2ByteAVLTreeMap.Submap.this.top && Float2ByteAVLTreeMap.this.compare(k, (this.prev = Float2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1705 */             this.next = null;
/*      */           } else {
/* 1707 */             this.next = Float2ByteAVLTreeMap.this.locateKey(k);
/* 1708 */             if (Float2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1719 */         if (!Float2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Float2ByteAVLTreeMap.this.compare(this.prev.key, Float2ByteAVLTreeMap.Submap.this.from) < 0)
/* 1720 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1724 */         this.next = this.next.next();
/* 1725 */         if (!Float2ByteAVLTreeMap.Submap.this.top && this.next != null && Float2ByteAVLTreeMap.this.compare(this.next.key, Float2ByteAVLTreeMap.Submap.this.to) >= 0)
/* 1726 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1806 */       c = (Float2ByteAVLTreeMap)super.clone();
...
/* 1887 */     if (n == 1) {
/* 1888 */       Entry entry = new Entry(s.readFloat(), s.readByte());
...
/*      */ 
/*      */       
/* 1898 */       Entry entry = new Entry(s.readFloat(), s.readByte());
/* 1899 */       entry.right(new Entry(s.readFloat(), s.readByte()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2ByteAVLTreeMap.class
