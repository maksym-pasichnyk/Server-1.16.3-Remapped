...
/*      */   
/*      */   public boolean trim() {
/* 1100 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1132 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1133 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1134 */       return true; 
/*      */     try {
/* 1136 */       rehash(l);
...
/* 1157 */     double[] value = this.value;
/* 1158 */     int mask = newN - 1;
/* 1159 */     float[] newKey = new float[newN + 1];
/* 1160 */     double[] newValue = new double[newN + 1];
/* 1161 */     int i = this.n;
/* 1162 */     for (int j = realSize(); j-- != 0; ) {
/* 1163 */       while (Float.floatToIntBits(key[--i]) == 0); int pos;
/* 1164 */       if (Float.floatToIntBits(newKey[
/* 1165 */             pos = HashCommon.mix(HashCommon.float2int(key[i])) & mask]) != 0)
/* 1166 */         while (Float.floatToIntBits(newKey[pos = pos + 1 & mask]) != 0); 
/* 1167 */       newKey[pos] = key[i];
/* 1168 */       newValue[pos] = value[i];
/*      */     } 
/* 1170 */     newValue[newN] = value[this.n];
/* 1171 */     this.n = newN;
/* 1172 */     this.mask = mask;
...
/*      */     try {
/* 1192 */       c = (Float2DoubleOpenHashMap)super.clone();
/* 1193 */     } catch (CloneNotSupportedException cantHappen) {
/* 1194 */       throw new InternalError();
/*      */     } 
/* 1196 */     c.keys = null;
/* 1197 */     c.values = null;
/* 1198 */     c.entries = null;
/* 1199 */     c.containsNullKey = this.containsNullKey;
/* 1200 */     c.key = (float[])this.key.clone();
/* 1201 */     c.value = (double[])this.value.clone();
/* 1202 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1215 */     int h = 0;
/* 1216 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1217 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1218 */         i++; 
/* 1219 */       t = HashCommon.float2int(this.key[i]);
/* 1220 */       t ^= HashCommon.double2int(this.value[i]);
/* 1221 */       h += t;
/* 1222 */       i++;
/*      */     } 
/*      */     
/* 1225 */     if (this.containsNullKey)
/* 1226 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1227 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1230 */     float[] key = this.key;
/* 1231 */     double[] value = this.value;
/* 1232 */     MapIterator i = new MapIterator();
/* 1233 */     s.defaultWriteObject();
/* 1234 */     for (int j = this.size; j-- != 0; ) {
/* 1235 */       int e = i.nextEntry();
/* 1236 */       s.writeFloat(key[e]);
/* 1237 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1246 */     float[] key = this.key = new float[this.n + 1];
/* 1247 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1250 */     for (int i = this.size; i-- != 0; ) {
/* 1251 */       int pos; float k = s.readFloat();
/* 1252 */       double v = s.readDouble();
/* 1253 */       if (Float.floatToIntBits(k) == 0) {
/* 1254 */         pos = this.n;
/* 1255 */         this.containsNullKey = true;
/*      */       } else {
/* 1257 */         pos = HashCommon.mix(HashCommon.float2int(k)) & this.mask;
/* 1258 */         while (Float.floatToIntBits(key[pos]) != 0)
/* 1259 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1261 */       key[pos] = k;
/* 1262 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2DoubleOpenHashMap.class
