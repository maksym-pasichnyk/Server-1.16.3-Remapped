...
/* 1147 */       int pos; if (this.strategy.equals(key[i], 0.0F)) {
/* 1148 */         pos = newN;
/*      */       } else {
/* 1150 */         pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask;
/* 1151 */         while (Float.floatToIntBits(newKey[pos]) != 0)
/* 1152 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1193 */       c = (FloatLinkedOpenCustomHashSet)super.clone();
/* 1194 */     } catch (CloneNotSupportedException cantHappen) {
/* 1195 */       throw new InternalError();
/*      */     } 
/* 1197 */     c.key = (float[])this.key.clone();
...
/* 1225 */     FloatIterator i = iterator();
/* 1226 */     s.defaultWriteObject();
/* 1227 */     for (int j = this.size; j-- != 0;)
/* 1228 */       s.writeFloat(i.nextFloat()); 
/*      */   }
/*      */   
...
/* 1236 */     float[] key = this.key = new float[this.n + 1];
...
/* 1243 */       if (this.strategy.equals(k, 0.0F)) {
/* 1244 */         pos = this.n;
/* 1245 */         this.containsNull = true;
/*      */       }
/* 1247 */       else if (Float.floatToIntBits(key[
/* 1248 */             pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) != 0) {
/* 1249 */         while (Float.floatToIntBits(key[pos = pos + 1 & this.mask]) != 0);
/*      */       } 
/* 1251 */       key[pos] = k;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\FloatLinkedOpenCustomHashSet.class
