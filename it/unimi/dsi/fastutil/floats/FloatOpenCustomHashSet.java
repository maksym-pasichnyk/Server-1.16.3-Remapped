...
/*     */   
/*     */   public boolean trim() {
/* 601 */     int l = HashCommon.arraySize(this.size, this.f);
/* 602 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 603 */       return true; 
/*     */     try {
/* 605 */       rehash(l);
...
/* 633 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 634 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 635 */       return true; 
/*     */     try {
/* 637 */       rehash(l);
/* 638 */     } catch (OutOfMemoryError cantDoIt) {
/* 639 */       return false;
/*     */     } 
/* 641 */     return true;
/*     */   }
...
/* 657 */     float[] key = this.key;
/* 658 */     int mask = newN - 1;
/* 659 */     float[] newKey = new float[newN + 1];
/* 660 */     int i = this.n;
/* 661 */     for (int j = realSize(); j-- != 0; ) {
/* 662 */       while (Float.floatToIntBits(key[--i]) == 0); int pos;
/* 663 */       if (Float.floatToIntBits(newKey[
/* 664 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0)
/* 665 */         while (Float.floatToIntBits(newKey[pos = pos + 1 & mask]) != 0); 
/* 666 */       newKey[pos] = key[i];
/*     */     } 
/* 668 */     this.n = newN;
/* 669 */     this.mask = mask;
/* 670 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 671 */     this.key = newKey;
/*     */   }
/*     */ 
/*     */ 
...
/*     */     try {
/* 688 */       c = (FloatOpenCustomHashSet)super.clone();
/* 689 */     } catch (CloneNotSupportedException cantHappen) {
/* 690 */       throw new InternalError();
/*     */     } 
/* 692 */     c.key = (float[])this.key.clone();
/* 693 */     c.containsNull = this.containsNull;
/* 694 */     c.strategy = this.strategy;
/* 695 */     return c;
/*     */   }
/*     */ 
/*     */ 
...
/*     */   public int hashCode() {
/* 708 */     int h = 0;
/* 709 */     for (int j = realSize(), i = 0; j-- != 0; ) {
/* 710 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 711 */         i++; 
/* 712 */       h += this.strategy.hashCode(this.key[i]);
/* 713 */       i++;
/*     */     } 
/*     */     
/* 716 */     return h;
...
/* 719 */     FloatIterator i = iterator();
/* 720 */     s.defaultWriteObject();
/* 721 */     for (int j = this.size; j-- != 0;)
/* 722 */       s.writeFloat(i.nextFloat()); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 726 */     s.defaultReadObject();
/* 727 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 728 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 729 */     this.mask = this.n - 1;
/* 730 */     float[] key = this.key = new float[this.n + 1];
/*     */     
/* 732 */     for (int i = this.size; i-- != 0; ) {
/* 733 */       int pos; float k = s.readFloat();
/* 734 */       if (this.strategy.equals(k, 0.0F)) {
/* 735 */         pos = this.n;
/* 736 */         this.containsNull = true;
/*     */       }
/* 738 */       else if (Float.floatToIntBits(key[
/* 739 */             pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) != 0) {
/* 740 */         while (Float.floatToIntBits(key[pos = pos + 1 & this.mask]) != 0);
/*     */       } 
/* 742 */       key[pos] = k;
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\FloatOpenCustomHashSet.class
