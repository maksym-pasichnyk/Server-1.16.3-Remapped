...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Float2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Float2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Float2DoubleFunction singleton(Float key, Double value) {
/* 161 */     return new Singleton(key.floatValue(), value.doubleValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Float2DoubleFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractFloat2DoubleFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Float2DoubleFunction function;
/*     */     
...
/* 468 */       Double v = this.function.apply(Float.valueOf(key));
/* 469 */       if (v == null)
...
/* 511 */     if (f instanceof Float2DoubleFunction)
/* 512 */       return (Float2DoubleFunction)f; 
/* 513 */     if (f instanceof DoubleUnaryOperator) {
/* 514 */       Objects.requireNonNull((DoubleUnaryOperator)f); return (DoubleUnaryOperator)f::applyAsDouble;
/* 515 */     }  return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2DoubleFunctions.class
