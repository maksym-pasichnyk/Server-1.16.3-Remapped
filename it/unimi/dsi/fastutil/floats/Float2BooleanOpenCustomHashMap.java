...
/* 1145 */       while (Float.floatToIntBits(key[--i]) == 0); int pos;
/* 1146 */       if (Float.floatToIntBits(newKey[
/* 1147 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0)
/* 1148 */         while (Float.floatToIntBits(newKey[pos = pos + 1 & mask]) != 0); 
...
/*      */     try {
/* 1174 */       c = (Float2BooleanOpenCustomHashMap)super.clone();
...
/* 1182 */     c.key = (float[])this.key.clone();
...
/* 1200 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1201 */         i++; 
...
/* 1229 */     float[] key = this.key = new float[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2BooleanOpenCustomHashMap.class
