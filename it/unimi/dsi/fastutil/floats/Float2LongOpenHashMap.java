...
/* 1153 */     long[] value = this.value;
/* 1154 */     int mask = newN - 1;
/* 1155 */     float[] newKey = new float[newN + 1];
/* 1156 */     long[] newValue = new long[newN + 1];
/* 1157 */     int i = this.n;
...
/*      */     try {
/* 1188 */       c = (Float2LongOpenHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2LongOpenHashMap.class
