...
/*  61 */     return (entries instanceof Float2ByteSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Float2ByteSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Float2ByteMap.Entry> entries = map.float2ByteEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Float2ByteSortedMap.FastSortedEntrySet)entries); return (entries instanceof Float2ByteSortedMap.FastSortedEntrySet) ? (Float2ByteSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Float2ByteMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Float2ByteMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Float, Byte>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Float2ByteSortedMap headMap(float to) {
/* 132 */       return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Float2ByteSortedMap tailMap(float from) {
/* 137 */       return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Float2ByteMap.Entry>)ObjectSortedSets.singleton(new AbstractFloat2ByteMap.BasicEntry(this.key, this.value), 
/* 237 */             Float2ByteSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Float2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Float, Byte>> entrySet() {
/* 249 */       return (ObjectSortedSet)float2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public FloatSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Float2ByteSortedMap headMap(float to) {
...
/* 268 */         return this; 
/* 269 */       return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Float2ByteSortedMap tailMap(float from) {
...
/* 275 */         return this; 
/* 276 */       return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public float firstFloatKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.floatValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Float2ByteMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.float2ByteEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Float2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Float, Byte>> entrySet() {
/* 449 */       return (ObjectSortedSet)float2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public FloatSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Float2ByteMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.float2ByteEntrySet()); 
/* 582 */       return (ObjectSortedSet<Float2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2ByteSortedMaps.class
