...
/*      */   
/*      */   public boolean trim() {
/* 1737 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1738 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1739 */       return true; 
/*      */     try {
/* 1741 */       rehash(l);
...
/* 1770 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1771 */       return true; 
/*      */     try {
/* 1773 */       rehash(l);
...
/* 1793 */     float[] key = this.key;
/* 1794 */     boolean[] value = this.value;
/* 1795 */     int mask = newN - 1;
/* 1796 */     float[] newKey = new float[newN + 1];
/* 1797 */     boolean[] newValue = new boolean[newN + 1];
...
/* 1803 */       int pos; if (Float.floatToIntBits(key[i]) == 0) {
/* 1804 */         pos = newN;
/*      */       } else {
/* 1806 */         pos = HashCommon.mix(HashCommon.float2int(key[i])) & mask;
/* 1807 */         while (Float.floatToIntBits(newKey[pos]) != 0)
/* 1808 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1851 */       c = (Float2BooleanLinkedOpenHashMap)super.clone();
...
/* 1859 */     c.key = (float[])this.key.clone();
/* 1860 */     c.value = (boolean[])this.value.clone();
...
/* 1877 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1878 */         i++; 
/* 1879 */       t = HashCommon.float2int(this.key[i]);
/* 1880 */       t ^= this.value[i] ? 1231 : 1237;
/* 1881 */       h += t;
/* 1882 */       i++;
/*      */     } 
/*      */     
/* 1885 */     if (this.containsNullKey)
/* 1886 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1887 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1890 */     float[] key = this.key;
/* 1891 */     boolean[] value = this.value;
/* 1892 */     MapIterator i = new MapIterator();
/* 1893 */     s.defaultWriteObject();
/* 1894 */     for (int j = this.size; j-- != 0; ) {
/* 1895 */       int e = i.nextEntry();
/* 1896 */       s.writeFloat(key[e]);
/* 1897 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1906 */     float[] key = this.key = new float[this.n + 1];
/* 1907 */     boolean[] value = this.value = new boolean[this.n + 1];
...
/* 1914 */       int pos; float k = s.readFloat();
/* 1915 */       boolean v = s.readBoolean();
/* 1916 */       if (Float.floatToIntBits(k) == 0) {
/* 1917 */         pos = this.n;
/* 1918 */         this.containsNullKey = true;
/*      */       } else {
/* 1920 */         pos = HashCommon.mix(HashCommon.float2int(k)) & this.mask;
/* 1921 */         while (Float.floatToIntBits(key[pos]) != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2BooleanLinkedOpenHashMap.class
