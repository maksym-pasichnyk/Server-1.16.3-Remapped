...
/*      */   
/*      */   public boolean trim() {
/* 1051 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1052 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1053 */       return true; 
/*      */     try {
/* 1055 */       rehash(l);
...
/* 1083 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1084 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1085 */       return true; 
/*      */     try {
/* 1087 */       rehash(l);
/* 1088 */     } catch (OutOfMemoryError cantDoIt) {
/* 1089 */       return false;
/*      */     } 
/* 1091 */     return true;
/*      */   }
...
/* 1107 */     float[] key = this.key;
/* 1108 */     boolean[] value = this.value;
/* 1109 */     int mask = newN - 1;
/* 1110 */     float[] newKey = new float[newN + 1];
/* 1111 */     boolean[] newValue = new boolean[newN + 1];
/* 1112 */     int i = this.n;
/* 1113 */     for (int j = realSize(); j-- != 0; ) {
/* 1114 */       while (Float.floatToIntBits(key[--i]) == 0); int pos;
/* 1115 */       if (Float.floatToIntBits(newKey[
/* 1116 */             pos = HashCommon.mix(HashCommon.float2int(key[i])) & mask]) != 0)
/* 1117 */         while (Float.floatToIntBits(newKey[pos = pos + 1 & mask]) != 0); 
/* 1118 */       newKey[pos] = key[i];
/* 1119 */       newValue[pos] = value[i];
/*      */     } 
/* 1121 */     newValue[newN] = value[this.n];
/* 1122 */     this.n = newN;
/* 1123 */     this.mask = mask;
/* 1124 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1125 */     this.key = newKey;
/* 1126 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1143 */       c = (Float2BooleanOpenHashMap)super.clone();
/* 1144 */     } catch (CloneNotSupportedException cantHappen) {
/* 1145 */       throw new InternalError();
/*      */     } 
/* 1147 */     c.keys = null;
/* 1148 */     c.values = null;
/* 1149 */     c.entries = null;
/* 1150 */     c.containsNullKey = this.containsNullKey;
/* 1151 */     c.key = (float[])this.key.clone();
/* 1152 */     c.value = (boolean[])this.value.clone();
/* 1153 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1166 */     int h = 0;
/* 1167 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1168 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1169 */         i++; 
/* 1170 */       t = HashCommon.float2int(this.key[i]);
/* 1171 */       t ^= this.value[i] ? 1231 : 1237;
/* 1172 */       h += t;
/* 1173 */       i++;
/*      */     } 
/*      */     
/* 1176 */     if (this.containsNullKey)
/* 1177 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1178 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1181 */     float[] key = this.key;
/* 1182 */     boolean[] value = this.value;
/* 1183 */     MapIterator i = new MapIterator();
/* 1184 */     s.defaultWriteObject();
/* 1185 */     for (int j = this.size; j-- != 0; ) {
/* 1186 */       int e = i.nextEntry();
/* 1187 */       s.writeFloat(key[e]);
/* 1188 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1197 */     float[] key = this.key = new float[this.n + 1];
/* 1198 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1201 */     for (int i = this.size; i-- != 0; ) {
/* 1202 */       int pos; float k = s.readFloat();
/* 1203 */       boolean v = s.readBoolean();
/* 1204 */       if (Float.floatToIntBits(k) == 0) {
/* 1205 */         pos = this.n;
/* 1206 */         this.containsNullKey = true;
/*      */       } else {
/* 1208 */         pos = HashCommon.mix(HashCommon.float2int(k)) & this.mask;
/* 1209 */         while (Float.floatToIntBits(key[pos]) != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2BooleanOpenHashMap.class
