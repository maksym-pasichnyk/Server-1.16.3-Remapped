...
/*     */   
/*     */   public boolean trim() {
/* 549 */     int l = HashCommon.arraySize(this.size, this.f);
/* 550 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 551 */       return true; 
/*     */     try {
/* 553 */       rehash(l);
/* 554 */     } catch (OutOfMemoryError cantDoIt) {
/* 555 */       return false;
/*     */     } 
/* 557 */     return true;
/*     */   }
...
/* 581 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 582 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 583 */       return true; 
/*     */     try {
/* 585 */       rehash(l);
/* 586 */     } catch (OutOfMemoryError cantDoIt) {
/* 587 */       return false;
/*     */     } 
/* 589 */     return true;
/*     */   }
...
/* 605 */     float[] key = this.key;
/* 606 */     int mask = newN - 1;
/* 607 */     float[] newKey = new float[newN + 1];
/* 608 */     int i = this.n;
/* 609 */     for (int j = realSize(); j-- != 0; ) {
/* 610 */       while (Float.floatToIntBits(key[--i]) == 0); int pos;
/* 611 */       if (Float.floatToIntBits(newKey[
/* 612 */             pos = HashCommon.mix(HashCommon.float2int(key[i])) & mask]) != 0)
/* 613 */         while (Float.floatToIntBits(newKey[pos = pos + 1 & mask]) != 0); 
...
/* 657 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 658 */         i++; 
/* 659 */       h += HashCommon.float2int(this.key[i]);
/* 660 */       i++;
/*     */     } 
/*     */     
/* 663 */     return h;
...
/* 666 */     FloatIterator i = iterator();
/* 667 */     s.defaultWriteObject();
/* 668 */     for (int j = this.size; j-- != 0;)
/* 669 */       s.writeFloat(i.nextFloat()); 
/*     */   }
/*     */   
...
/* 677 */     float[] key = this.key = new float[this.n + 1];
/*     */     
/* 679 */     for (int i = this.size; i-- != 0; ) {
/* 680 */       int pos; float k = s.readFloat();
/* 681 */       if (Float.floatToIntBits(k) == 0) {
/* 682 */         pos = this.n;
/* 683 */         this.containsNull = true;
/*     */       }
/* 685 */       else if (Float.floatToIntBits(key[
/* 686 */             pos = HashCommon.mix(HashCommon.float2int(k)) & this.mask]) != 0) {
/*     */         
/* 688 */         while (Float.floatToIntBits(key[pos = pos + 1 & this.mask]) != 0);
/*     */       } 
/* 690 */       key[pos] = k;
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\FloatOpenHashSet.class
