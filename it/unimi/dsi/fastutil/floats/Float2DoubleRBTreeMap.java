...
/*  910 */         return false; 
/*  911 */       Map.Entry<Float, Double> e = (Map.Entry<Float, Double>)o;
...
/*      */     
/*      */     public int hashCode() {
/*  917 */       return HashCommon.float2int(this.key) ^ HashCommon.double2int(this.value);
/*      */     }
/*      */     
...
/*  999 */     int index = 0;
/*      */     TreeIterator() {
/* 1001 */       this.next = Float2DoubleRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(float k) {
/* 1004 */       if ((this.next = Float2DoubleRBTreeMap.this.locateKey(k)) != null)
/* 1005 */         if (Float2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1056 */       updatePrevious();
/* 1057 */       updateNext();
/* 1058 */       Float2DoubleRBTreeMap.this.remove(this.curr.key);
/* 1059 */       this.curr = null;
/*      */     }
...
/* 1098 */       this.entries = (ObjectSortedSet<Float2DoubleMap.Entry>)new AbstractObjectSortedSet<Float2DoubleMap.Entry>()
/*      */         {
...
/* 1107 */             return (ObjectBidirectionalIterator<Float2DoubleMap.Entry>)new Float2DoubleRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2DoubleMap.Entry> iterator(Float2DoubleMap.Entry from) {
/* 1111 */             return (ObjectBidirectionalIterator<Float2DoubleMap.Entry>)new Float2DoubleRBTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1122 */               return false; 
/* 1123 */             Float2DoubleRBTreeMap.Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1135 */               return false; 
/* 1136 */             Float2DoubleRBTreeMap.Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1137 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != 
/* 1138 */               Double.doubleToLongBits(((Double)e.getValue()).doubleValue()))
/* 1139 */               return false; 
/* 1140 */             Float2DoubleRBTreeMap.this.remove(f.key);
/* 1141 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1145 */             return Float2DoubleRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1149 */             Float2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Float2DoubleMap.Entry first() {
/* 1153 */             return Float2DoubleRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Float2DoubleMap.Entry last() {
/* 1157 */             return Float2DoubleRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry from, Float2DoubleMap.Entry to) {
/* 1162 */             return Float2DoubleRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2DoubleMap.Entry> headSet(Float2DoubleMap.Entry to) {
/* 1166 */             return Float2DoubleRBTreeMap.this.headMap(to.getFloatKey()).float2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(Float2DoubleMap.Entry from) {
/* 1170 */             return Float2DoubleRBTreeMap.this.tailMap(from.getFloatKey()).float2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1204 */       return new Float2DoubleRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1208 */       return new Float2DoubleRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1263 */             return (DoubleIterator)new Float2DoubleRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(double k) {
/* 1267 */             return Float2DoubleRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1271 */             return Float2DoubleRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1275 */             Float2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1338 */       if (!bottom && !top && Float2DoubleRBTreeMap.this.compare(from, to) > 0)
/* 1339 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1340 */       this.from = from;
/* 1341 */       this.bottom = bottom;
/* 1342 */       this.to = to;
/* 1343 */       this.top = top;
/* 1344 */       this.defRetValue = Float2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1362 */       return ((this.bottom || Float2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2DoubleRBTreeMap.this
/* 1363 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
/* 1367 */       if (this.entries == null)
/* 1368 */         this.entries = (ObjectSortedSet<Float2DoubleMap.Entry>)new AbstractObjectSortedSet<Float2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2DoubleMap.Entry> iterator() {
/* 1371 */               return (ObjectBidirectionalIterator<Float2DoubleMap.Entry>)new Float2DoubleRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2DoubleMap.Entry> iterator(Float2DoubleMap.Entry from) {
/* 1376 */               return (ObjectBidirectionalIterator<Float2DoubleMap.Entry>)new Float2DoubleRBTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Float2DoubleMap.Entry> comparator() {
/* 1380 */               return Float2DoubleRBTreeMap.this.float2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1388 */               if (e.getKey() == null || !(e.getKey() instanceof Float))
/* 1389 */                 return false; 
/* 1390 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1391 */                 return false; 
/* 1392 */               Float2DoubleRBTreeMap.Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1393 */               return (f != null && Float2DoubleRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1401 */               if (e.getKey() == null || !(e.getKey() instanceof Float))
/* 1402 */                 return false; 
/* 1403 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1404 */                 return false; 
/* 1405 */               Float2DoubleRBTreeMap.Entry f = Float2DoubleRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1406 */               if (f != null && Float2DoubleRBTreeMap.Submap.this.in(f.key))
/* 1407 */                 Float2DoubleRBTreeMap.Submap.this.remove(f.key); 
/* 1408 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1412 */               int c = 0;
/* 1413 */               for (ObjectBidirectionalIterator<Float2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1414 */                 c++; 
/* 1415 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1419 */               return !(new Float2DoubleRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1423 */               Float2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Float2DoubleMap.Entry first() {
/* 1427 */               return Float2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Float2DoubleMap.Entry last() {
/* 1431 */               return Float2DoubleRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry from, Float2DoubleMap.Entry to) {
/* 1436 */               return Float2DoubleRBTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2DoubleMap.Entry> headSet(Float2DoubleMap.Entry to) {
/* 1440 */               return Float2DoubleRBTreeMap.Submap.this.headMap(to.getFloatKey()).float2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(Float2DoubleMap.Entry from) {
/* 1444 */               return Float2DoubleRBTreeMap.Submap.this.tailMap(from.getFloatKey()).float2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractFloat2DoubleSortedMap.KeySet {
/*      */       public FloatBidirectionalIterator iterator() {
/* 1452 */         return new Float2DoubleRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1456 */         return new Float2DoubleRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public FloatSortedSet keySet() {
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1471 */               return (DoubleIterator)new Float2DoubleRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(double k) {
/* 1475 */               return Float2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1479 */               return Float2DoubleRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1483 */               Float2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1491 */       return (in(k) && Float2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(float k) {
/* 1508 */       float kk = k; Float2DoubleRBTreeMap.Entry e;
/* 1509 */       return (in(kk) && (e = Float2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public double put(float k, double v) {
/* 1513 */       Float2DoubleRBTreeMap.this.modified = false;
/* 1514 */       if (!in(k))
...
/* 1517 */       double oldValue = Float2DoubleRBTreeMap.this.put(k, v);
/* 1518 */       return Float2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double remove(float k) {
/* 1523 */       Float2DoubleRBTreeMap.this.modified = false;
/* 1524 */       if (!in(k))
/* 1525 */         return this.defRetValue; 
/* 1526 */       double oldValue = Float2DoubleRBTreeMap.this.remove(k);
/* 1527 */       return Float2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1545 */       return Float2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Float2DoubleSortedMap headMap(float to) {
/* 1549 */       if (this.top)
/* 1550 */         return new Submap(this.from, this.bottom, to, false); 
/* 1551 */       return (Float2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Float2DoubleSortedMap tailMap(float from) {
/* 1555 */       if (this.bottom)
/* 1556 */         return new Submap(from, false, this.to, this.top); 
/* 1557 */       return (Float2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Float2DoubleSortedMap subMap(float from, float to) {
...
/* 1563 */       if (!this.top)
/* 1564 */         to = (Float2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1565 */       if (!this.bottom)
/* 1566 */         from = (Float2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1578 */       if (Float2DoubleRBTreeMap.this.tree == null) {
/* 1579 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1583 */       if (this.bottom) {
/* 1584 */         e = Float2DoubleRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1586 */         e = Float2DoubleRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1588 */         if (Float2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1589 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1593 */       if (e == null || (!this.top && Float2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1594 */         return null; 
/* 1595 */       return e;
/*      */     }
/*      */ 
...
/*      */       Float2DoubleRBTreeMap.Entry e;
/* 1604 */       if (Float2DoubleRBTreeMap.this.tree == null) {
/* 1605 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1609 */       if (this.top) {
/* 1610 */         e = Float2DoubleRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1612 */         e = Float2DoubleRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1614 */         if (Float2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1615 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1619 */       if (e == null || (!this.bottom && Float2DoubleRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1620 */         return null; 
/* 1621 */       return e;
/*      */     }
/*      */     
/*      */     public float firstFloatKey() {
/* 1625 */       Float2DoubleRBTreeMap.Entry e = firstEntry();
/* 1626 */       if (e == null)
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1632 */       Float2DoubleRBTreeMap.Entry e = lastEntry();
/* 1633 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1648 */         this.next = Float2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1651 */         this();
/* 1652 */         if (this.next != null)
/* 1653 */           if (!Float2DoubleRBTreeMap.Submap.this.bottom && Float2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1654 */             this.prev = null;
/* 1655 */           } else if (!Float2DoubleRBTreeMap.Submap.this.top && Float2DoubleRBTreeMap.this.compare(k, (this.prev = Float2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1656 */             this.next = null;
/*      */           } else {
/* 1658 */             this.next = Float2DoubleRBTreeMap.this.locateKey(k);
/* 1659 */             if (Float2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1670 */         if (!Float2DoubleRBTreeMap.Submap.this.bottom && this.prev != null && Float2DoubleRBTreeMap.this.compare(this.prev.key, Float2DoubleRBTreeMap.Submap.this.from) < 0)
/* 1671 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1675 */         this.next = this.next.next();
/* 1676 */         if (!Float2DoubleRBTreeMap.Submap.this.top && this.next != null && Float2DoubleRBTreeMap.this.compare(this.next.key, Float2DoubleRBTreeMap.Submap.this.to) >= 0)
/* 1677 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1757 */       c = (Float2DoubleRBTreeMap)super.clone();
...
/* 1838 */     if (n == 1) {
/* 1839 */       Entry entry = new Entry(s.readFloat(), s.readDouble());
...
/*      */ 
/*      */       
/* 1850 */       Entry entry = new Entry(s.readFloat(), s.readDouble());
/* 1851 */       entry.black(true);
/* 1852 */       entry.right(new Entry(s.readFloat(), s.readDouble()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2DoubleRBTreeMap.class
