...
/* 1140 */     float[] newKey = new float[newN + 1];
/* 1141 */     char[] newValue = new char[newN + 1];
/* 1142 */     int i = this.n;
/* 1143 */     for (int j = realSize(); j-- != 0; ) {
/* 1144 */       while (Float.floatToIntBits(key[--i]) == 0); int pos;
/* 1145 */       if (Float.floatToIntBits(newKey[
/* 1146 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0)
/* 1147 */         while (Float.floatToIntBits(newKey[pos = pos + 1 & mask]) != 0); 
...
/*      */     try {
/* 1173 */       c = (Float2CharOpenCustomHashMap)super.clone();
...
/* 1181 */     c.key = (float[])this.key.clone();
...
/* 1199 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1200 */         i++; 
...
/* 1233 */       int pos; float k = s.readFloat();
...
/* 1240 */         while (Float.floatToIntBits(key[pos]) != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2CharOpenCustomHashMap.class
