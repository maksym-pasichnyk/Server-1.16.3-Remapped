...
/*      */   
/*      */   public boolean trim() {
/* 1126 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1127 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1128 */       return true; 
/*      */     try {
/* 1130 */       rehash(l);
...
/* 1158 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1159 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1160 */       return true; 
/*      */     try {
/* 1162 */       rehash(l);
/* 1163 */     } catch (OutOfMemoryError cantDoIt) {
/* 1164 */       return false;
/*      */     } 
/* 1166 */     return true;
/*      */   }
...
/* 1182 */     float[] key = this.key;
/* 1183 */     int[] value = this.value;
/* 1184 */     int mask = newN - 1;
/* 1185 */     float[] newKey = new float[newN + 1];
/* 1186 */     int[] newValue = new int[newN + 1];
/* 1187 */     int i = this.n;
/* 1188 */     for (int j = realSize(); j-- != 0; ) {
/* 1189 */       while (Float.floatToIntBits(key[--i]) == 0); int pos;
/* 1190 */       if (Float.floatToIntBits(newKey[
/* 1191 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0)
/* 1192 */         while (Float.floatToIntBits(newKey[pos = pos + 1 & mask]) != 0); 
/* 1193 */       newKey[pos] = key[i];
/* 1194 */       newValue[pos] = value[i];
/*      */     } 
/* 1196 */     newValue[newN] = value[this.n];
/* 1197 */     this.n = newN;
/* 1198 */     this.mask = mask;
/* 1199 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1200 */     this.key = newKey;
/* 1201 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1218 */       c = (Float2IntOpenCustomHashMap)super.clone();
...
/* 1223 */     c.values = null;
/* 1224 */     c.entries = null;
/* 1225 */     c.containsNullKey = this.containsNullKey;
/* 1226 */     c.key = (float[])this.key.clone();
/* 1227 */     c.value = (int[])this.value.clone();
/* 1228 */     c.strategy = this.strategy;
/* 1229 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1242 */     int h = 0;
/* 1243 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1244 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1245 */         i++; 
/* 1246 */       t = this.strategy.hashCode(this.key[i]);
/* 1247 */       t ^= this.value[i];
/* 1248 */       h += t;
/* 1249 */       i++;
/*      */     } 
/*      */     
/* 1252 */     if (this.containsNullKey)
/* 1253 */       h += this.value[this.n]; 
/* 1254 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1257 */     float[] key = this.key;
/* 1258 */     int[] value = this.value;
/* 1259 */     MapIterator i = new MapIterator();
/* 1260 */     s.defaultWriteObject();
/* 1261 */     for (int j = this.size; j-- != 0; ) {
/* 1262 */       int e = i.nextEntry();
/* 1263 */       s.writeFloat(key[e]);
/* 1264 */       s.writeInt(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1269 */     s.defaultReadObject();
/* 1270 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1271 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1272 */     this.mask = this.n - 1;
/* 1273 */     float[] key = this.key = new float[this.n + 1];
/* 1274 */     int[] value = this.value = new int[this.n + 1];
/*      */ 
/*      */     
/* 1277 */     for (int i = this.size; i-- != 0; ) {
/* 1278 */       int pos; float k = s.readFloat();
/* 1279 */       int v = s.readInt();
/* 1280 */       if (this.strategy.equals(k, 0.0F)) {
/* 1281 */         pos = this.n;
/* 1282 */         this.containsNullKey = true;
/*      */       } else {
/* 1284 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1285 */         while (Float.floatToIntBits(key[pos]) != 0)
/* 1286 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1288 */       key[pos] = k;
/* 1289 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2IntOpenCustomHashMap.class
