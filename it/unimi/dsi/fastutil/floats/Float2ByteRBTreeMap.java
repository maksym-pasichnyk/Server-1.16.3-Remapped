...
/*  910 */         return false; 
/*  911 */       Map.Entry<Float, Byte> e = (Map.Entry<Float, Byte>)o;
/*  912 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Byte)e
...
/*  999 */     int index = 0;
/*      */     TreeIterator() {
/* 1001 */       this.next = Float2ByteRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(float k) {
/* 1004 */       if ((this.next = Float2ByteRBTreeMap.this.locateKey(k)) != null)
/* 1005 */         if (Float2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1056 */       updatePrevious();
/* 1057 */       updateNext();
/* 1058 */       Float2ByteRBTreeMap.this.remove(this.curr.key);
/* 1059 */       this.curr = null;
/*      */     }
...
/* 1098 */       this.entries = (ObjectSortedSet<Float2ByteMap.Entry>)new AbstractObjectSortedSet<Float2ByteMap.Entry>()
/*      */         {
...
/* 1107 */             return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1111 */             return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteRBTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1122 */               return false; 
/* 1123 */             Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1135 */               return false; 
/* 1136 */             Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1137 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue())
/* 1138 */               return false; 
/* 1139 */             Float2ByteRBTreeMap.this.remove(f.key);
/* 1140 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1144 */             return Float2ByteRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1148 */             Float2ByteRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Float2ByteMap.Entry first() {
/* 1152 */             return Float2ByteRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Float2ByteMap.Entry last() {
/* 1156 */             return Float2ByteRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) {
/* 1160 */             return Float2ByteRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) {
/* 1164 */             return Float2ByteRBTreeMap.this.headMap(to.getFloatKey()).float2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) {
/* 1168 */             return Float2ByteRBTreeMap.this.tailMap(from.getFloatKey()).float2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1202 */       return new Float2ByteRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1206 */       return new Float2ByteRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1258 */       this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1261 */             return (ByteIterator)new Float2ByteRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(byte k) {
/* 1265 */             return Float2ByteRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1269 */             return Float2ByteRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1273 */             Float2ByteRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1336 */       if (!bottom && !top && Float2ByteRBTreeMap.this.compare(from, to) > 0)
/* 1337 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1338 */       this.from = from;
/* 1339 */       this.bottom = bottom;
/* 1340 */       this.to = to;
/* 1341 */       this.top = top;
/* 1342 */       this.defRetValue = Float2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1360 */       return ((this.bottom || Float2ByteRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ByteRBTreeMap.this
/* 1361 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
/* 1365 */       if (this.entries == null)
/* 1366 */         this.entries = (ObjectSortedSet<Float2ByteMap.Entry>)new AbstractObjectSortedSet<Float2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator() {
/* 1369 */               return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1373 */               return (ObjectBidirectionalIterator<Float2ByteMap.Entry>)new Float2ByteRBTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Float2ByteMap.Entry> comparator() {
/* 1377 */               return Float2ByteRBTreeMap.this.float2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1386 */                 return false; 
/* 1387 */               if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1388 */                 return false; 
/* 1389 */               Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1390 */               return (f != null && Float2ByteRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1399 */                 return false; 
/* 1400 */               if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1401 */                 return false; 
/* 1402 */               Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1403 */               if (f != null && Float2ByteRBTreeMap.Submap.this.in(f.key))
/* 1404 */                 Float2ByteRBTreeMap.Submap.this.remove(f.key); 
/* 1405 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1409 */               int c = 0;
/* 1410 */               for (ObjectBidirectionalIterator<Float2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1411 */                 c++; 
/* 1412 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1416 */               return !(new Float2ByteRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1420 */               Float2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Float2ByteMap.Entry first() {
/* 1424 */               return Float2ByteRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Float2ByteMap.Entry last() {
/* 1428 */               return Float2ByteRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) {
/* 1433 */               return Float2ByteRBTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) {
/* 1437 */               return Float2ByteRBTreeMap.Submap.this.headMap(to.getFloatKey()).float2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) {
/* 1441 */               return Float2ByteRBTreeMap.Submap.this.tailMap(from.getFloatKey()).float2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractFloat2ByteSortedMap.KeySet {
/*      */       public FloatBidirectionalIterator iterator() {
/* 1449 */         return new Float2ByteRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1453 */         return new Float2ByteRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public FloatSortedSet keySet() {
...
/* 1465 */         this.values = (ByteCollection)new AbstractByteCollection()
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1468 */               return (ByteIterator)new Float2ByteRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(byte k) {
/* 1472 */               return Float2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1476 */               return Float2ByteRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1480 */               Float2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1488 */       return (in(k) && Float2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/* 1495 */         byte ev = (i.nextEntry()).value;
/* 1496 */         if (ev == v)
/* 1497 */           return true; 
/*      */       } 
/* 1499 */       return false;
...
/*      */     
/*      */     public byte get(float k) {
/* 1505 */       float kk = k; Float2ByteRBTreeMap.Entry e;
/* 1506 */       return (in(kk) && (e = Float2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public byte put(float k, byte v) {
/* 1510 */       Float2ByteRBTreeMap.this.modified = false;
/* 1511 */       if (!in(k))
...
/* 1514 */       byte oldValue = Float2ByteRBTreeMap.this.put(k, v);
/* 1515 */       return Float2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte remove(float k) {
/* 1520 */       Float2ByteRBTreeMap.this.modified = false;
/* 1521 */       if (!in(k))
/* 1522 */         return this.defRetValue; 
/* 1523 */       byte oldValue = Float2ByteRBTreeMap.this.remove(k);
/* 1524 */       return Float2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1542 */       return Float2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Float2ByteSortedMap headMap(float to) {
/* 1546 */       if (this.top)
/* 1547 */         return new Submap(this.from, this.bottom, to, false); 
/* 1548 */       return (Float2ByteRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Float2ByteSortedMap tailMap(float from) {
/* 1552 */       if (this.bottom)
/* 1553 */         return new Submap(from, false, this.to, this.top); 
/* 1554 */       return (Float2ByteRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Float2ByteSortedMap subMap(float from, float to) {
...
/* 1560 */       if (!this.top)
/* 1561 */         to = (Float2ByteRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1562 */       if (!this.bottom)
/* 1563 */         from = (Float2ByteRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1575 */       if (Float2ByteRBTreeMap.this.tree == null) {
/* 1576 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1580 */       if (this.bottom) {
/* 1581 */         e = Float2ByteRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1583 */         e = Float2ByteRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1585 */         if (Float2ByteRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1586 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1590 */       if (e == null || (!this.top && Float2ByteRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1591 */         return null; 
/* 1592 */       return e;
/*      */     }
/*      */ 
...
/*      */       Float2ByteRBTreeMap.Entry e;
/* 1601 */       if (Float2ByteRBTreeMap.this.tree == null) {
/* 1602 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1606 */       if (this.top) {
/* 1607 */         e = Float2ByteRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1609 */         e = Float2ByteRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1611 */         if (Float2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1612 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1616 */       if (e == null || (!this.bottom && Float2ByteRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1617 */         return null; 
/* 1618 */       return e;
/*      */     }
/*      */     
/*      */     public float firstFloatKey() {
/* 1622 */       Float2ByteRBTreeMap.Entry e = firstEntry();
/* 1623 */       if (e == null)
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1629 */       Float2ByteRBTreeMap.Entry e = lastEntry();
/* 1630 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1645 */         this.next = Float2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1648 */         this();
/* 1649 */         if (this.next != null)
/* 1650 */           if (!Float2ByteRBTreeMap.Submap.this.bottom && Float2ByteRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1651 */             this.prev = null;
/* 1652 */           } else if (!Float2ByteRBTreeMap.Submap.this.top && Float2ByteRBTreeMap.this.compare(k, (this.prev = Float2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1653 */             this.next = null;
/*      */           } else {
/* 1655 */             this.next = Float2ByteRBTreeMap.this.locateKey(k);
/* 1656 */             if (Float2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1667 */         if (!Float2ByteRBTreeMap.Submap.this.bottom && this.prev != null && Float2ByteRBTreeMap.this.compare(this.prev.key, Float2ByteRBTreeMap.Submap.this.from) < 0)
/* 1668 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1672 */         this.next = this.next.next();
/* 1673 */         if (!Float2ByteRBTreeMap.Submap.this.top && this.next != null && Float2ByteRBTreeMap.this.compare(this.next.key, Float2ByteRBTreeMap.Submap.this.to) >= 0)
/* 1674 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1754 */       c = (Float2ByteRBTreeMap)super.clone();
...
/* 1835 */     if (n == 1) {
/* 1836 */       Entry entry = new Entry(s.readFloat(), s.readByte());
...
/*      */ 
/*      */       
/* 1847 */       Entry entry = new Entry(s.readFloat(), s.readByte());
/* 1848 */       entry.black(true);
/* 1849 */       entry.right(new Entry(s.readFloat(), s.readByte()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2ByteRBTreeMap.class
