...
/* 134 */     this(a, 0L, FloatBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 155 */     this(length);
/* 156 */     FloatBigArrays.copy(a, offset, this.a, 0L, length);
...
/* 217 */     return wrap(a, FloatBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       return; 
/* 230 */     this.a = FloatBigArrays.forceCapacity(this.a, capacity, this.size);
/* 231 */     assert this.size <= FloatBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 243 */     long oldLength = FloatBigArrays.length(this.a);
...
/* 249 */       capacity = 10L;
/* 250 */     }  this.a = FloatBigArrays.forceCapacity(this.a, capacity, this.size);
/* 251 */     assert this.size <= FloatBigArrays.length(this.a);
/*     */   }
/*     */   
...
/* 258 */       FloatBigArrays.copy(this.a, index, this.a, index + 1L, this.size - index); 
/* 259 */     FloatBigArrays.set(this.a, index, k);
/* 260 */     this.size++;
/* 261 */     assert this.size <= FloatBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public boolean add(float k) {
/* 265 */     grow(this.size + 1L);
/* 266 */     FloatBigArrays.set(this.a, this.size++, k);
/* 267 */     if (!$assertionsDisabled && this.size > FloatBigArrays.length(this.a)) throw new AssertionError(); 
/* 268 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 275 */     return FloatBigArrays.get(this.a, index);
/*     */   }
/*     */   
/*     */   public long indexOf(float k) {
/* 279 */     for (long i = 0L; i < this.size; i++) {
/* 280 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(FloatBigArrays.get(this.a, i)))
/* 281 */         return i; 
/* 282 */     }  return -1L;
/*     */   }
/*     */   
...
/* 287 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(FloatBigArrays.get(this.a, i)))
/* 288 */         return i; 
/* 289 */     }  return -1L;
/*     */   }
/*     */   
...
/*     */     }
/* 296 */     float old = FloatBigArrays.get(this.a, index);
/* 297 */     this.size--;
/* 298 */     if (index != this.size)
/* 299 */       FloatBigArrays.copy(this.a, index + 1L, this.a, index, this.size - index); 
/* 300 */     assert this.size <= FloatBigArrays.length(this.a);
/* 301 */     return old;
/*     */   }
/*     */   
...
/* 309 */     assert this.size <= FloatBigArrays.length(this.a);
/* 310 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 317 */     float old = FloatBigArrays.get(this.a, index);
/* 318 */     FloatBigArrays.set(this.a, index, k);
/* 319 */     return old;
/*     */   }
/*     */   
...
/*     */   public void clear() {
/* 369 */     this.size = 0L;
/* 370 */     assert this.size <= FloatBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public long size64() {
...
/* 378 */     if (size > FloatBigArrays.length(this.a))
/* 379 */       ensureCapacity(size); 
/* 380 */     if (size > this.size)
/* 381 */       FloatBigArrays.fill(this.a, this.size, size, 0.0F); 
/* 382 */     this.size = size;
/*     */   }
/*     */   
...
/* 414 */     long arrayLength = FloatBigArrays.length(this.a);
/* 415 */     if (n >= arrayLength || this.size == arrayLength)
/*     */       return; 
/* 417 */     this.a = FloatBigArrays.trim(this.a, Math.max(n, this.size));
/* 418 */     assert this.size <= FloatBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 436 */     FloatBigArrays.copy(this.a, from, a, offset, length);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 449 */     FloatBigArrays.copy(this.a, to, this.a, from, this.size - to);
...
/* 467 */     FloatBigArrays.ensureOffsetLength(a, offset, length);
/* 468 */     grow(this.size + length);
/* 469 */     FloatBigArrays.copy(this.a, index, this.a, index + length, this.size - index);
/* 470 */     FloatBigArrays.copy(a, offset, this.a, index, length);
...
/* 490 */           return FloatBigArrays.get(FloatBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public float previousFloat() {
/* 494 */           if (!hasPrevious())
/* 495 */             throw new NoSuchElementException(); 
/* 496 */           return FloatBigArrays.get(FloatBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 535 */     FloatBigArrays.copy(this.a, 0L, c.a, 0L, this.size);
...
/* 558 */     float[][] a2 = l.a;
/* 559 */     while (s-- != 0L) {
/* 560 */       if (FloatBigArrays.get(a1, s) != FloatBigArrays.get(a2, s))
/* 561 */         return false; 
/* 562 */     }  return true;
/*     */   }
/*     */ 
...
/* 583 */       float e1 = FloatBigArrays.get(a1, i);
/* 584 */       float e2 = FloatBigArrays.get(a2, i); int r;
...
/* 593 */       s.writeFloat(FloatBigArrays.get(this.a, i)); 
/*     */   }
/*     */   
...
/* 600 */       FloatBigArrays.set(this.a, i, s.readFloat()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\FloatBigArrayBigList.class
