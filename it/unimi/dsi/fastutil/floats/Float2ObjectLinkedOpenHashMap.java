...
/*  748 */       if (Float.floatToIntBits(key[i]) != 0 && Objects.equals(value[i], v))
/*  749 */         return true; 
/*  750 */     }  return false;
/*      */   }
/*      */ 
...
/*      */     {
/*  803 */       return false; } 
/*  804 */     if (Float.floatToIntBits(k) == Float.floatToIntBits(curr) && Objects.equals(v, this.value[pos])) {
/*  805 */       removeEntry(pos);
/*  806 */       return true;
/*      */     } 
/*      */     while (true) {
...
/*  810 */         return false; 
/*  811 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(curr) && Objects.equals(v, this.value[pos])) {
/*  812 */         removeEntry(pos);
/*  813 */         return true;
/*      */       } 
/*      */     } 
...
/*  820 */     int pos = find(k);
/*  821 */     if (pos < 0 || !Objects.equals(oldValue, this.value[pos]))
/*  822 */       return false; 
...
/*  951 */       return Float2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public V getValue() {
/*  955 */       return Float2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public V setValue(V v) {
/*  959 */       V oldValue = Float2ObjectLinkedOpenHashMap.this.value[this.index];
/*  960 */       Float2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  961 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Float getKey() {
/*  971 */       return Float.valueOf(Float2ObjectLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */     
...
/*  979 */       return (Float.floatToIntBits(Float2ObjectLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && 
/*  980 */         Objects.equals(Float2ObjectLinkedOpenHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  984 */       return HashCommon.float2int(Float2ObjectLinkedOpenHashMap.this.key[this.index]) ^ (
/*  985 */         (Float2ObjectLinkedOpenHashMap.this.value[this.index] == null) ? 0 : Float2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     
/*      */     public String toString() {
/*  989 */       return Float2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Float2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1152 */       this.next = Float2ObjectLinkedOpenHashMap.this.first;
/* 1153 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(float from) {
/* 1156 */       if (Float.floatToIntBits(from) == 0) {
/* 1157 */         if (Float2ObjectLinkedOpenHashMap.this.containsNullKey) {
/* 1158 */           this.next = (int)Float2ObjectLinkedOpenHashMap.this.link[Float2ObjectLinkedOpenHashMap.this.n];
/* 1159 */           this.prev = Float2ObjectLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1162 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1164 */       if (Float.floatToIntBits(Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.last]) == Float.floatToIntBits(from)) {
/* 1165 */         this.prev = Float2ObjectLinkedOpenHashMap.this.last;
/* 1166 */         this.index = Float2ObjectLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1170 */       int pos = HashCommon.mix(HashCommon.float2int(from)) & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */       
/* 1172 */       while (Float.floatToIntBits(Float2ObjectLinkedOpenHashMap.this.key[pos]) != 0) {
/* 1173 */         if (Float.floatToIntBits(Float2ObjectLinkedOpenHashMap.this.key[pos]) == Float.floatToIntBits(from)) {
/*      */           
/* 1175 */           this.next = (int)Float2ObjectLinkedOpenHashMap.this.link[pos];
/* 1176 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1179 */         pos = pos + 1 & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1196 */       if (this.next == -1) {
/* 1197 */         this.index = Float2ObjectLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1200 */       int pos = Float2ObjectLinkedOpenHashMap.this.first;
/* 1201 */       this.index = 1;
/* 1202 */       while (pos != this.prev) {
/* 1203 */         pos = (int)Float2ObjectLinkedOpenHashMap.this.link[pos];
/* 1204 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1219 */       this.next = (int)Float2ObjectLinkedOpenHashMap.this.link[this.curr];
...
/* 1229 */       this.prev = (int)(Float2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1244 */         this.index--;
/* 1245 */         this.prev = (int)(Float2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1247 */         this.next = (int)Float2ObjectLinkedOpenHashMap.this.link[this.curr];
/* 1248 */       }  Float2ObjectLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1253 */       if (this.prev == -1) {
/* 1254 */         Float2ObjectLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1256 */         Float2ObjectLinkedOpenHashMap.this.link[this.prev] = Float2ObjectLinkedOpenHashMap.this.link[this.prev] ^ (Float2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1257 */       }  if (this.next == -1) {
/* 1258 */         Float2ObjectLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1260 */         Float2ObjectLinkedOpenHashMap.this.link[this.next] = Float2ObjectLinkedOpenHashMap.this.link[this.next] ^ (Float2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1261 */       }  int pos = this.curr;
/* 1262 */       this.curr = -1;
/* 1263 */       if (pos == Float2ObjectLinkedOpenHashMap.this.n) {
/* 1264 */         Float2ObjectLinkedOpenHashMap.this.containsNullKey = false;
/* 1265 */         Float2ObjectLinkedOpenHashMap.this.value[Float2ObjectLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1268 */         float[] key = Float2ObjectLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           float curr;
/*      */           int last;
/* 1272 */           pos = (last = pos) + 1 & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1274 */             if (Float.floatToIntBits(curr = key[pos]) == 0) {
/* 1275 */               key[last] = 0.0F;
/* 1276 */               Float2ObjectLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1279 */             int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */             
/* 1281 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1283 */             pos = pos + 1 & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1285 */           key[last] = curr;
/* 1286 */           Float2ObjectLinkedOpenHashMap.this.value[last] = Float2ObjectLinkedOpenHashMap.this.value[pos];
/* 1287 */           if (this.next == pos)
/* 1288 */             this.next = last; 
/* 1289 */           if (this.prev == pos)
/* 1290 */             this.prev = last; 
/* 1291 */           Float2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Float2ObjectMap.Entry<V>> { private Float2ObjectLinkedOpenHashMap<V>.MapEntry entry;
/*      */     
...
/* 1323 */       return this.entry = new Float2ObjectLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Float2ObjectLinkedOpenHashMap<V>.MapEntry previous() {
/* 1327 */       return this.entry = new Float2ObjectLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1331 */       super.remove();
...
/*      */ 
/*      */   
/* 1336 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Float2ObjectMap.Entry<V>> { final Float2ObjectLinkedOpenHashMap<V>.MapEntry entry = new Float2ObjectLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Float2ObjectMap.Entry<V>> implements Float2ObjectSortedMap.FastSortedEntrySet<V> { private MapEntrySet() {}
/*      */     
/*      */     public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator() {
/* 1358 */       return (ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>>)new Float2ObjectLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     
...
/* 1379 */       if (Float2ObjectLinkedOpenHashMap.this.size == 0)
/* 1380 */         throw new NoSuchElementException(); 
/* 1381 */       return new Float2ObjectLinkedOpenHashMap.MapEntry(Float2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Float2ObjectMap.Entry<V> last() {
/* 1385 */       if (Float2ObjectLinkedOpenHashMap.this.size == 0)
/* 1386 */         throw new NoSuchElementException(); 
/* 1387 */       return new Float2ObjectLinkedOpenHashMap.MapEntry(Float2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1400 */         return (Float2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Float2ObjectLinkedOpenHashMap.this.value[Float2ObjectLinkedOpenHashMap.this.n], v));
/*      */       }
/* 1402 */       float[] key = Float2ObjectLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1405 */       if (Float.floatToIntBits(
/* 1406 */           curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2ObjectLinkedOpenHashMap.this.mask]) == 0)
/*      */       {
/* 1408 */         return false; } 
/* 1409 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) {
/* 1410 */         return Objects.equals(Float2ObjectLinkedOpenHashMap.this.value[pos], v);
/*      */       }
/*      */       while (true) {
/* 1413 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ObjectLinkedOpenHashMap.this.mask]) == 0)
/* 1414 */           return false; 
/* 1415 */         if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) {
/* 1416 */           return Objects.equals(Float2ObjectLinkedOpenHashMap.this.value[pos], v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1430 */         if (Float2ObjectLinkedOpenHashMap.this.containsNullKey && Objects.equals(Float2ObjectLinkedOpenHashMap.this.value[Float2ObjectLinkedOpenHashMap.this.n], v)) {
/* 1431 */           Float2ObjectLinkedOpenHashMap.this.removeNullEntry();
/* 1432 */           return true;
/*      */         } 
/* 1434 */         return false;
/*      */       } 
/*      */       
/* 1437 */       float[] key = Float2ObjectLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1440 */       if (Float.floatToIntBits(
/* 1441 */           curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2ObjectLinkedOpenHashMap.this.mask]) == 0)
/*      */       {
/* 1443 */         return false; } 
/* 1444 */       if (Float.floatToIntBits(curr) == Float.floatToIntBits(k)) {
/* 1445 */         if (Objects.equals(Float2ObjectLinkedOpenHashMap.this.value[pos], v)) {
/* 1446 */           Float2ObjectLinkedOpenHashMap.this.removeEntry(pos);
/* 1447 */           return true;
/*      */         } 
/* 1449 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1452 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ObjectLinkedOpenHashMap.this.mask]) == 0)
/* 1453 */           return false; 
/* 1454 */         if (Float.floatToIntBits(curr) == Float.floatToIntBits(k) && 
/* 1455 */           Objects.equals(Float2ObjectLinkedOpenHashMap.this.value[pos], v)) {
/* 1456 */           Float2ObjectLinkedOpenHashMap.this.removeEntry(pos);
/* 1457 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1464 */       return Float2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1468 */       Float2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1483 */       return new Float2ObjectLinkedOpenHashMap.EntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1494 */       return new Float2ObjectLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1509 */       return new Float2ObjectLinkedOpenHashMap.FastEntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
/* 1514 */       for (int i = Float2ObjectLinkedOpenHashMap.this.size, next = Float2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1515 */         int curr = next;
/* 1516 */         next = (int)Float2ObjectLinkedOpenHashMap.this.link[curr];
/* 1517 */         consumer.accept(new AbstractFloat2ObjectMap.BasicEntry<>(Float2ObjectLinkedOpenHashMap.this.key[curr], Float2ObjectLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
/* 1523 */       AbstractFloat2ObjectMap.BasicEntry<V> entry = new AbstractFloat2ObjectMap.BasicEntry<>();
/* 1524 */       for (int i = Float2ObjectLinkedOpenHashMap.this.size, next = Float2ObjectLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1525 */         int curr = next;
/* 1526 */         next = (int)Float2ObjectLinkedOpenHashMap.this.link[curr];
/* 1527 */         entry.key = Float2ObjectLinkedOpenHashMap.this.key[curr];
/* 1528 */         entry.value = Float2ObjectLinkedOpenHashMap.this.value[curr];
...
/* 1554 */       return Float2ObjectLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
...
/* 1561 */       return Float2ObjectLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractFloatSortedSet { private KeySet() {}
/*      */     
/*      */     public FloatListIterator iterator(float from) {
/* 1567 */       return new Float2ObjectLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public FloatListIterator iterator() {
/* 1571 */       return new Float2ObjectLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(DoubleConsumer consumer) {
/* 1576 */       if (Float2ObjectLinkedOpenHashMap.this.containsNullKey)
/* 1577 */         consumer.accept(Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.n]); 
/* 1578 */       for (int pos = Float2ObjectLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1579 */         float k = Float2ObjectLinkedOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1586 */       return Float2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(float k) {
/* 1590 */       return Float2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(float k) {
/* 1594 */       int oldSize = Float2ObjectLinkedOpenHashMap.this.size;
/* 1595 */       Float2ObjectLinkedOpenHashMap.this.remove(k);
/* 1596 */       return (Float2ObjectLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1600 */       Float2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public float firstFloat() {
/* 1604 */       if (Float2ObjectLinkedOpenHashMap.this.size == 0)
/* 1605 */         throw new NoSuchElementException(); 
/* 1606 */       return Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public float lastFloat() {
/* 1610 */       if (Float2ObjectLinkedOpenHashMap.this.size == 0)
/* 1611 */         throw new NoSuchElementException(); 
/* 1612 */       return Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public FloatComparator comparator() {
/* 1616 */       return null;
...
/*      */   {
/*      */     public V previous() {
/* 1649 */       return Float2ObjectLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*      */     public V next() {
/* 1656 */       return Float2ObjectLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1665 */             return (ObjectIterator<V>)new Float2ObjectLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1669 */             return Float2ObjectLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(Object v) {
/* 1673 */             return Float2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1677 */             Float2ObjectLinkedOpenHashMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1682 */             if (Float2ObjectLinkedOpenHashMap.this.containsNullKey)
/* 1683 */               consumer.accept(Float2ObjectLinkedOpenHashMap.this.value[Float2ObjectLinkedOpenHashMap.this.n]); 
/* 1684 */             for (int pos = Float2ObjectLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1685 */               if (Float.floatToIntBits(Float2ObjectLinkedOpenHashMap.this.key[pos]) != 0)
/* 1686 */                 consumer.accept(Float2ObjectLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */   
/*      */   public boolean trim() {
/* 1706 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1707 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1708 */       return true; 
/*      */     try {
/* 1710 */       rehash(l);
/* 1711 */     } catch (OutOfMemoryError cantDoIt) {
/* 1712 */       return false;
/*      */     } 
/* 1714 */     return true;
/*      */   }
...
/* 1738 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1739 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1740 */       return true; 
/*      */     try {
/* 1742 */       rehash(l);
/* 1743 */     } catch (OutOfMemoryError cantDoIt) {
/* 1744 */       return false;
/*      */     } 
/* 1746 */     return true;
/*      */   }
...
/* 1762 */     float[] key = this.key;
/* 1763 */     V[] value = this.value;
/* 1764 */     int mask = newN - 1;
/* 1765 */     float[] newKey = new float[newN + 1];
/* 1766 */     V[] newValue = (V[])new Object[newN + 1];
/* 1767 */     int i = this.first, prev = -1, newPrev = -1;
/* 1768 */     long[] link = this.link;
/* 1769 */     long[] newLink = new long[newN + 1];
/* 1770 */     this.first = -1;
/* 1771 */     for (int j = this.size; j-- != 0; ) {
/* 1772 */       int pos; if (Float.floatToIntBits(key[i]) == 0) {
/* 1773 */         pos = newN;
/*      */       } else {
/* 1775 */         pos = HashCommon.mix(HashCommon.float2int(key[i])) & mask;
/* 1776 */         while (Float.floatToIntBits(newKey[pos]) != 0)
/* 1777 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1779 */       newKey[pos] = key[i];
/* 1780 */       newValue[pos] = value[i];
/* 1781 */       if (prev != -1) {
/* 1782 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1783 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1784 */         newPrev = pos;
/*      */       } else {
/* 1786 */         newPrev = this.first = pos;
/*      */         
/* 1788 */         newLink[pos] = -1L;
/*      */       } 
/* 1790 */       int t = i;
...
/* 1792 */       prev = t;
/*      */     } 
/* 1794 */     this.link = newLink;
/* 1795 */     this.last = newPrev;
/* 1796 */     if (newPrev != -1)
/*      */     {
/* 1798 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1799 */     this.n = newN;
/* 1800 */     this.mask = mask;
/* 1801 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1802 */     this.key = newKey;
/* 1803 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1820 */       c = (Float2ObjectLinkedOpenHashMap<V>)super.clone();
/* 1821 */     } catch (CloneNotSupportedException cantHappen) {
/* 1822 */       throw new InternalError();
/*      */     } 
/* 1824 */     c.keys = null;
/* 1825 */     c.values = null;
/* 1826 */     c.entries = null;
/* 1827 */     c.containsNullKey = this.containsNullKey;
/* 1828 */     c.key = (float[])this.key.clone();
/* 1829 */     c.value = (V[])this.value.clone();
/* 1830 */     c.link = (long[])this.link.clone();
/* 1831 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1844 */     int h = 0;
/* 1845 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1846 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1847 */         i++; 
/* 1848 */       t = HashCommon.float2int(this.key[i]);
/* 1849 */       if (this != this.value[i])
/* 1850 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1851 */       h += t;
/* 1852 */       i++;
/*      */     } 
/*      */     
/* 1855 */     if (this.containsNullKey)
/* 1856 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1857 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1860 */     float[] key = this.key;
/* 1861 */     V[] value = this.value;
/* 1862 */     MapIterator i = new MapIterator();
/* 1863 */     s.defaultWriteObject();
/* 1864 */     for (int j = this.size; j-- != 0; ) {
/* 1865 */       int e = i.nextEntry();
/* 1866 */       s.writeFloat(key[e]);
/* 1867 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1872 */     s.defaultReadObject();
/* 1873 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1874 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1875 */     this.mask = this.n - 1;
/* 1876 */     float[] key = this.key = new float[this.n + 1];
/* 1877 */     V[] value = this.value = (V[])new Object[this.n + 1];
/* 1878 */     long[] link = this.link = new long[this.n + 1];
/* 1879 */     int prev = -1;
/* 1880 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1883 */     for (int i = this.size; i-- != 0; ) {
/* 1884 */       int pos; float k = s.readFloat();
/* 1885 */       V v = (V)s.readObject();
/* 1886 */       if (Float.floatToIntBits(k) == 0) {
/* 1887 */         pos = this.n;
/* 1888 */         this.containsNullKey = true;
/*      */       } else {
/* 1890 */         pos = HashCommon.mix(HashCommon.float2int(k)) & this.mask;
/* 1891 */         while (Float.floatToIntBits(key[pos]) != 0)
/* 1892 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1894 */       key[pos] = k;
/* 1895 */       value[pos] = v;
/* 1896 */       if (this.first != -1) {
/* 1897 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1898 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1899 */         prev = pos; continue;
/*      */       } 
/* 1901 */       prev = this.first = pos;
/*      */       
/* 1903 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1906 */     this.last = prev;
/* 1907 */     if (prev != -1)
/*      */     {
/* 1909 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2ObjectLinkedOpenHashMap.class
