...
/*  74 */     this(refArray, capacity, (FloatComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  97 */     this(refArray, refArray.length, (FloatComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 175 */     float first = this.refArray[this.array[firstIndex]];
/* 176 */     if (this.c == null) {
/* 177 */       while (i-- != 0) {
/* 178 */         if (Float.compare(this.refArray[this.array[i]], first) < 0)
...
/* 191 */     int i = this.size;
/* 192 */     int lastIndex = --i;
/* 193 */     float last = this.refArray[this.array[lastIndex]];
/* 194 */     if (this.c == null)
/* 195 */     { while (i-- != 0) {
/* 196 */         if (Float.compare(last, this.refArray[this.array[i]]) < 0)
...
/* 240 */     { if (this.c == null) {
/* 241 */         if (Float.compare(this.refArray[x], this.refArray[this.array[this.firstIndex]]) < 0)
...
/* 318 */     float top = this.refArray[this.array[findFirst()]];
/* 319 */     int i = this.size, c = 0;
/* 320 */     while (i-- != 0) {
/* 321 */       if (Float.floatToIntBits(top) == Float.floatToIntBits(this.refArray[this.array[i]]))
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\FloatArrayIndirectPriorityQueue.class
