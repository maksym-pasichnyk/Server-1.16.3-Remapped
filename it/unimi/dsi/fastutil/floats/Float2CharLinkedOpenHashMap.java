...
/*      */   
/*      */   public boolean trim() {
/* 1734 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1735 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1736 */       return true; 
/*      */     try {
/* 1738 */       rehash(l);
/* 1739 */     } catch (OutOfMemoryError cantDoIt) {
/* 1740 */       return false;
/*      */     } 
/* 1742 */     return true;
/*      */   }
...
/* 1767 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1768 */       return true; 
/*      */     try {
/* 1770 */       rehash(l);
...
/* 1790 */     float[] key = this.key;
/* 1791 */     char[] value = this.value;
/* 1792 */     int mask = newN - 1;
/* 1793 */     float[] newKey = new float[newN + 1];
/* 1794 */     char[] newValue = new char[newN + 1];
...
/* 1800 */       int pos; if (Float.floatToIntBits(key[i]) == 0) {
/* 1801 */         pos = newN;
/*      */       } else {
/* 1803 */         pos = HashCommon.mix(HashCommon.float2int(key[i])) & mask;
/* 1804 */         while (Float.floatToIntBits(newKey[pos]) != 0)
/* 1805 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1848 */       c = (Float2CharLinkedOpenHashMap)super.clone();
...
/* 1856 */     c.key = (float[])this.key.clone();
/* 1857 */     c.value = (char[])this.value.clone();
...
/* 1874 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1875 */         i++; 
/* 1876 */       t = HashCommon.float2int(this.key[i]);
/* 1877 */       t ^= this.value[i];
/* 1878 */       h += t;
/* 1879 */       i++;
/*      */     } 
/*      */     
/* 1882 */     if (this.containsNullKey)
/* 1883 */       h += this.value[this.n]; 
/* 1884 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1887 */     float[] key = this.key;
/* 1888 */     char[] value = this.value;
/* 1889 */     MapIterator i = new MapIterator();
/* 1890 */     s.defaultWriteObject();
/* 1891 */     for (int j = this.size; j-- != 0; ) {
/* 1892 */       int e = i.nextEntry();
/* 1893 */       s.writeFloat(key[e]);
/* 1894 */       s.writeChar(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1899 */     s.defaultReadObject();
/* 1900 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1901 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1902 */     this.mask = this.n - 1;
/* 1903 */     float[] key = this.key = new float[this.n + 1];
/* 1904 */     char[] value = this.value = new char[this.n + 1];
/* 1905 */     long[] link = this.link = new long[this.n + 1];
/* 1906 */     int prev = -1;
/* 1907 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1910 */     for (int i = this.size; i-- != 0; ) {
/* 1911 */       int pos; float k = s.readFloat();
/* 1912 */       char v = s.readChar();
/* 1913 */       if (Float.floatToIntBits(k) == 0) {
/* 1914 */         pos = this.n;
/* 1915 */         this.containsNullKey = true;
/*      */       } else {
/* 1917 */         pos = HashCommon.mix(HashCommon.float2int(k)) & this.mask;
/* 1918 */         while (Float.floatToIntBits(key[pos]) != 0)
/* 1919 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1921 */       key[pos] = k;
/* 1922 */       value[pos] = v;
/* 1923 */       if (this.first != -1) {
/* 1924 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1925 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1926 */         prev = pos; continue;
/*      */       } 
/* 1928 */       prev = this.first = pos;
/*      */       
/* 1930 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1933 */     this.last = prev;
/* 1934 */     if (prev != -1)
/*      */     {
/* 1936 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2CharLinkedOpenHashMap.class
