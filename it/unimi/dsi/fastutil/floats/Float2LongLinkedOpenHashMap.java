...
/* 1850 */     long[] value = this.value;
/* 1851 */     int mask = newN - 1;
/* 1852 */     float[] newKey = new float[newN + 1];
/* 1853 */     long[] newValue = new long[newN + 1];
...
/*      */     try {
/* 1907 */       c = (Float2LongLinkedOpenHashMap)super.clone();
...
/* 1916 */     c.value = (long[])this.value.clone();
...
/* 1936 */       t ^= HashCommon.long2int(this.value[i]);
/* 1937 */       h += t;
/* 1938 */       i++;
/*      */     } 
/*      */     
/* 1941 */     if (this.containsNullKey)
/* 1942 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1943 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1946 */     float[] key = this.key;
/* 1947 */     long[] value = this.value;
...
/* 1963 */     long[] value = this.value = new long[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2LongLinkedOpenHashMap.class
