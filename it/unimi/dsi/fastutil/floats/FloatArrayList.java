...
/*  78 */     if (capacity == 0) {
/*  79 */       this.a = FloatArrays.EMPTY_ARRAY;
/*     */     } else {
/*  81 */       this.a = new float[capacity];
/*     */     } 
/*     */   }
/*     */   
/*     */   public FloatArrayList() {
/*  86 */     this.a = FloatArrays.DEFAULT_EMPTY_ARRAY;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  95 */     this(c.size());
/*  96 */     this.size = FloatIterators.unwrap(FloatIterators.asFloatIterator(c.iterator()), this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */     this(c.size());
/* 107 */     this.size = FloatIterators.unwrap(c.iterator(), this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 151 */     this();
/* 152 */     while (i.hasNext()) {
/* 153 */       add(((Float)i.next()).floatValue());
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 194 */     FloatArrayList l = new FloatArrayList(a, false);
/* 195 */     l.size = length;
/* 196 */     return l;
/*     */   }
/*     */ 
...
/* 222 */     if (capacity <= this.a.length || this.a == FloatArrays.DEFAULT_EMPTY_ARRAY)
/*     */       return; 
/* 224 */     this.a = FloatArrays.ensureCapacity(this.a, capacity, this.size);
...
/* 274 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(this.a[i]))
/* 275 */         return i; 
/* 276 */     }  return -1;
/*     */   }
/*     */   
...
/* 281 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(this.a[i]))
/* 282 */         return i; 
/* 283 */     }  return -1;
/*     */   }
/*     */   
...
/* 329 */       Arrays.fill(this.a, this.size, size, 0.0F); 
/* 330 */     this.size = size;
/*     */   }
/*     */   
...
/*     */       return; 
/* 365 */     float[] t = new float[Math.max(n, this.size)];
...
/* 386 */     FloatArrays.ensureOffsetLength(a, offset, length);
...
/* 418 */     FloatArrays.ensureOffsetLength(a, offset, length);
...
/* 440 */     FloatIterator i = c.iterator();
/* 441 */     this.size += n;
/* 442 */     while (n-- != 0)
/* 443 */       this.a[index++] = i.nextFloat(); 
...
/* 477 */       if (!c.contains(Float.valueOf(a[i])))
/* 478 */         a[j++] = a[i]; 
...
/* 486 */     return new FloatListIterator() {
/* 487 */         int pos = index; int last = -1;
/*     */         
/*     */         public boolean hasNext() {
/* 490 */           return (this.pos < FloatArrayList.this.size);
/*     */         }
/*     */         
...
/* 500 */           return FloatArrayList.this.a[this.last = this.pos++];
/*     */         }
/*     */         
/*     */         public float previousFloat() {
/* 504 */           if (!hasPrevious())
/* 505 */             throw new NoSuchElementException(); 
/* 506 */           return FloatArrayList.this.a[this.last = --this.pos];
/*     */         }
/*     */         
...
/* 518 */           FloatArrayList.this.add(this.pos++, k);
/* 519 */           this.last = -1;
/*     */         }
/*     */         
...
/* 525 */           FloatArrayList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 529 */           if (this.last == -1)
/* 530 */             throw new IllegalStateException(); 
/* 531 */           FloatArrayList.this.removeFloat(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 544 */     FloatArrayList c = new FloatArrayList(this.size);
...
/* 589 */     float[] a1 = this.a, a2 = l.a;
/*     */     
/*     */     int i;
/* 592 */     for (i = 0; i < s1 && i < s2; i++) {
/* 593 */       float e1 = a1[i];
/* 594 */       float e2 = a2[i]; int r;
/* 595 */       if ((r = Float.compare(e1, e2)) != 0)
/* 596 */         return r; 
/*     */     } 
...
/* 603 */       s.writeFloat(this.a[i]); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 607 */     s.defaultReadObject();
/* 608 */     this.a = new float[this.size];
/* 609 */     for (int i = 0; i < this.size; i++)
/* 610 */       this.a[i] = s.readFloat(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\FloatArrayList.class
