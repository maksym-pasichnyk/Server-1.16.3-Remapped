...
/*      */     try {
/* 1820 */       c = (Float2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* 1850 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1851 */       h += t;
/* 1852 */       i++;
/*      */     } 
/*      */     
/* 1855 */     if (this.containsNullKey)
/* 1856 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1857 */     return h;
/*      */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2ReferenceLinkedOpenHashMap.class
