...
/*  925 */     Integer newValue = remappingFunction.apply(Float.valueOf(k), Integer.valueOf(this.value[pos]));
...
/*  940 */     int pos = find(k);
/*  941 */     Integer newValue = remappingFunction.apply(Float.valueOf(k), 
/*  942 */         (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
/*  943 */     if (newValue == null) {
/*  944 */       if (pos >= 0)
/*  945 */         if (Float.floatToIntBits(k) == 0) {
/*  946 */           removeNullEntry();
/*      */         } else {
/*  948 */           removeEntry(pos);
/*      */         }  
...
/*  971 */       if (Float.floatToIntBits(k) == 0) {
/*  972 */         removeNullEntry();
/*      */       } else {
/*  974 */         removeEntry(pos);
...
/* 1019 */       return Float2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public int getIntValue() {
/* 1023 */       return Float2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public int setValue(int v) {
/* 1027 */       int oldValue = Float2IntLinkedOpenHashMap.this.value[this.index];
/* 1028 */       Float2IntLinkedOpenHashMap.this.value[this.index] = v;
...
/*      */     @Deprecated
/*      */     public Float getKey() {
/* 1039 */       return Float.valueOf(Float2IntLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1049 */       return Integer.valueOf(Float2IntLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1065 */         return false; 
/* 1066 */       Map.Entry<Float, Integer> e = (Map.Entry<Float, Integer>)o;
/* 1067 */       return (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)e
/* 1068 */         .getValue()).intValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1072 */       return HashCommon.float2int(Float2IntLinkedOpenHashMap.this.key[this.index]) ^ Float2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1076 */       return Float2IntLinkedOpenHashMap.this.key[this.index] + "=>" + Float2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1239 */       this.next = Float2IntLinkedOpenHashMap.this.first;
/* 1240 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(float from) {
/* 1243 */       if (Float.floatToIntBits(from) == 0) {
/* 1244 */         if (Float2IntLinkedOpenHashMap.this.containsNullKey) {
/* 1245 */           this.next = (int)Float2IntLinkedOpenHashMap.this.link[Float2IntLinkedOpenHashMap.this.n];
/* 1246 */           this.prev = Float2IntLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1249 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1251 */       if (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.last]) == Float.floatToIntBits(from)) {
/* 1252 */         this.prev = Float2IntLinkedOpenHashMap.this.last;
/* 1253 */         this.index = Float2IntLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1257 */       int pos = HashCommon.mix(HashCommon.float2int(from)) & Float2IntLinkedOpenHashMap.this.mask;
/*      */       
/* 1259 */       while (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[pos]) != 0) {
/* 1260 */         if (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[pos]) == Float.floatToIntBits(from)) {
/*      */           
/* 1262 */           this.next = (int)Float2IntLinkedOpenHashMap.this.link[pos];
/* 1263 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1266 */         pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1283 */       if (this.next == -1) {
/* 1284 */         this.index = Float2IntLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1287 */       int pos = Float2IntLinkedOpenHashMap.this.first;
/* 1288 */       this.index = 1;
/* 1289 */       while (pos != this.prev) {
/* 1290 */         pos = (int)Float2IntLinkedOpenHashMap.this.link[pos];
/* 1291 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1306 */       this.next = (int)Float2IntLinkedOpenHashMap.this.link[this.curr];
...
/* 1316 */       this.prev = (int)(Float2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1331 */         this.index--;
/* 1332 */         this.prev = (int)(Float2IntLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1334 */         this.next = (int)Float2IntLinkedOpenHashMap.this.link[this.curr];
/* 1335 */       }  Float2IntLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1340 */       if (this.prev == -1) {
/* 1341 */         Float2IntLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1343 */         Float2IntLinkedOpenHashMap.this.link[this.prev] = Float2IntLinkedOpenHashMap.this.link[this.prev] ^ (Float2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1344 */       }  if (this.next == -1) {
/* 1345 */         Float2IntLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1347 */         Float2IntLinkedOpenHashMap.this.link[this.next] = Float2IntLinkedOpenHashMap.this.link[this.next] ^ (Float2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1348 */       }  int pos = this.curr;
/* 1349 */       this.curr = -1;
/* 1350 */       if (pos == Float2IntLinkedOpenHashMap.this.n) {
/* 1351 */         Float2IntLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1354 */         float[] key = Float2IntLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           float curr;
/*      */           int last;
/* 1358 */           pos = (last = pos) + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1360 */             if (Float.floatToIntBits(curr = key[pos]) == 0) {
/* 1361 */               key[last] = 0.0F;
/*      */               return;
/*      */             } 
/* 1364 */             int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2IntLinkedOpenHashMap.this.mask;
/*      */             
/* 1366 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1368 */             pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1370 */           key[last] = curr;
/* 1371 */           Float2IntLinkedOpenHashMap.this.value[last] = Float2IntLinkedOpenHashMap.this.value[pos];
/* 1372 */           if (this.next == pos)
/* 1373 */             this.next = last; 
/* 1374 */           if (this.prev == pos)
/* 1375 */             this.prev = last; 
/* 1376 */           Float2IntLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Float2IntMap.Entry> { private Float2IntLinkedOpenHashMap.MapEntry entry;
/*      */     
...
/* 1408 */       return this.entry = new Float2IntLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Float2IntLinkedOpenHashMap.MapEntry previous() {
/* 1412 */       return this.entry = new Float2IntLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1416 */       super.remove();
...
/*      */ 
/*      */   
/* 1421 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Float2IntMap.Entry> { final Float2IntLinkedOpenHashMap.MapEntry entry = new Float2IntLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Float2IntMap.Entry> implements Float2IntSortedMap.FastSortedEntrySet { public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator() {
/* 1441 */       return (ObjectBidirectionalIterator<Float2IntMap.Entry>)new Float2IntLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     private MapEntrySet() {}
...
/* 1462 */       if (Float2IntLinkedOpenHashMap.this.size == 0)
/* 1463 */         throw new NoSuchElementException(); 
/* 1464 */       return new Float2IntLinkedOpenHashMap.MapEntry(Float2IntLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Float2IntMap.Entry last() {
/* 1468 */       if (Float2IntLinkedOpenHashMap.this.size == 0)
/* 1469 */         throw new NoSuchElementException(); 
/* 1470 */       return new Float2IntLinkedOpenHashMap.MapEntry(Float2IntLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1479 */         return false; 
/* 1480 */       if (e.getValue() == null || !(e.getValue() instanceof Integer))
/* 1481 */         return false; 
/* 1482 */       float k = ((Float)e.getKey()).floatValue();
/* 1483 */       int v = ((Integer)e.getValue()).intValue();
/* 1484 */       if (Float.floatToIntBits(k) == 0) {
/* 1485 */         return (Float2IntLinkedOpenHashMap.this.containsNullKey && Float2IntLinkedOpenHashMap.this.value[Float2IntLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1487 */       float[] key = Float2IntLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1490 */       if (Float.floatToIntBits(
/* 1491 */           curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2IntLinkedOpenHashMap.this.mask]) == 0)
/*      */       {
/* 1493 */         return false; } 
/* 1494 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) {
/* 1495 */         return (Float2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1498 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask]) == 0)
/* 1499 */           return false; 
/* 1500 */         if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) {
/* 1501 */           return (Float2IntLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1511 */         return false; 
/* 1512 */       if (e.getValue() == null || !(e.getValue() instanceof Integer))
/* 1513 */         return false; 
/* 1514 */       float k = ((Float)e.getKey()).floatValue();
/* 1515 */       int v = ((Integer)e.getValue()).intValue();
/* 1516 */       if (Float.floatToIntBits(k) == 0) {
/* 1517 */         if (Float2IntLinkedOpenHashMap.this.containsNullKey && Float2IntLinkedOpenHashMap.this.value[Float2IntLinkedOpenHashMap.this.n] == v) {
/* 1518 */           Float2IntLinkedOpenHashMap.this.removeNullEntry();
/* 1519 */           return true;
/*      */         } 
/* 1521 */         return false;
/*      */       } 
/*      */       
/* 1524 */       float[] key = Float2IntLinkedOpenHashMap.this.key;
/*      */       float curr;
/*      */       int pos;
/* 1527 */       if (Float.floatToIntBits(
/* 1528 */           curr = key[pos = HashCommon.mix(HashCommon.float2int(k)) & Float2IntLinkedOpenHashMap.this.mask]) == 0)
/*      */       {
/* 1530 */         return false; } 
/* 1531 */       if (Float.floatToIntBits(curr) == Float.floatToIntBits(k)) {
/* 1532 */         if (Float2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1533 */           Float2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1534 */           return true;
/*      */         } 
/* 1536 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1539 */         if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask]) == 0)
/* 1540 */           return false; 
/* 1541 */         if (Float.floatToIntBits(curr) == Float.floatToIntBits(k) && 
/* 1542 */           Float2IntLinkedOpenHashMap.this.value[pos] == v) {
/* 1543 */           Float2IntLinkedOpenHashMap.this.removeEntry(pos);
/* 1544 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1551 */       return Float2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1555 */       Float2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1570 */       return new Float2IntLinkedOpenHashMap.EntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1581 */       return new Float2IntLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1596 */       return new Float2IntLinkedOpenHashMap.FastEntryIterator(from.getFloatKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Float2IntMap.Entry> consumer) {
/* 1601 */       for (int i = Float2IntLinkedOpenHashMap.this.size, next = Float2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1602 */         int curr = next;
/* 1603 */         next = (int)Float2IntLinkedOpenHashMap.this.link[curr];
/* 1604 */         consumer.accept(new AbstractFloat2IntMap.BasicEntry(Float2IntLinkedOpenHashMap.this.key[curr], Float2IntLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Float2IntMap.Entry> consumer) {
/* 1610 */       AbstractFloat2IntMap.BasicEntry entry = new AbstractFloat2IntMap.BasicEntry();
/* 1611 */       for (int i = Float2IntLinkedOpenHashMap.this.size, next = Float2IntLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1612 */         int curr = next;
/* 1613 */         next = (int)Float2IntLinkedOpenHashMap.this.link[curr];
/* 1614 */         entry.key = Float2IntLinkedOpenHashMap.this.key[curr];
/* 1615 */         entry.value = Float2IntLinkedOpenHashMap.this.value[curr];
...
/* 1641 */       return Float2IntLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
...
/* 1648 */       return Float2IntLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractFloatSortedSet { private KeySet() {}
/*      */     
/*      */     public FloatListIterator iterator(float from) {
/* 1654 */       return new Float2IntLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
...
/* 1663 */       if (Float2IntLinkedOpenHashMap.this.containsNullKey)
/* 1664 */         consumer.accept(Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.n]); 
/* 1665 */       for (int pos = Float2IntLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1666 */         float k = Float2IntLinkedOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1673 */       return Float2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(float k) {
/* 1677 */       return Float2IntLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(float k) {
/* 1681 */       int oldSize = Float2IntLinkedOpenHashMap.this.size;
/* 1682 */       Float2IntLinkedOpenHashMap.this.remove(k);
/* 1683 */       return (Float2IntLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1687 */       Float2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public float firstFloat() {
/* 1691 */       if (Float2IntLinkedOpenHashMap.this.size == 0)
/* 1692 */         throw new NoSuchElementException(); 
/* 1693 */       return Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public float lastFloat() {
/* 1697 */       if (Float2IntLinkedOpenHashMap.this.size == 0)
/* 1698 */         throw new NoSuchElementException(); 
/* 1699 */       return Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public FloatComparator comparator() {
/* 1703 */       return null;
...
/* 1736 */       return Float2IntLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1743 */       return Float2IntLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public IntCollection values() {
/* 1748 */     if (this.values == null)
/* 1749 */       this.values = (IntCollection)new AbstractIntCollection()
/*      */         {
/*      */           public IntIterator iterator() {
/* 1752 */             return (IntIterator)new Float2IntLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1756 */             return Float2IntLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(int v) {
/* 1760 */             return Float2IntLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1764 */             Float2IntLinkedOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1769 */             if (Float2IntLinkedOpenHashMap.this.containsNullKey)
/* 1770 */               consumer.accept(Float2IntLinkedOpenHashMap.this.value[Float2IntLinkedOpenHashMap.this.n]); 
/* 1771 */             for (int pos = Float2IntLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1772 */               if (Float.floatToIntBits(Float2IntLinkedOpenHashMap.this.key[pos]) != 0)
/* 1773 */                 consumer.accept(Float2IntLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1849 */     float[] key = this.key;
/* 1850 */     int[] value = this.value;
/* 1851 */     int mask = newN - 1;
/* 1852 */     float[] newKey = new float[newN + 1];
/* 1853 */     int[] newValue = new int[newN + 1];
...
/* 1859 */       int pos; if (Float.floatToIntBits(key[i]) == 0) {
/* 1860 */         pos = newN;
/*      */       } else {
/* 1862 */         pos = HashCommon.mix(HashCommon.float2int(key[i])) & mask;
/* 1863 */         while (Float.floatToIntBits(newKey[pos]) != 0)
/* 1864 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1907 */       c = (Float2IntLinkedOpenHashMap)super.clone();
...
/* 1915 */     c.key = (float[])this.key.clone();
/* 1916 */     c.value = (int[])this.value.clone();
...
/* 1933 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1934 */         i++; 
/* 1935 */       t = HashCommon.float2int(this.key[i]);
/* 1936 */       t ^= this.value[i];
/* 1937 */       h += t;
/* 1938 */       i++;
/*      */     } 
...
/* 1962 */     float[] key = this.key = new float[this.n + 1];
/* 1963 */     int[] value = this.value = new int[this.n + 1];
...
/* 1970 */       int pos; float k = s.readFloat();
/* 1971 */       int v = s.readInt();
/* 1972 */       if (Float.floatToIntBits(k) == 0) {
/* 1973 */         pos = this.n;
/* 1974 */         this.containsNullKey = true;
/*      */       } else {
/* 1976 */         pos = HashCommon.mix(HashCommon.float2int(k)) & this.mask;
/* 1977 */         while (Float.floatToIntBits(key[pos]) != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2IntLinkedOpenHashMap.class
