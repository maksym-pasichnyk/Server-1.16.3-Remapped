...
/*      */   
/*      */   public boolean trim() {
/* 1798 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1799 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1800 */       return true; 
/*      */     try {
/* 1802 */       rehash(l);
/* 1803 */     } catch (OutOfMemoryError cantDoIt) {
/* 1804 */       return false;
/*      */     } 
/* 1806 */     return true;
/*      */   }
...
/* 1830 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1831 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1832 */       return true; 
/*      */     try {
/* 1834 */       rehash(l);
...
/* 1854 */     float[] key = this.key;
/* 1855 */     float[] value = this.value;
/* 1856 */     int mask = newN - 1;
/* 1857 */     float[] newKey = new float[newN + 1];
...
/* 1864 */       int pos; if (Float.floatToIntBits(key[i]) == 0) {
/* 1865 */         pos = newN;
/*      */       } else {
/* 1867 */         pos = HashCommon.mix(HashCommon.float2int(key[i])) & mask;
/* 1868 */         while (Float.floatToIntBits(newKey[pos]) != 0)
/* 1869 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1871 */       newKey[pos] = key[i];
/* 1872 */       newValue[pos] = value[i];
/* 1873 */       if (prev != -1) {
/* 1874 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1875 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1876 */         newPrev = pos;
/*      */       } else {
/* 1878 */         newPrev = this.first = pos;
/*      */         
/* 1880 */         newLink[pos] = -1L;
/*      */       } 
/* 1882 */       int t = i;
...
/* 1884 */       prev = t;
/*      */     } 
/* 1886 */     this.link = newLink;
/* 1887 */     this.last = newPrev;
/* 1888 */     if (newPrev != -1)
/*      */     {
/* 1890 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1891 */     this.n = newN;
/* 1892 */     this.mask = mask;
/* 1893 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1894 */     this.key = newKey;
/* 1895 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1912 */       c = (Float2FloatLinkedOpenHashMap)super.clone();
/* 1913 */     } catch (CloneNotSupportedException cantHappen) {
/* 1914 */       throw new InternalError();
/*      */     } 
/* 1916 */     c.keys = null;
/* 1917 */     c.values = null;
/* 1918 */     c.entries = null;
/* 1919 */     c.containsNullKey = this.containsNullKey;
/* 1920 */     c.key = (float[])this.key.clone();
/* 1921 */     c.value = (float[])this.value.clone();
/* 1922 */     c.link = (long[])this.link.clone();
/* 1923 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1936 */     int h = 0;
/* 1937 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1938 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1939 */         i++; 
/* 1940 */       t = HashCommon.float2int(this.key[i]);
/* 1941 */       t ^= HashCommon.float2int(this.value[i]);
/* 1942 */       h += t;
/* 1943 */       i++;
/*      */     } 
/*      */     
/* 1946 */     if (this.containsNullKey)
/* 1947 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1948 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1951 */     float[] key = this.key;
/* 1952 */     float[] value = this.value;
/* 1953 */     MapIterator i = new MapIterator();
/* 1954 */     s.defaultWriteObject();
/* 1955 */     for (int j = this.size; j-- != 0; ) {
/* 1956 */       int e = i.nextEntry();
/* 1957 */       s.writeFloat(key[e]);
/* 1958 */       s.writeFloat(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1963 */     s.defaultReadObject();
/* 1964 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1965 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1966 */     this.mask = this.n - 1;
/* 1967 */     float[] key = this.key = new float[this.n + 1];
/* 1968 */     float[] value = this.value = new float[this.n + 1];
/* 1969 */     long[] link = this.link = new long[this.n + 1];
/* 1970 */     int prev = -1;
/* 1971 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1974 */     for (int i = this.size; i-- != 0; ) {
/* 1975 */       int pos; float k = s.readFloat();
/* 1976 */       float v = s.readFloat();
/* 1977 */       if (Float.floatToIntBits(k) == 0) {
/* 1978 */         pos = this.n;
/* 1979 */         this.containsNullKey = true;
/*      */       } else {
/* 1981 */         pos = HashCommon.mix(HashCommon.float2int(k)) & this.mask;
/* 1982 */         while (Float.floatToIntBits(key[pos]) != 0)
/* 1983 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1985 */       key[pos] = k;
/* 1986 */       value[pos] = v;
/* 1987 */       if (this.first != -1) {
/* 1988 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1989 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1990 */         prev = pos; continue;
/*      */       } 
/* 1992 */       prev = this.first = pos;
/*      */       
/* 1994 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1997 */     this.last = prev;
/* 1998 */     if (prev != -1)
/*      */     {
/* 2000 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2FloatLinkedOpenHashMap.class
