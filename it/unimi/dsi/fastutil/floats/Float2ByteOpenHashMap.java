...
/* 1152 */     byte[] value = this.value;
/* 1153 */     int mask = newN - 1;
/* 1154 */     float[] newKey = new float[newN + 1];
/* 1155 */     byte[] newValue = new byte[newN + 1];
/* 1156 */     int i = this.n;
...
/*      */     try {
/* 1187 */       c = (Float2ByteOpenHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2ByteOpenHashMap.class
