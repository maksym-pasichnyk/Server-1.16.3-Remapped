...
/*  52 */     assert i < size;
/*  53 */     int e = heap[i];
/*  54 */     float E = refArray[e];
/*     */     
/*  56 */     if (c == null) {
/*  57 */       int child; while ((child = (i << 1) + 1) < size) {
/*  58 */         int t = heap[child];
/*  59 */         int right = child + 1;
/*  60 */         if (right < size && Float.compare(refArray[heap[right]], refArray[t]) < 0)
/*  61 */           t = heap[child = right]; 
/*  62 */         if (Float.compare(E, refArray[t]) <= 0)
/*     */           break; 
/*  64 */         heap[i] = t;
/*  65 */         inv[heap[i]] = i;
/*  66 */         i = child;
...
/* 107 */     assert i < size;
/* 108 */     int e = heap[i];
/* 109 */     float E = refArray[e];
/* 110 */     if (c == null) {
/* 111 */       while (i != 0) {
/* 112 */         int parent = i - 1 >>> 1;
/* 113 */         int t = heap[parent];
/* 114 */         if (Float.compare(refArray[t], E) <= 0)
/*     */           break; 
/* 116 */         heap[i] = t;
/* 117 */         inv[heap[i]] = i;
/* 118 */         i = parent;
...
/* 152 */     FloatArrays.ensureOffsetLength(refArray, offset, length);
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\FloatIndirectHeaps.class
