...
/*  954 */         return false; 
/*  955 */       Map.Entry<Float, Character> e = (Map.Entry<Float, Character>)o;
/*  956 */       return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && this.value == ((Character)e
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Float2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(float k) {
/* 1048 */       if ((this.next = Float2CharAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Float2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Float2CharAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Float2CharMap.Entry>)new AbstractObjectSortedSet<Float2CharMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharAVLTreeMap.EntryIterator(from.getFloatKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1174 */               return false; 
/* 1175 */             Float2CharAVLTreeMap.Entry f = Float2CharAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1187 */               return false; 
/* 1188 */             Float2CharAVLTreeMap.Entry f = Float2CharAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1189 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1190 */               return false; 
/* 1191 */             Float2CharAVLTreeMap.this.remove(f.key);
/* 1192 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1196 */             return Float2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1200 */             Float2CharAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Float2CharMap.Entry first() {
/* 1204 */             return Float2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Float2CharMap.Entry last() {
/* 1208 */             return Float2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) {
/* 1212 */             return Float2CharAVLTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry to) {
/* 1216 */             return Float2CharAVLTreeMap.this.headMap(to.getFloatKey()).float2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from) {
/* 1220 */             return Float2CharAVLTreeMap.this.tailMap(from.getFloatKey()).float2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1254 */       return new Float2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public FloatBidirectionalIterator iterator(float from) {
/* 1258 */       return new Float2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1310 */       this.values = (CharCollection)new AbstractCharCollection()
/*      */         {
/*      */           public CharIterator iterator() {
/* 1313 */             return (CharIterator)new Float2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1317 */             return Float2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1321 */             return Float2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1325 */             Float2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1388 */       if (!bottom && !top && Float2CharAVLTreeMap.this.compare(from, to) > 0)
/* 1389 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1390 */       this.from = from;
/* 1391 */       this.bottom = bottom;
/* 1392 */       this.to = to;
/* 1393 */       this.top = top;
/* 1394 */       this.defRetValue = Float2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1412 */       return ((this.bottom || Float2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2CharAVLTreeMap.this
/* 1413 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
/* 1417 */       if (this.entries == null)
/* 1418 */         this.entries = (ObjectSortedSet<Float2CharMap.Entry>)new AbstractObjectSortedSet<Float2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator() {
/* 1421 */               return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from) {
/* 1425 */               return (ObjectBidirectionalIterator<Float2CharMap.Entry>)new Float2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getFloatKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Float2CharMap.Entry> comparator() {
/* 1429 */               return Float2CharAVLTreeMap.this.float2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1440 */                 return false; 
/* 1441 */               Float2CharAVLTreeMap.Entry f = Float2CharAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1442 */               return (f != null && Float2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1451 */                 return false; 
/* 1452 */               if (e.getValue() == null || !(e.getValue() instanceof Character))
/* 1453 */                 return false; 
/* 1454 */               Float2CharAVLTreeMap.Entry f = Float2CharAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1455 */               if (f != null && Float2CharAVLTreeMap.Submap.this.in(f.key))
/* 1456 */                 Float2CharAVLTreeMap.Submap.this.remove(f.key); 
/* 1457 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1461 */               int c = 0;
/* 1462 */               for (ObjectBidirectionalIterator<Float2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1463 */                 c++; 
/* 1464 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1468 */               return !(new Float2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1472 */               Float2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Float2CharMap.Entry first() {
/* 1476 */               return Float2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Float2CharMap.Entry last() {
/* 1480 */               return Float2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) {
/* 1485 */               return Float2CharAVLTreeMap.Submap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry to) {
/* 1489 */               return Float2CharAVLTreeMap.Submap.this.headMap(to.getFloatKey()).float2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from) {
/* 1493 */               return Float2CharAVLTreeMap.Submap.this.tailMap(from.getFloatKey()).float2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractFloat2CharSortedMap.KeySet {
/*      */       public FloatBidirectionalIterator iterator() {
/* 1501 */         return new Float2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public FloatBidirectionalIterator iterator(float from) {
/* 1505 */         return new Float2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public FloatSortedSet keySet() {
...
/* 1517 */         this.values = (CharCollection)new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1520 */               return (CharIterator)new Float2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1524 */               return Float2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1528 */               return Float2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1532 */               Float2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(float k) {
/* 1540 */       return (in(k) && Float2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/* 1547 */         char ev = (i.nextEntry()).value;
/* 1548 */         if (ev == v)
/* 1549 */           return true; 
/*      */       } 
/* 1551 */       return false;
...
/*      */     
/*      */     public char get(float k) {
/* 1557 */       float kk = k; Float2CharAVLTreeMap.Entry e;
/* 1558 */       return (in(kk) && (e = Float2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(float k, char v) {
/* 1562 */       Float2CharAVLTreeMap.this.modified = false;
/* 1563 */       if (!in(k))
...
/* 1566 */       char oldValue = Float2CharAVLTreeMap.this.put(k, v);
/* 1567 */       return Float2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(float k) {
/* 1572 */       Float2CharAVLTreeMap.this.modified = false;
/* 1573 */       if (!in(k))
/* 1574 */         return this.defRetValue; 
/* 1575 */       char oldValue = Float2CharAVLTreeMap.this.remove(k);
/* 1576 */       return Float2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public FloatComparator comparator() {
/* 1594 */       return Float2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Float2CharSortedMap headMap(float to) {
/* 1598 */       if (this.top)
/* 1599 */         return new Submap(this.from, this.bottom, to, false); 
/* 1600 */       return (Float2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Float2CharSortedMap tailMap(float from) {
/* 1604 */       if (this.bottom)
/* 1605 */         return new Submap(from, false, this.to, this.top); 
/* 1606 */       return (Float2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Float2CharSortedMap subMap(float from, float to) {
...
/* 1612 */       if (!this.top)
/* 1613 */         to = (Float2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1614 */       if (!this.bottom)
/* 1615 */         from = (Float2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1627 */       if (Float2CharAVLTreeMap.this.tree == null) {
/* 1628 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1632 */       if (this.bottom) {
/* 1633 */         e = Float2CharAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1635 */         e = Float2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1637 */         if (Float2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1638 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1642 */       if (e == null || (!this.top && Float2CharAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1643 */         return null; 
/* 1644 */       return e;
/*      */     }
/*      */ 
...
/*      */       Float2CharAVLTreeMap.Entry e;
/* 1653 */       if (Float2CharAVLTreeMap.this.tree == null) {
/* 1654 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1658 */       if (this.top) {
/* 1659 */         e = Float2CharAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1661 */         e = Float2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1663 */         if (Float2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1664 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1668 */       if (e == null || (!this.bottom && Float2CharAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1669 */         return null; 
/* 1670 */       return e;
/*      */     }
/*      */     
/*      */     public float firstFloatKey() {
/* 1674 */       Float2CharAVLTreeMap.Entry e = firstEntry();
/* 1675 */       if (e == null)
...
/*      */     
/*      */     public float lastFloatKey() {
/* 1681 */       Float2CharAVLTreeMap.Entry e = lastEntry();
/* 1682 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1697 */         this.next = Float2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1700 */         this();
/* 1701 */         if (this.next != null)
/* 1702 */           if (!Float2CharAVLTreeMap.Submap.this.bottom && Float2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1703 */             this.prev = null;
/* 1704 */           } else if (!Float2CharAVLTreeMap.Submap.this.top && Float2CharAVLTreeMap.this.compare(k, (this.prev = Float2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1705 */             this.next = null;
/*      */           } else {
/* 1707 */             this.next = Float2CharAVLTreeMap.this.locateKey(k);
/* 1708 */             if (Float2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1719 */         if (!Float2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Float2CharAVLTreeMap.this.compare(this.prev.key, Float2CharAVLTreeMap.Submap.this.from) < 0)
/* 1720 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1724 */         this.next = this.next.next();
/* 1725 */         if (!Float2CharAVLTreeMap.Submap.this.top && this.next != null && Float2CharAVLTreeMap.this.compare(this.next.key, Float2CharAVLTreeMap.Submap.this.to) >= 0)
/* 1726 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1806 */       c = (Float2CharAVLTreeMap)super.clone();
...
/* 1887 */     if (n == 1) {
/* 1888 */       Entry entry = new Entry(s.readFloat(), s.readChar());
...
/*      */ 
/*      */       
/* 1898 */       Entry entry = new Entry(s.readFloat(), s.readChar());
/* 1899 */       entry.right(new Entry(s.readFloat(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2CharAVLTreeMap.class
