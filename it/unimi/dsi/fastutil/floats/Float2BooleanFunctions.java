...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Float2BooleanFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Float2BooleanFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Float2BooleanFunction singleton(Float key, Boolean value) {
/* 161 */     return new Singleton(key.floatValue(), value.booleanValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Float2BooleanFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractFloat2BooleanFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Float2BooleanFunction function;
/*     */     
...
/* 468 */       Boolean v = this.function.apply(Float.valueOf(key));
/* 469 */       if (v == null)
...
/* 512 */     if (f instanceof Float2BooleanFunction)
/* 513 */       return (Float2BooleanFunction)f; 
/* 514 */     if (f instanceof DoublePredicate) {
/* 515 */       Objects.requireNonNull((DoublePredicate)f); return (DoublePredicate)f::test;
/* 516 */     }  return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2BooleanFunctions.class
