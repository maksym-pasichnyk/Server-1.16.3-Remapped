...
/*      */   
/*      */   public boolean trim() {
/* 1131 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1132 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1133 */       return true; 
/*      */     try {
/* 1135 */       rehash(l);
/* 1136 */     } catch (OutOfMemoryError cantDoIt) {
/* 1137 */       return false;
/*      */     } 
/* 1139 */     return true;
/*      */   }
...
/* 1163 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1164 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1165 */       return true; 
/*      */     try {
/* 1167 */       rehash(l);
/* 1168 */     } catch (OutOfMemoryError cantDoIt) {
/* 1169 */       return false;
/*      */     } 
/* 1171 */     return true;
/*      */   }
...
/* 1187 */     float[] key = this.key;
/* 1188 */     double[] value = this.value;
/* 1189 */     int mask = newN - 1;
/* 1190 */     float[] newKey = new float[newN + 1];
/* 1191 */     double[] newValue = new double[newN + 1];
/* 1192 */     int i = this.n;
/* 1193 */     for (int j = realSize(); j-- != 0; ) {
/* 1194 */       while (Float.floatToIntBits(key[--i]) == 0); int pos;
/* 1195 */       if (Float.floatToIntBits(newKey[
/* 1196 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0)
/* 1197 */         while (Float.floatToIntBits(newKey[pos = pos + 1 & mask]) != 0); 
/* 1198 */       newKey[pos] = key[i];
/* 1199 */       newValue[pos] = value[i];
/*      */     } 
/* 1201 */     newValue[newN] = value[this.n];
/* 1202 */     this.n = newN;
/* 1203 */     this.mask = mask;
/* 1204 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1205 */     this.key = newKey;
/* 1206 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1223 */       c = (Float2DoubleOpenCustomHashMap)super.clone();
/* 1224 */     } catch (CloneNotSupportedException cantHappen) {
/* 1225 */       throw new InternalError();
/*      */     } 
/* 1227 */     c.keys = null;
/* 1228 */     c.values = null;
/* 1229 */     c.entries = null;
/* 1230 */     c.containsNullKey = this.containsNullKey;
/* 1231 */     c.key = (float[])this.key.clone();
/* 1232 */     c.value = (double[])this.value.clone();
/* 1233 */     c.strategy = this.strategy;
/* 1234 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1247 */     int h = 0;
/* 1248 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1249 */       while (Float.floatToIntBits(this.key[i]) == 0)
/* 1250 */         i++; 
/* 1251 */       t = this.strategy.hashCode(this.key[i]);
/* 1252 */       t ^= HashCommon.double2int(this.value[i]);
/* 1253 */       h += t;
/* 1254 */       i++;
/*      */     } 
/*      */     
/* 1257 */     if (this.containsNullKey)
/* 1258 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1259 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1262 */     float[] key = this.key;
/* 1263 */     double[] value = this.value;
/* 1264 */     MapIterator i = new MapIterator();
/* 1265 */     s.defaultWriteObject();
/* 1266 */     for (int j = this.size; j-- != 0; ) {
/* 1267 */       int e = i.nextEntry();
/* 1268 */       s.writeFloat(key[e]);
/* 1269 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1274 */     s.defaultReadObject();
/* 1275 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1276 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1277 */     this.mask = this.n - 1;
/* 1278 */     float[] key = this.key = new float[this.n + 1];
/* 1279 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1282 */     for (int i = this.size; i-- != 0; ) {
/* 1283 */       int pos; float k = s.readFloat();
/* 1284 */       double v = s.readDouble();
/* 1285 */       if (this.strategy.equals(k, 0.0F)) {
/* 1286 */         pos = this.n;
/* 1287 */         this.containsNullKey = true;
/*      */       } else {
/* 1289 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1290 */         while (Float.floatToIntBits(key[pos]) != 0)
/* 1291 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1293 */       key[pos] = k;
/* 1294 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\floats\Float2DoubleOpenCustomHashMap.class
