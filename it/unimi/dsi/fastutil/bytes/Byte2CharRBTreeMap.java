...
/*  910 */         return false; 
/*  911 */       Map.Entry<Byte, Character> e = (Map.Entry<Byte, Character>)o;
/*  912 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  998 */     int index = 0;
/*      */     TreeIterator() {
/* 1000 */       this.next = Byte2CharRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/* 1003 */       if ((this.next = Byte2CharRBTreeMap.this.locateKey(k)) != null)
/* 1004 */         if (Byte2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1055 */       updatePrevious();
/* 1056 */       updateNext();
/* 1057 */       Byte2CharRBTreeMap.this.remove(this.curr.key);
/* 1058 */       this.curr = null;
/*      */     }
...
/* 1097 */       this.entries = (ObjectSortedSet<Byte2CharMap.Entry>)new AbstractObjectSortedSet<Byte2CharMap.Entry>()
/*      */         {
...
/* 1106 */             return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from) {
/* 1110 */             return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1121 */               return false; 
/* 1122 */             Byte2CharRBTreeMap.Entry f = Byte2CharRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1134 */               return false; 
/* 1135 */             Byte2CharRBTreeMap.Entry f = Byte2CharRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1136 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1137 */               return false; 
/* 1138 */             Byte2CharRBTreeMap.this.remove(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Byte2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Byte2CharRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2CharMap.Entry first() {
/* 1151 */             return Byte2CharRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2CharMap.Entry last() {
/* 1155 */             return Byte2CharRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry to) {
/* 1159 */             return Byte2CharRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry to) {
/* 1163 */             return Byte2CharRBTreeMap.this.headMap(to.getByteKey()).byte2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from) {
/* 1167 */             return Byte2CharRBTreeMap.this.tailMap(from.getByteKey()).byte2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1201 */       return new Byte2CharRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1205 */       return new Byte2CharRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1260 */             return (CharIterator)new Byte2CharRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1264 */             return Byte2CharRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Byte2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1272 */             Byte2CharRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1335 */       if (!bottom && !top && Byte2CharRBTreeMap.this.compare(from, to) > 0)
/* 1336 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1337 */       this.from = from;
/* 1338 */       this.bottom = bottom;
/* 1339 */       this.to = to;
/* 1340 */       this.top = top;
/* 1341 */       this.defRetValue = Byte2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1359 */       return ((this.bottom || Byte2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2CharRBTreeMap.this
/* 1360 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
/* 1364 */       if (this.entries == null)
/* 1365 */         this.entries = (ObjectSortedSet<Byte2CharMap.Entry>)new AbstractObjectSortedSet<Byte2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator() {
/* 1368 */               return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from) {
/* 1372 */               return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2CharMap.Entry> comparator() {
/* 1376 */               return Byte2CharRBTreeMap.this.byte2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Byte2CharRBTreeMap.Entry f = Byte2CharRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1389 */               return (f != null && Byte2CharRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1400 */                 return false; 
/* 1401 */               Byte2CharRBTreeMap.Entry f = Byte2CharRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1402 */               if (f != null && Byte2CharRBTreeMap.Submap.this.in(f.key))
/* 1403 */                 Byte2CharRBTreeMap.Submap.this.remove(f.key); 
/* 1404 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1408 */               int c = 0;
/* 1409 */               for (ObjectBidirectionalIterator<Byte2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1410 */                 c++; 
/* 1411 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1415 */               return !(new Byte2CharRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1419 */               Byte2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2CharMap.Entry first() {
/* 1423 */               return Byte2CharRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2CharMap.Entry last() {
/* 1427 */               return Byte2CharRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry to) {
/* 1431 */               return Byte2CharRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry to) {
/* 1435 */               return Byte2CharRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from) {
/* 1439 */               return Byte2CharRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2CharSortedMap.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1447 */         return new Byte2CharRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1451 */         return new Byte2CharRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/* 1463 */         this.values = (CharCollection)new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1466 */               return (CharIterator)new Byte2CharRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1470 */               return Byte2CharRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1474 */               return Byte2CharRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1478 */               Byte2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1486 */       return (in(k) && Byte2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/* 1493 */         char ev = (i.nextEntry()).value;
/* 1494 */         if (ev == v)
/* 1495 */           return true; 
/*      */       } 
/* 1497 */       return false;
...
/*      */     
/*      */     public char get(byte k) {
/* 1503 */       byte kk = k; Byte2CharRBTreeMap.Entry e;
/* 1504 */       return (in(kk) && (e = Byte2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(byte k, char v) {
/* 1508 */       Byte2CharRBTreeMap.this.modified = false;
/* 1509 */       if (!in(k))
...
/* 1512 */       char oldValue = Byte2CharRBTreeMap.this.put(k, v);
/* 1513 */       return Byte2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(byte k) {
/* 1518 */       Byte2CharRBTreeMap.this.modified = false;
/* 1519 */       if (!in(k))
/* 1520 */         return this.defRetValue; 
/* 1521 */       char oldValue = Byte2CharRBTreeMap.this.remove(k);
/* 1522 */       return Byte2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1540 */       return Byte2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2CharSortedMap headMap(byte to) {
/* 1544 */       if (this.top)
/* 1545 */         return new Submap(this.from, this.bottom, to, false); 
/* 1546 */       return (Byte2CharRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2CharSortedMap tailMap(byte from) {
/* 1550 */       if (this.bottom)
/* 1551 */         return new Submap(from, false, this.to, this.top); 
/* 1552 */       return (Byte2CharRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2CharSortedMap subMap(byte from, byte to) {
...
/* 1558 */       if (!this.top)
/* 1559 */         to = (Byte2CharRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1560 */       if (!this.bottom)
/* 1561 */         from = (Byte2CharRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1573 */       if (Byte2CharRBTreeMap.this.tree == null) {
/* 1574 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1578 */       if (this.bottom) {
/* 1579 */         e = Byte2CharRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1581 */         e = Byte2CharRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1583 */         if (Byte2CharRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1584 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1588 */       if (e == null || (!this.top && Byte2CharRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1589 */         return null; 
/* 1590 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2CharRBTreeMap.Entry e;
/* 1599 */       if (Byte2CharRBTreeMap.this.tree == null) {
/* 1600 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1604 */       if (this.top) {
/* 1605 */         e = Byte2CharRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1607 */         e = Byte2CharRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1609 */         if (Byte2CharRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1610 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Byte2CharRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1615 */         return null; 
/* 1616 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1620 */       Byte2CharRBTreeMap.Entry e = firstEntry();
/* 1621 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1627 */       Byte2CharRBTreeMap.Entry e = lastEntry();
/* 1628 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Byte2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1646 */         this();
/* 1647 */         if (this.next != null)
/* 1648 */           if (!Byte2CharRBTreeMap.Submap.this.bottom && Byte2CharRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1649 */             this.prev = null;
/* 1650 */           } else if (!Byte2CharRBTreeMap.Submap.this.top && Byte2CharRBTreeMap.this.compare(k, (this.prev = Byte2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1651 */             this.next = null;
/*      */           } else {
/* 1653 */             this.next = Byte2CharRBTreeMap.this.locateKey(k);
/* 1654 */             if (Byte2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1665 */         if (!Byte2CharRBTreeMap.Submap.this.bottom && this.prev != null && Byte2CharRBTreeMap.this.compare(this.prev.key, Byte2CharRBTreeMap.Submap.this.from) < 0)
/* 1666 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1670 */         this.next = this.next.next();
/* 1671 */         if (!Byte2CharRBTreeMap.Submap.this.top && this.next != null && Byte2CharRBTreeMap.this.compare(this.next.key, Byte2CharRBTreeMap.Submap.this.to) >= 0)
/* 1672 */           this.next = null; 
/*      */       } }
/*      */     
/*      */     private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Byte2CharMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1752 */       c = (Byte2CharRBTreeMap)super.clone();
...
/* 1833 */     if (n == 1) {
/* 1834 */       Entry entry = new Entry(s.readByte(), s.readChar());
...
/*      */ 
/*      */       
/* 1845 */       Entry entry = new Entry(s.readByte(), s.readChar());
/* 1846 */       entry.black(true);
/* 1847 */       entry.right(new Entry(s.readByte(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharRBTreeMap.class
