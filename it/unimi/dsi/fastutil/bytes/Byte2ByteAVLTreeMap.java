...
/*  954 */         return false; 
/*  955 */       Map.Entry<Byte, Byte> e = (Map.Entry<Byte, Byte>)o;
/*  956 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Byte2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/* 1047 */       if ((this.next = Byte2ByteAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Byte2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Byte2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Byte2ByteMap.Entry>)new AbstractObjectSortedSet<Byte2ByteMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Byte2ByteAVLTreeMap.Entry f = Byte2ByteAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1186 */               return false; 
/* 1187 */             Byte2ByteAVLTreeMap.Entry f = Byte2ByteAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1188 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue())
/* 1189 */               return false; 
/* 1190 */             Byte2ByteAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Byte2ByteAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Byte2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2ByteMap.Entry first() {
/* 1203 */             return Byte2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2ByteMap.Entry last() {
/* 1207 */             return Byte2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry from, Byte2ByteMap.Entry to) {
/* 1211 */             return Byte2ByteAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry to) {
/* 1215 */             return Byte2ByteAVLTreeMap.this.headMap(to.getByteKey()).byte2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from) {
/* 1219 */             return Byte2ByteAVLTreeMap.this.tailMap(from.getByteKey()).byte2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Byte2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1257 */       return new Byte2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1309 */       this.values = new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1312 */             return new Byte2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(byte k) {
/* 1316 */             return Byte2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Byte2ByteAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Byte2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Byte2ByteAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Byte2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Byte2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ByteAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Byte2ByteMap.Entry>)new AbstractObjectSortedSet<Byte2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2ByteMap.Entry> comparator() {
/* 1428 */               return Byte2ByteAVLTreeMap.this.byte2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Byte2ByteAVLTreeMap.Entry f = Byte2ByteAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1441 */               return (f != null && Byte2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Byte2ByteAVLTreeMap.Entry f = Byte2ByteAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1454 */               if (f != null && Byte2ByteAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Byte2ByteAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Byte2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Byte2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Byte2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2ByteMap.Entry first() {
/* 1475 */               return Byte2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2ByteMap.Entry last() {
/* 1479 */               return Byte2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry from, Byte2ByteMap.Entry to) {
/* 1483 */               return Byte2ByteAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry to) {
/* 1487 */               return Byte2ByteAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from) {
/* 1491 */               return Byte2ByteAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2ByteSortedMap.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1499 */         return new Byte2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1503 */         return new Byte2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/* 1515 */         this.values = new AbstractByteCollection()
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1518 */               return new Byte2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(byte k) {
/* 1522 */               return Byte2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Byte2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Byte2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1538 */       return (in(k) && Byte2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(byte k) {
/* 1555 */       byte kk = k; Byte2ByteAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Byte2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public byte put(byte k, byte v) {
/* 1560 */       Byte2ByteAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       byte oldValue = Byte2ByteAVLTreeMap.this.put(k, v);
/* 1565 */       return Byte2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte remove(byte k) {
/* 1570 */       Byte2ByteAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       byte oldValue = Byte2ByteAVLTreeMap.this.remove(k);
/* 1574 */       return Byte2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1592 */       return Byte2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2ByteSortedMap headMap(byte to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Byte2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2ByteSortedMap tailMap(byte from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Byte2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2ByteSortedMap subMap(byte from, byte to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Byte2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Byte2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Byte2ByteAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Byte2ByteAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Byte2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Byte2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Byte2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2ByteAVLTreeMap.Entry e;
/* 1651 */       if (Byte2ByteAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Byte2ByteAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Byte2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Byte2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Byte2ByteAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1672 */       Byte2ByteAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1679 */       Byte2ByteAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Byte2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Byte2ByteAVLTreeMap.Submap.this.bottom && Byte2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Byte2ByteAVLTreeMap.Submap.this.top && Byte2ByteAVLTreeMap.this.compare(k, (this.prev = Byte2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Byte2ByteAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Byte2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Byte2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2ByteAVLTreeMap.this.compare(this.prev.key, Byte2ByteAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Byte2ByteAVLTreeMap.Submap.this.top && this.next != null && Byte2ByteAVLTreeMap.this.compare(this.next.key, Byte2ByteAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
/*      */     private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Byte2ByteMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1804 */       c = (Byte2ByteAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readByte(), s.readByte());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readByte(), s.readByte());
/* 1897 */       entry.right(new Entry(s.readByte(), s.readByte()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ByteAVLTreeMap.class
