...
/*  61 */     return (entries instanceof Byte2ByteSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Byte2ByteSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Byte2ByteMap.Entry> entries = map.byte2ByteEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Byte2ByteSortedMap.FastSortedEntrySet)entries); return (entries instanceof Byte2ByteSortedMap.FastSortedEntrySet) ? (Byte2ByteSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Byte2ByteMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Byte2ByteMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Byte, Byte>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ByteSortedMap headMap(byte to) {
/* 132 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ByteSortedMap tailMap(byte from) {
/* 137 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Byte2ByteMap.Entry>)ObjectSortedSets.singleton(new AbstractByte2ByteMap.BasicEntry(this.key, this.value), 
/* 237 */             Byte2ByteSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Byte2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Byte>> entrySet() {
/* 249 */       return (ObjectSortedSet)byte2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ByteSortedMap headMap(byte to) {
...
/* 268 */         return this; 
/* 269 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2ByteSortedMap tailMap(byte from) {
...
/* 275 */         return this; 
/* 276 */       return Byte2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public byte firstByteKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.byteValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Byte2ByteMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.byte2ByteEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Byte2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Byte>> entrySet() {
/* 449 */       return (ObjectSortedSet)byte2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Byte2ByteMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.byte2ByteEntrySet()); 
/* 582 */       return (ObjectSortedSet<Byte2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ByteSortedMaps.class
