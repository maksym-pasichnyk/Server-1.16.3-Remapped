...
/*  586 */       return Byte2ReferenceOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public V getValue() {
/*  590 */       return Byte2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public V setValue(V v) {
/*  594 */       V oldValue = Byte2ReferenceOpenHashMap.this.value[this.index];
/*  595 */       Byte2ReferenceOpenHashMap.this.value[this.index] = v;
/*  596 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  606 */       return Byte.valueOf(Byte2ReferenceOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */     
...
/*  614 */       return (Byte2ReferenceOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  618 */       return Byte2ReferenceOpenHashMap.this.key[this.index] ^ ((Byte2ReferenceOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Byte2ReferenceOpenHashMap.this.value[this.index]));
/*      */     }
/*      */     
/*      */     public String toString() {
/*  622 */       return Byte2ReferenceOpenHashMap.this.key[this.index] + "=>" + Byte2ReferenceOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  632 */     int pos = Byte2ReferenceOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  639 */     int last = -1;
/*      */     
/*  641 */     int c = Byte2ReferenceOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  645 */     boolean mustReturnNullKey = Byte2ReferenceOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  660 */         return this.last = Byte2ReferenceOpenHashMap.this.n;
/*      */       } 
/*  662 */       byte[] key = Byte2ReferenceOpenHashMap.this.key;
/*      */       while (true) {
/*  664 */         if (--this.pos < 0) {
/*      */           
/*  666 */           this.last = Integer.MIN_VALUE;
/*  667 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  668 */           int p = HashCommon.mix(k) & Byte2ReferenceOpenHashMap.this.mask;
/*  669 */           while (k != key[p])
/*  670 */             p = p + 1 & Byte2ReferenceOpenHashMap.this.mask; 
/*  671 */           return p;
/*      */         } 
...
/*  688 */       byte[] key = Byte2ReferenceOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  690 */         pos = (last = pos) + 1 & Byte2ReferenceOpenHashMap.this.mask;
/*      */         while (true) {
/*  692 */           if ((curr = key[pos]) == 0) {
/*  693 */             key[last] = 0;
/*  694 */             Byte2ReferenceOpenHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  697 */           int slot = HashCommon.mix(curr) & Byte2ReferenceOpenHashMap.this.mask;
/*  698 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  700 */           pos = pos + 1 & Byte2ReferenceOpenHashMap.this.mask;
/*      */         } 
/*  702 */         if (pos < last) {
/*  703 */           if (this.wrapped == null)
/*  704 */             this.wrapped = new ByteArrayList(2); 
/*  705 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  707 */         key[last] = curr;
/*  708 */         Byte2ReferenceOpenHashMap.this.value[last] = Byte2ReferenceOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  712 */       if (this.last == -1)
/*  713 */         throw new IllegalStateException(); 
/*  714 */       if (this.last == Byte2ReferenceOpenHashMap.this.n) {
/*  715 */         Byte2ReferenceOpenHashMap.this.containsNullKey = false;
/*  716 */         Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n] = null;
/*  717 */       } else if (this.pos >= 0) {
/*  718 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  721 */         Byte2ReferenceOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  722 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  725 */       Byte2ReferenceOpenHashMap.this.size--;
/*  726 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Byte2ReferenceMap.Entry<V>> { private Byte2ReferenceOpenHashMap<V>.MapEntry entry;
/*      */     
/*      */     public Byte2ReferenceOpenHashMap<V>.MapEntry next() {
/*  741 */       return this.entry = new Byte2ReferenceOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  750 */       this.entry = new Byte2ReferenceOpenHashMap.MapEntry();
...
/*  760 */       return new Byte2ReferenceOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Byte2ReferenceMap.Entry<V>> fastIterator() {
/*  764 */       return new Byte2ReferenceOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  772 */       if (e.getKey() == null || !(e.getKey() instanceof Byte))
/*  773 */         return false; 
/*  774 */       byte k = ((Byte)e.getKey()).byteValue();
/*  775 */       V v = (V)e.getValue();
/*  776 */       if (k == 0) {
/*  777 */         return (Byte2ReferenceOpenHashMap.this.containsNullKey && Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n] == v);
/*      */       }
/*  779 */       byte[] key = Byte2ReferenceOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  782 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ReferenceOpenHashMap.this.mask]) == 0)
/*  783 */         return false; 
/*  784 */       if (k == curr) {
/*  785 */         return (Byte2ReferenceOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  788 */         if ((curr = key[pos = pos + 1 & Byte2ReferenceOpenHashMap.this.mask]) == 0)
/*  789 */           return false; 
/*  790 */         if (k == curr) {
/*  791 */           return (Byte2ReferenceOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  800 */       if (e.getKey() == null || !(e.getKey() instanceof Byte))
/*  801 */         return false; 
/*  802 */       byte k = ((Byte)e.getKey()).byteValue();
/*  803 */       V v = (V)e.getValue();
/*  804 */       if (k == 0) {
/*  805 */         if (Byte2ReferenceOpenHashMap.this.containsNullKey && Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n] == v) {
/*  806 */           Byte2ReferenceOpenHashMap.this.removeNullEntry();
/*  807 */           return true;
/*      */         } 
/*  809 */         return false;
/*      */       } 
/*      */       
/*  812 */       byte[] key = Byte2ReferenceOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  815 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ReferenceOpenHashMap.this.mask]) == 0)
/*  816 */         return false; 
/*  817 */       if (curr == k) {
/*  818 */         if (Byte2ReferenceOpenHashMap.this.value[pos] == v) {
/*  819 */           Byte2ReferenceOpenHashMap.this.removeEntry(pos);
/*  820 */           return true;
/*      */         } 
/*  822 */         return false;
/*      */       } 
/*      */       while (true) {
/*  825 */         if ((curr = key[pos = pos + 1 & Byte2ReferenceOpenHashMap.this.mask]) == 0)
/*  826 */           return false; 
/*  827 */         if (curr == k && 
/*  828 */           Byte2ReferenceOpenHashMap.this.value[pos] == v) {
/*  829 */           Byte2ReferenceOpenHashMap.this.removeEntry(pos);
/*  830 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  837 */       return Byte2ReferenceOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  841 */       Byte2ReferenceOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
/*  846 */       if (Byte2ReferenceOpenHashMap.this.containsNullKey)
/*  847 */         consumer.accept(new AbstractByte2ReferenceMap.BasicEntry<>(Byte2ReferenceOpenHashMap.this.key[Byte2ReferenceOpenHashMap.this.n], Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n])); 
/*  848 */       for (int pos = Byte2ReferenceOpenHashMap.this.n; pos-- != 0;) {
/*  849 */         if (Byte2ReferenceOpenHashMap.this.key[pos] != 0)
/*  850 */           consumer.accept(new AbstractByte2ReferenceMap.BasicEntry<>(Byte2ReferenceOpenHashMap.this.key[pos], Byte2ReferenceOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
/*  855 */       AbstractByte2ReferenceMap.BasicEntry<V> entry = new AbstractByte2ReferenceMap.BasicEntry<>();
/*  856 */       if (Byte2ReferenceOpenHashMap.this.containsNullKey) {
/*  857 */         entry.key = Byte2ReferenceOpenHashMap.this.key[Byte2ReferenceOpenHashMap.this.n];
/*  858 */         entry.value = Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n];
/*  859 */         consumer.accept(entry);
/*      */       } 
/*  861 */       for (int pos = Byte2ReferenceOpenHashMap.this.n; pos-- != 0;) {
/*  862 */         if (Byte2ReferenceOpenHashMap.this.key[pos] != 0) {
/*  863 */           entry.key = Byte2ReferenceOpenHashMap.this.key[pos];
/*  864 */           entry.value = Byte2ReferenceOpenHashMap.this.value[pos];
...
/*  890 */       return Byte2ReferenceOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractByteSet { private KeySet() {}
/*      */     
/*      */     public ByteIterator iterator() {
/*  896 */       return new Byte2ReferenceOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  901 */       if (Byte2ReferenceOpenHashMap.this.containsNullKey)
/*  902 */         consumer.accept(Byte2ReferenceOpenHashMap.this.key[Byte2ReferenceOpenHashMap.this.n]); 
/*  903 */       for (int pos = Byte2ReferenceOpenHashMap.this.n; pos-- != 0; ) {
/*  904 */         byte k = Byte2ReferenceOpenHashMap.this.key[pos];
/*  905 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/*  911 */       return Byte2ReferenceOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(byte k) {
/*  915 */       return Byte2ReferenceOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(byte k) {
/*  919 */       int oldSize = Byte2ReferenceOpenHashMap.this.size;
/*  920 */       Byte2ReferenceOpenHashMap.this.remove(k);
/*  921 */       return (Byte2ReferenceOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  925 */       Byte2ReferenceOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*      */   {
/*      */     public V next() {
/*  949 */       return Byte2ReferenceOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*  958 */             return new Byte2ReferenceOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/*  962 */             return Byte2ReferenceOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(Object v) {
/*  966 */             return Byte2ReferenceOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/*  970 */             Byte2ReferenceOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer)
/*      */           {
/*  975 */             if (Byte2ReferenceOpenHashMap.this.containsNullKey)
/*  976 */               consumer.accept(Byte2ReferenceOpenHashMap.this.value[Byte2ReferenceOpenHashMap.this.n]); 
/*  977 */             for (int pos = Byte2ReferenceOpenHashMap.this.n; pos-- != 0;) {
/*  978 */               if (Byte2ReferenceOpenHashMap.this.key[pos] != 0)
/*  979 */                 consumer.accept(Byte2ReferenceOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1055 */     byte[] key = this.key;
/* 1056 */     V[] value = this.value;
/* 1057 */     int mask = newN - 1;
/* 1058 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1090 */       c = (Byte2ReferenceOpenHashMap<V>)super.clone();
...
/* 1098 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceOpenHashMap.class
