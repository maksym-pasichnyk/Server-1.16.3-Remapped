...
/*  888 */         return false; 
/*  889 */       Map.Entry<Byte, Boolean> e = (Map.Entry<Byte, Boolean>)o;
/*  890 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  976 */     int index = 0;
/*      */     TreeIterator() {
/*  978 */       this.next = Byte2BooleanRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/*  981 */       if ((this.next = Byte2BooleanRBTreeMap.this.locateKey(k)) != null)
/*  982 */         if (Byte2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1033 */       updatePrevious();
/* 1034 */       updateNext();
/* 1035 */       Byte2BooleanRBTreeMap.this.remove(this.curr.key);
/* 1036 */       this.curr = null;
/*      */     }
...
/* 1075 */       this.entries = (ObjectSortedSet<Byte2BooleanMap.Entry>)new AbstractObjectSortedSet<Byte2BooleanMap.Entry>()
/*      */         {
...
/* 1084 */             return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from) {
/* 1088 */             return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1096 */             if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1097 */               return false; 
/* 1098 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1099 */               return false; 
/* 1100 */             Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1109 */             if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1110 */               return false; 
/* 1111 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1112 */               return false; 
/* 1113 */             Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1114 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue())
/* 1115 */               return false; 
/* 1116 */             Byte2BooleanRBTreeMap.this.remove(f.key);
/* 1117 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1121 */             return Byte2BooleanRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1125 */             Byte2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2BooleanMap.Entry first() {
/* 1129 */             return Byte2BooleanRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2BooleanMap.Entry last() {
/* 1133 */             return Byte2BooleanRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry to) {
/* 1138 */             return Byte2BooleanRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry to) {
/* 1142 */             return Byte2BooleanRBTreeMap.this.headMap(to.getByteKey()).byte2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from) {
/* 1146 */             return Byte2BooleanRBTreeMap.this.tailMap(from.getByteKey()).byte2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1180 */       return new Byte2BooleanRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1184 */       return new Byte2BooleanRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1239 */             return (BooleanIterator)new Byte2BooleanRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1243 */             return Byte2BooleanRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1247 */             return Byte2BooleanRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1251 */             Byte2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1262 */     return new Submap((byte)0, true, to, false);
/*      */   }
/*      */   
/*      */   public Byte2BooleanSortedMap tailMap(byte from) {
/* 1266 */     return new Submap(from, false, (byte)0, true);
/*      */   }
/*      */   
...
/* 1314 */       if (!bottom && !top && Byte2BooleanRBTreeMap.this.compare(from, to) > 0)
/* 1315 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1316 */       this.from = from;
/* 1317 */       this.bottom = bottom;
/* 1318 */       this.to = to;
/* 1319 */       this.top = top;
/* 1320 */       this.defRetValue = Byte2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1338 */       return ((this.bottom || Byte2BooleanRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2BooleanRBTreeMap.this
/* 1339 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
/* 1343 */       if (this.entries == null)
/* 1344 */         this.entries = (ObjectSortedSet<Byte2BooleanMap.Entry>)new AbstractObjectSortedSet<Byte2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator() {
/* 1347 */               return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from) {
/* 1352 */               return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2BooleanMap.Entry> comparator() {
/* 1356 */               return Byte2BooleanRBTreeMap.this.byte2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1364 */               if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1365 */                 return false; 
/* 1366 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1367 */                 return false; 
/* 1368 */               Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1369 */               return (f != null && Byte2BooleanRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1377 */               if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1378 */                 return false; 
/* 1379 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1380 */                 return false; 
/* 1381 */               Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1382 */               if (f != null && Byte2BooleanRBTreeMap.Submap.this.in(f.key))
/* 1383 */                 Byte2BooleanRBTreeMap.Submap.this.remove(f.key); 
/* 1384 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1388 */               int c = 0;
/* 1389 */               for (ObjectBidirectionalIterator<Byte2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1390 */                 c++; 
/* 1391 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1395 */               return !(new Byte2BooleanRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1399 */               Byte2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2BooleanMap.Entry first() {
/* 1403 */               return Byte2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2BooleanMap.Entry last() {
/* 1407 */               return Byte2BooleanRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry to) {
/* 1412 */               return Byte2BooleanRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry to) {
/* 1416 */               return Byte2BooleanRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from) {
/* 1420 */               return Byte2BooleanRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2BooleanSortedMap.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1428 */         return new Byte2BooleanRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1432 */         return new Byte2BooleanRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1447 */               return (BooleanIterator)new Byte2BooleanRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1451 */               return Byte2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1455 */               return Byte2BooleanRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1459 */               Byte2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1467 */       return (in(k) && Byte2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(byte k) {
/* 1484 */       byte kk = k; Byte2BooleanRBTreeMap.Entry e;
/* 1485 */       return (in(kk) && (e = Byte2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public boolean put(byte k, boolean v) {
/* 1489 */       Byte2BooleanRBTreeMap.this.modified = false;
/* 1490 */       if (!in(k))
...
/* 1493 */       boolean oldValue = Byte2BooleanRBTreeMap.this.put(k, v);
/* 1494 */       return Byte2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1499 */       Byte2BooleanRBTreeMap.this.modified = false;
/* 1500 */       if (!in(k))
/* 1501 */         return this.defRetValue; 
/* 1502 */       boolean oldValue = Byte2BooleanRBTreeMap.this.remove(k);
/* 1503 */       return Byte2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1521 */       return Byte2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2BooleanSortedMap headMap(byte to) {
/* 1525 */       if (this.top)
/* 1526 */         return new Submap(this.from, this.bottom, to, false); 
/* 1527 */       return (Byte2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2BooleanSortedMap tailMap(byte from) {
/* 1531 */       if (this.bottom)
/* 1532 */         return new Submap(from, false, this.to, this.top); 
/* 1533 */       return (Byte2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2BooleanSortedMap subMap(byte from, byte to) {
...
/* 1539 */       if (!this.top)
/* 1540 */         to = (Byte2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1541 */       if (!this.bottom)
/* 1542 */         from = (Byte2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1554 */       if (Byte2BooleanRBTreeMap.this.tree == null) {
/* 1555 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1559 */       if (this.bottom) {
/* 1560 */         e = Byte2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1562 */         e = Byte2BooleanRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1564 */         if (Byte2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1565 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1569 */       if (e == null || (!this.top && Byte2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1570 */         return null; 
/* 1571 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2BooleanRBTreeMap.Entry e;
/* 1580 */       if (Byte2BooleanRBTreeMap.this.tree == null) {
/* 1581 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1585 */       if (this.top) {
/* 1586 */         e = Byte2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1588 */         e = Byte2BooleanRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1590 */         if (Byte2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1591 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1595 */       if (e == null || (!this.bottom && Byte2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1596 */         return null; 
/* 1597 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1601 */       Byte2BooleanRBTreeMap.Entry e = firstEntry();
/* 1602 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1608 */       Byte2BooleanRBTreeMap.Entry e = lastEntry();
/* 1609 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1624 */         this.next = Byte2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1627 */         this();
/* 1628 */         if (this.next != null)
/* 1629 */           if (!Byte2BooleanRBTreeMap.Submap.this.bottom && Byte2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1630 */             this.prev = null;
/* 1631 */           } else if (!Byte2BooleanRBTreeMap.Submap.this.top && Byte2BooleanRBTreeMap.this.compare(k, (this.prev = Byte2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1632 */             this.next = null;
/*      */           } else {
/* 1634 */             this.next = Byte2BooleanRBTreeMap.this.locateKey(k);
/* 1635 */             if (Byte2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1646 */         if (!Byte2BooleanRBTreeMap.Submap.this.bottom && this.prev != null && Byte2BooleanRBTreeMap.this.compare(this.prev.key, Byte2BooleanRBTreeMap.Submap.this.from) < 0)
/* 1647 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1651 */         this.next = this.next.next();
/* 1652 */         if (!Byte2BooleanRBTreeMap.Submap.this.top && this.next != null && Byte2BooleanRBTreeMap.this.compare(this.next.key, Byte2BooleanRBTreeMap.Submap.this.to) >= 0)
/* 1653 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1733 */       c = (Byte2BooleanRBTreeMap)super.clone();
...
/* 1814 */     if (n == 1) {
/* 1815 */       Entry entry = new Entry(s.readByte(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1826 */       Entry entry = new Entry(s.readByte(), s.readBoolean());
/* 1827 */       entry.black(true);
/* 1828 */       entry.right(new Entry(s.readByte(), s.readBoolean()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2BooleanRBTreeMap.class
