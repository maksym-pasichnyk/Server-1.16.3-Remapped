...
/*  936 */       return (this.key == ((Byte)e.getKey()).byteValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1022 */     int index = 0;
/*      */     TreeIterator() {
/* 1024 */       this.next = Byte2ObjectAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/* 1027 */       if ((this.next = Byte2ObjectAVLTreeMap.this.locateKey(k)) != null)
/* 1028 */         if (Byte2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1079 */       updatePrevious();
/* 1080 */       updateNext();
/* 1081 */       Byte2ObjectAVLTreeMap.this.remove(this.curr.key);
/* 1082 */       this.curr = null;
/*      */     }
...
/* 1129 */       this.entries = (ObjectSortedSet<Byte2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1138 */             return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from) {
/* 1143 */             return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1152 */               return false; 
/* 1153 */             Byte2ObjectAVLTreeMap.Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1163 */               return false; 
/* 1164 */             Byte2ObjectAVLTreeMap.Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1165 */             if (f == null || !Objects.equals(f.getValue(), e.getValue()))
/* 1166 */               return false; 
/* 1167 */             Byte2ObjectAVLTreeMap.this.remove(f.key);
/* 1168 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1172 */             return Byte2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1176 */             Byte2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2ObjectMap.Entry<V> first() {
/* 1180 */             return Byte2ObjectAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2ObjectMap.Entry<V> last() {
/* 1184 */             return Byte2ObjectAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> to) {
/* 1189 */             return Byte2ObjectAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to) {
/* 1193 */             return Byte2ObjectAVLTreeMap.this.headMap(to.getByteKey()).byte2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from) {
/* 1197 */             return Byte2ObjectAVLTreeMap.this.tailMap(from.getByteKey()).byte2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1231 */       return new Byte2ObjectAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1235 */       return new Byte2ObjectAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1290 */             return (ObjectIterator<V>)new Byte2ObjectAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1294 */             return Byte2ObjectAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1298 */             return Byte2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1302 */             Byte2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1365 */       if (!bottom && !top && Byte2ObjectAVLTreeMap.this.compare(from, to) > 0)
/* 1366 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Byte2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1389 */       return ((this.bottom || Byte2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ObjectAVLTreeMap.this
/* 1390 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
/* 1394 */       if (this.entries == null)
/* 1395 */         this.entries = (ObjectSortedSet<Byte2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator() {
/* 1398 */               return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from) {
/* 1403 */               return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2ObjectMap.Entry<V>> comparator() {
/* 1407 */               return Byte2ObjectAVLTreeMap.this.byte2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1416 */                 return false; 
/* 1417 */               Byte2ObjectAVLTreeMap.Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1418 */               return (f != null && Byte2ObjectAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1427 */                 return false; 
/* 1428 */               Byte2ObjectAVLTreeMap.Entry<V> f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1429 */               if (f != null && Byte2ObjectAVLTreeMap.Submap.this.in(f.key))
/* 1430 */                 Byte2ObjectAVLTreeMap.Submap.this.remove(f.key); 
/* 1431 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1435 */               int c = 0;
/* 1436 */               for (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1437 */                 c++; 
/* 1438 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1442 */               return !(new Byte2ObjectAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1446 */               Byte2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2ObjectMap.Entry<V> first() {
/* 1450 */               return Byte2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2ObjectMap.Entry<V> last() {
/* 1454 */               return Byte2ObjectAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> to) {
/* 1459 */               return Byte2ObjectAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to) {
/* 1463 */               return Byte2ObjectAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from) {
/* 1467 */               return Byte2ObjectAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ObjectEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2ObjectSortedMap<V>.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1475 */         return new Byte2ObjectAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1479 */         return new Byte2ObjectAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1494 */               return (ObjectIterator<V>)new Byte2ObjectAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1498 */               return Byte2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1502 */               return Byte2ObjectAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1506 */               Byte2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1514 */       return (in(k) && Byte2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(byte k) {
/* 1531 */       byte kk = k; Byte2ObjectAVLTreeMap.Entry<V> e;
/* 1532 */       return (in(kk) && (e = Byte2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(byte k, V v) {
/* 1536 */       Byte2ObjectAVLTreeMap.this.modified = false;
/* 1537 */       if (!in(k))
...
/* 1540 */       V oldValue = Byte2ObjectAVLTreeMap.this.put(k, v);
/* 1541 */       return Byte2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(byte k) {
/* 1546 */       Byte2ObjectAVLTreeMap.this.modified = false;
/* 1547 */       if (!in(k))
/* 1548 */         return this.defRetValue; 
/* 1549 */       V oldValue = Byte2ObjectAVLTreeMap.this.remove(k);
/* 1550 */       return Byte2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1568 */       return Byte2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2ObjectSortedMap<V> headMap(byte to) {
/* 1572 */       if (this.top)
/* 1573 */         return new Submap(this.from, this.bottom, to, false); 
/* 1574 */       return (Byte2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2ObjectSortedMap<V> tailMap(byte from) {
/* 1578 */       if (this.bottom)
/* 1579 */         return new Submap(from, false, this.to, this.top); 
/* 1580 */       return (Byte2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2ObjectSortedMap<V> subMap(byte from, byte to) {
...
/* 1586 */       if (!this.top)
/* 1587 */         to = (Byte2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1588 */       if (!this.bottom)
/* 1589 */         from = (Byte2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1601 */       if (Byte2ObjectAVLTreeMap.this.tree == null) {
/* 1602 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1606 */       if (this.bottom) {
/* 1607 */         e = Byte2ObjectAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1609 */         e = Byte2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1611 */         if (Byte2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1612 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1616 */       if (e == null || (!this.top && Byte2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1617 */         return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2ObjectAVLTreeMap.Entry<V> e;
/* 1627 */       if (Byte2ObjectAVLTreeMap.this.tree == null) {
/* 1628 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1632 */       if (this.top) {
/* 1633 */         e = Byte2ObjectAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1635 */         e = Byte2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1637 */         if (Byte2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1638 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1642 */       if (e == null || (!this.bottom && Byte2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1643 */         return null; 
/* 1644 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1648 */       Byte2ObjectAVLTreeMap.Entry<V> e = firstEntry();
/* 1649 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1655 */       Byte2ObjectAVLTreeMap.Entry<V> e = lastEntry();
/* 1656 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1671 */         this.next = Byte2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1674 */         this();
/* 1675 */         if (this.next != null)
/* 1676 */           if (!Byte2ObjectAVLTreeMap.Submap.this.bottom && Byte2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1677 */             this.prev = null;
/* 1678 */           } else if (!Byte2ObjectAVLTreeMap.Submap.this.top && Byte2ObjectAVLTreeMap.this.compare(k, (this.prev = Byte2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1679 */             this.next = null;
/*      */           } else {
/* 1681 */             this.next = Byte2ObjectAVLTreeMap.this.locateKey(k);
/* 1682 */             if (Byte2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1693 */         if (!Byte2ObjectAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2ObjectAVLTreeMap.this.compare(this.prev.key, Byte2ObjectAVLTreeMap.Submap.this.from) < 0)
/* 1694 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1698 */         this.next = this.next.next();
/* 1699 */         if (!Byte2ObjectAVLTreeMap.Submap.this.top && this.next != null && Byte2ObjectAVLTreeMap.this.compare(this.next.key, Byte2ObjectAVLTreeMap.Submap.this.to) >= 0)
/* 1700 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1782 */       c = (Byte2ObjectAVLTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ObjectAVLTreeMap.class
