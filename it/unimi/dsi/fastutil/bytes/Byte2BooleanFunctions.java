...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Byte2BooleanFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Byte2BooleanFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Byte2BooleanFunction singleton(Byte key, Boolean value) {
/* 161 */     return new Singleton(key.byteValue(), value.booleanValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Byte2BooleanFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractByte2BooleanFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2BooleanFunction function;
/*     */     
...
/* 468 */       Boolean v = this.function.apply(Byte.valueOf(key));
/* 469 */       if (v == null)
...
/* 511 */     if (f instanceof Byte2BooleanFunction)
/* 512 */       return (Byte2BooleanFunction)f; 
/* 513 */     if (f instanceof IntPredicate) {
/* 514 */       Objects.requireNonNull((IntPredicate)f); return (IntPredicate)f::test;
/* 515 */     }  return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2BooleanFunctions.class
