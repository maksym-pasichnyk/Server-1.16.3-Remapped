...
/* 1177 */     byte[] key = this.key;
/* 1178 */     short[] value = this.value;
/* 1179 */     int mask = newN - 1;
/* 1180 */     byte[] newKey = new byte[newN + 1];
...
/*      */       {
/* 1187 */         while (newKey[pos = pos + 1 & mask] != 0); } 
...
/*      */     try {
/* 1213 */       c = (Byte2ShortOpenCustomHashMap)super.clone();
...
/* 1221 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortOpenCustomHashMap.class
