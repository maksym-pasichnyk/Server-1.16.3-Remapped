...
/*   93 */     this.actualComparator = ByteComparators.asByteComparator(this.storedComparator);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  180 */     this(k, v, (Comparator<? super Byte>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  208 */     return (this.actualComparator == null) ? Byte.compare(k1, k2) : this.actualComparator.compare(k1, k2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  890 */         return false; 
/*  891 */       Map.Entry<Byte, V> e = (Map.Entry<Byte, V>)o;
/*  892 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  978 */     int index = 0;
/*      */     TreeIterator() {
/*  980 */       this.next = Byte2ReferenceRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/*  983 */       if ((this.next = Byte2ReferenceRBTreeMap.this.locateKey(k)) != null)
/*  984 */         if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1035 */       updatePrevious();
/* 1036 */       updateNext();
/* 1037 */       Byte2ReferenceRBTreeMap.this.remove(this.curr.key);
/* 1038 */       this.curr = null;
/*      */     }
...
/* 1077 */       this.entries = (ObjectSortedSet<Byte2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1086 */             return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) {
/* 1091 */             return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1099 */             if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1100 */               return false; 
/* 1101 */             Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1110 */             if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1111 */               return false; 
/* 1112 */             Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1113 */             if (f == null || f.getValue() != e.getValue())
/* 1114 */               return false; 
/* 1115 */             Byte2ReferenceRBTreeMap.this.remove(f.key);
/* 1116 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1120 */             return Byte2ReferenceRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1124 */             Byte2ReferenceRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2ReferenceMap.Entry<V> first() {
/* 1128 */             return Byte2ReferenceRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2ReferenceMap.Entry<V> last() {
/* 1132 */             return Byte2ReferenceRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) {
/* 1137 */             return Byte2ReferenceRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) {
/* 1141 */             return Byte2ReferenceRBTreeMap.this.headMap(to.getByteKey()).byte2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) {
/* 1145 */             return Byte2ReferenceRBTreeMap.this.tailMap(from.getByteKey()).byte2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1179 */       return new Byte2ReferenceRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1183 */       return new Byte2ReferenceRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1238 */             return (ObjectIterator<V>)new Byte2ReferenceRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1242 */             return Byte2ReferenceRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1246 */             return Byte2ReferenceRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1250 */             Byte2ReferenceRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1261 */     return new Submap((byte)0, true, to, false);
/*      */   }
/*      */   
/*      */   public Byte2ReferenceSortedMap<V> tailMap(byte from) {
/* 1265 */     return new Submap(from, false, (byte)0, true);
/*      */   }
/*      */   
...
/* 1313 */       if (!bottom && !top && Byte2ReferenceRBTreeMap.this.compare(from, to) > 0)
/* 1314 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1315 */       this.from = from;
/* 1316 */       this.bottom = bottom;
/* 1317 */       this.to = to;
/* 1318 */       this.top = top;
/* 1319 */       this.defRetValue = Byte2ReferenceRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1337 */       return ((this.bottom || Byte2ReferenceRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ReferenceRBTreeMap.this
/* 1338 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
/* 1342 */       if (this.entries == null)
/* 1343 */         this.entries = (ObjectSortedSet<Byte2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator() {
/* 1346 */               return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) {
/* 1351 */               return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() {
/* 1355 */               return Byte2ReferenceRBTreeMap.this.byte2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1363 */               if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1364 */                 return false; 
/* 1365 */               Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1366 */               return (f != null && Byte2ReferenceRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1374 */               if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1375 */                 return false; 
/* 1376 */               Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1377 */               if (f != null && Byte2ReferenceRBTreeMap.Submap.this.in(f.key))
/* 1378 */                 Byte2ReferenceRBTreeMap.Submap.this.remove(f.key); 
/* 1379 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1383 */               int c = 0;
/* 1384 */               for (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1385 */                 c++; 
/* 1386 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1390 */               return !(new Byte2ReferenceRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1394 */               Byte2ReferenceRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2ReferenceMap.Entry<V> first() {
/* 1398 */               return Byte2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2ReferenceMap.Entry<V> last() {
/* 1402 */               return Byte2ReferenceRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) {
/* 1407 */               return Byte2ReferenceRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) {
/* 1411 */               return Byte2ReferenceRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) {
/* 1415 */               return Byte2ReferenceRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ReferenceEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2ReferenceSortedMap<V>.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1423 */         return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1427 */         return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1442 */               return (ObjectIterator<V>)new Byte2ReferenceRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1446 */               return Byte2ReferenceRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1450 */               return Byte2ReferenceRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1454 */               Byte2ReferenceRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1462 */       return (in(k) && Byte2ReferenceRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(byte k) {
/* 1479 */       byte kk = k; Byte2ReferenceRBTreeMap.Entry<V> e;
/* 1480 */       return (in(kk) && (e = Byte2ReferenceRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(byte k, V v) {
/* 1484 */       Byte2ReferenceRBTreeMap.this.modified = false;
/* 1485 */       if (!in(k))
...
/* 1488 */       V oldValue = Byte2ReferenceRBTreeMap.this.put(k, v);
/* 1489 */       return Byte2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(byte k) {
/* 1494 */       Byte2ReferenceRBTreeMap.this.modified = false;
/* 1495 */       if (!in(k))
/* 1496 */         return this.defRetValue; 
/* 1497 */       V oldValue = Byte2ReferenceRBTreeMap.this.remove(k);
/* 1498 */       return Byte2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1516 */       return Byte2ReferenceRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2ReferenceSortedMap<V> headMap(byte to) {
/* 1520 */       if (this.top)
/* 1521 */         return new Submap(this.from, this.bottom, to, false); 
/* 1522 */       return (Byte2ReferenceRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2ReferenceSortedMap<V> tailMap(byte from) {
/* 1526 */       if (this.bottom)
/* 1527 */         return new Submap(from, false, this.to, this.top); 
/* 1528 */       return (Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) {
...
/* 1534 */       if (!this.top)
/* 1535 */         to = (Byte2ReferenceRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom)
/* 1537 */         from = (Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1549 */       if (Byte2ReferenceRBTreeMap.this.tree == null) {
/* 1550 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1554 */       if (this.bottom) {
/* 1555 */         e = Byte2ReferenceRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1557 */         e = Byte2ReferenceRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1559 */         if (Byte2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1560 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1564 */       if (e == null || (!this.top && Byte2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1565 */         return null; 
/* 1566 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2ReferenceRBTreeMap.Entry<V> e;
/* 1575 */       if (Byte2ReferenceRBTreeMap.this.tree == null) {
/* 1576 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1580 */       if (this.top) {
/* 1581 */         e = Byte2ReferenceRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1583 */         e = Byte2ReferenceRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1585 */         if (Byte2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1586 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1590 */       if (e == null || (!this.bottom && Byte2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1591 */         return null; 
/* 1592 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1596 */       Byte2ReferenceRBTreeMap.Entry<V> e = firstEntry();
/* 1597 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1603 */       Byte2ReferenceRBTreeMap.Entry<V> e = lastEntry();
/* 1604 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1619 */         this.next = Byte2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1622 */         this();
/* 1623 */         if (this.next != null)
/* 1624 */           if (!Byte2ReferenceRBTreeMap.Submap.this.bottom && Byte2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1625 */             this.prev = null;
/* 1626 */           } else if (!Byte2ReferenceRBTreeMap.Submap.this.top && Byte2ReferenceRBTreeMap.this.compare(k, (this.prev = Byte2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1627 */             this.next = null;
/*      */           } else {
/* 1629 */             this.next = Byte2ReferenceRBTreeMap.this.locateKey(k);
/* 1630 */             if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1641 */         if (!Byte2ReferenceRBTreeMap.Submap.this.bottom && this.prev != null && Byte2ReferenceRBTreeMap.this.compare(this.prev.key, Byte2ReferenceRBTreeMap.Submap.this.from) < 0)
/* 1642 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1646 */         this.next = this.next.next();
/* 1647 */         if (!Byte2ReferenceRBTreeMap.Submap.this.top && this.next != null && Byte2ReferenceRBTreeMap.this.compare(this.next.key, Byte2ReferenceRBTreeMap.Submap.this.to) >= 0)
/* 1648 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1730 */       c = (Byte2ReferenceRBTreeMap<V>)super.clone();
...
/* 1811 */     if (n == 1) {
/* 1812 */       Entry<V> entry = new Entry<>(s.readByte(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1823 */       Entry<V> entry = new Entry<>(s.readByte(), (V)s.readObject());
/* 1824 */       entry.black(true);
/* 1825 */       entry.right(new Entry<>(s.readByte(), (V)s.readObject()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceRBTreeMap.class
