...
/*  548 */     Long newValue = remappingFunction.apply(Byte.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  563 */     int pos = find(k);
/*  564 */     Long newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  640 */       return Byte2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public long getLongValue() {
/*  644 */       return Byte2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public long setValue(long v) {
/*  648 */       long oldValue = Byte2LongOpenHashMap.this.value[this.index];
/*  649 */       Byte2LongOpenHashMap.this.value[this.index] = v;
/*  650 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  660 */       return Byte.valueOf(Byte2LongOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  670 */       return Long.valueOf(Byte2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */         return false; 
/*  687 */       Map.Entry<Byte, Long> e = (Map.Entry<Byte, Long>)o;
/*  688 */       return (Byte2LongOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  692 */       return Byte2LongOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Byte2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/*  696 */       return Byte2LongOpenHashMap.this.key[this.index] + "=>" + Byte2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  706 */     int pos = Byte2LongOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  713 */     int last = -1;
/*      */     
/*  715 */     int c = Byte2LongOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  719 */     boolean mustReturnNullKey = Byte2LongOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  734 */         return this.last = Byte2LongOpenHashMap.this.n;
/*      */       } 
/*  736 */       byte[] key = Byte2LongOpenHashMap.this.key;
/*      */       while (true) {
/*  738 */         if (--this.pos < 0) {
/*      */           
/*  740 */           this.last = Integer.MIN_VALUE;
/*  741 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  742 */           int p = HashCommon.mix(k) & Byte2LongOpenHashMap.this.mask;
/*  743 */           while (k != key[p])
/*  744 */             p = p + 1 & Byte2LongOpenHashMap.this.mask; 
/*  745 */           return p;
/*      */         } 
...
/*  762 */       byte[] key = Byte2LongOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  764 */         pos = (last = pos) + 1 & Byte2LongOpenHashMap.this.mask;
/*      */         while (true) {
/*  766 */           if ((curr = key[pos]) == 0) {
/*  767 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  770 */           int slot = HashCommon.mix(curr) & Byte2LongOpenHashMap.this.mask;
/*  771 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  773 */           pos = pos + 1 & Byte2LongOpenHashMap.this.mask;
/*      */         } 
/*  775 */         if (pos < last) {
/*  776 */           if (this.wrapped == null)
/*  777 */             this.wrapped = new ByteArrayList(2); 
/*  778 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  780 */         key[last] = curr;
/*  781 */         Byte2LongOpenHashMap.this.value[last] = Byte2LongOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  785 */       if (this.last == -1)
/*  786 */         throw new IllegalStateException(); 
/*  787 */       if (this.last == Byte2LongOpenHashMap.this.n) {
/*  788 */         Byte2LongOpenHashMap.this.containsNullKey = false;
/*  789 */       } else if (this.pos >= 0) {
/*  790 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  793 */         Byte2LongOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  794 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  797 */       Byte2LongOpenHashMap.this.size--;
/*  798 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Byte2LongMap.Entry> { private Byte2LongOpenHashMap.MapEntry entry;
/*      */     
/*      */     public Byte2LongOpenHashMap.MapEntry next() {
/*  813 */       return this.entry = new Byte2LongOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  822 */       this.entry = new Byte2LongOpenHashMap.MapEntry();
...
/*  832 */       return new Byte2LongOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Byte2LongMap.Entry> fastIterator() {
/*  836 */       return new Byte2LongOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  844 */       if (e.getKey() == null || !(e.getKey() instanceof Byte))
/*  845 */         return false; 
/*  846 */       if (e.getValue() == null || !(e.getValue() instanceof Long))
/*  847 */         return false; 
/*  848 */       byte k = ((Byte)e.getKey()).byteValue();
/*  849 */       long v = ((Long)e.getValue()).longValue();
/*  850 */       if (k == 0) {
/*  851 */         return (Byte2LongOpenHashMap.this.containsNullKey && Byte2LongOpenHashMap.this.value[Byte2LongOpenHashMap.this.n] == v);
/*      */       }
/*  853 */       byte[] key = Byte2LongOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  856 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2LongOpenHashMap.this.mask]) == 0)
/*  857 */         return false; 
/*  858 */       if (k == curr) {
/*  859 */         return (Byte2LongOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  862 */         if ((curr = key[pos = pos + 1 & Byte2LongOpenHashMap.this.mask]) == 0)
/*  863 */           return false; 
/*  864 */         if (k == curr) {
/*  865 */           return (Byte2LongOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  874 */       if (e.getKey() == null || !(e.getKey() instanceof Byte))
/*  875 */         return false; 
/*  876 */       if (e.getValue() == null || !(e.getValue() instanceof Long))
/*  877 */         return false; 
/*  878 */       byte k = ((Byte)e.getKey()).byteValue();
/*  879 */       long v = ((Long)e.getValue()).longValue();
/*  880 */       if (k == 0) {
/*  881 */         if (Byte2LongOpenHashMap.this.containsNullKey && Byte2LongOpenHashMap.this.value[Byte2LongOpenHashMap.this.n] == v) {
/*  882 */           Byte2LongOpenHashMap.this.removeNullEntry();
/*  883 */           return true;
/*      */         } 
/*  885 */         return false;
/*      */       } 
/*      */       
/*  888 */       byte[] key = Byte2LongOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  891 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2LongOpenHashMap.this.mask]) == 0)
/*  892 */         return false; 
/*  893 */       if (curr == k) {
/*  894 */         if (Byte2LongOpenHashMap.this.value[pos] == v) {
/*  895 */           Byte2LongOpenHashMap.this.removeEntry(pos);
/*  896 */           return true;
/*      */         } 
/*  898 */         return false;
/*      */       } 
/*      */       while (true) {
/*  901 */         if ((curr = key[pos = pos + 1 & Byte2LongOpenHashMap.this.mask]) == 0)
/*  902 */           return false; 
/*  903 */         if (curr == k && 
/*  904 */           Byte2LongOpenHashMap.this.value[pos] == v) {
/*  905 */           Byte2LongOpenHashMap.this.removeEntry(pos);
/*  906 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  913 */       return Byte2LongOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  917 */       Byte2LongOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2LongMap.Entry> consumer) {
/*  922 */       if (Byte2LongOpenHashMap.this.containsNullKey)
/*  923 */         consumer.accept(new AbstractByte2LongMap.BasicEntry(Byte2LongOpenHashMap.this.key[Byte2LongOpenHashMap.this.n], Byte2LongOpenHashMap.this.value[Byte2LongOpenHashMap.this.n])); 
/*  924 */       for (int pos = Byte2LongOpenHashMap.this.n; pos-- != 0;) {
/*  925 */         if (Byte2LongOpenHashMap.this.key[pos] != 0)
/*  926 */           consumer.accept(new AbstractByte2LongMap.BasicEntry(Byte2LongOpenHashMap.this.key[pos], Byte2LongOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2LongMap.Entry> consumer) {
/*  931 */       AbstractByte2LongMap.BasicEntry entry = new AbstractByte2LongMap.BasicEntry();
/*  932 */       if (Byte2LongOpenHashMap.this.containsNullKey) {
/*  933 */         entry.key = Byte2LongOpenHashMap.this.key[Byte2LongOpenHashMap.this.n];
/*  934 */         entry.value = Byte2LongOpenHashMap.this.value[Byte2LongOpenHashMap.this.n];
/*  935 */         consumer.accept(entry);
/*      */       } 
/*  937 */       for (int pos = Byte2LongOpenHashMap.this.n; pos-- != 0;) {
/*  938 */         if (Byte2LongOpenHashMap.this.key[pos] != 0) {
/*  939 */           entry.key = Byte2LongOpenHashMap.this.key[pos];
/*  940 */           entry.value = Byte2LongOpenHashMap.this.value[pos];
...
/*  966 */       return Byte2LongOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractByteSet { private KeySet() {}
/*      */     
/*      */     public ByteIterator iterator() {
/*  972 */       return new Byte2LongOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  977 */       if (Byte2LongOpenHashMap.this.containsNullKey)
/*  978 */         consumer.accept(Byte2LongOpenHashMap.this.key[Byte2LongOpenHashMap.this.n]); 
/*  979 */       for (int pos = Byte2LongOpenHashMap.this.n; pos-- != 0; ) {
/*  980 */         byte k = Byte2LongOpenHashMap.this.key[pos];
/*  981 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/*  987 */       return Byte2LongOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(byte k) {
/*  991 */       return Byte2LongOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(byte k) {
/*  995 */       int oldSize = Byte2LongOpenHashMap.this.size;
/*  996 */       Byte2LongOpenHashMap.this.remove(k);
/*  997 */       return (Byte2LongOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1001 */       Byte2LongOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1025 */       return Byte2LongOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1034 */             return new Byte2LongOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1038 */             return Byte2LongOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(long v) {
/* 1042 */             return Byte2LongOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1046 */             Byte2LongOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(LongConsumer consumer)
/*      */           {
/* 1051 */             if (Byte2LongOpenHashMap.this.containsNullKey)
/* 1052 */               consumer.accept(Byte2LongOpenHashMap.this.value[Byte2LongOpenHashMap.this.n]); 
/* 1053 */             for (int pos = Byte2LongOpenHashMap.this.n; pos-- != 0;) {
/* 1054 */               if (Byte2LongOpenHashMap.this.key[pos] != 0)
/* 1055 */                 consumer.accept(Byte2LongOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1131 */     byte[] key = this.key;
/* 1132 */     long[] value = this.value;
/* 1133 */     int mask = newN - 1;
/* 1134 */     byte[] newKey = new byte[newN + 1];
/* 1135 */     long[] newValue = new long[newN + 1];
/* 1136 */     int i = this.n;
...
/*      */     try {
/* 1166 */       c = (Byte2LongOpenHashMap)super.clone();
...
/* 1175 */     c.value = (long[])this.value.clone();
/* 1176 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1192 */         i++; 
/* 1193 */       t = this.key[i];
/* 1194 */       t ^= HashCommon.long2int(this.value[i]);
/* 1195 */       h += t;
/* 1196 */       i++;
/*      */     } 
/*      */     
/* 1199 */     if (this.containsNullKey)
/* 1200 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1201 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1204 */     byte[] key = this.key;
/* 1205 */     long[] value = this.value;
/* 1206 */     MapIterator i = new MapIterator();
/* 1207 */     s.defaultWriteObject();
/* 1208 */     for (int j = this.size; j-- != 0; ) {
/* 1209 */       int e = i.nextEntry();
/* 1210 */       s.writeByte(key[e]);
/* 1211 */       s.writeLong(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1220 */     byte[] key = this.key = new byte[this.n + 1];
/* 1221 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1224 */     for (int i = this.size; i-- != 0; ) {
/* 1225 */       int pos; byte k = s.readByte();
/* 1226 */       long v = s.readLong();
/* 1227 */       if (k == 0) {
/* 1228 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2LongOpenHashMap.class
