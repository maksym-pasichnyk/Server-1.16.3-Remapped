...
/*  954 */         return false; 
/*  955 */       Map.Entry<Byte, Short> e = (Map.Entry<Byte, Short>)o;
/*  956 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Byte2ShortAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/* 1047 */       if ((this.next = Byte2ShortAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Byte2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Byte2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Byte2ShortMap.Entry>)new AbstractObjectSortedSet<Byte2ShortMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Byte2ShortMap.Entry>)new Byte2ShortAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Byte2ShortMap.Entry>)new Byte2ShortAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1186 */               return false; 
/* 1187 */             Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1188 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue())
/* 1189 */               return false; 
/* 1190 */             Byte2ShortAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Byte2ShortAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Byte2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2ShortMap.Entry first() {
/* 1203 */             return Byte2ShortAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2ShortMap.Entry last() {
/* 1207 */             return Byte2ShortAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry to) {
/* 1211 */             return Byte2ShortAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ShortEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry to) {
/* 1215 */             return Byte2ShortAVLTreeMap.this.headMap(to.getByteKey()).byte2ShortEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from) {
/* 1219 */             return Byte2ShortAVLTreeMap.this.tailMap(from.getByteKey()).byte2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Byte2ShortAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1257 */       return new Byte2ShortAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (ShortIterator)new Byte2ShortAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(short k) {
/* 1316 */             return Byte2ShortAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Byte2ShortAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Byte2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Byte2ShortAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Byte2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Byte2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ShortAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Byte2ShortMap.Entry>)new AbstractObjectSortedSet<Byte2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Byte2ShortMap.Entry>)new Byte2ShortAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Byte2ShortMap.Entry>)new Byte2ShortAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2ShortMap.Entry> comparator() {
/* 1428 */               return Byte2ShortAVLTreeMap.this.byte2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1441 */               return (f != null && Byte2ShortAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1454 */               if (f != null && Byte2ShortAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Byte2ShortAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Byte2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Byte2ShortAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Byte2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2ShortMap.Entry first() {
/* 1475 */               return Byte2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2ShortMap.Entry last() {
/* 1479 */               return Byte2ShortAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry to) {
/* 1484 */               return Byte2ShortAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ShortEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry to) {
/* 1488 */               return Byte2ShortAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2ShortEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from) {
/* 1492 */               return Byte2ShortAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2ShortSortedMap.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1500 */         return new Byte2ShortAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1504 */         return new Byte2ShortAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1519 */               return (ShortIterator)new Byte2ShortAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(short k) {
/* 1523 */               return Byte2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1527 */               return Byte2ShortAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1531 */               Byte2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1539 */       return (in(k) && Byte2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(byte k) {
/* 1556 */       byte kk = k; Byte2ShortAVLTreeMap.Entry e;
/* 1557 */       return (in(kk) && (e = Byte2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public short put(byte k, short v) {
/* 1561 */       Byte2ShortAVLTreeMap.this.modified = false;
/* 1562 */       if (!in(k))
...
/* 1565 */       short oldValue = Byte2ShortAVLTreeMap.this.put(k, v);
/* 1566 */       return Byte2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short remove(byte k) {
/* 1571 */       Byte2ShortAVLTreeMap.this.modified = false;
/* 1572 */       if (!in(k))
/* 1573 */         return this.defRetValue; 
/* 1574 */       short oldValue = Byte2ShortAVLTreeMap.this.remove(k);
/* 1575 */       return Byte2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1593 */       return Byte2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2ShortSortedMap headMap(byte to) {
/* 1597 */       if (this.top)
/* 1598 */         return new Submap(this.from, this.bottom, to, false); 
/* 1599 */       return (Byte2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2ShortSortedMap tailMap(byte from) {
/* 1603 */       if (this.bottom)
/* 1604 */         return new Submap(from, false, this.to, this.top); 
/* 1605 */       return (Byte2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2ShortSortedMap subMap(byte from, byte to) {
...
/* 1611 */       if (!this.top)
/* 1612 */         to = (Byte2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1613 */       if (!this.bottom)
/* 1614 */         from = (Byte2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1626 */       if (Byte2ShortAVLTreeMap.this.tree == null) {
/* 1627 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1631 */       if (this.bottom) {
/* 1632 */         e = Byte2ShortAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1634 */         e = Byte2ShortAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1636 */         if (Byte2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1637 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1641 */       if (e == null || (!this.top && Byte2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1642 */         return null; 
/* 1643 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2ShortAVLTreeMap.Entry e;
/* 1652 */       if (Byte2ShortAVLTreeMap.this.tree == null) {
/* 1653 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1657 */       if (this.top) {
/* 1658 */         e = Byte2ShortAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1660 */         e = Byte2ShortAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1662 */         if (Byte2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1663 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1667 */       if (e == null || (!this.bottom && Byte2ShortAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1668 */         return null; 
/* 1669 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1673 */       Byte2ShortAVLTreeMap.Entry e = firstEntry();
/* 1674 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1680 */       Byte2ShortAVLTreeMap.Entry e = lastEntry();
/* 1681 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1696 */         this.next = Byte2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1699 */         this();
/* 1700 */         if (this.next != null)
/* 1701 */           if (!Byte2ShortAVLTreeMap.Submap.this.bottom && Byte2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1702 */             this.prev = null;
/* 1703 */           } else if (!Byte2ShortAVLTreeMap.Submap.this.top && Byte2ShortAVLTreeMap.this.compare(k, (this.prev = Byte2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1704 */             this.next = null;
/*      */           } else {
/* 1706 */             this.next = Byte2ShortAVLTreeMap.this.locateKey(k);
/* 1707 */             if (Byte2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1718 */         if (!Byte2ShortAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2ShortAVLTreeMap.this.compare(this.prev.key, Byte2ShortAVLTreeMap.Submap.this.from) < 0)
/* 1719 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1723 */         this.next = this.next.next();
/* 1724 */         if (!Byte2ShortAVLTreeMap.Submap.this.top && this.next != null && Byte2ShortAVLTreeMap.this.compare(this.next.key, Byte2ShortAVLTreeMap.Submap.this.to) >= 0)
/* 1725 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1805 */       c = (Byte2ShortAVLTreeMap)super.clone();
...
/* 1886 */     if (n == 1) {
/* 1887 */       Entry entry = new Entry(s.readByte(), s.readShort());
...
/*      */ 
/*      */       
/* 1897 */       Entry entry = new Entry(s.readByte(), s.readShort());
/* 1898 */       entry.right(new Entry(s.readByte(), s.readShort()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortAVLTreeMap.class
