...
/*  293 */     byte[] key = this.key; while (true) {
/*      */       byte curr; int last;
...
/*  500 */     Character newValue = remappingFunction.apply(Byte.valueOf(k), Character.valueOf(this.value[pos]));
...
/*  515 */     int pos = find(k);
/*  516 */     Character newValue = remappingFunction.apply(Byte.valueOf(k), 
...
/*  567 */     Arrays.fill(this.key, (byte)0);
/*      */   }
/*      */   
/*      */   public int size() {
...
/*  593 */       return Byte2CharOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public char getCharValue() {
/*  597 */       return Byte2CharOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public char setValue(char v) {
/*  601 */       char oldValue = Byte2CharOpenHashMap.this.value[this.index];
/*  602 */       Byte2CharOpenHashMap.this.value[this.index] = v;
/*  603 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  613 */       return Byte.valueOf(Byte2CharOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  623 */       return Character.valueOf(Byte2CharOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  639 */         return false; 
/*  640 */       Map.Entry<Byte, Character> e = (Map.Entry<Byte, Character>)o;
/*  641 */       return (Byte2CharOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  645 */       return Byte2CharOpenHashMap.this.key[this.index] ^ Byte2CharOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  649 */       return Byte2CharOpenHashMap.this.key[this.index] + "=>" + Byte2CharOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  659 */     int pos = Byte2CharOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  666 */     int last = -1;
/*      */     
/*  668 */     int c = Byte2CharOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  672 */     boolean mustReturnNullKey = Byte2CharOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  687 */         return this.last = Byte2CharOpenHashMap.this.n;
/*      */       } 
/*  689 */       byte[] key = Byte2CharOpenHashMap.this.key;
/*      */       while (true) {
/*  691 */         if (--this.pos < 0) {
/*      */           
/*  693 */           this.last = Integer.MIN_VALUE;
/*  694 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  695 */           int p = HashCommon.mix(k) & Byte2CharOpenHashMap.this.mask;
/*  696 */           while (k != key[p])
/*  697 */             p = p + 1 & Byte2CharOpenHashMap.this.mask; 
/*  698 */           return p;
/*      */         } 
...
/*  715 */       byte[] key = Byte2CharOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  717 */         pos = (last = pos) + 1 & Byte2CharOpenHashMap.this.mask;
/*      */         while (true) {
/*  719 */           if ((curr = key[pos]) == 0) {
/*  720 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  723 */           int slot = HashCommon.mix(curr) & Byte2CharOpenHashMap.this.mask;
/*  724 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  726 */           pos = pos + 1 & Byte2CharOpenHashMap.this.mask;
/*      */         } 
/*  728 */         if (pos < last) {
/*  729 */           if (this.wrapped == null)
/*  730 */             this.wrapped = new ByteArrayList(2); 
/*  731 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  733 */         key[last] = curr;
/*  734 */         Byte2CharOpenHashMap.this.value[last] = Byte2CharOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  738 */       if (this.last == -1)
/*  739 */         throw new IllegalStateException(); 
/*  740 */       if (this.last == Byte2CharOpenHashMap.this.n) {
/*  741 */         Byte2CharOpenHashMap.this.containsNullKey = false;
/*  742 */       } else if (this.pos >= 0) {
/*  743 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  746 */         Byte2CharOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  747 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  750 */       Byte2CharOpenHashMap.this.size--;
/*  751 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Byte2CharMap.Entry> { private Byte2CharOpenHashMap.MapEntry entry;
/*      */     
/*      */     public Byte2CharOpenHashMap.MapEntry next() {
/*  766 */       return this.entry = new Byte2CharOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  775 */       this.entry = new Byte2CharOpenHashMap.MapEntry();
...
/*  785 */       return new Byte2CharOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Byte2CharMap.Entry> fastIterator() {
/*  789 */       return new Byte2CharOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  797 */       if (e.getKey() == null || !(e.getKey() instanceof Byte))
/*  798 */         return false; 
/*  799 */       if (e.getValue() == null || !(e.getValue() instanceof Character))
/*  800 */         return false; 
/*  801 */       byte k = ((Byte)e.getKey()).byteValue();
/*  802 */       char v = ((Character)e.getValue()).charValue();
/*  803 */       if (k == 0) {
/*  804 */         return (Byte2CharOpenHashMap.this.containsNullKey && Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n] == v);
/*      */       }
/*  806 */       byte[] key = Byte2CharOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  809 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2CharOpenHashMap.this.mask]) == 0)
/*  810 */         return false; 
/*  811 */       if (k == curr) {
/*  812 */         return (Byte2CharOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  815 */         if ((curr = key[pos = pos + 1 & Byte2CharOpenHashMap.this.mask]) == 0)
/*  816 */           return false; 
/*  817 */         if (k == curr) {
/*  818 */           return (Byte2CharOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  827 */       if (e.getKey() == null || !(e.getKey() instanceof Byte))
/*  828 */         return false; 
/*  829 */       if (e.getValue() == null || !(e.getValue() instanceof Character))
/*  830 */         return false; 
/*  831 */       byte k = ((Byte)e.getKey()).byteValue();
/*  832 */       char v = ((Character)e.getValue()).charValue();
/*  833 */       if (k == 0) {
/*  834 */         if (Byte2CharOpenHashMap.this.containsNullKey && Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n] == v) {
/*  835 */           Byte2CharOpenHashMap.this.removeNullEntry();
/*  836 */           return true;
/*      */         } 
/*  838 */         return false;
/*      */       } 
/*      */       
/*  841 */       byte[] key = Byte2CharOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  844 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2CharOpenHashMap.this.mask]) == 0)
/*  845 */         return false; 
/*  846 */       if (curr == k) {
/*  847 */         if (Byte2CharOpenHashMap.this.value[pos] == v) {
/*  848 */           Byte2CharOpenHashMap.this.removeEntry(pos);
/*  849 */           return true;
/*      */         } 
/*  851 */         return false;
/*      */       } 
/*      */       while (true) {
/*  854 */         if ((curr = key[pos = pos + 1 & Byte2CharOpenHashMap.this.mask]) == 0)
/*  855 */           return false; 
/*  856 */         if (curr == k && 
/*  857 */           Byte2CharOpenHashMap.this.value[pos] == v) {
/*  858 */           Byte2CharOpenHashMap.this.removeEntry(pos);
/*  859 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  866 */       return Byte2CharOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  870 */       Byte2CharOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2CharMap.Entry> consumer) {
/*  875 */       if (Byte2CharOpenHashMap.this.containsNullKey)
/*  876 */         consumer.accept(new AbstractByte2CharMap.BasicEntry(Byte2CharOpenHashMap.this.key[Byte2CharOpenHashMap.this.n], Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n])); 
/*  877 */       for (int pos = Byte2CharOpenHashMap.this.n; pos-- != 0;) {
/*  878 */         if (Byte2CharOpenHashMap.this.key[pos] != 0)
/*  879 */           consumer.accept(new AbstractByte2CharMap.BasicEntry(Byte2CharOpenHashMap.this.key[pos], Byte2CharOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2CharMap.Entry> consumer) {
/*  884 */       AbstractByte2CharMap.BasicEntry entry = new AbstractByte2CharMap.BasicEntry();
/*  885 */       if (Byte2CharOpenHashMap.this.containsNullKey) {
/*  886 */         entry.key = Byte2CharOpenHashMap.this.key[Byte2CharOpenHashMap.this.n];
/*  887 */         entry.value = Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n];
/*  888 */         consumer.accept(entry);
/*      */       } 
/*  890 */       for (int pos = Byte2CharOpenHashMap.this.n; pos-- != 0;) {
/*  891 */         if (Byte2CharOpenHashMap.this.key[pos] != 0) {
/*  892 */           entry.key = Byte2CharOpenHashMap.this.key[pos];
/*  893 */           entry.value = Byte2CharOpenHashMap.this.value[pos];
...
/*  919 */       return Byte2CharOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractByteSet { private KeySet() {}
/*      */     
/*      */     public ByteIterator iterator() {
/*  925 */       return new Byte2CharOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  930 */       if (Byte2CharOpenHashMap.this.containsNullKey)
/*  931 */         consumer.accept(Byte2CharOpenHashMap.this.key[Byte2CharOpenHashMap.this.n]); 
/*  932 */       for (int pos = Byte2CharOpenHashMap.this.n; pos-- != 0; ) {
/*  933 */         byte k = Byte2CharOpenHashMap.this.key[pos];
/*  934 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/*  940 */       return Byte2CharOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(byte k) {
/*  944 */       return Byte2CharOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(byte k) {
/*  948 */       int oldSize = Byte2CharOpenHashMap.this.size;
/*  949 */       Byte2CharOpenHashMap.this.remove(k);
/*  950 */       return (Byte2CharOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  954 */       Byte2CharOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*  978 */       return Byte2CharOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*  987 */             return new Byte2CharOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/*  991 */             return Byte2CharOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(char v) {
/*  995 */             return Byte2CharOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/*  999 */             Byte2CharOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1004 */             if (Byte2CharOpenHashMap.this.containsNullKey)
/* 1005 */               consumer.accept(Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n]); 
/* 1006 */             for (int pos = Byte2CharOpenHashMap.this.n; pos-- != 0;) {
/* 1007 */               if (Byte2CharOpenHashMap.this.key[pos] != 0)
/* 1008 */                 consumer.accept(Byte2CharOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1087 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1119 */       c = (Byte2CharOpenHashMap)super.clone();
...
/* 1127 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharOpenHashMap.class
