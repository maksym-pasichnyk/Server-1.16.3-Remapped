...
/* 1136 */     byte[] key = this.key;
/* 1137 */     int mask = newN - 1;
/* 1138 */     byte[] newKey = new byte[newN + 1];
...
/* 1144 */       int pos; if (this.strategy.equals(key[i], (byte)0)) {
/* 1145 */         pos = newN;
/*      */       } else {
/* 1147 */         pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask;
/* 1148 */         while (newKey[pos] != 0)
/* 1149 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1190 */       c = (ByteLinkedOpenCustomHashSet)super.clone();
/* 1191 */     } catch (CloneNotSupportedException cantHappen) {
/* 1192 */       throw new InternalError();
/*      */     } 
/* 1194 */     c.key = (byte[])this.key.clone();
...
/* 1222 */     ByteIterator i = iterator();
/* 1223 */     s.defaultWriteObject();
/* 1224 */     for (int j = this.size; j-- != 0;)
/* 1225 */       s.writeByte(i.nextByte()); 
/*      */   }
/*      */   
...
/* 1240 */       if (this.strategy.equals(k, (byte)0)) {
/* 1241 */         pos = this.n;
/* 1242 */         this.containsNull = true;
/*      */       }
/* 1244 */       else if (key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask] != 0) {
/* 1245 */         while (key[pos = pos + 1 & this.mask] != 0);
/*      */       } 
/* 1247 */       key[pos] = k;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\ByteLinkedOpenCustomHashSet.class
