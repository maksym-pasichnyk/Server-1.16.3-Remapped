...
/*  61 */     return (entries instanceof Byte2DoubleSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Byte2DoubleSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Byte2DoubleMap.Entry> entries = map.byte2DoubleEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Byte2DoubleSortedMap.FastSortedEntrySet)entries); return (entries instanceof Byte2DoubleSortedMap.FastSortedEntrySet) ? (Byte2DoubleSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Byte2DoubleMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Byte2DoubleMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Byte, Double>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Byte2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2DoubleSortedMap headMap(byte to) {
/* 132 */       return Byte2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2DoubleSortedMap tailMap(byte from) {
/* 137 */       return Byte2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Byte2DoubleMap.Entry>)ObjectSortedSets.singleton(new AbstractByte2DoubleMap.BasicEntry(this.key, this.value), 
/* 237 */             Byte2DoubleSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Byte2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Double>> entrySet() {
/* 249 */       return (ObjectSortedSet)byte2DoubleEntrySet();
/*     */     }
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Byte2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2DoubleSortedMap headMap(byte to) {
...
/* 268 */         return this; 
/* 269 */       return Byte2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Byte2DoubleSortedMap tailMap(byte from) {
...
/* 275 */         return this; 
/* 276 */       return Byte2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public byte firstByteKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.byteValue(), value.doubleValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Byte2DoubleMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.byte2DoubleEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Byte2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Byte, Double>> entrySet() {
/* 449 */       return (ObjectSortedSet)byte2DoubleEntrySet();
/*     */     }
/*     */     
/*     */     public ByteSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Byte2DoubleMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.byte2DoubleEntrySet()); 
/* 582 */       return (ObjectSortedSet<Byte2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2DoubleSortedMaps.class
