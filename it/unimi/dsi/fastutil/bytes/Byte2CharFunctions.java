...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Byte2CharFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Byte2CharFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 161 */     return new Singleton(key.byteValue(), value.charValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Byte2CharFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractByte2CharFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2CharFunction function;
/*     */     
...
/* 468 */       Character v = this.function.apply(Byte.valueOf(key));
/* 469 */       if (v == null)
...
/* 511 */     if (f instanceof Byte2CharFunction)
/* 512 */       return (Byte2CharFunction)f; 
/* 513 */     if (f instanceof IntUnaryOperator) {
/* 514 */       return key -> SafeMath.safeIntToChar(((IntUnaryOperator)f).applyAsInt(key));
/*     */     }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharFunctions.class
