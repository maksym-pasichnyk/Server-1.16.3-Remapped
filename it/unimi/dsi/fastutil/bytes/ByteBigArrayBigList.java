...
/* 130 */     this(a, 0L, ByteBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 151 */     this(length);
/* 152 */     ByteBigArrays.copy(a, offset, this.a, 0L, length);
...
/* 213 */     return wrap(a, ByteBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       return; 
/* 226 */     this.a = ByteBigArrays.forceCapacity(this.a, capacity, this.size);
/* 227 */     assert this.size <= ByteBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 239 */     long oldLength = ByteBigArrays.length(this.a);
...
/* 245 */       capacity = 10L;
/* 246 */     }  this.a = ByteBigArrays.forceCapacity(this.a, capacity, this.size);
/* 247 */     assert this.size <= ByteBigArrays.length(this.a);
/*     */   }
/*     */   
...
/* 254 */       ByteBigArrays.copy(this.a, index, this.a, index + 1L, this.size - index); 
/* 255 */     ByteBigArrays.set(this.a, index, k);
/* 256 */     this.size++;
/* 257 */     assert this.size <= ByteBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public boolean add(byte k) {
/* 261 */     grow(this.size + 1L);
/* 262 */     ByteBigArrays.set(this.a, this.size++, k);
/* 263 */     if (!$assertionsDisabled && this.size > ByteBigArrays.length(this.a)) throw new AssertionError(); 
/* 264 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 271 */     return ByteBigArrays.get(this.a, index);
/*     */   }
/*     */   
/*     */   public long indexOf(byte k) {
/* 275 */     for (long i = 0L; i < this.size; i++) {
/* 276 */       if (k == ByteBigArrays.get(this.a, i))
/* 277 */         return i; 
/* 278 */     }  return -1L;
/*     */   }
/*     */   
...
/* 283 */       if (k == ByteBigArrays.get(this.a, i))
/* 284 */         return i; 
/* 285 */     }  return -1L;
/*     */   }
/*     */   
...
/*     */     }
/* 292 */     byte old = ByteBigArrays.get(this.a, index);
/* 293 */     this.size--;
/* 294 */     if (index != this.size)
/* 295 */       ByteBigArrays.copy(this.a, index + 1L, this.a, index, this.size - index); 
/* 296 */     assert this.size <= ByteBigArrays.length(this.a);
/* 297 */     return old;
/*     */   }
/*     */   
...
/* 305 */     assert this.size <= ByteBigArrays.length(this.a);
/* 306 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 313 */     byte old = ByteBigArrays.get(this.a, index);
/* 314 */     ByteBigArrays.set(this.a, index, k);
/* 315 */     return old;
/*     */   }
/*     */   
...
/*     */   public void clear() {
/* 365 */     this.size = 0L;
/* 366 */     assert this.size <= ByteBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public long size64() {
...
/* 374 */     if (size > ByteBigArrays.length(this.a))
/* 375 */       ensureCapacity(size); 
/* 376 */     if (size > this.size)
/* 377 */       ByteBigArrays.fill(this.a, this.size, size, (byte)0); 
/* 378 */     this.size = size;
/*     */   }
/*     */   
...
/* 410 */     long arrayLength = ByteBigArrays.length(this.a);
/* 411 */     if (n >= arrayLength || this.size == arrayLength)
/*     */       return; 
/* 413 */     this.a = ByteBigArrays.trim(this.a, Math.max(n, this.size));
/* 414 */     assert this.size <= ByteBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 432 */     ByteBigArrays.copy(this.a, from, a, offset, length);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 445 */     ByteBigArrays.copy(this.a, to, this.a, from, this.size - to);
...
/* 463 */     ByteBigArrays.ensureOffsetLength(a, offset, length);
/* 464 */     grow(this.size + length);
/* 465 */     ByteBigArrays.copy(this.a, index, this.a, index + length, this.size - index);
/* 466 */     ByteBigArrays.copy(a, offset, this.a, index, length);
...
/* 486 */           return ByteBigArrays.get(ByteBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public byte previousByte() {
/* 490 */           if (!hasPrevious())
/* 491 */             throw new NoSuchElementException(); 
/* 492 */           return ByteBigArrays.get(ByteBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 531 */     ByteBigArrays.copy(this.a, 0L, c.a, 0L, this.size);
...
/* 554 */     byte[][] a2 = l.a;
/* 555 */     while (s-- != 0L) {
/* 556 */       if (ByteBigArrays.get(a1, s) != ByteBigArrays.get(a2, s))
/* 557 */         return false; 
/* 558 */     }  return true;
/*     */   }
/*     */ 
...
/* 579 */       byte e1 = ByteBigArrays.get(a1, i);
/* 580 */       byte e2 = ByteBigArrays.get(a2, i); int r;
...
/* 589 */       s.writeByte(ByteBigArrays.get(this.a, i)); 
/*     */   }
/*     */   
...
/* 596 */       ByteBigArrays.set(this.a, i, s.readByte()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\ByteBigArrayBigList.class
