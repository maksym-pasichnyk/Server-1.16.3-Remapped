...
/* 1736 */     byte[] key = this.key;
/* 1737 */     V[] value = this.value;
/* 1738 */     int mask = newN - 1;
/* 1739 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1794 */       c = (Byte2ObjectLinkedOpenHashMap<V>)super.clone();
...
/* 1802 */     c.key = (byte[])this.key.clone();
...
/* 1850 */     byte[] key = this.key = new byte[this.n + 1];
...
/* 1858 */       int pos; byte k = s.readByte();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ObjectLinkedOpenHashMap.class
