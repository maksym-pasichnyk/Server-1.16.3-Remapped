...
/* 1133 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
/*      */       {
/* 1135 */         while (newKey[pos = pos + 1 & mask] != 0); } 
...
/*      */     try {
/* 1161 */       c = (Byte2CharOpenCustomHashMap)super.clone();
...
/* 1169 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharOpenCustomHashMap.class
