...
/*  186 */       return ByteBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigListIterator iterator() {
/*  191 */       return ByteBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigListIterator listIterator(long i) {
/*  196 */       if (i == 0L)
/*  197 */         return ByteBigListIterators.EMPTY_BIG_LIST_ITERATOR; 
...
/*  208 */       ByteBigArrays.ensureOffsetLength(a, offset, length);
/*  209 */       if (from != 0L)
...
/*      */     
/*      */     public Object clone() {
/*  240 */       return ByteBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  244 */       return 1;
...
/*  256 */       return ByteBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  298 */       byte[] a = new byte[1];
/*  299 */       a[0] = this.element;
/*  300 */       return a;
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator() {
/*  304 */       return ByteBigListIterators.singleton(this.element);
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator(long i) {
/*  308 */       if (i > 1L || i < 0L)
/*  309 */         throw new IndexOutOfBoundsException(); 
/*  310 */       ByteBigListIterator l = listIterator();
/*  311 */       if (i == 1L)
/*  312 */         l.nextByte(); 
/*  313 */       return l;
/*      */     }
...
/*  324 */         return ByteBigLists.EMPTY_BIG_LIST; 
/*  325 */       return this;
/*      */     }
/*      */     
/*      */     public boolean addAll(long i, Collection<? extends Byte> c) {
...
/*  400 */     return new Singleton(((Byte)element).byteValue());
/*      */   }
/*      */   
...
/*  421 */         return this.list.getByte(i);
/*      */       } 
/*      */     }
/*      */     
...
/*  439 */         return this.list.removeByte(i);
/*      */       } 
/*      */     }
/*      */     
/*      */     public long indexOf(byte k) {
...
/*  517 */         return ByteBigLists.synchronize(this.list.subList(from, to), this.sync);
/*      */       } 
/*      */     }
/*      */     
/*      */     public boolean equals(Object o) {
...
/*      */     
/*      */     public byte getByte(long i) {
/*  672 */       return this.list.getByte(i);
/*      */     }
/*      */     
/*      */     public byte set(long i, byte k) {
...
/*      */     
/*      */     public ByteBigListIterator listIterator() {
/*  734 */       return ByteBigListIterators.unmodifiable(this.list.listIterator());
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator(long i) {
/*  738 */       return ByteBigListIterators.unmodifiable(this.list.listIterator(i));
/*      */     }
/*      */     
/*      */     public ByteBigList subList(long from, long to) {
/*  742 */       return ByteBigLists.unmodifiable(this.list.subList(from, to));
/*      */     }
/*      */     
/*      */     public boolean equals(Object o) {
/*  746 */       if (o == this)
...
/*      */   }
/*      */   
/*      */   public static class ListBigList extends AbstractByteBigList implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*      */     
/*      */     public ByteBigListIterator iterator() {
/*  865 */       return ByteBigListIterators.asBigListIterator(this.list.iterator());
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator() {
/*  869 */       return ByteBigListIterators.asBigListIterator(this.list.listIterator());
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator(long index) {
/*  873 */       return ByteBigListIterators.asBigListIterator(this.list.listIterator(intIndex(index)));
/*      */     }
/*      */     
/*      */     public boolean addAll(long index, Collection<? extends Byte> c) {
...
/*      */     
/*      */     public byte[] toByteArray() {
/*  889 */       return this.list.toByteArray();
/*      */     }
/*      */     
/*      */     public void removeElements(long from, long to) {
...
/*  944 */       return this.list.getByte(intIndex(index));
/*      */     }
/*      */     
/*      */     public long indexOf(byte k) {
...
/*  956 */       return this.list.removeByte(intIndex(index));
/*      */     }
/*      */     
/*      */     public byte set(long index, byte k) {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\ByteBigLists.class
