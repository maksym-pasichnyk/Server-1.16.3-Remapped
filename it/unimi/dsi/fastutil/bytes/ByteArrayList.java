...
/* 222 */     if (capacity <= this.a.length || this.a == ByteArrays.DEFAULT_EMPTY_ARRAY)
/*     */       return; 
...
/* 440 */     ByteIterator i = c.iterator();
/* 441 */     this.size += n;
/* 442 */     while (n-- != 0)
/* 443 */       this.a[index++] = i.nextByte(); 
...
/* 477 */       if (!c.contains(Byte.valueOf(a[i])))
/* 478 */         a[j++] = a[i]; 
...
/* 486 */     return new ByteListIterator() {
/* 487 */         int pos = index; int last = -1;
/*     */         
/*     */         public boolean hasNext() {
/* 490 */           return (this.pos < ByteArrayList.this.size);
/*     */         }
/*     */         
...
/* 500 */           return ByteArrayList.this.a[this.last = this.pos++];
/*     */         }
/*     */         
/*     */         public byte previousByte() {
/* 504 */           if (!hasPrevious())
/* 505 */             throw new NoSuchElementException(); 
/* 506 */           return ByteArrayList.this.a[this.last = --this.pos];
/*     */         }
/*     */         
...
/* 518 */           ByteArrayList.this.add(this.pos++, k);
/* 519 */           this.last = -1;
/*     */         }
/*     */         
...
/* 525 */           ByteArrayList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 529 */           if (this.last == -1)
/* 530 */             throw new IllegalStateException(); 
/* 531 */           ByteArrayList.this.removeByte(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 544 */     ByteArrayList c = new ByteArrayList(this.size);
...
/* 589 */     byte[] a1 = this.a, a2 = l.a;
/*     */     
/*     */     int i;
/* 592 */     for (i = 0; i < s1 && i < s2; i++) {
/* 593 */       byte e1 = a1[i];
/* 594 */       byte e2 = a2[i]; int r;
/* 595 */       if ((r = Byte.compare(e1, e2)) != 0)
/* 596 */         return r; 
/*     */     } 
...
/* 603 */       s.writeByte(this.a[i]); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 607 */     s.defaultReadObject();
/* 608 */     this.a = new byte[this.size];
/* 609 */     for (int i = 0; i < this.size; i++)
/* 610 */       this.a[i] = s.readByte(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\ByteArrayList.class
