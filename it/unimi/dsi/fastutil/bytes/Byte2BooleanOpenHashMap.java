...
/* 1085 */     byte[] key = this.key;
/* 1086 */     boolean[] value = this.value;
/* 1087 */     int mask = newN - 1;
/* 1088 */     byte[] newKey = new byte[newN + 1];
/* 1089 */     boolean[] newValue = new boolean[newN + 1];
/* 1090 */     int i = this.n;
/* 1091 */     for (int j = realSize(); j-- != 0; ) {
/* 1092 */       while (key[--i] == 0); int pos;
/* 1093 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != 0)
/* 1094 */         while (newKey[pos = pos + 1 & mask] != 0); 
...
/*      */     try {
/* 1120 */       c = (Byte2BooleanOpenHashMap)super.clone();
...
/* 1128 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2BooleanOpenHashMap.class
