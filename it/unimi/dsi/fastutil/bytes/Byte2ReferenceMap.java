...
/* 158 */     return (ObjectSet)byte2ReferenceEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 308 */     if (curValue != value || (curValue == defaultReturnValue() && !containsKey(key)))
/* 309 */       return false; 
/* 310 */     remove(key);
/* 311 */     return true;
/*     */   }
...
/* 331 */     if (curValue != oldValue || (curValue == defaultReturnValue() && !containsKey(key)))
/* 332 */       return false; 
...
/* 444 */       return drv; 
/* 445 */     V newValue = remappingFunction.apply(Byte.valueOf(key), oldValue);
...
/* 479 */     V newValue = remappingFunction.apply(Byte.valueOf(key), contained ? oldValue : null);
...
/*     */     @Deprecated
/*     */     default Byte getKey() {
/* 671 */       return Byte.valueOf(getByteKey());
/*     */     }
/*     */     
/*     */     byte getByteKey();
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceMap.class
