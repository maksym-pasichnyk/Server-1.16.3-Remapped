...
/* 1824 */     byte[] key = this.key;
/* 1825 */     double[] value = this.value;
/* 1826 */     int mask = newN - 1;
/* 1827 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1882 */       c = (Byte2DoubleLinkedOpenHashMap)super.clone();
...
/* 1890 */     c.key = (byte[])this.key.clone();
...
/* 1937 */     byte[] key = this.key = new byte[this.n + 1];
...
/* 1945 */       int pos; byte k = s.readByte();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2DoubleLinkedOpenHashMap.class
