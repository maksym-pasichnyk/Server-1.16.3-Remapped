...
/*  892 */       return (this.key == ((Byte)e.getKey()).byteValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  978 */     int index = 0;
/*      */     TreeIterator() {
/*  980 */       this.next = Byte2ObjectRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/*  983 */       if ((this.next = Byte2ObjectRBTreeMap.this.locateKey(k)) != null)
/*  984 */         if (Byte2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1035 */       updatePrevious();
/* 1036 */       updateNext();
/* 1037 */       Byte2ObjectRBTreeMap.this.remove(this.curr.key);
/* 1038 */       this.curr = null;
/*      */     }
...
/* 1077 */       this.entries = (ObjectSortedSet<Byte2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1086 */             return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from) {
/* 1091 */             return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1100 */               return false; 
/* 1101 */             Byte2ObjectRBTreeMap.Entry<V> f = Byte2ObjectRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1111 */               return false; 
/* 1112 */             Byte2ObjectRBTreeMap.Entry<V> f = Byte2ObjectRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1113 */             if (f == null || !Objects.equals(f.getValue(), e.getValue()))
/* 1114 */               return false; 
/* 1115 */             Byte2ObjectRBTreeMap.this.remove(f.key);
/* 1116 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1120 */             return Byte2ObjectRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1124 */             Byte2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2ObjectMap.Entry<V> first() {
/* 1128 */             return Byte2ObjectRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2ObjectMap.Entry<V> last() {
/* 1132 */             return Byte2ObjectRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> to) {
/* 1137 */             return Byte2ObjectRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to) {
/* 1141 */             return Byte2ObjectRBTreeMap.this.headMap(to.getByteKey()).byte2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from) {
/* 1145 */             return Byte2ObjectRBTreeMap.this.tailMap(from.getByteKey()).byte2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1179 */       return new Byte2ObjectRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1183 */       return new Byte2ObjectRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1238 */             return (ObjectIterator<V>)new Byte2ObjectRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1242 */             return Byte2ObjectRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1246 */             return Byte2ObjectRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1250 */             Byte2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1313 */       if (!bottom && !top && Byte2ObjectRBTreeMap.this.compare(from, to) > 0)
/* 1314 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1315 */       this.from = from;
/* 1316 */       this.bottom = bottom;
/* 1317 */       this.to = to;
/* 1318 */       this.top = top;
/* 1319 */       this.defRetValue = Byte2ObjectRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1337 */       return ((this.bottom || Byte2ObjectRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ObjectRBTreeMap.this
/* 1338 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
/* 1342 */       if (this.entries == null)
/* 1343 */         this.entries = (ObjectSortedSet<Byte2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator() {
/* 1346 */               return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from) {
/* 1351 */               return (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>>)new Byte2ObjectRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2ObjectMap.Entry<V>> comparator() {
/* 1355 */               return Byte2ObjectRBTreeMap.this.byte2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1364 */                 return false; 
/* 1365 */               Byte2ObjectRBTreeMap.Entry<V> f = Byte2ObjectRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1366 */               return (f != null && Byte2ObjectRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1375 */                 return false; 
/* 1376 */               Byte2ObjectRBTreeMap.Entry<V> f = Byte2ObjectRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1377 */               if (f != null && Byte2ObjectRBTreeMap.Submap.this.in(f.key))
/* 1378 */                 Byte2ObjectRBTreeMap.Submap.this.remove(f.key); 
/* 1379 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1383 */               int c = 0;
/* 1384 */               for (ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1385 */                 c++; 
/* 1386 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1390 */               return !(new Byte2ObjectRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1394 */               Byte2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2ObjectMap.Entry<V> first() {
/* 1398 */               return Byte2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2ObjectMap.Entry<V> last() {
/* 1402 */               return Byte2ObjectRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> to) {
/* 1407 */               return Byte2ObjectRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to) {
/* 1411 */               return Byte2ObjectRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from) {
/* 1415 */               return Byte2ObjectRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ObjectEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2ObjectSortedMap<V>.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1423 */         return new Byte2ObjectRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1427 */         return new Byte2ObjectRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1442 */               return (ObjectIterator<V>)new Byte2ObjectRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1446 */               return Byte2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1450 */               return Byte2ObjectRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1454 */               Byte2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1462 */       return (in(k) && Byte2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(byte k) {
/* 1479 */       byte kk = k; Byte2ObjectRBTreeMap.Entry<V> e;
/* 1480 */       return (in(kk) && (e = Byte2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(byte k, V v) {
/* 1484 */       Byte2ObjectRBTreeMap.this.modified = false;
/* 1485 */       if (!in(k))
...
/* 1488 */       V oldValue = Byte2ObjectRBTreeMap.this.put(k, v);
/* 1489 */       return Byte2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(byte k) {
/* 1494 */       Byte2ObjectRBTreeMap.this.modified = false;
/* 1495 */       if (!in(k))
/* 1496 */         return this.defRetValue; 
/* 1497 */       V oldValue = Byte2ObjectRBTreeMap.this.remove(k);
/* 1498 */       return Byte2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1516 */       return Byte2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2ObjectSortedMap<V> headMap(byte to) {
/* 1520 */       if (this.top)
/* 1521 */         return new Submap(this.from, this.bottom, to, false); 
/* 1522 */       return (Byte2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2ObjectSortedMap<V> tailMap(byte from) {
/* 1526 */       if (this.bottom)
/* 1527 */         return new Submap(from, false, this.to, this.top); 
/* 1528 */       return (Byte2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2ObjectSortedMap<V> subMap(byte from, byte to) {
...
/* 1534 */       if (!this.top)
/* 1535 */         to = (Byte2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom)
/* 1537 */         from = (Byte2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1549 */       if (Byte2ObjectRBTreeMap.this.tree == null) {
/* 1550 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1554 */       if (this.bottom) {
/* 1555 */         e = Byte2ObjectRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1557 */         e = Byte2ObjectRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1559 */         if (Byte2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1560 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1564 */       if (e == null || (!this.top && Byte2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1565 */         return null; 
/* 1566 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2ObjectRBTreeMap.Entry<V> e;
/* 1575 */       if (Byte2ObjectRBTreeMap.this.tree == null) {
/* 1576 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1580 */       if (this.top) {
/* 1581 */         e = Byte2ObjectRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1583 */         e = Byte2ObjectRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1585 */         if (Byte2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1586 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1590 */       if (e == null || (!this.bottom && Byte2ObjectRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1591 */         return null; 
/* 1592 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1596 */       Byte2ObjectRBTreeMap.Entry<V> e = firstEntry();
/* 1597 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1603 */       Byte2ObjectRBTreeMap.Entry<V> e = lastEntry();
/* 1604 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1619 */         this.next = Byte2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1622 */         this();
/* 1623 */         if (this.next != null)
/* 1624 */           if (!Byte2ObjectRBTreeMap.Submap.this.bottom && Byte2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1625 */             this.prev = null;
/* 1626 */           } else if (!Byte2ObjectRBTreeMap.Submap.this.top && Byte2ObjectRBTreeMap.this.compare(k, (this.prev = Byte2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1627 */             this.next = null;
/*      */           } else {
/* 1629 */             this.next = Byte2ObjectRBTreeMap.this.locateKey(k);
/* 1630 */             if (Byte2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1641 */         if (!Byte2ObjectRBTreeMap.Submap.this.bottom && this.prev != null && Byte2ObjectRBTreeMap.this.compare(this.prev.key, Byte2ObjectRBTreeMap.Submap.this.from) < 0)
/* 1642 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1646 */         this.next = this.next.next();
/* 1647 */         if (!Byte2ObjectRBTreeMap.Submap.this.top && this.next != null && Byte2ObjectRBTreeMap.this.compare(this.next.key, Byte2ObjectRBTreeMap.Submap.this.to) >= 0)
/* 1648 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1730 */       c = (Byte2ObjectRBTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ObjectRBTreeMap.class
