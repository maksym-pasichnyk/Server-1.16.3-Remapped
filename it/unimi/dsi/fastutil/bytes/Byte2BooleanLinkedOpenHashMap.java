...
/* 1767 */     byte[] key = this.key;
/* 1768 */     boolean[] value = this.value;
/* 1769 */     int mask = newN - 1;
/* 1770 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1825 */       c = (Byte2BooleanLinkedOpenHashMap)super.clone();
...
/* 1833 */     c.key = (byte[])this.key.clone();
...
/* 1880 */     byte[] key = this.key = new byte[this.n + 1];
...
/* 1888 */       int pos; byte k = s.readByte();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2BooleanLinkedOpenHashMap.class
