...
/*     */     
/*     */     public Object clone() {
/*  75 */       return ByteIterators.EMPTY_ITERATOR;
/*     */     }
/*     */     private Object readResolve() {
/*  78 */       return ByteIterators.EMPTY_ITERATOR;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 215 */     ByteArrays.ensureOffsetLength(array, offset, length);
...
/* 300 */     byte[] array = new byte[16];
/* 301 */     int j = 0;
/* 302 */     while (max-- != 0 && i.hasNext()) {
/* 303 */       if (j == array.length)
/* 304 */         array = ByteArrays.grow(array, j + 1); 
/* 305 */       array[j++] = i.nextByte();
/*     */     } 
/* 307 */     return ByteArrays.trim(array, j);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 444 */     ByteArrayList l = new ByteArrayList();
/* 445 */     pour(i, l, max);
/* 446 */     l.trim();
/* 447 */     return l;
/*     */   }
...
/*     */     
/*     */     public byte nextByte() {
/* 480 */       return ((Byte)this.i.next()).byteValue();
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/* 503 */     if (i instanceof ByteIterator)
/* 504 */       return (ByteIterator)i; 
...
/* 530 */       this.i.set(Byte.valueOf(k));
/*     */     }
/*     */     
/*     */     public void add(byte k) {
/* 534 */       this.i.add(Byte.valueOf(k));
/*     */     }
/*     */     
/*     */     public void remove() {
/* 538 */       this.i.remove();
...
/*     */     
/*     */     public byte nextByte() {
/* 542 */       return ((Byte)this.i.next()).byteValue();
/*     */     }
/*     */     
/*     */     public byte previousByte() {
/* 546 */       return ((Byte)this.i.previous()).byteValue();
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/* 569 */     if (i instanceof ByteListIterator)
/* 570 */       return (ByteListIterator)i; 
...
/* 580 */         return true; 
/* 581 */       if (!predicate.test(iterator.nextByte()))
/* 582 */         return false; 
/*     */     } 
...
/* 587 */       if (predicate.test(iterator.nextByte()))
/* 588 */         return i; 
/*     */     } 
/* 590 */     return -1;
/*     */   }
...
/* 611 */       this.curr = (byte)(this.curr + 1); return this.curr;
/*     */     }
/*     */     
/*     */     public byte previousByte() {
/* 615 */       if (!hasPrevious())
/* 616 */         throw new NoSuchElementException(); 
/* 617 */       return this.curr = (byte)(this.curr - 1);
/*     */     }
/*     */     
/*     */     public int nextIndex() {
...
/* 630 */         this.curr = (byte)(this.curr + n);
/* 631 */         return n;
/*     */       } 
...
/* 640 */         this.curr = (byte)(this.curr - n);
/* 641 */         return n;
/*     */       } 
...
/* 691 */       byte next = this.a[this.lastOffset = this.offset].nextByte();
/* 692 */       advance();
/* 693 */       return next;
/*     */     }
/*     */     
...
/*     */     
/*     */     public byte nextByte() {
/* 790 */       return this.i.nextByte();
/*     */     }
/*     */     
/*     */     public byte previousByte() {
/* 794 */       return this.i.previousByte();
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     public byte nextByte() {
/* 825 */       return this.i.nextByte();
/*     */     }
/*     */     
/*     */     public byte previousByte() {
/* 829 */       return this.i.previousByte();
/*     */     }
/*     */     
/*     */     public int nextIndex() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\ByteIterators.class
