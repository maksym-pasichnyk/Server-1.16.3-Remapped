...
/*  50 */     return (entries instanceof Byte2CharMap.FastEntrySet) ? (
/*  51 */       (Byte2CharMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Byte2CharMap.Entry> entries = map.byte2CharEntrySet();
/*  71 */     if (entries instanceof Byte2CharMap.FastEntrySet) {
/*  72 */       ((Byte2CharMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Byte2CharMap.Entry> entries = map.byte2CharEntrySet();
/*  91 */     return (entries instanceof Byte2CharMap.FastEntrySet) ? new ObjectIterable<Byte2CharMap.Entry>() {
/*     */         public ObjectIterator<Byte2CharMap.Entry> iterator() {
/*  93 */           return ((Byte2CharMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Byte2CharMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Byte2CharMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractByte2CharMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)byte2CharEntrySet();
/*     */     }
/*     */     
/*     */     public ByteSet keySet() {
...
/* 300 */     return new Singleton(key.byteValue(), value.charValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.byte2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, Character>> entrySet() {
/* 361 */       return (ObjectSet)byte2CharEntrySet();
/*     */     }
/*     */     
/*     */     public ByteSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.byte2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Byte, Character>> entrySet() {
/* 674 */       return (ObjectSet)byte2CharEntrySet();
/*     */     }
/*     */     
/*     */     public ByteSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharMaps.class
