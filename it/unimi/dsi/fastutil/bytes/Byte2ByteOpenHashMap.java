...
/*  548 */     Byte newValue = remappingFunction.apply(Byte.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  563 */     int pos = find(k);
/*  564 */     Byte newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  640 */       return Byte2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/*  644 */       return Byte2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/*  648 */       byte oldValue = Byte2ByteOpenHashMap.this.value[this.index];
/*  649 */       Byte2ByteOpenHashMap.this.value[this.index] = v;
/*  650 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  660 */       return Byte.valueOf(Byte2ByteOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  670 */       return Byte.valueOf(Byte2ByteOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */         return false; 
/*  687 */       Map.Entry<Byte, Byte> e = (Map.Entry<Byte, Byte>)o;
/*  688 */       return (Byte2ByteOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  692 */       return Byte2ByteOpenHashMap.this.key[this.index] ^ Byte2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  696 */       return Byte2ByteOpenHashMap.this.key[this.index] + "=>" + Byte2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  706 */     int pos = Byte2ByteOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  713 */     int last = -1;
/*      */     
/*  715 */     int c = Byte2ByteOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  719 */     boolean mustReturnNullKey = Byte2ByteOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  734 */         return this.last = Byte2ByteOpenHashMap.this.n;
/*      */       } 
/*  736 */       byte[] key = Byte2ByteOpenHashMap.this.key;
/*      */       while (true) {
/*  738 */         if (--this.pos < 0) {
/*      */           
/*  740 */           this.last = Integer.MIN_VALUE;
/*  741 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  742 */           int p = HashCommon.mix(k) & Byte2ByteOpenHashMap.this.mask;
/*  743 */           while (k != key[p])
/*  744 */             p = p + 1 & Byte2ByteOpenHashMap.this.mask; 
/*  745 */           return p;
/*      */         } 
...
/*  762 */       byte[] key = Byte2ByteOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  764 */         pos = (last = pos) + 1 & Byte2ByteOpenHashMap.this.mask;
/*      */         while (true) {
/*  766 */           if ((curr = key[pos]) == 0) {
/*  767 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  770 */           int slot = HashCommon.mix(curr) & Byte2ByteOpenHashMap.this.mask;
/*  771 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  773 */           pos = pos + 1 & Byte2ByteOpenHashMap.this.mask;
/*      */         } 
/*  775 */         if (pos < last) {
...
/*      */         } 
/*  780 */         key[last] = curr;
/*  781 */         Byte2ByteOpenHashMap.this.value[last] = Byte2ByteOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  785 */       if (this.last == -1)
/*  786 */         throw new IllegalStateException(); 
/*  787 */       if (this.last == Byte2ByteOpenHashMap.this.n) {
/*  788 */         Byte2ByteOpenHashMap.this.containsNullKey = false;
/*  789 */       } else if (this.pos >= 0) {
/*  790 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  793 */         Byte2ByteOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  794 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  797 */       Byte2ByteOpenHashMap.this.size--;
/*  798 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Byte2ByteMap.Entry> { private Byte2ByteOpenHashMap.MapEntry entry;
/*      */     
/*      */     public Byte2ByteOpenHashMap.MapEntry next() {
/*  813 */       return this.entry = new Byte2ByteOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  822 */       this.entry = new Byte2ByteOpenHashMap.MapEntry();
...
/*  832 */       return new Byte2ByteOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Byte2ByteMap.Entry> fastIterator() {
/*  836 */       return new Byte2ByteOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  850 */       if (k == 0) {
/*  851 */         return (Byte2ByteOpenHashMap.this.containsNullKey && Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n] == v);
/*      */       }
/*  853 */       byte[] key = Byte2ByteOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  856 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ByteOpenHashMap.this.mask]) == 0)
/*  857 */         return false; 
/*  858 */       if (k == curr) {
/*  859 */         return (Byte2ByteOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  862 */         if ((curr = key[pos = pos + 1 & Byte2ByteOpenHashMap.this.mask]) == 0)
/*  863 */           return false; 
/*  864 */         if (k == curr) {
/*  865 */           return (Byte2ByteOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  880 */       if (k == 0) {
/*  881 */         if (Byte2ByteOpenHashMap.this.containsNullKey && Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n] == v) {
/*  882 */           Byte2ByteOpenHashMap.this.removeNullEntry();
/*  883 */           return true;
/*      */         } 
/*  885 */         return false;
/*      */       } 
/*      */       
/*  888 */       byte[] key = Byte2ByteOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  891 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ByteOpenHashMap.this.mask]) == 0)
/*  892 */         return false; 
/*  893 */       if (curr == k) {
/*  894 */         if (Byte2ByteOpenHashMap.this.value[pos] == v) {
/*  895 */           Byte2ByteOpenHashMap.this.removeEntry(pos);
/*  896 */           return true;
/*      */         } 
/*  898 */         return false;
/*      */       } 
/*      */       while (true) {
/*  901 */         if ((curr = key[pos = pos + 1 & Byte2ByteOpenHashMap.this.mask]) == 0)
/*  902 */           return false; 
/*  903 */         if (curr == k && 
/*  904 */           Byte2ByteOpenHashMap.this.value[pos] == v) {
/*  905 */           Byte2ByteOpenHashMap.this.removeEntry(pos);
/*  906 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  913 */       return Byte2ByteOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  917 */       Byte2ByteOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
/*  922 */       if (Byte2ByteOpenHashMap.this.containsNullKey)
/*  923 */         consumer.accept(new AbstractByte2ByteMap.BasicEntry(Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.n], Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n])); 
/*  924 */       for (int pos = Byte2ByteOpenHashMap.this.n; pos-- != 0;) {
/*  925 */         if (Byte2ByteOpenHashMap.this.key[pos] != 0)
/*  926 */           consumer.accept(new AbstractByte2ByteMap.BasicEntry(Byte2ByteOpenHashMap.this.key[pos], Byte2ByteOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
/*  931 */       AbstractByte2ByteMap.BasicEntry entry = new AbstractByte2ByteMap.BasicEntry();
/*  932 */       if (Byte2ByteOpenHashMap.this.containsNullKey) {
/*  933 */         entry.key = Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.n];
/*  934 */         entry.value = Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n];
/*  935 */         consumer.accept(entry);
/*      */       } 
/*  937 */       for (int pos = Byte2ByteOpenHashMap.this.n; pos-- != 0;) {
/*  938 */         if (Byte2ByteOpenHashMap.this.key[pos] != 0) {
/*  939 */           entry.key = Byte2ByteOpenHashMap.this.key[pos];
/*  940 */           entry.value = Byte2ByteOpenHashMap.this.value[pos];
...
/*  966 */       return Byte2ByteOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractByteSet { private KeySet() {}
/*      */     
/*      */     public ByteIterator iterator() {
/*  972 */       return new Byte2ByteOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  977 */       if (Byte2ByteOpenHashMap.this.containsNullKey)
/*  978 */         consumer.accept(Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.n]); 
/*  979 */       for (int pos = Byte2ByteOpenHashMap.this.n; pos-- != 0; ) {
/*  980 */         byte k = Byte2ByteOpenHashMap.this.key[pos];
/*  981 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/*  987 */       return Byte2ByteOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(byte k) {
/*  991 */       return Byte2ByteOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(byte k) {
/*  995 */       int oldSize = Byte2ByteOpenHashMap.this.size;
/*  996 */       Byte2ByteOpenHashMap.this.remove(k);
/*  997 */       return (Byte2ByteOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1001 */       Byte2ByteOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*      */   {
/*      */     public byte nextByte() {
/* 1025 */       return Byte2ByteOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public ByteCollection values() {
/* 1030 */     if (this.values == null)
/* 1031 */       this.values = new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1034 */             return new Byte2ByteOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1038 */             return Byte2ByteOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1042 */             return Byte2ByteOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1046 */             Byte2ByteOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1051 */             if (Byte2ByteOpenHashMap.this.containsNullKey)
/* 1052 */               consumer.accept(Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n]); 
/* 1053 */             for (int pos = Byte2ByteOpenHashMap.this.n; pos-- != 0;) {
/* 1054 */               if (Byte2ByteOpenHashMap.this.key[pos] != 0)
/* 1055 */                 consumer.accept(Byte2ByteOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1166 */       c = (Byte2ByteOpenHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ByteOpenHashMap.class
