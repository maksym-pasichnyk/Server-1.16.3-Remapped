...
/*  548 */     Float newValue = remappingFunction.apply(Byte.valueOf(k), Float.valueOf(this.value[pos]));
...
/*  563 */     int pos = find(k);
/*  564 */     Float newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Float.valueOf(this.value[pos]) : null);
...
/*  640 */       return Byte2FloatOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public float getFloatValue() {
/*  644 */       return Byte2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public float setValue(float v) {
/*  648 */       float oldValue = Byte2FloatOpenHashMap.this.value[this.index];
/*  649 */       Byte2FloatOpenHashMap.this.value[this.index] = v;
/*  650 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  660 */       return Byte.valueOf(Byte2FloatOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  670 */       return Float.valueOf(Byte2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */         return false; 
/*  687 */       Map.Entry<Byte, Float> e = (Map.Entry<Byte, Float>)o;
/*  688 */       return (Byte2FloatOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && 
/*  689 */         Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  693 */       return Byte2FloatOpenHashMap.this.key[this.index] ^ HashCommon.float2int(Byte2FloatOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/*  697 */       return Byte2FloatOpenHashMap.this.key[this.index] + "=>" + Byte2FloatOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  707 */     int pos = Byte2FloatOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  714 */     int last = -1;
/*      */     
/*  716 */     int c = Byte2FloatOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  720 */     boolean mustReturnNullKey = Byte2FloatOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  735 */         return this.last = Byte2FloatOpenHashMap.this.n;
/*      */       } 
/*  737 */       byte[] key = Byte2FloatOpenHashMap.this.key;
/*      */       while (true) {
/*  739 */         if (--this.pos < 0) {
/*      */           
/*  741 */           this.last = Integer.MIN_VALUE;
/*  742 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  743 */           int p = HashCommon.mix(k) & Byte2FloatOpenHashMap.this.mask;
/*  744 */           while (k != key[p])
/*  745 */             p = p + 1 & Byte2FloatOpenHashMap.this.mask; 
/*  746 */           return p;
/*      */         } 
...
/*  763 */       byte[] key = Byte2FloatOpenHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  765 */         pos = (last = pos) + 1 & Byte2FloatOpenHashMap.this.mask;
/*      */         while (true) {
/*  767 */           if ((curr = key[pos]) == 0) {
/*  768 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  771 */           int slot = HashCommon.mix(curr) & Byte2FloatOpenHashMap.this.mask;
/*  772 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  774 */           pos = pos + 1 & Byte2FloatOpenHashMap.this.mask;
/*      */         } 
/*  776 */         if (pos < last) {
...
/*      */         } 
/*  781 */         key[last] = curr;
/*  782 */         Byte2FloatOpenHashMap.this.value[last] = Byte2FloatOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  786 */       if (this.last == -1)
/*  787 */         throw new IllegalStateException(); 
/*  788 */       if (this.last == Byte2FloatOpenHashMap.this.n) {
/*  789 */         Byte2FloatOpenHashMap.this.containsNullKey = false;
/*  790 */       } else if (this.pos >= 0) {
/*  791 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  794 */         Byte2FloatOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  795 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  798 */       Byte2FloatOpenHashMap.this.size--;
/*  799 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Byte2FloatMap.Entry> { private Byte2FloatOpenHashMap.MapEntry entry;
/*      */     
/*      */     public Byte2FloatOpenHashMap.MapEntry next() {
/*  814 */       return this.entry = new Byte2FloatOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  823 */       this.entry = new Byte2FloatOpenHashMap.MapEntry();
...
/*  833 */       return new Byte2FloatOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Byte2FloatMap.Entry> fastIterator() {
/*  837 */       return new Byte2FloatOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  851 */       if (k == 0) {
/*  852 */         return (Byte2FloatOpenHashMap.this.containsNullKey && 
/*  853 */           Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       }
/*  855 */       byte[] key = Byte2FloatOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  858 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2FloatOpenHashMap.this.mask]) == 0)
/*  859 */         return false; 
/*  860 */       if (k == curr) {
/*  861 */         return (Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       }
/*      */       while (true) {
/*  864 */         if ((curr = key[pos = pos + 1 & Byte2FloatOpenHashMap.this.mask]) == 0)
/*  865 */           return false; 
/*  866 */         if (k == curr) {
/*  867 */           return (Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  882 */       if (k == 0) {
/*  883 */         if (Byte2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v)) {
/*  884 */           Byte2FloatOpenHashMap.this.removeNullEntry();
/*  885 */           return true;
/*      */         } 
/*  887 */         return false;
/*      */       } 
/*      */       
/*  890 */       byte[] key = Byte2FloatOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  893 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2FloatOpenHashMap.this.mask]) == 0)
/*  894 */         return false; 
/*  895 */       if (curr == k) {
/*  896 */         if (Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/*  897 */           Byte2FloatOpenHashMap.this.removeEntry(pos);
/*  898 */           return true;
/*      */         } 
/*  900 */         return false;
/*      */       } 
/*      */       while (true) {
/*  903 */         if ((curr = key[pos = pos + 1 & Byte2FloatOpenHashMap.this.mask]) == 0)
/*  904 */           return false; 
/*  905 */         if (curr == k && 
/*  906 */           Float.floatToIntBits(Byte2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/*  907 */           Byte2FloatOpenHashMap.this.removeEntry(pos);
/*  908 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  915 */       return Byte2FloatOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  919 */       Byte2FloatOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
/*  924 */       if (Byte2FloatOpenHashMap.this.containsNullKey)
/*  925 */         consumer.accept(new AbstractByte2FloatMap.BasicEntry(Byte2FloatOpenHashMap.this.key[Byte2FloatOpenHashMap.this.n], Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n])); 
/*  926 */       for (int pos = Byte2FloatOpenHashMap.this.n; pos-- != 0;) {
/*  927 */         if (Byte2FloatOpenHashMap.this.key[pos] != 0)
/*  928 */           consumer.accept(new AbstractByte2FloatMap.BasicEntry(Byte2FloatOpenHashMap.this.key[pos], Byte2FloatOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
/*  933 */       AbstractByte2FloatMap.BasicEntry entry = new AbstractByte2FloatMap.BasicEntry();
/*  934 */       if (Byte2FloatOpenHashMap.this.containsNullKey) {
/*  935 */         entry.key = Byte2FloatOpenHashMap.this.key[Byte2FloatOpenHashMap.this.n];
/*  936 */         entry.value = Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n];
/*  937 */         consumer.accept(entry);
/*      */       } 
/*  939 */       for (int pos = Byte2FloatOpenHashMap.this.n; pos-- != 0;) {
/*  940 */         if (Byte2FloatOpenHashMap.this.key[pos] != 0) {
/*  941 */           entry.key = Byte2FloatOpenHashMap.this.key[pos];
/*  942 */           entry.value = Byte2FloatOpenHashMap.this.value[pos];
...
/*  968 */       return Byte2FloatOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractByteSet { private KeySet() {}
/*      */     
/*      */     public ByteIterator iterator() {
/*  974 */       return new Byte2FloatOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  979 */       if (Byte2FloatOpenHashMap.this.containsNullKey)
/*  980 */         consumer.accept(Byte2FloatOpenHashMap.this.key[Byte2FloatOpenHashMap.this.n]); 
/*  981 */       for (int pos = Byte2FloatOpenHashMap.this.n; pos-- != 0; ) {
/*  982 */         byte k = Byte2FloatOpenHashMap.this.key[pos];
/*  983 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/*  989 */       return Byte2FloatOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(byte k) {
/*  993 */       return Byte2FloatOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(byte k) {
/*  997 */       int oldSize = Byte2FloatOpenHashMap.this.size;
/*  998 */       Byte2FloatOpenHashMap.this.remove(k);
/*  999 */       return (Byte2FloatOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1003 */       Byte2FloatOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1027 */       return Byte2FloatOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1036 */             return new Byte2FloatOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1040 */             return Byte2FloatOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(float v) {
/* 1044 */             return Byte2FloatOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1048 */             Byte2FloatOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(DoubleConsumer consumer)
/*      */           {
/* 1053 */             if (Byte2FloatOpenHashMap.this.containsNullKey)
/* 1054 */               consumer.accept(Byte2FloatOpenHashMap.this.value[Byte2FloatOpenHashMap.this.n]); 
/* 1055 */             for (int pos = Byte2FloatOpenHashMap.this.n; pos-- != 0;) {
/* 1056 */               if (Byte2FloatOpenHashMap.this.key[pos] != 0)
/* 1057 */                 consumer.accept(Byte2FloatOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1133 */     byte[] key = this.key;
/* 1134 */     float[] value = this.value;
/* 1135 */     int mask = newN - 1;
/* 1136 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1168 */       c = (Byte2FloatOpenHashMap)super.clone();
...
/* 1176 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2FloatOpenHashMap.class
