...
/*  903 */     Short newValue = remappingFunction.apply(Byte.valueOf(k), Short.valueOf(this.value[pos]));
...
/*  918 */     int pos = find(k);
/*  919 */     Short newValue = remappingFunction.apply(Byte.valueOf(k), (pos >= 0) ? Short.valueOf(this.value[pos]) : null);
...
/*  996 */       return Byte2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public short getShortValue() {
/* 1000 */       return Byte2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public short setValue(short v) {
/* 1004 */       short oldValue = Byte2ShortLinkedOpenHashMap.this.value[this.index];
/* 1005 */       Byte2ShortLinkedOpenHashMap.this.value[this.index] = v;
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/* 1016 */       return Byte.valueOf(Byte2ShortLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       return Short.valueOf(Byte2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1042 */         return false; 
/* 1043 */       Map.Entry<Byte, Short> e = (Map.Entry<Byte, Short>)o;
/* 1044 */       return (Byte2ShortLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1048 */       return Byte2ShortLinkedOpenHashMap.this.key[this.index] ^ Byte2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1052 */       return Byte2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */       this.next = Byte2ShortLinkedOpenHashMap.this.first;
/* 1216 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(byte from) {
/* 1219 */       if (from == 0) {
/* 1220 */         if (Byte2ShortLinkedOpenHashMap.this.containsNullKey) {
/* 1221 */           this.next = (int)Byte2ShortLinkedOpenHashMap.this.link[Byte2ShortLinkedOpenHashMap.this.n];
/* 1222 */           this.prev = Byte2ShortLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1225 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1227 */       if (Byte2ShortLinkedOpenHashMap.this.key[Byte2ShortLinkedOpenHashMap.this.last] == from) {
/* 1228 */         this.prev = Byte2ShortLinkedOpenHashMap.this.last;
/* 1229 */         this.index = Byte2ShortLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1233 */       int pos = HashCommon.mix(from) & Byte2ShortLinkedOpenHashMap.this.mask;
/*      */       
/* 1235 */       while (Byte2ShortLinkedOpenHashMap.this.key[pos] != 0) {
/* 1236 */         if (Byte2ShortLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1238 */           this.next = (int)Byte2ShortLinkedOpenHashMap.this.link[pos];
/* 1239 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1242 */         pos = pos + 1 & Byte2ShortLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1259 */       if (this.next == -1) {
/* 1260 */         this.index = Byte2ShortLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1263 */       int pos = Byte2ShortLinkedOpenHashMap.this.first;
/* 1264 */       this.index = 1;
/* 1265 */       while (pos != this.prev) {
/* 1266 */         pos = (int)Byte2ShortLinkedOpenHashMap.this.link[pos];
/* 1267 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1282 */       this.next = (int)Byte2ShortLinkedOpenHashMap.this.link[this.curr];
...
/* 1292 */       this.prev = (int)(Byte2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1307 */         this.index--;
/* 1308 */         this.prev = (int)(Byte2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1310 */         this.next = (int)Byte2ShortLinkedOpenHashMap.this.link[this.curr];
/* 1311 */       }  Byte2ShortLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1316 */       if (this.prev == -1) {
/* 1317 */         Byte2ShortLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1319 */         Byte2ShortLinkedOpenHashMap.this.link[this.prev] = Byte2ShortLinkedOpenHashMap.this.link[this.prev] ^ (Byte2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1320 */       }  if (this.next == -1) {
/* 1321 */         Byte2ShortLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1323 */         Byte2ShortLinkedOpenHashMap.this.link[this.next] = Byte2ShortLinkedOpenHashMap.this.link[this.next] ^ (Byte2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1324 */       }  int pos = this.curr;
/* 1325 */       this.curr = -1;
/* 1326 */       if (pos == Byte2ShortLinkedOpenHashMap.this.n) {
/* 1327 */         Byte2ShortLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1330 */         byte[] key = Byte2ShortLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           byte curr;
/*      */           int last;
/* 1334 */           pos = (last = pos) + 1 & Byte2ShortLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1336 */             if ((curr = key[pos]) == 0) {
/* 1337 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1340 */             int slot = HashCommon.mix(curr) & Byte2ShortLinkedOpenHashMap.this.mask;
/* 1341 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1343 */             pos = pos + 1 & Byte2ShortLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1345 */           key[last] = curr;
/* 1346 */           Byte2ShortLinkedOpenHashMap.this.value[last] = Byte2ShortLinkedOpenHashMap.this.value[pos];
/* 1347 */           if (this.next == pos)
/* 1348 */             this.next = last; 
/* 1349 */           if (this.prev == pos)
/* 1350 */             this.prev = last; 
/* 1351 */           Byte2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Byte2ShortMap.Entry> { private Byte2ShortLinkedOpenHashMap.MapEntry entry;
/*      */     
...
/* 1383 */       return this.entry = new Byte2ShortLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Byte2ShortLinkedOpenHashMap.MapEntry previous() {
/* 1387 */       return this.entry = new Byte2ShortLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1391 */       super.remove();
...
/*      */ 
/*      */   
/* 1396 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Byte2ShortMap.Entry> { final Byte2ShortLinkedOpenHashMap.MapEntry entry = new Byte2ShortLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Byte2ShortMap.Entry> implements Byte2ShortSortedMap.FastSortedEntrySet { public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator() {
/* 1416 */       return (ObjectBidirectionalIterator<Byte2ShortMap.Entry>)new Byte2ShortLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     private MapEntrySet() {}
...
/* 1437 */       if (Byte2ShortLinkedOpenHashMap.this.size == 0)
/* 1438 */         throw new NoSuchElementException(); 
/* 1439 */       return new Byte2ShortLinkedOpenHashMap.MapEntry(Byte2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Byte2ShortMap.Entry last() {
/* 1443 */       if (Byte2ShortLinkedOpenHashMap.this.size == 0)
/* 1444 */         throw new NoSuchElementException(); 
/* 1445 */       return new Byte2ShortLinkedOpenHashMap.MapEntry(Byte2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1459 */       if (k == 0) {
/* 1460 */         return (Byte2ShortLinkedOpenHashMap.this.containsNullKey && Byte2ShortLinkedOpenHashMap.this.value[Byte2ShortLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1462 */       byte[] key = Byte2ShortLinkedOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1465 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ShortLinkedOpenHashMap.this.mask]) == 0)
/* 1466 */         return false; 
/* 1467 */       if (k == curr) {
/* 1468 */         return (Byte2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1471 */         if ((curr = key[pos = pos + 1 & Byte2ShortLinkedOpenHashMap.this.mask]) == 0)
/* 1472 */           return false; 
/* 1473 */         if (k == curr) {
/* 1474 */           return (Byte2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1489 */       if (k == 0) {
/* 1490 */         if (Byte2ShortLinkedOpenHashMap.this.containsNullKey && Byte2ShortLinkedOpenHashMap.this.value[Byte2ShortLinkedOpenHashMap.this.n] == v) {
/* 1491 */           Byte2ShortLinkedOpenHashMap.this.removeNullEntry();
/* 1492 */           return true;
/*      */         } 
/* 1494 */         return false;
/*      */       } 
/*      */       
/* 1497 */       byte[] key = Byte2ShortLinkedOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1500 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ShortLinkedOpenHashMap.this.mask]) == 0)
/* 1501 */         return false; 
/* 1502 */       if (curr == k) {
/* 1503 */         if (Byte2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1504 */           Byte2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1505 */           return true;
/*      */         } 
/* 1507 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1510 */         if ((curr = key[pos = pos + 1 & Byte2ShortLinkedOpenHashMap.this.mask]) == 0)
/* 1511 */           return false; 
/* 1512 */         if (curr == k && 
/* 1513 */           Byte2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1514 */           Byte2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1515 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1522 */       return Byte2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1526 */       Byte2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1541 */       return new Byte2ShortLinkedOpenHashMap.EntryIterator(from.getByteKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1552 */       return new Byte2ShortLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1567 */       return new Byte2ShortLinkedOpenHashMap.FastEntryIterator(from.getByteKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
/* 1572 */       for (int i = Byte2ShortLinkedOpenHashMap.this.size, next = Byte2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1573 */         int curr = next;
/* 1574 */         next = (int)Byte2ShortLinkedOpenHashMap.this.link[curr];
/* 1575 */         consumer.accept(new AbstractByte2ShortMap.BasicEntry(Byte2ShortLinkedOpenHashMap.this.key[curr], Byte2ShortLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
/* 1581 */       AbstractByte2ShortMap.BasicEntry entry = new AbstractByte2ShortMap.BasicEntry();
/* 1582 */       for (int i = Byte2ShortLinkedOpenHashMap.this.size, next = Byte2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1583 */         int curr = next;
/* 1584 */         next = (int)Byte2ShortLinkedOpenHashMap.this.link[curr];
/* 1585 */         entry.key = Byte2ShortLinkedOpenHashMap.this.key[curr];
/* 1586 */         entry.value = Byte2ShortLinkedOpenHashMap.this.value[curr];
...
/* 1612 */       return Byte2ShortLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
...
/* 1619 */       return Byte2ShortLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractByteSortedSet { private KeySet() {}
/*      */     
/*      */     public ByteListIterator iterator(byte from) {
/* 1625 */       return new Byte2ShortLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ByteListIterator iterator() {
/* 1629 */       return new Byte2ShortLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1634 */       if (Byte2ShortLinkedOpenHashMap.this.containsNullKey)
/* 1635 */         consumer.accept(Byte2ShortLinkedOpenHashMap.this.key[Byte2ShortLinkedOpenHashMap.this.n]); 
/* 1636 */       for (int pos = Byte2ShortLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1637 */         byte k = Byte2ShortLinkedOpenHashMap.this.key[pos];
/* 1638 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/* 1644 */       return Byte2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(byte k) {
/* 1648 */       return Byte2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(byte k) {
/* 1652 */       int oldSize = Byte2ShortLinkedOpenHashMap.this.size;
/* 1653 */       Byte2ShortLinkedOpenHashMap.this.remove(k);
/* 1654 */       return (Byte2ShortLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1658 */       Byte2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public byte firstByte() {
/* 1662 */       if (Byte2ShortLinkedOpenHashMap.this.size == 0)
/* 1663 */         throw new NoSuchElementException(); 
/* 1664 */       return Byte2ShortLinkedOpenHashMap.this.key[Byte2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public byte lastByte() {
/* 1668 */       if (Byte2ShortLinkedOpenHashMap.this.size == 0)
/* 1669 */         throw new NoSuchElementException(); 
/* 1670 */       return Byte2ShortLinkedOpenHashMap.this.key[Byte2ShortLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public ByteComparator comparator() {
/* 1674 */       return null;
...
/* 1707 */       return Byte2ShortLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1714 */       return Byte2ShortLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1723 */             return (ShortIterator)new Byte2ShortLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1727 */             return Byte2ShortLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(short v) {
/* 1731 */             return Byte2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1735 */             Byte2ShortLinkedOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1740 */             if (Byte2ShortLinkedOpenHashMap.this.containsNullKey)
/* 1741 */               consumer.accept(Byte2ShortLinkedOpenHashMap.this.value[Byte2ShortLinkedOpenHashMap.this.n]); 
/* 1742 */             for (int pos = Byte2ShortLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1743 */               if (Byte2ShortLinkedOpenHashMap.this.key[pos] != 0)
/* 1744 */                 consumer.accept(Byte2ShortLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1878 */       c = (Byte2ShortLinkedOpenHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortLinkedOpenHashMap.class
