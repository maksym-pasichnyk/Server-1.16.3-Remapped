...
/* 1134 */     double[] value = this.value;
/* 1135 */     int mask = newN - 1;
/* 1136 */     byte[] newKey = new byte[newN + 1];
/* 1137 */     double[] newValue = new double[newN + 1];
/* 1138 */     int i = this.n;
...
/*      */     try {
/* 1168 */       c = (Byte2DoubleOpenHashMap)super.clone();
...
/* 1177 */     c.value = (double[])this.value.clone();
/* 1178 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */         i++; 
/* 1195 */       t = this.key[i];
/* 1196 */       t ^= HashCommon.double2int(this.value[i]);
/* 1197 */       h += t;
/* 1198 */       i++;
/*      */     } 
/*      */     
/* 1201 */     if (this.containsNullKey)
/* 1202 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1203 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1206 */     byte[] key = this.key;
/* 1207 */     double[] value = this.value;
...
/* 1223 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1226 */     for (int i = this.size; i-- != 0; ) {
/* 1227 */       int pos; byte k = s.readByte();
/* 1228 */       double v = s.readDouble();
/* 1229 */       if (k == 0) {
/* 1230 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2DoubleOpenHashMap.class
