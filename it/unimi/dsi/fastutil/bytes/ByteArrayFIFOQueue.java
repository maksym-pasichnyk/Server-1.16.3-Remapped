...
/*  62 */     this.array = new byte[Math.max(1, capacity)];
...
/*  85 */     byte t = this.array[this.start];
...
/* 103 */     byte t = this.array[--this.end];
/* 104 */     reduce();
/* 105 */     return t;
/*     */   }
/*     */   
/*     */   private final void resize(int size, int newLength) {
/* 109 */     byte[] newArray = new byte[newLength];
...
/*     */   public void trim() {
/* 171 */     int size = size();
/* 172 */     byte[] newArray = new byte[size + 1];
...
/* 202 */     this.array = new byte[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
/* 203 */     for (int i = 0; i < this.end; i++)
/* 204 */       this.array[i] = s.readByte(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\ByteArrayFIFOQueue.class
