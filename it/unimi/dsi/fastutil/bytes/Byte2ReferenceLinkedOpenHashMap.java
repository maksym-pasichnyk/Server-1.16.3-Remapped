...
/*  931 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public V getValue() {
/*  935 */       return Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public V setValue(V v) {
/*  939 */       V oldValue = Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  940 */       Byte2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  941 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  951 */       return Byte.valueOf(Byte2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */     
...
/*  959 */       return (Byte2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue() && Byte2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  963 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index] ^ ((Byte2ReferenceLinkedOpenHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Byte2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */     
/*      */     public String toString() {
/*  967 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1130 */       this.next = Byte2ReferenceLinkedOpenHashMap.this.first;
/* 1131 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(byte from) {
/* 1134 */       if (from == 0) {
/* 1135 */         if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey) {
/* 1136 */           this.next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[Byte2ReferenceLinkedOpenHashMap.this.n];
/* 1137 */           this.prev = Byte2ReferenceLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1140 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1142 */       if (Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.last] == from) {
/* 1143 */         this.prev = Byte2ReferenceLinkedOpenHashMap.this.last;
/* 1144 */         this.index = Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1148 */       int pos = HashCommon.mix(from) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */       
/* 1150 */       while (Byte2ReferenceLinkedOpenHashMap.this.key[pos] != 0) {
/* 1151 */         if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1153 */           this.next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1154 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1157 */         pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1174 */       if (this.next == -1) {
/* 1175 */         this.index = Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1178 */       int pos = Byte2ReferenceLinkedOpenHashMap.this.first;
/* 1179 */       this.index = 1;
/* 1180 */       while (pos != this.prev) {
/* 1181 */         pos = (int)Byte2ReferenceLinkedOpenHashMap.this.link[pos];
/* 1182 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1197 */       this.next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[this.curr];
...
/* 1207 */       this.prev = (int)(Byte2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1222 */         this.index--;
/* 1223 */         this.prev = (int)(Byte2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1225 */         this.next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[this.curr];
/* 1226 */       }  Byte2ReferenceLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1231 */       if (this.prev == -1) {
/* 1232 */         Byte2ReferenceLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1234 */         Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] = Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ (Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1235 */       }  if (this.next == -1) {
/* 1236 */         Byte2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1238 */         Byte2ReferenceLinkedOpenHashMap.this.link[this.next] = Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1239 */       }  int pos = this.curr;
/* 1240 */       this.curr = -1;
/* 1241 */       if (pos == Byte2ReferenceLinkedOpenHashMap.this.n) {
/* 1242 */         Byte2ReferenceLinkedOpenHashMap.this.containsNullKey = false;
/* 1243 */         Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1246 */         byte[] key = Byte2ReferenceLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           byte curr;
/*      */           int last;
/* 1250 */           pos = (last = pos) + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1252 */             if ((curr = key[pos]) == 0) {
/* 1253 */               key[last] = 0;
/* 1254 */               Byte2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*      */               return;
/*      */             } 
/* 1257 */             int slot = HashCommon.mix(curr) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/* 1258 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1260 */             pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1262 */           key[last] = curr;
/* 1263 */           Byte2ReferenceLinkedOpenHashMap.this.value[last] = Byte2ReferenceLinkedOpenHashMap.this.value[pos];
/* 1264 */           if (this.next == pos)
/* 1265 */             this.next = last; 
/* 1266 */           if (this.prev == pos)
/* 1267 */             this.prev = last; 
/* 1268 */           Byte2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> { private Byte2ReferenceLinkedOpenHashMap<V>.MapEntry entry;
/*      */     
...
/* 1300 */       return this.entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Byte2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/* 1304 */       return this.entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1308 */       super.remove();
...
/*      */ 
/*      */   
/* 1313 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> { final Byte2ReferenceLinkedOpenHashMap<V>.MapEntry entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>> implements Byte2ReferenceSortedMap.FastSortedEntrySet<V> { private MapEntrySet() {}
/*      */     
/*      */     public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator() {
/* 1335 */       return (ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>>)new Byte2ReferenceLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     
...
/* 1356 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0)
/* 1357 */         throw new NoSuchElementException(); 
/* 1358 */       return new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Byte2ReferenceMap.Entry<V> last() {
/* 1362 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0)
/* 1363 */         throw new NoSuchElementException(); 
/* 1364 */       return new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1372 */       if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1373 */         return false; 
/* 1374 */       byte k = ((Byte)e.getKey()).byteValue();
/* 1375 */       V v = (V)e.getValue();
/* 1376 */       if (k == 0) {
/* 1377 */         return (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey && Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1379 */       byte[] key = Byte2ReferenceLinkedOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1382 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ReferenceLinkedOpenHashMap.this.mask]) == 0)
/* 1383 */         return false; 
/* 1384 */       if (k == curr) {
/* 1385 */         return (Byte2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1388 */         if ((curr = key[pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask]) == 0)
/* 1389 */           return false; 
/* 1390 */         if (k == curr) {
/* 1391 */           return (Byte2ReferenceLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1404 */       if (k == 0) {
/* 1405 */         if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey && Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n] == v) {
/* 1406 */           Byte2ReferenceLinkedOpenHashMap.this.removeNullEntry();
/* 1407 */           return true;
/*      */         } 
/* 1409 */         return false;
/*      */       } 
/*      */       
/* 1412 */       byte[] key = Byte2ReferenceLinkedOpenHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/* 1415 */       if ((curr = key[pos = HashCommon.mix(k) & Byte2ReferenceLinkedOpenHashMap.this.mask]) == 0)
/* 1416 */         return false; 
/* 1417 */       if (curr == k) {
/* 1418 */         if (Byte2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1419 */           Byte2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1420 */           return true;
/*      */         } 
/* 1422 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1425 */         if ((curr = key[pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask]) == 0)
/* 1426 */           return false; 
/* 1427 */         if (curr == k && 
/* 1428 */           Byte2ReferenceLinkedOpenHashMap.this.value[pos] == v) {
/* 1429 */           Byte2ReferenceLinkedOpenHashMap.this.removeEntry(pos);
/* 1430 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1437 */       return Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1441 */       Byte2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1456 */       return new Byte2ReferenceLinkedOpenHashMap.EntryIterator(from.getByteKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1467 */       return new Byte2ReferenceLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1482 */       return new Byte2ReferenceLinkedOpenHashMap.FastEntryIterator(from.getByteKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
/* 1487 */       for (int i = Byte2ReferenceLinkedOpenHashMap.this.size, next = Byte2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1488 */         int curr = next;
/* 1489 */         next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1490 */         consumer.accept(new AbstractByte2ReferenceMap.BasicEntry<>(Byte2ReferenceLinkedOpenHashMap.this.key[curr], Byte2ReferenceLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
/* 1496 */       AbstractByte2ReferenceMap.BasicEntry<V> entry = new AbstractByte2ReferenceMap.BasicEntry<>();
/* 1497 */       for (int i = Byte2ReferenceLinkedOpenHashMap.this.size, next = Byte2ReferenceLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1498 */         int curr = next;
/* 1499 */         next = (int)Byte2ReferenceLinkedOpenHashMap.this.link[curr];
/* 1500 */         entry.key = Byte2ReferenceLinkedOpenHashMap.this.key[curr];
/* 1501 */         entry.value = Byte2ReferenceLinkedOpenHashMap.this.value[curr];
...
/* 1527 */       return Byte2ReferenceLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
...
/* 1534 */       return Byte2ReferenceLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractByteSortedSet { private KeySet() {}
/*      */     
/*      */     public ByteListIterator iterator(byte from) {
/* 1540 */       return new Byte2ReferenceLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ByteListIterator iterator() {
/* 1544 */       return new Byte2ReferenceLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1549 */       if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey)
/* 1550 */         consumer.accept(Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.n]); 
/* 1551 */       for (int pos = Byte2ReferenceLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1552 */         byte k = Byte2ReferenceLinkedOpenHashMap.this.key[pos];
/* 1553 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/* 1559 */       return Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(byte k) {
/* 1563 */       return Byte2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(byte k) {
/* 1567 */       int oldSize = Byte2ReferenceLinkedOpenHashMap.this.size;
/* 1568 */       Byte2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1569 */       return (Byte2ReferenceLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1573 */       Byte2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public byte firstByte() {
/* 1577 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0)
/* 1578 */         throw new NoSuchElementException(); 
/* 1579 */       return Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public byte lastByte() {
/* 1583 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0)
/* 1584 */         throw new NoSuchElementException(); 
/* 1585 */       return Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public ByteComparator comparator() {
/* 1589 */       return null;
...
/*      */   {
/*      */     public V previous() {
/* 1622 */       return Byte2ReferenceLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*      */     public V next() {
/* 1629 */       return Byte2ReferenceLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1638 */             return (ObjectIterator<V>)new Byte2ReferenceLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1642 */             return Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(Object v) {
/* 1646 */             return Byte2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1650 */             Byte2ReferenceLinkedOpenHashMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer) {
/* 1655 */             if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey)
/* 1656 */               consumer.accept(Byte2ReferenceLinkedOpenHashMap.this.value[Byte2ReferenceLinkedOpenHashMap.this.n]); 
/* 1657 */             for (int pos = Byte2ReferenceLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1658 */               if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] != 0)
/* 1659 */                 consumer.accept(Byte2ReferenceLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1735 */     byte[] key = this.key;
/* 1736 */     V[] value = this.value;
/* 1737 */     int mask = newN - 1;
/* 1738 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1793 */       c = (Byte2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* 1801 */     c.key = (byte[])this.key.clone();
...
/* 1849 */     byte[] key = this.key = new byte[this.n + 1];
...
/* 1857 */       int pos; byte k = s.readByte();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceLinkedOpenHashMap.class
