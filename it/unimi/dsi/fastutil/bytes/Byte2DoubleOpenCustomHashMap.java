...
/*      */   
/*      */   public boolean trim() {
/* 1122 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1155 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1156 */       return true; 
/*      */     try {
/* 1158 */       rehash(l);
...
/* 1178 */     byte[] key = this.key;
/* 1179 */     double[] value = this.value;
/* 1180 */     int mask = newN - 1;
/* 1181 */     byte[] newKey = new byte[newN + 1];
/* 1182 */     double[] newValue = new double[newN + 1];
/* 1183 */     int i = this.n;
/* 1184 */     for (int j = realSize(); j-- != 0; ) {
/* 1185 */       while (key[--i] == 0); int pos;
/* 1186 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
/*      */       {
/* 1188 */         while (newKey[pos = pos + 1 & mask] != 0); } 
...
/*      */     try {
/* 1214 */       c = (Byte2DoubleOpenCustomHashMap)super.clone();
...
/* 1222 */     c.key = (byte[])this.key.clone();
/* 1223 */     c.value = (double[])this.value.clone();
...
/* 1240 */       while (this.key[i] == 0)
/* 1241 */         i++; 
/* 1242 */       t = this.strategy.hashCode(this.key[i]);
/* 1243 */       t ^= HashCommon.double2int(this.value[i]);
/* 1244 */       h += t;
/* 1245 */       i++;
/*      */     } 
/*      */     
/* 1248 */     if (this.containsNullKey)
/* 1249 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1250 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1253 */     byte[] key = this.key;
/* 1254 */     double[] value = this.value;
/* 1255 */     MapIterator i = new MapIterator();
/* 1256 */     s.defaultWriteObject();
/* 1257 */     for (int j = this.size; j-- != 0; ) {
/* 1258 */       int e = i.nextEntry();
/* 1259 */       s.writeByte(key[e]);
/* 1260 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1269 */     byte[] key = this.key = new byte[this.n + 1];
/* 1270 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1273 */     for (int i = this.size; i-- != 0; ) {
/* 1274 */       int pos; byte k = s.readByte();
/* 1275 */       double v = s.readDouble();
/* 1276 */       if (this.strategy.equals(k, (byte)0)) {
/* 1277 */         pos = this.n;
/* 1278 */         this.containsNullKey = true;
/*      */       } else {
/* 1280 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1281 */         while (key[pos] != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2DoubleOpenCustomHashMap.class
