...
/*  954 */         return false; 
/*  955 */       Map.Entry<Byte, Character> e = (Map.Entry<Byte, Character>)o;
/*  956 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Byte2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/* 1047 */       if ((this.next = Byte2CharAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Byte2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Byte2CharAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Byte2CharMap.Entry>)new AbstractObjectSortedSet<Byte2CharMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Byte2CharAVLTreeMap.Entry f = Byte2CharAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1186 */               return false; 
/* 1187 */             Byte2CharAVLTreeMap.Entry f = Byte2CharAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1188 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1189 */               return false; 
/* 1190 */             Byte2CharAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Byte2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Byte2CharAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2CharMap.Entry first() {
/* 1203 */             return Byte2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2CharMap.Entry last() {
/* 1207 */             return Byte2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry to) {
/* 1211 */             return Byte2CharAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry to) {
/* 1215 */             return Byte2CharAVLTreeMap.this.headMap(to.getByteKey()).byte2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from) {
/* 1219 */             return Byte2CharAVLTreeMap.this.tailMap(from.getByteKey()).byte2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Byte2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1257 */       return new Byte2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (CharIterator)new Byte2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1316 */             return Byte2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Byte2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Byte2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Byte2CharAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Byte2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Byte2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2CharAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Byte2CharMap.Entry>)new AbstractObjectSortedSet<Byte2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Byte2CharMap.Entry>)new Byte2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2CharMap.Entry> comparator() {
/* 1428 */               return Byte2CharAVLTreeMap.this.byte2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Byte2CharAVLTreeMap.Entry f = Byte2CharAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1441 */               return (f != null && Byte2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Byte2CharAVLTreeMap.Entry f = Byte2CharAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1454 */               if (f != null && Byte2CharAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Byte2CharAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Byte2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Byte2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Byte2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2CharMap.Entry first() {
/* 1475 */               return Byte2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2CharMap.Entry last() {
/* 1479 */               return Byte2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry to) {
/* 1483 */               return Byte2CharAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry to) {
/* 1487 */               return Byte2CharAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from) {
/* 1491 */               return Byte2CharAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2CharSortedMap.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1499 */         return new Byte2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1503 */         return new Byte2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/*      */           {
/*      */             public CharIterator iterator() {
/* 1518 */               return (CharIterator)new Byte2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1522 */               return Byte2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Byte2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Byte2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1538 */       return (in(k) && Byte2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(byte k) {
/* 1555 */       byte kk = k; Byte2CharAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Byte2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(byte k, char v) {
/* 1560 */       Byte2CharAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       char oldValue = Byte2CharAVLTreeMap.this.put(k, v);
/* 1565 */       return Byte2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(byte k) {
/* 1570 */       Byte2CharAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       char oldValue = Byte2CharAVLTreeMap.this.remove(k);
/* 1574 */       return Byte2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1592 */       return Byte2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2CharSortedMap headMap(byte to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Byte2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2CharSortedMap tailMap(byte from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Byte2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2CharSortedMap subMap(byte from, byte to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Byte2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Byte2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Byte2CharAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Byte2CharAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Byte2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Byte2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Byte2CharAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2CharAVLTreeMap.Entry e;
/* 1651 */       if (Byte2CharAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Byte2CharAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Byte2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Byte2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Byte2CharAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1672 */       Byte2CharAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1679 */       Byte2CharAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Byte2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Byte2CharAVLTreeMap.Submap.this.bottom && Byte2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Byte2CharAVLTreeMap.Submap.this.top && Byte2CharAVLTreeMap.this.compare(k, (this.prev = Byte2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Byte2CharAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Byte2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Byte2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2CharAVLTreeMap.this.compare(this.prev.key, Byte2CharAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Byte2CharAVLTreeMap.Submap.this.top && this.next != null && Byte2CharAVLTreeMap.this.compare(this.next.key, Byte2CharAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1804 */       c = (Byte2CharAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readByte(), s.readChar());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readByte(), s.readChar());
/* 1897 */       entry.right(new Entry(s.readByte(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharAVLTreeMap.class
