...
/*  626 */       return Byte2ReferenceOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public V getValue() {
/*  630 */       return Byte2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public V setValue(V v) {
/*  634 */       V oldValue = Byte2ReferenceOpenCustomHashMap.this.value[this.index];
/*  635 */       Byte2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/*  636 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte getKey() {
/*  646 */       return Byte.valueOf(Byte2ReferenceOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */     
...
/*  654 */       return (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(Byte2ReferenceOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue()) && Byte2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  658 */       return Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(Byte2ReferenceOpenCustomHashMap.this.key[this.index]) ^ (
/*  659 */         (Byte2ReferenceOpenCustomHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Byte2ReferenceOpenCustomHashMap.this.value[this.index]));
/*      */     }
/*      */     
/*      */     public String toString() {
/*  663 */       return Byte2ReferenceOpenCustomHashMap.this.key[this.index] + "=>" + Byte2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  673 */     int pos = Byte2ReferenceOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */     int last = -1;
/*      */     
/*  682 */     int c = Byte2ReferenceOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  686 */     boolean mustReturnNullKey = Byte2ReferenceOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  701 */         return this.last = Byte2ReferenceOpenCustomHashMap.this.n;
/*      */       } 
/*  703 */       byte[] key = Byte2ReferenceOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  705 */         if (--this.pos < 0) {
/*      */           
/*  707 */           this.last = Integer.MIN_VALUE;
/*  708 */           byte k = this.wrapped.getByte(-this.pos - 1);
/*  709 */           int p = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ReferenceOpenCustomHashMap.this.mask;
/*  710 */           while (!Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  711 */             p = p + 1 & Byte2ReferenceOpenCustomHashMap.this.mask; 
/*  712 */           return p;
/*      */         } 
...
/*  729 */       byte[] key = Byte2ReferenceOpenCustomHashMap.this.key; while (true) {
/*      */         byte curr; int last;
/*  731 */         pos = (last = pos) + 1 & Byte2ReferenceOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  733 */           if ((curr = key[pos]) == 0) {
/*  734 */             key[last] = 0;
/*  735 */             Byte2ReferenceOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  738 */           int slot = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(curr)) & Byte2ReferenceOpenCustomHashMap.this.mask;
/*  739 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  741 */           pos = pos + 1 & Byte2ReferenceOpenCustomHashMap.this.mask;
/*      */         } 
/*  743 */         if (pos < last) {
...
/*      */         } 
/*  748 */         key[last] = curr;
/*  749 */         Byte2ReferenceOpenCustomHashMap.this.value[last] = Byte2ReferenceOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  753 */       if (this.last == -1)
/*  754 */         throw new IllegalStateException(); 
/*  755 */       if (this.last == Byte2ReferenceOpenCustomHashMap.this.n) {
/*  756 */         Byte2ReferenceOpenCustomHashMap.this.containsNullKey = false;
/*  757 */         Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n] = null;
/*  758 */       } else if (this.pos >= 0) {
/*  759 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  762 */         Byte2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 1));
/*  763 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  766 */       Byte2ReferenceOpenCustomHashMap.this.size--;
/*  767 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Byte2ReferenceMap.Entry<V>> { private Byte2ReferenceOpenCustomHashMap<V>.MapEntry entry;
/*      */     
/*      */     public Byte2ReferenceOpenCustomHashMap<V>.MapEntry next() {
/*  782 */       return this.entry = new Byte2ReferenceOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class FastEntryIterator extends MapIterator implements ObjectIterator<Byte2ReferenceMap.Entry<V>> { private FastEntryIterator() {
/*  791 */       this.entry = new Byte2ReferenceOpenCustomHashMap.MapEntry();
...
/*      */     } }
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSet<Byte2ReferenceMap.Entry<V>> implements Byte2ReferenceMap.FastEntrySet<V> { private MapEntrySet() {}
/*      */     
/*      */     public ObjectIterator<Byte2ReferenceMap.Entry<V>> iterator() {
/*  801 */       return new Byte2ReferenceOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Byte2ReferenceMap.Entry<V>> fastIterator() {
/*  805 */       return new Byte2ReferenceOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  817 */       if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
/*  818 */         return (Byte2ReferenceOpenCustomHashMap.this.containsNullKey && Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n] == v);
/*      */       }
/*  820 */       byte[] key = Byte2ReferenceOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  823 */       if ((curr = key[pos = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ReferenceOpenCustomHashMap.this.mask]) == 0)
/*  824 */         return false; 
/*  825 */       if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  826 */         return (Byte2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  829 */         if ((curr = key[pos = pos + 1 & Byte2ReferenceOpenCustomHashMap.this.mask]) == 0)
/*  830 */           return false; 
/*  831 */         if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  832 */           return (Byte2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  845 */       if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
/*  846 */         if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey && Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n] == v) {
/*  847 */           Byte2ReferenceOpenCustomHashMap.this.removeNullEntry();
/*  848 */           return true;
/*      */         } 
/*  850 */         return false;
/*      */       } 
/*      */       
/*  853 */       byte[] key = Byte2ReferenceOpenCustomHashMap.this.key;
/*      */       byte curr;
/*      */       int pos;
/*  856 */       if ((curr = key[pos = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ReferenceOpenCustomHashMap.this.mask]) == 0)
/*  857 */         return false; 
/*  858 */       if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  859 */         if (Byte2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/*  860 */           Byte2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/*  861 */           return true;
/*      */         } 
/*  863 */         return false;
/*      */       } 
/*      */       while (true) {
/*  866 */         if ((curr = key[pos = pos + 1 & Byte2ReferenceOpenCustomHashMap.this.mask]) == 0)
/*  867 */           return false; 
/*  868 */         if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  869 */           Byte2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/*  870 */           Byte2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/*  871 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  878 */       return Byte2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  882 */       Byte2ReferenceOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
/*  887 */       if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey)
/*  888 */         consumer.accept(new AbstractByte2ReferenceMap.BasicEntry<>(Byte2ReferenceOpenCustomHashMap.this.key[Byte2ReferenceOpenCustomHashMap.this.n], Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n])); 
/*  889 */       for (int pos = Byte2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) {
/*  890 */         if (Byte2ReferenceOpenCustomHashMap.this.key[pos] != 0)
/*  891 */           consumer.accept(new AbstractByte2ReferenceMap.BasicEntry<>(Byte2ReferenceOpenCustomHashMap.this.key[pos], Byte2ReferenceOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
/*  896 */       AbstractByte2ReferenceMap.BasicEntry<V> entry = new AbstractByte2ReferenceMap.BasicEntry<>();
/*  897 */       if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey) {
/*  898 */         entry.key = Byte2ReferenceOpenCustomHashMap.this.key[Byte2ReferenceOpenCustomHashMap.this.n];
/*  899 */         entry.value = Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n];
/*  900 */         consumer.accept(entry);
/*      */       } 
/*  902 */       for (int pos = Byte2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) {
/*  903 */         if (Byte2ReferenceOpenCustomHashMap.this.key[pos] != 0) {
/*  904 */           entry.key = Byte2ReferenceOpenCustomHashMap.this.key[pos];
/*  905 */           entry.value = Byte2ReferenceOpenCustomHashMap.this.value[pos];
...
/*  931 */       return Byte2ReferenceOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractByteSet { private KeySet() {}
/*      */     
/*      */     public ByteIterator iterator() {
/*  937 */       return new Byte2ReferenceOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  942 */       if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey)
/*  943 */         consumer.accept(Byte2ReferenceOpenCustomHashMap.this.key[Byte2ReferenceOpenCustomHashMap.this.n]); 
/*  944 */       for (int pos = Byte2ReferenceOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  945 */         byte k = Byte2ReferenceOpenCustomHashMap.this.key[pos];
/*  946 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/*  952 */       return Byte2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(byte k) {
/*  956 */       return Byte2ReferenceOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(byte k) {
/*  960 */       int oldSize = Byte2ReferenceOpenCustomHashMap.this.size;
/*  961 */       Byte2ReferenceOpenCustomHashMap.this.remove(k);
/*  962 */       return (Byte2ReferenceOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  966 */       Byte2ReferenceOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*      */   {
/*      */     public V next() {
/*  990 */       return Byte2ReferenceOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*  999 */             return new Byte2ReferenceOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1003 */             return Byte2ReferenceOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(Object v) {
/* 1007 */             return Byte2ReferenceOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1011 */             Byte2ReferenceOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer)
/*      */           {
/* 1016 */             if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey)
/* 1017 */               consumer.accept(Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n]); 
/* 1018 */             for (int pos = Byte2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1019 */               if (Byte2ReferenceOpenCustomHashMap.this.key[pos] != 0)
/* 1020 */                 consumer.accept(Byte2ReferenceOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1096 */     byte[] key = this.key;
/* 1097 */     V[] value = this.value;
/* 1098 */     int mask = newN - 1;
/* 1099 */     byte[] newKey = new byte[newN + 1];
/* 1100 */     V[] newValue = (V[])new Object[newN + 1];
/* 1101 */     int i = this.n;
/* 1102 */     for (int j = realSize(); j-- != 0; ) {
/* 1103 */       while (key[--i] == 0); int pos;
/* 1104 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
/*      */       {
/* 1106 */         while (newKey[pos = pos + 1 & mask] != 0); } 
...
/*      */     try {
/* 1132 */       c = (Byte2ReferenceOpenCustomHashMap<V>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceOpenCustomHashMap.class
