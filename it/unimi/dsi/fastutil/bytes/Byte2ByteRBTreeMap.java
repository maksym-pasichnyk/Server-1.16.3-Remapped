...
/*  910 */         return false; 
/*  911 */       Map.Entry<Byte, Byte> e = (Map.Entry<Byte, Byte>)o;
/*  912 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  998 */     int index = 0;
/*      */     TreeIterator() {
/* 1000 */       this.next = Byte2ByteRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/* 1003 */       if ((this.next = Byte2ByteRBTreeMap.this.locateKey(k)) != null)
/* 1004 */         if (Byte2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1055 */       updatePrevious();
/* 1056 */       updateNext();
/* 1057 */       Byte2ByteRBTreeMap.this.remove(this.curr.key);
/* 1058 */       this.curr = null;
/*      */     }
...
/* 1097 */       this.entries = (ObjectSortedSet<Byte2ByteMap.Entry>)new AbstractObjectSortedSet<Byte2ByteMap.Entry>()
/*      */         {
...
/* 1106 */             return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from) {
/* 1110 */             return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteRBTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1121 */               return false; 
/* 1122 */             Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1134 */               return false; 
/* 1135 */             Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1136 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue())
/* 1137 */               return false; 
/* 1138 */             Byte2ByteRBTreeMap.this.remove(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Byte2ByteRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Byte2ByteRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2ByteMap.Entry first() {
/* 1151 */             return Byte2ByteRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2ByteMap.Entry last() {
/* 1155 */             return Byte2ByteRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry from, Byte2ByteMap.Entry to) {
/* 1159 */             return Byte2ByteRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry to) {
/* 1163 */             return Byte2ByteRBTreeMap.this.headMap(to.getByteKey()).byte2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from) {
/* 1167 */             return Byte2ByteRBTreeMap.this.tailMap(from.getByteKey()).byte2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1201 */       return new Byte2ByteRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1205 */       return new Byte2ByteRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */       this.values = new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1260 */             return new Byte2ByteRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(byte k) {
/* 1264 */             return Byte2ByteRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Byte2ByteRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1272 */             Byte2ByteRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1335 */       if (!bottom && !top && Byte2ByteRBTreeMap.this.compare(from, to) > 0)
/* 1336 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1337 */       this.from = from;
/* 1338 */       this.bottom = bottom;
/* 1339 */       this.to = to;
/* 1340 */       this.top = top;
/* 1341 */       this.defRetValue = Byte2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1359 */       return ((this.bottom || Byte2ByteRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ByteRBTreeMap.this
/* 1360 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
/* 1364 */       if (this.entries == null)
/* 1365 */         this.entries = (ObjectSortedSet<Byte2ByteMap.Entry>)new AbstractObjectSortedSet<Byte2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator() {
/* 1368 */               return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from) {
/* 1372 */               return (ObjectBidirectionalIterator<Byte2ByteMap.Entry>)new Byte2ByteRBTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2ByteMap.Entry> comparator() {
/* 1376 */               return Byte2ByteRBTreeMap.this.byte2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1389 */               return (f != null && Byte2ByteRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1400 */                 return false; 
/* 1401 */               Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1402 */               if (f != null && Byte2ByteRBTreeMap.Submap.this.in(f.key))
/* 1403 */                 Byte2ByteRBTreeMap.Submap.this.remove(f.key); 
/* 1404 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1408 */               int c = 0;
/* 1409 */               for (ObjectBidirectionalIterator<Byte2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1410 */                 c++; 
/* 1411 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1415 */               return !(new Byte2ByteRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1419 */               Byte2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2ByteMap.Entry first() {
/* 1423 */               return Byte2ByteRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2ByteMap.Entry last() {
/* 1427 */               return Byte2ByteRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry from, Byte2ByteMap.Entry to) {
/* 1431 */               return Byte2ByteRBTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry to) {
/* 1435 */               return Byte2ByteRBTreeMap.Submap.this.headMap(to.getByteKey()).byte2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from) {
/* 1439 */               return Byte2ByteRBTreeMap.Submap.this.tailMap(from.getByteKey()).byte2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2ByteSortedMap.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1447 */         return new Byte2ByteRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1451 */         return new Byte2ByteRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/* 1463 */         this.values = new AbstractByteCollection()
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1466 */               return new Byte2ByteRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(byte k) {
/* 1470 */               return Byte2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1474 */               return Byte2ByteRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1478 */               Byte2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1486 */       return (in(k) && Byte2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(byte k) {
/* 1503 */       byte kk = k; Byte2ByteRBTreeMap.Entry e;
/* 1504 */       return (in(kk) && (e = Byte2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public byte put(byte k, byte v) {
/* 1508 */       Byte2ByteRBTreeMap.this.modified = false;
/* 1509 */       if (!in(k))
...
/* 1512 */       byte oldValue = Byte2ByteRBTreeMap.this.put(k, v);
/* 1513 */       return Byte2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte remove(byte k) {
/* 1518 */       Byte2ByteRBTreeMap.this.modified = false;
/* 1519 */       if (!in(k))
/* 1520 */         return this.defRetValue; 
/* 1521 */       byte oldValue = Byte2ByteRBTreeMap.this.remove(k);
/* 1522 */       return Byte2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1540 */       return Byte2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2ByteSortedMap headMap(byte to) {
/* 1544 */       if (this.top)
/* 1545 */         return new Submap(this.from, this.bottom, to, false); 
/* 1546 */       return (Byte2ByteRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2ByteSortedMap tailMap(byte from) {
/* 1550 */       if (this.bottom)
/* 1551 */         return new Submap(from, false, this.to, this.top); 
/* 1552 */       return (Byte2ByteRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2ByteSortedMap subMap(byte from, byte to) {
...
/* 1558 */       if (!this.top)
/* 1559 */         to = (Byte2ByteRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1560 */       if (!this.bottom)
/* 1561 */         from = (Byte2ByteRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1573 */       if (Byte2ByteRBTreeMap.this.tree == null) {
/* 1574 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1578 */       if (this.bottom) {
/* 1579 */         e = Byte2ByteRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1581 */         e = Byte2ByteRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1583 */         if (Byte2ByteRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1584 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1588 */       if (e == null || (!this.top && Byte2ByteRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1589 */         return null; 
/* 1590 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2ByteRBTreeMap.Entry e;
/* 1599 */       if (Byte2ByteRBTreeMap.this.tree == null) {
/* 1600 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1604 */       if (this.top) {
/* 1605 */         e = Byte2ByteRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1607 */         e = Byte2ByteRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1609 */         if (Byte2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1610 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Byte2ByteRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1615 */         return null; 
/* 1616 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1620 */       Byte2ByteRBTreeMap.Entry e = firstEntry();
/* 1621 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1627 */       Byte2ByteRBTreeMap.Entry e = lastEntry();
/* 1628 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Byte2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1646 */         this();
/* 1647 */         if (this.next != null)
/* 1648 */           if (!Byte2ByteRBTreeMap.Submap.this.bottom && Byte2ByteRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1649 */             this.prev = null;
/* 1650 */           } else if (!Byte2ByteRBTreeMap.Submap.this.top && Byte2ByteRBTreeMap.this.compare(k, (this.prev = Byte2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1651 */             this.next = null;
/*      */           } else {
/* 1653 */             this.next = Byte2ByteRBTreeMap.this.locateKey(k);
/* 1654 */             if (Byte2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1665 */         if (!Byte2ByteRBTreeMap.Submap.this.bottom && this.prev != null && Byte2ByteRBTreeMap.this.compare(this.prev.key, Byte2ByteRBTreeMap.Submap.this.from) < 0)
/* 1666 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1670 */         this.next = this.next.next();
/* 1671 */         if (!Byte2ByteRBTreeMap.Submap.this.top && this.next != null && Byte2ByteRBTreeMap.this.compare(this.next.key, Byte2ByteRBTreeMap.Submap.this.to) >= 0)
/* 1672 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1752 */       c = (Byte2ByteRBTreeMap)super.clone();
...
/* 1833 */     if (n == 1) {
/* 1834 */       Entry entry = new Entry(s.readByte(), s.readByte());
...
/*      */ 
/*      */       
/* 1845 */       Entry entry = new Entry(s.readByte(), s.readByte());
/* 1846 */       entry.black(true);
/* 1847 */       entry.right(new Entry(s.readByte(), s.readByte()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2ByteRBTreeMap.class
