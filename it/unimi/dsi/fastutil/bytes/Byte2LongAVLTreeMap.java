...
/*  954 */         return false; 
/*  955 */       Map.Entry<Byte, Long> e = (Map.Entry<Byte, Long>)o;
/*  956 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Byte2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/* 1047 */       if ((this.next = Byte2LongAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Byte2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Byte2LongAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Byte2LongMap.Entry>)new AbstractObjectSortedSet<Byte2LongMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Byte2LongMap.Entry>)new Byte2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Byte2LongMap.Entry>)new Byte2LongAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Byte2LongAVLTreeMap.Entry f = Byte2LongAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1186 */               return false; 
/* 1187 */             Byte2LongAVLTreeMap.Entry f = Byte2LongAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1188 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue())
/* 1189 */               return false; 
/* 1190 */             Byte2LongAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Byte2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Byte2LongAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2LongMap.Entry first() {
/* 1203 */             return Byte2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2LongMap.Entry last() {
/* 1207 */             return Byte2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry from, Byte2LongMap.Entry to) {
/* 1211 */             return Byte2LongAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry to) {
/* 1215 */             return Byte2LongAVLTreeMap.this.headMap(to.getByteKey()).byte2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry from) {
/* 1219 */             return Byte2LongAVLTreeMap.this.tailMap(from.getByteKey()).byte2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Byte2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1257 */       return new Byte2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (LongIterator)new Byte2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(long k) {
/* 1316 */             return Byte2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Byte2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Byte2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Byte2LongAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Byte2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Byte2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2LongAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Byte2LongMap.Entry>)new AbstractObjectSortedSet<Byte2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Byte2LongMap.Entry>)new Byte2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Byte2LongMap.Entry>)new Byte2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2LongMap.Entry> comparator() {
/* 1428 */               return Byte2LongAVLTreeMap.this.byte2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Byte2LongAVLTreeMap.Entry f = Byte2LongAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1441 */               return (f != null && Byte2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Byte2LongAVLTreeMap.Entry f = Byte2LongAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1454 */               if (f != null && Byte2LongAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Byte2LongAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Byte2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Byte2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Byte2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2LongMap.Entry first() {
/* 1475 */               return Byte2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2LongMap.Entry last() {
/* 1479 */               return Byte2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry from, Byte2LongMap.Entry to) {
/* 1483 */               return Byte2LongAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry to) {
/* 1487 */               return Byte2LongAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry from) {
/* 1491 */               return Byte2LongAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2LongSortedMap.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1499 */         return new Byte2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1503 */         return new Byte2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/*      */           {
/*      */             public LongIterator iterator() {
/* 1518 */               return (LongIterator)new Byte2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(long k) {
/* 1522 */               return Byte2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Byte2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Byte2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1538 */       return (in(k) && Byte2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(long v) {
...
/*      */     
/*      */     public long get(byte k) {
/* 1555 */       byte kk = k; Byte2LongAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Byte2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public long put(byte k, long v) {
/* 1560 */       Byte2LongAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       long oldValue = Byte2LongAVLTreeMap.this.put(k, v);
/* 1565 */       return Byte2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long remove(byte k) {
/* 1570 */       Byte2LongAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       long oldValue = Byte2LongAVLTreeMap.this.remove(k);
/* 1574 */       return Byte2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1592 */       return Byte2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2LongSortedMap headMap(byte to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Byte2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2LongSortedMap tailMap(byte from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Byte2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2LongSortedMap subMap(byte from, byte to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Byte2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Byte2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Byte2LongAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Byte2LongAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Byte2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Byte2LongAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Byte2LongAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2LongAVLTreeMap.Entry e;
/* 1651 */       if (Byte2LongAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Byte2LongAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Byte2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Byte2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Byte2LongAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1672 */       Byte2LongAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1679 */       Byte2LongAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Byte2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Byte2LongAVLTreeMap.Submap.this.bottom && Byte2LongAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Byte2LongAVLTreeMap.Submap.this.top && Byte2LongAVLTreeMap.this.compare(k, (this.prev = Byte2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Byte2LongAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Byte2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Byte2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2LongAVLTreeMap.this.compare(this.prev.key, Byte2LongAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Byte2LongAVLTreeMap.Submap.this.top && this.next != null && Byte2LongAVLTreeMap.this.compare(this.next.key, Byte2LongAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1804 */       c = (Byte2LongAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readByte(), s.readLong());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readByte(), s.readLong());
/* 1897 */       entry.right(new Entry(s.readByte(), s.readLong()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2LongAVLTreeMap.class
