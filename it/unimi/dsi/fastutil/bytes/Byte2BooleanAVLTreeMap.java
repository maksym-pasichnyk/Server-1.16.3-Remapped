...
/*  932 */         return false; 
/*  933 */       Map.Entry<Byte, Boolean> e = (Map.Entry<Byte, Boolean>)o;
/*  934 */       return (this.key == ((Byte)e.getKey()).byteValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1020 */     int index = 0;
/*      */     TreeIterator() {
/* 1022 */       this.next = Byte2BooleanAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(byte k) {
/* 1025 */       if ((this.next = Byte2BooleanAVLTreeMap.this.locateKey(k)) != null)
/* 1026 */         if (Byte2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1077 */       updatePrevious();
/* 1078 */       updateNext();
/* 1079 */       Byte2BooleanAVLTreeMap.this.remove(this.curr.key);
/* 1080 */       this.curr = null;
/*      */     }
...
/* 1127 */       this.entries = (ObjectSortedSet<Byte2BooleanMap.Entry>)new AbstractObjectSortedSet<Byte2BooleanMap.Entry>()
/*      */         {
...
/* 1136 */             return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from) {
/* 1140 */             return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanAVLTreeMap.EntryIterator(from.getByteKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1148 */             if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1149 */               return false; 
/* 1150 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1151 */               return false; 
/* 1152 */             Byte2BooleanAVLTreeMap.Entry f = Byte2BooleanAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1161 */             if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1162 */               return false; 
/* 1163 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1164 */               return false; 
/* 1165 */             Byte2BooleanAVLTreeMap.Entry f = Byte2BooleanAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1166 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue())
/* 1167 */               return false; 
/* 1168 */             Byte2BooleanAVLTreeMap.this.remove(f.key);
/* 1169 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1173 */             return Byte2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1177 */             Byte2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Byte2BooleanMap.Entry first() {
/* 1181 */             return Byte2BooleanAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Byte2BooleanMap.Entry last() {
/* 1185 */             return Byte2BooleanAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry to) {
/* 1190 */             return Byte2BooleanAVLTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry to) {
/* 1194 */             return Byte2BooleanAVLTreeMap.this.headMap(to.getByteKey()).byte2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from) {
/* 1198 */             return Byte2BooleanAVLTreeMap.this.tailMap(from.getByteKey()).byte2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1232 */       return new Byte2BooleanAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ByteBidirectionalIterator iterator(byte from) {
/* 1236 */       return new Byte2BooleanAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1291 */             return (BooleanIterator)new Byte2BooleanAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1295 */             return Byte2BooleanAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1299 */             return Byte2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1303 */             Byte2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1314 */     return new Submap((byte)0, true, to, false);
/*      */   }
/*      */   
/*      */   public Byte2BooleanSortedMap tailMap(byte from) {
/* 1318 */     return new Submap(from, false, (byte)0, true);
/*      */   }
/*      */   
...
/* 1366 */       if (!bottom && !top && Byte2BooleanAVLTreeMap.this.compare(from, to) > 0)
/* 1367 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1368 */       this.from = from;
/* 1369 */       this.bottom = bottom;
/* 1370 */       this.to = to;
/* 1371 */       this.top = top;
/* 1372 */       this.defRetValue = Byte2BooleanAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1390 */       return ((this.bottom || Byte2BooleanAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2BooleanAVLTreeMap.this
/* 1391 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
/* 1395 */       if (this.entries == null)
/* 1396 */         this.entries = (ObjectSortedSet<Byte2BooleanMap.Entry>)new AbstractObjectSortedSet<Byte2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator() {
/* 1399 */               return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from) {
/* 1404 */               return (ObjectBidirectionalIterator<Byte2BooleanMap.Entry>)new Byte2BooleanAVLTreeMap.Submap.SubmapEntryIterator(from.getByteKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Byte2BooleanMap.Entry> comparator() {
/* 1408 */               return Byte2BooleanAVLTreeMap.this.byte2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1416 */               if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1417 */                 return false; 
/* 1418 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1419 */                 return false; 
/* 1420 */               Byte2BooleanAVLTreeMap.Entry f = Byte2BooleanAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1421 */               return (f != null && Byte2BooleanAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1429 */               if (e.getKey() == null || !(e.getKey() instanceof Byte))
/* 1430 */                 return false; 
/* 1431 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1432 */                 return false; 
/* 1433 */               Byte2BooleanAVLTreeMap.Entry f = Byte2BooleanAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1434 */               if (f != null && Byte2BooleanAVLTreeMap.Submap.this.in(f.key))
/* 1435 */                 Byte2BooleanAVLTreeMap.Submap.this.remove(f.key); 
/* 1436 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1440 */               int c = 0;
/* 1441 */               for (ObjectBidirectionalIterator<Byte2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1442 */                 c++; 
/* 1443 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1447 */               return !(new Byte2BooleanAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1451 */               Byte2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Byte2BooleanMap.Entry first() {
/* 1455 */               return Byte2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Byte2BooleanMap.Entry last() {
/* 1459 */               return Byte2BooleanAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry to) {
/* 1464 */               return Byte2BooleanAVLTreeMap.Submap.this.subMap(from.getByteKey(), to.getByteKey()).byte2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry to) {
/* 1468 */               return Byte2BooleanAVLTreeMap.Submap.this.headMap(to.getByteKey()).byte2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from) {
/* 1472 */               return Byte2BooleanAVLTreeMap.Submap.this.tailMap(from.getByteKey()).byte2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractByte2BooleanSortedMap.KeySet {
/*      */       public ByteBidirectionalIterator iterator() {
/* 1480 */         return new Byte2BooleanAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ByteBidirectionalIterator iterator(byte from) {
/* 1484 */         return new Byte2BooleanAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ByteSortedSet keySet() {
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1499 */               return (BooleanIterator)new Byte2BooleanAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1503 */               return Byte2BooleanAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1507 */               return Byte2BooleanAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1511 */               Byte2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(byte k) {
/* 1519 */       return (in(k) && Byte2BooleanAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(byte k) {
/* 1536 */       byte kk = k; Byte2BooleanAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Byte2BooleanAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public boolean put(byte k, boolean v) {
/* 1541 */       Byte2BooleanAVLTreeMap.this.modified = false;
/* 1542 */       if (!in(k))
...
/* 1545 */       boolean oldValue = Byte2BooleanAVLTreeMap.this.put(k, v);
/* 1546 */       return Byte2BooleanAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(byte k) {
/* 1551 */       Byte2BooleanAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k))
/* 1553 */         return this.defRetValue; 
/* 1554 */       boolean oldValue = Byte2BooleanAVLTreeMap.this.remove(k);
/* 1555 */       return Byte2BooleanAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ByteComparator comparator() {
/* 1573 */       return Byte2BooleanAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Byte2BooleanSortedMap headMap(byte to) {
/* 1577 */       if (this.top)
/* 1578 */         return new Submap(this.from, this.bottom, to, false); 
/* 1579 */       return (Byte2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Byte2BooleanSortedMap tailMap(byte from) {
/* 1583 */       if (this.bottom)
/* 1584 */         return new Submap(from, false, this.to, this.top); 
/* 1585 */       return (Byte2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Byte2BooleanSortedMap subMap(byte from, byte to) {
...
/* 1591 */       if (!this.top)
/* 1592 */         to = (Byte2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1593 */       if (!this.bottom)
/* 1594 */         from = (Byte2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1606 */       if (Byte2BooleanAVLTreeMap.this.tree == null) {
/* 1607 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1611 */       if (this.bottom) {
/* 1612 */         e = Byte2BooleanAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1614 */         e = Byte2BooleanAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1616 */         if (Byte2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1617 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1621 */       if (e == null || (!this.top && Byte2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1622 */         return null; 
/* 1623 */       return e;
/*      */     }
/*      */ 
...
/*      */       Byte2BooleanAVLTreeMap.Entry e;
/* 1632 */       if (Byte2BooleanAVLTreeMap.this.tree == null) {
/* 1633 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1637 */       if (this.top) {
/* 1638 */         e = Byte2BooleanAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1640 */         e = Byte2BooleanAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1642 */         if (Byte2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1643 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1647 */       if (e == null || (!this.bottom && Byte2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1648 */         return null; 
/* 1649 */       return e;
/*      */     }
/*      */     
/*      */     public byte firstByteKey() {
/* 1653 */       Byte2BooleanAVLTreeMap.Entry e = firstEntry();
/* 1654 */       if (e == null)
...
/*      */     
/*      */     public byte lastByteKey() {
/* 1660 */       Byte2BooleanAVLTreeMap.Entry e = lastEntry();
/* 1661 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1676 */         this.next = Byte2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1679 */         this();
/* 1680 */         if (this.next != null)
/* 1681 */           if (!Byte2BooleanAVLTreeMap.Submap.this.bottom && Byte2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1682 */             this.prev = null;
/* 1683 */           } else if (!Byte2BooleanAVLTreeMap.Submap.this.top && Byte2BooleanAVLTreeMap.this.compare(k, (this.prev = Byte2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1684 */             this.next = null;
/*      */           } else {
/* 1686 */             this.next = Byte2BooleanAVLTreeMap.this.locateKey(k);
/* 1687 */             if (Byte2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1698 */         if (!Byte2BooleanAVLTreeMap.Submap.this.bottom && this.prev != null && Byte2BooleanAVLTreeMap.this.compare(this.prev.key, Byte2BooleanAVLTreeMap.Submap.this.from) < 0)
/* 1699 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1703 */         this.next = this.next.next();
/* 1704 */         if (!Byte2BooleanAVLTreeMap.Submap.this.top && this.next != null && Byte2BooleanAVLTreeMap.this.compare(this.next.key, Byte2BooleanAVLTreeMap.Submap.this.to) >= 0)
/* 1705 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1785 */       c = (Byte2BooleanAVLTreeMap)super.clone();
...
/* 1866 */     if (n == 1) {
/* 1867 */       Entry entry = new Entry(s.readByte(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1877 */       Entry entry = new Entry(s.readByte(), s.readBoolean());
/* 1878 */       entry.right(new Entry(s.readByte(), s.readBoolean()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\bytes\Byte2BooleanAVLTreeMap.class
