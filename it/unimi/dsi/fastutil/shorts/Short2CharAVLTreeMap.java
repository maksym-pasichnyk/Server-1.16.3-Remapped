...
/*  954 */         return false; 
/*  955 */       Map.Entry<Short, Character> e = (Map.Entry<Short, Character>)o;
/*  956 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Short2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/* 1047 */       if ((this.next = Short2CharAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Short2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Short2CharAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Short2CharMap.Entry>)new AbstractObjectSortedSet<Short2CharMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Short2CharAVLTreeMap.Entry f = Short2CharAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1186 */               return false; 
/* 1187 */             Short2CharAVLTreeMap.Entry f = Short2CharAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1188 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1189 */               return false; 
/* 1190 */             Short2CharAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Short2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Short2CharAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2CharMap.Entry first() {
/* 1203 */             return Short2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2CharMap.Entry last() {
/* 1207 */             return Short2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry from, Short2CharMap.Entry to) {
/* 1211 */             return Short2CharAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry to) {
/* 1215 */             return Short2CharAVLTreeMap.this.headMap(to.getShortKey()).short2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from) {
/* 1219 */             return Short2CharAVLTreeMap.this.tailMap(from.getShortKey()).short2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Short2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1257 */       return new Short2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (CharIterator)new Short2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1316 */             return Short2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Short2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Short2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Short2CharAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Short2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Short2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2CharAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Short2CharMap.Entry>)new AbstractObjectSortedSet<Short2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2CharMap.Entry> comparator() {
/* 1428 */               return Short2CharAVLTreeMap.this.short2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Short2CharAVLTreeMap.Entry f = Short2CharAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1441 */               return (f != null && Short2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Short2CharAVLTreeMap.Entry f = Short2CharAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1454 */               if (f != null && Short2CharAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Short2CharAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Short2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Short2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Short2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2CharMap.Entry first() {
/* 1475 */               return Short2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2CharMap.Entry last() {
/* 1479 */               return Short2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry from, Short2CharMap.Entry to) {
/* 1484 */               return Short2CharAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry to) {
/* 1488 */               return Short2CharAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from) {
/* 1492 */               return Short2CharAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2CharSortedMap.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1500 */         return new Short2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1504 */         return new Short2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/* 1516 */         this.values = (CharCollection)new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1519 */               return (CharIterator)new Short2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1523 */               return Short2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1527 */               return Short2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1531 */               Short2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1539 */       return (in(k) && Short2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/* 1546 */         char ev = (i.nextEntry()).value;
/* 1547 */         if (ev == v)
/* 1548 */           return true; 
/*      */       } 
/* 1550 */       return false;
...
/*      */     
/*      */     public char get(short k) {
/* 1556 */       short kk = k; Short2CharAVLTreeMap.Entry e;
/* 1557 */       return (in(kk) && (e = Short2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(short k, char v) {
/* 1561 */       Short2CharAVLTreeMap.this.modified = false;
/* 1562 */       if (!in(k))
...
/* 1565 */       char oldValue = Short2CharAVLTreeMap.this.put(k, v);
/* 1566 */       return Short2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(short k) {
/* 1571 */       Short2CharAVLTreeMap.this.modified = false;
/* 1572 */       if (!in(k))
/* 1573 */         return this.defRetValue; 
/* 1574 */       char oldValue = Short2CharAVLTreeMap.this.remove(k);
/* 1575 */       return Short2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1593 */       return Short2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2CharSortedMap headMap(short to) {
/* 1597 */       if (this.top)
/* 1598 */         return new Submap(this.from, this.bottom, to, false); 
/* 1599 */       return (Short2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2CharSortedMap tailMap(short from) {
/* 1603 */       if (this.bottom)
/* 1604 */         return new Submap(from, false, this.to, this.top); 
/* 1605 */       return (Short2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2CharSortedMap subMap(short from, short to) {
...
/* 1611 */       if (!this.top)
/* 1612 */         to = (Short2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1613 */       if (!this.bottom)
/* 1614 */         from = (Short2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1626 */       if (Short2CharAVLTreeMap.this.tree == null) {
/* 1627 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1631 */       if (this.bottom) {
/* 1632 */         e = Short2CharAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1634 */         e = Short2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1636 */         if (Short2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1637 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1641 */       if (e == null || (!this.top && Short2CharAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1642 */         return null; 
/* 1643 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2CharAVLTreeMap.Entry e;
/* 1652 */       if (Short2CharAVLTreeMap.this.tree == null) {
/* 1653 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1657 */       if (this.top) {
/* 1658 */         e = Short2CharAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1660 */         e = Short2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1662 */         if (Short2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1663 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1667 */       if (e == null || (!this.bottom && Short2CharAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1668 */         return null; 
/* 1669 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1673 */       Short2CharAVLTreeMap.Entry e = firstEntry();
/* 1674 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1680 */       Short2CharAVLTreeMap.Entry e = lastEntry();
/* 1681 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1696 */         this.next = Short2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1699 */         this();
/* 1700 */         if (this.next != null)
/* 1701 */           if (!Short2CharAVLTreeMap.Submap.this.bottom && Short2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1702 */             this.prev = null;
/* 1703 */           } else if (!Short2CharAVLTreeMap.Submap.this.top && Short2CharAVLTreeMap.this.compare(k, (this.prev = Short2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1704 */             this.next = null;
/*      */           } else {
/* 1706 */             this.next = Short2CharAVLTreeMap.this.locateKey(k);
/* 1707 */             if (Short2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1718 */         if (!Short2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Short2CharAVLTreeMap.this.compare(this.prev.key, Short2CharAVLTreeMap.Submap.this.from) < 0)
/* 1719 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1723 */         this.next = this.next.next();
/* 1724 */         if (!Short2CharAVLTreeMap.Submap.this.top && this.next != null && Short2CharAVLTreeMap.this.compare(this.next.key, Short2CharAVLTreeMap.Submap.this.to) >= 0)
/* 1725 */           this.next = null; 
/*      */       } }
/*      */     
/*      */     private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Short2CharMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1805 */       c = (Short2CharAVLTreeMap)super.clone();
...
/* 1886 */     if (n == 1) {
/* 1887 */       Entry entry = new Entry(s.readShort(), s.readChar());
...
/*      */ 
/*      */       
/* 1897 */       Entry entry = new Entry(s.readShort(), s.readChar());
/* 1898 */       entry.right(new Entry(s.readShort(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2CharAVLTreeMap.class
