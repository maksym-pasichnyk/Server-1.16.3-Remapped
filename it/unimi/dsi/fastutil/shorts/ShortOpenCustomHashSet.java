...
/*     */   
/*     */   public boolean trim() {
/* 599 */     int l = HashCommon.arraySize(this.size, this.f);
/* 600 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 601 */       return true; 
/*     */     try {
/* 603 */       rehash(l);
/* 604 */     } catch (OutOfMemoryError cantDoIt) {
/* 605 */       return false;
/*     */     } 
/* 607 */     return true;
/*     */   }
...
/* 631 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 632 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 633 */       return true; 
/*     */     try {
/* 635 */       rehash(l);
/* 636 */     } catch (OutOfMemoryError cantDoIt) {
/* 637 */       return false;
/*     */     } 
/* 639 */     return true;
/*     */   }
...
/* 655 */     short[] key = this.key;
/* 656 */     int mask = newN - 1;
/* 657 */     short[] newKey = new short[newN + 1];
/* 658 */     int i = this.n;
/* 659 */     for (int j = realSize(); j-- != 0; ) {
/* 660 */       while (key[--i] == 0); int pos;
/* 661 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
/*     */       {
/* 663 */         while (newKey[pos = pos + 1 & mask] != 0); } 
/* 664 */       newKey[pos] = key[i];
/*     */     } 
/* 666 */     this.n = newN;
/* 667 */     this.mask = mask;
/* 668 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 669 */     this.key = newKey;
/*     */   }
/*     */ 
/*     */ 
...
/*     */     try {
/* 686 */       c = (ShortOpenCustomHashSet)super.clone();
/* 687 */     } catch (CloneNotSupportedException cantHappen) {
/* 688 */       throw new InternalError();
/*     */     } 
/* 690 */     c.key = (short[])this.key.clone();
/* 691 */     c.containsNull = this.containsNull;
/* 692 */     c.strategy = this.strategy;
/* 693 */     return c;
/*     */   }
/*     */ 
/*     */ 
...
/*     */   public int hashCode() {
/* 706 */     int h = 0;
/* 707 */     for (int j = realSize(), i = 0; j-- != 0; ) {
/* 708 */       while (this.key[i] == 0)
/* 709 */         i++; 
/* 710 */       h += this.strategy.hashCode(this.key[i]);
/* 711 */       i++;
/*     */     } 
/*     */     
/* 714 */     return h;
...
/* 717 */     ShortIterator i = iterator();
/* 718 */     s.defaultWriteObject();
/* 719 */     for (int j = this.size; j-- != 0;)
/* 720 */       s.writeShort(i.nextShort()); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 724 */     s.defaultReadObject();
/* 725 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 726 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 727 */     this.mask = this.n - 1;
/* 728 */     short[] key = this.key = new short[this.n + 1];
/*     */     
/* 730 */     for (int i = this.size; i-- != 0; ) {
/* 731 */       int pos; short k = s.readShort();
/* 732 */       if (this.strategy.equals(k, (short)0)) {
/* 733 */         pos = this.n;
/* 734 */         this.containsNull = true;
/*     */       }
/* 736 */       else if (key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask] != 0) {
/* 737 */         while (key[pos = pos + 1 & this.mask] != 0);
/*     */       } 
/* 739 */       key[pos] = k;
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\ShortOpenCustomHashSet.class
