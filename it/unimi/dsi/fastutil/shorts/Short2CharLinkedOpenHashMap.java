...
/*  362 */     short[] key = this.key; while (true) {
/*      */       short curr; int last;
...
/*  846 */     Character newValue = remappingFunction.apply(Short.valueOf(k), Character.valueOf(this.value[pos]));
...
/*  861 */     int pos = find(k);
/*  862 */     Character newValue = remappingFunction.apply(Short.valueOf(k), 
...
/*  913 */     Arrays.fill(this.key, (short)0);
...
/*  940 */       return Short2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public char getCharValue() {
/*  944 */       return Short2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public char setValue(char v) {
/*  948 */       char oldValue = Short2CharLinkedOpenHashMap.this.value[this.index];
/*  949 */       Short2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  950 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  960 */       return Short.valueOf(Short2CharLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  970 */       return Character.valueOf(Short2CharLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  986 */         return false; 
/*  987 */       Map.Entry<Short, Character> e = (Map.Entry<Short, Character>)o;
/*  988 */       return (Short2CharLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  992 */       return Short2CharLinkedOpenHashMap.this.key[this.index] ^ Short2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  996 */       return Short2CharLinkedOpenHashMap.this.key[this.index] + "=>" + Short2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1159 */       this.next = Short2CharLinkedOpenHashMap.this.first;
/* 1160 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(short from) {
/* 1163 */       if (from == 0) {
/* 1164 */         if (Short2CharLinkedOpenHashMap.this.containsNullKey) {
/* 1165 */           this.next = (int)Short2CharLinkedOpenHashMap.this.link[Short2CharLinkedOpenHashMap.this.n];
/* 1166 */           this.prev = Short2CharLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1169 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1171 */       if (Short2CharLinkedOpenHashMap.this.key[Short2CharLinkedOpenHashMap.this.last] == from) {
/* 1172 */         this.prev = Short2CharLinkedOpenHashMap.this.last;
/* 1173 */         this.index = Short2CharLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1177 */       int pos = HashCommon.mix(from) & Short2CharLinkedOpenHashMap.this.mask;
/*      */       
/* 1179 */       while (Short2CharLinkedOpenHashMap.this.key[pos] != 0) {
/* 1180 */         if (Short2CharLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1182 */           this.next = (int)Short2CharLinkedOpenHashMap.this.link[pos];
/* 1183 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1186 */         pos = pos + 1 & Short2CharLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1203 */       if (this.next == -1) {
/* 1204 */         this.index = Short2CharLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1207 */       int pos = Short2CharLinkedOpenHashMap.this.first;
/* 1208 */       this.index = 1;
/* 1209 */       while (pos != this.prev) {
/* 1210 */         pos = (int)Short2CharLinkedOpenHashMap.this.link[pos];
/* 1211 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1226 */       this.next = (int)Short2CharLinkedOpenHashMap.this.link[this.curr];
...
/* 1236 */       this.prev = (int)(Short2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1251 */         this.index--;
/* 1252 */         this.prev = (int)(Short2CharLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1254 */         this.next = (int)Short2CharLinkedOpenHashMap.this.link[this.curr];
/* 1255 */       }  Short2CharLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1260 */       if (this.prev == -1) {
/* 1261 */         Short2CharLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1263 */         Short2CharLinkedOpenHashMap.this.link[this.prev] = Short2CharLinkedOpenHashMap.this.link[this.prev] ^ (Short2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1264 */       }  if (this.next == -1) {
/* 1265 */         Short2CharLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1267 */         Short2CharLinkedOpenHashMap.this.link[this.next] = Short2CharLinkedOpenHashMap.this.link[this.next] ^ (Short2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1268 */       }  int pos = this.curr;
/* 1269 */       this.curr = -1;
/* 1270 */       if (pos == Short2CharLinkedOpenHashMap.this.n) {
/* 1271 */         Short2CharLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1274 */         short[] key = Short2CharLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           short curr;
/*      */           int last;
/* 1278 */           pos = (last = pos) + 1 & Short2CharLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1280 */             if ((curr = key[pos]) == 0) {
/* 1281 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1284 */             int slot = HashCommon.mix(curr) & Short2CharLinkedOpenHashMap.this.mask;
/* 1285 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1287 */             pos = pos + 1 & Short2CharLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1289 */           key[last] = curr;
/* 1290 */           Short2CharLinkedOpenHashMap.this.value[last] = Short2CharLinkedOpenHashMap.this.value[pos];
/* 1291 */           if (this.next == pos)
/* 1292 */             this.next = last; 
/* 1293 */           if (this.prev == pos)
/* 1294 */             this.prev = last; 
/* 1295 */           Short2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Short2CharMap.Entry> { private Short2CharLinkedOpenHashMap.MapEntry entry;
/*      */     
...
/* 1327 */       return this.entry = new Short2CharLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Short2CharLinkedOpenHashMap.MapEntry previous() {
/* 1331 */       return this.entry = new Short2CharLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1335 */       super.remove();
...
/*      */ 
/*      */   
/* 1340 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Short2CharMap.Entry> { final Short2CharLinkedOpenHashMap.MapEntry entry = new Short2CharLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Short2CharMap.Entry> implements Short2CharSortedMap.FastSortedEntrySet { public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator() {
/* 1360 */       return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     private MapEntrySet() {}
...
/* 1381 */       if (Short2CharLinkedOpenHashMap.this.size == 0)
/* 1382 */         throw new NoSuchElementException(); 
/* 1383 */       return new Short2CharLinkedOpenHashMap.MapEntry(Short2CharLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Short2CharMap.Entry last() {
/* 1387 */       if (Short2CharLinkedOpenHashMap.this.size == 0)
/* 1388 */         throw new NoSuchElementException(); 
/* 1389 */       return new Short2CharLinkedOpenHashMap.MapEntry(Short2CharLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1400 */         return false; 
/* 1401 */       short k = ((Short)e.getKey()).shortValue();
/* 1402 */       char v = ((Character)e.getValue()).charValue();
/* 1403 */       if (k == 0) {
/* 1404 */         return (Short2CharLinkedOpenHashMap.this.containsNullKey && Short2CharLinkedOpenHashMap.this.value[Short2CharLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1406 */       short[] key = Short2CharLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1409 */       if ((curr = key[pos = HashCommon.mix(k) & Short2CharLinkedOpenHashMap.this.mask]) == 0)
/* 1410 */         return false; 
/* 1411 */       if (k == curr) {
/* 1412 */         return (Short2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1415 */         if ((curr = key[pos = pos + 1 & Short2CharLinkedOpenHashMap.this.mask]) == 0)
/* 1416 */           return false; 
/* 1417 */         if (k == curr) {
/* 1418 */           return (Short2CharLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1430 */         return false; 
/* 1431 */       short k = ((Short)e.getKey()).shortValue();
/* 1432 */       char v = ((Character)e.getValue()).charValue();
/* 1433 */       if (k == 0) {
/* 1434 */         if (Short2CharLinkedOpenHashMap.this.containsNullKey && Short2CharLinkedOpenHashMap.this.value[Short2CharLinkedOpenHashMap.this.n] == v) {
/* 1435 */           Short2CharLinkedOpenHashMap.this.removeNullEntry();
/* 1436 */           return true;
/*      */         } 
/* 1438 */         return false;
/*      */       } 
/*      */       
/* 1441 */       short[] key = Short2CharLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1444 */       if ((curr = key[pos = HashCommon.mix(k) & Short2CharLinkedOpenHashMap.this.mask]) == 0)
/* 1445 */         return false; 
/* 1446 */       if (curr == k) {
/* 1447 */         if (Short2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1448 */           Short2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1449 */           return true;
/*      */         } 
/* 1451 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1454 */         if ((curr = key[pos = pos + 1 & Short2CharLinkedOpenHashMap.this.mask]) == 0)
/* 1455 */           return false; 
/* 1456 */         if (curr == k && 
/* 1457 */           Short2CharLinkedOpenHashMap.this.value[pos] == v) {
/* 1458 */           Short2CharLinkedOpenHashMap.this.removeEntry(pos);
/* 1459 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1466 */       return Short2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1470 */       Short2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1485 */       return new Short2CharLinkedOpenHashMap.EntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1496 */       return new Short2CharLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1511 */       return new Short2CharLinkedOpenHashMap.FastEntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2CharMap.Entry> consumer) {
/* 1516 */       for (int i = Short2CharLinkedOpenHashMap.this.size, next = Short2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1517 */         int curr = next;
/* 1518 */         next = (int)Short2CharLinkedOpenHashMap.this.link[curr];
/* 1519 */         consumer.accept(new AbstractShort2CharMap.BasicEntry(Short2CharLinkedOpenHashMap.this.key[curr], Short2CharLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2CharMap.Entry> consumer) {
/* 1525 */       AbstractShort2CharMap.BasicEntry entry = new AbstractShort2CharMap.BasicEntry();
/* 1526 */       for (int i = Short2CharLinkedOpenHashMap.this.size, next = Short2CharLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1527 */         int curr = next;
/* 1528 */         next = (int)Short2CharLinkedOpenHashMap.this.link[curr];
/* 1529 */         entry.key = Short2CharLinkedOpenHashMap.this.key[curr];
/* 1530 */         entry.value = Short2CharLinkedOpenHashMap.this.value[curr];
...
/* 1556 */       return Short2CharLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
...
/* 1563 */       return Short2CharLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractShortSortedSet { private KeySet() {}
/*      */     
/*      */     public ShortListIterator iterator(short from) {
/* 1569 */       return new Short2CharLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ShortListIterator iterator() {
/* 1573 */       return new Short2CharLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1578 */       if (Short2CharLinkedOpenHashMap.this.containsNullKey)
/* 1579 */         consumer.accept(Short2CharLinkedOpenHashMap.this.key[Short2CharLinkedOpenHashMap.this.n]); 
/* 1580 */       for (int pos = Short2CharLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1581 */         short k = Short2CharLinkedOpenHashMap.this.key[pos];
/* 1582 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/* 1588 */       return Short2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(short k) {
/* 1592 */       return Short2CharLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(short k) {
/* 1596 */       int oldSize = Short2CharLinkedOpenHashMap.this.size;
/* 1597 */       Short2CharLinkedOpenHashMap.this.remove(k);
/* 1598 */       return (Short2CharLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1602 */       Short2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public short firstShort() {
/* 1606 */       if (Short2CharLinkedOpenHashMap.this.size == 0)
/* 1607 */         throw new NoSuchElementException(); 
/* 1608 */       return Short2CharLinkedOpenHashMap.this.key[Short2CharLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public short lastShort() {
/* 1612 */       if (Short2CharLinkedOpenHashMap.this.size == 0)
/* 1613 */         throw new NoSuchElementException(); 
/* 1614 */       return Short2CharLinkedOpenHashMap.this.key[Short2CharLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public ShortComparator comparator() {
/* 1618 */       return null;
...
/* 1651 */       return Short2CharLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1658 */       return Short2CharLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1667 */             return (CharIterator)new Short2CharLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1671 */             return Short2CharLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(char v) {
/* 1675 */             return Short2CharLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1679 */             Short2CharLinkedOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1684 */             if (Short2CharLinkedOpenHashMap.this.containsNullKey)
/* 1685 */               consumer.accept(Short2CharLinkedOpenHashMap.this.value[Short2CharLinkedOpenHashMap.this.n]); 
/* 1686 */             for (int pos = Short2CharLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1687 */               if (Short2CharLinkedOpenHashMap.this.key[pos] != 0)
/* 1688 */                 consumer.accept(Short2CharLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1764 */     short[] key = this.key;
/* 1765 */     char[] value = this.value;
/* 1766 */     int mask = newN - 1;
/* 1767 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1822 */       c = (Short2CharLinkedOpenHashMap)super.clone();
...
/* 1830 */     c.key = (short[])this.key.clone();
...
/* 1877 */     short[] key = this.key = new short[this.n + 1];
...
/* 1885 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2CharLinkedOpenHashMap.class
