...
/* 1132 */     char[] value = this.value;
/* 1133 */     int mask = newN - 1;
/* 1134 */     short[] newKey = new short[newN + 1];
/* 1135 */     char[] newValue = new char[newN + 1];
/* 1136 */     int i = this.n;
/* 1137 */     for (int j = realSize(); j-- != 0; ) {
/* 1138 */       while (key[--i] == 0); int pos;
/* 1139 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
/*      */       {
...
/*      */     try {
/* 1167 */       c = (Short2CharOpenCustomHashMap)super.clone();
...
/* 1175 */     c.key = (short[])this.key.clone();
/* 1176 */     c.value = (char[])this.value.clone();
/* 1177 */     c.strategy = this.strategy;
/* 1178 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1194 */         i++; 
/* 1195 */       t = this.strategy.hashCode(this.key[i]);
/* 1196 */       t ^= this.value[i];
/* 1197 */       h += t;
/* 1198 */       i++;
/*      */     } 
...
/* 1202 */       h += this.value[this.n]; 
/* 1203 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1206 */     short[] key = this.key;
/* 1207 */     char[] value = this.value;
...
/* 1223 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1226 */     for (int i = this.size; i-- != 0; ) {
/* 1227 */       int pos; short k = s.readShort();
/* 1228 */       char v = s.readChar();
/* 1229 */       if (this.strategy.equals(k, (short)0)) {
/* 1230 */         pos = this.n;
/* 1231 */         this.containsNullKey = true;
/*      */       } else {
/* 1233 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2CharOpenCustomHashMap.class
