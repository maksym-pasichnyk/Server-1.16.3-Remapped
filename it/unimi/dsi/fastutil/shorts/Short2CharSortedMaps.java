...
/*  61 */     return (entries instanceof Short2CharSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Short2CharSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Short2CharMap.Entry> entries = map.short2CharEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Short2CharSortedMap.FastSortedEntrySet)entries); return (entries instanceof Short2CharSortedMap.FastSortedEntrySet) ? (Short2CharSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Short2CharMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Short2CharMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Short, Character>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Short2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2CharSortedMap headMap(short to) {
/* 132 */       return Short2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2CharSortedMap tailMap(short from) {
/* 137 */       return Short2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Short2CharMap.Entry>)ObjectSortedSets.singleton(new AbstractShort2CharMap.BasicEntry(this.key, this.value), 
/* 237 */             Short2CharSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Short2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, Character>> entrySet() {
/* 249 */       return (ObjectSortedSet)short2CharEntrySet();
/*     */     }
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Short2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2CharSortedMap headMap(short to) {
...
/* 268 */         return this; 
/* 269 */       return Short2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Short2CharSortedMap tailMap(short from) {
...
/* 275 */         return this; 
/* 276 */       return Short2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public short firstShortKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.shortValue(), value.charValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Short2CharMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.short2CharEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Short2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Short, Character>> entrySet() {
/* 449 */       return (ObjectSortedSet)short2CharEntrySet();
/*     */     }
/*     */     
/*     */     public ShortSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Short2CharMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.short2CharEntrySet()); 
/* 582 */       return (ObjectSortedSet<Short2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2CharSortedMaps.class
