...
/*  954 */         return false; 
/*  955 */       Map.Entry<Short, Double> e = (Map.Entry<Short, Double>)o;
/*  956 */       return (this.key == ((Short)e.getKey()).shortValue() && 
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Short2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/* 1048 */       if ((this.next = Short2DoubleAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Short2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Short2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Short2DoubleMap.Entry>)new AbstractObjectSortedSet<Short2DoubleMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1171 */             if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1172 */               return false; 
/* 1173 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1174 */               return false; 
/* 1175 */             Short2DoubleAVLTreeMap.Entry f = Short2DoubleAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1184 */             if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1185 */               return false; 
/* 1186 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1187 */               return false; 
/* 1188 */             Short2DoubleAVLTreeMap.Entry f = Short2DoubleAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1189 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != 
/* 1190 */               Double.doubleToLongBits(((Double)e.getValue()).doubleValue()))
/* 1191 */               return false; 
/* 1192 */             Short2DoubleAVLTreeMap.this.remove(f.key);
/* 1193 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1197 */             return Short2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1201 */             Short2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2DoubleMap.Entry first() {
/* 1205 */             return Short2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2DoubleMap.Entry last() {
/* 1209 */             return Short2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry from, Short2DoubleMap.Entry to) {
/* 1214 */             return Short2DoubleAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry to) {
/* 1218 */             return Short2DoubleAVLTreeMap.this.headMap(to.getShortKey()).short2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry from) {
/* 1222 */             return Short2DoubleAVLTreeMap.this.tailMap(from.getShortKey()).short2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1256 */       return new Short2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1260 */       return new Short2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1315 */             return (DoubleIterator)new Short2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(double k) {
/* 1319 */             return Short2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1323 */             return Short2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1327 */             Short2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1338 */     return new Submap((short)0, true, to, false);
/*      */   }
/*      */   
/*      */   public Short2DoubleSortedMap tailMap(short from) {
/* 1342 */     return new Submap(from, false, (short)0, true);
/*      */   }
/*      */   
...
/* 1390 */       if (!bottom && !top && Short2DoubleAVLTreeMap.this.compare(from, to) > 0)
/* 1391 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1392 */       this.from = from;
/* 1393 */       this.bottom = bottom;
/* 1394 */       this.to = to;
/* 1395 */       this.top = top;
/* 1396 */       this.defRetValue = Short2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1414 */       return ((this.bottom || Short2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2DoubleAVLTreeMap.this
/* 1415 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
/* 1419 */       if (this.entries == null)
/* 1420 */         this.entries = (ObjectSortedSet<Short2DoubleMap.Entry>)new AbstractObjectSortedSet<Short2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator() {
/* 1423 */               return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from) {
/* 1428 */               return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2DoubleMap.Entry> comparator() {
/* 1432 */               return Short2DoubleAVLTreeMap.this.short2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1440 */               if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1441 */                 return false; 
/* 1442 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1443 */                 return false; 
/* 1444 */               Short2DoubleAVLTreeMap.Entry f = Short2DoubleAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1445 */               return (f != null && Short2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1456 */                 return false; 
/* 1457 */               Short2DoubleAVLTreeMap.Entry f = Short2DoubleAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1458 */               if (f != null && Short2DoubleAVLTreeMap.Submap.this.in(f.key))
/* 1459 */                 Short2DoubleAVLTreeMap.Submap.this.remove(f.key); 
/* 1460 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1464 */               int c = 0;
/* 1465 */               for (ObjectBidirectionalIterator<Short2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1466 */                 c++; 
/* 1467 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1471 */               return !(new Short2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1475 */               Short2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2DoubleMap.Entry first() {
/* 1479 */               return Short2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2DoubleMap.Entry last() {
/* 1483 */               return Short2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry from, Short2DoubleMap.Entry to) {
/* 1488 */               return Short2DoubleAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry to) {
/* 1492 */               return Short2DoubleAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry from) {
/* 1496 */               return Short2DoubleAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2DoubleSortedMap.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1504 */         return new Short2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1508 */         return new Short2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1523 */               return (DoubleIterator)new Short2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(double k) {
/* 1527 */               return Short2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1531 */               return Short2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1535 */               Short2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1543 */       return (in(k) && Short2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(short k) {
/* 1560 */       short kk = k; Short2DoubleAVLTreeMap.Entry e;
/* 1561 */       return (in(kk) && (e = Short2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public double put(short k, double v) {
/* 1565 */       Short2DoubleAVLTreeMap.this.modified = false;
/* 1566 */       if (!in(k))
...
/* 1569 */       double oldValue = Short2DoubleAVLTreeMap.this.put(k, v);
/* 1570 */       return Short2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double remove(short k) {
/* 1575 */       Short2DoubleAVLTreeMap.this.modified = false;
/* 1576 */       if (!in(k))
/* 1577 */         return this.defRetValue; 
/* 1578 */       double oldValue = Short2DoubleAVLTreeMap.this.remove(k);
/* 1579 */       return Short2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1597 */       return Short2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2DoubleSortedMap headMap(short to) {
/* 1601 */       if (this.top)
/* 1602 */         return new Submap(this.from, this.bottom, to, false); 
/* 1603 */       return (Short2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2DoubleSortedMap tailMap(short from) {
/* 1607 */       if (this.bottom)
/* 1608 */         return new Submap(from, false, this.to, this.top); 
/* 1609 */       return (Short2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2DoubleSortedMap subMap(short from, short to) {
...
/* 1615 */       if (!this.top)
/* 1616 */         to = (Short2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1617 */       if (!this.bottom)
/* 1618 */         from = (Short2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1630 */       if (Short2DoubleAVLTreeMap.this.tree == null) {
/* 1631 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1635 */       if (this.bottom) {
/* 1636 */         e = Short2DoubleAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1638 */         e = Short2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1640 */         if (Short2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1641 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1645 */       if (e == null || (!this.top && Short2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1646 */         return null; 
/* 1647 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2DoubleAVLTreeMap.Entry e;
/* 1656 */       if (Short2DoubleAVLTreeMap.this.tree == null) {
/* 1657 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1661 */       if (this.top) {
/* 1662 */         e = Short2DoubleAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1664 */         e = Short2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1666 */         if (Short2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1667 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1671 */       if (e == null || (!this.bottom && Short2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1672 */         return null; 
/* 1673 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1677 */       Short2DoubleAVLTreeMap.Entry e = firstEntry();
/* 1678 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1684 */       Short2DoubleAVLTreeMap.Entry e = lastEntry();
/* 1685 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1700 */         this.next = Short2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1703 */         this();
/* 1704 */         if (this.next != null)
/* 1705 */           if (!Short2DoubleAVLTreeMap.Submap.this.bottom && Short2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1706 */             this.prev = null;
/* 1707 */           } else if (!Short2DoubleAVLTreeMap.Submap.this.top && Short2DoubleAVLTreeMap.this.compare(k, (this.prev = Short2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1708 */             this.next = null;
/*      */           } else {
/* 1710 */             this.next = Short2DoubleAVLTreeMap.this.locateKey(k);
/* 1711 */             if (Short2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1722 */         if (!Short2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Short2DoubleAVLTreeMap.this.compare(this.prev.key, Short2DoubleAVLTreeMap.Submap.this.from) < 0)
/* 1723 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1727 */         this.next = this.next.next();
/* 1728 */         if (!Short2DoubleAVLTreeMap.Submap.this.top && this.next != null && Short2DoubleAVLTreeMap.this.compare(this.next.key, Short2DoubleAVLTreeMap.Submap.this.to) >= 0)
/* 1729 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1809 */       c = (Short2DoubleAVLTreeMap)super.clone();
...
/* 1890 */     if (n == 1) {
/* 1891 */       Entry entry = new Entry(s.readShort(), s.readDouble());
...
/*      */ 
/*      */       
/* 1901 */       Entry entry = new Entry(s.readShort(), s.readDouble());
/* 1902 */       entry.right(new Entry(s.readShort(), s.readDouble()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2DoubleAVLTreeMap.class
