...
/*      */   
/*      */   public boolean trim() {
/* 1081 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1113 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1114 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1115 */       return true; 
/*      */     try {
/* 1117 */       rehash(l);
/* 1118 */     } catch (OutOfMemoryError cantDoIt) {
/* 1119 */       return false;
/*      */     } 
/* 1121 */     return true;
/*      */   }
...
/* 1137 */     short[] key = this.key;
/* 1138 */     int mask = newN - 1;
/* 1139 */     short[] newKey = new short[newN + 1];
/* 1140 */     int i = this.first, prev = -1, newPrev = -1;
/* 1141 */     long[] link = this.link;
/* 1142 */     long[] newLink = new long[newN + 1];
/* 1143 */     this.first = -1;
/* 1144 */     for (int j = this.size; j-- != 0; ) {
/* 1145 */       int pos; if (this.strategy.equals(key[i], (short)0)) {
/* 1146 */         pos = newN;
/*      */       } else {
/* 1148 */         pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask;
/* 1149 */         while (newKey[pos] != 0)
/* 1150 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1191 */       c = (ShortLinkedOpenCustomHashSet)super.clone();
...
/* 1214 */       while (this.key[i] == 0)
/* 1215 */         i++; 
/* 1216 */       h += this.strategy.hashCode(this.key[i]);
/* 1217 */       i++;
/*      */     } 
/*      */     
/* 1220 */     return h;
...
/* 1234 */     short[] key = this.key = new short[this.n + 1];
/* 1235 */     long[] link = this.link = new long[this.n + 1];
/* 1236 */     int prev = -1;
/* 1237 */     this.first = this.last = -1;
/*      */     
/* 1239 */     for (int i = this.size; i-- != 0; ) {
/* 1240 */       int pos; short k = s.readShort();
/* 1241 */       if (this.strategy.equals(k, (short)0)) {
/* 1242 */         pos = this.n;
/* 1243 */         this.containsNull = true;
/*      */       }
/* 1245 */       else if (key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask] != 0) {
/* 1246 */         while (key[pos = pos + 1 & this.mask] != 0);
/*      */       } 
/* 1248 */       key[pos] = k;
/* 1249 */       if (this.first != -1) {
/* 1250 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1251 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1252 */         prev = pos; continue;
/*      */       } 
/* 1254 */       prev = this.first = pos;
/*      */       
/* 1256 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1259 */     this.last = prev;
/* 1260 */     if (prev != -1)
/*      */     {
/* 1262 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\ShortLinkedOpenCustomHashSet.class
