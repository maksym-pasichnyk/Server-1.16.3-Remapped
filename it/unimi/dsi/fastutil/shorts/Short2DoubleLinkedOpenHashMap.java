...
/*  903 */     Double newValue = remappingFunction.apply(Short.valueOf(k), Double.valueOf(this.value[pos]));
...
/*  918 */     int pos = find(k);
/*  919 */     Double newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Double.valueOf(this.value[pos]) : null);
...
/*  996 */       return Short2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public double getDoubleValue() {
/* 1000 */       return Short2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public double setValue(double v) {
/* 1004 */       double oldValue = Short2DoubleLinkedOpenHashMap.this.value[this.index];
/* 1005 */       Short2DoubleLinkedOpenHashMap.this.value[this.index] = v;
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/* 1016 */       return Short.valueOf(Short2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       return Double.valueOf(Short2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1042 */         return false; 
/* 1043 */       Map.Entry<Short, Double> e = (Map.Entry<Short, Double>)o;
/* 1044 */       return (Short2DoubleLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && 
/* 1045 */         Double.doubleToLongBits(Short2DoubleLinkedOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1049 */       return Short2DoubleLinkedOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Short2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1053 */       return Short2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Short2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1216 */       this.next = Short2DoubleLinkedOpenHashMap.this.first;
/* 1217 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(short from) {
/* 1220 */       if (from == 0) {
/* 1221 */         if (Short2DoubleLinkedOpenHashMap.this.containsNullKey) {
/* 1222 */           this.next = (int)Short2DoubleLinkedOpenHashMap.this.link[Short2DoubleLinkedOpenHashMap.this.n];
/* 1223 */           this.prev = Short2DoubleLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1226 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1228 */       if (Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.last] == from) {
/* 1229 */         this.prev = Short2DoubleLinkedOpenHashMap.this.last;
/* 1230 */         this.index = Short2DoubleLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1234 */       int pos = HashCommon.mix(from) & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */       
/* 1236 */       while (Short2DoubleLinkedOpenHashMap.this.key[pos] != 0) {
/* 1237 */         if (Short2DoubleLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1239 */           this.next = (int)Short2DoubleLinkedOpenHashMap.this.link[pos];
/* 1240 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1243 */         pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1260 */       if (this.next == -1) {
/* 1261 */         this.index = Short2DoubleLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1264 */       int pos = Short2DoubleLinkedOpenHashMap.this.first;
/* 1265 */       this.index = 1;
/* 1266 */       while (pos != this.prev) {
/* 1267 */         pos = (int)Short2DoubleLinkedOpenHashMap.this.link[pos];
/* 1268 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1283 */       this.next = (int)Short2DoubleLinkedOpenHashMap.this.link[this.curr];
...
/* 1293 */       this.prev = (int)(Short2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1308 */         this.index--;
/* 1309 */         this.prev = (int)(Short2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1311 */         this.next = (int)Short2DoubleLinkedOpenHashMap.this.link[this.curr];
/* 1312 */       }  Short2DoubleLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1317 */       if (this.prev == -1) {
/* 1318 */         Short2DoubleLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1320 */         Short2DoubleLinkedOpenHashMap.this.link[this.prev] = Short2DoubleLinkedOpenHashMap.this.link[this.prev] ^ (Short2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1321 */       }  if (this.next == -1) {
/* 1322 */         Short2DoubleLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1324 */         Short2DoubleLinkedOpenHashMap.this.link[this.next] = Short2DoubleLinkedOpenHashMap.this.link[this.next] ^ (Short2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1325 */       }  int pos = this.curr;
/* 1326 */       this.curr = -1;
/* 1327 */       if (pos == Short2DoubleLinkedOpenHashMap.this.n) {
/* 1328 */         Short2DoubleLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1331 */         short[] key = Short2DoubleLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           short curr;
/*      */           int last;
/* 1335 */           pos = (last = pos) + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1337 */             if ((curr = key[pos]) == 0) {
/* 1338 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1341 */             int slot = HashCommon.mix(curr) & Short2DoubleLinkedOpenHashMap.this.mask;
/* 1342 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1344 */             pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1346 */           key[last] = curr;
/* 1347 */           Short2DoubleLinkedOpenHashMap.this.value[last] = Short2DoubleLinkedOpenHashMap.this.value[pos];
/* 1348 */           if (this.next == pos)
/* 1349 */             this.next = last; 
/* 1350 */           if (this.prev == pos)
/* 1351 */             this.prev = last; 
/* 1352 */           Short2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Short2DoubleMap.Entry> { private Short2DoubleLinkedOpenHashMap.MapEntry entry;
/*      */     
...
/* 1384 */       return this.entry = new Short2DoubleLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Short2DoubleLinkedOpenHashMap.MapEntry previous() {
/* 1388 */       return this.entry = new Short2DoubleLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1392 */       super.remove();
...
/*      */ 
/*      */   
/* 1397 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Short2DoubleMap.Entry> { final Short2DoubleLinkedOpenHashMap.MapEntry entry = new Short2DoubleLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Short2DoubleMap.Entry> implements Short2DoubleSortedMap.FastSortedEntrySet { private MapEntrySet() {}
/*      */     
/*      */     public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator() {
/* 1419 */       return (ObjectBidirectionalIterator<Short2DoubleMap.Entry>)new Short2DoubleLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     
...
/* 1440 */       if (Short2DoubleLinkedOpenHashMap.this.size == 0)
/* 1441 */         throw new NoSuchElementException(); 
/* 1442 */       return new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Short2DoubleMap.Entry last() {
/* 1446 */       if (Short2DoubleLinkedOpenHashMap.this.size == 0)
/* 1447 */         throw new NoSuchElementException(); 
/* 1448 */       return new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1462 */       if (k == 0) {
/* 1463 */         return (Short2DoubleLinkedOpenHashMap.this.containsNullKey && 
/* 1464 */           Double.doubleToLongBits(Short2DoubleLinkedOpenHashMap.this.value[Short2DoubleLinkedOpenHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       }
/* 1466 */       short[] key = Short2DoubleLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1469 */       if ((curr = key[pos = HashCommon.mix(k) & Short2DoubleLinkedOpenHashMap.this.mask]) == 0)
/* 1470 */         return false; 
/* 1471 */       if (k == curr) {
/* 1472 */         return (Double.doubleToLongBits(Short2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       }
/*      */       while (true) {
/* 1475 */         if ((curr = key[pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask]) == 0)
/* 1476 */           return false; 
/* 1477 */         if (k == curr) {
/* 1478 */           return (Double.doubleToLongBits(Short2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1493 */       if (k == 0) {
/* 1494 */         if (Short2DoubleLinkedOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Short2DoubleLinkedOpenHashMap.this.value[Short2DoubleLinkedOpenHashMap.this.n]) == Double.doubleToLongBits(v)) {
/* 1495 */           Short2DoubleLinkedOpenHashMap.this.removeNullEntry();
/* 1496 */           return true;
/*      */         } 
/* 1498 */         return false;
/*      */       } 
/*      */       
/* 1501 */       short[] key = Short2DoubleLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1504 */       if ((curr = key[pos = HashCommon.mix(k) & Short2DoubleLinkedOpenHashMap.this.mask]) == 0)
/* 1505 */         return false; 
/* 1506 */       if (curr == k) {
/* 1507 */         if (Double.doubleToLongBits(Short2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1508 */           Short2DoubleLinkedOpenHashMap.this.removeEntry(pos);
/* 1509 */           return true;
/*      */         } 
/* 1511 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1514 */         if ((curr = key[pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask]) == 0)
/* 1515 */           return false; 
/* 1516 */         if (curr == k && 
/* 1517 */           Double.doubleToLongBits(Short2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/* 1518 */           Short2DoubleLinkedOpenHashMap.this.removeEntry(pos);
/* 1519 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1526 */       return Short2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1530 */       Short2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1545 */       return new Short2DoubleLinkedOpenHashMap.EntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1556 */       return new Short2DoubleLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1571 */       return new Short2DoubleLinkedOpenHashMap.FastEntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
/* 1576 */       for (int i = Short2DoubleLinkedOpenHashMap.this.size, next = Short2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1577 */         int curr = next;
/* 1578 */         next = (int)Short2DoubleLinkedOpenHashMap.this.link[curr];
/* 1579 */         consumer.accept(new AbstractShort2DoubleMap.BasicEntry(Short2DoubleLinkedOpenHashMap.this.key[curr], Short2DoubleLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
/* 1585 */       AbstractShort2DoubleMap.BasicEntry entry = new AbstractShort2DoubleMap.BasicEntry();
/* 1586 */       for (int i = Short2DoubleLinkedOpenHashMap.this.size, next = Short2DoubleLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1587 */         int curr = next;
/* 1588 */         next = (int)Short2DoubleLinkedOpenHashMap.this.link[curr];
/* 1589 */         entry.key = Short2DoubleLinkedOpenHashMap.this.key[curr];
/* 1590 */         entry.value = Short2DoubleLinkedOpenHashMap.this.value[curr];
...
/* 1616 */       return Short2DoubleLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
...
/* 1623 */       return Short2DoubleLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractShortSortedSet { private KeySet() {}
/*      */     
/*      */     public ShortListIterator iterator(short from) {
/* 1629 */       return new Short2DoubleLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ShortListIterator iterator() {
/* 1633 */       return new Short2DoubleLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1638 */       if (Short2DoubleLinkedOpenHashMap.this.containsNullKey)
/* 1639 */         consumer.accept(Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.n]); 
/* 1640 */       for (int pos = Short2DoubleLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1641 */         short k = Short2DoubleLinkedOpenHashMap.this.key[pos];
/* 1642 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/* 1648 */       return Short2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(short k) {
/* 1652 */       return Short2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(short k) {
/* 1656 */       int oldSize = Short2DoubleLinkedOpenHashMap.this.size;
/* 1657 */       Short2DoubleLinkedOpenHashMap.this.remove(k);
/* 1658 */       return (Short2DoubleLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1662 */       Short2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public short firstShort() {
/* 1666 */       if (Short2DoubleLinkedOpenHashMap.this.size == 0)
/* 1667 */         throw new NoSuchElementException(); 
/* 1668 */       return Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public short lastShort() {
/* 1672 */       if (Short2DoubleLinkedOpenHashMap.this.size == 0)
/* 1673 */         throw new NoSuchElementException(); 
/* 1674 */       return Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public ShortComparator comparator() {
/* 1678 */       return null;
...
/* 1711 */       return Short2DoubleLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1718 */       return Short2DoubleLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1727 */             return (DoubleIterator)new Short2DoubleLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1731 */             return Short2DoubleLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(double v) {
/* 1735 */             return Short2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1739 */             Short2DoubleLinkedOpenHashMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public void forEach(DoubleConsumer consumer) {
/* 1744 */             if (Short2DoubleLinkedOpenHashMap.this.containsNullKey)
/* 1745 */               consumer.accept(Short2DoubleLinkedOpenHashMap.this.value[Short2DoubleLinkedOpenHashMap.this.n]); 
/* 1746 */             for (int pos = Short2DoubleLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1747 */               if (Short2DoubleLinkedOpenHashMap.this.key[pos] != 0)
/* 1748 */                 consumer.accept(Short2DoubleLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */   
/*      */   public boolean trim() {
/* 1768 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1800 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1801 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1802 */       return true; 
/*      */     try {
/* 1804 */       rehash(l);
/* 1805 */     } catch (OutOfMemoryError cantDoIt) {
/* 1806 */       return false;
/*      */     } 
/* 1808 */     return true;
/*      */   }
...
/* 1824 */     short[] key = this.key;
/* 1825 */     double[] value = this.value;
/* 1826 */     int mask = newN - 1;
/* 1827 */     short[] newKey = new short[newN + 1];
/* 1828 */     double[] newValue = new double[newN + 1];
/* 1829 */     int i = this.first, prev = -1, newPrev = -1;
/* 1830 */     long[] link = this.link;
/* 1831 */     long[] newLink = new long[newN + 1];
/* 1832 */     this.first = -1;
/* 1833 */     for (int j = this.size; j-- != 0; ) {
/* 1834 */       int pos; if (key[i] == 0) {
/* 1835 */         pos = newN;
/*      */       } else {
/* 1837 */         pos = HashCommon.mix(key[i]) & mask;
/* 1838 */         while (newKey[pos] != 0)
/* 1839 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1882 */       c = (Short2DoubleLinkedOpenHashMap)super.clone();
...
/* 1890 */     c.key = (short[])this.key.clone();
/* 1891 */     c.value = (double[])this.value.clone();
...
/* 1908 */       while (this.key[i] == 0)
/* 1909 */         i++; 
/* 1910 */       t = this.key[i];
/* 1911 */       t ^= HashCommon.double2int(this.value[i]);
/* 1912 */       h += t;
/* 1913 */       i++;
/*      */     } 
/*      */     
/* 1916 */     if (this.containsNullKey)
/* 1917 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1918 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1921 */     short[] key = this.key;
/* 1922 */     double[] value = this.value;
/* 1923 */     MapIterator i = new MapIterator();
/* 1924 */     s.defaultWriteObject();
/* 1925 */     for (int j = this.size; j-- != 0; ) {
/* 1926 */       int e = i.nextEntry();
/* 1927 */       s.writeShort(key[e]);
/* 1928 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1933 */     s.defaultReadObject();
/* 1934 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1935 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1936 */     this.mask = this.n - 1;
/* 1937 */     short[] key = this.key = new short[this.n + 1];
/* 1938 */     double[] value = this.value = new double[this.n + 1];
/* 1939 */     long[] link = this.link = new long[this.n + 1];
/* 1940 */     int prev = -1;
/* 1941 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1944 */     for (int i = this.size; i-- != 0; ) {
/* 1945 */       int pos; short k = s.readShort();
/* 1946 */       double v = s.readDouble();
/* 1947 */       if (k == 0) {
/* 1948 */         pos = this.n;
/* 1949 */         this.containsNullKey = true;
/*      */       } else {
/* 1951 */         pos = HashCommon.mix(k) & this.mask;
/* 1952 */         while (key[pos] != 0)
/* 1953 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1955 */       key[pos] = k;
/* 1956 */       value[pos] = v;
/* 1957 */       if (this.first != -1) {
/* 1958 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1959 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1960 */         prev = pos; continue;
/*      */       } 
/* 1962 */       prev = this.first = pos;
/*      */       
/* 1964 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1967 */     this.last = prev;
/* 1968 */     if (prev != -1)
/*      */     {
/* 1970 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2DoubleLinkedOpenHashMap.class
