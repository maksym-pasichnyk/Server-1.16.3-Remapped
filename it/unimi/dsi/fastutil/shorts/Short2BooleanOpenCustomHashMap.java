...
/* 1132 */     short[] key = this.key;
/* 1133 */     boolean[] value = this.value;
/* 1134 */     int mask = newN - 1;
/* 1135 */     short[] newKey = new short[newN + 1];
/* 1136 */     boolean[] newValue = new boolean[newN + 1];
/* 1137 */     int i = this.n;
/* 1138 */     for (int j = realSize(); j-- != 0; ) {
/* 1139 */       while (key[--i] == 0); int pos;
/* 1140 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
/*      */       {
...
/*      */     try {
/* 1168 */       c = (Short2BooleanOpenCustomHashMap)super.clone();
...
/* 1177 */     c.value = (boolean[])this.value.clone();
/* 1178 */     c.strategy = this.strategy;
/* 1179 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1195 */         i++; 
/* 1196 */       t = this.strategy.hashCode(this.key[i]);
/* 1197 */       t ^= this.value[i] ? 1231 : 1237;
/* 1198 */       h += t;
/* 1199 */       i++;
/*      */     } 
/*      */     
/* 1202 */     if (this.containsNullKey)
/* 1203 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1204 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1207 */     short[] key = this.key;
/* 1208 */     boolean[] value = this.value;
/* 1209 */     MapIterator i = new MapIterator();
/* 1210 */     s.defaultWriteObject();
/* 1211 */     for (int j = this.size; j-- != 0; ) {
/* 1212 */       int e = i.nextEntry();
/* 1213 */       s.writeShort(key[e]);
/* 1214 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1223 */     short[] key = this.key = new short[this.n + 1];
/* 1224 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1227 */     for (int i = this.size; i-- != 0; ) {
/* 1228 */       int pos; short k = s.readShort();
/* 1229 */       boolean v = s.readBoolean();
/* 1230 */       if (this.strategy.equals(k, (short)0)) {
/* 1231 */         pos = this.n;
/* 1232 */         this.containsNullKey = true;
/*      */       } else {
/* 1234 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2BooleanOpenCustomHashMap.class
