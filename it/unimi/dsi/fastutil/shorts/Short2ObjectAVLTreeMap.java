...
/*  936 */       return (this.key == ((Short)e.getKey()).shortValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1022 */     int index = 0;
/*      */     TreeIterator() {
/* 1024 */       this.next = Short2ObjectAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/* 1027 */       if ((this.next = Short2ObjectAVLTreeMap.this.locateKey(k)) != null)
/* 1028 */         if (Short2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1079 */       updatePrevious();
/* 1080 */       updateNext();
/* 1081 */       Short2ObjectAVLTreeMap.this.remove(this.curr.key);
/* 1082 */       this.curr = null;
/*      */     }
...
/* 1129 */       this.entries = (ObjectSortedSet<Short2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1138 */             return (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>>)new Short2ObjectAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator(Short2ObjectMap.Entry<V> from) {
/* 1143 */             return (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>>)new Short2ObjectAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1151 */             if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1152 */               return false; 
/* 1153 */             Short2ObjectAVLTreeMap.Entry<V> f = Short2ObjectAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1162 */             if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1163 */               return false; 
/* 1164 */             Short2ObjectAVLTreeMap.Entry<V> f = Short2ObjectAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1165 */             if (f == null || !Objects.equals(f.getValue(), e.getValue()))
/* 1166 */               return false; 
/* 1167 */             Short2ObjectAVLTreeMap.this.remove(f.key);
/* 1168 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1172 */             return Short2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1176 */             Short2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2ObjectMap.Entry<V> first() {
/* 1180 */             return Short2ObjectAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2ObjectMap.Entry<V> last() {
/* 1184 */             return Short2ObjectAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2ObjectMap.Entry<V>> subSet(Short2ObjectMap.Entry<V> from, Short2ObjectMap.Entry<V> to) {
/* 1189 */             return Short2ObjectAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2ObjectMap.Entry<V>> headSet(Short2ObjectMap.Entry<V> to) {
/* 1193 */             return Short2ObjectAVLTreeMap.this.headMap(to.getShortKey()).short2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2ObjectMap.Entry<V>> tailSet(Short2ObjectMap.Entry<V> from) {
/* 1197 */             return Short2ObjectAVLTreeMap.this.tailMap(from.getShortKey()).short2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1231 */       return new Short2ObjectAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1235 */       return new Short2ObjectAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1290 */             return (ObjectIterator<V>)new Short2ObjectAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1294 */             return Short2ObjectAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1298 */             return Short2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1302 */             Short2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1313 */     return new Submap((short)0, true, to, false);
/*      */   }
/*      */   
/*      */   public Short2ObjectSortedMap<V> tailMap(short from) {
/* 1317 */     return new Submap(from, false, (short)0, true);
/*      */   }
/*      */   
...
/* 1365 */       if (!bottom && !top && Short2ObjectAVLTreeMap.this.compare(from, to) > 0)
/* 1366 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Short2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1389 */       return ((this.bottom || Short2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2ObjectAVLTreeMap.this
/* 1390 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
/* 1394 */       if (this.entries == null)
/* 1395 */         this.entries = (ObjectSortedSet<Short2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator() {
/* 1398 */               return (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>>)new Short2ObjectAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator(Short2ObjectMap.Entry<V> from) {
/* 1403 */               return (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>>)new Short2ObjectAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2ObjectMap.Entry<V>> comparator() {
/* 1407 */               return Short2ObjectAVLTreeMap.this.short2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1415 */               if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1416 */                 return false; 
/* 1417 */               Short2ObjectAVLTreeMap.Entry<V> f = Short2ObjectAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1418 */               return (f != null && Short2ObjectAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1426 */               if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1427 */                 return false; 
/* 1428 */               Short2ObjectAVLTreeMap.Entry<V> f = Short2ObjectAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1429 */               if (f != null && Short2ObjectAVLTreeMap.Submap.this.in(f.key))
/* 1430 */                 Short2ObjectAVLTreeMap.Submap.this.remove(f.key); 
/* 1431 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1435 */               int c = 0;
/* 1436 */               for (ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1437 */                 c++; 
/* 1438 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1442 */               return !(new Short2ObjectAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1446 */               Short2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2ObjectMap.Entry<V> first() {
/* 1450 */               return Short2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2ObjectMap.Entry<V> last() {
/* 1454 */               return Short2ObjectAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2ObjectMap.Entry<V>> subSet(Short2ObjectMap.Entry<V> from, Short2ObjectMap.Entry<V> to) {
/* 1459 */               return Short2ObjectAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2ObjectMap.Entry<V>> headSet(Short2ObjectMap.Entry<V> to) {
/* 1463 */               return Short2ObjectAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2ObjectMap.Entry<V>> tailSet(Short2ObjectMap.Entry<V> from) {
/* 1467 */               return Short2ObjectAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2ObjectEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2ObjectSortedMap<V>.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1475 */         return new Short2ObjectAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1479 */         return new Short2ObjectAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1494 */               return (ObjectIterator<V>)new Short2ObjectAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1498 */               return Short2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1502 */               return Short2ObjectAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1506 */               Short2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1514 */       return (in(k) && Short2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(short k) {
/* 1531 */       short kk = k; Short2ObjectAVLTreeMap.Entry<V> e;
/* 1532 */       return (in(kk) && (e = Short2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(short k, V v) {
/* 1536 */       Short2ObjectAVLTreeMap.this.modified = false;
/* 1537 */       if (!in(k))
...
/* 1540 */       V oldValue = Short2ObjectAVLTreeMap.this.put(k, v);
/* 1541 */       return Short2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(short k) {
/* 1546 */       Short2ObjectAVLTreeMap.this.modified = false;
/* 1547 */       if (!in(k))
/* 1548 */         return this.defRetValue; 
/* 1549 */       V oldValue = Short2ObjectAVLTreeMap.this.remove(k);
/* 1550 */       return Short2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1568 */       return Short2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2ObjectSortedMap<V> headMap(short to) {
/* 1572 */       if (this.top)
/* 1573 */         return new Submap(this.from, this.bottom, to, false); 
/* 1574 */       return (Short2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2ObjectSortedMap<V> tailMap(short from) {
/* 1578 */       if (this.bottom)
/* 1579 */         return new Submap(from, false, this.to, this.top); 
/* 1580 */       return (Short2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2ObjectSortedMap<V> subMap(short from, short to) {
...
/* 1586 */       if (!this.top)
/* 1587 */         to = (Short2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1588 */       if (!this.bottom)
/* 1589 */         from = (Short2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1601 */       if (Short2ObjectAVLTreeMap.this.tree == null) {
/* 1602 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1606 */       if (this.bottom) {
/* 1607 */         e = Short2ObjectAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1609 */         e = Short2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1611 */         if (Short2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1612 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1616 */       if (e == null || (!this.top && Short2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1617 */         return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2ObjectAVLTreeMap.Entry<V> e;
/* 1627 */       if (Short2ObjectAVLTreeMap.this.tree == null) {
/* 1628 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1632 */       if (this.top) {
/* 1633 */         e = Short2ObjectAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1635 */         e = Short2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1637 */         if (Short2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1638 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1642 */       if (e == null || (!this.bottom && Short2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1643 */         return null; 
/* 1644 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1648 */       Short2ObjectAVLTreeMap.Entry<V> e = firstEntry();
/* 1649 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1655 */       Short2ObjectAVLTreeMap.Entry<V> e = lastEntry();
/* 1656 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1671 */         this.next = Short2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1674 */         this();
/* 1675 */         if (this.next != null)
/* 1676 */           if (!Short2ObjectAVLTreeMap.Submap.this.bottom && Short2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1677 */             this.prev = null;
/* 1678 */           } else if (!Short2ObjectAVLTreeMap.Submap.this.top && Short2ObjectAVLTreeMap.this.compare(k, (this.prev = Short2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1679 */             this.next = null;
/*      */           } else {
/* 1681 */             this.next = Short2ObjectAVLTreeMap.this.locateKey(k);
/* 1682 */             if (Short2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1693 */         if (!Short2ObjectAVLTreeMap.Submap.this.bottom && this.prev != null && Short2ObjectAVLTreeMap.this.compare(this.prev.key, Short2ObjectAVLTreeMap.Submap.this.from) < 0)
/* 1694 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1698 */         this.next = this.next.next();
/* 1699 */         if (!Short2ObjectAVLTreeMap.Submap.this.top && this.next != null && Short2ObjectAVLTreeMap.this.compare(this.next.key, Short2ObjectAVLTreeMap.Submap.this.to) >= 0)
/* 1700 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1782 */       c = (Short2ObjectAVLTreeMap<V>)super.clone();
...
/* 1863 */     if (n == 1) {
/* 1864 */       Entry<V> entry = new Entry<>(s.readShort(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1874 */       Entry<V> entry = new Entry<>(s.readShort(), (V)s.readObject());
/* 1875 */       entry.right(new Entry<>(s.readShort(), (V)s.readObject()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2ObjectAVLTreeMap.class
