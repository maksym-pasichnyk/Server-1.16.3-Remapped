...
/*  888 */         return false; 
/*  889 */       Map.Entry<Short, Boolean> e = (Map.Entry<Short, Boolean>)o;
/*  890 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  976 */     int index = 0;
/*      */     TreeIterator() {
/*  978 */       this.next = Short2BooleanRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/*  981 */       if ((this.next = Short2BooleanRBTreeMap.this.locateKey(k)) != null)
/*  982 */         if (Short2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1033 */       updatePrevious();
/* 1034 */       updateNext();
/* 1035 */       Short2BooleanRBTreeMap.this.remove(this.curr.key);
/* 1036 */       this.curr = null;
/*      */     }
...
/* 1075 */       this.entries = (ObjectSortedSet<Short2BooleanMap.Entry>)new AbstractObjectSortedSet<Short2BooleanMap.Entry>()
/*      */         {
...
/* 1084 */             return (ObjectBidirectionalIterator<Short2BooleanMap.Entry>)new Short2BooleanRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from) {
/* 1088 */             return (ObjectBidirectionalIterator<Short2BooleanMap.Entry>)new Short2BooleanRBTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1096 */             if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1097 */               return false; 
/* 1098 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1099 */               return false; 
/* 1100 */             Short2BooleanRBTreeMap.Entry f = Short2BooleanRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1109 */             if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1110 */               return false; 
/* 1111 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1112 */               return false; 
/* 1113 */             Short2BooleanRBTreeMap.Entry f = Short2BooleanRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1114 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue())
/* 1115 */               return false; 
/* 1116 */             Short2BooleanRBTreeMap.this.remove(f.key);
/* 1117 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1121 */             return Short2BooleanRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1125 */             Short2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2BooleanMap.Entry first() {
/* 1129 */             return Short2BooleanRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2BooleanMap.Entry last() {
/* 1133 */             return Short2BooleanRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry from, Short2BooleanMap.Entry to) {
/* 1138 */             return Short2BooleanRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry to) {
/* 1142 */             return Short2BooleanRBTreeMap.this.headMap(to.getShortKey()).short2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry from) {
/* 1146 */             return Short2BooleanRBTreeMap.this.tailMap(from.getShortKey()).short2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1180 */       return new Short2BooleanRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1184 */       return new Short2BooleanRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1239 */             return (BooleanIterator)new Short2BooleanRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1243 */             return Short2BooleanRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1247 */             return Short2BooleanRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1251 */             Short2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1314 */       if (!bottom && !top && Short2BooleanRBTreeMap.this.compare(from, to) > 0)
/* 1315 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1316 */       this.from = from;
/* 1317 */       this.bottom = bottom;
/* 1318 */       this.to = to;
/* 1319 */       this.top = top;
/* 1320 */       this.defRetValue = Short2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1338 */       return ((this.bottom || Short2BooleanRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2BooleanRBTreeMap.this
/* 1339 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
/* 1343 */       if (this.entries == null)
/* 1344 */         this.entries = (ObjectSortedSet<Short2BooleanMap.Entry>)new AbstractObjectSortedSet<Short2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator() {
/* 1347 */               return (ObjectBidirectionalIterator<Short2BooleanMap.Entry>)new Short2BooleanRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from) {
/* 1352 */               return (ObjectBidirectionalIterator<Short2BooleanMap.Entry>)new Short2BooleanRBTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2BooleanMap.Entry> comparator() {
/* 1356 */               return Short2BooleanRBTreeMap.this.short2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1367 */                 return false; 
/* 1368 */               Short2BooleanRBTreeMap.Entry f = Short2BooleanRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1369 */               return (f != null && Short2BooleanRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1377 */               if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1378 */                 return false; 
/* 1379 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1380 */                 return false; 
/* 1381 */               Short2BooleanRBTreeMap.Entry f = Short2BooleanRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1382 */               if (f != null && Short2BooleanRBTreeMap.Submap.this.in(f.key))
/* 1383 */                 Short2BooleanRBTreeMap.Submap.this.remove(f.key); 
/* 1384 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1388 */               int c = 0;
/* 1389 */               for (ObjectBidirectionalIterator<Short2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1390 */                 c++; 
/* 1391 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1395 */               return !(new Short2BooleanRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1399 */               Short2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2BooleanMap.Entry first() {
/* 1403 */               return Short2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2BooleanMap.Entry last() {
/* 1407 */               return Short2BooleanRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry from, Short2BooleanMap.Entry to) {
/* 1412 */               return Short2BooleanRBTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry to) {
/* 1416 */               return Short2BooleanRBTreeMap.Submap.this.headMap(to.getShortKey()).short2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry from) {
/* 1420 */               return Short2BooleanRBTreeMap.Submap.this.tailMap(from.getShortKey()).short2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2BooleanSortedMap.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1428 */         return new Short2BooleanRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1432 */         return new Short2BooleanRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1447 */               return (BooleanIterator)new Short2BooleanRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1451 */               return Short2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1455 */               return Short2BooleanRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1459 */               Short2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1467 */       return (in(k) && Short2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(short k) {
/* 1484 */       short kk = k; Short2BooleanRBTreeMap.Entry e;
/* 1485 */       return (in(kk) && (e = Short2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public boolean put(short k, boolean v) {
/* 1489 */       Short2BooleanRBTreeMap.this.modified = false;
/* 1490 */       if (!in(k))
...
/* 1493 */       boolean oldValue = Short2BooleanRBTreeMap.this.put(k, v);
/* 1494 */       return Short2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(short k) {
/* 1499 */       Short2BooleanRBTreeMap.this.modified = false;
/* 1500 */       if (!in(k))
/* 1501 */         return this.defRetValue; 
/* 1502 */       boolean oldValue = Short2BooleanRBTreeMap.this.remove(k);
/* 1503 */       return Short2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1521 */       return Short2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2BooleanSortedMap headMap(short to) {
/* 1525 */       if (this.top)
/* 1526 */         return new Submap(this.from, this.bottom, to, false); 
/* 1527 */       return (Short2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2BooleanSortedMap tailMap(short from) {
/* 1531 */       if (this.bottom)
/* 1532 */         return new Submap(from, false, this.to, this.top); 
/* 1533 */       return (Short2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2BooleanSortedMap subMap(short from, short to) {
...
/* 1539 */       if (!this.top)
/* 1540 */         to = (Short2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1541 */       if (!this.bottom)
/* 1542 */         from = (Short2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1554 */       if (Short2BooleanRBTreeMap.this.tree == null) {
/* 1555 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1559 */       if (this.bottom) {
/* 1560 */         e = Short2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1562 */         e = Short2BooleanRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1564 */         if (Short2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1565 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1569 */       if (e == null || (!this.top && Short2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1570 */         return null; 
/* 1571 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2BooleanRBTreeMap.Entry e;
/* 1580 */       if (Short2BooleanRBTreeMap.this.tree == null) {
/* 1581 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1585 */       if (this.top) {
/* 1586 */         e = Short2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1588 */         e = Short2BooleanRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1590 */         if (Short2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1591 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1595 */       if (e == null || (!this.bottom && Short2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1596 */         return null; 
/* 1597 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1601 */       Short2BooleanRBTreeMap.Entry e = firstEntry();
/* 1602 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1608 */       Short2BooleanRBTreeMap.Entry e = lastEntry();
/* 1609 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1624 */         this.next = Short2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1627 */         this();
/* 1628 */         if (this.next != null)
/* 1629 */           if (!Short2BooleanRBTreeMap.Submap.this.bottom && Short2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1630 */             this.prev = null;
/* 1631 */           } else if (!Short2BooleanRBTreeMap.Submap.this.top && Short2BooleanRBTreeMap.this.compare(k, (this.prev = Short2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1632 */             this.next = null;
/*      */           } else {
/* 1634 */             this.next = Short2BooleanRBTreeMap.this.locateKey(k);
/* 1635 */             if (Short2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1646 */         if (!Short2BooleanRBTreeMap.Submap.this.bottom && this.prev != null && Short2BooleanRBTreeMap.this.compare(this.prev.key, Short2BooleanRBTreeMap.Submap.this.from) < 0)
/* 1647 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1651 */         this.next = this.next.next();
/* 1652 */         if (!Short2BooleanRBTreeMap.Submap.this.top && this.next != null && Short2BooleanRBTreeMap.this.compare(this.next.key, Short2BooleanRBTreeMap.Submap.this.to) >= 0)
/* 1653 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1733 */       c = (Short2BooleanRBTreeMap)super.clone();
...
/* 1814 */     if (n == 1) {
/* 1815 */       Entry entry = new Entry(s.readShort(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1826 */       Entry entry = new Entry(s.readShort(), s.readBoolean());
/* 1827 */       entry.black(true);
/* 1828 */       entry.right(new Entry(s.readShort(), s.readBoolean()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2BooleanRBTreeMap.class
