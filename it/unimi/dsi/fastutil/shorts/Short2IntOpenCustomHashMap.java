...
/*      */   
/*      */   public boolean trim() {
/* 1120 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1152 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1153 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1154 */       return true; 
/*      */     try {
/* 1156 */       rehash(l);
/* 1157 */     } catch (OutOfMemoryError cantDoIt) {
/* 1158 */       return false;
/*      */     } 
/* 1160 */     return true;
/*      */   }
...
/* 1176 */     short[] key = this.key;
/* 1177 */     int[] value = this.value;
/* 1178 */     int mask = newN - 1;
/* 1179 */     short[] newKey = new short[newN + 1];
/* 1180 */     int[] newValue = new int[newN + 1];
/* 1181 */     int i = this.n;
/* 1182 */     for (int j = realSize(); j-- != 0; ) {
/* 1183 */       while (key[--i] == 0); int pos;
/* 1184 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
/*      */       {
/* 1186 */         while (newKey[pos = pos + 1 & mask] != 0); } 
/* 1187 */       newKey[pos] = key[i];
/* 1188 */       newValue[pos] = value[i];
/*      */     } 
/* 1190 */     newValue[newN] = value[this.n];
/* 1191 */     this.n = newN;
/* 1192 */     this.mask = mask;
/* 1193 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1194 */     this.key = newKey;
/* 1195 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1212 */       c = (Short2IntOpenCustomHashMap)super.clone();
/* 1213 */     } catch (CloneNotSupportedException cantHappen) {
/* 1214 */       throw new InternalError();
/*      */     } 
/* 1216 */     c.keys = null;
/* 1217 */     c.values = null;
/* 1218 */     c.entries = null;
/* 1219 */     c.containsNullKey = this.containsNullKey;
/* 1220 */     c.key = (short[])this.key.clone();
/* 1221 */     c.value = (int[])this.value.clone();
/* 1222 */     c.strategy = this.strategy;
/* 1223 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1236 */     int h = 0;
/* 1237 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1238 */       while (this.key[i] == 0)
/* 1239 */         i++; 
/* 1240 */       t = this.strategy.hashCode(this.key[i]);
/* 1241 */       t ^= this.value[i];
/* 1242 */       h += t;
/* 1243 */       i++;
/*      */     } 
/*      */     
/* 1246 */     if (this.containsNullKey)
/* 1247 */       h += this.value[this.n]; 
/* 1248 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1251 */     short[] key = this.key;
/* 1252 */     int[] value = this.value;
/* 1253 */     MapIterator i = new MapIterator();
/* 1254 */     s.defaultWriteObject();
/* 1255 */     for (int j = this.size; j-- != 0; ) {
/* 1256 */       int e = i.nextEntry();
/* 1257 */       s.writeShort(key[e]);
/* 1258 */       s.writeInt(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1267 */     short[] key = this.key = new short[this.n + 1];
/* 1268 */     int[] value = this.value = new int[this.n + 1];
/*      */ 
/*      */     
/* 1271 */     for (int i = this.size; i-- != 0; ) {
/* 1272 */       int pos; short k = s.readShort();
/* 1273 */       int v = s.readInt();
/* 1274 */       if (this.strategy.equals(k, (short)0)) {
/* 1275 */         pos = this.n;
/* 1276 */         this.containsNullKey = true;
/*      */       } else {
/* 1278 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1279 */         while (key[pos] != 0)
/* 1280 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1282 */       key[pos] = k;
/* 1283 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2IntOpenCustomHashMap.class
