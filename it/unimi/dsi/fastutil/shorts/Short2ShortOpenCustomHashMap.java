...
/* 1180 */     short[] value = this.value;
/* 1181 */     int mask = newN - 1;
/* 1182 */     short[] newKey = new short[newN + 1];
/* 1183 */     short[] newValue = new short[newN + 1];
/* 1184 */     int i = this.n;
...
/*      */     try {
/* 1215 */       c = (Short2ShortOpenCustomHashMap)super.clone();
...
/* 1224 */     c.value = (short[])this.value.clone();
...
/* 1250 */       h += this.value[this.n]; 
/* 1251 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1254 */     short[] key = this.key;
/* 1255 */     short[] value = this.value;
...
/* 1271 */     short[] value = this.value = new short[this.n + 1];
/*      */ 
/*      */     
/* 1274 */     for (int i = this.size; i-- != 0; ) {
/* 1275 */       int pos; short k = s.readShort();
/* 1276 */       short v = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2ShortOpenCustomHashMap.class
