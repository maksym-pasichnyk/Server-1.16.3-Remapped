...
/*      */     try {
/* 1134 */       c = (Short2ObjectOpenCustomHashMap<V>)super.clone();
...
/* 1164 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1165 */       h += t;
/* 1166 */       i++;
/*      */     } 
/*      */     
/* 1169 */     if (this.containsNullKey)
/* 1170 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1171 */     return h;
/*      */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2ObjectOpenCustomHashMap.class
