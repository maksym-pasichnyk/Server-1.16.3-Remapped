...
/*  954 */         return false; 
/*  955 */       Map.Entry<Short, Long> e = (Map.Entry<Short, Long>)o;
/*  956 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  960 */       return this.key ^ HashCommon.long2int(this.value);
/*      */     }
/*      */     
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Short2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/* 1047 */       if ((this.next = Short2LongAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Short2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Short2LongAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Short2LongMap.Entry>)new AbstractObjectSortedSet<Short2LongMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1171 */               return false; 
/* 1172 */             if (e.getValue() == null || !(e.getValue() instanceof Long))
/* 1173 */               return false; 
/* 1174 */             Short2LongAVLTreeMap.Entry f = Short2LongAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1184 */               return false; 
/* 1185 */             if (e.getValue() == null || !(e.getValue() instanceof Long))
/* 1186 */               return false; 
/* 1187 */             Short2LongAVLTreeMap.Entry f = Short2LongAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1188 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue())
/* 1189 */               return false; 
/* 1190 */             Short2LongAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Short2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Short2LongAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2LongMap.Entry first() {
/* 1203 */             return Short2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2LongMap.Entry last() {
/* 1207 */             return Short2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) {
/* 1211 */             return Short2LongAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry to) {
/* 1215 */             return Short2LongAVLTreeMap.this.headMap(to.getShortKey()).short2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from) {
/* 1219 */             return Short2LongAVLTreeMap.this.tailMap(from.getShortKey()).short2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Short2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1257 */       return new Short2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1309 */       this.values = (LongCollection)new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1312 */             return (LongIterator)new Short2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(long k) {
/* 1316 */             return Short2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Short2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Short2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Short2LongAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Short2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Short2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2LongAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Short2LongMap.Entry>)new AbstractObjectSortedSet<Short2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2LongMap.Entry> comparator() {
/* 1428 */               return Short2LongAVLTreeMap.this.short2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1437 */                 return false; 
/* 1438 */               if (e.getValue() == null || !(e.getValue() instanceof Long))
/* 1439 */                 return false; 
/* 1440 */               Short2LongAVLTreeMap.Entry f = Short2LongAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1441 */               return (f != null && Short2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1450 */                 return false; 
/* 1451 */               if (e.getValue() == null || !(e.getValue() instanceof Long))
/* 1452 */                 return false; 
/* 1453 */               Short2LongAVLTreeMap.Entry f = Short2LongAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1454 */               if (f != null && Short2LongAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Short2LongAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Short2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Short2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Short2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2LongMap.Entry first() {
/* 1475 */               return Short2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2LongMap.Entry last() {
/* 1479 */               return Short2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) {
/* 1484 */               return Short2LongAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry to) {
/* 1488 */               return Short2LongAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from) {
/* 1492 */               return Short2LongAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2LongSortedMap.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1500 */         return new Short2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1504 */         return new Short2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/* 1516 */         this.values = (LongCollection)new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1519 */               return (LongIterator)new Short2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(long k) {
/* 1523 */               return Short2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1527 */               return Short2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1531 */               Short2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1539 */       return (in(k) && Short2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(long v) {
...
/* 1546 */         long ev = (i.nextEntry()).value;
/* 1547 */         if (ev == v)
/* 1548 */           return true; 
/*      */       } 
/* 1550 */       return false;
...
/*      */     
/*      */     public long get(short k) {
/* 1556 */       short kk = k; Short2LongAVLTreeMap.Entry e;
/* 1557 */       return (in(kk) && (e = Short2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public long put(short k, long v) {
/* 1561 */       Short2LongAVLTreeMap.this.modified = false;
/* 1562 */       if (!in(k))
...
/* 1565 */       long oldValue = Short2LongAVLTreeMap.this.put(k, v);
/* 1566 */       return Short2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long remove(short k) {
/* 1571 */       Short2LongAVLTreeMap.this.modified = false;
/* 1572 */       if (!in(k))
/* 1573 */         return this.defRetValue; 
/* 1574 */       long oldValue = Short2LongAVLTreeMap.this.remove(k);
/* 1575 */       return Short2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1593 */       return Short2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2LongSortedMap headMap(short to) {
/* 1597 */       if (this.top)
/* 1598 */         return new Submap(this.from, this.bottom, to, false); 
/* 1599 */       return (Short2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2LongSortedMap tailMap(short from) {
/* 1603 */       if (this.bottom)
/* 1604 */         return new Submap(from, false, this.to, this.top); 
/* 1605 */       return (Short2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2LongSortedMap subMap(short from, short to) {
...
/* 1611 */       if (!this.top)
/* 1612 */         to = (Short2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1613 */       if (!this.bottom)
/* 1614 */         from = (Short2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1626 */       if (Short2LongAVLTreeMap.this.tree == null) {
/* 1627 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1631 */       if (this.bottom) {
/* 1632 */         e = Short2LongAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1634 */         e = Short2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1636 */         if (Short2LongAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1637 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1641 */       if (e == null || (!this.top && Short2LongAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1642 */         return null; 
/* 1643 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2LongAVLTreeMap.Entry e;
/* 1652 */       if (Short2LongAVLTreeMap.this.tree == null) {
/* 1653 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1657 */       if (this.top) {
/* 1658 */         e = Short2LongAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1660 */         e = Short2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1662 */         if (Short2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1663 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1667 */       if (e == null || (!this.bottom && Short2LongAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1668 */         return null; 
/* 1669 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1673 */       Short2LongAVLTreeMap.Entry e = firstEntry();
/* 1674 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1680 */       Short2LongAVLTreeMap.Entry e = lastEntry();
/* 1681 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1696 */         this.next = Short2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1699 */         this();
/* 1700 */         if (this.next != null)
/* 1701 */           if (!Short2LongAVLTreeMap.Submap.this.bottom && Short2LongAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1702 */             this.prev = null;
/* 1703 */           } else if (!Short2LongAVLTreeMap.Submap.this.top && Short2LongAVLTreeMap.this.compare(k, (this.prev = Short2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1704 */             this.next = null;
/*      */           } else {
/* 1706 */             this.next = Short2LongAVLTreeMap.this.locateKey(k);
/* 1707 */             if (Short2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1718 */         if (!Short2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Short2LongAVLTreeMap.this.compare(this.prev.key, Short2LongAVLTreeMap.Submap.this.from) < 0)
/* 1719 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1723 */         this.next = this.next.next();
/* 1724 */         if (!Short2LongAVLTreeMap.Submap.this.top && this.next != null && Short2LongAVLTreeMap.this.compare(this.next.key, Short2LongAVLTreeMap.Submap.this.to) >= 0)
/* 1725 */           this.next = null; 
/*      */       } }
/*      */     
/*      */     private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Short2LongMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1805 */       c = (Short2LongAVLTreeMap)super.clone();
...
/* 1886 */     if (n == 1) {
/* 1887 */       Entry entry = new Entry(s.readShort(), s.readLong());
...
/*      */ 
/*      */       
/* 1897 */       Entry entry = new Entry(s.readShort(), s.readLong());
/* 1898 */       entry.right(new Entry(s.readShort(), s.readLong()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongAVLTreeMap.class
