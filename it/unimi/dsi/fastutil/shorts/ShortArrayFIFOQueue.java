...
/*  62 */     this.array = new short[Math.max(1, capacity)];
...
/*  85 */     short t = this.array[this.start];
...
/*     */   public void trim() {
/* 171 */     int size = size();
/* 172 */     short[] newArray = new short[size + 1];
...
/* 202 */     this.array = new short[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
/* 203 */     for (int i = 0; i < this.end; i++)
/* 204 */       this.array[i] = s.readShort(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\ShortArrayFIFOQueue.class
