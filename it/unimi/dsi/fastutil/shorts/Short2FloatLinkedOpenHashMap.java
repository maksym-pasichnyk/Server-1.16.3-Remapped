...
/* 1825 */     float[] value = this.value;
/* 1826 */     int mask = newN - 1;
/* 1827 */     short[] newKey = new short[newN + 1];
/* 1828 */     float[] newValue = new float[newN + 1];
...
/*      */     try {
/* 1882 */       c = (Short2FloatLinkedOpenHashMap)super.clone();
...
/* 1891 */     c.value = (float[])this.value.clone();
...
/* 1909 */         i++; 
/* 1910 */       t = this.key[i];
/* 1911 */       t ^= HashCommon.float2int(this.value[i]);
/* 1912 */       h += t;
/* 1913 */       i++;
/*      */     } 
/*      */     
/* 1916 */     if (this.containsNullKey)
/* 1917 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1918 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1921 */     short[] key = this.key;
/* 1922 */     float[] value = this.value;
...
/* 1938 */     float[] value = this.value = new float[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2FloatLinkedOpenHashMap.class
