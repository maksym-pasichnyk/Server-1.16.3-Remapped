...
/*  954 */         return false; 
/*  955 */       Map.Entry<Short, Float> e = (Map.Entry<Short, Float>)o;
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Short2FloatAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/* 1048 */       if ((this.next = Short2FloatAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Short2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Short2FloatAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Short2FloatMap.Entry>)new AbstractObjectSortedSet<Short2FloatMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1174 */               return false; 
/* 1175 */             Short2FloatAVLTreeMap.Entry f = Short2FloatAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1187 */               return false; 
/* 1188 */             Short2FloatAVLTreeMap.Entry f = Short2FloatAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1189 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != 
/* 1190 */               Float.floatToIntBits(((Float)e.getValue()).floatValue()))
/* 1191 */               return false; 
/* 1192 */             Short2FloatAVLTreeMap.this.remove(f.key);
/* 1193 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1197 */             return Short2FloatAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1201 */             Short2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2FloatMap.Entry first() {
/* 1205 */             return Short2FloatAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2FloatMap.Entry last() {
/* 1209 */             return Short2FloatAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) {
/* 1214 */             return Short2FloatAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) {
/* 1218 */             return Short2FloatAVLTreeMap.this.headMap(to.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) {
/* 1222 */             return Short2FloatAVLTreeMap.this.tailMap(from.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1256 */       return new Short2FloatAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1260 */       return new Short2FloatAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1315 */             return (FloatIterator)new Short2FloatAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(float k) {
/* 1319 */             return Short2FloatAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1323 */             return Short2FloatAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1327 */             Short2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1390 */       if (!bottom && !top && Short2FloatAVLTreeMap.this.compare(from, to) > 0)
/* 1391 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1392 */       this.from = from;
/* 1393 */       this.bottom = bottom;
/* 1394 */       this.to = to;
/* 1395 */       this.top = top;
/* 1396 */       this.defRetValue = Short2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1414 */       return ((this.bottom || Short2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2FloatAVLTreeMap.this
/* 1415 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
/* 1419 */       if (this.entries == null)
/* 1420 */         this.entries = (ObjectSortedSet<Short2FloatMap.Entry>)new AbstractObjectSortedSet<Short2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator() {
/* 1423 */               return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1427 */               return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2FloatMap.Entry> comparator() {
/* 1431 */               return Short2FloatAVLTreeMap.this.short2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */               if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1440 */                 return false; 
/* 1441 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1442 */                 return false; 
/* 1443 */               Short2FloatAVLTreeMap.Entry f = Short2FloatAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1444 */               return (f != null && Short2FloatAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */               if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1453 */                 return false; 
/* 1454 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1455 */                 return false; 
/* 1456 */               Short2FloatAVLTreeMap.Entry f = Short2FloatAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1457 */               if (f != null && Short2FloatAVLTreeMap.Submap.this.in(f.key))
/* 1458 */                 Short2FloatAVLTreeMap.Submap.this.remove(f.key); 
/* 1459 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1463 */               int c = 0;
/* 1464 */               for (ObjectBidirectionalIterator<Short2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1465 */                 c++; 
/* 1466 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1470 */               return !(new Short2FloatAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1474 */               Short2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2FloatMap.Entry first() {
/* 1478 */               return Short2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2FloatMap.Entry last() {
/* 1482 */               return Short2FloatAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) {
/* 1487 */               return Short2FloatAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) {
/* 1491 */               return Short2FloatAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) {
/* 1495 */               return Short2FloatAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2FloatSortedMap.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1503 */         return new Short2FloatAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1507 */         return new Short2FloatAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/* 1519 */         this.values = (FloatCollection)new AbstractFloatCollection()
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1522 */               return (FloatIterator)new Short2FloatAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(float k) {
/* 1526 */               return Short2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1530 */               return Short2FloatAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1534 */               Short2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1542 */       return (in(k) && Short2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(short k) {
/* 1559 */       short kk = k; Short2FloatAVLTreeMap.Entry e;
/* 1560 */       return (in(kk) && (e = Short2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public float put(short k, float v) {
/* 1564 */       Short2FloatAVLTreeMap.this.modified = false;
/* 1565 */       if (!in(k))
...
/* 1568 */       float oldValue = Short2FloatAVLTreeMap.this.put(k, v);
/* 1569 */       return Short2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float remove(short k) {
/* 1574 */       Short2FloatAVLTreeMap.this.modified = false;
/* 1575 */       if (!in(k))
/* 1576 */         return this.defRetValue; 
/* 1577 */       float oldValue = Short2FloatAVLTreeMap.this.remove(k);
/* 1578 */       return Short2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1596 */       return Short2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2FloatSortedMap headMap(short to) {
/* 1600 */       if (this.top)
/* 1601 */         return new Submap(this.from, this.bottom, to, false); 
/* 1602 */       return (Short2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2FloatSortedMap tailMap(short from) {
/* 1606 */       if (this.bottom)
/* 1607 */         return new Submap(from, false, this.to, this.top); 
/* 1608 */       return (Short2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2FloatSortedMap subMap(short from, short to) {
...
/* 1614 */       if (!this.top)
/* 1615 */         to = (Short2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1616 */       if (!this.bottom)
/* 1617 */         from = (Short2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1629 */       if (Short2FloatAVLTreeMap.this.tree == null) {
/* 1630 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1634 */       if (this.bottom) {
/* 1635 */         e = Short2FloatAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1637 */         e = Short2FloatAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1639 */         if (Short2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1640 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1644 */       if (e == null || (!this.top && Short2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1645 */         return null; 
/* 1646 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2FloatAVLTreeMap.Entry e;
/* 1655 */       if (Short2FloatAVLTreeMap.this.tree == null) {
/* 1656 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1660 */       if (this.top) {
/* 1661 */         e = Short2FloatAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1663 */         e = Short2FloatAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1665 */         if (Short2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1666 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1670 */       if (e == null || (!this.bottom && Short2FloatAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1671 */         return null; 
/* 1672 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1676 */       Short2FloatAVLTreeMap.Entry e = firstEntry();
/* 1677 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1683 */       Short2FloatAVLTreeMap.Entry e = lastEntry();
/* 1684 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1699 */         this.next = Short2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1702 */         this();
/* 1703 */         if (this.next != null)
/* 1704 */           if (!Short2FloatAVLTreeMap.Submap.this.bottom && Short2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1705 */             this.prev = null;
/* 1706 */           } else if (!Short2FloatAVLTreeMap.Submap.this.top && Short2FloatAVLTreeMap.this.compare(k, (this.prev = Short2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1707 */             this.next = null;
/*      */           } else {
/* 1709 */             this.next = Short2FloatAVLTreeMap.this.locateKey(k);
/* 1710 */             if (Short2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1721 */         if (!Short2FloatAVLTreeMap.Submap.this.bottom && this.prev != null && Short2FloatAVLTreeMap.this.compare(this.prev.key, Short2FloatAVLTreeMap.Submap.this.from) < 0)
/* 1722 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1726 */         this.next = this.next.next();
/* 1727 */         if (!Short2FloatAVLTreeMap.Submap.this.top && this.next != null && Short2FloatAVLTreeMap.this.compare(this.next.key, Short2FloatAVLTreeMap.Submap.this.to) >= 0)
/* 1728 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1808 */       c = (Short2FloatAVLTreeMap)super.clone();
...
/* 1889 */     if (n == 1) {
/* 1890 */       Entry entry = new Entry(s.readShort(), s.readFloat());
...
/*      */ 
/*      */       
/* 1900 */       Entry entry = new Entry(s.readShort(), s.readFloat());
/* 1901 */       entry.right(new Entry(s.readShort(), s.readFloat()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2FloatAVLTreeMap.class
