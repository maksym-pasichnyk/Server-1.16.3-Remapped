...
/*  293 */     short[] key = this.key; while (true) {
/*      */       short curr; int last;
...
/*  500 */     Character newValue = remappingFunction.apply(Short.valueOf(k), Character.valueOf(this.value[pos]));
...
/*  515 */     int pos = find(k);
/*  516 */     Character newValue = remappingFunction.apply(Short.valueOf(k), 
...
/*  567 */     Arrays.fill(this.key, (short)0);
/*      */   }
/*      */   
/*      */   public int size() {
...
/*  593 */       return Short2CharOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public char getCharValue() {
/*  597 */       return Short2CharOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public char setValue(char v) {
/*  601 */       char oldValue = Short2CharOpenHashMap.this.value[this.index];
/*  602 */       Short2CharOpenHashMap.this.value[this.index] = v;
/*  603 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  613 */       return Short.valueOf(Short2CharOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  623 */       return Character.valueOf(Short2CharOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  639 */         return false; 
/*  640 */       Map.Entry<Short, Character> e = (Map.Entry<Short, Character>)o;
/*  641 */       return (Short2CharOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  645 */       return Short2CharOpenHashMap.this.key[this.index] ^ Short2CharOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  649 */       return Short2CharOpenHashMap.this.key[this.index] + "=>" + Short2CharOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  659 */     int pos = Short2CharOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  666 */     int last = -1;
/*      */     
/*  668 */     int c = Short2CharOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  672 */     boolean mustReturnNullKey = Short2CharOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  687 */         return this.last = Short2CharOpenHashMap.this.n;
/*      */       } 
/*  689 */       short[] key = Short2CharOpenHashMap.this.key;
/*      */       while (true) {
/*  691 */         if (--this.pos < 0) {
/*      */           
/*  693 */           this.last = Integer.MIN_VALUE;
/*  694 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  695 */           int p = HashCommon.mix(k) & Short2CharOpenHashMap.this.mask;
/*  696 */           while (k != key[p])
/*  697 */             p = p + 1 & Short2CharOpenHashMap.this.mask; 
/*  698 */           return p;
/*      */         } 
...
/*  715 */       short[] key = Short2CharOpenHashMap.this.key; while (true) {
/*      */         short curr; int last;
/*  717 */         pos = (last = pos) + 1 & Short2CharOpenHashMap.this.mask;
/*      */         while (true) {
/*  719 */           if ((curr = key[pos]) == 0) {
/*  720 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  723 */           int slot = HashCommon.mix(curr) & Short2CharOpenHashMap.this.mask;
/*  724 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  726 */           pos = pos + 1 & Short2CharOpenHashMap.this.mask;
/*      */         } 
/*  728 */         if (pos < last) {
/*  729 */           if (this.wrapped == null)
/*  730 */             this.wrapped = new ShortArrayList(2); 
/*  731 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  733 */         key[last] = curr;
/*  734 */         Short2CharOpenHashMap.this.value[last] = Short2CharOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  738 */       if (this.last == -1)
/*  739 */         throw new IllegalStateException(); 
/*  740 */       if (this.last == Short2CharOpenHashMap.this.n) {
/*  741 */         Short2CharOpenHashMap.this.containsNullKey = false;
/*  742 */       } else if (this.pos >= 0) {
/*  743 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  746 */         Short2CharOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 1));
/*  747 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  750 */       Short2CharOpenHashMap.this.size--;
/*  751 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Short2CharMap.Entry> { private Short2CharOpenHashMap.MapEntry entry;
/*      */     
/*      */     public Short2CharOpenHashMap.MapEntry next() {
/*  766 */       return this.entry = new Short2CharOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  775 */       this.entry = new Short2CharOpenHashMap.MapEntry();
...
/*  785 */       return new Short2CharOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Short2CharMap.Entry> fastIterator() {
/*  789 */       return new Short2CharOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  797 */       if (e.getKey() == null || !(e.getKey() instanceof Short))
/*  798 */         return false; 
/*  799 */       if (e.getValue() == null || !(e.getValue() instanceof Character))
/*  800 */         return false; 
/*  801 */       short k = ((Short)e.getKey()).shortValue();
/*  802 */       char v = ((Character)e.getValue()).charValue();
/*  803 */       if (k == 0) {
/*  804 */         return (Short2CharOpenHashMap.this.containsNullKey && Short2CharOpenHashMap.this.value[Short2CharOpenHashMap.this.n] == v);
/*      */       }
/*  806 */       short[] key = Short2CharOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/*  809 */       if ((curr = key[pos = HashCommon.mix(k) & Short2CharOpenHashMap.this.mask]) == 0)
/*  810 */         return false; 
/*  811 */       if (k == curr) {
/*  812 */         return (Short2CharOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  815 */         if ((curr = key[pos = pos + 1 & Short2CharOpenHashMap.this.mask]) == 0)
/*  816 */           return false; 
/*  817 */         if (k == curr) {
/*  818 */           return (Short2CharOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  827 */       if (e.getKey() == null || !(e.getKey() instanceof Short))
/*  828 */         return false; 
/*  829 */       if (e.getValue() == null || !(e.getValue() instanceof Character))
/*  830 */         return false; 
/*  831 */       short k = ((Short)e.getKey()).shortValue();
/*  832 */       char v = ((Character)e.getValue()).charValue();
/*  833 */       if (k == 0) {
/*  834 */         if (Short2CharOpenHashMap.this.containsNullKey && Short2CharOpenHashMap.this.value[Short2CharOpenHashMap.this.n] == v) {
/*  835 */           Short2CharOpenHashMap.this.removeNullEntry();
/*  836 */           return true;
/*      */         } 
/*  838 */         return false;
/*      */       } 
/*      */       
/*  841 */       short[] key = Short2CharOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/*  844 */       if ((curr = key[pos = HashCommon.mix(k) & Short2CharOpenHashMap.this.mask]) == 0)
/*  845 */         return false; 
/*  846 */       if (curr == k) {
/*  847 */         if (Short2CharOpenHashMap.this.value[pos] == v) {
/*  848 */           Short2CharOpenHashMap.this.removeEntry(pos);
/*  849 */           return true;
/*      */         } 
/*  851 */         return false;
/*      */       } 
/*      */       while (true) {
/*  854 */         if ((curr = key[pos = pos + 1 & Short2CharOpenHashMap.this.mask]) == 0)
/*  855 */           return false; 
/*  856 */         if (curr == k && 
/*  857 */           Short2CharOpenHashMap.this.value[pos] == v) {
/*  858 */           Short2CharOpenHashMap.this.removeEntry(pos);
/*  859 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  866 */       return Short2CharOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  870 */       Short2CharOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2CharMap.Entry> consumer) {
/*  875 */       if (Short2CharOpenHashMap.this.containsNullKey)
/*  876 */         consumer.accept(new AbstractShort2CharMap.BasicEntry(Short2CharOpenHashMap.this.key[Short2CharOpenHashMap.this.n], Short2CharOpenHashMap.this.value[Short2CharOpenHashMap.this.n])); 
/*  877 */       for (int pos = Short2CharOpenHashMap.this.n; pos-- != 0;) {
/*  878 */         if (Short2CharOpenHashMap.this.key[pos] != 0)
/*  879 */           consumer.accept(new AbstractShort2CharMap.BasicEntry(Short2CharOpenHashMap.this.key[pos], Short2CharOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2CharMap.Entry> consumer) {
/*  884 */       AbstractShort2CharMap.BasicEntry entry = new AbstractShort2CharMap.BasicEntry();
/*  885 */       if (Short2CharOpenHashMap.this.containsNullKey) {
/*  886 */         entry.key = Short2CharOpenHashMap.this.key[Short2CharOpenHashMap.this.n];
/*  887 */         entry.value = Short2CharOpenHashMap.this.value[Short2CharOpenHashMap.this.n];
/*  888 */         consumer.accept(entry);
/*      */       } 
/*  890 */       for (int pos = Short2CharOpenHashMap.this.n; pos-- != 0;) {
/*  891 */         if (Short2CharOpenHashMap.this.key[pos] != 0) {
/*  892 */           entry.key = Short2CharOpenHashMap.this.key[pos];
/*  893 */           entry.value = Short2CharOpenHashMap.this.value[pos];
...
/*  919 */       return Short2CharOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractShortSet { private KeySet() {}
/*      */     
/*      */     public ShortIterator iterator() {
/*  925 */       return new Short2CharOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  930 */       if (Short2CharOpenHashMap.this.containsNullKey)
/*  931 */         consumer.accept(Short2CharOpenHashMap.this.key[Short2CharOpenHashMap.this.n]); 
/*  932 */       for (int pos = Short2CharOpenHashMap.this.n; pos-- != 0; ) {
/*  933 */         short k = Short2CharOpenHashMap.this.key[pos];
/*  934 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/*  940 */       return Short2CharOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(short k) {
/*  944 */       return Short2CharOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(short k) {
/*  948 */       int oldSize = Short2CharOpenHashMap.this.size;
/*  949 */       Short2CharOpenHashMap.this.remove(k);
/*  950 */       return (Short2CharOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  954 */       Short2CharOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*  978 */       return Short2CharOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*  987 */             return new Short2CharOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/*  991 */             return Short2CharOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(char v) {
/*  995 */             return Short2CharOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/*  999 */             Short2CharOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1004 */             if (Short2CharOpenHashMap.this.containsNullKey)
/* 1005 */               consumer.accept(Short2CharOpenHashMap.this.value[Short2CharOpenHashMap.this.n]); 
/* 1006 */             for (int pos = Short2CharOpenHashMap.this.n; pos-- != 0;) {
/* 1007 */               if (Short2CharOpenHashMap.this.key[pos] != 0)
/* 1008 */                 consumer.accept(Short2CharOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1087 */     short[] newKey = new short[newN + 1];
/* 1088 */     char[] newValue = new char[newN + 1];
/* 1089 */     int i = this.n;
/* 1090 */     for (int j = realSize(); j-- != 0; ) {
/* 1091 */       while (key[--i] == 0); int pos;
/* 1092 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != 0)
/* 1093 */         while (newKey[pos = pos + 1 & mask] != 0); 
...
/*      */     try {
/* 1119 */       c = (Short2CharOpenHashMap)super.clone();
...
/* 1127 */     c.key = (short[])this.key.clone();
...
/* 1173 */     short[] key = this.key = new short[this.n + 1];
/* 1174 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1177 */     for (int i = this.size; i-- != 0; ) {
/* 1178 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2CharOpenHashMap.class
