...
/* 1821 */     short[] key = this.key;
/* 1822 */     int[] value = this.value;
/* 1823 */     int mask = newN - 1;
/* 1824 */     short[] newKey = new short[newN + 1];
/* 1825 */     int[] newValue = new int[newN + 1];
...
/* 1831 */       int pos; if (key[i] == 0) {
/* 1832 */         pos = newN;
/*      */       } else {
/* 1834 */         pos = HashCommon.mix(key[i]) & mask;
/* 1835 */         while (newKey[pos] != 0)
/* 1836 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1879 */       c = (Short2IntLinkedOpenHashMap)super.clone();
...
/* 1887 */     c.key = (short[])this.key.clone();
/* 1888 */     c.value = (int[])this.value.clone();
...
/* 1934 */     short[] key = this.key = new short[this.n + 1];
/* 1935 */     int[] value = this.value = new int[this.n + 1];
...
/* 1942 */       int pos; short k = s.readShort();
/* 1943 */       int v = s.readInt();
/* 1944 */       if (k == 0) {
/* 1945 */         pos = this.n;
/* 1946 */         this.containsNullKey = true;
/*      */       } else {
/* 1948 */         pos = HashCommon.mix(k) & this.mask;
/* 1949 */         while (key[pos] != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2IntLinkedOpenHashMap.class
