...
/*  548 */     Long newValue = remappingFunction.apply(Short.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  563 */     int pos = find(k);
/*  564 */     Long newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  640 */       return Short2LongOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public long getLongValue() {
/*  644 */       return Short2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public long setValue(long v) {
/*  648 */       long oldValue = Short2LongOpenHashMap.this.value[this.index];
/*  649 */       Short2LongOpenHashMap.this.value[this.index] = v;
/*  650 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/*  660 */       return Short.valueOf(Short2LongOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  670 */       return Long.valueOf(Short2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */         return false; 
/*  687 */       Map.Entry<Short, Long> e = (Map.Entry<Short, Long>)o;
/*  688 */       return (Short2LongOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  692 */       return Short2LongOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Short2LongOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/*  696 */       return Short2LongOpenHashMap.this.key[this.index] + "=>" + Short2LongOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  706 */     int pos = Short2LongOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  713 */     int last = -1;
/*      */     
/*  715 */     int c = Short2LongOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  719 */     boolean mustReturnNullKey = Short2LongOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  734 */         return this.last = Short2LongOpenHashMap.this.n;
/*      */       } 
/*  736 */       short[] key = Short2LongOpenHashMap.this.key;
/*      */       while (true) {
/*  738 */         if (--this.pos < 0) {
/*      */           
/*  740 */           this.last = Integer.MIN_VALUE;
/*  741 */           short k = this.wrapped.getShort(-this.pos - 1);
/*  742 */           int p = HashCommon.mix(k) & Short2LongOpenHashMap.this.mask;
/*  743 */           while (k != key[p])
/*  744 */             p = p + 1 & Short2LongOpenHashMap.this.mask; 
/*  745 */           return p;
/*      */         } 
...
/*  762 */       short[] key = Short2LongOpenHashMap.this.key; while (true) {
/*      */         short curr; int last;
/*  764 */         pos = (last = pos) + 1 & Short2LongOpenHashMap.this.mask;
/*      */         while (true) {
/*  766 */           if ((curr = key[pos]) == 0) {
/*  767 */             key[last] = 0;
/*      */             return;
/*      */           } 
/*  770 */           int slot = HashCommon.mix(curr) & Short2LongOpenHashMap.this.mask;
/*  771 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  773 */           pos = pos + 1 & Short2LongOpenHashMap.this.mask;
/*      */         } 
/*  775 */         if (pos < last) {
...
/*      */         } 
/*  780 */         key[last] = curr;
/*  781 */         Short2LongOpenHashMap.this.value[last] = Short2LongOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  785 */       if (this.last == -1)
/*  786 */         throw new IllegalStateException(); 
/*  787 */       if (this.last == Short2LongOpenHashMap.this.n) {
/*  788 */         Short2LongOpenHashMap.this.containsNullKey = false;
/*  789 */       } else if (this.pos >= 0) {
/*  790 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  793 */         Short2LongOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 1));
/*  794 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  797 */       Short2LongOpenHashMap.this.size--;
/*  798 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Short2LongMap.Entry> { private Short2LongOpenHashMap.MapEntry entry;
/*      */     
/*      */     public Short2LongOpenHashMap.MapEntry next() {
/*  813 */       return this.entry = new Short2LongOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  822 */       this.entry = new Short2LongOpenHashMap.MapEntry();
...
/*  832 */       return new Short2LongOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Short2LongMap.Entry> fastIterator() {
/*  836 */       return new Short2LongOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  850 */       if (k == 0) {
/*  851 */         return (Short2LongOpenHashMap.this.containsNullKey && Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n] == v);
/*      */       }
/*  853 */       short[] key = Short2LongOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/*  856 */       if ((curr = key[pos = HashCommon.mix(k) & Short2LongOpenHashMap.this.mask]) == 0)
/*  857 */         return false; 
/*  858 */       if (k == curr) {
/*  859 */         return (Short2LongOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  862 */         if ((curr = key[pos = pos + 1 & Short2LongOpenHashMap.this.mask]) == 0)
/*  863 */           return false; 
/*  864 */         if (k == curr) {
/*  865 */           return (Short2LongOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  880 */       if (k == 0) {
/*  881 */         if (Short2LongOpenHashMap.this.containsNullKey && Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n] == v) {
/*  882 */           Short2LongOpenHashMap.this.removeNullEntry();
/*  883 */           return true;
/*      */         } 
/*  885 */         return false;
/*      */       } 
/*      */       
/*  888 */       short[] key = Short2LongOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/*  891 */       if ((curr = key[pos = HashCommon.mix(k) & Short2LongOpenHashMap.this.mask]) == 0)
/*  892 */         return false; 
/*  893 */       if (curr == k) {
/*  894 */         if (Short2LongOpenHashMap.this.value[pos] == v) {
/*  895 */           Short2LongOpenHashMap.this.removeEntry(pos);
/*  896 */           return true;
/*      */         } 
/*  898 */         return false;
/*      */       } 
/*      */       while (true) {
/*  901 */         if ((curr = key[pos = pos + 1 & Short2LongOpenHashMap.this.mask]) == 0)
/*  902 */           return false; 
/*  903 */         if (curr == k && 
/*  904 */           Short2LongOpenHashMap.this.value[pos] == v) {
/*  905 */           Short2LongOpenHashMap.this.removeEntry(pos);
/*  906 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  913 */       return Short2LongOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  917 */       Short2LongOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2LongMap.Entry> consumer) {
/*  922 */       if (Short2LongOpenHashMap.this.containsNullKey)
/*  923 */         consumer.accept(new AbstractShort2LongMap.BasicEntry(Short2LongOpenHashMap.this.key[Short2LongOpenHashMap.this.n], Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n])); 
/*  924 */       for (int pos = Short2LongOpenHashMap.this.n; pos-- != 0;) {
/*  925 */         if (Short2LongOpenHashMap.this.key[pos] != 0)
/*  926 */           consumer.accept(new AbstractShort2LongMap.BasicEntry(Short2LongOpenHashMap.this.key[pos], Short2LongOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2LongMap.Entry> consumer) {
/*  931 */       AbstractShort2LongMap.BasicEntry entry = new AbstractShort2LongMap.BasicEntry();
/*  932 */       if (Short2LongOpenHashMap.this.containsNullKey) {
/*  933 */         entry.key = Short2LongOpenHashMap.this.key[Short2LongOpenHashMap.this.n];
/*  934 */         entry.value = Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n];
/*  935 */         consumer.accept(entry);
/*      */       } 
/*  937 */       for (int pos = Short2LongOpenHashMap.this.n; pos-- != 0;) {
/*  938 */         if (Short2LongOpenHashMap.this.key[pos] != 0) {
/*  939 */           entry.key = Short2LongOpenHashMap.this.key[pos];
/*  940 */           entry.value = Short2LongOpenHashMap.this.value[pos];
...
/*  966 */       return Short2LongOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractShortSet { private KeySet() {}
/*      */     
/*      */     public ShortIterator iterator() {
/*  972 */       return new Short2LongOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  977 */       if (Short2LongOpenHashMap.this.containsNullKey)
/*  978 */         consumer.accept(Short2LongOpenHashMap.this.key[Short2LongOpenHashMap.this.n]); 
/*  979 */       for (int pos = Short2LongOpenHashMap.this.n; pos-- != 0; ) {
/*  980 */         short k = Short2LongOpenHashMap.this.key[pos];
/*  981 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/*  987 */       return Short2LongOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(short k) {
/*  991 */       return Short2LongOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(short k) {
/*  995 */       int oldSize = Short2LongOpenHashMap.this.size;
/*  996 */       Short2LongOpenHashMap.this.remove(k);
/*  997 */       return (Short2LongOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1001 */       Short2LongOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1025 */       return Short2LongOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1034 */             return new Short2LongOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1038 */             return Short2LongOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(long v) {
/* 1042 */             return Short2LongOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1046 */             Short2LongOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(LongConsumer consumer)
/*      */           {
/* 1051 */             if (Short2LongOpenHashMap.this.containsNullKey)
/* 1052 */               consumer.accept(Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n]); 
/* 1053 */             for (int pos = Short2LongOpenHashMap.this.n; pos-- != 0;) {
/* 1054 */               if (Short2LongOpenHashMap.this.key[pos] != 0)
/* 1055 */                 consumer.accept(Short2LongOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1131 */     short[] key = this.key;
/* 1132 */     long[] value = this.value;
/* 1133 */     int mask = newN - 1;
/* 1134 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1166 */       c = (Short2LongOpenHashMap)super.clone();
...
/* 1174 */     c.key = (short[])this.key.clone();
...
/* 1220 */     short[] key = this.key = new short[this.n + 1];
/* 1221 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1224 */     for (int i = this.size; i-- != 0; ) {
/* 1225 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongOpenHashMap.class
