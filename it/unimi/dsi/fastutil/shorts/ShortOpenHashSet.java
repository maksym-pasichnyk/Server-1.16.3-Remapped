...
/* 598 */     short[] key = this.key;
/* 599 */     int mask = newN - 1;
/* 600 */     short[] newKey = new short[newN + 1];
/* 601 */     int i = this.n;
...
/* 658 */     ShortIterator i = iterator();
/* 659 */     s.defaultWriteObject();
/* 660 */     for (int j = this.size; j-- != 0;)
/* 661 */       s.writeShort(i.nextShort()); 
/*     */   }
/*     */   
...
/* 669 */     short[] key = this.key = new short[this.n + 1];
/*     */     
/* 671 */     for (int i = this.size; i-- != 0; ) {
/* 672 */       int pos; short k = s.readShort();
/* 673 */       if (k == 0) {
/* 674 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\ShortOpenHashSet.class
