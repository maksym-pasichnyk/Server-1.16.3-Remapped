...
/*      */   
/*      */   public boolean trim() {
/* 1033 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1065 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1066 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1067 */       return true; 
/*      */     try {
/* 1069 */       rehash(l);
/* 1070 */     } catch (OutOfMemoryError cantDoIt) {
/* 1071 */       return false;
/*      */     } 
/* 1073 */     return true;
/*      */   }
...
/* 1089 */     short[] key = this.key;
/* 1090 */     boolean[] value = this.value;
/* 1091 */     int mask = newN - 1;
/* 1092 */     short[] newKey = new short[newN + 1];
/* 1093 */     boolean[] newValue = new boolean[newN + 1];
/* 1094 */     int i = this.n;
/* 1095 */     for (int j = realSize(); j-- != 0; ) {
/* 1096 */       while (key[--i] == 0); int pos;
/* 1097 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != 0)
...
/*      */     try {
/* 1124 */       c = (Short2BooleanOpenHashMap)super.clone();
...
/* 1132 */     c.key = (short[])this.key.clone();
/* 1133 */     c.value = (boolean[])this.value.clone();
/* 1134 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1150 */         i++; 
/* 1151 */       t = this.key[i];
/* 1152 */       t ^= this.value[i] ? 1231 : 1237;
/* 1153 */       h += t;
/* 1154 */       i++;
/*      */     } 
/*      */     
/* 1157 */     if (this.containsNullKey)
/* 1158 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1159 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1162 */     short[] key = this.key;
/* 1163 */     boolean[] value = this.value;
/* 1164 */     MapIterator i = new MapIterator();
/* 1165 */     s.defaultWriteObject();
/* 1166 */     for (int j = this.size; j-- != 0; ) {
/* 1167 */       int e = i.nextEntry();
/* 1168 */       s.writeShort(key[e]);
/* 1169 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1178 */     short[] key = this.key = new short[this.n + 1];
/* 1179 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1182 */     for (int i = this.size; i-- != 0; ) {
/* 1183 */       int pos; short k = s.readShort();
/* 1184 */       boolean v = s.readBoolean();
/* 1185 */       if (k == 0) {
/* 1186 */         pos = this.n;
/* 1187 */         this.containsNullKey = true;
/*      */       } else {
/* 1189 */         pos = HashCommon.mix(k) & this.mask;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2BooleanOpenHashMap.class
