...
/*  903 */     Long newValue = remappingFunction.apply(Short.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  918 */     int pos = find(k);
/*  919 */     Long newValue = remappingFunction.apply(Short.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  996 */       return Short2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public long getLongValue() {
/* 1000 */       return Short2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public long setValue(long v) {
/* 1004 */       long oldValue = Short2LongLinkedOpenHashMap.this.value[this.index];
/* 1005 */       Short2LongLinkedOpenHashMap.this.value[this.index] = v;
...
/*      */     @Deprecated
/*      */     public Short getKey() {
/* 1016 */       return Short.valueOf(Short2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       return Long.valueOf(Short2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1042 */         return false; 
/* 1043 */       Map.Entry<Short, Long> e = (Map.Entry<Short, Long>)o;
/* 1044 */       return (Short2LongLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue() && Short2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1048 */       return Short2LongLinkedOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Short2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1052 */       return Short2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Short2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */       this.next = Short2LongLinkedOpenHashMap.this.first;
/* 1216 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(short from) {
/* 1219 */       if (from == 0) {
/* 1220 */         if (Short2LongLinkedOpenHashMap.this.containsNullKey) {
/* 1221 */           this.next = (int)Short2LongLinkedOpenHashMap.this.link[Short2LongLinkedOpenHashMap.this.n];
/* 1222 */           this.prev = Short2LongLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1225 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1227 */       if (Short2LongLinkedOpenHashMap.this.key[Short2LongLinkedOpenHashMap.this.last] == from) {
/* 1228 */         this.prev = Short2LongLinkedOpenHashMap.this.last;
/* 1229 */         this.index = Short2LongLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1233 */       int pos = HashCommon.mix(from) & Short2LongLinkedOpenHashMap.this.mask;
/*      */       
/* 1235 */       while (Short2LongLinkedOpenHashMap.this.key[pos] != 0) {
/* 1236 */         if (Short2LongLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1238 */           this.next = (int)Short2LongLinkedOpenHashMap.this.link[pos];
/* 1239 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1242 */         pos = pos + 1 & Short2LongLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1259 */       if (this.next == -1) {
/* 1260 */         this.index = Short2LongLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1263 */       int pos = Short2LongLinkedOpenHashMap.this.first;
/* 1264 */       this.index = 1;
/* 1265 */       while (pos != this.prev) {
/* 1266 */         pos = (int)Short2LongLinkedOpenHashMap.this.link[pos];
/* 1267 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1292 */       this.prev = (int)(Short2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1307 */         this.index--;
/* 1308 */         this.prev = (int)(Short2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1310 */         this.next = (int)Short2LongLinkedOpenHashMap.this.link[this.curr];
/* 1311 */       }  Short2LongLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1316 */       if (this.prev == -1) {
/* 1317 */         Short2LongLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1319 */         Short2LongLinkedOpenHashMap.this.link[this.prev] = Short2LongLinkedOpenHashMap.this.link[this.prev] ^ (Short2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1320 */       }  if (this.next == -1) {
/* 1321 */         Short2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1323 */         Short2LongLinkedOpenHashMap.this.link[this.next] = Short2LongLinkedOpenHashMap.this.link[this.next] ^ (Short2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1324 */       }  int pos = this.curr;
/* 1325 */       this.curr = -1;
/* 1326 */       if (pos == Short2LongLinkedOpenHashMap.this.n) {
/* 1327 */         Short2LongLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1330 */         short[] key = Short2LongLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           short curr;
/*      */           int last;
/* 1334 */           pos = (last = pos) + 1 & Short2LongLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1336 */             if ((curr = key[pos]) == 0) {
/* 1337 */               key[last] = 0;
/*      */               return;
/*      */             } 
/* 1340 */             int slot = HashCommon.mix(curr) & Short2LongLinkedOpenHashMap.this.mask;
/* 1341 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1343 */             pos = pos + 1 & Short2LongLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1345 */           key[last] = curr;
/* 1346 */           Short2LongLinkedOpenHashMap.this.value[last] = Short2LongLinkedOpenHashMap.this.value[pos];
/* 1347 */           if (this.next == pos)
/* 1348 */             this.next = last; 
/* 1349 */           if (this.prev == pos)
/* 1350 */             this.prev = last; 
/* 1351 */           Short2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Short2LongMap.Entry> { private Short2LongLinkedOpenHashMap.MapEntry entry;
/*      */     
...
/* 1383 */       return this.entry = new Short2LongLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Short2LongLinkedOpenHashMap.MapEntry previous() {
/* 1387 */       return this.entry = new Short2LongLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1391 */       super.remove();
...
/*      */ 
/*      */   
/* 1396 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Short2LongMap.Entry> { final Short2LongLinkedOpenHashMap.MapEntry entry = new Short2LongLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Short2LongMap.Entry> implements Short2LongSortedMap.FastSortedEntrySet { public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator() {
/* 1416 */       return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     private MapEntrySet() {}
...
/* 1437 */       if (Short2LongLinkedOpenHashMap.this.size == 0)
/* 1438 */         throw new NoSuchElementException(); 
/* 1439 */       return new Short2LongLinkedOpenHashMap.MapEntry(Short2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Short2LongMap.Entry last() {
/* 1443 */       if (Short2LongLinkedOpenHashMap.this.size == 0)
/* 1444 */         throw new NoSuchElementException(); 
/* 1445 */       return new Short2LongLinkedOpenHashMap.MapEntry(Short2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1459 */       if (k == 0) {
/* 1460 */         return (Short2LongLinkedOpenHashMap.this.containsNullKey && Short2LongLinkedOpenHashMap.this.value[Short2LongLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1462 */       short[] key = Short2LongLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1465 */       if ((curr = key[pos = HashCommon.mix(k) & Short2LongLinkedOpenHashMap.this.mask]) == 0)
/* 1466 */         return false; 
/* 1467 */       if (k == curr) {
/* 1468 */         return (Short2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1471 */         if ((curr = key[pos = pos + 1 & Short2LongLinkedOpenHashMap.this.mask]) == 0)
/* 1472 */           return false; 
/* 1473 */         if (k == curr) {
/* 1474 */           return (Short2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1489 */       if (k == 0) {
/* 1490 */         if (Short2LongLinkedOpenHashMap.this.containsNullKey && Short2LongLinkedOpenHashMap.this.value[Short2LongLinkedOpenHashMap.this.n] == v) {
/* 1491 */           Short2LongLinkedOpenHashMap.this.removeNullEntry();
/* 1492 */           return true;
/*      */         } 
/* 1494 */         return false;
/*      */       } 
/*      */       
/* 1497 */       short[] key = Short2LongLinkedOpenHashMap.this.key;
/*      */       short curr;
/*      */       int pos;
/* 1500 */       if ((curr = key[pos = HashCommon.mix(k) & Short2LongLinkedOpenHashMap.this.mask]) == 0)
/* 1501 */         return false; 
/* 1502 */       if (curr == k) {
/* 1503 */         if (Short2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1504 */           Short2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1505 */           return true;
/*      */         } 
/* 1507 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1510 */         if ((curr = key[pos = pos + 1 & Short2LongLinkedOpenHashMap.this.mask]) == 0)
/* 1511 */           return false; 
/* 1512 */         if (curr == k && 
/* 1513 */           Short2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1514 */           Short2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1515 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1522 */       return Short2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1526 */       Short2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1541 */       return new Short2LongLinkedOpenHashMap.EntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1552 */       return new Short2LongLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1567 */       return new Short2LongLinkedOpenHashMap.FastEntryIterator(from.getShortKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Short2LongMap.Entry> consumer) {
/* 1572 */       for (int i = Short2LongLinkedOpenHashMap.this.size, next = Short2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1573 */         int curr = next;
/* 1574 */         next = (int)Short2LongLinkedOpenHashMap.this.link[curr];
/* 1575 */         consumer.accept(new AbstractShort2LongMap.BasicEntry(Short2LongLinkedOpenHashMap.this.key[curr], Short2LongLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Short2LongMap.Entry> consumer) {
/* 1581 */       AbstractShort2LongMap.BasicEntry entry = new AbstractShort2LongMap.BasicEntry();
/* 1582 */       for (int i = Short2LongLinkedOpenHashMap.this.size, next = Short2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1583 */         int curr = next;
/* 1584 */         next = (int)Short2LongLinkedOpenHashMap.this.link[curr];
/* 1585 */         entry.key = Short2LongLinkedOpenHashMap.this.key[curr];
/* 1586 */         entry.value = Short2LongLinkedOpenHashMap.this.value[curr];
...
/* 1612 */       return Short2LongLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
...
/* 1619 */       return Short2LongLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractShortSortedSet { private KeySet() {}
/*      */     
/*      */     public ShortListIterator iterator(short from) {
/* 1625 */       return new Short2LongLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ShortListIterator iterator() {
/* 1629 */       return new Short2LongLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1634 */       if (Short2LongLinkedOpenHashMap.this.containsNullKey)
/* 1635 */         consumer.accept(Short2LongLinkedOpenHashMap.this.key[Short2LongLinkedOpenHashMap.this.n]); 
/* 1636 */       for (int pos = Short2LongLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1637 */         short k = Short2LongLinkedOpenHashMap.this.key[pos];
/* 1638 */         if (k != 0)
...
/*      */     
/*      */     public int size() {
/* 1644 */       return Short2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(short k) {
/* 1648 */       return Short2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(short k) {
/* 1652 */       int oldSize = Short2LongLinkedOpenHashMap.this.size;
/* 1653 */       Short2LongLinkedOpenHashMap.this.remove(k);
/* 1654 */       return (Short2LongLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1658 */       Short2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public short firstShort() {
/* 1662 */       if (Short2LongLinkedOpenHashMap.this.size == 0)
/* 1663 */         throw new NoSuchElementException(); 
/* 1664 */       return Short2LongLinkedOpenHashMap.this.key[Short2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public short lastShort() {
/* 1668 */       if (Short2LongLinkedOpenHashMap.this.size == 0)
/* 1669 */         throw new NoSuchElementException(); 
/* 1670 */       return Short2LongLinkedOpenHashMap.this.key[Short2LongLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public ShortComparator comparator() {
/* 1674 */       return null;
...
/* 1707 */       return Short2LongLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1714 */       return Short2LongLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1723 */             return (LongIterator)new Short2LongLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1727 */             return Short2LongLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(long v) {
/* 1731 */             return Short2LongLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1735 */             Short2LongLinkedOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(LongConsumer consumer)
/*      */           {
/* 1740 */             if (Short2LongLinkedOpenHashMap.this.containsNullKey)
/* 1741 */               consumer.accept(Short2LongLinkedOpenHashMap.this.value[Short2LongLinkedOpenHashMap.this.n]); 
/* 1742 */             for (int pos = Short2LongLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1743 */               if (Short2LongLinkedOpenHashMap.this.key[pos] != 0)
/* 1744 */                 consumer.accept(Short2LongLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1820 */     short[] key = this.key;
/* 1821 */     long[] value = this.value;
/* 1822 */     int mask = newN - 1;
/* 1823 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1878 */       c = (Short2LongLinkedOpenHashMap)super.clone();
...
/* 1886 */     c.key = (short[])this.key.clone();
...
/* 1933 */     short[] key = this.key = new short[this.n + 1];
...
/* 1941 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongLinkedOpenHashMap.class
