...
/* 1056 */     short[] key = this.key;
/* 1057 */     V[] value = this.value;
/* 1058 */     int mask = newN - 1;
/* 1059 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1091 */       c = (Short2ObjectOpenHashMap<V>)super.clone();
...
/* 1099 */     c.key = (short[])this.key.clone();
...
/* 1146 */     short[] key = this.key = new short[this.n + 1];
/* 1147 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1150 */     for (int i = this.size; i-- != 0; ) {
/* 1151 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2ObjectOpenHashMap.class
