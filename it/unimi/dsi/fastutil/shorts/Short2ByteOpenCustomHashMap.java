...
/* 1180 */     byte[] value = this.value;
/* 1181 */     int mask = newN - 1;
/* 1182 */     short[] newKey = new short[newN + 1];
/* 1183 */     byte[] newValue = new byte[newN + 1];
/* 1184 */     int i = this.n;
...
/*      */     try {
/* 1215 */       c = (Short2ByteOpenCustomHashMap)super.clone();
...
/* 1224 */     c.value = (byte[])this.value.clone();
...
/* 1271 */     byte[] value = this.value = new byte[this.n + 1];
/*      */ 
/*      */     
/* 1274 */     for (int i = this.size; i-- != 0; ) {
/* 1275 */       int pos; short k = s.readShort();
/* 1276 */       byte v = s.readByte();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2ByteOpenCustomHashMap.class
