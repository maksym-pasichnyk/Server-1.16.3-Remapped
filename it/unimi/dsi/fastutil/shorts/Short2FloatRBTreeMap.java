...
/*  910 */         return false; 
/*  911 */       Map.Entry<Short, Float> e = (Map.Entry<Short, Float>)o;
...
/*  999 */     int index = 0;
/*      */     TreeIterator() {
/* 1001 */       this.next = Short2FloatRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/* 1004 */       if ((this.next = Short2FloatRBTreeMap.this.locateKey(k)) != null)
/* 1005 */         if (Short2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1056 */       updatePrevious();
/* 1057 */       updateNext();
/* 1058 */       Short2FloatRBTreeMap.this.remove(this.curr.key);
/* 1059 */       this.curr = null;
/*      */     }
...
/* 1098 */       this.entries = (ObjectSortedSet<Short2FloatMap.Entry>)new AbstractObjectSortedSet<Short2FloatMap.Entry>()
/*      */         {
...
/* 1107 */             return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1111 */             return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatRBTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1122 */               return false; 
/* 1123 */             Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1135 */               return false; 
/* 1136 */             Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1137 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != 
/* 1138 */               Float.floatToIntBits(((Float)e.getValue()).floatValue()))
/* 1139 */               return false; 
/* 1140 */             Short2FloatRBTreeMap.this.remove(f.key);
/* 1141 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1145 */             return Short2FloatRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1149 */             Short2FloatRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2FloatMap.Entry first() {
/* 1153 */             return Short2FloatRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2FloatMap.Entry last() {
/* 1157 */             return Short2FloatRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) {
/* 1162 */             return Short2FloatRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) {
/* 1166 */             return Short2FloatRBTreeMap.this.headMap(to.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) {
/* 1170 */             return Short2FloatRBTreeMap.this.tailMap(from.getShortKey()).short2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1204 */       return new Short2FloatRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1208 */       return new Short2FloatRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1263 */             return (FloatIterator)new Short2FloatRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(float k) {
/* 1267 */             return Short2FloatRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1271 */             return Short2FloatRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1275 */             Short2FloatRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1338 */       if (!bottom && !top && Short2FloatRBTreeMap.this.compare(from, to) > 0)
/* 1339 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1340 */       this.from = from;
/* 1341 */       this.bottom = bottom;
/* 1342 */       this.to = to;
/* 1343 */       this.top = top;
/* 1344 */       this.defRetValue = Short2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1362 */       return ((this.bottom || Short2FloatRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2FloatRBTreeMap.this
/* 1363 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
/* 1367 */       if (this.entries == null)
/* 1368 */         this.entries = (ObjectSortedSet<Short2FloatMap.Entry>)new AbstractObjectSortedSet<Short2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator() {
/* 1371 */               return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1375 */               return (ObjectBidirectionalIterator<Short2FloatMap.Entry>)new Short2FloatRBTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2FloatMap.Entry> comparator() {
/* 1379 */               return Short2FloatRBTreeMap.this.short2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */               if (e.getKey() == null || !(e.getKey() instanceof Short))
/* 1388 */                 return false; 
/* 1389 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1390 */                 return false; 
/* 1391 */               Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1392 */               return (f != null && Short2FloatRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1403 */                 return false; 
/* 1404 */               Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1405 */               if (f != null && Short2FloatRBTreeMap.Submap.this.in(f.key))
/* 1406 */                 Short2FloatRBTreeMap.Submap.this.remove(f.key); 
/* 1407 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1411 */               int c = 0;
/* 1412 */               for (ObjectBidirectionalIterator<Short2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1413 */                 c++; 
/* 1414 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1418 */               return !(new Short2FloatRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1422 */               Short2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2FloatMap.Entry first() {
/* 1426 */               return Short2FloatRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2FloatMap.Entry last() {
/* 1430 */               return Short2FloatRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) {
/* 1435 */               return Short2FloatRBTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) {
/* 1439 */               return Short2FloatRBTreeMap.Submap.this.headMap(to.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) {
/* 1443 */               return Short2FloatRBTreeMap.Submap.this.tailMap(from.getShortKey()).short2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2FloatSortedMap.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1451 */         return new Short2FloatRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1455 */         return new Short2FloatRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/* 1467 */         this.values = (FloatCollection)new AbstractFloatCollection()
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1470 */               return (FloatIterator)new Short2FloatRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(float k) {
/* 1474 */               return Short2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1478 */               return Short2FloatRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1482 */               Short2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1490 */       return (in(k) && Short2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(short k) {
/* 1507 */       short kk = k; Short2FloatRBTreeMap.Entry e;
/* 1508 */       return (in(kk) && (e = Short2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public float put(short k, float v) {
/* 1512 */       Short2FloatRBTreeMap.this.modified = false;
/* 1513 */       if (!in(k))
...
/* 1516 */       float oldValue = Short2FloatRBTreeMap.this.put(k, v);
/* 1517 */       return Short2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float remove(short k) {
/* 1522 */       Short2FloatRBTreeMap.this.modified = false;
/* 1523 */       if (!in(k))
/* 1524 */         return this.defRetValue; 
/* 1525 */       float oldValue = Short2FloatRBTreeMap.this.remove(k);
/* 1526 */       return Short2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1544 */       return Short2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2FloatSortedMap headMap(short to) {
/* 1548 */       if (this.top)
/* 1549 */         return new Submap(this.from, this.bottom, to, false); 
/* 1550 */       return (Short2FloatRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2FloatSortedMap tailMap(short from) {
/* 1554 */       if (this.bottom)
/* 1555 */         return new Submap(from, false, this.to, this.top); 
/* 1556 */       return (Short2FloatRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2FloatSortedMap subMap(short from, short to) {
...
/* 1562 */       if (!this.top)
/* 1563 */         to = (Short2FloatRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1564 */       if (!this.bottom)
/* 1565 */         from = (Short2FloatRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1577 */       if (Short2FloatRBTreeMap.this.tree == null) {
/* 1578 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1582 */       if (this.bottom) {
/* 1583 */         e = Short2FloatRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1585 */         e = Short2FloatRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1587 */         if (Short2FloatRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1588 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1592 */       if (e == null || (!this.top && Short2FloatRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1593 */         return null; 
/* 1594 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2FloatRBTreeMap.Entry e;
/* 1603 */       if (Short2FloatRBTreeMap.this.tree == null) {
/* 1604 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1608 */       if (this.top) {
/* 1609 */         e = Short2FloatRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1611 */         e = Short2FloatRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1613 */         if (Short2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1614 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1618 */       if (e == null || (!this.bottom && Short2FloatRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1619 */         return null; 
/* 1620 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1624 */       Short2FloatRBTreeMap.Entry e = firstEntry();
/* 1625 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1631 */       Short2FloatRBTreeMap.Entry e = lastEntry();
/* 1632 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1647 */         this.next = Short2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1650 */         this();
/* 1651 */         if (this.next != null)
/* 1652 */           if (!Short2FloatRBTreeMap.Submap.this.bottom && Short2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1653 */             this.prev = null;
/* 1654 */           } else if (!Short2FloatRBTreeMap.Submap.this.top && Short2FloatRBTreeMap.this.compare(k, (this.prev = Short2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1655 */             this.next = null;
/*      */           } else {
/* 1657 */             this.next = Short2FloatRBTreeMap.this.locateKey(k);
/* 1658 */             if (Short2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1669 */         if (!Short2FloatRBTreeMap.Submap.this.bottom && this.prev != null && Short2FloatRBTreeMap.this.compare(this.prev.key, Short2FloatRBTreeMap.Submap.this.from) < 0)
/* 1670 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1674 */         this.next = this.next.next();
/* 1675 */         if (!Short2FloatRBTreeMap.Submap.this.top && this.next != null && Short2FloatRBTreeMap.this.compare(this.next.key, Short2FloatRBTreeMap.Submap.this.to) >= 0)
/* 1676 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1756 */       c = (Short2FloatRBTreeMap)super.clone();
...
/* 1837 */     if (n == 1) {
/* 1838 */       Entry entry = new Entry(s.readShort(), s.readFloat());
...
/*      */ 
/*      */       
/* 1849 */       Entry entry = new Entry(s.readShort(), s.readFloat());
/* 1850 */       entry.black(true);
/* 1851 */       entry.right(new Entry(s.readShort(), s.readFloat()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2FloatRBTreeMap.class
