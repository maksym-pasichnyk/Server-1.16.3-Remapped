...
/* 1179 */     short[] key = this.key;
/* 1180 */     long[] value = this.value;
/* 1181 */     int mask = newN - 1;
/* 1182 */     short[] newKey = new short[newN + 1];
/* 1183 */     long[] newValue = new long[newN + 1];
/* 1184 */     int i = this.n;
/* 1185 */     for (int j = realSize(); j-- != 0; ) {
/* 1186 */       while (key[--i] == 0); int pos;
/* 1187 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0)
/*      */       {
/* 1189 */         while (newKey[pos = pos + 1 & mask] != 0); } 
...
/*      */     try {
/* 1215 */       c = (Short2LongOpenCustomHashMap)super.clone();
...
/* 1223 */     c.key = (short[])this.key.clone();
/* 1224 */     c.value = (long[])this.value.clone();
...
/* 1241 */       while (this.key[i] == 0)
/* 1242 */         i++; 
/* 1243 */       t = this.strategy.hashCode(this.key[i]);
/* 1244 */       t ^= HashCommon.long2int(this.value[i]);
/* 1245 */       h += t;
/* 1246 */       i++;
/*      */     } 
/*      */     
/* 1249 */     if (this.containsNullKey)
/* 1250 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1251 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1254 */     short[] key = this.key;
/* 1255 */     long[] value = this.value;
/* 1256 */     MapIterator i = new MapIterator();
/* 1257 */     s.defaultWriteObject();
/* 1258 */     for (int j = this.size; j-- != 0; ) {
/* 1259 */       int e = i.nextEntry();
/* 1260 */       s.writeShort(key[e]);
/* 1261 */       s.writeLong(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1270 */     short[] key = this.key = new short[this.n + 1];
/* 1271 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1274 */     for (int i = this.size; i-- != 0; ) {
/* 1275 */       int pos; short k = s.readShort();
/* 1276 */       long v = s.readLong();
/* 1277 */       if (this.strategy.equals(k, (short)0)) {
/* 1278 */         pos = this.n;
/* 1279 */         this.containsNullKey = true;
/*      */       } else {
/* 1281 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1282 */         while (key[pos] != 0)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongOpenCustomHashMap.class
