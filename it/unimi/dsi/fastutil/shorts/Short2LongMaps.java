...
/*  50 */     return (entries instanceof Short2LongMap.FastEntrySet) ? (
/*  51 */       (Short2LongMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Short2LongMap.Entry> entries = map.short2LongEntrySet();
/*  71 */     if (entries instanceof Short2LongMap.FastEntrySet) {
/*  72 */       ((Short2LongMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Short2LongMap.Entry> entries = map.short2LongEntrySet();
/*  91 */     return (entries instanceof Short2LongMap.FastEntrySet) ? new ObjectIterable<Short2LongMap.Entry>() {
/*     */         public ObjectIterator<Short2LongMap.Entry> iterator() {
/*  93 */           return ((Short2LongMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Short2LongMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Short2LongMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractShort2LongMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)short2LongEntrySet();
/*     */     }
/*     */     
/*     */     public ShortSet keySet() {
...
/*     */   
/*     */   public static Short2LongMap singleton(Short key, Long value) {
/* 300 */     return new Singleton(key.shortValue(), value.longValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.short2LongEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, Long>> entrySet() {
/* 361 */       return (ObjectSet)short2LongEntrySet();
/*     */     }
/*     */     
/*     */     public ShortSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.short2LongEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Short, Long>> entrySet() {
/* 674 */       return (ObjectSet)short2LongEntrySet();
/*     */     }
/*     */     
/*     */     public ShortSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongMaps.class
