...
/*  954 */         return false; 
/*  955 */       Map.Entry<Short, Integer> e = (Map.Entry<Short, Integer>)o;
/*  956 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Short2IntAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/* 1047 */       if ((this.next = Short2IntAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Short2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Short2IntAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Short2IntMap.Entry>)new AbstractObjectSortedSet<Short2IntMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntAVLTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1186 */               return false; 
/* 1187 */             Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1188 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue())
/* 1189 */               return false; 
/* 1190 */             Short2IntAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Short2IntAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Short2IntAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2IntMap.Entry first() {
/* 1203 */             return Short2IntAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2IntMap.Entry last() {
/* 1207 */             return Short2IntAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry from, Short2IntMap.Entry to) {
/* 1211 */             return Short2IntAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2IntEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry to) {
/* 1215 */             return Short2IntAVLTreeMap.this.headMap(to.getShortKey()).short2IntEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from) {
/* 1219 */             return Short2IntAVLTreeMap.this.tailMap(from.getShortKey()).short2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Short2IntAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1257 */       return new Short2IntAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (IntIterator)new Short2IntAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(int k) {
/* 1316 */             return Short2IntAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Short2IntAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Short2IntAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Short2IntAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Short2IntAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Short2IntAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2IntAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Short2IntMap.Entry>)new AbstractObjectSortedSet<Short2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Short2IntMap.Entry>)new Short2IntAVLTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2IntMap.Entry> comparator() {
/* 1428 */               return Short2IntAVLTreeMap.this.short2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1441 */               return (f != null && Short2IntAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1454 */               if (f != null && Short2IntAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Short2IntAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Short2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Short2IntAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Short2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2IntMap.Entry first() {
/* 1475 */               return Short2IntAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2IntMap.Entry last() {
/* 1479 */               return Short2IntAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry from, Short2IntMap.Entry to) {
/* 1483 */               return Short2IntAVLTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2IntEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry to) {
/* 1487 */               return Short2IntAVLTreeMap.Submap.this.headMap(to.getShortKey()).short2IntEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from) {
/* 1491 */               return Short2IntAVLTreeMap.Submap.this.tailMap(from.getShortKey()).short2IntEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2IntSortedMap.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1499 */         return new Short2IntAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1503 */         return new Short2IntAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1518 */               return (IntIterator)new Short2IntAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(int k) {
/* 1522 */               return Short2IntAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Short2IntAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Short2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1538 */       return (in(k) && Short2IntAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(short k) {
/* 1555 */       short kk = k; Short2IntAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Short2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int put(short k, int v) {
/* 1560 */       Short2IntAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       int oldValue = Short2IntAVLTreeMap.this.put(k, v);
/* 1565 */       return Short2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int remove(short k) {
/* 1570 */       Short2IntAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       int oldValue = Short2IntAVLTreeMap.this.remove(k);
/* 1574 */       return Short2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1592 */       return Short2IntAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2IntSortedMap headMap(short to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Short2IntAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2IntSortedMap tailMap(short from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Short2IntAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2IntSortedMap subMap(short from, short to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Short2IntAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Short2IntAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Short2IntAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Short2IntAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Short2IntAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Short2IntAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Short2IntAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2IntAVLTreeMap.Entry e;
/* 1651 */       if (Short2IntAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Short2IntAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Short2IntAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Short2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Short2IntAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1672 */       Short2IntAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1679 */       Short2IntAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Short2IntAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Short2IntAVLTreeMap.Submap.this.bottom && Short2IntAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Short2IntAVLTreeMap.Submap.this.top && Short2IntAVLTreeMap.this.compare(k, (this.prev = Short2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Short2IntAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Short2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Short2IntAVLTreeMap.Submap.this.bottom && this.prev != null && Short2IntAVLTreeMap.this.compare(this.prev.key, Short2IntAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Short2IntAVLTreeMap.Submap.this.top && this.next != null && Short2IntAVLTreeMap.this.compare(this.next.key, Short2IntAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1804 */       c = (Short2IntAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readShort(), s.readInt());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readShort(), s.readInt());
/* 1897 */       entry.right(new Entry(s.readShort(), s.readInt()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2IntAVLTreeMap.class
