...
/* 1055 */     short[] key = this.key;
/* 1056 */     V[] value = this.value;
/* 1057 */     int mask = newN - 1;
/* 1058 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1090 */       c = (Short2ReferenceOpenHashMap<V>)super.clone();
...
/* 1098 */     c.key = (short[])this.key.clone();
...
/* 1145 */     short[] key = this.key = new short[this.n + 1];
/* 1146 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1149 */     for (int i = this.size; i-- != 0; ) {
/* 1150 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2ReferenceOpenHashMap.class
