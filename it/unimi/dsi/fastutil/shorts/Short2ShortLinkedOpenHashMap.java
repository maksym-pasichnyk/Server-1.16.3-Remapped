...
/* 1822 */     short[] key = this.key;
/* 1823 */     short[] value = this.value;
/* 1824 */     int mask = newN - 1;
/* 1825 */     short[] newKey = new short[newN + 1];
/* 1826 */     short[] newValue = new short[newN + 1];
...
/*      */     try {
/* 1880 */       c = (Short2ShortLinkedOpenHashMap)super.clone();
...
/* 1888 */     c.key = (short[])this.key.clone();
/* 1889 */     c.value = (short[])this.value.clone();
...
/* 1915 */       h += this.value[this.n]; 
/* 1916 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1919 */     short[] key = this.key;
/* 1920 */     short[] value = this.value;
/* 1921 */     MapIterator i = new MapIterator();
/* 1922 */     s.defaultWriteObject();
/* 1923 */     for (int j = this.size; j-- != 0; ) {
/* 1924 */       int e = i.nextEntry();
/* 1925 */       s.writeShort(key[e]);
/* 1926 */       s.writeShort(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1935 */     short[] key = this.key = new short[this.n + 1];
/* 1936 */     short[] value = this.value = new short[this.n + 1];
...
/* 1943 */       int pos; short k = s.readShort();
/* 1944 */       short v = s.readShort();
/* 1945 */       if (k == 0) {
/* 1946 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2ShortLinkedOpenHashMap.class
