...
/*  910 */         return false; 
/*  911 */       Map.Entry<Short, Character> e = (Map.Entry<Short, Character>)o;
/*  912 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  998 */     int index = 0;
/*      */     TreeIterator() {
/* 1000 */       this.next = Short2CharRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/* 1003 */       if ((this.next = Short2CharRBTreeMap.this.locateKey(k)) != null)
/* 1004 */         if (Short2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1055 */       updatePrevious();
/* 1056 */       updateNext();
/* 1057 */       Short2CharRBTreeMap.this.remove(this.curr.key);
/* 1058 */       this.curr = null;
/*      */     }
...
/* 1097 */       this.entries = (ObjectSortedSet<Short2CharMap.Entry>)new AbstractObjectSortedSet<Short2CharMap.Entry>()
/*      */         {
...
/* 1106 */             return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from) {
/* 1110 */             return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharRBTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1119 */               return false; 
/* 1120 */             if (e.getValue() == null || !(e.getValue() instanceof Character))
/* 1121 */               return false; 
/* 1122 */             Short2CharRBTreeMap.Entry f = Short2CharRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1134 */               return false; 
/* 1135 */             Short2CharRBTreeMap.Entry f = Short2CharRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1136 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1137 */               return false; 
/* 1138 */             Short2CharRBTreeMap.this.remove(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Short2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Short2CharRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2CharMap.Entry first() {
/* 1151 */             return Short2CharRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2CharMap.Entry last() {
/* 1155 */             return Short2CharRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry from, Short2CharMap.Entry to) {
/* 1159 */             return Short2CharRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry to) {
/* 1163 */             return Short2CharRBTreeMap.this.headMap(to.getShortKey()).short2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from) {
/* 1167 */             return Short2CharRBTreeMap.this.tailMap(from.getShortKey()).short2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1201 */       return new Short2CharRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1205 */       return new Short2CharRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */       this.values = (CharCollection)new AbstractCharCollection()
/*      */         {
/*      */           public CharIterator iterator() {
/* 1260 */             return (CharIterator)new Short2CharRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1264 */             return Short2CharRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Short2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1272 */             Short2CharRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1335 */       if (!bottom && !top && Short2CharRBTreeMap.this.compare(from, to) > 0)
/* 1336 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1337 */       this.from = from;
/* 1338 */       this.bottom = bottom;
/* 1339 */       this.to = to;
/* 1340 */       this.top = top;
/* 1341 */       this.defRetValue = Short2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1359 */       return ((this.bottom || Short2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2CharRBTreeMap.this
/* 1360 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
/* 1364 */       if (this.entries == null)
/* 1365 */         this.entries = (ObjectSortedSet<Short2CharMap.Entry>)new AbstractObjectSortedSet<Short2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator() {
/* 1368 */               return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from) {
/* 1372 */               return (ObjectBidirectionalIterator<Short2CharMap.Entry>)new Short2CharRBTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2CharMap.Entry> comparator() {
/* 1376 */               return Short2CharRBTreeMap.this.short2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Short2CharRBTreeMap.Entry f = Short2CharRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1389 */               return (f != null && Short2CharRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1400 */                 return false; 
/* 1401 */               Short2CharRBTreeMap.Entry f = Short2CharRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1402 */               if (f != null && Short2CharRBTreeMap.Submap.this.in(f.key))
/* 1403 */                 Short2CharRBTreeMap.Submap.this.remove(f.key); 
/* 1404 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1408 */               int c = 0;
/* 1409 */               for (ObjectBidirectionalIterator<Short2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1410 */                 c++; 
/* 1411 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1415 */               return !(new Short2CharRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1419 */               Short2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2CharMap.Entry first() {
/* 1423 */               return Short2CharRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2CharMap.Entry last() {
/* 1427 */               return Short2CharRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry from, Short2CharMap.Entry to) {
/* 1432 */               return Short2CharRBTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry to) {
/* 1436 */               return Short2CharRBTreeMap.Submap.this.headMap(to.getShortKey()).short2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from) {
/* 1440 */               return Short2CharRBTreeMap.Submap.this.tailMap(from.getShortKey()).short2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2CharSortedMap.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1448 */         return new Short2CharRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1452 */         return new Short2CharRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/* 1464 */         this.values = (CharCollection)new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1467 */               return (CharIterator)new Short2CharRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1471 */               return Short2CharRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1475 */               return Short2CharRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1479 */               Short2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1487 */       return (in(k) && Short2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/* 1494 */         char ev = (i.nextEntry()).value;
/* 1495 */         if (ev == v)
/* 1496 */           return true; 
/*      */       } 
/* 1498 */       return false;
...
/*      */     
/*      */     public char get(short k) {
/* 1504 */       short kk = k; Short2CharRBTreeMap.Entry e;
/* 1505 */       return (in(kk) && (e = Short2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(short k, char v) {
/* 1509 */       Short2CharRBTreeMap.this.modified = false;
/* 1510 */       if (!in(k))
...
/* 1513 */       char oldValue = Short2CharRBTreeMap.this.put(k, v);
/* 1514 */       return Short2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(short k) {
/* 1519 */       Short2CharRBTreeMap.this.modified = false;
/* 1520 */       if (!in(k))
/* 1521 */         return this.defRetValue; 
/* 1522 */       char oldValue = Short2CharRBTreeMap.this.remove(k);
/* 1523 */       return Short2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1541 */       return Short2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2CharSortedMap headMap(short to) {
/* 1545 */       if (this.top)
/* 1546 */         return new Submap(this.from, this.bottom, to, false); 
/* 1547 */       return (Short2CharRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2CharSortedMap tailMap(short from) {
/* 1551 */       if (this.bottom)
/* 1552 */         return new Submap(from, false, this.to, this.top); 
/* 1553 */       return (Short2CharRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2CharSortedMap subMap(short from, short to) {
...
/* 1559 */       if (!this.top)
/* 1560 */         to = (Short2CharRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1561 */       if (!this.bottom)
/* 1562 */         from = (Short2CharRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1574 */       if (Short2CharRBTreeMap.this.tree == null) {
/* 1575 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1579 */       if (this.bottom) {
/* 1580 */         e = Short2CharRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1582 */         e = Short2CharRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1584 */         if (Short2CharRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1585 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1589 */       if (e == null || (!this.top && Short2CharRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1590 */         return null; 
/* 1591 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2CharRBTreeMap.Entry e;
/* 1600 */       if (Short2CharRBTreeMap.this.tree == null) {
/* 1601 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1605 */       if (this.top) {
/* 1606 */         e = Short2CharRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1608 */         e = Short2CharRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Short2CharRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1611 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1615 */       if (e == null || (!this.bottom && Short2CharRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1616 */         return null; 
/* 1617 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1621 */       Short2CharRBTreeMap.Entry e = firstEntry();
/* 1622 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1628 */       Short2CharRBTreeMap.Entry e = lastEntry();
/* 1629 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1644 */         this.next = Short2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null)
/* 1649 */           if (!Short2CharRBTreeMap.Submap.this.bottom && Short2CharRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1650 */             this.prev = null;
/* 1651 */           } else if (!Short2CharRBTreeMap.Submap.this.top && Short2CharRBTreeMap.this.compare(k, (this.prev = Short2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1652 */             this.next = null;
/*      */           } else {
/* 1654 */             this.next = Short2CharRBTreeMap.this.locateKey(k);
/* 1655 */             if (Short2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1666 */         if (!Short2CharRBTreeMap.Submap.this.bottom && this.prev != null && Short2CharRBTreeMap.this.compare(this.prev.key, Short2CharRBTreeMap.Submap.this.from) < 0)
/* 1667 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1671 */         this.next = this.next.next();
/* 1672 */         if (!Short2CharRBTreeMap.Submap.this.top && this.next != null && Short2CharRBTreeMap.this.compare(this.next.key, Short2CharRBTreeMap.Submap.this.to) >= 0)
/* 1673 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1753 */       c = (Short2CharRBTreeMap)super.clone();
...
/* 1834 */     if (n == 1) {
/* 1835 */       Entry entry = new Entry(s.readShort(), s.readChar());
...
/*      */ 
/*      */       
/* 1846 */       Entry entry = new Entry(s.readShort(), s.readChar());
/* 1847 */       entry.black(true);
/* 1848 */       entry.right(new Entry(s.readShort(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2CharRBTreeMap.class
