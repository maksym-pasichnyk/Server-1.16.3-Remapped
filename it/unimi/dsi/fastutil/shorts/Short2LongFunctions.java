...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Short2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Short2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Short2LongFunction singleton(Short key, Long value) {
/* 161 */     return new Singleton(key.shortValue(), value.longValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Short2LongFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractShort2LongFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Short2LongFunction function;
/*     */     
...
/* 468 */       Long v = this.function.apply(Short.valueOf(key));
/* 469 */       if (v == null)
...
/* 511 */     if (f instanceof Short2LongFunction)
/* 512 */       return (Short2LongFunction)f; 
/* 513 */     if (f instanceof IntToLongFunction) {
/* 514 */       Objects.requireNonNull((IntToLongFunction)f); return (IntToLongFunction)f::applyAsLong;
/* 515 */     }  return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongFunctions.class
