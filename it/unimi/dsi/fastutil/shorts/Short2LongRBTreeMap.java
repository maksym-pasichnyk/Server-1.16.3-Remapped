...
/*  910 */         return false; 
/*  911 */       Map.Entry<Short, Long> e = (Map.Entry<Short, Long>)o;
/*  912 */       return (this.key == ((Short)e.getKey()).shortValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  998 */     int index = 0;
/*      */     TreeIterator() {
/* 1000 */       this.next = Short2LongRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(short k) {
/* 1003 */       if ((this.next = Short2LongRBTreeMap.this.locateKey(k)) != null)
/* 1004 */         if (Short2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1055 */       updatePrevious();
/* 1056 */       updateNext();
/* 1057 */       Short2LongRBTreeMap.this.remove(this.curr.key);
/* 1058 */       this.curr = null;
/*      */     }
...
/* 1097 */       this.entries = (ObjectSortedSet<Short2LongMap.Entry>)new AbstractObjectSortedSet<Short2LongMap.Entry>()
/*      */         {
...
/* 1106 */             return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from) {
/* 1110 */             return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongRBTreeMap.EntryIterator(from.getShortKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1121 */               return false; 
/* 1122 */             Short2LongRBTreeMap.Entry f = Short2LongRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1134 */               return false; 
/* 1135 */             Short2LongRBTreeMap.Entry f = Short2LongRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1136 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue())
/* 1137 */               return false; 
/* 1138 */             Short2LongRBTreeMap.this.remove(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Short2LongRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Short2LongRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Short2LongMap.Entry first() {
/* 1151 */             return Short2LongRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Short2LongMap.Entry last() {
/* 1155 */             return Short2LongRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) {
/* 1159 */             return Short2LongRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry to) {
/* 1163 */             return Short2LongRBTreeMap.this.headMap(to.getShortKey()).short2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from) {
/* 1167 */             return Short2LongRBTreeMap.this.tailMap(from.getShortKey()).short2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1201 */       return new Short2LongRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public ShortBidirectionalIterator iterator(short from) {
/* 1205 */       return new Short2LongRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1260 */             return (LongIterator)new Short2LongRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(long k) {
/* 1264 */             return Short2LongRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Short2LongRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1272 */             Short2LongRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1335 */       if (!bottom && !top && Short2LongRBTreeMap.this.compare(from, to) > 0)
/* 1336 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1337 */       this.from = from;
/* 1338 */       this.bottom = bottom;
/* 1339 */       this.to = to;
/* 1340 */       this.top = top;
/* 1341 */       this.defRetValue = Short2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1359 */       return ((this.bottom || Short2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2LongRBTreeMap.this
/* 1360 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 1364 */       if (this.entries == null)
/* 1365 */         this.entries = (ObjectSortedSet<Short2LongMap.Entry>)new AbstractObjectSortedSet<Short2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator() {
/* 1368 */               return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from) {
/* 1372 */               return (ObjectBidirectionalIterator<Short2LongMap.Entry>)new Short2LongRBTreeMap.Submap.SubmapEntryIterator(from.getShortKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Short2LongMap.Entry> comparator() {
/* 1376 */               return Short2LongRBTreeMap.this.short2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Short2LongRBTreeMap.Entry f = Short2LongRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1389 */               return (f != null && Short2LongRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1400 */                 return false; 
/* 1401 */               Short2LongRBTreeMap.Entry f = Short2LongRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1402 */               if (f != null && Short2LongRBTreeMap.Submap.this.in(f.key))
/* 1403 */                 Short2LongRBTreeMap.Submap.this.remove(f.key); 
/* 1404 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1408 */               int c = 0;
/* 1409 */               for (ObjectBidirectionalIterator<Short2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1410 */                 c++; 
/* 1411 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1415 */               return !(new Short2LongRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1419 */               Short2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Short2LongMap.Entry first() {
/* 1423 */               return Short2LongRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Short2LongMap.Entry last() {
/* 1427 */               return Short2LongRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) {
/* 1432 */               return Short2LongRBTreeMap.Submap.this.subMap(from.getShortKey(), to.getShortKey()).short2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry to) {
/* 1436 */               return Short2LongRBTreeMap.Submap.this.headMap(to.getShortKey()).short2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from) {
/* 1440 */               return Short2LongRBTreeMap.Submap.this.tailMap(from.getShortKey()).short2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractShort2LongSortedMap.KeySet {
/*      */       public ShortBidirectionalIterator iterator() {
/* 1448 */         return new Short2LongRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public ShortBidirectionalIterator iterator(short from) {
/* 1452 */         return new Short2LongRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public ShortSortedSet keySet() {
...
/* 1464 */         this.values = (LongCollection)new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1467 */               return (LongIterator)new Short2LongRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(long k) {
/* 1471 */               return Short2LongRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1475 */               return Short2LongRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1479 */               Short2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(short k) {
/* 1487 */       return (in(k) && Short2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(long v) {
...
/* 1494 */         long ev = (i.nextEntry()).value;
/* 1495 */         if (ev == v)
/* 1496 */           return true; 
/*      */       } 
/* 1498 */       return false;
...
/*      */     
/*      */     public long get(short k) {
/* 1504 */       short kk = k; Short2LongRBTreeMap.Entry e;
/* 1505 */       return (in(kk) && (e = Short2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public long put(short k, long v) {
/* 1509 */       Short2LongRBTreeMap.this.modified = false;
/* 1510 */       if (!in(k))
...
/* 1513 */       long oldValue = Short2LongRBTreeMap.this.put(k, v);
/* 1514 */       return Short2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long remove(short k) {
/* 1519 */       Short2LongRBTreeMap.this.modified = false;
/* 1520 */       if (!in(k))
/* 1521 */         return this.defRetValue; 
/* 1522 */       long oldValue = Short2LongRBTreeMap.this.remove(k);
/* 1523 */       return Short2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public ShortComparator comparator() {
/* 1541 */       return Short2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Short2LongSortedMap headMap(short to) {
/* 1545 */       if (this.top)
/* 1546 */         return new Submap(this.from, this.bottom, to, false); 
/* 1547 */       return (Short2LongRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Short2LongSortedMap tailMap(short from) {
/* 1551 */       if (this.bottom)
/* 1552 */         return new Submap(from, false, this.to, this.top); 
/* 1553 */       return (Short2LongRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Short2LongSortedMap subMap(short from, short to) {
...
/* 1559 */       if (!this.top)
/* 1560 */         to = (Short2LongRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1561 */       if (!this.bottom)
/* 1562 */         from = (Short2LongRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1574 */       if (Short2LongRBTreeMap.this.tree == null) {
/* 1575 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1579 */       if (this.bottom) {
/* 1580 */         e = Short2LongRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1582 */         e = Short2LongRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1584 */         if (Short2LongRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1585 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1589 */       if (e == null || (!this.top && Short2LongRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1590 */         return null; 
/* 1591 */       return e;
/*      */     }
/*      */ 
...
/*      */       Short2LongRBTreeMap.Entry e;
/* 1600 */       if (Short2LongRBTreeMap.this.tree == null) {
/* 1601 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1605 */       if (this.top) {
/* 1606 */         e = Short2LongRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1608 */         e = Short2LongRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1610 */         if (Short2LongRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1611 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1615 */       if (e == null || (!this.bottom && Short2LongRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1616 */         return null; 
/* 1617 */       return e;
/*      */     }
/*      */     
/*      */     public short firstShortKey() {
/* 1621 */       Short2LongRBTreeMap.Entry e = firstEntry();
/* 1622 */       if (e == null)
...
/*      */     
/*      */     public short lastShortKey() {
/* 1628 */       Short2LongRBTreeMap.Entry e = lastEntry();
/* 1629 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1644 */         this.next = Short2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1647 */         this();
/* 1648 */         if (this.next != null)
/* 1649 */           if (!Short2LongRBTreeMap.Submap.this.bottom && Short2LongRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1650 */             this.prev = null;
/* 1651 */           } else if (!Short2LongRBTreeMap.Submap.this.top && Short2LongRBTreeMap.this.compare(k, (this.prev = Short2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1652 */             this.next = null;
/*      */           } else {
/* 1654 */             this.next = Short2LongRBTreeMap.this.locateKey(k);
/* 1655 */             if (Short2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1666 */         if (!Short2LongRBTreeMap.Submap.this.bottom && this.prev != null && Short2LongRBTreeMap.this.compare(this.prev.key, Short2LongRBTreeMap.Submap.this.from) < 0)
/* 1667 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1671 */         this.next = this.next.next();
/* 1672 */         if (!Short2LongRBTreeMap.Submap.this.top && this.next != null && Short2LongRBTreeMap.this.compare(this.next.key, Short2LongRBTreeMap.Submap.this.to) >= 0)
/* 1673 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1753 */       c = (Short2LongRBTreeMap)super.clone();
...
/* 1834 */     if (n == 1) {
/* 1835 */       Entry entry = new Entry(s.readShort(), s.readLong());
...
/*      */ 
/*      */       
/* 1846 */       Entry entry = new Entry(s.readShort(), s.readLong());
/* 1847 */       entry.black(true);
/* 1848 */       entry.right(new Entry(s.readShort(), s.readLong()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2LongRBTreeMap.class
