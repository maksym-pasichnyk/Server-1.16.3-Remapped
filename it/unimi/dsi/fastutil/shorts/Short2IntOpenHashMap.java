...
/*      */     try {
/* 1167 */       c = (Short2IntOpenHashMap)super.clone();
...
/* 1221 */     short[] key = this.key = new short[this.n + 1];
/* 1222 */     int[] value = this.value = new int[this.n + 1];
/*      */ 
/*      */     
/* 1225 */     for (int i = this.size; i-- != 0; ) {
/* 1226 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2IntOpenHashMap.class
