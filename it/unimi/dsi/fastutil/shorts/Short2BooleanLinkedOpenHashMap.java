...
/* 1767 */     short[] key = this.key;
/* 1768 */     boolean[] value = this.value;
/* 1769 */     int mask = newN - 1;
/* 1770 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1825 */       c = (Short2BooleanLinkedOpenHashMap)super.clone();
...
/* 1833 */     c.key = (short[])this.key.clone();
...
/* 1880 */     short[] key = this.key = new short[this.n + 1];
...
/* 1888 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\shorts\Short2BooleanLinkedOpenHashMap.class
