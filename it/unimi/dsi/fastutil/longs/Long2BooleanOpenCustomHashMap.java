...
/* 1133 */     long[] newKey = new long[newN + 1];
/* 1134 */     boolean[] newValue = new boolean[newN + 1];
/* 1135 */     int i = this.n;
/* 1136 */     for (int j = realSize(); j-- != 0; ) {
/* 1137 */       while (key[--i] == 0L); int pos;
/* 1138 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0L)
/* 1139 */         while (newKey[pos = pos + 1 & mask] != 0L); 
...
/*      */     try {
/* 1165 */       c = (Long2BooleanOpenCustomHashMap)super.clone();
...
/* 1173 */     c.key = (long[])this.key.clone();
/* 1174 */     c.value = (boolean[])this.value.clone();
...
/* 1194 */       t ^= this.value[i] ? 1231 : 1237;
/* 1195 */       h += t;
/* 1196 */       i++;
/*      */     } 
/*      */     
/* 1199 */     if (this.containsNullKey)
/* 1200 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1201 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1204 */     long[] key = this.key;
/* 1205 */     boolean[] value = this.value;
...
/* 1221 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1224 */     for (int i = this.size; i-- != 0; ) {
/* 1225 */       int pos; long k = s.readLong();
/* 1226 */       boolean v = s.readBoolean();
/* 1227 */       if (this.strategy.equals(k, 0L)) {
/* 1228 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2BooleanOpenCustomHashMap.class
