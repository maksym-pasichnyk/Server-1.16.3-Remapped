...
/*  50 */     return (entries instanceof Long2IntMap.FastEntrySet) ? (
/*  51 */       (Long2IntMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Long2IntMap.Entry> entries = map.long2IntEntrySet();
/*  71 */     if (entries instanceof Long2IntMap.FastEntrySet) {
/*  72 */       ((Long2IntMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Long2IntMap.Entry> entries = map.long2IntEntrySet();
/*  91 */     return (entries instanceof Long2IntMap.FastEntrySet) ? new ObjectIterable<Long2IntMap.Entry>() {
/*     */         public ObjectIterator<Long2IntMap.Entry> iterator() {
/*  93 */           return ((Long2IntMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Long2IntMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Long2IntMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractLong2IntMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)long2IntEntrySet();
/*     */     }
/*     */     
/*     */     public LongSet keySet() {
...
/* 300 */     return new Singleton(key.longValue(), value.intValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.long2IntEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Integer>> entrySet() {
/* 361 */       return (ObjectSet)long2IntEntrySet();
/*     */     }
/*     */     
/*     */     public LongSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.long2IntEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Integer>> entrySet() {
/* 674 */       return (ObjectSet)long2IntEntrySet();
/*     */     }
/*     */     
/*     */     public LongSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2IntMaps.class
