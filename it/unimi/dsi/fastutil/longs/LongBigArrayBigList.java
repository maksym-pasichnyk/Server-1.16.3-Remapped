...
/* 130 */     this(a, 0L, LongBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 151 */     this(length);
/* 152 */     LongBigArrays.copy(a, offset, this.a, 0L, length);
...
/* 213 */     return wrap(a, LongBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       return; 
/* 226 */     this.a = LongBigArrays.forceCapacity(this.a, capacity, this.size);
/* 227 */     assert this.size <= LongBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 239 */     long oldLength = LongBigArrays.length(this.a);
...
/* 245 */       capacity = 10L;
/* 246 */     }  this.a = LongBigArrays.forceCapacity(this.a, capacity, this.size);
/* 247 */     assert this.size <= LongBigArrays.length(this.a);
/*     */   }
/*     */   
...
/* 254 */       LongBigArrays.copy(this.a, index, this.a, index + 1L, this.size - index); 
/* 255 */     LongBigArrays.set(this.a, index, k);
/* 256 */     this.size++;
/* 257 */     assert this.size <= LongBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public boolean add(long k) {
/* 261 */     grow(this.size + 1L);
/* 262 */     LongBigArrays.set(this.a, this.size++, k);
/* 263 */     if (!$assertionsDisabled && this.size > LongBigArrays.length(this.a)) throw new AssertionError(); 
/* 264 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 271 */     return LongBigArrays.get(this.a, index);
/*     */   }
/*     */   
/*     */   public long indexOf(long k) {
/* 275 */     for (long i = 0L; i < this.size; i++) {
/* 276 */       if (k == LongBigArrays.get(this.a, i))
/* 277 */         return i; 
/* 278 */     }  return -1L;
/*     */   }
/*     */   
...
/* 283 */       if (k == LongBigArrays.get(this.a, i))
/* 284 */         return i; 
/* 285 */     }  return -1L;
/*     */   }
/*     */   
...
/*     */     }
/* 292 */     long old = LongBigArrays.get(this.a, index);
/* 293 */     this.size--;
/* 294 */     if (index != this.size)
/* 295 */       LongBigArrays.copy(this.a, index + 1L, this.a, index, this.size - index); 
/* 296 */     assert this.size <= LongBigArrays.length(this.a);
/* 297 */     return old;
/*     */   }
/*     */   
...
/* 305 */     assert this.size <= LongBigArrays.length(this.a);
/* 306 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 313 */     long old = LongBigArrays.get(this.a, index);
/* 314 */     LongBigArrays.set(this.a, index, k);
/* 315 */     return old;
/*     */   }
/*     */   
...
/*     */   public void clear() {
/* 365 */     this.size = 0L;
/* 366 */     assert this.size <= LongBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public long size64() {
...
/* 374 */     if (size > LongBigArrays.length(this.a))
/* 375 */       ensureCapacity(size); 
/* 376 */     if (size > this.size)
/* 377 */       LongBigArrays.fill(this.a, this.size, size, 0L); 
/* 378 */     this.size = size;
/*     */   }
/*     */   
...
/* 410 */     long arrayLength = LongBigArrays.length(this.a);
/* 411 */     if (n >= arrayLength || this.size == arrayLength)
/*     */       return; 
/* 413 */     this.a = LongBigArrays.trim(this.a, Math.max(n, this.size));
/* 414 */     assert this.size <= LongBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 432 */     LongBigArrays.copy(this.a, from, a, offset, length);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 445 */     LongBigArrays.copy(this.a, to, this.a, from, this.size - to);
...
/* 463 */     LongBigArrays.ensureOffsetLength(a, offset, length);
/* 464 */     grow(this.size + length);
/* 465 */     LongBigArrays.copy(this.a, index, this.a, index + length, this.size - index);
/* 466 */     LongBigArrays.copy(a, offset, this.a, index, length);
...
/* 486 */           return LongBigArrays.get(LongBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public long previousLong() {
/* 490 */           if (!hasPrevious())
/* 491 */             throw new NoSuchElementException(); 
/* 492 */           return LongBigArrays.get(LongBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 531 */     LongBigArrays.copy(this.a, 0L, c.a, 0L, this.size);
...
/* 554 */     long[][] a2 = l.a;
/* 555 */     while (s-- != 0L) {
/* 556 */       if (LongBigArrays.get(a1, s) != LongBigArrays.get(a2, s))
/* 557 */         return false; 
/* 558 */     }  return true;
/*     */   }
/*     */ 
...
/* 579 */       long e1 = LongBigArrays.get(a1, i);
/* 580 */       long e2 = LongBigArrays.get(a2, i); int r;
...
/* 589 */       s.writeLong(LongBigArrays.get(this.a, i)); 
/*     */   }
/*     */   
...
/* 596 */       LongBigArrays.set(this.a, i, s.readLong()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\LongBigArrayBigList.class
