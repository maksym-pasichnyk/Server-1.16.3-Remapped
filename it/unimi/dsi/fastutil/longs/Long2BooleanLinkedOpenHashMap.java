...
/* 1767 */     long[] key = this.key;
/* 1768 */     boolean[] value = this.value;
/* 1769 */     int mask = newN - 1;
/* 1770 */     long[] newKey = new long[newN + 1];
...
/* 1777 */       int pos; if (key[i] == 0L) {
/* 1778 */         pos = newN;
/*      */       } else {
/* 1780 */         pos = (int)HashCommon.mix(key[i]) & mask;
/* 1781 */         while (newKey[pos] != 0L)
/* 1782 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1825 */       c = (Long2BooleanLinkedOpenHashMap)super.clone();
...
/* 1833 */     c.key = (long[])this.key.clone();
...
/* 1851 */       while (this.key[i] == 0L)
/* 1852 */         i++; 
/* 1853 */       t = HashCommon.long2int(this.key[i]);
...
/* 1880 */     long[] key = this.key = new long[this.n + 1];
...
/* 1888 */       int pos; long k = s.readLong();
/* 1889 */       boolean v = s.readBoolean();
/* 1890 */       if (k == 0L) {
/* 1891 */         pos = this.n;
/* 1892 */         this.containsNullKey = true;
/*      */       } else {
/* 1894 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1895 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2BooleanLinkedOpenHashMap.class
