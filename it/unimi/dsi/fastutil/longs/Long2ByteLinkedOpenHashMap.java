...
/* 1821 */     byte[] value = this.value;
/* 1822 */     int mask = newN - 1;
/* 1823 */     long[] newKey = new long[newN + 1];
/* 1824 */     byte[] newValue = new byte[newN + 1];
...
/*      */     try {
/* 1878 */       c = (Long2ByteLinkedOpenHashMap)super.clone();
...
/* 1887 */     c.value = (byte[])this.value.clone();
...
/* 1934 */     byte[] value = this.value = new byte[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ByteLinkedOpenHashMap.class
