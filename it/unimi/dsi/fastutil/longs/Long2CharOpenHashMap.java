...
/* 1087 */     long[] newKey = new long[newN + 1];
/* 1088 */     char[] newValue = new char[newN + 1];
/* 1089 */     int i = this.n;
/* 1090 */     for (int j = realSize(); j-- != 0; ) {
/* 1091 */       while (key[--i] == 0L); int pos;
/* 1092 */       if (newKey[pos = (int)HashCommon.mix(key[i]) & mask] != 0L)
/* 1093 */         while (newKey[pos = pos + 1 & mask] != 0L); 
...
/*      */     try {
/* 1119 */       c = (Long2CharOpenHashMap)super.clone();
...
/* 1127 */     c.key = (long[])this.key.clone();
...
/* 1144 */       while (this.key[i] == 0L)
/* 1145 */         i++; 
/* 1146 */       t = HashCommon.long2int(this.key[i]);
/* 1147 */       t ^= this.value[i];
/* 1148 */       h += t;
/* 1149 */       i++;
/*      */     } 
...
/* 1173 */     long[] key = this.key = new long[this.n + 1];
/* 1174 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1177 */     for (int i = this.size; i-- != 0; ) {
/* 1178 */       int pos; long k = s.readLong();
/* 1179 */       char v = s.readChar();
/* 1180 */       if (k == 0L) {
/* 1181 */         pos = this.n;
/* 1182 */         this.containsNullKey = true;
/*      */       } else {
/* 1184 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1185 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2CharOpenHashMap.class
