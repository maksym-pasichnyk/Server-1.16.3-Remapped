...
/*  934 */         return false; 
/*  935 */       Map.Entry<Long, V> e = (Map.Entry<Long, V>)o;
/*  936 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  940 */       return HashCommon.long2int(this.key) ^ (
/*  941 */         (this.value == null) ? 0 : System.identityHashCode(this.value));
/*      */     }
/*      */     
...
/* 1023 */     int index = 0;
/*      */     TreeIterator() {
/* 1025 */       this.next = Long2ReferenceAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1028 */       if ((this.next = Long2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/* 1029 */         if (Long2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1080 */       updatePrevious();
/* 1081 */       updateNext();
/* 1082 */       Long2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1083 */       this.curr = null;
/*      */     }
...
/* 1130 */       this.entries = (ObjectSortedSet<Long2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1139 */             return (ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>>)new Long2ReferenceAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator(Long2ReferenceMap.Entry<V> from) {
/* 1144 */             return (ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>>)new Long2ReferenceAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1152 */             if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1153 */               return false; 
/* 1154 */             Long2ReferenceAVLTreeMap.Entry<V> f = Long2ReferenceAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1163 */             if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1164 */               return false; 
/* 1165 */             Long2ReferenceAVLTreeMap.Entry<V> f = Long2ReferenceAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1166 */             if (f == null || f.getValue() != e.getValue())
/* 1167 */               return false; 
/* 1168 */             Long2ReferenceAVLTreeMap.this.remove(f.key);
/* 1169 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1173 */             return Long2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1177 */             Long2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2ReferenceMap.Entry<V> first() {
/* 1181 */             return Long2ReferenceAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2ReferenceMap.Entry<V> last() {
/* 1185 */             return Long2ReferenceAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ReferenceMap.Entry<V>> subSet(Long2ReferenceMap.Entry<V> from, Long2ReferenceMap.Entry<V> to) {
/* 1190 */             return Long2ReferenceAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2ReferenceMap.Entry<V>> headSet(Long2ReferenceMap.Entry<V> to) {
/* 1194 */             return Long2ReferenceAVLTreeMap.this.headMap(to.getLongKey()).long2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2ReferenceMap.Entry<V>> tailSet(Long2ReferenceMap.Entry<V> from) {
/* 1198 */             return Long2ReferenceAVLTreeMap.this.tailMap(from.getLongKey()).long2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1232 */       return new Long2ReferenceAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1236 */       return new Long2ReferenceAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1291 */             return (ObjectIterator<V>)new Long2ReferenceAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1295 */             return Long2ReferenceAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1299 */             return Long2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1303 */             Long2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1314 */     return new Submap(0L, true, to, false);
/*      */   }
/*      */   
/*      */   public Long2ReferenceSortedMap<V> tailMap(long from) {
/* 1318 */     return new Submap(from, false, 0L, true);
/*      */   }
/*      */   
...
/* 1366 */       if (!bottom && !top && Long2ReferenceAVLTreeMap.this.compare(from, to) > 0)
/* 1367 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1368 */       this.from = from;
/* 1369 */       this.bottom = bottom;
/* 1370 */       this.to = to;
/* 1371 */       this.top = top;
/* 1372 */       this.defRetValue = Long2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1390 */       return ((this.bottom || Long2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ReferenceAVLTreeMap.this
/* 1391 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
/* 1395 */       if (this.entries == null)
/* 1396 */         this.entries = (ObjectSortedSet<Long2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator() {
/* 1399 */               return (ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>>)new Long2ReferenceAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator(Long2ReferenceMap.Entry<V> from) {
/* 1404 */               return (ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>>)new Long2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2ReferenceMap.Entry<V>> comparator() {
/* 1408 */               return Long2ReferenceAVLTreeMap.this.long2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1416 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1417 */                 return false; 
/* 1418 */               Long2ReferenceAVLTreeMap.Entry<V> f = Long2ReferenceAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1419 */               return (f != null && Long2ReferenceAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1428 */                 return false; 
/* 1429 */               Long2ReferenceAVLTreeMap.Entry<V> f = Long2ReferenceAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1430 */               if (f != null && Long2ReferenceAVLTreeMap.Submap.this.in(f.key))
/* 1431 */                 Long2ReferenceAVLTreeMap.Submap.this.remove(f.key); 
/* 1432 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1436 */               int c = 0;
/* 1437 */               for (ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1438 */                 c++; 
/* 1439 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1443 */               return !(new Long2ReferenceAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1447 */               Long2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2ReferenceMap.Entry<V> first() {
/* 1451 */               return Long2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2ReferenceMap.Entry<V> last() {
/* 1455 */               return Long2ReferenceAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ReferenceMap.Entry<V>> subSet(Long2ReferenceMap.Entry<V> from, Long2ReferenceMap.Entry<V> to) {
/* 1460 */               return Long2ReferenceAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2ReferenceMap.Entry<V>> headSet(Long2ReferenceMap.Entry<V> to) {
/* 1464 */               return Long2ReferenceAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2ReferenceMap.Entry<V>> tailSet(Long2ReferenceMap.Entry<V> from) {
/* 1468 */               return Long2ReferenceAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2ReferenceEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2ReferenceSortedMap<V>.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1476 */         return new Long2ReferenceAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1480 */         return new Long2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1495 */               return (ObjectIterator<V>)new Long2ReferenceAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1499 */               return Long2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1503 */               return Long2ReferenceAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1507 */               Long2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1515 */       return (in(k) && Long2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(long k) {
/* 1532 */       long kk = k; Long2ReferenceAVLTreeMap.Entry<V> e;
/* 1533 */       return (in(kk) && (e = Long2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(long k, V v) {
/* 1537 */       Long2ReferenceAVLTreeMap.this.modified = false;
/* 1538 */       if (!in(k))
...
/* 1541 */       V oldValue = Long2ReferenceAVLTreeMap.this.put(k, v);
/* 1542 */       return Long2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(long k) {
/* 1547 */       Long2ReferenceAVLTreeMap.this.modified = false;
/* 1548 */       if (!in(k))
/* 1549 */         return this.defRetValue; 
/* 1550 */       V oldValue = Long2ReferenceAVLTreeMap.this.remove(k);
/* 1551 */       return Long2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1569 */       return Long2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2ReferenceSortedMap<V> headMap(long to) {
/* 1573 */       if (this.top)
/* 1574 */         return new Submap(this.from, this.bottom, to, false); 
/* 1575 */       return (Long2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2ReferenceSortedMap<V> tailMap(long from) {
/* 1579 */       if (this.bottom)
/* 1580 */         return new Submap(from, false, this.to, this.top); 
/* 1581 */       return (Long2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2ReferenceSortedMap<V> subMap(long from, long to) {
...
/* 1587 */       if (!this.top)
/* 1588 */         to = (Long2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1589 */       if (!this.bottom)
/* 1590 */         from = (Long2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1602 */       if (Long2ReferenceAVLTreeMap.this.tree == null) {
/* 1603 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1607 */       if (this.bottom) {
/* 1608 */         e = Long2ReferenceAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1610 */         e = Long2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1612 */         if (Long2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1613 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1617 */       if (e == null || (!this.top && Long2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1618 */         return null; 
/* 1619 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2ReferenceAVLTreeMap.Entry<V> e;
/* 1628 */       if (Long2ReferenceAVLTreeMap.this.tree == null) {
/* 1629 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1633 */       if (this.top) {
/* 1634 */         e = Long2ReferenceAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1636 */         e = Long2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1638 */         if (Long2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1639 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1643 */       if (e == null || (!this.bottom && Long2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1644 */         return null; 
/* 1645 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1649 */       Long2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
/* 1650 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1656 */       Long2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
/* 1657 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1672 */         this.next = Long2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1675 */         this();
/* 1676 */         if (this.next != null)
/* 1677 */           if (!Long2ReferenceAVLTreeMap.Submap.this.bottom && Long2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1678 */             this.prev = null;
/* 1679 */           } else if (!Long2ReferenceAVLTreeMap.Submap.this.top && Long2ReferenceAVLTreeMap.this.compare(k, (this.prev = Long2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1680 */             this.next = null;
/*      */           } else {
/* 1682 */             this.next = Long2ReferenceAVLTreeMap.this.locateKey(k);
/* 1683 */             if (Long2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1694 */         if (!Long2ReferenceAVLTreeMap.Submap.this.bottom && this.prev != null && Long2ReferenceAVLTreeMap.this.compare(this.prev.key, Long2ReferenceAVLTreeMap.Submap.this.from) < 0)
/* 1695 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1699 */         this.next = this.next.next();
/* 1700 */         if (!Long2ReferenceAVLTreeMap.Submap.this.top && this.next != null && Long2ReferenceAVLTreeMap.this.compare(this.next.key, Long2ReferenceAVLTreeMap.Submap.this.to) >= 0)
/* 1701 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1783 */       c = (Long2ReferenceAVLTreeMap<V>)super.clone();
...
/* 1864 */     if (n == 1) {
/* 1865 */       Entry<V> entry = new Entry<>(s.readLong(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1875 */       Entry<V> entry = new Entry<>(s.readLong(), (V)s.readObject());
/* 1876 */       entry.right(new Entry<>(s.readLong(), (V)s.readObject()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ReferenceAVLTreeMap.class
