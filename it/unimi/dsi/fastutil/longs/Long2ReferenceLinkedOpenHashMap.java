...
/* 1736 */     long[] key = this.key;
/* 1737 */     V[] value = this.value;
/* 1738 */     int mask = newN - 1;
/* 1739 */     long[] newKey = new long[newN + 1];
...
/* 1746 */       int pos; if (key[i] == 0L) {
/* 1747 */         pos = newN;
/*      */       } else {
/* 1749 */         pos = (int)HashCommon.mix(key[i]) & mask;
/* 1750 */         while (newKey[pos] != 0L)
/* 1751 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1794 */       c = (Long2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* 1802 */     c.key = (long[])this.key.clone();
...
/* 1820 */       while (this.key[i] == 0L)
/* 1821 */         i++; 
/* 1822 */       t = HashCommon.long2int(this.key[i]);
/* 1823 */       if (this != this.value[i])
/* 1824 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1825 */       h += t;
/* 1826 */       i++;
/*      */     } 
/*      */     
/* 1829 */     if (this.containsNullKey)
/* 1830 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1831 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1834 */     long[] key = this.key;
...
/* 1850 */     long[] key = this.key = new long[this.n + 1];
...
/* 1858 */       int pos; long k = s.readLong();
/* 1859 */       V v = (V)s.readObject();
/* 1860 */       if (k == 0L) {
/* 1861 */         pos = this.n;
/* 1862 */         this.containsNullKey = true;
/*      */       } else {
/* 1864 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1865 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ReferenceLinkedOpenHashMap.class
