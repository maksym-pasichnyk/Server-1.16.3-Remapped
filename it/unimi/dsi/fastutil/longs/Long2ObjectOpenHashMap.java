...
/*      */   
/*      */   public boolean trim() {
/* 1001 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1002 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1003 */       return true; 
/*      */     try {
/* 1005 */       rehash(l);
/* 1006 */     } catch (OutOfMemoryError cantDoIt) {
/* 1007 */       return false;
/*      */     } 
/* 1009 */     return true;
/*      */   }
...
/* 1034 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1035 */       return true; 
/*      */     try {
/* 1037 */       rehash(l);
...
/* 1057 */     long[] key = this.key;
/* 1058 */     V[] value = this.value;
/* 1059 */     int mask = newN - 1;
/* 1060 */     long[] newKey = new long[newN + 1];
/* 1061 */     V[] newValue = (V[])new Object[newN + 1];
/* 1062 */     int i = this.n;
/* 1063 */     for (int j = realSize(); j-- != 0; ) {
/* 1064 */       while (key[--i] == 0L); int pos;
/* 1065 */       if (newKey[pos = (int)HashCommon.mix(key[i]) & mask] != 0L)
/* 1066 */         while (newKey[pos = pos + 1 & mask] != 0L); 
/* 1067 */       newKey[pos] = key[i];
/* 1068 */       newValue[pos] = value[i];
/*      */     } 
/* 1070 */     newValue[newN] = value[this.n];
/* 1071 */     this.n = newN;
/* 1072 */     this.mask = mask;
/* 1073 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1074 */     this.key = newKey;
/* 1075 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1092 */       c = (Long2ObjectOpenHashMap<V>)super.clone();
/* 1093 */     } catch (CloneNotSupportedException cantHappen) {
/* 1094 */       throw new InternalError();
/*      */     } 
/* 1096 */     c.keys = null;
/* 1097 */     c.values = null;
/* 1098 */     c.entries = null;
/* 1099 */     c.containsNullKey = this.containsNullKey;
/* 1100 */     c.key = (long[])this.key.clone();
/* 1101 */     c.value = (V[])this.value.clone();
/* 1102 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1115 */     int h = 0;
/* 1116 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1117 */       while (this.key[i] == 0L)
/* 1118 */         i++; 
/* 1119 */       t = HashCommon.long2int(this.key[i]);
/* 1120 */       if (this != this.value[i])
/* 1121 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1122 */       h += t;
/* 1123 */       i++;
/*      */     } 
/*      */     
/* 1126 */     if (this.containsNullKey)
/* 1127 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1128 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1131 */     long[] key = this.key;
/* 1132 */     V[] value = this.value;
/* 1133 */     MapIterator i = new MapIterator();
/* 1134 */     s.defaultWriteObject();
/* 1135 */     for (int j = this.size; j-- != 0; ) {
/* 1136 */       int e = i.nextEntry();
/* 1137 */       s.writeLong(key[e]);
/* 1138 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1143 */     s.defaultReadObject();
/* 1144 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1145 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1146 */     this.mask = this.n - 1;
/* 1147 */     long[] key = this.key = new long[this.n + 1];
/* 1148 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1151 */     for (int i = this.size; i-- != 0; ) {
/* 1152 */       int pos; long k = s.readLong();
/* 1153 */       V v = (V)s.readObject();
/* 1154 */       if (k == 0L) {
/* 1155 */         pos = this.n;
/* 1156 */         this.containsNullKey = true;
/*      */       } else {
/* 1158 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1159 */         while (key[pos] != 0L)
/* 1160 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1162 */       key[pos] = k;
/* 1163 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ObjectOpenHashMap.class
