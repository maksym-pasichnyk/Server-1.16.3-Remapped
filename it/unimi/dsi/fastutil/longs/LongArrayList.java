...
/*  78 */     if (capacity == 0) {
/*  79 */       this.a = LongArrays.EMPTY_ARRAY;
/*     */     } else {
/*  81 */       this.a = new long[capacity];
/*     */     } 
/*     */   }
/*     */   
/*     */   public LongArrayList() {
/*  86 */     this.a = LongArrays.DEFAULT_EMPTY_ARRAY;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  95 */     this(c.size());
/*  96 */     this.size = LongIterators.unwrap(LongIterators.asLongIterator(c.iterator()), this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */     this(c.size());
/* 107 */     this.size = LongIterators.unwrap(c.iterator(), this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/* 194 */     LongArrayList l = new LongArrayList(a, false);
/* 195 */     l.size = length;
/* 196 */     return l;
/*     */   }
/*     */ 
...
/* 222 */     if (capacity <= this.a.length || this.a == LongArrays.DEFAULT_EMPTY_ARRAY)
/*     */       return; 
/* 224 */     this.a = LongArrays.ensureCapacity(this.a, capacity, this.size);
...
/* 329 */       Arrays.fill(this.a, this.size, size, 0L); 
/* 330 */     this.size = size;
/*     */   }
/*     */   
...
/*     */       return; 
/* 365 */     long[] t = new long[Math.max(n, this.size)];
...
/* 386 */     LongArrays.ensureOffsetLength(a, offset, length);
...
/* 418 */     LongArrays.ensureOffsetLength(a, offset, length);
...
/* 440 */     LongIterator i = c.iterator();
/* 441 */     this.size += n;
/* 442 */     while (n-- != 0)
/* 443 */       this.a[index++] = i.nextLong(); 
...
/* 477 */       if (!c.contains(Long.valueOf(a[i])))
/* 478 */         a[j++] = a[i]; 
...
/* 486 */     return new LongListIterator() {
/* 487 */         int pos = index; int last = -1;
/*     */         
/*     */         public boolean hasNext() {
/* 490 */           return (this.pos < LongArrayList.this.size);
/*     */         }
/*     */         
...
/* 500 */           return LongArrayList.this.a[this.last = this.pos++];
/*     */         }
/*     */         
/*     */         public long previousLong() {
/* 504 */           if (!hasPrevious())
/* 505 */             throw new NoSuchElementException(); 
/* 506 */           return LongArrayList.this.a[this.last = --this.pos];
/*     */         }
/*     */         
...
/* 518 */           LongArrayList.this.add(this.pos++, k);
/* 519 */           this.last = -1;
/*     */         }
/*     */         
...
/* 525 */           LongArrayList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 529 */           if (this.last == -1)
/* 530 */             throw new IllegalStateException(); 
/* 531 */           LongArrayList.this.removeLong(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 544 */     LongArrayList c = new LongArrayList(this.size);
...
/* 589 */     long[] a1 = this.a, a2 = l.a;
/*     */     
/*     */     int i;
/* 592 */     for (i = 0; i < s1 && i < s2; i++) {
/* 593 */       long e1 = a1[i];
/* 594 */       long e2 = a2[i]; int r;
/* 595 */       if ((r = Long.compare(e1, e2)) != 0)
/* 596 */         return r; 
/*     */     } 
...
/* 603 */       s.writeLong(this.a[i]); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 607 */     s.defaultReadObject();
/* 608 */     this.a = new long[this.size];
/* 609 */     for (int i = 0; i < this.size; i++)
/* 610 */       this.a[i] = s.readLong(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\LongArrayList.class
