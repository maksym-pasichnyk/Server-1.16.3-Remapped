...
/*      */   
/*      */   public boolean trim() {
/* 1029 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1061 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1062 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1063 */       return true; 
/*      */     try {
/* 1065 */       rehash(l);
...
/* 1085 */     long[] key = this.key;
/* 1086 */     boolean[] value = this.value;
/* 1087 */     int mask = newN - 1;
/* 1088 */     long[] newKey = new long[newN + 1];
/* 1089 */     boolean[] newValue = new boolean[newN + 1];
/* 1090 */     int i = this.n;
/* 1091 */     for (int j = realSize(); j-- != 0; ) {
/* 1092 */       while (key[--i] == 0L); int pos;
/* 1093 */       if (newKey[pos = (int)HashCommon.mix(key[i]) & mask] != 0L)
/* 1094 */         while (newKey[pos = pos + 1 & mask] != 0L); 
/* 1095 */       newKey[pos] = key[i];
/* 1096 */       newValue[pos] = value[i];
/*      */     } 
/* 1098 */     newValue[newN] = value[this.n];
/* 1099 */     this.n = newN;
/* 1100 */     this.mask = mask;
/* 1101 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1102 */     this.key = newKey;
/* 1103 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1120 */       c = (Long2BooleanOpenHashMap)super.clone();
/* 1121 */     } catch (CloneNotSupportedException cantHappen) {
/* 1122 */       throw new InternalError();
/*      */     } 
/* 1124 */     c.keys = null;
/* 1125 */     c.values = null;
/* 1126 */     c.entries = null;
/* 1127 */     c.containsNullKey = this.containsNullKey;
/* 1128 */     c.key = (long[])this.key.clone();
/* 1129 */     c.value = (boolean[])this.value.clone();
/* 1130 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1143 */     int h = 0;
/* 1144 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1145 */       while (this.key[i] == 0L)
/* 1146 */         i++; 
/* 1147 */       t = HashCommon.long2int(this.key[i]);
/* 1148 */       t ^= this.value[i] ? 1231 : 1237;
/* 1149 */       h += t;
/* 1150 */       i++;
/*      */     } 
/*      */     
/* 1153 */     if (this.containsNullKey)
/* 1154 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1155 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1158 */     long[] key = this.key;
/* 1159 */     boolean[] value = this.value;
/* 1160 */     MapIterator i = new MapIterator();
/* 1161 */     s.defaultWriteObject();
/* 1162 */     for (int j = this.size; j-- != 0; ) {
/* 1163 */       int e = i.nextEntry();
/* 1164 */       s.writeLong(key[e]);
/* 1165 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1170 */     s.defaultReadObject();
/* 1171 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1172 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1173 */     this.mask = this.n - 1;
/* 1174 */     long[] key = this.key = new long[this.n + 1];
/* 1175 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1178 */     for (int i = this.size; i-- != 0; ) {
/* 1179 */       int pos; long k = s.readLong();
/* 1180 */       boolean v = s.readBoolean();
/* 1181 */       if (k == 0L) {
/* 1182 */         pos = this.n;
/* 1183 */         this.containsNullKey = true;
/*      */       } else {
/* 1185 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1186 */         while (key[pos] != 0L)
/* 1187 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1189 */       key[pos] = k;
/* 1190 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2BooleanOpenHashMap.class
