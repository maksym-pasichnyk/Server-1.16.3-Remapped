...
/* 597 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 598 */       return true; 
/*     */     try {
/* 600 */       rehash(l);
/* 601 */     } catch (OutOfMemoryError cantDoIt) {
/* 602 */       return false;
/*     */     } 
/* 604 */     return true;
/*     */   }
...
/* 628 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 629 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 630 */       return true; 
/*     */     try {
/* 632 */       rehash(l);
/* 633 */     } catch (OutOfMemoryError cantDoIt) {
/* 634 */       return false;
/*     */     } 
/* 636 */     return true;
/*     */   }
...
/* 653 */     int mask = newN - 1;
/* 654 */     long[] newKey = new long[newN + 1];
/* 655 */     int i = this.n;
/* 656 */     for (int j = realSize(); j-- != 0; ) {
/* 657 */       while (key[--i] == 0L); int pos;
/* 658 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0L)
/* 659 */         while (newKey[pos = pos + 1 & mask] != 0L); 
...
/* 713 */     LongIterator i = iterator();
/* 714 */     s.defaultWriteObject();
/* 715 */     for (int j = this.size; j-- != 0;)
/* 716 */       s.writeLong(i.nextLong()); 
/*     */   }
/*     */   
...
/* 724 */     long[] key = this.key = new long[this.n + 1];
/*     */     
/* 726 */     for (int i = this.size; i-- != 0; ) {
/* 727 */       int pos; long k = s.readLong();
/* 728 */       if (this.strategy.equals(k, 0L)) {
/* 729 */         pos = this.n;
/* 730 */         this.containsNull = true;
/*     */       }
/* 732 */       else if (key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask] != 0L) {
/* 733 */         while (key[pos = pos + 1 & this.mask] != 0L);
/*     */       } 
/* 735 */       key[pos] = k;
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\LongOpenCustomHashSet.class
