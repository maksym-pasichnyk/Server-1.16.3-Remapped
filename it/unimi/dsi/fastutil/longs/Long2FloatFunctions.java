...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Long2FloatFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Long2FloatFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Long2FloatFunction singleton(Long key, Float value) {
/* 161 */     return new Singleton(key.longValue(), value.floatValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Long2FloatFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractLong2FloatFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2FloatFunction function;
/*     */     
...
/* 462 */       Float v = this.function.apply(Long.valueOf(key));
/* 463 */       if (v == null)
...
/* 505 */     if (f instanceof Long2FloatFunction)
/* 506 */       return (Long2FloatFunction)f; 
/* 507 */     if (f instanceof LongToDoubleFunction) {
/* 508 */       return key -> SafeMath.safeDoubleToFloat(((LongToDoubleFunction)f).applyAsDouble(key));
/*     */     }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatFunctions.class
