...
/*      */   
/*      */   public boolean trim() {
/* 1765 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1766 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1767 */       return true; 
/*      */     try {
/* 1769 */       rehash(l);
/* 1770 */     } catch (OutOfMemoryError cantDoIt) {
/* 1771 */       return false;
/*      */     } 
/* 1773 */     return true;
/*      */   }
...
/* 1797 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1798 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1799 */       return true; 
/*      */     try {
/* 1801 */       rehash(l);
/* 1802 */     } catch (OutOfMemoryError cantDoIt) {
/* 1803 */       return false;
/*      */     } 
/* 1805 */     return true;
/*      */   }
...
/* 1821 */     long[] key = this.key;
/* 1822 */     long[] value = this.value;
/* 1823 */     int mask = newN - 1;
/* 1824 */     long[] newKey = new long[newN + 1];
/* 1825 */     long[] newValue = new long[newN + 1];
/* 1826 */     int i = this.first, prev = -1, newPrev = -1;
/* 1827 */     long[] link = this.link;
/* 1828 */     long[] newLink = new long[newN + 1];
/* 1829 */     this.first = -1;
/* 1830 */     for (int j = this.size; j-- != 0; ) {
/* 1831 */       int pos; if (key[i] == 0L) {
/* 1832 */         pos = newN;
/*      */       } else {
/* 1834 */         pos = (int)HashCommon.mix(key[i]) & mask;
/* 1835 */         while (newKey[pos] != 0L)
/* 1836 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1838 */       newKey[pos] = key[i];
/* 1839 */       newValue[pos] = value[i];
/* 1840 */       if (prev != -1) {
/* 1841 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1842 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1843 */         newPrev = pos;
/*      */       } else {
/* 1845 */         newPrev = this.first = pos;
/*      */         
/* 1847 */         newLink[pos] = -1L;
/*      */       } 
/* 1849 */       int t = i;
...
/* 1851 */       prev = t;
/*      */     } 
/* 1853 */     this.link = newLink;
/* 1854 */     this.last = newPrev;
/* 1855 */     if (newPrev != -1)
/*      */     {
/* 1857 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1858 */     this.n = newN;
/* 1859 */     this.mask = mask;
/* 1860 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1861 */     this.key = newKey;
/* 1862 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1879 */       c = (Long2LongLinkedOpenHashMap)super.clone();
/* 1880 */     } catch (CloneNotSupportedException cantHappen) {
/* 1881 */       throw new InternalError();
/*      */     } 
/* 1883 */     c.keys = null;
/* 1884 */     c.values = null;
/* 1885 */     c.entries = null;
/* 1886 */     c.containsNullKey = this.containsNullKey;
/* 1887 */     c.key = (long[])this.key.clone();
/* 1888 */     c.value = (long[])this.value.clone();
/* 1889 */     c.link = (long[])this.link.clone();
/* 1890 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1903 */     int h = 0;
/* 1904 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1905 */       while (this.key[i] == 0L)
/* 1906 */         i++; 
/* 1907 */       t = HashCommon.long2int(this.key[i]);
/* 1908 */       t ^= HashCommon.long2int(this.value[i]);
/* 1909 */       h += t;
/* 1910 */       i++;
/*      */     } 
/*      */     
/* 1913 */     if (this.containsNullKey)
/* 1914 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1915 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1918 */     long[] key = this.key;
/* 1919 */     long[] value = this.value;
/* 1920 */     MapIterator i = new MapIterator();
/* 1921 */     s.defaultWriteObject();
/* 1922 */     for (int j = this.size; j-- != 0; ) {
/* 1923 */       int e = i.nextEntry();
/* 1924 */       s.writeLong(key[e]);
/* 1925 */       s.writeLong(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1930 */     s.defaultReadObject();
/* 1931 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1932 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1933 */     this.mask = this.n - 1;
/* 1934 */     long[] key = this.key = new long[this.n + 1];
/* 1935 */     long[] value = this.value = new long[this.n + 1];
/* 1936 */     long[] link = this.link = new long[this.n + 1];
/* 1937 */     int prev = -1;
/* 1938 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1941 */     for (int i = this.size; i-- != 0; ) {
/* 1942 */       int pos; long k = s.readLong();
/* 1943 */       long v = s.readLong();
/* 1944 */       if (k == 0L) {
/* 1945 */         pos = this.n;
/* 1946 */         this.containsNullKey = true;
/*      */       } else {
/* 1948 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1949 */         while (key[pos] != 0L)
/* 1950 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1952 */       key[pos] = k;
/* 1953 */       value[pos] = v;
/* 1954 */       if (this.first != -1) {
/* 1955 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1956 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1957 */         prev = pos; continue;
/*      */       } 
/* 1959 */       prev = this.first = pos;
/*      */       
/* 1961 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1964 */     this.last = prev;
/* 1965 */     if (prev != -1)
/*      */     {
/* 1967 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2LongLinkedOpenHashMap.class
