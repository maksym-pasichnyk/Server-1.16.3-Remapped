...
/* 1823 */     long[] key = this.key;
/* 1824 */     float[] value = this.value;
/* 1825 */     int mask = newN - 1;
/* 1826 */     long[] newKey = new long[newN + 1];
/* 1827 */     float[] newValue = new float[newN + 1];
...
/* 1833 */       int pos; if (key[i] == 0L) {
/* 1834 */         pos = newN;
/*      */       } else {
/* 1836 */         pos = (int)HashCommon.mix(key[i]) & mask;
/* 1837 */         while (newKey[pos] != 0L)
/* 1838 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1881 */       c = (Long2FloatLinkedOpenHashMap)super.clone();
...
/* 1889 */     c.key = (long[])this.key.clone();
/* 1890 */     c.value = (float[])this.value.clone();
...
/* 1907 */       while (this.key[i] == 0L)
/* 1908 */         i++; 
/* 1909 */       t = HashCommon.long2int(this.key[i]);
/* 1910 */       t ^= HashCommon.float2int(this.value[i]);
/* 1911 */       h += t;
/* 1912 */       i++;
/*      */     } 
/*      */     
/* 1915 */     if (this.containsNullKey)
/* 1916 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1917 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1920 */     long[] key = this.key;
/* 1921 */     float[] value = this.value;
/* 1922 */     MapIterator i = new MapIterator();
/* 1923 */     s.defaultWriteObject();
/* 1924 */     for (int j = this.size; j-- != 0; ) {
/* 1925 */       int e = i.nextEntry();
/* 1926 */       s.writeLong(key[e]);
/* 1927 */       s.writeFloat(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1936 */     long[] key = this.key = new long[this.n + 1];
/* 1937 */     float[] value = this.value = new float[this.n + 1];
...
/* 1944 */       int pos; long k = s.readLong();
/* 1945 */       float v = s.readFloat();
/* 1946 */       if (k == 0L) {
/* 1947 */         pos = this.n;
/* 1948 */         this.containsNullKey = true;
/*      */       } else {
/* 1950 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1951 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatLinkedOpenHashMap.class
