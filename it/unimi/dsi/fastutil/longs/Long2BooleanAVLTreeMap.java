...
/*  932 */         return false; 
/*  933 */       Map.Entry<Long, Boolean> e = (Map.Entry<Long, Boolean>)o;
/*  934 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  938 */       return HashCommon.long2int(this.key) ^ (this.value ? 1231 : 1237);
/*      */     }
/*      */     
...
/* 1020 */     int index = 0;
/*      */     TreeIterator() {
/* 1022 */       this.next = Long2BooleanAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1025 */       if ((this.next = Long2BooleanAVLTreeMap.this.locateKey(k)) != null)
/* 1026 */         if (Long2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1077 */       updatePrevious();
/* 1078 */       updateNext();
/* 1079 */       Long2BooleanAVLTreeMap.this.remove(this.curr.key);
/* 1080 */       this.curr = null;
/*      */     }
...
/* 1127 */       this.entries = (ObjectSortedSet<Long2BooleanMap.Entry>)new AbstractObjectSortedSet<Long2BooleanMap.Entry>()
/*      */         {
...
/* 1136 */             return (ObjectBidirectionalIterator<Long2BooleanMap.Entry>)new Long2BooleanAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator(Long2BooleanMap.Entry from) {
/* 1140 */             return (ObjectBidirectionalIterator<Long2BooleanMap.Entry>)new Long2BooleanAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1148 */             if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1149 */               return false; 
/* 1150 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1151 */               return false; 
/* 1152 */             Long2BooleanAVLTreeMap.Entry f = Long2BooleanAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1161 */             if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1162 */               return false; 
/* 1163 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1164 */               return false; 
/* 1165 */             Long2BooleanAVLTreeMap.Entry f = Long2BooleanAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1166 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue())
/* 1167 */               return false; 
/* 1168 */             Long2BooleanAVLTreeMap.this.remove(f.key);
/* 1169 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1173 */             return Long2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1177 */             Long2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2BooleanMap.Entry first() {
/* 1181 */             return Long2BooleanAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2BooleanMap.Entry last() {
/* 1185 */             return Long2BooleanAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry from, Long2BooleanMap.Entry to) {
/* 1190 */             return Long2BooleanAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry to) {
/* 1194 */             return Long2BooleanAVLTreeMap.this.headMap(to.getLongKey()).long2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry from) {
/* 1198 */             return Long2BooleanAVLTreeMap.this.tailMap(from.getLongKey()).long2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1232 */       return new Long2BooleanAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1236 */       return new Long2BooleanAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1291 */             return (BooleanIterator)new Long2BooleanAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1295 */             return Long2BooleanAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1299 */             return Long2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1303 */             Long2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1366 */       if (!bottom && !top && Long2BooleanAVLTreeMap.this.compare(from, to) > 0)
/* 1367 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1368 */       this.from = from;
/* 1369 */       this.bottom = bottom;
/* 1370 */       this.to = to;
/* 1371 */       this.top = top;
/* 1372 */       this.defRetValue = Long2BooleanAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1390 */       return ((this.bottom || Long2BooleanAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2BooleanAVLTreeMap.this
/* 1391 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
/* 1395 */       if (this.entries == null)
/* 1396 */         this.entries = (ObjectSortedSet<Long2BooleanMap.Entry>)new AbstractObjectSortedSet<Long2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator() {
/* 1399 */               return (ObjectBidirectionalIterator<Long2BooleanMap.Entry>)new Long2BooleanAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator(Long2BooleanMap.Entry from) {
/* 1404 */               return (ObjectBidirectionalIterator<Long2BooleanMap.Entry>)new Long2BooleanAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2BooleanMap.Entry> comparator() {
/* 1408 */               return Long2BooleanAVLTreeMap.this.long2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1419 */                 return false; 
/* 1420 */               Long2BooleanAVLTreeMap.Entry f = Long2BooleanAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1421 */               return (f != null && Long2BooleanAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1429 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1430 */                 return false; 
/* 1431 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1432 */                 return false; 
/* 1433 */               Long2BooleanAVLTreeMap.Entry f = Long2BooleanAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1434 */               if (f != null && Long2BooleanAVLTreeMap.Submap.this.in(f.key))
/* 1435 */                 Long2BooleanAVLTreeMap.Submap.this.remove(f.key); 
/* 1436 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1440 */               int c = 0;
/* 1441 */               for (ObjectBidirectionalIterator<Long2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1442 */                 c++; 
/* 1443 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1447 */               return !(new Long2BooleanAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1451 */               Long2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2BooleanMap.Entry first() {
/* 1455 */               return Long2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2BooleanMap.Entry last() {
/* 1459 */               return Long2BooleanAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry from, Long2BooleanMap.Entry to) {
/* 1464 */               return Long2BooleanAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry to) {
/* 1468 */               return Long2BooleanAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry from) {
/* 1472 */               return Long2BooleanAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2BooleanSortedMap.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1480 */         return new Long2BooleanAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1484 */         return new Long2BooleanAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1499 */               return (BooleanIterator)new Long2BooleanAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1503 */               return Long2BooleanAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1507 */               return Long2BooleanAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1511 */               Long2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1519 */       return (in(k) && Long2BooleanAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(long k) {
/* 1536 */       long kk = k; Long2BooleanAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Long2BooleanAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public boolean put(long k, boolean v) {
/* 1541 */       Long2BooleanAVLTreeMap.this.modified = false;
/* 1542 */       if (!in(k))
...
/* 1545 */       boolean oldValue = Long2BooleanAVLTreeMap.this.put(k, v);
/* 1546 */       return Long2BooleanAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(long k) {
/* 1551 */       Long2BooleanAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k))
/* 1553 */         return this.defRetValue; 
/* 1554 */       boolean oldValue = Long2BooleanAVLTreeMap.this.remove(k);
/* 1555 */       return Long2BooleanAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1573 */       return Long2BooleanAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2BooleanSortedMap headMap(long to) {
/* 1577 */       if (this.top)
/* 1578 */         return new Submap(this.from, this.bottom, to, false); 
/* 1579 */       return (Long2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2BooleanSortedMap tailMap(long from) {
/* 1583 */       if (this.bottom)
/* 1584 */         return new Submap(from, false, this.to, this.top); 
/* 1585 */       return (Long2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2BooleanSortedMap subMap(long from, long to) {
...
/* 1591 */       if (!this.top)
/* 1592 */         to = (Long2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1593 */       if (!this.bottom)
/* 1594 */         from = (Long2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1606 */       if (Long2BooleanAVLTreeMap.this.tree == null) {
/* 1607 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1611 */       if (this.bottom) {
/* 1612 */         e = Long2BooleanAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1614 */         e = Long2BooleanAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1616 */         if (Long2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1617 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1621 */       if (e == null || (!this.top && Long2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1622 */         return null; 
/* 1623 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2BooleanAVLTreeMap.Entry e;
/* 1632 */       if (Long2BooleanAVLTreeMap.this.tree == null) {
/* 1633 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1637 */       if (this.top) {
/* 1638 */         e = Long2BooleanAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1640 */         e = Long2BooleanAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1642 */         if (Long2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1643 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1647 */       if (e == null || (!this.bottom && Long2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1648 */         return null; 
/* 1649 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1653 */       Long2BooleanAVLTreeMap.Entry e = firstEntry();
/* 1654 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1660 */       Long2BooleanAVLTreeMap.Entry e = lastEntry();
/* 1661 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1676 */         this.next = Long2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1679 */         this();
/* 1680 */         if (this.next != null)
/* 1681 */           if (!Long2BooleanAVLTreeMap.Submap.this.bottom && Long2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1682 */             this.prev = null;
/* 1683 */           } else if (!Long2BooleanAVLTreeMap.Submap.this.top && Long2BooleanAVLTreeMap.this.compare(k, (this.prev = Long2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1684 */             this.next = null;
/*      */           } else {
/* 1686 */             this.next = Long2BooleanAVLTreeMap.this.locateKey(k);
/* 1687 */             if (Long2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1698 */         if (!Long2BooleanAVLTreeMap.Submap.this.bottom && this.prev != null && Long2BooleanAVLTreeMap.this.compare(this.prev.key, Long2BooleanAVLTreeMap.Submap.this.from) < 0)
/* 1699 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1703 */         this.next = this.next.next();
/* 1704 */         if (!Long2BooleanAVLTreeMap.Submap.this.top && this.next != null && Long2BooleanAVLTreeMap.this.compare(this.next.key, Long2BooleanAVLTreeMap.Submap.this.to) >= 0)
/* 1705 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1785 */       c = (Long2BooleanAVLTreeMap)super.clone();
...
/* 1866 */     if (n == 1) {
/* 1867 */       Entry entry = new Entry(s.readLong(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1877 */       Entry entry = new Entry(s.readLong(), s.readBoolean());
/* 1878 */       entry.right(new Entry(s.readLong(), s.readBoolean()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2BooleanAVLTreeMap.class
