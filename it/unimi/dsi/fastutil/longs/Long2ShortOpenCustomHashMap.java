...
/* 1176 */     long[] key = this.key;
/* 1177 */     short[] value = this.value;
/* 1178 */     int mask = newN - 1;
/* 1179 */     long[] newKey = new long[newN + 1];
/* 1180 */     short[] newValue = new short[newN + 1];
/* 1181 */     int i = this.n;
/* 1182 */     for (int j = realSize(); j-- != 0; ) {
/* 1183 */       while (key[--i] == 0L); int pos;
/* 1184 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0L)
/* 1185 */         while (newKey[pos = pos + 1 & mask] != 0L); 
/* 1186 */       newKey[pos] = key[i];
/* 1187 */       newValue[pos] = value[i];
/*      */     } 
/* 1189 */     newValue[newN] = value[this.n];
/* 1190 */     this.n = newN;
/* 1191 */     this.mask = mask;
...
/*      */     try {
/* 1211 */       c = (Long2ShortOpenCustomHashMap)super.clone();
/* 1212 */     } catch (CloneNotSupportedException cantHappen) {
/* 1213 */       throw new InternalError();
/*      */     } 
/* 1215 */     c.keys = null;
/* 1216 */     c.values = null;
/* 1217 */     c.entries = null;
/* 1218 */     c.containsNullKey = this.containsNullKey;
/* 1219 */     c.key = (long[])this.key.clone();
/* 1220 */     c.value = (short[])this.value.clone();
/* 1221 */     c.strategy = this.strategy;
/* 1222 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1235 */     int h = 0;
/* 1236 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1237 */       while (this.key[i] == 0L)
/* 1238 */         i++; 
/* 1239 */       t = this.strategy.hashCode(this.key[i]);
/* 1240 */       t ^= this.value[i];
/* 1241 */       h += t;
/* 1242 */       i++;
/*      */     } 
/*      */     
/* 1245 */     if (this.containsNullKey)
/* 1246 */       h += this.value[this.n]; 
/* 1247 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1250 */     long[] key = this.key;
/* 1251 */     short[] value = this.value;
/* 1252 */     MapIterator i = new MapIterator();
/* 1253 */     s.defaultWriteObject();
/* 1254 */     for (int j = this.size; j-- != 0; ) {
/* 1255 */       int e = i.nextEntry();
/* 1256 */       s.writeLong(key[e]);
/* 1257 */       s.writeShort(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1266 */     long[] key = this.key = new long[this.n + 1];
/* 1267 */     short[] value = this.value = new short[this.n + 1];
/*      */ 
/*      */     
/* 1270 */     for (int i = this.size; i-- != 0; ) {
/* 1271 */       int pos; long k = s.readLong();
/* 1272 */       short v = s.readShort();
/* 1273 */       if (this.strategy.equals(k, 0L)) {
/* 1274 */         pos = this.n;
/* 1275 */         this.containsNullKey = true;
/*      */       } else {
/* 1277 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1278 */         while (key[pos] != 0L)
/* 1279 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1281 */       key[pos] = k;
/* 1282 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ShortOpenCustomHashMap.class
