...
/*      */   
/*      */   public boolean trim() {
/* 1681 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1682 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1683 */       return true; 
/*      */     try {
/* 1685 */       rehash(l);
/* 1686 */     } catch (OutOfMemoryError cantDoIt) {
/* 1687 */       return false;
/*      */     } 
/* 1689 */     return true;
/*      */   }
...
/* 1713 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1714 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1715 */       return true; 
/*      */     try {
/* 1717 */       rehash(l);
/* 1718 */     } catch (OutOfMemoryError cantDoIt) {
/* 1719 */       return false;
/*      */     } 
/* 1721 */     return true;
/*      */   }
...
/* 1737 */     long[] key = this.key;
/* 1738 */     V[] value = this.value;
/* 1739 */     int mask = newN - 1;
/* 1740 */     long[] newKey = new long[newN + 1];
/* 1741 */     V[] newValue = (V[])new Object[newN + 1];
/* 1742 */     int i = this.first, prev = -1, newPrev = -1;
/* 1743 */     long[] link = this.link;
/* 1744 */     long[] newLink = new long[newN + 1];
/* 1745 */     this.first = -1;
/* 1746 */     for (int j = this.size; j-- != 0; ) {
/* 1747 */       int pos; if (key[i] == 0L) {
/* 1748 */         pos = newN;
/*      */       } else {
/* 1750 */         pos = (int)HashCommon.mix(key[i]) & mask;
/* 1751 */         while (newKey[pos] != 0L)
/* 1752 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1754 */       newKey[pos] = key[i];
/* 1755 */       newValue[pos] = value[i];
/* 1756 */       if (prev != -1) {
/* 1757 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1758 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1759 */         newPrev = pos;
/*      */       } else {
/* 1761 */         newPrev = this.first = pos;
/*      */         
/* 1763 */         newLink[pos] = -1L;
/*      */       } 
/* 1765 */       int t = i;
...
/* 1767 */       prev = t;
/*      */     } 
/* 1769 */     this.link = newLink;
/* 1770 */     this.last = newPrev;
/* 1771 */     if (newPrev != -1)
/*      */     {
/* 1773 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1774 */     this.n = newN;
/* 1775 */     this.mask = mask;
/* 1776 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1777 */     this.key = newKey;
/* 1778 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1795 */       c = (Long2ObjectLinkedOpenHashMap<V>)super.clone();
/* 1796 */     } catch (CloneNotSupportedException cantHappen) {
/* 1797 */       throw new InternalError();
/*      */     } 
/* 1799 */     c.keys = null;
/* 1800 */     c.values = null;
/* 1801 */     c.entries = null;
/* 1802 */     c.containsNullKey = this.containsNullKey;
/* 1803 */     c.key = (long[])this.key.clone();
/* 1804 */     c.value = (V[])this.value.clone();
/* 1805 */     c.link = (long[])this.link.clone();
/* 1806 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1819 */     int h = 0;
/* 1820 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1821 */       while (this.key[i] == 0L)
/* 1822 */         i++; 
/* 1823 */       t = HashCommon.long2int(this.key[i]);
/* 1824 */       if (this != this.value[i])
/* 1825 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1826 */       h += t;
/* 1827 */       i++;
/*      */     } 
/*      */     
/* 1830 */     if (this.containsNullKey)
/* 1831 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1832 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1835 */     long[] key = this.key;
/* 1836 */     V[] value = this.value;
/* 1837 */     MapIterator i = new MapIterator();
/* 1838 */     s.defaultWriteObject();
/* 1839 */     for (int j = this.size; j-- != 0; ) {
/* 1840 */       int e = i.nextEntry();
/* 1841 */       s.writeLong(key[e]);
/* 1842 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1847 */     s.defaultReadObject();
/* 1848 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1849 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1850 */     this.mask = this.n - 1;
/* 1851 */     long[] key = this.key = new long[this.n + 1];
/* 1852 */     V[] value = this.value = (V[])new Object[this.n + 1];
/* 1853 */     long[] link = this.link = new long[this.n + 1];
/* 1854 */     int prev = -1;
/* 1855 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1858 */     for (int i = this.size; i-- != 0; ) {
/* 1859 */       int pos; long k = s.readLong();
/* 1860 */       V v = (V)s.readObject();
/* 1861 */       if (k == 0L) {
/* 1862 */         pos = this.n;
/* 1863 */         this.containsNullKey = true;
/*      */       } else {
/* 1865 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1866 */         while (key[pos] != 0L)
/* 1867 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1869 */       key[pos] = k;
/* 1870 */       value[pos] = v;
/* 1871 */       if (this.first != -1) {
/* 1872 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1873 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1874 */         prev = pos; continue;
/*      */       } 
/* 1876 */       prev = this.first = pos;
/*      */       
/* 1878 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1881 */     this.last = prev;
/* 1882 */     if (prev != -1)
/*      */     {
/* 1884 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ObjectLinkedOpenHashMap.class
