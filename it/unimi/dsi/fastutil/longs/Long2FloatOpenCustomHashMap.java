...
/* 1181 */     float[] newValue = new float[newN + 1];
/* 1182 */     int i = this.n;
...
/*      */     try {
/* 1212 */       c = (Long2FloatOpenCustomHashMap)super.clone();
...
/* 1221 */     c.value = (float[])this.value.clone();
...
/* 1241 */       t ^= HashCommon.float2int(this.value[i]);
/* 1242 */       h += t;
/* 1243 */       i++;
/*      */     } 
/*      */     
/* 1246 */     if (this.containsNullKey)
/* 1247 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1248 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1251 */     long[] key = this.key;
/* 1252 */     float[] value = this.value;
...
/* 1268 */     float[] value = this.value = new float[this.n + 1];
/*      */ 
/*      */     
/* 1271 */     for (int i = this.size; i-- != 0; ) {
/* 1272 */       int pos; long k = s.readLong();
/* 1273 */       float v = s.readFloat();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatOpenCustomHashMap.class
