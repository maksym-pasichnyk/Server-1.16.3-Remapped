...
/*  61 */     return (entries instanceof Long2DoubleSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Long2DoubleSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Long2DoubleMap.Entry> entries = map.long2DoubleEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Long2DoubleSortedMap.FastSortedEntrySet)entries); return (entries instanceof Long2DoubleSortedMap.FastSortedEntrySet) ? (Long2DoubleSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Long2DoubleMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Long2DoubleMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Long, Double>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Long2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2DoubleSortedMap headMap(long to) {
/* 132 */       return Long2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2DoubleSortedMap tailMap(long from) {
/* 137 */       return Long2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Long2DoubleMap.Entry>)ObjectSortedSets.singleton(new AbstractLong2DoubleMap.BasicEntry(this.key, this.value), 
/* 237 */             Long2DoubleSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Long2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Double>> entrySet() {
/* 249 */       return (ObjectSortedSet)long2DoubleEntrySet();
/*     */     }
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Long2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2DoubleSortedMap headMap(long to) {
...
/* 268 */         return this; 
/* 269 */       return Long2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2DoubleSortedMap tailMap(long from) {
...
/* 275 */         return this; 
/* 276 */       return Long2DoubleSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public long firstLongKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.longValue(), value.doubleValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Long2DoubleMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.long2DoubleEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Long2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Double>> entrySet() {
/* 449 */       return (ObjectSortedSet)long2DoubleEntrySet();
/*     */     }
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Long2DoubleMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.long2DoubleEntrySet()); 
/* 582 */       return (ObjectSortedSet<Long2DoubleMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2DoubleSortedMaps.class
