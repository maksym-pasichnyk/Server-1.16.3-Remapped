...
/*  428 */       if (key[i] != 0L && Objects.equals(value[i], v))
/*  429 */         return true; 
/*  430 */     }  return false;
/*      */   }
/*      */ 
...
/*  626 */       return Long2ObjectOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public V getValue() {
/*  630 */       return Long2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public V setValue(V v) {
/*  634 */       V oldValue = Long2ObjectOpenCustomHashMap.this.value[this.index];
/*  635 */       Long2ObjectOpenCustomHashMap.this.value[this.index] = v;
/*  636 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/*  646 */       return Long.valueOf(Long2ObjectOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */     
...
/*  654 */       return (Long2ObjectOpenCustomHashMap.this.strategy.equals(Long2ObjectOpenCustomHashMap.this.key[this.index], ((Long)e.getKey()).longValue()) && 
/*  655 */         Objects.equals(Long2ObjectOpenCustomHashMap.this.value[this.index], e.getValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  659 */       return Long2ObjectOpenCustomHashMap.this.strategy.hashCode(Long2ObjectOpenCustomHashMap.this.key[this.index]) ^ ((Long2ObjectOpenCustomHashMap.this.value[this.index] == null) ? 0 : Long2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     
/*      */     public String toString() {
/*  663 */       return Long2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Long2ObjectOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  673 */     int pos = Long2ObjectOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */     int last = -1;
/*      */     
/*  682 */     int c = Long2ObjectOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  686 */     boolean mustReturnNullKey = Long2ObjectOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  701 */         return this.last = Long2ObjectOpenCustomHashMap.this.n;
/*      */       } 
/*  703 */       long[] key = Long2ObjectOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  705 */         if (--this.pos < 0) {
/*      */           
/*  707 */           this.last = Integer.MIN_VALUE;
/*  708 */           long k = this.wrapped.getLong(-this.pos - 1);
/*  709 */           int p = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ObjectOpenCustomHashMap.this.mask;
/*  710 */           while (!Long2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  711 */             p = p + 1 & Long2ObjectOpenCustomHashMap.this.mask; 
/*  712 */           return p;
/*      */         } 
...
/*  729 */       long[] key = Long2ObjectOpenCustomHashMap.this.key; while (true) {
/*      */         long curr; int last;
/*  731 */         pos = (last = pos) + 1 & Long2ObjectOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  733 */           if ((curr = key[pos]) == 0L) {
/*  734 */             key[last] = 0L;
/*  735 */             Long2ObjectOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  738 */           int slot = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(curr)) & Long2ObjectOpenCustomHashMap.this.mask;
/*  739 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  741 */           pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask;
/*      */         } 
/*  743 */         if (pos < last) {
...
/*      */         } 
/*  748 */         key[last] = curr;
/*  749 */         Long2ObjectOpenCustomHashMap.this.value[last] = Long2ObjectOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  753 */       if (this.last == -1)
/*  754 */         throw new IllegalStateException(); 
/*  755 */       if (this.last == Long2ObjectOpenCustomHashMap.this.n) {
/*  756 */         Long2ObjectOpenCustomHashMap.this.containsNullKey = false;
/*  757 */         Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n] = null;
/*  758 */       } else if (this.pos >= 0) {
/*  759 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  762 */         Long2ObjectOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 1));
/*  763 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  766 */       Long2ObjectOpenCustomHashMap.this.size--;
/*  767 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Long2ObjectMap.Entry<V>> { private Long2ObjectOpenCustomHashMap<V>.MapEntry entry;
/*      */     
/*      */     public Long2ObjectOpenCustomHashMap<V>.MapEntry next() {
/*  782 */       return this.entry = new Long2ObjectOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  791 */       this.entry = new Long2ObjectOpenCustomHashMap.MapEntry();
...
/*  801 */       return new Long2ObjectOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Long2ObjectMap.Entry<V>> fastIterator() {
/*  805 */       return new Long2ObjectOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  817 */       if (Long2ObjectOpenCustomHashMap.this.strategy.equals(k, 0L)) {
/*  818 */         return (Long2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n], v));
/*      */       }
/*  820 */       long[] key = Long2ObjectOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/*  823 */       if ((curr = key[pos = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ObjectOpenCustomHashMap.this.mask]) == 0L)
/*  824 */         return false; 
/*  825 */       if (Long2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  826 */         return Objects.equals(Long2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */       }
/*      */       while (true) {
/*  829 */         if ((curr = key[pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask]) == 0L)
/*  830 */           return false; 
/*  831 */         if (Long2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  832 */           return Objects.equals(Long2ObjectOpenCustomHashMap.this.value[pos], v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  845 */       if (Long2ObjectOpenCustomHashMap.this.strategy.equals(k, 0L)) {
/*  846 */         if (Long2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n], v)) {
/*  847 */           Long2ObjectOpenCustomHashMap.this.removeNullEntry();
/*  848 */           return true;
/*      */         } 
/*  850 */         return false;
/*      */       } 
/*      */       
/*  853 */       long[] key = Long2ObjectOpenCustomHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/*  856 */       if ((curr = key[pos = HashCommon.mix(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ObjectOpenCustomHashMap.this.mask]) == 0L)
/*  857 */         return false; 
/*  858 */       if (Long2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  859 */         if (Objects.equals(Long2ObjectOpenCustomHashMap.this.value[pos], v)) {
/*  860 */           Long2ObjectOpenCustomHashMap.this.removeEntry(pos);
/*  861 */           return true;
/*      */         } 
/*  863 */         return false;
/*      */       } 
/*      */       while (true) {
/*  866 */         if ((curr = key[pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask]) == 0L)
/*  867 */           return false; 
/*  868 */         if (Long2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  869 */           Objects.equals(Long2ObjectOpenCustomHashMap.this.value[pos], v)) {
/*  870 */           Long2ObjectOpenCustomHashMap.this.removeEntry(pos);
/*  871 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  878 */       return Long2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  882 */       Long2ObjectOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
/*  887 */       if (Long2ObjectOpenCustomHashMap.this.containsNullKey)
/*  888 */         consumer.accept(new AbstractLong2ObjectMap.BasicEntry<>(Long2ObjectOpenCustomHashMap.this.key[Long2ObjectOpenCustomHashMap.this.n], Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n])); 
/*  889 */       for (int pos = Long2ObjectOpenCustomHashMap.this.n; pos-- != 0;) {
/*  890 */         if (Long2ObjectOpenCustomHashMap.this.key[pos] != 0L)
/*  891 */           consumer.accept(new AbstractLong2ObjectMap.BasicEntry<>(Long2ObjectOpenCustomHashMap.this.key[pos], Long2ObjectOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
/*  896 */       AbstractLong2ObjectMap.BasicEntry<V> entry = new AbstractLong2ObjectMap.BasicEntry<>();
/*  897 */       if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
/*  898 */         entry.key = Long2ObjectOpenCustomHashMap.this.key[Long2ObjectOpenCustomHashMap.this.n];
/*  899 */         entry.value = Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n];
/*  900 */         consumer.accept(entry);
/*      */       } 
/*  902 */       for (int pos = Long2ObjectOpenCustomHashMap.this.n; pos-- != 0;) {
/*  903 */         if (Long2ObjectOpenCustomHashMap.this.key[pos] != 0L) {
/*  904 */           entry.key = Long2ObjectOpenCustomHashMap.this.key[pos];
/*  905 */           entry.value = Long2ObjectOpenCustomHashMap.this.value[pos];
...
/*  931 */       return Long2ObjectOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractLongSet { private KeySet() {}
/*      */     
/*      */     public LongIterator iterator() {
/*  937 */       return new Long2ObjectOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/*  942 */       if (Long2ObjectOpenCustomHashMap.this.containsNullKey)
/*  943 */         consumer.accept(Long2ObjectOpenCustomHashMap.this.key[Long2ObjectOpenCustomHashMap.this.n]); 
/*  944 */       for (int pos = Long2ObjectOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  945 */         long k = Long2ObjectOpenCustomHashMap.this.key[pos];
/*  946 */         if (k != 0L)
...
/*      */     
/*      */     public int size() {
/*  952 */       return Long2ObjectOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(long k) {
/*  956 */       return Long2ObjectOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(long k) {
/*  960 */       int oldSize = Long2ObjectOpenCustomHashMap.this.size;
/*  961 */       Long2ObjectOpenCustomHashMap.this.remove(k);
/*  962 */       return (Long2ObjectOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  966 */       Long2ObjectOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*      */   {
/*      */     public V next() {
/*  990 */       return Long2ObjectOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*  999 */             return new Long2ObjectOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1003 */             return Long2ObjectOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(Object v) {
/* 1007 */             return Long2ObjectOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1011 */             Long2ObjectOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer)
/*      */           {
/* 1016 */             if (Long2ObjectOpenCustomHashMap.this.containsNullKey)
/* 1017 */               consumer.accept(Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n]); 
/* 1018 */             for (int pos = Long2ObjectOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1019 */               if (Long2ObjectOpenCustomHashMap.this.key[pos] != 0L)
/* 1020 */                 consumer.accept(Long2ObjectOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */   
/*      */   public boolean trim() {
/* 1040 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1041 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1042 */       return true; 
/*      */     try {
/* 1044 */       rehash(l);
/* 1045 */     } catch (OutOfMemoryError cantDoIt) {
/* 1046 */       return false;
/*      */     } 
/* 1048 */     return true;
/*      */   }
...
/* 1073 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1074 */       return true; 
/*      */     try {
/* 1076 */       rehash(l);
...
/* 1096 */     long[] key = this.key;
/* 1097 */     V[] value = this.value;
/* 1098 */     int mask = newN - 1;
/* 1099 */     long[] newKey = new long[newN + 1];
/* 1100 */     V[] newValue = (V[])new Object[newN + 1];
/* 1101 */     int i = this.n;
/* 1102 */     for (int j = realSize(); j-- != 0; ) {
/* 1103 */       while (key[--i] == 0L); int pos;
/* 1104 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0L)
/* 1105 */         while (newKey[pos = pos + 1 & mask] != 0L); 
/* 1106 */       newKey[pos] = key[i];
/* 1107 */       newValue[pos] = value[i];
/*      */     } 
/* 1109 */     newValue[newN] = value[this.n];
/* 1110 */     this.n = newN;
/* 1111 */     this.mask = mask;
/* 1112 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1113 */     this.key = newKey;
/* 1114 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1131 */       c = (Long2ObjectOpenCustomHashMap<V>)super.clone();
/* 1132 */     } catch (CloneNotSupportedException cantHappen) {
/* 1133 */       throw new InternalError();
/*      */     } 
/* 1135 */     c.keys = null;
/* 1136 */     c.values = null;
/* 1137 */     c.entries = null;
/* 1138 */     c.containsNullKey = this.containsNullKey;
/* 1139 */     c.key = (long[])this.key.clone();
/* 1140 */     c.value = (V[])this.value.clone();
/* 1141 */     c.strategy = this.strategy;
/* 1142 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1155 */     int h = 0;
/* 1156 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1157 */       while (this.key[i] == 0L)
/* 1158 */         i++; 
/* 1159 */       t = this.strategy.hashCode(this.key[i]);
/* 1160 */       if (this != this.value[i])
/* 1161 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1162 */       h += t;
/* 1163 */       i++;
/*      */     } 
/*      */     
/* 1166 */     if (this.containsNullKey)
/* 1167 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1168 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1171 */     long[] key = this.key;
/* 1172 */     V[] value = this.value;
/* 1173 */     MapIterator i = new MapIterator();
/* 1174 */     s.defaultWriteObject();
/* 1175 */     for (int j = this.size; j-- != 0; ) {
/* 1176 */       int e = i.nextEntry();
/* 1177 */       s.writeLong(key[e]);
/* 1178 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1183 */     s.defaultReadObject();
/* 1184 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1185 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1186 */     this.mask = this.n - 1;
/* 1187 */     long[] key = this.key = new long[this.n + 1];
/* 1188 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1191 */     for (int i = this.size; i-- != 0; ) {
/* 1192 */       int pos; long k = s.readLong();
/* 1193 */       V v = (V)s.readObject();
/* 1194 */       if (this.strategy.equals(k, 0L)) {
/* 1195 */         pos = this.n;
/* 1196 */         this.containsNullKey = true;
/*      */       } else {
/* 1198 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1199 */         while (key[pos] != 0L)
/* 1200 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1202 */       key[pos] = k;
/* 1203 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ObjectOpenCustomHashMap.class
