...
/*  954 */         return false; 
/*  955 */       Map.Entry<Long, Short> e = (Map.Entry<Long, Short>)o;
/*  956 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Long2ShortAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1047 */       if ((this.next = Long2ShortAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Long2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Long2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Long2ShortMap.Entry>)new AbstractObjectSortedSet<Long2ShortMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Long2ShortMap.Entry>)new Long2ShortAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator(Long2ShortMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Long2ShortMap.Entry>)new Long2ShortAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Long2ShortAVLTreeMap.Entry f = Long2ShortAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1186 */               return false; 
/* 1187 */             Long2ShortAVLTreeMap.Entry f = Long2ShortAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1188 */             if (f == null || f.getShortValue() != ((Short)e.getValue()).shortValue())
/* 1189 */               return false; 
/* 1190 */             Long2ShortAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Long2ShortAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Long2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2ShortMap.Entry first() {
/* 1203 */             return Long2ShortAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2ShortMap.Entry last() {
/* 1207 */             return Long2ShortAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2ShortMap.Entry> subSet(Long2ShortMap.Entry from, Long2ShortMap.Entry to) {
/* 1211 */             return Long2ShortAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2ShortEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2ShortMap.Entry> headSet(Long2ShortMap.Entry to) {
/* 1215 */             return Long2ShortAVLTreeMap.this.headMap(to.getLongKey()).long2ShortEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2ShortMap.Entry> tailSet(Long2ShortMap.Entry from) {
/* 1219 */             return Long2ShortAVLTreeMap.this.tailMap(from.getLongKey()).long2ShortEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Long2ShortAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1257 */       return new Long2ShortAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (ShortIterator)new Long2ShortAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(short k) {
/* 1316 */             return Long2ShortAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Long2ShortAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Long2ShortAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Long2ShortAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Long2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Long2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ShortAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Long2ShortMap.Entry>)new AbstractObjectSortedSet<Long2ShortMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Long2ShortMap.Entry>)new Long2ShortAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator(Long2ShortMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Long2ShortMap.Entry>)new Long2ShortAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2ShortMap.Entry> comparator() {
/* 1428 */               return Long2ShortAVLTreeMap.this.long2ShortEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Long2ShortAVLTreeMap.Entry f = Long2ShortAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1441 */               return (f != null && Long2ShortAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Long2ShortAVLTreeMap.Entry f = Long2ShortAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1454 */               if (f != null && Long2ShortAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Long2ShortAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Long2ShortMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Long2ShortAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Long2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2ShortMap.Entry first() {
/* 1475 */               return Long2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2ShortMap.Entry last() {
/* 1479 */               return Long2ShortAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ShortMap.Entry> subSet(Long2ShortMap.Entry from, Long2ShortMap.Entry to) {
/* 1484 */               return Long2ShortAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2ShortEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2ShortMap.Entry> headSet(Long2ShortMap.Entry to) {
/* 1488 */               return Long2ShortAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2ShortEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2ShortMap.Entry> tailSet(Long2ShortMap.Entry from) {
/* 1492 */               return Long2ShortAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2ShortEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2ShortSortedMap.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1500 */         return new Long2ShortAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1504 */         return new Long2ShortAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/*      */           {
/*      */             public ShortIterator iterator() {
/* 1519 */               return (ShortIterator)new Long2ShortAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(short k) {
/* 1523 */               return Long2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1527 */               return Long2ShortAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1531 */               Long2ShortAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1539 */       return (in(k) && Long2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(short v) {
...
/*      */     
/*      */     public short get(long k) {
/* 1556 */       long kk = k; Long2ShortAVLTreeMap.Entry e;
/* 1557 */       return (in(kk) && (e = Long2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public short put(long k, short v) {
/* 1561 */       Long2ShortAVLTreeMap.this.modified = false;
/* 1562 */       if (!in(k))
...
/* 1565 */       short oldValue = Long2ShortAVLTreeMap.this.put(k, v);
/* 1566 */       return Long2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public short remove(long k) {
/* 1571 */       Long2ShortAVLTreeMap.this.modified = false;
/* 1572 */       if (!in(k))
/* 1573 */         return this.defRetValue; 
/* 1574 */       short oldValue = Long2ShortAVLTreeMap.this.remove(k);
/* 1575 */       return Long2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1593 */       return Long2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2ShortSortedMap headMap(long to) {
/* 1597 */       if (this.top)
/* 1598 */         return new Submap(this.from, this.bottom, to, false); 
/* 1599 */       return (Long2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2ShortSortedMap tailMap(long from) {
/* 1603 */       if (this.bottom)
/* 1604 */         return new Submap(from, false, this.to, this.top); 
/* 1605 */       return (Long2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2ShortSortedMap subMap(long from, long to) {
...
/* 1611 */       if (!this.top)
/* 1612 */         to = (Long2ShortAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1613 */       if (!this.bottom)
/* 1614 */         from = (Long2ShortAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1626 */       if (Long2ShortAVLTreeMap.this.tree == null) {
/* 1627 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1631 */       if (this.bottom) {
/* 1632 */         e = Long2ShortAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1634 */         e = Long2ShortAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1636 */         if (Long2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1637 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1641 */       if (e == null || (!this.top && Long2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1642 */         return null; 
/* 1643 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2ShortAVLTreeMap.Entry e;
/* 1652 */       if (Long2ShortAVLTreeMap.this.tree == null) {
/* 1653 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1657 */       if (this.top) {
/* 1658 */         e = Long2ShortAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1660 */         e = Long2ShortAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1662 */         if (Long2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1663 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1667 */       if (e == null || (!this.bottom && Long2ShortAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1668 */         return null; 
/* 1669 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1673 */       Long2ShortAVLTreeMap.Entry e = firstEntry();
/* 1674 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1680 */       Long2ShortAVLTreeMap.Entry e = lastEntry();
/* 1681 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1696 */         this.next = Long2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1699 */         this();
/* 1700 */         if (this.next != null)
/* 1701 */           if (!Long2ShortAVLTreeMap.Submap.this.bottom && Long2ShortAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1702 */             this.prev = null;
/* 1703 */           } else if (!Long2ShortAVLTreeMap.Submap.this.top && Long2ShortAVLTreeMap.this.compare(k, (this.prev = Long2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1704 */             this.next = null;
/*      */           } else {
/* 1706 */             this.next = Long2ShortAVLTreeMap.this.locateKey(k);
/* 1707 */             if (Long2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1718 */         if (!Long2ShortAVLTreeMap.Submap.this.bottom && this.prev != null && Long2ShortAVLTreeMap.this.compare(this.prev.key, Long2ShortAVLTreeMap.Submap.this.from) < 0)
/* 1719 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1723 */         this.next = this.next.next();
/* 1724 */         if (!Long2ShortAVLTreeMap.Submap.this.top && this.next != null && Long2ShortAVLTreeMap.this.compare(this.next.key, Long2ShortAVLTreeMap.Submap.this.to) >= 0)
/* 1725 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1805 */       c = (Long2ShortAVLTreeMap)super.clone();
...
/* 1886 */     if (n == 1) {
/* 1887 */       Entry entry = new Entry(s.readLong(), s.readShort());
...
/*      */ 
/*      */       
/* 1897 */       Entry entry = new Entry(s.readLong(), s.readShort());
/* 1898 */       entry.right(new Entry(s.readLong(), s.readShort()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ShortAVLTreeMap.class
