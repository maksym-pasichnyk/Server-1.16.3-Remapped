...
/* 1764 */     long[] key = this.key;
/* 1765 */     char[] value = this.value;
/* 1766 */     int mask = newN - 1;
/* 1767 */     long[] newKey = new long[newN + 1];
...
/* 1774 */       int pos; if (key[i] == 0L) {
/* 1775 */         pos = newN;
/*      */       } else {
/* 1777 */         pos = (int)HashCommon.mix(key[i]) & mask;
/* 1778 */         while (newKey[pos] != 0L)
/* 1779 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1822 */       c = (Long2CharLinkedOpenHashMap)super.clone();
...
/* 1830 */     c.key = (long[])this.key.clone();
...
/* 1848 */       while (this.key[i] == 0L)
/* 1849 */         i++; 
/* 1850 */       t = HashCommon.long2int(this.key[i]);
/* 1851 */       t ^= this.value[i];
/* 1852 */       h += t;
/* 1853 */       i++;
/*      */     } 
...
/* 1877 */     long[] key = this.key = new long[this.n + 1];
...
/* 1885 */       int pos; long k = s.readLong();
/* 1886 */       char v = s.readChar();
/* 1887 */       if (k == 0L) {
/* 1888 */         pos = this.n;
/* 1889 */         this.containsNullKey = true;
/*      */       } else {
/* 1891 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1892 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2CharLinkedOpenHashMap.class
