...
/*  903 */     Short newValue = remappingFunction.apply(Long.valueOf(k), Short.valueOf(this.value[pos]));
...
/*  918 */     int pos = find(k);
/*  919 */     Short newValue = remappingFunction.apply(Long.valueOf(k), (pos >= 0) ? Short.valueOf(this.value[pos]) : null);
...
/*  996 */       return Long2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public short getShortValue() {
/* 1000 */       return Long2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public short setValue(short v) {
/* 1004 */       short oldValue = Long2ShortLinkedOpenHashMap.this.value[this.index];
/* 1005 */       Long2ShortLinkedOpenHashMap.this.value[this.index] = v;
...
/*      */     @Deprecated
/*      */     public Long getKey() {
/* 1016 */       return Long.valueOf(Long2ShortLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       return Short.valueOf(Long2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1042 */         return false; 
/* 1043 */       Map.Entry<Long, Short> e = (Map.Entry<Long, Short>)o;
/* 1044 */       return (Long2ShortLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue() && Long2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1048 */       return HashCommon.long2int(Long2ShortLinkedOpenHashMap.this.key[this.index]) ^ Long2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1052 */       return Long2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Long2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */       this.next = Long2ShortLinkedOpenHashMap.this.first;
/* 1216 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(long from) {
/* 1219 */       if (from == 0L) {
/* 1220 */         if (Long2ShortLinkedOpenHashMap.this.containsNullKey) {
/* 1221 */           this.next = (int)Long2ShortLinkedOpenHashMap.this.link[Long2ShortLinkedOpenHashMap.this.n];
/* 1222 */           this.prev = Long2ShortLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1225 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1227 */       if (Long2ShortLinkedOpenHashMap.this.key[Long2ShortLinkedOpenHashMap.this.last] == from) {
/* 1228 */         this.prev = Long2ShortLinkedOpenHashMap.this.last;
/* 1229 */         this.index = Long2ShortLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1233 */       int pos = (int)HashCommon.mix(from) & Long2ShortLinkedOpenHashMap.this.mask;
/*      */       
/* 1235 */       while (Long2ShortLinkedOpenHashMap.this.key[pos] != 0L) {
/* 1236 */         if (Long2ShortLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1238 */           this.next = (int)Long2ShortLinkedOpenHashMap.this.link[pos];
/* 1239 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1242 */         pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1259 */       if (this.next == -1) {
/* 1260 */         this.index = Long2ShortLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1263 */       int pos = Long2ShortLinkedOpenHashMap.this.first;
/* 1264 */       this.index = 1;
/* 1265 */       while (pos != this.prev) {
/* 1266 */         pos = (int)Long2ShortLinkedOpenHashMap.this.link[pos];
/* 1267 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1282 */       this.next = (int)Long2ShortLinkedOpenHashMap.this.link[this.curr];
...
/* 1292 */       this.prev = (int)(Long2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1307 */         this.index--;
/* 1308 */         this.prev = (int)(Long2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1310 */         this.next = (int)Long2ShortLinkedOpenHashMap.this.link[this.curr];
/* 1311 */       }  Long2ShortLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1316 */       if (this.prev == -1) {
/* 1317 */         Long2ShortLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1319 */         Long2ShortLinkedOpenHashMap.this.link[this.prev] = Long2ShortLinkedOpenHashMap.this.link[this.prev] ^ (Long2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1320 */       }  if (this.next == -1) {
/* 1321 */         Long2ShortLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1323 */         Long2ShortLinkedOpenHashMap.this.link[this.next] = Long2ShortLinkedOpenHashMap.this.link[this.next] ^ (Long2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1324 */       }  int pos = this.curr;
/* 1325 */       this.curr = -1;
/* 1326 */       if (pos == Long2ShortLinkedOpenHashMap.this.n) {
/* 1327 */         Long2ShortLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1330 */         long[] key = Long2ShortLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           long curr;
/*      */           int last;
/* 1334 */           pos = (last = pos) + 1 & Long2ShortLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1336 */             if ((curr = key[pos]) == 0L) {
/* 1337 */               key[last] = 0L;
/*      */               return;
/*      */             } 
/* 1340 */             int slot = (int)HashCommon.mix(curr) & Long2ShortLinkedOpenHashMap.this.mask;
/* 1341 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1343 */             pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1345 */           key[last] = curr;
/* 1346 */           Long2ShortLinkedOpenHashMap.this.value[last] = Long2ShortLinkedOpenHashMap.this.value[pos];
/* 1347 */           if (this.next == pos)
/* 1348 */             this.next = last; 
/* 1349 */           if (this.prev == pos)
/* 1350 */             this.prev = last; 
/* 1351 */           Long2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Long2ShortMap.Entry> { private Long2ShortLinkedOpenHashMap.MapEntry entry;
/*      */     
...
/* 1383 */       return this.entry = new Long2ShortLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Long2ShortLinkedOpenHashMap.MapEntry previous() {
/* 1387 */       return this.entry = new Long2ShortLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1391 */       super.remove();
...
/*      */ 
/*      */   
/* 1396 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Long2ShortMap.Entry> { final Long2ShortLinkedOpenHashMap.MapEntry entry = new Long2ShortLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Long2ShortMap.Entry> implements Long2ShortSortedMap.FastSortedEntrySet { public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator() {
/* 1416 */       return (ObjectBidirectionalIterator<Long2ShortMap.Entry>)new Long2ShortLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     private MapEntrySet() {}
...
/* 1437 */       if (Long2ShortLinkedOpenHashMap.this.size == 0)
/* 1438 */         throw new NoSuchElementException(); 
/* 1439 */       return new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Long2ShortMap.Entry last() {
/* 1443 */       if (Long2ShortLinkedOpenHashMap.this.size == 0)
/* 1444 */         throw new NoSuchElementException(); 
/* 1445 */       return new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1459 */       if (k == 0L) {
/* 1460 */         return (Long2ShortLinkedOpenHashMap.this.containsNullKey && Long2ShortLinkedOpenHashMap.this.value[Long2ShortLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1462 */       long[] key = Long2ShortLinkedOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1465 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2ShortLinkedOpenHashMap.this.mask]) == 0L)
/* 1466 */         return false; 
/* 1467 */       if (k == curr) {
/* 1468 */         return (Long2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1471 */         if ((curr = key[pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask]) == 0L)
/* 1472 */           return false; 
/* 1473 */         if (k == curr) {
/* 1474 */           return (Long2ShortLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1489 */       if (k == 0L) {
/* 1490 */         if (Long2ShortLinkedOpenHashMap.this.containsNullKey && Long2ShortLinkedOpenHashMap.this.value[Long2ShortLinkedOpenHashMap.this.n] == v) {
/* 1491 */           Long2ShortLinkedOpenHashMap.this.removeNullEntry();
/* 1492 */           return true;
/*      */         } 
/* 1494 */         return false;
/*      */       } 
/*      */       
/* 1497 */       long[] key = Long2ShortLinkedOpenHashMap.this.key;
/*      */       long curr;
/*      */       int pos;
/* 1500 */       if ((curr = key[pos = (int)HashCommon.mix(k) & Long2ShortLinkedOpenHashMap.this.mask]) == 0L)
/* 1501 */         return false; 
/* 1502 */       if (curr == k) {
/* 1503 */         if (Long2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1504 */           Long2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1505 */           return true;
/*      */         } 
/* 1507 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1510 */         if ((curr = key[pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask]) == 0L)
/* 1511 */           return false; 
/* 1512 */         if (curr == k && 
/* 1513 */           Long2ShortLinkedOpenHashMap.this.value[pos] == v) {
/* 1514 */           Long2ShortLinkedOpenHashMap.this.removeEntry(pos);
/* 1515 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1522 */       return Long2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1526 */       Long2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1541 */       return new Long2ShortLinkedOpenHashMap.EntryIterator(from.getLongKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1552 */       return new Long2ShortLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1567 */       return new Long2ShortLinkedOpenHashMap.FastEntryIterator(from.getLongKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Long2ShortMap.Entry> consumer) {
/* 1572 */       for (int i = Long2ShortLinkedOpenHashMap.this.size, next = Long2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1573 */         int curr = next;
/* 1574 */         next = (int)Long2ShortLinkedOpenHashMap.this.link[curr];
/* 1575 */         consumer.accept(new AbstractLong2ShortMap.BasicEntry(Long2ShortLinkedOpenHashMap.this.key[curr], Long2ShortLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Long2ShortMap.Entry> consumer) {
/* 1581 */       AbstractLong2ShortMap.BasicEntry entry = new AbstractLong2ShortMap.BasicEntry();
/* 1582 */       for (int i = Long2ShortLinkedOpenHashMap.this.size, next = Long2ShortLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1583 */         int curr = next;
/* 1584 */         next = (int)Long2ShortLinkedOpenHashMap.this.link[curr];
/* 1585 */         entry.key = Long2ShortLinkedOpenHashMap.this.key[curr];
/* 1586 */         entry.value = Long2ShortLinkedOpenHashMap.this.value[curr];
...
/* 1612 */       return Long2ShortLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
...
/* 1619 */       return Long2ShortLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractLongSortedSet { private KeySet() {}
/*      */     
/*      */     public LongListIterator iterator(long from) {
/* 1625 */       return new Long2ShortLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public LongListIterator iterator() {
/* 1629 */       return new Long2ShortLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(LongConsumer consumer) {
/* 1634 */       if (Long2ShortLinkedOpenHashMap.this.containsNullKey)
/* 1635 */         consumer.accept(Long2ShortLinkedOpenHashMap.this.key[Long2ShortLinkedOpenHashMap.this.n]); 
/* 1636 */       for (int pos = Long2ShortLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1637 */         long k = Long2ShortLinkedOpenHashMap.this.key[pos];
/* 1638 */         if (k != 0L)
...
/*      */     
/*      */     public int size() {
/* 1644 */       return Long2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(long k) {
/* 1648 */       return Long2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(long k) {
/* 1652 */       int oldSize = Long2ShortLinkedOpenHashMap.this.size;
/* 1653 */       Long2ShortLinkedOpenHashMap.this.remove(k);
/* 1654 */       return (Long2ShortLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1658 */       Long2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public long firstLong() {
/* 1662 */       if (Long2ShortLinkedOpenHashMap.this.size == 0)
/* 1663 */         throw new NoSuchElementException(); 
/* 1664 */       return Long2ShortLinkedOpenHashMap.this.key[Long2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public long lastLong() {
/* 1668 */       if (Long2ShortLinkedOpenHashMap.this.size == 0)
/* 1669 */         throw new NoSuchElementException(); 
/* 1670 */       return Long2ShortLinkedOpenHashMap.this.key[Long2ShortLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public LongComparator comparator() {
/* 1674 */       return null;
...
/* 1707 */       return Long2ShortLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1714 */       return Long2ShortLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1723 */             return (ShortIterator)new Long2ShortLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1727 */             return Long2ShortLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(short v) {
/* 1731 */             return Long2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1735 */             Long2ShortLinkedOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1740 */             if (Long2ShortLinkedOpenHashMap.this.containsNullKey)
/* 1741 */               consumer.accept(Long2ShortLinkedOpenHashMap.this.value[Long2ShortLinkedOpenHashMap.this.n]); 
/* 1742 */             for (int pos = Long2ShortLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1743 */               if (Long2ShortLinkedOpenHashMap.this.key[pos] != 0L)
/* 1744 */                 consumer.accept(Long2ShortLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1820 */     long[] key = this.key;
/* 1821 */     short[] value = this.value;
/* 1822 */     int mask = newN - 1;
/* 1823 */     long[] newKey = new long[newN + 1];
...
/* 1830 */       int pos; if (key[i] == 0L) {
/* 1831 */         pos = newN;
/*      */       } else {
/* 1833 */         pos = (int)HashCommon.mix(key[i]) & mask;
/* 1834 */         while (newKey[pos] != 0L)
/* 1835 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1878 */       c = (Long2ShortLinkedOpenHashMap)super.clone();
...
/* 1886 */     c.key = (long[])this.key.clone();
...
/* 1904 */       while (this.key[i] == 0L)
/* 1905 */         i++; 
/* 1906 */       t = HashCommon.long2int(this.key[i]);
/* 1907 */       t ^= this.value[i];
/* 1908 */       h += t;
/* 1909 */       i++;
/*      */     } 
...
/* 1933 */     long[] key = this.key = new long[this.n + 1];
...
/* 1941 */       int pos; long k = s.readLong();
/* 1942 */       short v = s.readShort();
/* 1943 */       if (k == 0L) {
/* 1944 */         pos = this.n;
/* 1945 */         this.containsNullKey = true;
/*      */       } else {
/* 1947 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1948 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ShortLinkedOpenHashMap.class
