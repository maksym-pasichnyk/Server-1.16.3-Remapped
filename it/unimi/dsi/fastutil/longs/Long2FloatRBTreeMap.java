...
/*  910 */         return false; 
/*  911 */       Map.Entry<Long, Float> e = (Map.Entry<Long, Float>)o;
...
/*      */     
/*      */     public int hashCode() {
/*  917 */       return HashCommon.long2int(this.key) ^ HashCommon.float2int(this.value);
/*      */     }
/*      */     
...
/*  999 */     int index = 0;
/*      */     TreeIterator() {
/* 1001 */       this.next = Long2FloatRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1004 */       if ((this.next = Long2FloatRBTreeMap.this.locateKey(k)) != null)
/* 1005 */         if (Long2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1056 */       updatePrevious();
/* 1057 */       updateNext();
/* 1058 */       Long2FloatRBTreeMap.this.remove(this.curr.key);
/* 1059 */       this.curr = null;
/*      */     }
...
/* 1098 */       this.entries = (ObjectSortedSet<Long2FloatMap.Entry>)new AbstractObjectSortedSet<Long2FloatMap.Entry>()
/*      */         {
...
/* 1107 */             return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from) {
/* 1111 */             return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatRBTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1122 */               return false; 
/* 1123 */             Long2FloatRBTreeMap.Entry f = Long2FloatRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1135 */               return false; 
/* 1136 */             Long2FloatRBTreeMap.Entry f = Long2FloatRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1137 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != 
/* 1138 */               Float.floatToIntBits(((Float)e.getValue()).floatValue()))
/* 1139 */               return false; 
/* 1140 */             Long2FloatRBTreeMap.this.remove(f.key);
/* 1141 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1145 */             return Long2FloatRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1149 */             Long2FloatRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2FloatMap.Entry first() {
/* 1153 */             return Long2FloatRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2FloatMap.Entry last() {
/* 1157 */             return Long2FloatRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) {
/* 1161 */             return Long2FloatRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry to) {
/* 1165 */             return Long2FloatRBTreeMap.this.headMap(to.getLongKey()).long2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from) {
/* 1169 */             return Long2FloatRBTreeMap.this.tailMap(from.getLongKey()).long2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1203 */       return new Long2FloatRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1207 */       return new Long2FloatRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1262 */             return (FloatIterator)new Long2FloatRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(float k) {
/* 1266 */             return Long2FloatRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1270 */             return Long2FloatRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1274 */             Long2FloatRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1289 */     return new Submap(from, false, 0L, true);
/*      */   }
/*      */   
...
/* 1337 */       if (!bottom && !top && Long2FloatRBTreeMap.this.compare(from, to) > 0)
/* 1338 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1339 */       this.from = from;
/* 1340 */       this.bottom = bottom;
/* 1341 */       this.to = to;
/* 1342 */       this.top = top;
/* 1343 */       this.defRetValue = Long2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1361 */       return ((this.bottom || Long2FloatRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2FloatRBTreeMap.this
/* 1362 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
/* 1366 */       if (this.entries == null)
/* 1367 */         this.entries = (ObjectSortedSet<Long2FloatMap.Entry>)new AbstractObjectSortedSet<Long2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator() {
/* 1370 */               return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from) {
/* 1374 */               return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatRBTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2FloatMap.Entry> comparator() {
/* 1378 */               return Long2FloatRBTreeMap.this.long2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1386 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1387 */                 return false; 
/* 1388 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1389 */                 return false; 
/* 1390 */               Long2FloatRBTreeMap.Entry f = Long2FloatRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1391 */               return (f != null && Long2FloatRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1399 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1400 */                 return false; 
/* 1401 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1402 */                 return false; 
/* 1403 */               Long2FloatRBTreeMap.Entry f = Long2FloatRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1404 */               if (f != null && Long2FloatRBTreeMap.Submap.this.in(f.key))
/* 1405 */                 Long2FloatRBTreeMap.Submap.this.remove(f.key); 
/* 1406 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1410 */               int c = 0;
/* 1411 */               for (ObjectBidirectionalIterator<Long2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1412 */                 c++; 
/* 1413 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1417 */               return !(new Long2FloatRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1421 */               Long2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2FloatMap.Entry first() {
/* 1425 */               return Long2FloatRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2FloatMap.Entry last() {
/* 1429 */               return Long2FloatRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) {
/* 1434 */               return Long2FloatRBTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry to) {
/* 1438 */               return Long2FloatRBTreeMap.Submap.this.headMap(to.getLongKey()).long2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from) {
/* 1442 */               return Long2FloatRBTreeMap.Submap.this.tailMap(from.getLongKey()).long2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2FloatSortedMap.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1450 */         return new Long2FloatRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1454 */         return new Long2FloatRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1469 */               return (FloatIterator)new Long2FloatRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(float k) {
/* 1473 */               return Long2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1477 */               return Long2FloatRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1481 */               Long2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1489 */       return (in(k) && Long2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(long k) {
/* 1506 */       long kk = k; Long2FloatRBTreeMap.Entry e;
/* 1507 */       return (in(kk) && (e = Long2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public float put(long k, float v) {
/* 1511 */       Long2FloatRBTreeMap.this.modified = false;
/* 1512 */       if (!in(k))
...
/* 1515 */       float oldValue = Long2FloatRBTreeMap.this.put(k, v);
/* 1516 */       return Long2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float remove(long k) {
/* 1521 */       Long2FloatRBTreeMap.this.modified = false;
/* 1522 */       if (!in(k))
/* 1523 */         return this.defRetValue; 
/* 1524 */       float oldValue = Long2FloatRBTreeMap.this.remove(k);
/* 1525 */       return Long2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1543 */       return Long2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2FloatSortedMap headMap(long to) {
/* 1547 */       if (this.top)
/* 1548 */         return new Submap(this.from, this.bottom, to, false); 
/* 1549 */       return (Long2FloatRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2FloatSortedMap tailMap(long from) {
/* 1553 */       if (this.bottom)
/* 1554 */         return new Submap(from, false, this.to, this.top); 
/* 1555 */       return (Long2FloatRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2FloatSortedMap subMap(long from, long to) {
...
/* 1561 */       if (!this.top)
/* 1562 */         to = (Long2FloatRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1563 */       if (!this.bottom)
/* 1564 */         from = (Long2FloatRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1576 */       if (Long2FloatRBTreeMap.this.tree == null) {
/* 1577 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1581 */       if (this.bottom) {
/* 1582 */         e = Long2FloatRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1584 */         e = Long2FloatRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1586 */         if (Long2FloatRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1587 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1591 */       if (e == null || (!this.top && Long2FloatRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1592 */         return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2FloatRBTreeMap.Entry e;
/* 1602 */       if (Long2FloatRBTreeMap.this.tree == null) {
/* 1603 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1607 */       if (this.top) {
/* 1608 */         e = Long2FloatRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1610 */         e = Long2FloatRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1612 */         if (Long2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1613 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1617 */       if (e == null || (!this.bottom && Long2FloatRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1618 */         return null; 
/* 1619 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1623 */       Long2FloatRBTreeMap.Entry e = firstEntry();
/* 1624 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1630 */       Long2FloatRBTreeMap.Entry e = lastEntry();
/* 1631 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1646 */         this.next = Long2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1649 */         this();
/* 1650 */         if (this.next != null)
/* 1651 */           if (!Long2FloatRBTreeMap.Submap.this.bottom && Long2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1652 */             this.prev = null;
/* 1653 */           } else if (!Long2FloatRBTreeMap.Submap.this.top && Long2FloatRBTreeMap.this.compare(k, (this.prev = Long2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1654 */             this.next = null;
/*      */           } else {
/* 1656 */             this.next = Long2FloatRBTreeMap.this.locateKey(k);
/* 1657 */             if (Long2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1668 */         if (!Long2FloatRBTreeMap.Submap.this.bottom && this.prev != null && Long2FloatRBTreeMap.this.compare(this.prev.key, Long2FloatRBTreeMap.Submap.this.from) < 0)
/* 1669 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1673 */         this.next = this.next.next();
/* 1674 */         if (!Long2FloatRBTreeMap.Submap.this.top && this.next != null && Long2FloatRBTreeMap.this.compare(this.next.key, Long2FloatRBTreeMap.Submap.this.to) >= 0)
/* 1675 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1755 */       c = (Long2FloatRBTreeMap)super.clone();
...
/* 1836 */     if (n == 1) {
/* 1837 */       Entry entry = new Entry(s.readLong(), s.readFloat());
...
/*      */ 
/*      */       
/* 1848 */       Entry entry = new Entry(s.readLong(), s.readFloat());
/* 1849 */       entry.black(true);
/* 1850 */       entry.right(new Entry(s.readLong(), s.readFloat()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatRBTreeMap.class
