...
/*  62 */     this.array = new long[Math.max(1, capacity)];
...
/*  85 */     long t = this.array[this.start];
...
/* 109 */     long[] newArray = new long[newLength];
...
/*     */   public void trim() {
/* 171 */     int size = size();
/* 172 */     long[] newArray = new long[size + 1];
...
/* 202 */     this.array = new long[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
/* 203 */     for (int i = 0; i < this.end; i++)
/* 204 */       this.array[i] = s.readLong(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\LongArrayFIFOQueue.class
