...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Long2CharFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Long2CharFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 161 */     return new Singleton(key.longValue(), value.charValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Long2CharFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractLong2CharFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2CharFunction function;
/*     */     
...
/* 462 */       Character v = this.function.apply(Long.valueOf(key));
/* 463 */       if (v == null)
...
/* 505 */     if (f instanceof Long2CharFunction)
/* 506 */       return (Long2CharFunction)f; 
/* 507 */     if (f instanceof LongToIntFunction) {
/* 508 */       return key -> SafeMath.safeIntToChar(((LongToIntFunction)f).applyAsInt(key));
/*     */     }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2CharFunctions.class
