...
/*  50 */     return (entries instanceof Long2CharMap.FastEntrySet) ? (
/*  51 */       (Long2CharMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Long2CharMap.Entry> entries = map.long2CharEntrySet();
/*  71 */     if (entries instanceof Long2CharMap.FastEntrySet) {
/*  72 */       ((Long2CharMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Long2CharMap.Entry> entries = map.long2CharEntrySet();
/*  91 */     return (entries instanceof Long2CharMap.FastEntrySet) ? new ObjectIterable<Long2CharMap.Entry>() {
/*     */         public ObjectIterator<Long2CharMap.Entry> iterator() {
/*  93 */           return ((Long2CharMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Long2CharMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Long2CharMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractLong2CharMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)long2CharEntrySet();
/*     */     }
/*     */     
/*     */     public LongSet keySet() {
...
/* 300 */     return new Singleton(key.longValue(), value.charValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.long2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Character>> entrySet() {
/* 361 */       return (ObjectSet)long2CharEntrySet();
/*     */     }
/*     */     
/*     */     public LongSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.long2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Character>> entrySet() {
/* 674 */       return (ObjectSet)long2CharEntrySet();
/*     */     }
/*     */     
/*     */     public LongSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2CharMaps.class
