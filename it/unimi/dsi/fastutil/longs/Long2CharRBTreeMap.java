...
/*  910 */         return false; 
/*  911 */       Map.Entry<Long, Character> e = (Map.Entry<Long, Character>)o;
/*  912 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  998 */     int index = 0;
/*      */     TreeIterator() {
/* 1000 */       this.next = Long2CharRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1003 */       if ((this.next = Long2CharRBTreeMap.this.locateKey(k)) != null)
/* 1004 */         if (Long2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1055 */       updatePrevious();
/* 1056 */       updateNext();
/* 1057 */       Long2CharRBTreeMap.this.remove(this.curr.key);
/* 1058 */       this.curr = null;
/*      */     }
...
/* 1097 */       this.entries = (ObjectSortedSet<Long2CharMap.Entry>)new AbstractObjectSortedSet<Long2CharMap.Entry>()
/*      */         {
...
/* 1106 */             return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from) {
/* 1110 */             return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharRBTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1121 */               return false; 
/* 1122 */             Long2CharRBTreeMap.Entry f = Long2CharRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1134 */               return false; 
/* 1135 */             Long2CharRBTreeMap.Entry f = Long2CharRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1136 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1137 */               return false; 
/* 1138 */             Long2CharRBTreeMap.this.remove(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Long2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Long2CharRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2CharMap.Entry first() {
/* 1151 */             return Long2CharRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2CharMap.Entry last() {
/* 1155 */             return Long2CharRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry to) {
/* 1159 */             return Long2CharRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry to) {
/* 1163 */             return Long2CharRBTreeMap.this.headMap(to.getLongKey()).long2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from) {
/* 1167 */             return Long2CharRBTreeMap.this.tailMap(from.getLongKey()).long2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1201 */       return new Long2CharRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1205 */       return new Long2CharRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1260 */             return (CharIterator)new Long2CharRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1264 */             return Long2CharRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Long2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1272 */             Long2CharRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1335 */       if (!bottom && !top && Long2CharRBTreeMap.this.compare(from, to) > 0)
/* 1336 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1337 */       this.from = from;
/* 1338 */       this.bottom = bottom;
/* 1339 */       this.to = to;
/* 1340 */       this.top = top;
/* 1341 */       this.defRetValue = Long2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1359 */       return ((this.bottom || Long2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2CharRBTreeMap.this
/* 1360 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
/* 1364 */       if (this.entries == null)
/* 1365 */         this.entries = (ObjectSortedSet<Long2CharMap.Entry>)new AbstractObjectSortedSet<Long2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator() {
/* 1368 */               return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from) {
/* 1372 */               return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharRBTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2CharMap.Entry> comparator() {
/* 1376 */               return Long2CharRBTreeMap.this.long2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Long2CharRBTreeMap.Entry f = Long2CharRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1389 */               return (f != null && Long2CharRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1400 */                 return false; 
/* 1401 */               Long2CharRBTreeMap.Entry f = Long2CharRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1402 */               if (f != null && Long2CharRBTreeMap.Submap.this.in(f.key))
/* 1403 */                 Long2CharRBTreeMap.Submap.this.remove(f.key); 
/* 1404 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1408 */               int c = 0;
/* 1409 */               for (ObjectBidirectionalIterator<Long2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1410 */                 c++; 
/* 1411 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1415 */               return !(new Long2CharRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1419 */               Long2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2CharMap.Entry first() {
/* 1423 */               return Long2CharRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2CharMap.Entry last() {
/* 1427 */               return Long2CharRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry to) {
/* 1431 */               return Long2CharRBTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry to) {
/* 1435 */               return Long2CharRBTreeMap.Submap.this.headMap(to.getLongKey()).long2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from) {
/* 1439 */               return Long2CharRBTreeMap.Submap.this.tailMap(from.getLongKey()).long2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2CharSortedMap.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1447 */         return new Long2CharRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1451 */         return new Long2CharRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/*      */           {
/*      */             public CharIterator iterator() {
/* 1466 */               return (CharIterator)new Long2CharRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1470 */               return Long2CharRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1474 */               return Long2CharRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1478 */               Long2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1486 */       return (in(k) && Long2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(long k) {
/* 1503 */       long kk = k; Long2CharRBTreeMap.Entry e;
/* 1504 */       return (in(kk) && (e = Long2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(long k, char v) {
/* 1508 */       Long2CharRBTreeMap.this.modified = false;
/* 1509 */       if (!in(k))
...
/* 1512 */       char oldValue = Long2CharRBTreeMap.this.put(k, v);
/* 1513 */       return Long2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(long k) {
/* 1518 */       Long2CharRBTreeMap.this.modified = false;
/* 1519 */       if (!in(k))
/* 1520 */         return this.defRetValue; 
/* 1521 */       char oldValue = Long2CharRBTreeMap.this.remove(k);
/* 1522 */       return Long2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1540 */       return Long2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2CharSortedMap headMap(long to) {
/* 1544 */       if (this.top)
/* 1545 */         return new Submap(this.from, this.bottom, to, false); 
/* 1546 */       return (Long2CharRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2CharSortedMap tailMap(long from) {
/* 1550 */       if (this.bottom)
/* 1551 */         return new Submap(from, false, this.to, this.top); 
/* 1552 */       return (Long2CharRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2CharSortedMap subMap(long from, long to) {
...
/* 1558 */       if (!this.top)
/* 1559 */         to = (Long2CharRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1560 */       if (!this.bottom)
/* 1561 */         from = (Long2CharRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1573 */       if (Long2CharRBTreeMap.this.tree == null) {
/* 1574 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1578 */       if (this.bottom) {
/* 1579 */         e = Long2CharRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1581 */         e = Long2CharRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1583 */         if (Long2CharRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1584 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1588 */       if (e == null || (!this.top && Long2CharRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1589 */         return null; 
/* 1590 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2CharRBTreeMap.Entry e;
/* 1599 */       if (Long2CharRBTreeMap.this.tree == null) {
/* 1600 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1604 */       if (this.top) {
/* 1605 */         e = Long2CharRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1607 */         e = Long2CharRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1609 */         if (Long2CharRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1610 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Long2CharRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1615 */         return null; 
/* 1616 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1620 */       Long2CharRBTreeMap.Entry e = firstEntry();
/* 1621 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1627 */       Long2CharRBTreeMap.Entry e = lastEntry();
/* 1628 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Long2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1646 */         this();
/* 1647 */         if (this.next != null)
/* 1648 */           if (!Long2CharRBTreeMap.Submap.this.bottom && Long2CharRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1649 */             this.prev = null;
/* 1650 */           } else if (!Long2CharRBTreeMap.Submap.this.top && Long2CharRBTreeMap.this.compare(k, (this.prev = Long2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1651 */             this.next = null;
/*      */           } else {
/* 1653 */             this.next = Long2CharRBTreeMap.this.locateKey(k);
/* 1654 */             if (Long2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1665 */         if (!Long2CharRBTreeMap.Submap.this.bottom && this.prev != null && Long2CharRBTreeMap.this.compare(this.prev.key, Long2CharRBTreeMap.Submap.this.from) < 0)
/* 1666 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1670 */         this.next = this.next.next();
/* 1671 */         if (!Long2CharRBTreeMap.Submap.this.top && this.next != null && Long2CharRBTreeMap.this.compare(this.next.key, Long2CharRBTreeMap.Submap.this.to) >= 0)
/* 1672 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1752 */       c = (Long2CharRBTreeMap)super.clone();
...
/* 1833 */     if (n == 1) {
/* 1834 */       Entry entry = new Entry(s.readLong(), s.readChar());
...
/*      */ 
/*      */       
/* 1845 */       Entry entry = new Entry(s.readLong(), s.readChar());
/* 1846 */       entry.black(true);
/* 1847 */       entry.right(new Entry(s.readLong(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2CharRBTreeMap.class
