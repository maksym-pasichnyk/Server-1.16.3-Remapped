...
/*  954 */         return false; 
/*  955 */       Map.Entry<Long, Character> e = (Map.Entry<Long, Character>)o;
/*  956 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Long2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1047 */       if ((this.next = Long2CharAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Long2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Long2CharAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Long2CharMap.Entry>)new AbstractObjectSortedSet<Long2CharMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Long2CharAVLTreeMap.Entry f = Long2CharAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1186 */               return false; 
/* 1187 */             Long2CharAVLTreeMap.Entry f = Long2CharAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1188 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1189 */               return false; 
/* 1190 */             Long2CharAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Long2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Long2CharAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2CharMap.Entry first() {
/* 1203 */             return Long2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2CharMap.Entry last() {
/* 1207 */             return Long2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry to) {
/* 1211 */             return Long2CharAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry to) {
/* 1215 */             return Long2CharAVLTreeMap.this.headMap(to.getLongKey()).long2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from) {
/* 1219 */             return Long2CharAVLTreeMap.this.tailMap(from.getLongKey()).long2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Long2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1257 */       return new Long2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (CharIterator)new Long2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1316 */             return Long2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Long2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Long2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Long2CharAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Long2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Long2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2CharAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Long2CharMap.Entry>)new AbstractObjectSortedSet<Long2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Long2CharMap.Entry>)new Long2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2CharMap.Entry> comparator() {
/* 1428 */               return Long2CharAVLTreeMap.this.long2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Long2CharAVLTreeMap.Entry f = Long2CharAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1441 */               return (f != null && Long2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Long2CharAVLTreeMap.Entry f = Long2CharAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1454 */               if (f != null && Long2CharAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Long2CharAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Long2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Long2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Long2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2CharMap.Entry first() {
/* 1475 */               return Long2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2CharMap.Entry last() {
/* 1479 */               return Long2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry to) {
/* 1483 */               return Long2CharAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry to) {
/* 1487 */               return Long2CharAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from) {
/* 1491 */               return Long2CharAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2CharSortedMap.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1499 */         return new Long2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1503 */         return new Long2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/*      */           {
/*      */             public CharIterator iterator() {
/* 1518 */               return (CharIterator)new Long2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1522 */               return Long2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Long2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Long2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1538 */       return (in(k) && Long2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(long k) {
/* 1555 */       long kk = k; Long2CharAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Long2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(long k, char v) {
/* 1560 */       Long2CharAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       char oldValue = Long2CharAVLTreeMap.this.put(k, v);
/* 1565 */       return Long2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(long k) {
/* 1570 */       Long2CharAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       char oldValue = Long2CharAVLTreeMap.this.remove(k);
/* 1574 */       return Long2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1592 */       return Long2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2CharSortedMap headMap(long to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Long2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2CharSortedMap tailMap(long from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Long2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2CharSortedMap subMap(long from, long to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Long2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Long2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Long2CharAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Long2CharAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Long2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Long2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Long2CharAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2CharAVLTreeMap.Entry e;
/* 1651 */       if (Long2CharAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Long2CharAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Long2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Long2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Long2CharAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1672 */       Long2CharAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1679 */       Long2CharAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Long2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Long2CharAVLTreeMap.Submap.this.bottom && Long2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Long2CharAVLTreeMap.Submap.this.top && Long2CharAVLTreeMap.this.compare(k, (this.prev = Long2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Long2CharAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Long2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Long2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Long2CharAVLTreeMap.this.compare(this.prev.key, Long2CharAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Long2CharAVLTreeMap.Submap.this.top && this.next != null && Long2CharAVLTreeMap.this.compare(this.next.key, Long2CharAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1804 */       c = (Long2CharAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readLong(), s.readChar());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readLong(), s.readChar());
/* 1897 */       entry.right(new Entry(s.readLong(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2CharAVLTreeMap.class
