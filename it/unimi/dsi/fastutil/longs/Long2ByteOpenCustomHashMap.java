...
/* 1173 */     byte[] value = this.value;
/* 1174 */     int mask = newN - 1;
/* 1175 */     long[] newKey = new long[newN + 1];
/* 1176 */     byte[] newValue = new byte[newN + 1];
/* 1177 */     int i = this.n;
...
/*      */     try {
/* 1207 */       c = (Long2ByteOpenCustomHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ByteOpenCustomHashMap.class
