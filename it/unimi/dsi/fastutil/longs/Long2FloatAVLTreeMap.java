...
/*  954 */         return false; 
/*  955 */       Map.Entry<Long, Float> e = (Map.Entry<Long, Float>)o;
...
/*      */     
/*      */     public int hashCode() {
/*  961 */       return HashCommon.long2int(this.key) ^ HashCommon.float2int(this.value);
/*      */     }
/*      */     
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Long2FloatAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1048 */       if ((this.next = Long2FloatAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Long2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Long2FloatAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Long2FloatMap.Entry>)new AbstractObjectSortedSet<Long2FloatMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1174 */               return false; 
/* 1175 */             Long2FloatAVLTreeMap.Entry f = Long2FloatAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1187 */               return false; 
/* 1188 */             Long2FloatAVLTreeMap.Entry f = Long2FloatAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1189 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != 
/* 1190 */               Float.floatToIntBits(((Float)e.getValue()).floatValue()))
/* 1191 */               return false; 
/* 1192 */             Long2FloatAVLTreeMap.this.remove(f.key);
/* 1193 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1197 */             return Long2FloatAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1201 */             Long2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2FloatMap.Entry first() {
/* 1205 */             return Long2FloatAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2FloatMap.Entry last() {
/* 1209 */             return Long2FloatAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) {
/* 1213 */             return Long2FloatAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry to) {
/* 1217 */             return Long2FloatAVLTreeMap.this.headMap(to.getLongKey()).long2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from) {
/* 1221 */             return Long2FloatAVLTreeMap.this.tailMap(from.getLongKey()).long2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1255 */       return new Long2FloatAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1259 */       return new Long2FloatAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1314 */             return (FloatIterator)new Long2FloatAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(float k) {
/* 1318 */             return Long2FloatAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1322 */             return Long2FloatAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1326 */             Long2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1337 */     return new Submap(0L, true, to, false);
/*      */   }
/*      */   
/*      */   public Long2FloatSortedMap tailMap(long from) {
/* 1341 */     return new Submap(from, false, 0L, true);
/*      */   }
/*      */   
...
/* 1389 */       if (!bottom && !top && Long2FloatAVLTreeMap.this.compare(from, to) > 0)
/* 1390 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1391 */       this.from = from;
/* 1392 */       this.bottom = bottom;
/* 1393 */       this.to = to;
/* 1394 */       this.top = top;
/* 1395 */       this.defRetValue = Long2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1413 */       return ((this.bottom || Long2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2FloatAVLTreeMap.this
/* 1414 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
/* 1418 */       if (this.entries == null)
/* 1419 */         this.entries = (ObjectSortedSet<Long2FloatMap.Entry>)new AbstractObjectSortedSet<Long2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator() {
/* 1422 */               return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from) {
/* 1426 */               return (ObjectBidirectionalIterator<Long2FloatMap.Entry>)new Long2FloatAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2FloatMap.Entry> comparator() {
/* 1430 */               return Long2FloatAVLTreeMap.this.long2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1438 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1439 */                 return false; 
/* 1440 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1441 */                 return false; 
/* 1442 */               Long2FloatAVLTreeMap.Entry f = Long2FloatAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1443 */               return (f != null && Long2FloatAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1451 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1452 */                 return false; 
/* 1453 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1454 */                 return false; 
/* 1455 */               Long2FloatAVLTreeMap.Entry f = Long2FloatAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1456 */               if (f != null && Long2FloatAVLTreeMap.Submap.this.in(f.key))
/* 1457 */                 Long2FloatAVLTreeMap.Submap.this.remove(f.key); 
/* 1458 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1462 */               int c = 0;
/* 1463 */               for (ObjectBidirectionalIterator<Long2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1464 */                 c++; 
/* 1465 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1469 */               return !(new Long2FloatAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1473 */               Long2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2FloatMap.Entry first() {
/* 1477 */               return Long2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2FloatMap.Entry last() {
/* 1481 */               return Long2FloatAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) {
/* 1486 */               return Long2FloatAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry to) {
/* 1490 */               return Long2FloatAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from) {
/* 1494 */               return Long2FloatAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2FloatSortedMap.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1502 */         return new Long2FloatAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1506 */         return new Long2FloatAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1521 */               return (FloatIterator)new Long2FloatAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(float k) {
/* 1525 */               return Long2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1529 */               return Long2FloatAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1533 */               Long2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1541 */       return (in(k) && Long2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(long k) {
/* 1558 */       long kk = k; Long2FloatAVLTreeMap.Entry e;
/* 1559 */       return (in(kk) && (e = Long2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public float put(long k, float v) {
/* 1563 */       Long2FloatAVLTreeMap.this.modified = false;
/* 1564 */       if (!in(k))
...
/* 1567 */       float oldValue = Long2FloatAVLTreeMap.this.put(k, v);
/* 1568 */       return Long2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float remove(long k) {
/* 1573 */       Long2FloatAVLTreeMap.this.modified = false;
/* 1574 */       if (!in(k))
/* 1575 */         return this.defRetValue; 
/* 1576 */       float oldValue = Long2FloatAVLTreeMap.this.remove(k);
/* 1577 */       return Long2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1595 */       return Long2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2FloatSortedMap headMap(long to) {
/* 1599 */       if (this.top)
/* 1600 */         return new Submap(this.from, this.bottom, to, false); 
/* 1601 */       return (Long2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2FloatSortedMap tailMap(long from) {
/* 1605 */       if (this.bottom)
/* 1606 */         return new Submap(from, false, this.to, this.top); 
/* 1607 */       return (Long2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2FloatSortedMap subMap(long from, long to) {
...
/* 1613 */       if (!this.top)
/* 1614 */         to = (Long2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1615 */       if (!this.bottom)
/* 1616 */         from = (Long2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1628 */       if (Long2FloatAVLTreeMap.this.tree == null) {
/* 1629 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1633 */       if (this.bottom) {
/* 1634 */         e = Long2FloatAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1636 */         e = Long2FloatAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1638 */         if (Long2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1639 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1643 */       if (e == null || (!this.top && Long2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1644 */         return null; 
/* 1645 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2FloatAVLTreeMap.Entry e;
/* 1654 */       if (Long2FloatAVLTreeMap.this.tree == null) {
/* 1655 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1659 */       if (this.top) {
/* 1660 */         e = Long2FloatAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1662 */         e = Long2FloatAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1664 */         if (Long2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1665 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1669 */       if (e == null || (!this.bottom && Long2FloatAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1670 */         return null; 
/* 1671 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1675 */       Long2FloatAVLTreeMap.Entry e = firstEntry();
/* 1676 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1682 */       Long2FloatAVLTreeMap.Entry e = lastEntry();
/* 1683 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1698 */         this.next = Long2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1701 */         this();
/* 1702 */         if (this.next != null)
/* 1703 */           if (!Long2FloatAVLTreeMap.Submap.this.bottom && Long2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1704 */             this.prev = null;
/* 1705 */           } else if (!Long2FloatAVLTreeMap.Submap.this.top && Long2FloatAVLTreeMap.this.compare(k, (this.prev = Long2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1706 */             this.next = null;
/*      */           } else {
/* 1708 */             this.next = Long2FloatAVLTreeMap.this.locateKey(k);
/* 1709 */             if (Long2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1720 */         if (!Long2FloatAVLTreeMap.Submap.this.bottom && this.prev != null && Long2FloatAVLTreeMap.this.compare(this.prev.key, Long2FloatAVLTreeMap.Submap.this.from) < 0)
/* 1721 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1725 */         this.next = this.next.next();
/* 1726 */         if (!Long2FloatAVLTreeMap.Submap.this.top && this.next != null && Long2FloatAVLTreeMap.this.compare(this.next.key, Long2FloatAVLTreeMap.Submap.this.to) >= 0)
/* 1727 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1807 */       c = (Long2FloatAVLTreeMap)super.clone();
...
/* 1888 */     if (n == 1) {
/* 1889 */       Entry entry = new Entry(s.readLong(), s.readFloat());
...
/*      */ 
/*      */       
/* 1899 */       Entry entry = new Entry(s.readLong(), s.readFloat());
/* 1900 */       entry.right(new Entry(s.readLong(), s.readFloat()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2FloatAVLTreeMap.class
