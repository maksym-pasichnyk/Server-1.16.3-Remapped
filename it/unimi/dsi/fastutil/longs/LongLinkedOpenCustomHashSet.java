...
/*      */   
/*      */   public boolean trim() {
/* 1079 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1111 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1112 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1113 */       return true; 
/*      */     try {
/* 1115 */       rehash(l);
...
/* 1135 */     long[] key = this.key;
/* 1136 */     int mask = newN - 1;
/* 1137 */     long[] newKey = new long[newN + 1];
/* 1138 */     int i = this.first, prev = -1, newPrev = -1;
/* 1139 */     long[] link = this.link;
/* 1140 */     long[] newLink = new long[newN + 1];
/* 1141 */     this.first = -1;
/* 1142 */     for (int j = this.size; j-- != 0; ) {
/* 1143 */       int pos; if (this.strategy.equals(key[i], 0L)) {
/* 1144 */         pos = newN;
/*      */       } else {
/* 1146 */         pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask;
/* 1147 */         while (newKey[pos] != 0L)
/* 1148 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1150 */       newKey[pos] = key[i];
/* 1151 */       if (prev != -1) {
/* 1152 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1153 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1154 */         newPrev = pos;
/*      */       } else {
/* 1156 */         newPrev = this.first = pos;
/*      */         
/* 1158 */         newLink[pos] = -1L;
/*      */       } 
/* 1160 */       int t = i;
...
/* 1162 */       prev = t;
/*      */     } 
/* 1164 */     this.link = newLink;
/* 1165 */     this.last = newPrev;
/* 1166 */     if (newPrev != -1)
/*      */     {
/* 1168 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1169 */     this.n = newN;
/* 1170 */     this.mask = mask;
/* 1171 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1172 */     this.key = newKey;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1189 */       c = (LongLinkedOpenCustomHashSet)super.clone();
/* 1190 */     } catch (CloneNotSupportedException cantHappen) {
/* 1191 */       throw new InternalError();
/*      */     } 
/* 1193 */     c.key = (long[])this.key.clone();
/* 1194 */     c.containsNull = this.containsNull;
/* 1195 */     c.link = (long[])this.link.clone();
/* 1196 */     c.strategy = this.strategy;
/* 1197 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1210 */     int h = 0;
/* 1211 */     for (int j = realSize(), i = 0; j-- != 0; ) {
/* 1212 */       while (this.key[i] == 0L)
/* 1213 */         i++; 
/* 1214 */       h += this.strategy.hashCode(this.key[i]);
/* 1215 */       i++;
/*      */     } 
/*      */     
/* 1218 */     return h;
...
/* 1221 */     LongIterator i = iterator();
/* 1222 */     s.defaultWriteObject();
/* 1223 */     for (int j = this.size; j-- != 0;)
/* 1224 */       s.writeLong(i.nextLong()); 
/*      */   }
/*      */   
...
/* 1232 */     long[] key = this.key = new long[this.n + 1];
/* 1233 */     long[] link = this.link = new long[this.n + 1];
/* 1234 */     int prev = -1;
/* 1235 */     this.first = this.last = -1;
/*      */     
/* 1237 */     for (int i = this.size; i-- != 0; ) {
/* 1238 */       int pos; long k = s.readLong();
/* 1239 */       if (this.strategy.equals(k, 0L)) {
/* 1240 */         pos = this.n;
/* 1241 */         this.containsNull = true;
/*      */       }
/* 1243 */       else if (key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask] != 0L) {
/* 1244 */         while (key[pos = pos + 1 & this.mask] != 0L);
/*      */       } 
/* 1246 */       key[pos] = k;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\LongLinkedOpenCustomHashSet.class
