...
/* 1075 */     long[] key = this.key;
/* 1076 */     int mask = newN - 1;
/* 1077 */     long[] newKey = new long[newN + 1];
...
/* 1083 */       int pos; if (key[i] == 0L) {
/* 1084 */         pos = newN;
/*      */       } else {
/* 1086 */         pos = (int)HashCommon.mix(key[i]) & mask;
/* 1087 */         while (newKey[pos] != 0L)
/* 1088 */           pos = pos + 1 & mask; 
/*      */       } 
...
/* 1151 */       while (this.key[i] == 0L)
/* 1152 */         i++; 
/* 1153 */       h += HashCommon.long2int(this.key[i]);
/* 1154 */       i++;
/*      */     } 
/*      */     
/* 1157 */     return h;
...
/* 1160 */     LongIterator i = iterator();
/* 1161 */     s.defaultWriteObject();
/* 1162 */     for (int j = this.size; j-- != 0;)
/* 1163 */       s.writeLong(i.nextLong()); 
/*      */   }
/*      */   
...
/* 1171 */     long[] key = this.key = new long[this.n + 1];
/* 1172 */     long[] link = this.link = new long[this.n + 1];
/* 1173 */     int prev = -1;
/* 1174 */     this.first = this.last = -1;
/*      */     
/* 1176 */     for (int i = this.size; i-- != 0; ) {
/* 1177 */       int pos; long k = s.readLong();
/* 1178 */       if (k == 0L) {
/* 1179 */         pos = this.n;
/* 1180 */         this.containsNull = true;
/*      */       }
/* 1182 */       else if (key[pos = (int)HashCommon.mix(k) & this.mask] != 0L) {
/* 1183 */         while (key[pos = pos + 1 & this.mask] != 0L);
/*      */       } 
/* 1185 */       key[pos] = k;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\LongLinkedOpenHashSet.class
