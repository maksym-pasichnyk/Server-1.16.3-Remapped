...
/*      */   
/*      */   public boolean trim() {
/* 1116 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1149 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1150 */       return true; 
/*      */     try {
/* 1152 */       rehash(l);
...
/* 1172 */     long[] key = this.key;
/* 1173 */     int[] value = this.value;
/* 1174 */     int mask = newN - 1;
/* 1175 */     long[] newKey = new long[newN + 1];
/* 1176 */     int[] newValue = new int[newN + 1];
/* 1177 */     int i = this.n;
/* 1178 */     for (int j = realSize(); j-- != 0; ) {
/* 1179 */       while (key[--i] == 0L); int pos;
/* 1180 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0L)
/* 1181 */         while (newKey[pos = pos + 1 & mask] != 0L); 
...
/*      */     try {
/* 1207 */       c = (Long2IntOpenCustomHashMap)super.clone();
...
/* 1215 */     c.key = (long[])this.key.clone();
/* 1216 */     c.value = (int[])this.value.clone();
...
/* 1262 */     long[] key = this.key = new long[this.n + 1];
/* 1263 */     int[] value = this.value = new int[this.n + 1];
/*      */ 
/*      */     
/* 1266 */     for (int i = this.size; i-- != 0; ) {
/* 1267 */       int pos; long k = s.readLong();
/* 1268 */       int v = s.readInt();
/* 1269 */       if (this.strategy.equals(k, 0L)) {
/* 1270 */         pos = this.n;
/* 1271 */         this.containsNullKey = true;
/*      */       } else {
/* 1273 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1274 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2IntOpenCustomHashMap.class
