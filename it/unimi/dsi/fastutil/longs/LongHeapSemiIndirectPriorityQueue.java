...
/*  91 */     this(refArray, refArray.length, (LongComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 192 */     LongSemiIndirectHeaps.upHeap(this.refArray, this.heap, this.size, this.size - 1, this.c);
/*     */   }
/*     */   
/*     */   public int dequeue() {
/* 196 */     if (this.size == 0)
...
/* 200 */     if (this.size != 0)
/* 201 */       LongSemiIndirectHeaps.downHeap(this.refArray, this.heap, this.size, 0, this.c); 
/* 202 */     return result;
/*     */   }
/*     */   
/*     */   public int first() {
...
/*     */   
/*     */   public void changed() {
/* 221 */     LongSemiIndirectHeaps.downHeap(this.refArray, this.heap, this.size, 0, this.c);
/*     */   }
/*     */ 
/*     */   
/*     */   public void allChanged() {
/* 226 */     LongSemiIndirectHeaps.makeHeap(this.refArray, this.heap, this.size, this.c);
/*     */   }
/*     */   
/*     */   public int size() {
...
/* 256 */       LongSemiIndirectHeaps.front(this.refArray, this.heap, this.size, a) : 
/* 257 */       LongSemiIndirectHeaps.front(this.refArray, this.heap, this.size, a, this.c);
/*     */   }
/*     */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\LongHeapSemiIndirectPriorityQueue.class
