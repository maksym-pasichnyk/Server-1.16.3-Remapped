...
/*  61 */     return (entries instanceof Long2ByteSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Long2ByteSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Long2ByteMap.Entry> entries = map.long2ByteEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Long2ByteSortedMap.FastSortedEntrySet)entries); return (entries instanceof Long2ByteSortedMap.FastSortedEntrySet) ? (Long2ByteSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Long2ByteMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Long2ByteMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Long, Byte>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ByteSortedMap headMap(long to) {
/* 132 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ByteSortedMap tailMap(long from) {
/* 137 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Long2ByteMap.Entry>)ObjectSortedSets.singleton(new AbstractLong2ByteMap.BasicEntry(this.key, this.value), 
/* 237 */             Long2ByteSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Long2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Byte>> entrySet() {
/* 249 */       return (ObjectSortedSet)long2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ByteSortedMap headMap(long to) {
...
/* 268 */         return this; 
/* 269 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Long2ByteSortedMap tailMap(long from) {
...
/* 275 */         return this; 
/* 276 */       return Long2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public long firstLongKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.longValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Long2ByteMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.long2ByteEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Long2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Long, Byte>> entrySet() {
/* 449 */       return (ObjectSortedSet)long2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public LongSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Long2ByteMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.long2ByteEntrySet()); 
/* 582 */       return (ObjectSortedSet<Long2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ByteSortedMaps.class
