...
/* 1132 */     long[] key = this.key;
/* 1133 */     long[] value = this.value;
/* 1134 */     int mask = newN - 1;
/* 1135 */     long[] newKey = new long[newN + 1];
/* 1136 */     long[] newValue = new long[newN + 1];
/* 1137 */     int i = this.n;
/* 1138 */     for (int j = realSize(); j-- != 0; ) {
/* 1139 */       while (key[--i] == 0L); int pos;
/* 1140 */       if (newKey[pos = (int)HashCommon.mix(key[i]) & mask] != 0L)
/* 1141 */         while (newKey[pos = pos + 1 & mask] != 0L); 
...
/*      */     try {
/* 1167 */       c = (Long2LongOpenHashMap)super.clone();
...
/* 1175 */     c.key = (long[])this.key.clone();
/* 1176 */     c.value = (long[])this.value.clone();
/* 1177 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1192 */       while (this.key[i] == 0L)
/* 1193 */         i++; 
/* 1194 */       t = HashCommon.long2int(this.key[i]);
/* 1195 */       t ^= HashCommon.long2int(this.value[i]);
/* 1196 */       h += t;
/* 1197 */       i++;
/*      */     } 
/*      */     
/* 1200 */     if (this.containsNullKey)
/* 1201 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1202 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1205 */     long[] key = this.key;
/* 1206 */     long[] value = this.value;
/* 1207 */     MapIterator i = new MapIterator();
/* 1208 */     s.defaultWriteObject();
/* 1209 */     for (int j = this.size; j-- != 0; ) {
/* 1210 */       int e = i.nextEntry();
/* 1211 */       s.writeLong(key[e]);
/* 1212 */       s.writeLong(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1221 */     long[] key = this.key = new long[this.n + 1];
/* 1222 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1225 */     for (int i = this.size; i-- != 0; ) {
/* 1226 */       int pos; long k = s.readLong();
/* 1227 */       long v = s.readLong();
/* 1228 */       if (k == 0L) {
/* 1229 */         pos = this.n;
/* 1230 */         this.containsNullKey = true;
/*      */       } else {
/* 1232 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1233 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2LongOpenHashMap.class
