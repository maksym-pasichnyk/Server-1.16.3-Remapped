...
/*      */   
/*      */   public boolean trim() {
/* 1121 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1122 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1123 */       return true; 
/*      */     try {
/* 1125 */       rehash(l);
...
/* 1154 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1155 */       return true; 
/*      */     try {
/* 1157 */       rehash(l);
...
/* 1177 */     long[] key = this.key;
/* 1178 */     double[] value = this.value;
/* 1179 */     int mask = newN - 1;
/* 1180 */     long[] newKey = new long[newN + 1];
/* 1181 */     double[] newValue = new double[newN + 1];
/* 1182 */     int i = this.n;
/* 1183 */     for (int j = realSize(); j-- != 0; ) {
/* 1184 */       while (key[--i] == 0L); int pos;
/* 1185 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0L)
/* 1186 */         while (newKey[pos = pos + 1 & mask] != 0L); 
...
/*      */     try {
/* 1212 */       c = (Long2DoubleOpenCustomHashMap)super.clone();
...
/* 1220 */     c.key = (long[])this.key.clone();
/* 1221 */     c.value = (double[])this.value.clone();
...
/* 1238 */       while (this.key[i] == 0L)
/* 1239 */         i++; 
/* 1240 */       t = this.strategy.hashCode(this.key[i]);
/* 1241 */       t ^= HashCommon.double2int(this.value[i]);
/* 1242 */       h += t;
/* 1243 */       i++;
/*      */     } 
/*      */     
/* 1246 */     if (this.containsNullKey)
/* 1247 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1248 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1251 */     long[] key = this.key;
/* 1252 */     double[] value = this.value;
/* 1253 */     MapIterator i = new MapIterator();
/* 1254 */     s.defaultWriteObject();
/* 1255 */     for (int j = this.size; j-- != 0; ) {
/* 1256 */       int e = i.nextEntry();
/* 1257 */       s.writeLong(key[e]);
/* 1258 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1268 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1271 */     for (int i = this.size; i-- != 0; ) {
/* 1272 */       int pos; long k = s.readLong();
/* 1273 */       double v = s.readDouble();
/* 1274 */       if (this.strategy.equals(k, 0L)) {
/* 1275 */         pos = this.n;
/* 1276 */         this.containsNullKey = true;
/*      */       } else {
/* 1278 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1279 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2DoubleOpenCustomHashMap.class
