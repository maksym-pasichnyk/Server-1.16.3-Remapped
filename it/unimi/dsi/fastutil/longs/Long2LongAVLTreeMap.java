...
/*  954 */         return false; 
/*  955 */       Map.Entry<Long, Long> e = (Map.Entry<Long, Long>)o;
/*  956 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  960 */       return HashCommon.long2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */     
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Long2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1047 */       if ((this.next = Long2LongAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Long2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Long2LongAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Long2LongMap.Entry>)new AbstractObjectSortedSet<Long2LongMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Long2LongAVLTreeMap.Entry f = Long2LongAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1186 */               return false; 
/* 1187 */             Long2LongAVLTreeMap.Entry f = Long2LongAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1188 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue())
/* 1189 */               return false; 
/* 1190 */             Long2LongAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Long2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Long2LongAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2LongMap.Entry first() {
/* 1203 */             return Long2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2LongMap.Entry last() {
/* 1207 */             return Long2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) {
/* 1211 */             return Long2LongAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry to) {
/* 1215 */             return Long2LongAVLTreeMap.this.headMap(to.getLongKey()).long2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from) {
/* 1219 */             return Long2LongAVLTreeMap.this.tailMap(from.getLongKey()).long2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Long2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1257 */       return new Long2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1309 */       this.values = new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1312 */             return new Long2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(long k) {
/* 1316 */             return Long2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Long2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Long2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Long2LongAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Long2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Long2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2LongAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Long2LongMap.Entry>)new AbstractObjectSortedSet<Long2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2LongMap.Entry> comparator() {
/* 1428 */               return Long2LongAVLTreeMap.this.long2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Long2LongAVLTreeMap.Entry f = Long2LongAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1441 */               return (f != null && Long2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Long2LongAVLTreeMap.Entry f = Long2LongAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1454 */               if (f != null && Long2LongAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Long2LongAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Long2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Long2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Long2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2LongMap.Entry first() {
/* 1475 */               return Long2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2LongMap.Entry last() {
/* 1479 */               return Long2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) {
/* 1483 */               return Long2LongAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry to) {
/* 1487 */               return Long2LongAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from) {
/* 1491 */               return Long2LongAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2LongSortedMap.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1499 */         return new Long2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1503 */         return new Long2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/* 1515 */         this.values = new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1518 */               return new Long2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(long k) {
/* 1522 */               return Long2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Long2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Long2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1538 */       return (in(k) && Long2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(long v) {
...
/*      */     
/*      */     public long get(long k) {
/* 1555 */       long kk = k; Long2LongAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Long2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public long put(long k, long v) {
/* 1560 */       Long2LongAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       long oldValue = Long2LongAVLTreeMap.this.put(k, v);
/* 1565 */       return Long2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long remove(long k) {
/* 1570 */       Long2LongAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       long oldValue = Long2LongAVLTreeMap.this.remove(k);
/* 1574 */       return Long2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1592 */       return Long2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2LongSortedMap headMap(long to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Long2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2LongSortedMap tailMap(long from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Long2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2LongSortedMap subMap(long from, long to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Long2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Long2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Long2LongAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Long2LongAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Long2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Long2LongAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Long2LongAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2LongAVLTreeMap.Entry e;
/* 1651 */       if (Long2LongAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Long2LongAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Long2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Long2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Long2LongAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1672 */       Long2LongAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1679 */       Long2LongAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Long2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Long2LongAVLTreeMap.Submap.this.bottom && Long2LongAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Long2LongAVLTreeMap.Submap.this.top && Long2LongAVLTreeMap.this.compare(k, (this.prev = Long2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Long2LongAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Long2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Long2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Long2LongAVLTreeMap.this.compare(this.prev.key, Long2LongAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Long2LongAVLTreeMap.Submap.this.top && this.next != null && Long2LongAVLTreeMap.this.compare(this.next.key, Long2LongAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
/*      */     private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Long2LongMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1804 */       c = (Long2LongAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readLong(), s.readLong());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readLong(), s.readLong());
/* 1897 */       entry.right(new Entry(s.readLong(), s.readLong()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2LongAVLTreeMap.class
