...
/* 1125 */     long[] key = this.key;
/* 1126 */     char[] value = this.value;
/* 1127 */     int mask = newN - 1;
/* 1128 */     long[] newKey = new long[newN + 1];
/* 1129 */     char[] newValue = new char[newN + 1];
/* 1130 */     int i = this.n;
/* 1131 */     for (int j = realSize(); j-- != 0; ) {
/* 1132 */       while (key[--i] == 0L); int pos;
/* 1133 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != 0L)
/* 1134 */         while (newKey[pos = pos + 1 & mask] != 0L); 
...
/*      */     try {
/* 1160 */       c = (Long2CharOpenCustomHashMap)super.clone();
...
/* 1168 */     c.key = (long[])this.key.clone();
/* 1169 */     c.value = (char[])this.value.clone();
...
/* 1195 */       h += this.value[this.n]; 
/* 1196 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1199 */     long[] key = this.key;
/* 1200 */     char[] value = this.value;
...
/* 1216 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1219 */     for (int i = this.size; i-- != 0; ) {
/* 1220 */       int pos; long k = s.readLong();
/* 1221 */       char v = s.readChar();
/* 1222 */       if (this.strategy.equals(k, 0L)) {
/* 1223 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2CharOpenCustomHashMap.class
