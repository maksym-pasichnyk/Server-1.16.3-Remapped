...
/*  49 */     ObjectSet<Long2LongMap.Entry> entries = map.long2LongEntrySet();
/*  50 */     return (entries instanceof Long2LongMap.FastEntrySet) ? (
/*  51 */       (Long2LongMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Long2LongMap.Entry> entries = map.long2LongEntrySet();
/*  71 */     if (entries instanceof Long2LongMap.FastEntrySet) {
/*  72 */       ((Long2LongMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Long2LongMap.Entry> entries = map.long2LongEntrySet();
/*  91 */     return (entries instanceof Long2LongMap.FastEntrySet) ? new ObjectIterable<Long2LongMap.Entry>() {
/*     */         public ObjectIterator<Long2LongMap.Entry> iterator() {
/*  93 */           return ((Long2LongMap.FastEntrySet)entries).fastIterator();
/*     */         }
/*     */         public void forEach(Consumer<? super Long2LongMap.Entry> consumer) {
/*  96 */           ((Long2LongMap.FastEntrySet)entries).fastForEach(consumer);
/*     */         }
/*  98 */       } : (ObjectIterable<Long2LongMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 136 */       return (ObjectSet<Long2LongMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 146 */       return LongSets.EMPTY_SET;
/*     */     }
/*     */     
/*     */     public Object clone() {
/* 150 */       return Long2LongMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractLong2LongMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)long2LongEntrySet();
/*     */     }
/*     */     
/*     */     public LongSet keySet() {
...
/* 239 */         this.values = LongSets.singleton(this.value); 
...
/*     */     
/*     */     public int hashCode() {
/* 248 */       return HashCommon.long2int(this.key) ^ HashCommon.long2int(this.value);
/*     */     }
/*     */     
/*     */     public boolean equals(Object o) {
/* 252 */       if (o == this)
...
/*     */   
/*     */   public static Long2LongMap singleton(Long key, Long value) {
/* 300 */     return new Singleton(key.longValue(), value.longValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.long2LongEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Long>> entrySet() {
/* 361 */       return (ObjectSet)long2LongEntrySet();
/*     */     }
/*     */     
/*     */     public LongSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.long2LongEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Long, Long>> entrySet() {
/* 674 */       return (ObjectSet)long2LongEntrySet();
/*     */     }
/*     */     
/*     */     public LongSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2LongMaps.class
