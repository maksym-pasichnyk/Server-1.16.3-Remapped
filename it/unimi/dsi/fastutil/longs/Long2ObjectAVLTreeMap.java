...
/*  936 */       return (this.key == ((Long)e.getKey()).longValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  940 */       return HashCommon.long2int(this.key) ^ ((this.value == null) ? 0 : this.value.hashCode());
/*      */     }
/*      */     
...
/* 1022 */     int index = 0;
/*      */     TreeIterator() {
/* 1024 */       this.next = Long2ObjectAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1027 */       if ((this.next = Long2ObjectAVLTreeMap.this.locateKey(k)) != null)
/* 1028 */         if (Long2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1079 */       updatePrevious();
/* 1080 */       updateNext();
/* 1081 */       Long2ObjectAVLTreeMap.this.remove(this.curr.key);
/* 1082 */       this.curr = null;
/*      */     }
...
/* 1129 */       this.entries = (ObjectSortedSet<Long2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1138 */             return (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>>)new Long2ObjectAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
/* 1143 */             return (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>>)new Long2ObjectAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1151 */             if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1152 */               return false; 
/* 1153 */             Long2ObjectAVLTreeMap.Entry<V> f = Long2ObjectAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1162 */             if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1163 */               return false; 
/* 1164 */             Long2ObjectAVLTreeMap.Entry<V> f = Long2ObjectAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1165 */             if (f == null || !Objects.equals(f.getValue(), e.getValue()))
/* 1166 */               return false; 
/* 1167 */             Long2ObjectAVLTreeMap.this.remove(f.key);
/* 1168 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1172 */             return Long2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1176 */             Long2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2ObjectMap.Entry<V> first() {
/* 1180 */             return Long2ObjectAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2ObjectMap.Entry<V> last() {
/* 1184 */             return Long2ObjectAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) {
/* 1189 */             return Long2ObjectAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) {
/* 1193 */             return Long2ObjectAVLTreeMap.this.headMap(to.getLongKey()).long2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) {
/* 1197 */             return Long2ObjectAVLTreeMap.this.tailMap(from.getLongKey()).long2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1231 */       return new Long2ObjectAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1235 */       return new Long2ObjectAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1290 */             return (ObjectIterator<V>)new Long2ObjectAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1294 */             return Long2ObjectAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1298 */             return Long2ObjectAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1302 */             Long2ObjectAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1313 */     return new Submap(0L, true, to, false);
/*      */   }
/*      */   
/*      */   public Long2ObjectSortedMap<V> tailMap(long from) {
/* 1317 */     return new Submap(from, false, 0L, true);
/*      */   }
/*      */   
...
/* 1365 */       if (!bottom && !top && Long2ObjectAVLTreeMap.this.compare(from, to) > 0)
/* 1366 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Long2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1389 */       return ((this.bottom || Long2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ObjectAVLTreeMap.this
/* 1390 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
/* 1394 */       if (this.entries == null)
/* 1395 */         this.entries = (ObjectSortedSet<Long2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator() {
/* 1398 */               return (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>>)new Long2ObjectAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
/* 1403 */               return (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>>)new Long2ObjectAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2ObjectMap.Entry<V>> comparator() {
/* 1407 */               return Long2ObjectAVLTreeMap.this.long2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1415 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1416 */                 return false; 
/* 1417 */               Long2ObjectAVLTreeMap.Entry<V> f = Long2ObjectAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1418 */               return (f != null && Long2ObjectAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1426 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1427 */                 return false; 
/* 1428 */               Long2ObjectAVLTreeMap.Entry<V> f = Long2ObjectAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1429 */               if (f != null && Long2ObjectAVLTreeMap.Submap.this.in(f.key))
/* 1430 */                 Long2ObjectAVLTreeMap.Submap.this.remove(f.key); 
/* 1431 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1435 */               int c = 0;
/* 1436 */               for (ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1437 */                 c++; 
/* 1438 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1442 */               return !(new Long2ObjectAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1446 */               Long2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2ObjectMap.Entry<V> first() {
/* 1450 */               return Long2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2ObjectMap.Entry<V> last() {
/* 1454 */               return Long2ObjectAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) {
/* 1459 */               return Long2ObjectAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) {
/* 1463 */               return Long2ObjectAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) {
/* 1467 */               return Long2ObjectAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2ObjectEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2ObjectSortedMap<V>.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1475 */         return new Long2ObjectAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1479 */         return new Long2ObjectAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1494 */               return (ObjectIterator<V>)new Long2ObjectAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1498 */               return Long2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1502 */               return Long2ObjectAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1506 */               Long2ObjectAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1514 */       return (in(k) && Long2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(long k) {
/* 1531 */       long kk = k; Long2ObjectAVLTreeMap.Entry<V> e;
/* 1532 */       return (in(kk) && (e = Long2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(long k, V v) {
/* 1536 */       Long2ObjectAVLTreeMap.this.modified = false;
/* 1537 */       if (!in(k))
...
/* 1540 */       V oldValue = Long2ObjectAVLTreeMap.this.put(k, v);
/* 1541 */       return Long2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(long k) {
/* 1546 */       Long2ObjectAVLTreeMap.this.modified = false;
/* 1547 */       if (!in(k))
/* 1548 */         return this.defRetValue; 
/* 1549 */       V oldValue = Long2ObjectAVLTreeMap.this.remove(k);
/* 1550 */       return Long2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1568 */       return Long2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2ObjectSortedMap<V> headMap(long to) {
/* 1572 */       if (this.top)
/* 1573 */         return new Submap(this.from, this.bottom, to, false); 
/* 1574 */       return (Long2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2ObjectSortedMap<V> tailMap(long from) {
/* 1578 */       if (this.bottom)
/* 1579 */         return new Submap(from, false, this.to, this.top); 
/* 1580 */       return (Long2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2ObjectSortedMap<V> subMap(long from, long to) {
...
/* 1586 */       if (!this.top)
/* 1587 */         to = (Long2ObjectAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1588 */       if (!this.bottom)
/* 1589 */         from = (Long2ObjectAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1601 */       if (Long2ObjectAVLTreeMap.this.tree == null) {
/* 1602 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1606 */       if (this.bottom) {
/* 1607 */         e = Long2ObjectAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1609 */         e = Long2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1611 */         if (Long2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1612 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1616 */       if (e == null || (!this.top && Long2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1617 */         return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2ObjectAVLTreeMap.Entry<V> e;
/* 1627 */       if (Long2ObjectAVLTreeMap.this.tree == null) {
/* 1628 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1632 */       if (this.top) {
/* 1633 */         e = Long2ObjectAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1635 */         e = Long2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1637 */         if (Long2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1638 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1642 */       if (e == null || (!this.bottom && Long2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1643 */         return null; 
/* 1644 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1648 */       Long2ObjectAVLTreeMap.Entry<V> e = firstEntry();
/* 1649 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1655 */       Long2ObjectAVLTreeMap.Entry<V> e = lastEntry();
/* 1656 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1671 */         this.next = Long2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1674 */         this();
/* 1675 */         if (this.next != null)
/* 1676 */           if (!Long2ObjectAVLTreeMap.Submap.this.bottom && Long2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1677 */             this.prev = null;
/* 1678 */           } else if (!Long2ObjectAVLTreeMap.Submap.this.top && Long2ObjectAVLTreeMap.this.compare(k, (this.prev = Long2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1679 */             this.next = null;
/*      */           } else {
/* 1681 */             this.next = Long2ObjectAVLTreeMap.this.locateKey(k);
/* 1682 */             if (Long2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1693 */         if (!Long2ObjectAVLTreeMap.Submap.this.bottom && this.prev != null && Long2ObjectAVLTreeMap.this.compare(this.prev.key, Long2ObjectAVLTreeMap.Submap.this.from) < 0)
/* 1694 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1698 */         this.next = this.next.next();
/* 1699 */         if (!Long2ObjectAVLTreeMap.Submap.this.top && this.next != null && Long2ObjectAVLTreeMap.this.compare(this.next.key, Long2ObjectAVLTreeMap.Submap.this.to) >= 0)
/* 1700 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1782 */       c = (Long2ObjectAVLTreeMap<V>)super.clone();
...
/* 1863 */     if (n == 1) {
/* 1864 */       Entry<V> entry = new Entry<>(s.readLong(), (V)s.readObject());
...
/*      */ 
/*      */       
/* 1874 */       Entry<V> entry = new Entry<>(s.readLong(), (V)s.readObject());
/* 1875 */       entry.right(new Entry<>(s.readLong(), (V)s.readObject()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ObjectAVLTreeMap.class
