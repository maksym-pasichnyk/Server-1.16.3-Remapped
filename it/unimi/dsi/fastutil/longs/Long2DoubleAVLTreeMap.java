...
/*  954 */         return false; 
/*  955 */       Map.Entry<Long, Double> e = (Map.Entry<Long, Double>)o;
/*  956 */       return (this.key == ((Long)e.getKey()).longValue() && 
/*  957 */         Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  961 */       return HashCommon.long2int(this.key) ^ HashCommon.double2int(this.value);
/*      */     }
/*      */     
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Long2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1048 */       if ((this.next = Long2DoubleAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Long2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Long2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Long2DoubleMap.Entry>)new AbstractObjectSortedSet<Long2DoubleMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Long2DoubleMap.Entry>)new Long2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Long2DoubleMap.Entry>)new Long2DoubleAVLTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1171 */             if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1172 */               return false; 
/* 1173 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1174 */               return false; 
/* 1175 */             Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1184 */             if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1185 */               return false; 
/* 1186 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1187 */               return false; 
/* 1188 */             Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1189 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != 
/* 1190 */               Double.doubleToLongBits(((Double)e.getValue()).doubleValue()))
/* 1191 */               return false; 
/* 1192 */             Long2DoubleAVLTreeMap.this.remove(f.key);
/* 1193 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1197 */             return Long2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1201 */             Long2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2DoubleMap.Entry first() {
/* 1205 */             return Long2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2DoubleMap.Entry last() {
/* 1209 */             return Long2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry to) {
/* 1214 */             return Long2DoubleAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry to) {
/* 1218 */             return Long2DoubleAVLTreeMap.this.headMap(to.getLongKey()).long2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from) {
/* 1222 */             return Long2DoubleAVLTreeMap.this.tailMap(from.getLongKey()).long2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1256 */       return new Long2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1260 */       return new Long2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1315 */             return (DoubleIterator)new Long2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(double k) {
/* 1319 */             return Long2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1323 */             return Long2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1327 */             Long2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1338 */     return new Submap(0L, true, to, false);
/*      */   }
/*      */   
/*      */   public Long2DoubleSortedMap tailMap(long from) {
/* 1342 */     return new Submap(from, false, 0L, true);
/*      */   }
/*      */   
...
/* 1390 */       if (!bottom && !top && Long2DoubleAVLTreeMap.this.compare(from, to) > 0)
/* 1391 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1392 */       this.from = from;
/* 1393 */       this.bottom = bottom;
/* 1394 */       this.to = to;
/* 1395 */       this.top = top;
/* 1396 */       this.defRetValue = Long2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1414 */       return ((this.bottom || Long2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2DoubleAVLTreeMap.this
/* 1415 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
/* 1419 */       if (this.entries == null)
/* 1420 */         this.entries = (ObjectSortedSet<Long2DoubleMap.Entry>)new AbstractObjectSortedSet<Long2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator() {
/* 1423 */               return (ObjectBidirectionalIterator<Long2DoubleMap.Entry>)new Long2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from) {
/* 1427 */               return (ObjectBidirectionalIterator<Long2DoubleMap.Entry>)new Long2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2DoubleMap.Entry> comparator() {
/* 1431 */               return Long2DoubleAVLTreeMap.this.long2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1440 */                 return false; 
/* 1441 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1442 */                 return false; 
/* 1443 */               Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1444 */               return (f != null && Long2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */               if (e.getKey() == null || !(e.getKey() instanceof Long))
/* 1453 */                 return false; 
/* 1454 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1455 */                 return false; 
/* 1456 */               Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1457 */               if (f != null && Long2DoubleAVLTreeMap.Submap.this.in(f.key))
/* 1458 */                 Long2DoubleAVLTreeMap.Submap.this.remove(f.key); 
/* 1459 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1463 */               int c = 0;
/* 1464 */               for (ObjectBidirectionalIterator<Long2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1465 */                 c++; 
/* 1466 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1470 */               return !(new Long2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1474 */               Long2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2DoubleMap.Entry first() {
/* 1478 */               return Long2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2DoubleMap.Entry last() {
/* 1482 */               return Long2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry to) {
/* 1487 */               return Long2DoubleAVLTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry to) {
/* 1491 */               return Long2DoubleAVLTreeMap.Submap.this.headMap(to.getLongKey()).long2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from) {
/* 1495 */               return Long2DoubleAVLTreeMap.Submap.this.tailMap(from.getLongKey()).long2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2DoubleSortedMap.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1503 */         return new Long2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1507 */         return new Long2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1522 */               return (DoubleIterator)new Long2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(double k) {
/* 1526 */               return Long2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1530 */               return Long2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1534 */               Long2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1542 */       return (in(k) && Long2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(long k) {
/* 1559 */       long kk = k; Long2DoubleAVLTreeMap.Entry e;
/* 1560 */       return (in(kk) && (e = Long2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public double put(long k, double v) {
/* 1564 */       Long2DoubleAVLTreeMap.this.modified = false;
/* 1565 */       if (!in(k))
...
/* 1568 */       double oldValue = Long2DoubleAVLTreeMap.this.put(k, v);
/* 1569 */       return Long2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double remove(long k) {
/* 1574 */       Long2DoubleAVLTreeMap.this.modified = false;
/* 1575 */       if (!in(k))
/* 1576 */         return this.defRetValue; 
/* 1577 */       double oldValue = Long2DoubleAVLTreeMap.this.remove(k);
/* 1578 */       return Long2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1596 */       return Long2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2DoubleSortedMap headMap(long to) {
/* 1600 */       if (this.top)
/* 1601 */         return new Submap(this.from, this.bottom, to, false); 
/* 1602 */       return (Long2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2DoubleSortedMap tailMap(long from) {
/* 1606 */       if (this.bottom)
/* 1607 */         return new Submap(from, false, this.to, this.top); 
/* 1608 */       return (Long2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2DoubleSortedMap subMap(long from, long to) {
...
/* 1614 */       if (!this.top)
/* 1615 */         to = (Long2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1616 */       if (!this.bottom)
/* 1617 */         from = (Long2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1629 */       if (Long2DoubleAVLTreeMap.this.tree == null) {
/* 1630 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1634 */       if (this.bottom) {
/* 1635 */         e = Long2DoubleAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1637 */         e = Long2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1639 */         if (Long2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1640 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1644 */       if (e == null || (!this.top && Long2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1645 */         return null; 
/* 1646 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2DoubleAVLTreeMap.Entry e;
/* 1655 */       if (Long2DoubleAVLTreeMap.this.tree == null) {
/* 1656 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1660 */       if (this.top) {
/* 1661 */         e = Long2DoubleAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1663 */         e = Long2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1665 */         if (Long2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1666 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1670 */       if (e == null || (!this.bottom && Long2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1671 */         return null; 
/* 1672 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1676 */       Long2DoubleAVLTreeMap.Entry e = firstEntry();
/* 1677 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1683 */       Long2DoubleAVLTreeMap.Entry e = lastEntry();
/* 1684 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1699 */         this.next = Long2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1702 */         this();
/* 1703 */         if (this.next != null)
/* 1704 */           if (!Long2DoubleAVLTreeMap.Submap.this.bottom && Long2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1705 */             this.prev = null;
/* 1706 */           } else if (!Long2DoubleAVLTreeMap.Submap.this.top && Long2DoubleAVLTreeMap.this.compare(k, (this.prev = Long2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1707 */             this.next = null;
/*      */           } else {
/* 1709 */             this.next = Long2DoubleAVLTreeMap.this.locateKey(k);
/* 1710 */             if (Long2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1721 */         if (!Long2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Long2DoubleAVLTreeMap.this.compare(this.prev.key, Long2DoubleAVLTreeMap.Submap.this.from) < 0)
/* 1722 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1726 */         this.next = this.next.next();
/* 1727 */         if (!Long2DoubleAVLTreeMap.Submap.this.top && this.next != null && Long2DoubleAVLTreeMap.this.compare(this.next.key, Long2DoubleAVLTreeMap.Submap.this.to) >= 0)
/* 1728 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1808 */       c = (Long2DoubleAVLTreeMap)super.clone();
...
/* 1889 */     if (n == 1) {
/* 1890 */       Entry entry = new Entry(s.readLong(), s.readDouble());
...
/*      */ 
/*      */       
/* 1900 */       Entry entry = new Entry(s.readLong(), s.readDouble());
/* 1901 */       entry.right(new Entry(s.readLong(), s.readDouble()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2DoubleAVLTreeMap.class
