...
/*      */     try {
/* 1131 */       c = (Long2ReferenceOpenCustomHashMap<V>)super.clone();
...
/* 1161 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1162 */       h += t;
/* 1163 */       i++;
/*      */     } 
/*      */     
/* 1166 */     if (this.containsNullKey)
/* 1167 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1168 */     return h;
/*      */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ReferenceOpenCustomHashMap.class
