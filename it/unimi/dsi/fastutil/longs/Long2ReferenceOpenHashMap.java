...
/* 1056 */     long[] key = this.key;
/* 1057 */     V[] value = this.value;
/* 1058 */     int mask = newN - 1;
/* 1059 */     long[] newKey = new long[newN + 1];
/* 1060 */     V[] newValue = (V[])new Object[newN + 1];
/* 1061 */     int i = this.n;
/* 1062 */     for (int j = realSize(); j-- != 0; ) {
/* 1063 */       while (key[--i] == 0L); int pos;
/* 1064 */       if (newKey[pos = (int)HashCommon.mix(key[i]) & mask] != 0L)
/* 1065 */         while (newKey[pos = pos + 1 & mask] != 0L); 
...
/*      */     try {
/* 1091 */       c = (Long2ReferenceOpenHashMap<V>)super.clone();
...
/* 1099 */     c.key = (long[])this.key.clone();
...
/* 1116 */       while (this.key[i] == 0L)
/* 1117 */         i++; 
/* 1118 */       t = HashCommon.long2int(this.key[i]);
/* 1119 */       if (this != this.value[i])
/* 1120 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1121 */       h += t;
/* 1122 */       i++;
/*      */     } 
/*      */     
/* 1125 */     if (this.containsNullKey)
/* 1126 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1127 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1130 */     long[] key = this.key;
...
/* 1146 */     long[] key = this.key = new long[this.n + 1];
/* 1147 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1150 */     for (int i = this.size; i-- != 0; ) {
/* 1151 */       int pos; long k = s.readLong();
/* 1152 */       V v = (V)s.readObject();
/* 1153 */       if (k == 0L) {
/* 1154 */         pos = this.n;
/* 1155 */         this.containsNullKey = true;
/*      */       } else {
/* 1157 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1158 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2ReferenceOpenHashMap.class
