...
/*  910 */         return false; 
/*  911 */       Map.Entry<Long, Long> e = (Map.Entry<Long, Long>)o;
/*  912 */       return (this.key == ((Long)e.getKey()).longValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  916 */       return HashCommon.long2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */     
...
/*  998 */     int index = 0;
/*      */     TreeIterator() {
/* 1000 */       this.next = Long2LongRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(long k) {
/* 1003 */       if ((this.next = Long2LongRBTreeMap.this.locateKey(k)) != null)
/* 1004 */         if (Long2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1055 */       updatePrevious();
/* 1056 */       updateNext();
/* 1057 */       Long2LongRBTreeMap.this.remove(this.curr.key);
/* 1058 */       this.curr = null;
/*      */     }
...
/* 1097 */       this.entries = (ObjectSortedSet<Long2LongMap.Entry>)new AbstractObjectSortedSet<Long2LongMap.Entry>()
/*      */         {
...
/* 1106 */             return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from) {
/* 1110 */             return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongRBTreeMap.EntryIterator(from.getLongKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1121 */               return false; 
/* 1122 */             Long2LongRBTreeMap.Entry f = Long2LongRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1134 */               return false; 
/* 1135 */             Long2LongRBTreeMap.Entry f = Long2LongRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1136 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue())
/* 1137 */               return false; 
/* 1138 */             Long2LongRBTreeMap.this.remove(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Long2LongRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Long2LongRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Long2LongMap.Entry first() {
/* 1151 */             return Long2LongRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Long2LongMap.Entry last() {
/* 1155 */             return Long2LongRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) {
/* 1159 */             return Long2LongRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry to) {
/* 1163 */             return Long2LongRBTreeMap.this.headMap(to.getLongKey()).long2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from) {
/* 1167 */             return Long2LongRBTreeMap.this.tailMap(from.getLongKey()).long2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1201 */       return new Long2LongRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public LongBidirectionalIterator iterator(long from) {
/* 1205 */       return new Long2LongRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1257 */       this.values = new AbstractLongCollection()
/*      */         {
/*      */           public LongIterator iterator() {
/* 1260 */             return new Long2LongRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(long k) {
/* 1264 */             return Long2LongRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Long2LongRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1272 */             Long2LongRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1335 */       if (!bottom && !top && Long2LongRBTreeMap.this.compare(from, to) > 0)
/* 1336 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1337 */       this.from = from;
/* 1338 */       this.bottom = bottom;
/* 1339 */       this.to = to;
/* 1340 */       this.top = top;
/* 1341 */       this.defRetValue = Long2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1359 */       return ((this.bottom || Long2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2LongRBTreeMap.this
/* 1360 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
/* 1364 */       if (this.entries == null)
/* 1365 */         this.entries = (ObjectSortedSet<Long2LongMap.Entry>)new AbstractObjectSortedSet<Long2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator() {
/* 1368 */               return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from) {
/* 1372 */               return (ObjectBidirectionalIterator<Long2LongMap.Entry>)new Long2LongRBTreeMap.Submap.SubmapEntryIterator(from.getLongKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Long2LongMap.Entry> comparator() {
/* 1376 */               return Long2LongRBTreeMap.this.long2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Long2LongRBTreeMap.Entry f = Long2LongRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1389 */               return (f != null && Long2LongRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1400 */                 return false; 
/* 1401 */               Long2LongRBTreeMap.Entry f = Long2LongRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1402 */               if (f != null && Long2LongRBTreeMap.Submap.this.in(f.key))
/* 1403 */                 Long2LongRBTreeMap.Submap.this.remove(f.key); 
/* 1404 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1408 */               int c = 0;
/* 1409 */               for (ObjectBidirectionalIterator<Long2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1410 */                 c++; 
/* 1411 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1415 */               return !(new Long2LongRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1419 */               Long2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Long2LongMap.Entry first() {
/* 1423 */               return Long2LongRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Long2LongMap.Entry last() {
/* 1427 */               return Long2LongRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) {
/* 1431 */               return Long2LongRBTreeMap.Submap.this.subMap(from.getLongKey(), to.getLongKey()).long2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry to) {
/* 1435 */               return Long2LongRBTreeMap.Submap.this.headMap(to.getLongKey()).long2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from) {
/* 1439 */               return Long2LongRBTreeMap.Submap.this.tailMap(from.getLongKey()).long2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractLong2LongSortedMap.KeySet {
/*      */       public LongBidirectionalIterator iterator() {
/* 1447 */         return new Long2LongRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public LongBidirectionalIterator iterator(long from) {
/* 1451 */         return new Long2LongRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public LongSortedSet keySet() {
...
/* 1463 */         this.values = new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1466 */               return new Long2LongRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(long k) {
/* 1470 */               return Long2LongRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1474 */               return Long2LongRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1478 */               Long2LongRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(long k) {
/* 1486 */       return (in(k) && Long2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(long v) {
...
/*      */     
/*      */     public long get(long k) {
/* 1503 */       long kk = k; Long2LongRBTreeMap.Entry e;
/* 1504 */       return (in(kk) && (e = Long2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public long put(long k, long v) {
/* 1508 */       Long2LongRBTreeMap.this.modified = false;
/* 1509 */       if (!in(k))
...
/* 1512 */       long oldValue = Long2LongRBTreeMap.this.put(k, v);
/* 1513 */       return Long2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long remove(long k) {
/* 1518 */       Long2LongRBTreeMap.this.modified = false;
/* 1519 */       if (!in(k))
/* 1520 */         return this.defRetValue; 
/* 1521 */       long oldValue = Long2LongRBTreeMap.this.remove(k);
/* 1522 */       return Long2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public LongComparator comparator() {
/* 1540 */       return Long2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Long2LongSortedMap headMap(long to) {
/* 1544 */       if (this.top)
/* 1545 */         return new Submap(this.from, this.bottom, to, false); 
/* 1546 */       return (Long2LongRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Long2LongSortedMap tailMap(long from) {
/* 1550 */       if (this.bottom)
/* 1551 */         return new Submap(from, false, this.to, this.top); 
/* 1552 */       return (Long2LongRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Long2LongSortedMap subMap(long from, long to) {
...
/* 1558 */       if (!this.top)
/* 1559 */         to = (Long2LongRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1560 */       if (!this.bottom)
/* 1561 */         from = (Long2LongRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1573 */       if (Long2LongRBTreeMap.this.tree == null) {
/* 1574 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1578 */       if (this.bottom) {
/* 1579 */         e = Long2LongRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1581 */         e = Long2LongRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1583 */         if (Long2LongRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1584 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1588 */       if (e == null || (!this.top && Long2LongRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1589 */         return null; 
/* 1590 */       return e;
/*      */     }
/*      */ 
...
/*      */       Long2LongRBTreeMap.Entry e;
/* 1599 */       if (Long2LongRBTreeMap.this.tree == null) {
/* 1600 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1604 */       if (this.top) {
/* 1605 */         e = Long2LongRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1607 */         e = Long2LongRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1609 */         if (Long2LongRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1610 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Long2LongRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1615 */         return null; 
/* 1616 */       return e;
/*      */     }
/*      */     
/*      */     public long firstLongKey() {
/* 1620 */       Long2LongRBTreeMap.Entry e = firstEntry();
/* 1621 */       if (e == null)
...
/*      */     
/*      */     public long lastLongKey() {
/* 1627 */       Long2LongRBTreeMap.Entry e = lastEntry();
/* 1628 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Long2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1646 */         this();
/* 1647 */         if (this.next != null)
/* 1648 */           if (!Long2LongRBTreeMap.Submap.this.bottom && Long2LongRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1649 */             this.prev = null;
/* 1650 */           } else if (!Long2LongRBTreeMap.Submap.this.top && Long2LongRBTreeMap.this.compare(k, (this.prev = Long2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1651 */             this.next = null;
/*      */           } else {
/* 1653 */             this.next = Long2LongRBTreeMap.this.locateKey(k);
/* 1654 */             if (Long2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1665 */         if (!Long2LongRBTreeMap.Submap.this.bottom && this.prev != null && Long2LongRBTreeMap.this.compare(this.prev.key, Long2LongRBTreeMap.Submap.this.from) < 0)
/* 1666 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1670 */         this.next = this.next.next();
/* 1671 */         if (!Long2LongRBTreeMap.Submap.this.top && this.next != null && Long2LongRBTreeMap.this.compare(this.next.key, Long2LongRBTreeMap.Submap.this.to) >= 0)
/* 1672 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1752 */       c = (Long2LongRBTreeMap)super.clone();
...
/* 1833 */     if (n == 1) {
/* 1834 */       Entry entry = new Entry(s.readLong(), s.readLong());
...
/*      */ 
/*      */       
/* 1845 */       Entry entry = new Entry(s.readLong(), s.readLong());
/* 1846 */       entry.black(true);
/* 1847 */       entry.right(new Entry(s.readLong(), s.readLong()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\longs\Long2LongRBTreeMap.class
