...
/*  73 */     this.length = size;
/*  74 */     this.array = new byte[(int)((size + 1024L - 1L) / 1024L) + 1][];
/*     */     
/*  76 */     for (int i = 0; i < this.array.length - 1; i++) {
/*  77 */       this.array[i] = new byte[(size >= 1024L) ? 1024 : (int)size];
/*     */       
...
/* 135 */     int disp = (int)(this.position++ & 0x3FFL);
...
/*     */     
/*     */     while (true) {
/* 148 */       int disp = (int)(this.position & 0x3FFL);
...
/* 161 */     this.current = this.array[(int)(this.position >>> 10L)];
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\io\FastMultiByteArrayInputStream.class
