...
/* 598 */     boolean[] key = this.key;
/* 599 */     int mask = newN - 1;
/* 600 */     boolean[] newKey = new boolean[newN + 1];
/* 601 */     int i = this.n;
/* 602 */     for (int j = realSize(); j-- != 0; ) {
/* 603 */       while (!key[--i]); int pos;
/* 604 */       if (newKey[pos = (key[i] ? 262886248 : -878682501) & mask])
/* 605 */         while (newKey[pos = pos + 1 & mask]); 
...
/* 649 */       while (!this.key[i])
/* 650 */         i++; 
/* 651 */       h += this.key[i] ? 1231 : 1237;
/* 652 */       i++;
/*     */     } 
/*     */     
/* 655 */     return h;
...
/* 658 */     BooleanIterator i = iterator();
/* 659 */     s.defaultWriteObject();
/* 660 */     for (int j = this.size; j-- != 0;)
/* 661 */       s.writeBoolean(i.nextBoolean()); 
/*     */   }
/*     */   
...
/* 669 */     boolean[] key = this.key = new boolean[this.n + 1];
/*     */     
/* 671 */     for (int i = this.size; i-- != 0; ) {
/* 672 */       int pos; boolean k = s.readBoolean();
/* 673 */       if (!k) {
/* 674 */         pos = this.n;
/* 675 */         this.containsNull = true;
/*     */       }
/* 677 */       else if (key[pos = (k ? 262886248 : -878682501) & this.mask]) {
/* 678 */         while (key[pos = pos + 1 & this.mask]);
/*     */       } 
/* 680 */       key[pos] = k;
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\booleans\BooleanOpenHashSet.class
