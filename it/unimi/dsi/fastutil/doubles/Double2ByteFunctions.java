...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Double2ByteFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Double2ByteFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Double2ByteFunction singleton(Double key, Byte value) {
/* 161 */     return new Singleton(key.doubleValue(), value.byteValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Double2ByteFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractDouble2ByteFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2ByteFunction function;
/*     */     
...
/* 462 */       Byte v = this.function.apply(Double.valueOf(key));
/* 463 */       if (v == null)
...
/* 505 */     if (f instanceof Double2ByteFunction)
/* 506 */       return (Double2ByteFunction)f; 
/* 507 */     if (f instanceof DoubleToIntFunction) {
/* 508 */       return key -> SafeMath.safeIntToByte(((DoubleToIntFunction)f).applyAsInt(key));
/*     */     }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteFunctions.class
