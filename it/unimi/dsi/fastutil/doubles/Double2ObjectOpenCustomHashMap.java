...
/* 1104 */     double[] key = this.key;
/* 1105 */     V[] value = this.value;
/* 1106 */     int mask = newN - 1;
/* 1107 */     double[] newKey = new double[newN + 1];
/* 1108 */     V[] newValue = (V[])new Object[newN + 1];
/* 1109 */     int i = this.n;
/* 1110 */     for (int j = realSize(); j-- != 0; ) {
/* 1111 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1112 */       if (Double.doubleToLongBits(newKey[
/* 1113 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0L)
/* 1114 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); 
...
/*      */     try {
/* 1140 */       c = (Double2ObjectOpenCustomHashMap<V>)super.clone();
...
/* 1148 */     c.key = (double[])this.key.clone();
...
/* 1166 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1167 */         i++; 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ObjectOpenCustomHashMap.class
