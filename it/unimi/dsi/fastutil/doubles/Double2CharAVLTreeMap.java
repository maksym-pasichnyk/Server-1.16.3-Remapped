...
/*  954 */         return false; 
/*  955 */       Map.Entry<Double, Character> e = (Map.Entry<Double, Character>)o;
/*  956 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Character)e
/*  957 */         .getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Double2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(double k) {
/* 1048 */       if ((this.next = Double2CharAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Double2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Double2CharAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Double2CharMap.Entry>)new AbstractObjectSortedSet<Double2CharMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharAVLTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1172 */               return false; 
/* 1173 */             if (e.getValue() == null || !(e.getValue() instanceof Character))
/* 1174 */               return false; 
/* 1175 */             Double2CharAVLTreeMap.Entry f = Double2CharAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1185 */               return false; 
/* 1186 */             if (e.getValue() == null || !(e.getValue() instanceof Character))
/* 1187 */               return false; 
/* 1188 */             Double2CharAVLTreeMap.Entry f = Double2CharAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1189 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1190 */               return false; 
/* 1191 */             Double2CharAVLTreeMap.this.remove(f.key);
/* 1192 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1196 */             return Double2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1200 */             Double2CharAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Double2CharMap.Entry first() {
/* 1204 */             return Double2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Double2CharMap.Entry last() {
/* 1208 */             return Double2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry from, Double2CharMap.Entry to) {
/* 1213 */             return Double2CharAVLTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry to) {
/* 1217 */             return Double2CharAVLTreeMap.this.headMap(to.getDoubleKey()).double2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry from) {
/* 1221 */             return Double2CharAVLTreeMap.this.tailMap(from.getDoubleKey()).double2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1255 */       return new Double2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1259 */       return new Double2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1311 */       this.values = (CharCollection)new AbstractCharCollection()
/*      */         {
/*      */           public CharIterator iterator() {
/* 1314 */             return (CharIterator)new Double2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1318 */             return Double2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1322 */             return Double2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1326 */             Double2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1389 */       if (!bottom && !top && Double2CharAVLTreeMap.this.compare(from, to) > 0)
/* 1390 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1391 */       this.from = from;
/* 1392 */       this.bottom = bottom;
/* 1393 */       this.to = to;
/* 1394 */       this.top = top;
/* 1395 */       this.defRetValue = Double2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1413 */       return ((this.bottom || Double2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2CharAVLTreeMap.this
/* 1414 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
/* 1418 */       if (this.entries == null)
/* 1419 */         this.entries = (ObjectSortedSet<Double2CharMap.Entry>)new AbstractObjectSortedSet<Double2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator() {
/* 1422 */               return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from) {
/* 1426 */               return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Double2CharMap.Entry> comparator() {
/* 1430 */               return Double2CharAVLTreeMap.this.double2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               if (e.getValue() == null || !(e.getValue() instanceof Character))
/* 1441 */                 return false; 
/* 1442 */               Double2CharAVLTreeMap.Entry f = Double2CharAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1443 */               return (f != null && Double2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1454 */                 return false; 
/* 1455 */               Double2CharAVLTreeMap.Entry f = Double2CharAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1456 */               if (f != null && Double2CharAVLTreeMap.Submap.this.in(f.key))
/* 1457 */                 Double2CharAVLTreeMap.Submap.this.remove(f.key); 
/* 1458 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1462 */               int c = 0;
/* 1463 */               for (ObjectBidirectionalIterator<Double2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1464 */                 c++; 
/* 1465 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1469 */               return !(new Double2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1473 */               Double2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Double2CharMap.Entry first() {
/* 1477 */               return Double2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Double2CharMap.Entry last() {
/* 1481 */               return Double2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry from, Double2CharMap.Entry to) {
/* 1486 */               return Double2CharAVLTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry to) {
/* 1490 */               return Double2CharAVLTreeMap.Submap.this.headMap(to.getDoubleKey()).double2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry from) {
/* 1494 */               return Double2CharAVLTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractDouble2CharSortedMap.KeySet {
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1502 */         return new Double2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1506 */         return new Double2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public DoubleSortedSet keySet() {
...
/* 1518 */         this.values = (CharCollection)new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1521 */               return (CharIterator)new Double2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1525 */               return Double2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1529 */               return Double2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1533 */               Double2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1541 */       return (in(k) && Double2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/* 1548 */         char ev = (i.nextEntry()).value;
/* 1549 */         if (ev == v)
/* 1550 */           return true; 
/*      */       } 
/* 1552 */       return false;
...
/*      */     
/*      */     public char get(double k) {
/* 1558 */       double kk = k; Double2CharAVLTreeMap.Entry e;
/* 1559 */       return (in(kk) && (e = Double2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(double k, char v) {
/* 1563 */       Double2CharAVLTreeMap.this.modified = false;
/* 1564 */       if (!in(k))
...
/* 1567 */       char oldValue = Double2CharAVLTreeMap.this.put(k, v);
/* 1568 */       return Double2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(double k) {
/* 1573 */       Double2CharAVLTreeMap.this.modified = false;
/* 1574 */       if (!in(k))
/* 1575 */         return this.defRetValue; 
/* 1576 */       char oldValue = Double2CharAVLTreeMap.this.remove(k);
/* 1577 */       return Double2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1595 */       return Double2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Double2CharSortedMap headMap(double to) {
/* 1599 */       if (this.top)
/* 1600 */         return new Submap(this.from, this.bottom, to, false); 
/* 1601 */       return (Double2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Double2CharSortedMap tailMap(double from) {
/* 1605 */       if (this.bottom)
/* 1606 */         return new Submap(from, false, this.to, this.top); 
/* 1607 */       return (Double2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Double2CharSortedMap subMap(double from, double to) {
...
/* 1613 */       if (!this.top)
/* 1614 */         to = (Double2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1615 */       if (!this.bottom)
/* 1616 */         from = (Double2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1628 */       if (Double2CharAVLTreeMap.this.tree == null) {
/* 1629 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1633 */       if (this.bottom) {
/* 1634 */         e = Double2CharAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1636 */         e = Double2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1638 */         if (Double2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1639 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1643 */       if (e == null || (!this.top && Double2CharAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1644 */         return null; 
/* 1645 */       return e;
/*      */     }
/*      */ 
...
/*      */       Double2CharAVLTreeMap.Entry e;
/* 1654 */       if (Double2CharAVLTreeMap.this.tree == null) {
/* 1655 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1659 */       if (this.top) {
/* 1660 */         e = Double2CharAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1662 */         e = Double2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1664 */         if (Double2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1665 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1669 */       if (e == null || (!this.bottom && Double2CharAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1670 */         return null; 
/* 1671 */       return e;
/*      */     }
/*      */     
/*      */     public double firstDoubleKey() {
/* 1675 */       Double2CharAVLTreeMap.Entry e = firstEntry();
/* 1676 */       if (e == null)
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1682 */       Double2CharAVLTreeMap.Entry e = lastEntry();
/* 1683 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1698 */         this.next = Double2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(double k) {
/* 1701 */         this();
/* 1702 */         if (this.next != null)
/* 1703 */           if (!Double2CharAVLTreeMap.Submap.this.bottom && Double2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1704 */             this.prev = null;
/* 1705 */           } else if (!Double2CharAVLTreeMap.Submap.this.top && Double2CharAVLTreeMap.this.compare(k, (this.prev = Double2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1706 */             this.next = null;
/*      */           } else {
/* 1708 */             this.next = Double2CharAVLTreeMap.this.locateKey(k);
/* 1709 */             if (Double2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1720 */         if (!Double2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Double2CharAVLTreeMap.this.compare(this.prev.key, Double2CharAVLTreeMap.Submap.this.from) < 0)
/* 1721 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1725 */         this.next = this.next.next();
/* 1726 */         if (!Double2CharAVLTreeMap.Submap.this.top && this.next != null && Double2CharAVLTreeMap.this.compare(this.next.key, Double2CharAVLTreeMap.Submap.this.to) >= 0)
/* 1727 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1807 */       c = (Double2CharAVLTreeMap)super.clone();
...
/* 1888 */     if (n == 1) {
/* 1889 */       Entry entry = new Entry(s.readDouble(), s.readChar());
...
/*      */ 
/*      */       
/* 1899 */       Entry entry = new Entry(s.readDouble(), s.readChar());
/* 1900 */       entry.right(new Entry(s.readDouble(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2CharAVLTreeMap.class
