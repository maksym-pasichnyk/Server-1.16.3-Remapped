...
/*      */   
/*      */   public boolean trim() {
/* 1132 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1133 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1134 */       return true; 
/*      */     try {
/* 1136 */       rehash(l);
...
/* 1164 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1165 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1166 */       return true; 
/*      */     try {
/* 1168 */       rehash(l);
/* 1169 */     } catch (OutOfMemoryError cantDoIt) {
/* 1170 */       return false;
/*      */     } 
/* 1172 */     return true;
/*      */   }
...
/* 1188 */     double[] key = this.key;
/* 1189 */     double[] value = this.value;
/* 1190 */     int mask = newN - 1;
/* 1191 */     double[] newKey = new double[newN + 1];
/* 1192 */     double[] newValue = new double[newN + 1];
/* 1193 */     int i = this.n;
/* 1194 */     for (int j = realSize(); j-- != 0; ) {
/* 1195 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1196 */       if (Double.doubleToLongBits(newKey[
/* 1197 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0L)
/* 1198 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); 
/* 1199 */       newKey[pos] = key[i];
/* 1200 */       newValue[pos] = value[i];
/*      */     } 
/* 1202 */     newValue[newN] = value[this.n];
/* 1203 */     this.n = newN;
/* 1204 */     this.mask = mask;
/* 1205 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1206 */     this.key = newKey;
/* 1207 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1224 */       c = (Double2DoubleOpenCustomHashMap)super.clone();
/* 1225 */     } catch (CloneNotSupportedException cantHappen) {
/* 1226 */       throw new InternalError();
/*      */     } 
/* 1228 */     c.keys = null;
/* 1229 */     c.values = null;
/* 1230 */     c.entries = null;
/* 1231 */     c.containsNullKey = this.containsNullKey;
/* 1232 */     c.key = (double[])this.key.clone();
/* 1233 */     c.value = (double[])this.value.clone();
/* 1234 */     c.strategy = this.strategy;
/* 1235 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1248 */     int h = 0;
/* 1249 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1250 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1251 */         i++; 
/* 1252 */       t = this.strategy.hashCode(this.key[i]);
/* 1253 */       t ^= HashCommon.double2int(this.value[i]);
/* 1254 */       h += t;
/* 1255 */       i++;
/*      */     } 
/*      */     
/* 1258 */     if (this.containsNullKey)
/* 1259 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1260 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1263 */     double[] key = this.key;
/* 1264 */     double[] value = this.value;
/* 1265 */     MapIterator i = new MapIterator();
/* 1266 */     s.defaultWriteObject();
/* 1267 */     for (int j = this.size; j-- != 0; ) {
/* 1268 */       int e = i.nextEntry();
/* 1269 */       s.writeDouble(key[e]);
/* 1270 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1275 */     s.defaultReadObject();
/* 1276 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1277 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1278 */     this.mask = this.n - 1;
/* 1279 */     double[] key = this.key = new double[this.n + 1];
/* 1280 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1283 */     for (int i = this.size; i-- != 0; ) {
/* 1284 */       int pos; double k = s.readDouble();
/* 1285 */       double v = s.readDouble();
/* 1286 */       if (this.strategy.equals(k, 0.0D)) {
/* 1287 */         pos = this.n;
/* 1288 */         this.containsNullKey = true;
/*      */       } else {
/* 1290 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1291 */         while (Double.doubleToLongBits(key[pos]) != 0L)
/* 1292 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1294 */       key[pos] = k;
/* 1295 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2DoubleOpenCustomHashMap.class
