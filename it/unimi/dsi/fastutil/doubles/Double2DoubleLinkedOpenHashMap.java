...
/*      */   
/*      */   public boolean trim() {
/* 1799 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1832 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1833 */       return true; 
/*      */     try {
/* 1835 */       rehash(l);
...
/* 1855 */     double[] key = this.key;
/* 1856 */     double[] value = this.value;
/* 1857 */     int mask = newN - 1;
/* 1858 */     double[] newKey = new double[newN + 1];
/* 1859 */     double[] newValue = new double[newN + 1];
/* 1860 */     int i = this.first, prev = -1, newPrev = -1;
/* 1861 */     long[] link = this.link;
/* 1862 */     long[] newLink = new long[newN + 1];
/* 1863 */     this.first = -1;
/* 1864 */     for (int j = this.size; j-- != 0; ) {
/* 1865 */       int pos; if (Double.doubleToLongBits(key[i]) == 0L) {
/* 1866 */         pos = newN;
/*      */       } else {
/* 1868 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask;
/* 1869 */         while (Double.doubleToLongBits(newKey[pos]) != 0L)
/* 1870 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1872 */       newKey[pos] = key[i];
/* 1873 */       newValue[pos] = value[i];
/* 1874 */       if (prev != -1) {
/* 1875 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1876 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1877 */         newPrev = pos;
/*      */       } else {
/* 1879 */         newPrev = this.first = pos;
/*      */         
/* 1881 */         newLink[pos] = -1L;
/*      */       } 
/* 1883 */       int t = i;
...
/* 1885 */       prev = t;
/*      */     } 
/* 1887 */     this.link = newLink;
/* 1888 */     this.last = newPrev;
/* 1889 */     if (newPrev != -1)
/*      */     {
/* 1891 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1892 */     this.n = newN;
/* 1893 */     this.mask = mask;
/* 1894 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1895 */     this.key = newKey;
/* 1896 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1913 */       c = (Double2DoubleLinkedOpenHashMap)super.clone();
/* 1914 */     } catch (CloneNotSupportedException cantHappen) {
/* 1915 */       throw new InternalError();
/*      */     } 
/* 1917 */     c.keys = null;
/* 1918 */     c.values = null;
/* 1919 */     c.entries = null;
/* 1920 */     c.containsNullKey = this.containsNullKey;
/* 1921 */     c.key = (double[])this.key.clone();
/* 1922 */     c.value = (double[])this.value.clone();
/* 1923 */     c.link = (long[])this.link.clone();
/* 1924 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1937 */     int h = 0;
/* 1938 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1939 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1940 */         i++; 
/* 1941 */       t = HashCommon.double2int(this.key[i]);
/* 1942 */       t ^= HashCommon.double2int(this.value[i]);
/* 1943 */       h += t;
/* 1944 */       i++;
/*      */     } 
/*      */     
/* 1947 */     if (this.containsNullKey)
/* 1948 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1949 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1952 */     double[] key = this.key;
/* 1953 */     double[] value = this.value;
/* 1954 */     MapIterator i = new MapIterator();
/* 1955 */     s.defaultWriteObject();
/* 1956 */     for (int j = this.size; j-- != 0; ) {
/* 1957 */       int e = i.nextEntry();
/* 1958 */       s.writeDouble(key[e]);
/* 1959 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1964 */     s.defaultReadObject();
/* 1965 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1966 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1967 */     this.mask = this.n - 1;
/* 1968 */     double[] key = this.key = new double[this.n + 1];
/* 1969 */     double[] value = this.value = new double[this.n + 1];
/* 1970 */     long[] link = this.link = new long[this.n + 1];
/* 1971 */     int prev = -1;
/* 1972 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1975 */     for (int i = this.size; i-- != 0; ) {
/* 1976 */       int pos; double k = s.readDouble();
/* 1977 */       double v = s.readDouble();
/* 1978 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1979 */         pos = this.n;
/* 1980 */         this.containsNullKey = true;
/*      */       } else {
/* 1982 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1983 */         while (Double.doubleToLongBits(key[pos]) != 0L)
/* 1984 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1986 */       key[pos] = k;
/* 1987 */       value[pos] = v;
/* 1988 */       if (this.first != -1) {
/* 1989 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1990 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1991 */         prev = pos; continue;
/*      */       } 
/* 1993 */       prev = this.first = pos;
/*      */       
/* 1995 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1998 */     this.last = prev;
/* 1999 */     if (prev != -1)
/*      */     {
/* 2001 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2DoubleLinkedOpenHashMap.class
