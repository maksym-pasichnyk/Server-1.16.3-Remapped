...
/*      */   
/*      */   public boolean trim() {
/* 1083 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1084 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1085 */       return true; 
/*      */     try {
/* 1087 */       rehash(l);
...
/* 1115 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1116 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1117 */       return true; 
/*      */     try {
/* 1119 */       rehash(l);
...
/* 1139 */     double[] key = this.key;
/* 1140 */     int mask = newN - 1;
/* 1141 */     double[] newKey = new double[newN + 1];
...
/* 1147 */       int pos; if (this.strategy.equals(key[i], 0.0D)) {
/* 1148 */         pos = newN;
/*      */       } else {
/* 1150 */         pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask;
/* 1151 */         while (Double.doubleToLongBits(newKey[pos]) != 0L)
/* 1152 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1154 */       newKey[pos] = key[i];
/* 1155 */       if (prev != -1) {
/* 1156 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1157 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1158 */         newPrev = pos;
/*      */       } else {
/* 1160 */         newPrev = this.first = pos;
/*      */         
/* 1162 */         newLink[pos] = -1L;
/*      */       } 
/* 1164 */       int t = i;
...
/* 1166 */       prev = t;
/*      */     } 
/* 1168 */     this.link = newLink;
/* 1169 */     this.last = newPrev;
/* 1170 */     if (newPrev != -1)
/*      */     {
/* 1172 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1173 */     this.n = newN;
/* 1174 */     this.mask = mask;
/* 1175 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1176 */     this.key = newKey;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1193 */       c = (DoubleLinkedOpenCustomHashSet)super.clone();
/* 1194 */     } catch (CloneNotSupportedException cantHappen) {
/* 1195 */       throw new InternalError();
/*      */     } 
/* 1197 */     c.key = (double[])this.key.clone();
/* 1198 */     c.containsNull = this.containsNull;
/* 1199 */     c.link = (long[])this.link.clone();
/* 1200 */     c.strategy = this.strategy;
/* 1201 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1214 */     int h = 0;
/* 1215 */     for (int j = realSize(), i = 0; j-- != 0; ) {
/* 1216 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1217 */         i++; 
/* 1218 */       h += this.strategy.hashCode(this.key[i]);
/* 1219 */       i++;
/*      */     } 
/*      */     
/* 1222 */     return h;
...
/* 1225 */     DoubleIterator i = iterator();
/* 1226 */     s.defaultWriteObject();
/* 1227 */     for (int j = this.size; j-- != 0;)
/* 1228 */       s.writeDouble(i.nextDouble()); 
/*      */   }
/*      */   
...
/* 1236 */     double[] key = this.key = new double[this.n + 1];
/* 1237 */     long[] link = this.link = new long[this.n + 1];
/* 1238 */     int prev = -1;
/* 1239 */     this.first = this.last = -1;
/*      */     
/* 1241 */     for (int i = this.size; i-- != 0; ) {
/* 1242 */       int pos; double k = s.readDouble();
/* 1243 */       if (this.strategy.equals(k, 0.0D)) {
/* 1244 */         pos = this.n;
/* 1245 */         this.containsNull = true;
/*      */       }
/* 1247 */       else if (Double.doubleToLongBits(key[
/* 1248 */             pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask]) != 0L) {
/* 1249 */         while (Double.doubleToLongBits(key[pos = pos + 1 & this.mask]) != 0L);
/*      */       } 
/* 1251 */       key[pos] = k;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\DoubleLinkedOpenCustomHashSet.class
