...
/* 134 */     this(a, 0L, DoubleBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 155 */     this(length);
/* 156 */     DoubleBigArrays.copy(a, offset, this.a, 0L, length);
...
/* 217 */     return wrap(a, DoubleBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       return; 
/* 230 */     this.a = DoubleBigArrays.forceCapacity(this.a, capacity, this.size);
/* 231 */     assert this.size <= DoubleBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 243 */     long oldLength = DoubleBigArrays.length(this.a);
...
/* 249 */       capacity = 10L;
/* 250 */     }  this.a = DoubleBigArrays.forceCapacity(this.a, capacity, this.size);
/* 251 */     assert this.size <= DoubleBigArrays.length(this.a);
/*     */   }
/*     */   
...
/* 258 */       DoubleBigArrays.copy(this.a, index, this.a, index + 1L, this.size - index); 
/* 259 */     DoubleBigArrays.set(this.a, index, k);
/* 260 */     this.size++;
/* 261 */     assert this.size <= DoubleBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public boolean add(double k) {
/* 265 */     grow(this.size + 1L);
/* 266 */     DoubleBigArrays.set(this.a, this.size++, k);
/* 267 */     if (!$assertionsDisabled && this.size > DoubleBigArrays.length(this.a)) throw new AssertionError(); 
/* 268 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 275 */     return DoubleBigArrays.get(this.a, index);
/*     */   }
/*     */   
/*     */   public long indexOf(double k) {
/* 279 */     for (long i = 0L; i < this.size; i++) {
/* 280 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(DoubleBigArrays.get(this.a, i)))
/* 281 */         return i; 
/* 282 */     }  return -1L;
/*     */   }
/*     */   
...
/* 287 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(DoubleBigArrays.get(this.a, i)))
/* 288 */         return i; 
/* 289 */     }  return -1L;
/*     */   }
/*     */   
...
/*     */     }
/* 296 */     double old = DoubleBigArrays.get(this.a, index);
/* 297 */     this.size--;
/* 298 */     if (index != this.size)
/* 299 */       DoubleBigArrays.copy(this.a, index + 1L, this.a, index, this.size - index); 
/* 300 */     assert this.size <= DoubleBigArrays.length(this.a);
/* 301 */     return old;
/*     */   }
/*     */   
...
/* 309 */     assert this.size <= DoubleBigArrays.length(this.a);
/* 310 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 317 */     double old = DoubleBigArrays.get(this.a, index);
/* 318 */     DoubleBigArrays.set(this.a, index, k);
/* 319 */     return old;
/*     */   }
/*     */   
...
/*     */   public void clear() {
/* 369 */     this.size = 0L;
/* 370 */     assert this.size <= DoubleBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public long size64() {
...
/* 378 */     if (size > DoubleBigArrays.length(this.a))
/* 379 */       ensureCapacity(size); 
/* 380 */     if (size > this.size)
/* 381 */       DoubleBigArrays.fill(this.a, this.size, size, 0.0D); 
/* 382 */     this.size = size;
/*     */   }
/*     */   
...
/* 414 */     long arrayLength = DoubleBigArrays.length(this.a);
/* 415 */     if (n >= arrayLength || this.size == arrayLength)
/*     */       return; 
/* 417 */     this.a = DoubleBigArrays.trim(this.a, Math.max(n, this.size));
/* 418 */     assert this.size <= DoubleBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 436 */     DoubleBigArrays.copy(this.a, from, a, offset, length);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 449 */     DoubleBigArrays.copy(this.a, to, this.a, from, this.size - to);
...
/* 467 */     DoubleBigArrays.ensureOffsetLength(a, offset, length);
/* 468 */     grow(this.size + length);
/* 469 */     DoubleBigArrays.copy(this.a, index, this.a, index + length, this.size - index);
/* 470 */     DoubleBigArrays.copy(a, offset, this.a, index, length);
...
/* 490 */           return DoubleBigArrays.get(DoubleBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public double previousDouble() {
/* 494 */           if (!hasPrevious())
/* 495 */             throw new NoSuchElementException(); 
/* 496 */           return DoubleBigArrays.get(DoubleBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 535 */     DoubleBigArrays.copy(this.a, 0L, c.a, 0L, this.size);
...
/* 558 */     double[][] a2 = l.a;
/* 559 */     while (s-- != 0L) {
/* 560 */       if (DoubleBigArrays.get(a1, s) != DoubleBigArrays.get(a2, s))
/* 561 */         return false; 
/* 562 */     }  return true;
/*     */   }
/*     */ 
...
/* 583 */       double e1 = DoubleBigArrays.get(a1, i);
/* 584 */       double e2 = DoubleBigArrays.get(a2, i); int r;
...
/* 593 */       s.writeDouble(DoubleBigArrays.get(this.a, i)); 
/*     */   }
/*     */   
...
/* 600 */       DoubleBigArrays.set(this.a, i, s.readDouble()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\DoubleBigArrayBigList.class
