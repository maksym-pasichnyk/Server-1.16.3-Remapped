...
/*      */   
/*      */   public boolean trim() {
/* 1017 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1018 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1019 */       return true; 
/*      */     try {
/* 1021 */       rehash(l);
/* 1022 */     } catch (OutOfMemoryError cantDoIt) {
/* 1023 */       return false;
/*      */     } 
/* 1025 */     return true;
/*      */   }
...
/* 1050 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1051 */       return true; 
/*      */     try {
/* 1053 */       rehash(l);
...
/* 1074 */     V[] value = this.value;
/* 1075 */     int mask = newN - 1;
/* 1076 */     double[] newKey = new double[newN + 1];
/* 1077 */     V[] newValue = (V[])new Object[newN + 1];
/* 1078 */     int i = this.n;
/* 1079 */     for (int j = realSize(); j-- != 0; ) {
/* 1080 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1081 */       if (Double.doubleToLongBits(newKey[
/* 1082 */             pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask]) != 0L)
/*      */       {
/* 1084 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); } 
...
/*      */     try {
/* 1110 */       c = (Double2ReferenceOpenHashMap<V>)super.clone();
...
/* 1118 */     c.key = (double[])this.key.clone();
...
/* 1135 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1136 */         i++; 
/* 1137 */       t = HashCommon.double2int(this.key[i]);
/* 1138 */       if (this != this.value[i])
/* 1139 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1140 */       h += t;
/* 1141 */       i++;
/*      */     } 
/*      */     
/* 1144 */     if (this.containsNullKey)
/* 1145 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1146 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1149 */     double[] key = this.key;
...
/* 1165 */     double[] key = this.key = new double[this.n + 1];
/* 1166 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1169 */     for (int i = this.size; i-- != 0; ) {
/* 1170 */       int pos; double k = s.readDouble();
/* 1171 */       V v = (V)s.readObject();
/* 1172 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1173 */         pos = this.n;
/* 1174 */         this.containsNullKey = true;
/*      */       } else {
/* 1176 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1177 */         while (Double.doubleToLongBits(key[pos]) != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ReferenceOpenHashMap.class
