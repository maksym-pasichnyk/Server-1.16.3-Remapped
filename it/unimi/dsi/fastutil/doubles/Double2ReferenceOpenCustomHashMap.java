...
/*      */   
/*      */   public boolean trim() {
/* 1049 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1082 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1083 */       return true; 
/*      */     try {
/* 1085 */       rehash(l);
...
/* 1105 */     double[] key = this.key;
/* 1106 */     V[] value = this.value;
/* 1107 */     int mask = newN - 1;
/* 1108 */     double[] newKey = new double[newN + 1];
/* 1109 */     V[] newValue = (V[])new Object[newN + 1];
/* 1110 */     int i = this.n;
/* 1111 */     for (int j = realSize(); j-- != 0; ) {
/* 1112 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1113 */       if (Double.doubleToLongBits(newKey[
/* 1114 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0L)
/* 1115 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); 
...
/*      */     try {
/* 1141 */       c = (Double2ReferenceOpenCustomHashMap<V>)super.clone();
...
/* 1149 */     c.key = (double[])this.key.clone();
/* 1150 */     c.value = (V[])this.value.clone();
/* 1151 */     c.strategy = this.strategy;
/* 1152 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1167 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1168 */         i++; 
/* 1169 */       t = this.strategy.hashCode(this.key[i]);
/* 1170 */       if (this != this.value[i])
/* 1171 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1172 */       h += t;
/* 1173 */       i++;
/*      */     } 
/*      */     
/* 1176 */     if (this.containsNullKey)
/* 1177 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1178 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1181 */     double[] key = this.key;
/* 1182 */     V[] value = this.value;
...
/* 1198 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1201 */     for (int i = this.size; i-- != 0; ) {
/* 1202 */       int pos; double k = s.readDouble();
/* 1203 */       V v = (V)s.readObject();
/* 1204 */       if (this.strategy.equals(k, 0.0D)) {
/* 1205 */         pos = this.n;
/* 1206 */         this.containsNullKey = true;
/*      */       } else {
/* 1208 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ReferenceOpenCustomHashMap.class
