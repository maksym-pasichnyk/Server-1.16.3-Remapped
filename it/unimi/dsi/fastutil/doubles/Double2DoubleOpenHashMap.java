...
/*      */   
/*      */   public boolean trim() {
/* 1104 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1136 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1137 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1138 */       return true; 
/*      */     try {
/* 1140 */       rehash(l);
/* 1141 */     } catch (OutOfMemoryError cantDoIt) {
/* 1142 */       return false;
/*      */     } 
/* 1144 */     return true;
/*      */   }
...
/* 1160 */     double[] key = this.key;
/* 1161 */     double[] value = this.value;
/* 1162 */     int mask = newN - 1;
/* 1163 */     double[] newKey = new double[newN + 1];
/* 1164 */     double[] newValue = new double[newN + 1];
/* 1165 */     int i = this.n;
/* 1166 */     for (int j = realSize(); j-- != 0; ) {
/* 1167 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1168 */       if (Double.doubleToLongBits(newKey[
/* 1169 */             pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask]) != 0L)
/*      */       {
/* 1171 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); } 
...
/*      */     try {
/* 1197 */       c = (Double2DoubleOpenHashMap)super.clone();
...
/* 1205 */     c.key = (double[])this.key.clone();
/* 1206 */     c.value = (double[])this.value.clone();
/* 1207 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1220 */     int h = 0;
/* 1221 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1222 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1223 */         i++; 
/* 1224 */       t = HashCommon.double2int(this.key[i]);
/* 1225 */       t ^= HashCommon.double2int(this.value[i]);
/* 1226 */       h += t;
/* 1227 */       i++;
/*      */     } 
/*      */     
/* 1230 */     if (this.containsNullKey)
/* 1231 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1232 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1235 */     double[] key = this.key;
/* 1236 */     double[] value = this.value;
/* 1237 */     MapIterator i = new MapIterator();
/* 1238 */     s.defaultWriteObject();
/* 1239 */     for (int j = this.size; j-- != 0; ) {
/* 1240 */       int e = i.nextEntry();
/* 1241 */       s.writeDouble(key[e]);
/* 1242 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1247 */     s.defaultReadObject();
/* 1248 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1249 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1250 */     this.mask = this.n - 1;
/* 1251 */     double[] key = this.key = new double[this.n + 1];
/* 1252 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1255 */     for (int i = this.size; i-- != 0; ) {
/* 1256 */       int pos; double k = s.readDouble();
/* 1257 */       double v = s.readDouble();
/* 1258 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1259 */         pos = this.n;
/* 1260 */         this.containsNullKey = true;
/*      */       } else {
/* 1262 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1263 */         while (Double.doubleToLongBits(key[pos]) != 0L)
/* 1264 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1266 */       key[pos] = k;
/* 1267 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2DoubleOpenHashMap.class
