...
/*  50 */     return (entries instanceof Double2ShortMap.FastEntrySet) ? (
/*  51 */       (Double2ShortMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Double2ShortMap.Entry> entries = map.double2ShortEntrySet();
/*  71 */     if (entries instanceof Double2ShortMap.FastEntrySet) {
/*  72 */       ((Double2ShortMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Double2ShortMap.Entry> entries = map.double2ShortEntrySet();
/*  91 */     return (entries instanceof Double2ShortMap.FastEntrySet) ? new ObjectIterable<Double2ShortMap.Entry>() {
/*     */         public ObjectIterator<Double2ShortMap.Entry> iterator() {
/*  93 */           return ((Double2ShortMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Double2ShortMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Double2ShortMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractDouble2ShortMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)double2ShortEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/*     */   
/*     */   public static Double2ShortMap singleton(Double key, Short value) {
/* 300 */     return new Singleton(key.doubleValue(), value.shortValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.double2ShortEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Short>> entrySet() {
/* 361 */       return (ObjectSet)double2ShortEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.double2ShortEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Short>> entrySet() {
/* 674 */       return (ObjectSet)double2ShortEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ShortMaps.class
