...
/*  78 */     if (capacity == 0) {
/*  79 */       this.a = DoubleArrays.EMPTY_ARRAY;
/*     */     } else {
/*  81 */       this.a = new double[capacity];
/*     */     } 
/*     */   }
/*     */   
/*     */   public DoubleArrayList() {
/*  86 */     this.a = DoubleArrays.DEFAULT_EMPTY_ARRAY;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  95 */     this(c.size());
/*  96 */     this.size = DoubleIterators.unwrap(DoubleIterators.asDoubleIterator(c.iterator()), this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */     this(c.size());
/* 107 */     this.size = DoubleIterators.unwrap(c.iterator(), this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 151 */     this();
/* 152 */     while (i.hasNext()) {
/* 153 */       add(((Double)i.next()).doubleValue());
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 194 */     DoubleArrayList l = new DoubleArrayList(a, false);
/* 195 */     l.size = length;
/* 196 */     return l;
/*     */   }
/*     */ 
...
/* 222 */     if (capacity <= this.a.length || this.a == DoubleArrays.DEFAULT_EMPTY_ARRAY)
/*     */       return; 
/* 224 */     this.a = DoubleArrays.ensureCapacity(this.a, capacity, this.size);
...
/* 274 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(this.a[i]))
/* 275 */         return i; 
/* 276 */     }  return -1;
/*     */   }
/*     */   
...
/* 281 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(this.a[i]))
/* 282 */         return i; 
/* 283 */     }  return -1;
/*     */   }
/*     */   
...
/* 329 */       Arrays.fill(this.a, this.size, size, 0.0D); 
/* 330 */     this.size = size;
/*     */   }
/*     */   
...
/*     */       return; 
/* 365 */     double[] t = new double[Math.max(n, this.size)];
...
/* 386 */     DoubleArrays.ensureOffsetLength(a, offset, length);
...
/* 418 */     DoubleArrays.ensureOffsetLength(a, offset, length);
...
/* 440 */     DoubleIterator i = c.iterator();
/* 441 */     this.size += n;
/* 442 */     while (n-- != 0)
/* 443 */       this.a[index++] = i.nextDouble(); 
...
/* 477 */       if (!c.contains(Double.valueOf(a[i])))
/* 478 */         a[j++] = a[i]; 
...
/* 486 */     return new DoubleListIterator() {
/* 487 */         int pos = index; int last = -1;
/*     */         
/*     */         public boolean hasNext() {
/* 490 */           return (this.pos < DoubleArrayList.this.size);
/*     */         }
/*     */         
...
/* 500 */           return DoubleArrayList.this.a[this.last = this.pos++];
/*     */         }
/*     */         
/*     */         public double previousDouble() {
/* 504 */           if (!hasPrevious())
/* 505 */             throw new NoSuchElementException(); 
/* 506 */           return DoubleArrayList.this.a[this.last = --this.pos];
/*     */         }
/*     */         
...
/* 518 */           DoubleArrayList.this.add(this.pos++, k);
/* 519 */           this.last = -1;
/*     */         }
/*     */         
...
/* 525 */           DoubleArrayList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 529 */           if (this.last == -1)
/* 530 */             throw new IllegalStateException(); 
/* 531 */           DoubleArrayList.this.removeDouble(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 544 */     DoubleArrayList c = new DoubleArrayList(this.size);
...
/* 589 */     double[] a1 = this.a, a2 = l.a;
/*     */     
/*     */     int i;
/* 592 */     for (i = 0; i < s1 && i < s2; i++) {
/* 593 */       double e1 = a1[i];
/* 594 */       double e2 = a2[i]; int r;
/* 595 */       if ((r = Double.compare(e1, e2)) != 0)
/* 596 */         return r; 
/*     */     } 
...
/* 603 */       s.writeDouble(this.a[i]); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 607 */     s.defaultReadObject();
/* 608 */     this.a = new double[this.size];
/* 609 */     for (int i = 0; i < this.size; i++)
/* 610 */       this.a[i] = s.readDouble(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\DoubleArrayList.class
