...
/*  910 */         return false; 
/*  911 */       Map.Entry<Double, Character> e = (Map.Entry<Double, Character>)o;
/*  912 */       return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && this.value == ((Character)e
...
/*  999 */     int index = 0;
/*      */     TreeIterator() {
/* 1001 */       this.next = Double2CharRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(double k) {
/* 1004 */       if ((this.next = Double2CharRBTreeMap.this.locateKey(k)) != null)
/* 1005 */         if (Double2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1056 */       updatePrevious();
/* 1057 */       updateNext();
/* 1058 */       Double2CharRBTreeMap.this.remove(this.curr.key);
/* 1059 */       this.curr = null;
/*      */     }
...
/* 1098 */       this.entries = (ObjectSortedSet<Double2CharMap.Entry>)new AbstractObjectSortedSet<Double2CharMap.Entry>()
/*      */         {
...
/* 1107 */             return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from) {
/* 1111 */             return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharRBTreeMap.EntryIterator(from.getDoubleKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1122 */               return false; 
/* 1123 */             Double2CharRBTreeMap.Entry f = Double2CharRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1135 */               return false; 
/* 1136 */             Double2CharRBTreeMap.Entry f = Double2CharRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1137 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1138 */               return false; 
/* 1139 */             Double2CharRBTreeMap.this.remove(f.key);
/* 1140 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1144 */             return Double2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1148 */             Double2CharRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Double2CharMap.Entry first() {
/* 1152 */             return Double2CharRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Double2CharMap.Entry last() {
/* 1156 */             return Double2CharRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry from, Double2CharMap.Entry to) {
/* 1161 */             return Double2CharRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry to) {
/* 1165 */             return Double2CharRBTreeMap.this.headMap(to.getDoubleKey()).double2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry from) {
/* 1169 */             return Double2CharRBTreeMap.this.tailMap(from.getDoubleKey()).double2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1203 */       return new Double2CharRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public DoubleBidirectionalIterator iterator(double from) {
/* 1207 */       return new Double2CharRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1259 */       this.values = (CharCollection)new AbstractCharCollection()
/*      */         {
/*      */           public CharIterator iterator() {
/* 1262 */             return (CharIterator)new Double2CharRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1266 */             return Double2CharRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1270 */             return Double2CharRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1274 */             Double2CharRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1337 */       if (!bottom && !top && Double2CharRBTreeMap.this.compare(from, to) > 0)
/* 1338 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1339 */       this.from = from;
/* 1340 */       this.bottom = bottom;
/* 1341 */       this.to = to;
/* 1342 */       this.top = top;
/* 1343 */       this.defRetValue = Double2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1361 */       return ((this.bottom || Double2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2CharRBTreeMap.this
/* 1362 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
/* 1366 */       if (this.entries == null)
/* 1367 */         this.entries = (ObjectSortedSet<Double2CharMap.Entry>)new AbstractObjectSortedSet<Double2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator() {
/* 1370 */               return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from) {
/* 1374 */               return (ObjectBidirectionalIterator<Double2CharMap.Entry>)new Double2CharRBTreeMap.Submap.SubmapEntryIterator(from.getDoubleKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Double2CharMap.Entry> comparator() {
/* 1378 */               return Double2CharRBTreeMap.this.double2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               if (e.getValue() == null || !(e.getValue() instanceof Character))
/* 1389 */                 return false; 
/* 1390 */               Double2CharRBTreeMap.Entry f = Double2CharRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1391 */               return (f != null && Double2CharRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1400 */                 return false; 
/* 1401 */               if (e.getValue() == null || !(e.getValue() instanceof Character))
/* 1402 */                 return false; 
/* 1403 */               Double2CharRBTreeMap.Entry f = Double2CharRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1404 */               if (f != null && Double2CharRBTreeMap.Submap.this.in(f.key))
/* 1405 */                 Double2CharRBTreeMap.Submap.this.remove(f.key); 
/* 1406 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1410 */               int c = 0;
/* 1411 */               for (ObjectBidirectionalIterator<Double2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1412 */                 c++; 
/* 1413 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1417 */               return !(new Double2CharRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1421 */               Double2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Double2CharMap.Entry first() {
/* 1425 */               return Double2CharRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Double2CharMap.Entry last() {
/* 1429 */               return Double2CharRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry from, Double2CharMap.Entry to) {
/* 1434 */               return Double2CharRBTreeMap.Submap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry to) {
/* 1438 */               return Double2CharRBTreeMap.Submap.this.headMap(to.getDoubleKey()).double2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry from) {
/* 1442 */               return Double2CharRBTreeMap.Submap.this.tailMap(from.getDoubleKey()).double2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractDouble2CharSortedMap.KeySet {
/*      */       public DoubleBidirectionalIterator iterator() {
/* 1450 */         return new Double2CharRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public DoubleBidirectionalIterator iterator(double from) {
/* 1454 */         return new Double2CharRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public DoubleSortedSet keySet() {
...
/* 1466 */         this.values = (CharCollection)new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1469 */               return (CharIterator)new Double2CharRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1473 */               return Double2CharRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1477 */               return Double2CharRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1481 */               Double2CharRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(double k) {
/* 1489 */       return (in(k) && Double2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/* 1496 */         char ev = (i.nextEntry()).value;
/* 1497 */         if (ev == v)
/* 1498 */           return true; 
/*      */       } 
/* 1500 */       return false;
...
/*      */     
/*      */     public char get(double k) {
/* 1506 */       double kk = k; Double2CharRBTreeMap.Entry e;
/* 1507 */       return (in(kk) && (e = Double2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(double k, char v) {
/* 1511 */       Double2CharRBTreeMap.this.modified = false;
/* 1512 */       if (!in(k))
...
/* 1515 */       char oldValue = Double2CharRBTreeMap.this.put(k, v);
/* 1516 */       return Double2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(double k) {
/* 1521 */       Double2CharRBTreeMap.this.modified = false;
/* 1522 */       if (!in(k))
/* 1523 */         return this.defRetValue; 
/* 1524 */       char oldValue = Double2CharRBTreeMap.this.remove(k);
/* 1525 */       return Double2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public DoubleComparator comparator() {
/* 1543 */       return Double2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Double2CharSortedMap headMap(double to) {
/* 1547 */       if (this.top)
/* 1548 */         return new Submap(this.from, this.bottom, to, false); 
/* 1549 */       return (Double2CharRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Double2CharSortedMap tailMap(double from) {
/* 1553 */       if (this.bottom)
/* 1554 */         return new Submap(from, false, this.to, this.top); 
/* 1555 */       return (Double2CharRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Double2CharSortedMap subMap(double from, double to) {
...
/* 1561 */       if (!this.top)
/* 1562 */         to = (Double2CharRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1563 */       if (!this.bottom)
/* 1564 */         from = (Double2CharRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1576 */       if (Double2CharRBTreeMap.this.tree == null) {
/* 1577 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1581 */       if (this.bottom) {
/* 1582 */         e = Double2CharRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1584 */         e = Double2CharRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1586 */         if (Double2CharRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1587 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1591 */       if (e == null || (!this.top && Double2CharRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1592 */         return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
...
/*      */       Double2CharRBTreeMap.Entry e;
/* 1602 */       if (Double2CharRBTreeMap.this.tree == null) {
/* 1603 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1607 */       if (this.top) {
/* 1608 */         e = Double2CharRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1610 */         e = Double2CharRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1612 */         if (Double2CharRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1613 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1617 */       if (e == null || (!this.bottom && Double2CharRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1618 */         return null; 
/* 1619 */       return e;
/*      */     }
/*      */     
/*      */     public double firstDoubleKey() {
/* 1623 */       Double2CharRBTreeMap.Entry e = firstEntry();
/* 1624 */       if (e == null)
...
/*      */     
/*      */     public double lastDoubleKey() {
/* 1630 */       Double2CharRBTreeMap.Entry e = lastEntry();
/* 1631 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1646 */         this.next = Double2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(double k) {
/* 1649 */         this();
/* 1650 */         if (this.next != null)
/* 1651 */           if (!Double2CharRBTreeMap.Submap.this.bottom && Double2CharRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1652 */             this.prev = null;
/* 1653 */           } else if (!Double2CharRBTreeMap.Submap.this.top && Double2CharRBTreeMap.this.compare(k, (this.prev = Double2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1654 */             this.next = null;
/*      */           } else {
/* 1656 */             this.next = Double2CharRBTreeMap.this.locateKey(k);
/* 1657 */             if (Double2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1668 */         if (!Double2CharRBTreeMap.Submap.this.bottom && this.prev != null && Double2CharRBTreeMap.this.compare(this.prev.key, Double2CharRBTreeMap.Submap.this.from) < 0)
/* 1669 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1673 */         this.next = this.next.next();
/* 1674 */         if (!Double2CharRBTreeMap.Submap.this.top && this.next != null && Double2CharRBTreeMap.this.compare(this.next.key, Double2CharRBTreeMap.Submap.this.to) >= 0)
/* 1675 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1755 */       c = (Double2CharRBTreeMap)super.clone();
...
/* 1836 */     if (n == 1) {
/* 1837 */       Entry entry = new Entry(s.readDouble(), s.readChar());
...
/*      */ 
/*      */       
/* 1848 */       Entry entry = new Entry(s.readDouble(), s.readChar());
/* 1849 */       entry.black(true);
/* 1850 */       entry.right(new Entry(s.readDouble(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2CharRBTreeMap.class
