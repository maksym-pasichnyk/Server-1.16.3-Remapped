...
/*      */   
/*      */   public boolean trim() {
/* 1735 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1768 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1769 */       return true; 
/*      */     try {
/* 1771 */       rehash(l);
...
/* 1791 */     double[] key = this.key;
/* 1792 */     char[] value = this.value;
/* 1793 */     int mask = newN - 1;
/* 1794 */     double[] newKey = new double[newN + 1];
/* 1795 */     char[] newValue = new char[newN + 1];
...
/* 1801 */       int pos; if (Double.doubleToLongBits(key[i]) == 0L) {
/* 1802 */         pos = newN;
/*      */       } else {
/* 1804 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask;
/* 1805 */         while (Double.doubleToLongBits(newKey[pos]) != 0L)
/* 1806 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1849 */       c = (Double2CharLinkedOpenHashMap)super.clone();
...
/* 1857 */     c.key = (double[])this.key.clone();
/* 1858 */     c.value = (char[])this.value.clone();
...
/* 1875 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1876 */         i++; 
/* 1877 */       t = HashCommon.double2int(this.key[i]);
/* 1878 */       t ^= this.value[i];
/* 1879 */       h += t;
/* 1880 */       i++;
/*      */     } 
...
/* 1904 */     double[] key = this.key = new double[this.n + 1];
/* 1905 */     char[] value = this.value = new char[this.n + 1];
...
/* 1912 */       int pos; double k = s.readDouble();
/* 1913 */       char v = s.readChar();
/* 1914 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1915 */         pos = this.n;
/* 1916 */         this.containsNullKey = true;
/*      */       } else {
/* 1918 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1919 */         while (Double.doubleToLongBits(key[pos]) != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2CharLinkedOpenHashMap.class
