...
/*      */   
/*      */   public boolean trim() {
/* 1705 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1737 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1738 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1739 */       return true; 
/*      */     try {
/* 1741 */       rehash(l);
/* 1742 */     } catch (OutOfMemoryError cantDoIt) {
/* 1743 */       return false;
/*      */     } 
/* 1745 */     return true;
/*      */   }
...
/* 1761 */     double[] key = this.key;
/* 1762 */     V[] value = this.value;
/* 1763 */     int mask = newN - 1;
/* 1764 */     double[] newKey = new double[newN + 1];
/* 1765 */     V[] newValue = (V[])new Object[newN + 1];
/* 1766 */     int i = this.first, prev = -1, newPrev = -1;
/* 1767 */     long[] link = this.link;
/* 1768 */     long[] newLink = new long[newN + 1];
/* 1769 */     this.first = -1;
/* 1770 */     for (int j = this.size; j-- != 0; ) {
/* 1771 */       int pos; if (Double.doubleToLongBits(key[i]) == 0L) {
/* 1772 */         pos = newN;
/*      */       } else {
/* 1774 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask;
/* 1775 */         while (Double.doubleToLongBits(newKey[pos]) != 0L)
/* 1776 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1778 */       newKey[pos] = key[i];
/* 1779 */       newValue[pos] = value[i];
/* 1780 */       if (prev != -1) {
/* 1781 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1782 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1783 */         newPrev = pos;
/*      */       } else {
/* 1785 */         newPrev = this.first = pos;
/*      */         
/* 1787 */         newLink[pos] = -1L;
/*      */       } 
/* 1789 */       int t = i;
...
/* 1791 */       prev = t;
/*      */     } 
/* 1793 */     this.link = newLink;
/* 1794 */     this.last = newPrev;
/* 1795 */     if (newPrev != -1)
/*      */     {
/* 1797 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1798 */     this.n = newN;
/* 1799 */     this.mask = mask;
/* 1800 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1801 */     this.key = newKey;
/* 1802 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1819 */       c = (Double2ReferenceLinkedOpenHashMap<V>)super.clone();
/* 1820 */     } catch (CloneNotSupportedException cantHappen) {
/* 1821 */       throw new InternalError();
/*      */     } 
/* 1823 */     c.keys = null;
/* 1824 */     c.values = null;
/* 1825 */     c.entries = null;
/* 1826 */     c.containsNullKey = this.containsNullKey;
/* 1827 */     c.key = (double[])this.key.clone();
/* 1828 */     c.value = (V[])this.value.clone();
/* 1829 */     c.link = (long[])this.link.clone();
/* 1830 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1843 */     int h = 0;
/* 1844 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1845 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1846 */         i++; 
/* 1847 */       t = HashCommon.double2int(this.key[i]);
/* 1848 */       if (this != this.value[i])
/* 1849 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1850 */       h += t;
/* 1851 */       i++;
/*      */     } 
/*      */     
/* 1854 */     if (this.containsNullKey)
/* 1855 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1856 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1859 */     double[] key = this.key;
/* 1860 */     V[] value = this.value;
/* 1861 */     MapIterator i = new MapIterator();
/* 1862 */     s.defaultWriteObject();
/* 1863 */     for (int j = this.size; j-- != 0; ) {
/* 1864 */       int e = i.nextEntry();
/* 1865 */       s.writeDouble(key[e]);
/* 1866 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1871 */     s.defaultReadObject();
/* 1872 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1873 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1874 */     this.mask = this.n - 1;
/* 1875 */     double[] key = this.key = new double[this.n + 1];
/* 1876 */     V[] value = this.value = (V[])new Object[this.n + 1];
/* 1877 */     long[] link = this.link = new long[this.n + 1];
/* 1878 */     int prev = -1;
/* 1879 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1882 */     for (int i = this.size; i-- != 0; ) {
/* 1883 */       int pos; double k = s.readDouble();
/* 1884 */       V v = (V)s.readObject();
/* 1885 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1886 */         pos = this.n;
/* 1887 */         this.containsNullKey = true;
/*      */       } else {
/* 1889 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1890 */         while (Double.doubleToLongBits(key[pos]) != 0L)
/* 1891 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1893 */       key[pos] = k;
/* 1894 */       value[pos] = v;
/* 1895 */       if (this.first != -1) {
/* 1896 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1897 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1898 */         prev = pos; continue;
/*      */       } 
/* 1900 */       prev = this.first = pos;
/*      */       
/* 1902 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1905 */     this.last = prev;
/* 1906 */     if (prev != -1)
/*      */     {
/* 1908 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ReferenceLinkedOpenHashMap.class
