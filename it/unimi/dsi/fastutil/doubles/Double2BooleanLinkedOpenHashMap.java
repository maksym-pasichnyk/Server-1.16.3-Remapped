...
/*      */   
/*      */   public boolean trim() {
/* 1736 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1737 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1738 */       return true; 
/*      */     try {
/* 1740 */       rehash(l);
/* 1741 */     } catch (OutOfMemoryError cantDoIt) {
/* 1742 */       return false;
/*      */     } 
/* 1744 */     return true;
/*      */   }
...
/* 1769 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1770 */       return true; 
/*      */     try {
/* 1772 */       rehash(l);
...
/* 1792 */     double[] key = this.key;
/* 1793 */     boolean[] value = this.value;
/* 1794 */     int mask = newN - 1;
/* 1795 */     double[] newKey = new double[newN + 1];
/* 1796 */     boolean[] newValue = new boolean[newN + 1];
...
/* 1802 */       int pos; if (Double.doubleToLongBits(key[i]) == 0L) {
/* 1803 */         pos = newN;
/*      */       } else {
/* 1805 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask;
/* 1806 */         while (Double.doubleToLongBits(newKey[pos]) != 0L)
/* 1807 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1850 */       c = (Double2BooleanLinkedOpenHashMap)super.clone();
...
/* 1858 */     c.key = (double[])this.key.clone();
/* 1859 */     c.value = (boolean[])this.value.clone();
...
/* 1876 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1877 */         i++; 
/* 1878 */       t = HashCommon.double2int(this.key[i]);
/* 1879 */       t ^= this.value[i] ? 1231 : 1237;
/* 1880 */       h += t;
/* 1881 */       i++;
/*      */     } 
/*      */     
/* 1884 */     if (this.containsNullKey)
/* 1885 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1886 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1889 */     double[] key = this.key;
/* 1890 */     boolean[] value = this.value;
/* 1891 */     MapIterator i = new MapIterator();
/* 1892 */     s.defaultWriteObject();
/* 1893 */     for (int j = this.size; j-- != 0; ) {
/* 1894 */       int e = i.nextEntry();
/* 1895 */       s.writeDouble(key[e]);
/* 1896 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1905 */     double[] key = this.key = new double[this.n + 1];
/* 1906 */     boolean[] value = this.value = new boolean[this.n + 1];
...
/* 1913 */       int pos; double k = s.readDouble();
/* 1914 */       boolean v = s.readBoolean();
/* 1915 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1916 */         pos = this.n;
/* 1917 */         this.containsNullKey = true;
/*      */       } else {
/* 1919 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1920 */         while (Double.doubleToLongBits(key[pos]) != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2BooleanLinkedOpenHashMap.class
