...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Double2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Double2DoubleFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Double2DoubleFunction singleton(Double key, Double value) {
/* 161 */     return new Singleton(key.doubleValue(), value.doubleValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Double2DoubleFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractDouble2DoubleFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2DoubleFunction function;
/*     */     
...
/* 462 */       Double v = this.function.apply(Double.valueOf(key));
/* 463 */       if (v == null)
...
/* 506 */     if (f instanceof Double2DoubleFunction)
/* 507 */       return (Double2DoubleFunction)f; 
/* 508 */     if (f instanceof DoubleUnaryOperator) {
/* 509 */       Objects.requireNonNull((DoubleUnaryOperator)f); return (DoubleUnaryOperator)f::applyAsDouble;
/* 510 */     }  return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2DoubleFunctions.class
