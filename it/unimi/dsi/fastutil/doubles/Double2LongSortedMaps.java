...
/*  61 */     return (entries instanceof Double2LongSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Double2LongSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Double2LongMap.Entry> entries = map.double2LongEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Double2LongSortedMap.FastSortedEntrySet)entries); return (entries instanceof Double2LongSortedMap.FastSortedEntrySet) ? (Double2LongSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Double2LongMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Double2LongMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Double, Long>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Double2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2LongSortedMap headMap(double to) {
/* 132 */       return Double2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2LongSortedMap tailMap(double from) {
/* 137 */       return Double2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Double2LongMap.Entry>)ObjectSortedSets.singleton(new AbstractDouble2LongMap.BasicEntry(this.key, this.value), 
/* 237 */             Double2LongSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Double2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Double, Long>> entrySet() {
/* 249 */       return (ObjectSortedSet)double2LongEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Double2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2LongSortedMap headMap(double to) {
...
/* 268 */         return this; 
/* 269 */       return Double2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2LongSortedMap tailMap(double from) {
...
/* 275 */         return this; 
/* 276 */       return Double2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public double firstDoubleKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.doubleValue(), value.longValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Double2LongMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.double2LongEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Double2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Double, Long>> entrySet() {
/* 449 */       return (ObjectSortedSet)double2LongEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Double2LongMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.double2LongEntrySet()); 
/* 582 */       return (ObjectSortedSet<Double2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2LongSortedMaps.class
