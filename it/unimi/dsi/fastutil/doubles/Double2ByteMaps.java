...
/*  50 */     return (entries instanceof Double2ByteMap.FastEntrySet) ? (
/*  51 */       (Double2ByteMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Double2ByteMap.Entry> entries = map.double2ByteEntrySet();
/*  71 */     if (entries instanceof Double2ByteMap.FastEntrySet) {
/*  72 */       ((Double2ByteMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Double2ByteMap.Entry> entries = map.double2ByteEntrySet();
/*  91 */     return (entries instanceof Double2ByteMap.FastEntrySet) ? new ObjectIterable<Double2ByteMap.Entry>() {
/*     */         public ObjectIterator<Double2ByteMap.Entry> iterator() {
/*  93 */           return ((Double2ByteMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Double2ByteMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Double2ByteMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractDouble2ByteMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)double2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/*     */   
/*     */   public static Double2ByteMap singleton(Double key, Byte value) {
/* 300 */     return new Singleton(key.doubleValue(), value.byteValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.double2ByteEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Byte>> entrySet() {
/* 361 */       return (ObjectSet)double2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.double2ByteEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Byte>> entrySet() {
/* 674 */       return (ObjectSet)double2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteMaps.class
