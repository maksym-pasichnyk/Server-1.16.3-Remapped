...
/* 1186 */     byte[] value = this.value;
/* 1187 */     int mask = newN - 1;
/* 1188 */     double[] newKey = new double[newN + 1];
/* 1189 */     byte[] newValue = new byte[newN + 1];
/* 1190 */     int i = this.n;
...
/*      */     try {
/* 1221 */       c = (Double2ByteOpenCustomHashMap)super.clone();
...
/* 1230 */     c.value = (byte[])this.value.clone();
...
/* 1277 */     byte[] value = this.value = new byte[this.n + 1];
/*      */ 
/*      */     
/* 1280 */     for (int i = this.size; i-- != 0; ) {
/* 1281 */       int pos; double k = s.readDouble();
/* 1282 */       byte v = s.readByte();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteOpenCustomHashMap.class
