...
/*  562 */     Byte newValue = remappingFunction.apply(Double.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  577 */     int pos = find(k);
/*  578 */     Byte newValue = remappingFunction.apply(Double.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  654 */       return Double2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/*  658 */       return Double2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/*  662 */       byte oldValue = Double2ByteOpenHashMap.this.value[this.index];
/*  663 */       Double2ByteOpenHashMap.this.value[this.index] = v;
/*  664 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  674 */       return Double.valueOf(Double2ByteOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  684 */       return Byte.valueOf(Double2ByteOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  700 */         return false; 
/*  701 */       Map.Entry<Double, Byte> e = (Map.Entry<Double, Byte>)o;
/*  702 */       return (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(((Double)e.getKey()).doubleValue()) && Double2ByteOpenHashMap.this.value[this.index] == ((Byte)e
/*  703 */         .getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  707 */       return HashCommon.double2int(Double2ByteOpenHashMap.this.key[this.index]) ^ Double2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  711 */       return Double2ByteOpenHashMap.this.key[this.index] + "=>" + Double2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  721 */     int pos = Double2ByteOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  728 */     int last = -1;
/*      */     
/*  730 */     int c = Double2ByteOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  734 */     boolean mustReturnNullKey = Double2ByteOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  749 */         return this.last = Double2ByteOpenHashMap.this.n;
/*      */       } 
/*  751 */       double[] key = Double2ByteOpenHashMap.this.key;
/*      */       while (true) {
/*  753 */         if (--this.pos < 0) {
/*      */           
/*  755 */           this.last = Integer.MIN_VALUE;
/*  756 */           double k = this.wrapped.getDouble(-this.pos - 1);
/*  757 */           int p = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ByteOpenHashMap.this.mask;
/*  758 */           while (Double.doubleToLongBits(k) != Double.doubleToLongBits(key[p]))
/*  759 */             p = p + 1 & Double2ByteOpenHashMap.this.mask; 
/*  760 */           return p;
/*      */         } 
...
/*  777 */       double[] key = Double2ByteOpenHashMap.this.key; while (true) {
/*      */         double curr; int last;
/*  779 */         pos = (last = pos) + 1 & Double2ByteOpenHashMap.this.mask;
/*      */         while (true) {
/*  781 */           if (Double.doubleToLongBits(curr = key[pos]) == 0L) {
/*  782 */             key[last] = 0.0D;
/*      */             return;
/*      */           } 
/*  785 */           int slot = (int)HashCommon.mix(Double.doubleToRawLongBits(curr)) & Double2ByteOpenHashMap.this.mask;
/*  786 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  788 */           pos = pos + 1 & Double2ByteOpenHashMap.this.mask;
/*      */         } 
/*  790 */         if (pos < last) {
...
/*      */         } 
/*  795 */         key[last] = curr;
/*  796 */         Double2ByteOpenHashMap.this.value[last] = Double2ByteOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  800 */       if (this.last == -1)
/*  801 */         throw new IllegalStateException(); 
/*  802 */       if (this.last == Double2ByteOpenHashMap.this.n) {
/*  803 */         Double2ByteOpenHashMap.this.containsNullKey = false;
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Double2ByteMap.Entry> { private Double2ByteOpenHashMap.MapEntry entry;
/*      */     
/*      */     public Double2ByteOpenHashMap.MapEntry next() {
/*  828 */       return this.entry = new Double2ByteOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  837 */       this.entry = new Double2ByteOpenHashMap.MapEntry();
...
/*  847 */       return new Double2ByteOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Double2ByteMap.Entry> fastIterator() {
/*  851 */       return new Double2ByteOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  860 */         return false; 
/*  861 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/*  862 */         return false; 
/*  863 */       double k = ((Double)e.getKey()).doubleValue();
/*  864 */       byte v = ((Byte)e.getValue()).byteValue();
/*  865 */       if (Double.doubleToLongBits(k) == 0L) {
/*  866 */         return (Double2ByteOpenHashMap.this.containsNullKey && Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n] == v);
/*      */       }
/*  868 */       double[] key = Double2ByteOpenHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/*  871 */       if (Double.doubleToLongBits(
/*  872 */           curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ByteOpenHashMap.this.mask]) == 0L)
/*      */       {
/*  874 */         return false; } 
/*  875 */       if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) {
/*  876 */         return (Double2ByteOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  879 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ByteOpenHashMap.this.mask]) == 0L)
/*  880 */           return false; 
/*  881 */         if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) {
/*  882 */           return (Double2ByteOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  892 */         return false; 
/*  893 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/*  894 */         return false; 
/*  895 */       double k = ((Double)e.getKey()).doubleValue();
/*  896 */       byte v = ((Byte)e.getValue()).byteValue();
/*  897 */       if (Double.doubleToLongBits(k) == 0L) {
/*  898 */         if (Double2ByteOpenHashMap.this.containsNullKey && Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n] == v) {
/*  899 */           Double2ByteOpenHashMap.this.removeNullEntry();
/*  900 */           return true;
/*      */         } 
/*  902 */         return false;
/*      */       } 
/*      */       
/*  905 */       double[] key = Double2ByteOpenHashMap.this.key;
/*      */       double curr;
/*      */       int pos;
/*  908 */       if (Double.doubleToLongBits(
/*  909 */           curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ByteOpenHashMap.this.mask]) == 0L)
/*      */       {
/*  911 */         return false; } 
/*  912 */       if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k)) {
/*  913 */         if (Double2ByteOpenHashMap.this.value[pos] == v) {
/*  914 */           Double2ByteOpenHashMap.this.removeEntry(pos);
/*  915 */           return true;
/*      */         } 
/*  917 */         return false;
/*      */       } 
/*      */       while (true) {
/*  920 */         if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ByteOpenHashMap.this.mask]) == 0L)
/*  921 */           return false; 
/*  922 */         if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k) && 
/*  923 */           Double2ByteOpenHashMap.this.value[pos] == v) {
/*  924 */           Double2ByteOpenHashMap.this.removeEntry(pos);
/*  925 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  932 */       return Double2ByteOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  936 */       Double2ByteOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Double2ByteMap.Entry> consumer) {
/*  941 */       if (Double2ByteOpenHashMap.this.containsNullKey)
/*  942 */         consumer.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n], Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n])); 
/*  943 */       for (int pos = Double2ByteOpenHashMap.this.n; pos-- != 0;) {
/*  944 */         if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[pos]) != 0L)
/*  945 */           consumer.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteOpenHashMap.this.key[pos], Double2ByteOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Double2ByteMap.Entry> consumer) {
/*  950 */       AbstractDouble2ByteMap.BasicEntry entry = new AbstractDouble2ByteMap.BasicEntry();
/*  951 */       if (Double2ByteOpenHashMap.this.containsNullKey) {
/*  952 */         entry.key = Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n];
/*  953 */         entry.value = Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n];
/*  954 */         consumer.accept(entry);
/*      */       } 
/*  956 */       for (int pos = Double2ByteOpenHashMap.this.n; pos-- != 0;) {
/*  957 */         if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[pos]) != 0L) {
/*  958 */           entry.key = Double2ByteOpenHashMap.this.key[pos];
/*  959 */           entry.value = Double2ByteOpenHashMap.this.value[pos];
...
/*  985 */       return Double2ByteOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractDoubleSet { private KeySet() {}
/*      */     
/*      */     public DoubleIterator iterator() {
/*  991 */       return new Double2ByteOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(DoubleConsumer consumer) {
/*  996 */       if (Double2ByteOpenHashMap.this.containsNullKey)
/*  997 */         consumer.accept(Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n]); 
/*  998 */       for (int pos = Double2ByteOpenHashMap.this.n; pos-- != 0; ) {
/*  999 */         double k = Double2ByteOpenHashMap.this.key[pos];
...
/*      */     
/*      */     public int size() {
/* 1006 */       return Double2ByteOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(double k) {
/* 1010 */       return Double2ByteOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(double k) {
/* 1014 */       int oldSize = Double2ByteOpenHashMap.this.size;
/* 1015 */       Double2ByteOpenHashMap.this.remove(k);
/* 1016 */       return (Double2ByteOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1020 */       Double2ByteOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1044 */       return Double2ByteOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public ByteCollection values() {
/* 1049 */     if (this.values == null)
/* 1050 */       this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1053 */             return new Double2ByteOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1057 */             return Double2ByteOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1061 */             return Double2ByteOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1065 */             Double2ByteOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1070 */             if (Double2ByteOpenHashMap.this.containsNullKey)
/* 1071 */               consumer.accept(Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n]); 
/* 1072 */             for (int pos = Double2ByteOpenHashMap.this.n; pos-- != 0;) {
/* 1073 */               if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[pos]) != 0L)
/* 1074 */                 consumer.accept(Double2ByteOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */   
/*      */   public boolean trim() {
/* 1094 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1095 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1096 */       return true; 
/*      */     try {
/* 1098 */       rehash(l);
/* 1099 */     } catch (OutOfMemoryError cantDoIt) {
/* 1100 */       return false;
/*      */     } 
/* 1102 */     return true;
/*      */   }
...
/* 1126 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1127 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1128 */       return true; 
/*      */     try {
/* 1130 */       rehash(l);
/* 1131 */     } catch (OutOfMemoryError cantDoIt) {
/* 1132 */       return false;
/*      */     } 
/* 1134 */     return true;
/*      */   }
...
/* 1150 */     double[] key = this.key;
/* 1151 */     byte[] value = this.value;
/* 1152 */     int mask = newN - 1;
/* 1153 */     double[] newKey = new double[newN + 1];
/* 1154 */     byte[] newValue = new byte[newN + 1];
/* 1155 */     int i = this.n;
/* 1156 */     for (int j = realSize(); j-- != 0; ) {
/* 1157 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1158 */       if (Double.doubleToLongBits(newKey[
/* 1159 */             pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask]) != 0L)
/*      */       {
/* 1161 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); } 
/* 1162 */       newKey[pos] = key[i];
/* 1163 */       newValue[pos] = value[i];
/*      */     } 
/* 1165 */     newValue[newN] = value[this.n];
/* 1166 */     this.n = newN;
/* 1167 */     this.mask = mask;
/* 1168 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1169 */     this.key = newKey;
/* 1170 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1187 */       c = (Double2ByteOpenHashMap)super.clone();
/* 1188 */     } catch (CloneNotSupportedException cantHappen) {
/* 1189 */       throw new InternalError();
/*      */     } 
/* 1191 */     c.keys = null;
/* 1192 */     c.values = null;
/* 1193 */     c.entries = null;
/* 1194 */     c.containsNullKey = this.containsNullKey;
/* 1195 */     c.key = (double[])this.key.clone();
/* 1196 */     c.value = (byte[])this.value.clone();
/* 1197 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1210 */     int h = 0;
/* 1211 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1212 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1213 */         i++; 
/* 1214 */       t = HashCommon.double2int(this.key[i]);
/* 1215 */       t ^= this.value[i];
/* 1216 */       h += t;
/* 1217 */       i++;
/*      */     } 
/*      */     
/* 1220 */     if (this.containsNullKey)
/* 1221 */       h += this.value[this.n]; 
/* 1222 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1225 */     double[] key = this.key;
/* 1226 */     byte[] value = this.value;
/* 1227 */     MapIterator i = new MapIterator();
/* 1228 */     s.defaultWriteObject();
/* 1229 */     for (int j = this.size; j-- != 0; ) {
/* 1230 */       int e = i.nextEntry();
/* 1231 */       s.writeDouble(key[e]);
/* 1232 */       s.writeByte(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1237 */     s.defaultReadObject();
/* 1238 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1239 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1240 */     this.mask = this.n - 1;
/* 1241 */     double[] key = this.key = new double[this.n + 1];
/* 1242 */     byte[] value = this.value = new byte[this.n + 1];
/*      */ 
/*      */     
/* 1245 */     for (int i = this.size; i-- != 0; ) {
/* 1246 */       int pos; double k = s.readDouble();
/* 1247 */       byte v = s.readByte();
/* 1248 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1249 */         pos = this.n;
/* 1250 */         this.containsNullKey = true;
/*      */       } else {
/* 1252 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1253 */         while (Double.doubleToLongBits(key[pos]) != 0L)
/* 1254 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1256 */       key[pos] = k;
/* 1257 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteOpenHashMap.class
