...
/*      */   
/*      */   public boolean trim() {
/* 1098 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1130 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1131 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1132 */       return true; 
/*      */     try {
/* 1134 */       rehash(l);
...
/* 1154 */     double[] key = this.key;
/* 1155 */     float[] value = this.value;
/* 1156 */     int mask = newN - 1;
/* 1157 */     double[] newKey = new double[newN + 1];
/* 1158 */     float[] newValue = new float[newN + 1];
/* 1159 */     int i = this.n;
/* 1160 */     for (int j = realSize(); j-- != 0; ) {
/* 1161 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1162 */       if (Double.doubleToLongBits(newKey[
/* 1163 */             pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask]) != 0L)
/*      */       {
/* 1165 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); } 
/* 1166 */       newKey[pos] = key[i];
/* 1167 */       newValue[pos] = value[i];
/*      */     } 
/* 1169 */     newValue[newN] = value[this.n];
/* 1170 */     this.n = newN;
/* 1171 */     this.mask = mask;
/* 1172 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1173 */     this.key = newKey;
/* 1174 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1191 */       c = (Double2FloatOpenHashMap)super.clone();
...
/* 1196 */     c.values = null;
/* 1197 */     c.entries = null;
/* 1198 */     c.containsNullKey = this.containsNullKey;
/* 1199 */     c.key = (double[])this.key.clone();
/* 1200 */     c.value = (float[])this.value.clone();
/* 1201 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1214 */     int h = 0;
/* 1215 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1216 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1217 */         i++; 
/* 1218 */       t = HashCommon.double2int(this.key[i]);
/* 1219 */       t ^= HashCommon.float2int(this.value[i]);
/* 1220 */       h += t;
/* 1221 */       i++;
/*      */     } 
/*      */     
/* 1224 */     if (this.containsNullKey)
/* 1225 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1226 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1229 */     double[] key = this.key;
/* 1230 */     float[] value = this.value;
/* 1231 */     MapIterator i = new MapIterator();
/* 1232 */     s.defaultWriteObject();
/* 1233 */     for (int j = this.size; j-- != 0; ) {
/* 1234 */       int e = i.nextEntry();
/* 1235 */       s.writeDouble(key[e]);
/* 1236 */       s.writeFloat(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1241 */     s.defaultReadObject();
/* 1242 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1243 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1244 */     this.mask = this.n - 1;
/* 1245 */     double[] key = this.key = new double[this.n + 1];
/* 1246 */     float[] value = this.value = new float[this.n + 1];
/*      */ 
/*      */     
/* 1249 */     for (int i = this.size; i-- != 0; ) {
/* 1250 */       int pos; double k = s.readDouble();
/* 1251 */       float v = s.readFloat();
/* 1252 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1253 */         pos = this.n;
/* 1254 */         this.containsNullKey = true;
/*      */       } else {
/* 1256 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1257 */         while (Double.doubleToLongBits(key[pos]) != 0L)
/* 1258 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1260 */       key[pos] = k;
/* 1261 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2FloatOpenHashMap.class
