...
/*  61 */     return (entries instanceof Double2ByteSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Double2ByteSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Double2ByteMap.Entry> entries = map.double2ByteEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Double2ByteSortedMap.FastSortedEntrySet)entries); return (entries instanceof Double2ByteSortedMap.FastSortedEntrySet) ? (Double2ByteSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Double2ByteMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Double2ByteMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Double, Byte>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Double2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2ByteSortedMap headMap(double to) {
/* 132 */       return Double2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2ByteSortedMap tailMap(double from) {
/* 137 */       return Double2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Double2ByteMap.Entry>)ObjectSortedSets.singleton(new AbstractDouble2ByteMap.BasicEntry(this.key, this.value), 
/* 237 */             Double2ByteSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Double2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Double, Byte>> entrySet() {
/* 249 */       return (ObjectSortedSet)double2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Double2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2ByteSortedMap headMap(double to) {
...
/* 268 */         return this; 
/* 269 */       return Double2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Double2ByteSortedMap tailMap(double from) {
...
/* 275 */         return this; 
/* 276 */       return Double2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public double firstDoubleKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.doubleValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Double2ByteMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.double2ByteEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Double2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Double, Byte>> entrySet() {
/* 449 */       return (ObjectSortedSet)double2ByteEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Double2ByteMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.double2ByteEntrySet()); 
/* 582 */       return (ObjectSortedSet<Double2ByteMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteSortedMaps.class
