...
/* 1152 */     int[] value = this.value;
/* 1153 */     int mask = newN - 1;
/* 1154 */     double[] newKey = new double[newN + 1];
/* 1155 */     int[] newValue = new int[newN + 1];
/* 1156 */     int i = this.n;
...
/*      */     try {
/* 1188 */       c = (Double2IntOpenHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2IntOpenHashMap.class
