...
/*      */   
/*      */   public boolean trim() {
/* 1792 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1824 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 1825 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1826 */       return true; 
/*      */     try {
/* 1828 */       rehash(l);
/* 1829 */     } catch (OutOfMemoryError cantDoIt) {
/* 1830 */       return false;
/*      */     } 
/* 1832 */     return true;
/*      */   }
...
/* 1848 */     double[] key = this.key;
/* 1849 */     int[] value = this.value;
/* 1850 */     int mask = newN - 1;
/* 1851 */     double[] newKey = new double[newN + 1];
/* 1852 */     int[] newValue = new int[newN + 1];
/* 1853 */     int i = this.first, prev = -1, newPrev = -1;
/* 1854 */     long[] link = this.link;
/* 1855 */     long[] newLink = new long[newN + 1];
/* 1856 */     this.first = -1;
/* 1857 */     for (int j = this.size; j-- != 0; ) {
/* 1858 */       int pos; if (Double.doubleToLongBits(key[i]) == 0L) {
/* 1859 */         pos = newN;
/*      */       } else {
/* 1861 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask;
/* 1862 */         while (Double.doubleToLongBits(newKey[pos]) != 0L)
/* 1863 */           pos = pos + 1 & mask; 
/*      */       } 
/* 1865 */       newKey[pos] = key[i];
/* 1866 */       newValue[pos] = value[i];
/* 1867 */       if (prev != -1) {
/* 1868 */         newLink[newPrev] = newLink[newPrev] ^ (newLink[newPrev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1869 */         newLink[pos] = newLink[pos] ^ (newLink[pos] ^ (newPrev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1870 */         newPrev = pos;
/*      */       } else {
/* 1872 */         newPrev = this.first = pos;
/*      */         
/* 1874 */         newLink[pos] = -1L;
/*      */       } 
/* 1876 */       int t = i;
...
/* 1878 */       prev = t;
/*      */     } 
/* 1880 */     this.link = newLink;
/* 1881 */     this.last = newPrev;
/* 1882 */     if (newPrev != -1)
/*      */     {
/* 1884 */       newLink[newPrev] = newLink[newPrev] | 0xFFFFFFFFL; } 
/* 1885 */     this.n = newN;
/* 1886 */     this.mask = mask;
/* 1887 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1888 */     this.key = newKey;
/* 1889 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1906 */       c = (Double2IntLinkedOpenHashMap)super.clone();
/* 1907 */     } catch (CloneNotSupportedException cantHappen) {
/* 1908 */       throw new InternalError();
/*      */     } 
/* 1910 */     c.keys = null;
/* 1911 */     c.values = null;
/* 1912 */     c.entries = null;
/* 1913 */     c.containsNullKey = this.containsNullKey;
/* 1914 */     c.key = (double[])this.key.clone();
/* 1915 */     c.value = (int[])this.value.clone();
/* 1916 */     c.link = (long[])this.link.clone();
/* 1917 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1930 */     int h = 0;
/* 1931 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1932 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1933 */         i++; 
/* 1934 */       t = HashCommon.double2int(this.key[i]);
/* 1935 */       t ^= this.value[i];
/* 1936 */       h += t;
/* 1937 */       i++;
/*      */     } 
/*      */     
/* 1940 */     if (this.containsNullKey)
/* 1941 */       h += this.value[this.n]; 
/* 1942 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1945 */     double[] key = this.key;
/* 1946 */     int[] value = this.value;
/* 1947 */     MapIterator i = new MapIterator();
/* 1948 */     s.defaultWriteObject();
/* 1949 */     for (int j = this.size; j-- != 0; ) {
/* 1950 */       int e = i.nextEntry();
/* 1951 */       s.writeDouble(key[e]);
/* 1952 */       s.writeInt(value[e]);
/*      */     } 
/*      */   }
/*      */   
/*      */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 1957 */     s.defaultReadObject();
/* 1958 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 1959 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1960 */     this.mask = this.n - 1;
/* 1961 */     double[] key = this.key = new double[this.n + 1];
/* 1962 */     int[] value = this.value = new int[this.n + 1];
/* 1963 */     long[] link = this.link = new long[this.n + 1];
/* 1964 */     int prev = -1;
/* 1965 */     this.first = this.last = -1;
/*      */ 
/*      */     
/* 1968 */     for (int i = this.size; i-- != 0; ) {
/* 1969 */       int pos; double k = s.readDouble();
/* 1970 */       int v = s.readInt();
/* 1971 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1972 */         pos = this.n;
/* 1973 */         this.containsNullKey = true;
/*      */       } else {
/* 1975 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1976 */         while (Double.doubleToLongBits(key[pos]) != 0L)
/* 1977 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1979 */       key[pos] = k;
/* 1980 */       value[pos] = v;
/* 1981 */       if (this.first != -1) {
/* 1982 */         link[prev] = link[prev] ^ (link[prev] ^ pos & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1983 */         link[pos] = link[pos] ^ (link[pos] ^ (prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1984 */         prev = pos; continue;
/*      */       } 
/* 1986 */       prev = this.first = pos;
/*      */       
/* 1988 */       link[pos] = link[pos] | 0xFFFFFFFF00000000L;
/*      */     } 
/*      */     
/* 1991 */     this.last = prev;
/* 1992 */     if (prev != -1)
/*      */     {
/* 1994 */       link[prev] = link[prev] | 0xFFFFFFFFL;
/*      */     }
/*      */   }
/*      */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2IntLinkedOpenHashMap.class
