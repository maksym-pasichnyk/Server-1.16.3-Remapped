...
/*  49 */       return DoubleIterators.EMPTY_ITERATOR;
/*     */     }
/*     */     
/*     */     public int size() {
/*  53 */       return 0;
...
/* 145 */         return this.collection.toDoubleArray();
/*     */       } 
/*     */     }
/*     */     
/*     */     public Object[] toArray() {
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableCollection implements DoubleCollection, Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final DoubleCollection collection;
/*     */     
...
/*     */     
/*     */     public DoubleIterator iterator() {
/* 344 */       return DoubleIterators.unmodifiable(this.collection.iterator());
/*     */     }
/*     */     
/*     */     public void clear() {
...
/*     */     
/*     */     public double[] toDoubleArray() {
/* 391 */       return this.collection.toDoubleArray();
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   }
/*     */   
/*     */   public static class IterableCollection extends AbstractDoubleCollection implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */     public int size() {
/* 461 */       int c = 0;
/* 462 */       DoubleIterator iterator = iterator();
/* 463 */       while (iterator.hasNext()) {
/* 464 */         iterator.nextDouble();
/* 465 */         c++;
/*     */       } 
/* 467 */       return c;
/*     */     }
...
/* 486 */     if (iterable instanceof DoubleCollection)
/* 487 */       return (DoubleCollection)iterable; 
/* 488 */     return new IterableCollection(iterable);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\DoubleCollections.class
