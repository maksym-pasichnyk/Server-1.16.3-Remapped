...
/*     */   
/*     */   public boolean trim() {
/* 548 */     int l = HashCommon.arraySize(this.size, this.f);
/* 549 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 550 */       return true; 
/*     */     try {
/* 552 */       rehash(l);
/* 553 */     } catch (OutOfMemoryError cantDoIt) {
/* 554 */       return false;
/*     */     } 
/* 556 */     return true;
/*     */   }
...
/* 580 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 581 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 582 */       return true; 
/*     */     try {
/* 584 */       rehash(l);
/* 585 */     } catch (OutOfMemoryError cantDoIt) {
/* 586 */       return false;
/*     */     } 
/* 588 */     return true;
/*     */   }
...
/* 605 */     int mask = newN - 1;
/* 606 */     double[] newKey = new double[newN + 1];
/* 607 */     int i = this.n;
/* 608 */     for (int j = realSize(); j-- != 0; ) {
/* 609 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 610 */       if (Double.doubleToLongBits(newKey[
/* 611 */             pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask]) != 0L)
/*     */       {
/* 613 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); } 
/* 614 */       newKey[pos] = key[i];
/*     */     } 
/* 616 */     this.n = newN;
/* 617 */     this.mask = mask;
/* 618 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 619 */     this.key = newKey;
/*     */   }
/*     */ 
/*     */ 
...
/*     */     DoubleOpenHashSet c;
/*     */     try {
/* 636 */       c = (DoubleOpenHashSet)super.clone();
/* 637 */     } catch (CloneNotSupportedException cantHappen) {
/* 638 */       throw new InternalError();
/*     */     } 
/* 640 */     c.key = (double[])this.key.clone();
/* 641 */     c.containsNull = this.containsNull;
/* 642 */     return c;
/*     */   }
/*     */ 
/*     */ 
...
/*     */   public int hashCode() {
/* 655 */     int h = 0;
/* 656 */     for (int j = realSize(), i = 0; j-- != 0; ) {
/* 657 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 658 */         i++; 
/* 659 */       h += HashCommon.double2int(this.key[i]);
/* 660 */       i++;
/*     */     } 
/*     */     
/* 663 */     return h;
...
/* 666 */     DoubleIterator i = iterator();
/* 667 */     s.defaultWriteObject();
/* 668 */     for (int j = this.size; j-- != 0;)
/* 669 */       s.writeDouble(i.nextDouble()); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 673 */     s.defaultReadObject();
/* 674 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 675 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 676 */     this.mask = this.n - 1;
/* 677 */     double[] key = this.key = new double[this.n + 1];
/*     */     
/* 679 */     for (int i = this.size; i-- != 0; ) {
/* 680 */       int pos; double k = s.readDouble();
/* 681 */       if (Double.doubleToLongBits(k) == 0L) {
/* 682 */         pos = this.n;
/* 683 */         this.containsNull = true;
/*     */       }
/* 685 */       else if (Double.doubleToLongBits(key[
/* 686 */             pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask]) != 0L) {
/*     */         
/* 688 */         while (Double.doubleToLongBits(key[pos = pos + 1 & this.mask]) != 0L);
/*     */       } 
/* 690 */       key[pos] = k;
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\DoubleOpenHashSet.class
