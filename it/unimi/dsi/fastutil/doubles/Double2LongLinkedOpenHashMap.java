...
/* 1850 */     double[] key = this.key;
/* 1851 */     long[] value = this.value;
/* 1852 */     int mask = newN - 1;
/* 1853 */     double[] newKey = new double[newN + 1];
/* 1854 */     long[] newValue = new long[newN + 1];
...
/* 1860 */       int pos; if (Double.doubleToLongBits(key[i]) == 0L) {
/* 1861 */         pos = newN;
/*      */       } else {
/* 1863 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask;
/* 1864 */         while (Double.doubleToLongBits(newKey[pos]) != 0L)
/* 1865 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1908 */       c = (Double2LongLinkedOpenHashMap)super.clone();
...
/* 1916 */     c.key = (double[])this.key.clone();
/* 1917 */     c.value = (long[])this.value.clone();
...
/* 1934 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1935 */         i++; 
/* 1936 */       t = HashCommon.double2int(this.key[i]);
/* 1937 */       t ^= HashCommon.long2int(this.value[i]);
/* 1938 */       h += t;
/* 1939 */       i++;
/*      */     } 
/*      */     
/* 1942 */     if (this.containsNullKey)
/* 1943 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1944 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1947 */     double[] key = this.key;
/* 1948 */     long[] value = this.value;
/* 1949 */     MapIterator i = new MapIterator();
/* 1950 */     s.defaultWriteObject();
/* 1951 */     for (int j = this.size; j-- != 0; ) {
/* 1952 */       int e = i.nextEntry();
/* 1953 */       s.writeDouble(key[e]);
/* 1954 */       s.writeLong(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1963 */     double[] key = this.key = new double[this.n + 1];
/* 1964 */     long[] value = this.value = new long[this.n + 1];
...
/* 1971 */       int pos; double k = s.readDouble();
/* 1972 */       long v = s.readLong();
/* 1973 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1974 */         pos = this.n;
/* 1975 */         this.containsNullKey = true;
/*      */       } else {
/* 1977 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1978 */         while (Double.doubleToLongBits(key[pos]) != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2LongLinkedOpenHashMap.class
