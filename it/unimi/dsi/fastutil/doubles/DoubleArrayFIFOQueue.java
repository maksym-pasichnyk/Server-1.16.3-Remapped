...
/*  62 */     this.array = new double[Math.max(1, capacity)];
...
/*  85 */     double t = this.array[this.start];
...
/* 109 */     double[] newArray = new double[newLength];
...
/*     */   public void trim() {
/* 171 */     int size = size();
/* 172 */     double[] newArray = new double[size + 1];
...
/* 193 */       s.writeDouble(this.array[i++]);
...
/* 202 */     this.array = new double[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
/* 203 */     for (int i = 0; i < this.end; i++)
/* 204 */       this.array[i] = s.readDouble(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\DoubleArrayFIFOQueue.class
