...
/*      */   
/*      */   public boolean trim() {
/* 1050 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1083 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1084 */       return true; 
/*      */     try {
/* 1086 */       rehash(l);
...
/* 1106 */     double[] key = this.key;
/* 1107 */     boolean[] value = this.value;
/* 1108 */     int mask = newN - 1;
/* 1109 */     double[] newKey = new double[newN + 1];
/* 1110 */     boolean[] newValue = new boolean[newN + 1];
/* 1111 */     int i = this.n;
/* 1112 */     for (int j = realSize(); j-- != 0; ) {
/* 1113 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1114 */       if (Double.doubleToLongBits(newKey[
/* 1115 */             pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask]) != 0L)
/*      */       {
/* 1117 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); } 
...
/*      */     try {
/* 1143 */       c = (Double2BooleanOpenHashMap)super.clone();
...
/* 1151 */     c.key = (double[])this.key.clone();
...
/* 1168 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1169 */         i++; 
/* 1170 */       t = HashCommon.double2int(this.key[i]);
...
/* 1197 */     double[] key = this.key = new double[this.n + 1];
/* 1198 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1201 */     for (int i = this.size; i-- != 0; ) {
/* 1202 */       int pos; double k = s.readDouble();
/* 1203 */       boolean v = s.readBoolean();
/* 1204 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1205 */         pos = this.n;
/* 1206 */         this.containsNullKey = true;
/*      */       } else {
/* 1208 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1209 */         while (Double.doubleToLongBits(key[pos]) != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2BooleanOpenHashMap.class
