...
/* 1151 */     short[] value = this.value;
/* 1152 */     int mask = newN - 1;
/* 1153 */     double[] newKey = new double[newN + 1];
/* 1154 */     short[] newValue = new short[newN + 1];
/* 1155 */     int i = this.n;
...
/*      */     try {
/* 1187 */       c = (Double2ShortOpenHashMap)super.clone();
...
/* 1196 */     c.value = (short[])this.value.clone();
/* 1197 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1242 */     short[] value = this.value = new short[this.n + 1];
/*      */ 
/*      */     
/* 1245 */     for (int i = this.size; i-- != 0; ) {
/* 1246 */       int pos; double k = s.readDouble();
/* 1247 */       short v = s.readShort();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ShortOpenHashMap.class
