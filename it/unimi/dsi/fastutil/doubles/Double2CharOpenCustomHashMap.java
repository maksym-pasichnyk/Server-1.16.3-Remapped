...
/* 1137 */     double[] key = this.key;
/* 1138 */     char[] value = this.value;
/* 1139 */     int mask = newN - 1;
/* 1140 */     double[] newKey = new double[newN + 1];
/* 1141 */     char[] newValue = new char[newN + 1];
/* 1142 */     int i = this.n;
/* 1143 */     for (int j = realSize(); j-- != 0; ) {
/* 1144 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1145 */       if (Double.doubleToLongBits(newKey[
/* 1146 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0L)
/* 1147 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); 
...
/*      */     try {
/* 1173 */       c = (Double2CharOpenCustomHashMap)super.clone();
...
/* 1181 */     c.key = (double[])this.key.clone();
/* 1182 */     c.value = (char[])this.value.clone();
...
/* 1199 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1200 */         i++; 
/* 1201 */       t = this.strategy.hashCode(this.key[i]);
/* 1202 */       t ^= this.value[i];
/* 1203 */       h += t;
/* 1204 */       i++;
/*      */     } 
/*      */     
/* 1207 */     if (this.containsNullKey)
/* 1208 */       h += this.value[this.n]; 
/* 1209 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1212 */     double[] key = this.key;
/* 1213 */     char[] value = this.value;
/* 1214 */     MapIterator i = new MapIterator();
/* 1215 */     s.defaultWriteObject();
/* 1216 */     for (int j = this.size; j-- != 0; ) {
/* 1217 */       int e = i.nextEntry();
/* 1218 */       s.writeDouble(key[e]);
/* 1219 */       s.writeChar(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1229 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1232 */     for (int i = this.size; i-- != 0; ) {
/* 1233 */       int pos; double k = s.readDouble();
/* 1234 */       char v = s.readChar();
/* 1235 */       if (this.strategy.equals(k, 0.0D)) {
/* 1236 */         pos = this.n;
/* 1237 */         this.containsNullKey = true;
/*      */       } else {
/* 1239 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1240 */         while (Double.doubleToLongBits(key[pos]) != 0L)
/* 1241 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1243 */       key[pos] = k;
/* 1244 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2CharOpenCustomHashMap.class
