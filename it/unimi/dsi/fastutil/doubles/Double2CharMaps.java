...
/*  50 */     return (entries instanceof Double2CharMap.FastEntrySet) ? (
/*  51 */       (Double2CharMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Double2CharMap.Entry> entries = map.double2CharEntrySet();
/*  71 */     if (entries instanceof Double2CharMap.FastEntrySet) {
/*  72 */       ((Double2CharMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Double2CharMap.Entry> entries = map.double2CharEntrySet();
/*  91 */     return (entries instanceof Double2CharMap.FastEntrySet) ? new ObjectIterable<Double2CharMap.Entry>() {
/*     */         public ObjectIterator<Double2CharMap.Entry> iterator() {
/*  93 */           return ((Double2CharMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Double2CharMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Double2CharMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractDouble2CharMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)double2CharEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/* 300 */     return new Singleton(key.doubleValue(), value.charValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.double2CharEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Character>> entrySet() {
/* 361 */       return (ObjectSet)double2CharEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.double2CharEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Character>> entrySet() {
/* 674 */       return (ObjectSet)double2CharEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2CharMaps.class
