...
/*      */   
/*      */   public boolean trim() {
/* 1082 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1115 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1116 */       return true; 
/*      */     try {
/* 1118 */       rehash(l);
...
/* 1138 */     double[] key = this.key;
/* 1139 */     boolean[] value = this.value;
/* 1140 */     int mask = newN - 1;
/* 1141 */     double[] newKey = new double[newN + 1];
/* 1142 */     boolean[] newValue = new boolean[newN + 1];
/* 1143 */     int i = this.n;
/* 1144 */     for (int j = realSize(); j-- != 0; ) {
/* 1145 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1146 */       if (Double.doubleToLongBits(newKey[
/* 1147 */             pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask]) != 0L)
/* 1148 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); 
/* 1149 */       newKey[pos] = key[i];
/* 1150 */       newValue[pos] = value[i];
/*      */     } 
/* 1152 */     newValue[newN] = value[this.n];
/* 1153 */     this.n = newN;
/* 1154 */     this.mask = mask;
/* 1155 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 1156 */     this.key = newKey;
/* 1157 */     this.value = newValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/* 1174 */       c = (Double2BooleanOpenCustomHashMap)super.clone();
...
/* 1179 */     c.values = null;
/* 1180 */     c.entries = null;
/* 1181 */     c.containsNullKey = this.containsNullKey;
/* 1182 */     c.key = (double[])this.key.clone();
/* 1183 */     c.value = (boolean[])this.value.clone();
/* 1184 */     c.strategy = this.strategy;
/* 1185 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1198 */     int h = 0;
/* 1199 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1200 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1201 */         i++; 
/* 1202 */       t = this.strategy.hashCode(this.key[i]);
/* 1203 */       t ^= this.value[i] ? 1231 : 1237;
/* 1204 */       h += t;
/* 1205 */       i++;
/*      */     } 
/*      */     
/* 1208 */     if (this.containsNullKey)
/* 1209 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1210 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1213 */     double[] key = this.key;
/* 1214 */     boolean[] value = this.value;
/* 1215 */     MapIterator i = new MapIterator();
/* 1216 */     s.defaultWriteObject();
/* 1217 */     for (int j = this.size; j-- != 0; ) {
/* 1218 */       int e = i.nextEntry();
/* 1219 */       s.writeDouble(key[e]);
/* 1220 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1229 */     double[] key = this.key = new double[this.n + 1];
/* 1230 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1233 */     for (int i = this.size; i-- != 0; ) {
/* 1234 */       int pos; double k = s.readDouble();
/* 1235 */       boolean v = s.readBoolean();
/* 1236 */       if (this.strategy.equals(k, 0.0D)) {
/* 1237 */         pos = this.n;
/* 1238 */         this.containsNullKey = true;
/*      */       } else {
/* 1240 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1241 */         while (Double.doubleToLongBits(key[pos]) != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2BooleanOpenCustomHashMap.class
