...
/*  50 */     return (entries instanceof Double2FloatMap.FastEntrySet) ? (
/*  51 */       (Double2FloatMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Double2FloatMap.Entry> entries = map.double2FloatEntrySet();
/*  71 */     if (entries instanceof Double2FloatMap.FastEntrySet) {
/*  72 */       ((Double2FloatMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Double2FloatMap.Entry> entries = map.double2FloatEntrySet();
/*  91 */     return (entries instanceof Double2FloatMap.FastEntrySet) ? new ObjectIterable<Double2FloatMap.Entry>() {
/*     */         public ObjectIterator<Double2FloatMap.Entry> iterator() {
/*  93 */           return ((Double2FloatMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Double2FloatMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Double2FloatMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractDouble2FloatMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)double2FloatEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/*     */     
/*     */     public int hashCode() {
/* 248 */       return HashCommon.double2int(this.key) ^ HashCommon.float2int(this.value);
/*     */     }
/*     */     
/*     */     public boolean equals(Object o) {
/* 252 */       if (o == this)
...
/*     */   
/*     */   public static Double2FloatMap singleton(Double key, Float value) {
/* 300 */     return new Singleton(key.doubleValue(), value.floatValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.double2FloatEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Float>> entrySet() {
/* 361 */       return (ObjectSet)double2FloatEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.double2FloatEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Double, Float>> entrySet() {
/* 674 */       return (ObjectSet)double2FloatEntrySet();
/*     */     }
/*     */     
/*     */     public DoubleSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2FloatMaps.class
