...
/*      */   
/*      */   public boolean trim() {
/* 1045 */     int l = HashCommon.arraySize(this.size, this.f);
/* 1046 */     if (l >= this.n || this.size > HashCommon.maxFill(l, this.f))
/* 1047 */       return true; 
/*      */     try {
/* 1049 */       rehash(l);
/* 1050 */     } catch (OutOfMemoryError cantDoIt) {
/* 1051 */       return false;
/*      */     } 
/* 1053 */     return true;
/*      */   }
...
/* 1078 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1079 */       return true; 
/*      */     try {
/* 1081 */       rehash(l);
...
/* 1101 */     double[] key = this.key;
/* 1102 */     char[] value = this.value;
/* 1103 */     int mask = newN - 1;
/* 1104 */     double[] newKey = new double[newN + 1];
/* 1105 */     char[] newValue = new char[newN + 1];
/* 1106 */     int i = this.n;
/* 1107 */     for (int j = realSize(); j-- != 0; ) {
/* 1108 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1109 */       if (Double.doubleToLongBits(newKey[
/* 1110 */             pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask]) != 0L)
/*      */       {
/* 1112 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); } 
...
/*      */     try {
/* 1138 */       c = (Double2CharOpenHashMap)super.clone();
...
/* 1146 */     c.key = (double[])this.key.clone();
/* 1147 */     c.value = (char[])this.value.clone();
/* 1148 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1163 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1164 */         i++; 
/* 1165 */       t = HashCommon.double2int(this.key[i]);
/* 1166 */       t ^= this.value[i];
/* 1167 */       h += t;
/* 1168 */       i++;
/*      */     } 
...
/* 1172 */       h += this.value[this.n]; 
/* 1173 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1176 */     double[] key = this.key;
/* 1177 */     char[] value = this.value;
/* 1178 */     MapIterator i = new MapIterator();
/* 1179 */     s.defaultWriteObject();
/* 1180 */     for (int j = this.size; j-- != 0; ) {
/* 1181 */       int e = i.nextEntry();
/* 1182 */       s.writeDouble(key[e]);
/* 1183 */       s.writeChar(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1192 */     double[] key = this.key = new double[this.n + 1];
/* 1193 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1196 */     for (int i = this.size; i-- != 0; ) {
/* 1197 */       int pos; double k = s.readDouble();
/* 1198 */       char v = s.readChar();
/* 1199 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1200 */         pos = this.n;
/* 1201 */         this.containsNullKey = true;
/*      */       } else {
/* 1203 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1204 */         while (Double.doubleToLongBits(key[pos]) != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2CharOpenHashMap.class
