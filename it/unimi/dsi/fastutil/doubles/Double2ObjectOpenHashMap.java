...
/* 1074 */     double[] key = this.key;
/* 1075 */     V[] value = this.value;
/* 1076 */     int mask = newN - 1;
/* 1077 */     double[] newKey = new double[newN + 1];
/* 1078 */     V[] newValue = (V[])new Object[newN + 1];
/* 1079 */     int i = this.n;
/* 1080 */     for (int j = realSize(); j-- != 0; ) {
/* 1081 */       while (Double.doubleToLongBits(key[--i]) == 0L); int pos;
/* 1082 */       if (Double.doubleToLongBits(newKey[
/* 1083 */             pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask]) != 0L)
/*      */       {
/* 1085 */         while (Double.doubleToLongBits(newKey[pos = pos + 1 & mask]) != 0L); } 
...
/*      */     try {
/* 1111 */       c = (Double2ObjectOpenHashMap<V>)super.clone();
...
/* 1119 */     c.key = (double[])this.key.clone();
/* 1120 */     c.value = (V[])this.value.clone();
/* 1121 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1136 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1137 */         i++; 
/* 1138 */       t = HashCommon.double2int(this.key[i]);
/* 1139 */       if (this != this.value[i])
/* 1140 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1141 */       h += t;
/* 1142 */       i++;
/*      */     } 
/*      */     
/* 1145 */     if (this.containsNullKey)
/* 1146 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1147 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1150 */     double[] key = this.key;
/* 1151 */     V[] value = this.value;
/* 1152 */     MapIterator i = new MapIterator();
/* 1153 */     s.defaultWriteObject();
/* 1154 */     for (int j = this.size; j-- != 0; ) {
/* 1155 */       int e = i.nextEntry();
/* 1156 */       s.writeDouble(key[e]);
/* 1157 */       s.writeObject(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1166 */     double[] key = this.key = new double[this.n + 1];
/* 1167 */     V[] value = this.value = (V[])new Object[this.n + 1];
/*      */ 
/*      */     
/* 1170 */     for (int i = this.size; i-- != 0; ) {
/* 1171 */       int pos; double k = s.readDouble();
/* 1172 */       V v = (V)s.readObject();
/* 1173 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1174 */         pos = this.n;
/* 1175 */         this.containsNullKey = true;
/*      */       } else {
/* 1177 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1178 */         while (Double.doubleToLongBits(key[pos]) != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ObjectOpenHashMap.class
