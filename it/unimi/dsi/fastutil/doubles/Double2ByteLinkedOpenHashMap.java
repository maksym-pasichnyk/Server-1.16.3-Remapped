...
/* 1850 */     byte[] value = this.value;
/* 1851 */     int mask = newN - 1;
/* 1852 */     double[] newKey = new double[newN + 1];
/* 1853 */     byte[] newValue = new byte[newN + 1];
...
/*      */     try {
/* 1907 */       c = (Double2ByteLinkedOpenHashMap)super.clone();
...
/* 1916 */     c.value = (byte[])this.value.clone();
...
/* 1963 */     byte[] value = this.value = new byte[this.n + 1];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteLinkedOpenHashMap.class
