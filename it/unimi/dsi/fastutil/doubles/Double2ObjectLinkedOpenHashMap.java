...
/* 1762 */     double[] key = this.key;
/* 1763 */     V[] value = this.value;
/* 1764 */     int mask = newN - 1;
/* 1765 */     double[] newKey = new double[newN + 1];
...
/* 1772 */       int pos; if (Double.doubleToLongBits(key[i]) == 0L) {
/* 1773 */         pos = newN;
/*      */       } else {
/* 1775 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(key[i])) & mask;
/* 1776 */         while (Double.doubleToLongBits(newKey[pos]) != 0L)
/* 1777 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1820 */       c = (Double2ObjectLinkedOpenHashMap<V>)super.clone();
...
/* 1828 */     c.key = (double[])this.key.clone();
...
/* 1846 */       while (Double.doubleToLongBits(this.key[i]) == 0L)
/* 1847 */         i++; 
/* 1848 */       t = HashCommon.double2int(this.key[i]);
...
/* 1876 */     double[] key = this.key = new double[this.n + 1];
...
/* 1884 */       int pos; double k = s.readDouble();
/* 1885 */       V v = (V)s.readObject();
/* 1886 */       if (Double.doubleToLongBits(k) == 0L) {
/* 1887 */         pos = this.n;
/* 1888 */         this.containsNullKey = true;
/*      */       } else {
/* 1890 */         pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & this.mask;
/* 1891 */         while (Double.doubleToLongBits(key[pos]) != 0L)
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2ObjectLinkedOpenHashMap.class
