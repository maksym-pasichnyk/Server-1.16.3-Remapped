...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Double2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Double2LongFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   
/*     */   public static Double2LongFunction singleton(Double key, Long value) {
/* 161 */     return new Singleton(key.doubleValue(), value.longValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Double2LongFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractDouble2LongFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2LongFunction function;
/*     */     
...
/* 462 */       Long v = this.function.apply(Double.valueOf(key));
/* 463 */       if (v == null)
...
/* 505 */     if (f instanceof Double2LongFunction)
/* 506 */       return (Double2LongFunction)f; 
/* 507 */     if (f instanceof DoubleToLongFunction) {
/* 508 */       Objects.requireNonNull((DoubleToLongFunction)f); return (DoubleToLongFunction)f::applyAsLong;
/* 509 */     }  return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\doubles\Double2LongFunctions.class
