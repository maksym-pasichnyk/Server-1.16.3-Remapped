...
/* 1764 */     char[] key = this.key;
/* 1765 */     char[] value = this.value;
/* 1766 */     int mask = newN - 1;
/* 1767 */     char[] newKey = new char[newN + 1];
...
/* 1774 */       int pos; if (key[i] == '\000') {
/* 1775 */         pos = newN;
/*      */       } else {
/* 1777 */         pos = HashCommon.mix(key[i]) & mask;
/* 1778 */         while (newKey[pos] != '\000')
/* 1779 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1822 */       c = (Char2CharLinkedOpenHashMap)super.clone();
...
/* 1830 */     c.key = (char[])this.key.clone();
...
/* 1877 */     char[] key = this.key = new char[this.n + 1];
...
/* 1885 */       int pos; char k = s.readChar();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2CharLinkedOpenHashMap.class
