...
/* 1085 */     char[] key = this.key;
/* 1086 */     boolean[] value = this.value;
/* 1087 */     int mask = newN - 1;
/* 1088 */     char[] newKey = new char[newN + 1];
/* 1089 */     boolean[] newValue = new boolean[newN + 1];
/* 1090 */     int i = this.n;
/* 1091 */     for (int j = realSize(); j-- != 0; ) {
/* 1092 */       while (key[--i] == '\000'); int pos;
/* 1093 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != '\000')
/* 1094 */         while (newKey[pos = pos + 1 & mask] != '\000'); 
...
/*      */     try {
/* 1120 */       c = (Char2BooleanOpenHashMap)super.clone();
...
/* 1128 */     c.key = (char[])this.key.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanOpenHashMap.class
