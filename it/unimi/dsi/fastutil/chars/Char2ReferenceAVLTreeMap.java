...
/*  936 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1022 */     int index = 0;
/*      */     TreeIterator() {
/* 1024 */       this.next = Char2ReferenceAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1027 */       if ((this.next = Char2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/* 1028 */         if (Char2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1079 */       updatePrevious();
/* 1080 */       updateNext();
/* 1081 */       Char2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1082 */       this.curr = null;
/*      */     }
...
/* 1129 */       this.entries = (ObjectSortedSet<Char2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>()
/*      */         {
...
/* 1138 */             return (ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>>)new Char2ReferenceAVLTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> from) {
/* 1143 */             return (ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>>)new Char2ReferenceAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1152 */               return false; 
/* 1153 */             Char2ReferenceAVLTreeMap.Entry<V> f = Char2ReferenceAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1163 */               return false; 
/* 1164 */             Char2ReferenceAVLTreeMap.Entry<V> f = Char2ReferenceAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1165 */             if (f == null || f.getValue() != e.getValue())
/* 1166 */               return false; 
/* 1167 */             Char2ReferenceAVLTreeMap.this.remove(f.key);
/* 1168 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1172 */             return Char2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1176 */             Char2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2ReferenceMap.Entry<V> first() {
/* 1180 */             return Char2ReferenceAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2ReferenceMap.Entry<V> last() {
/* 1184 */             return Char2ReferenceAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> from, Char2ReferenceMap.Entry<V> to) {
/* 1189 */             return Char2ReferenceAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> to) {
/* 1193 */             return Char2ReferenceAVLTreeMap.this.headMap(to.getCharKey()).char2ReferenceEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> from) {
/* 1197 */             return Char2ReferenceAVLTreeMap.this.tailMap(from.getCharKey()).char2ReferenceEntrySet();
/*      */           }
/*      */         }; 
...
/* 1231 */       return new Char2ReferenceAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1235 */       return new Char2ReferenceAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1290 */             return (ObjectIterator<V>)new Char2ReferenceAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1294 */             return Char2ReferenceAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1298 */             return Char2ReferenceAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1302 */             Char2ReferenceAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1365 */       if (!bottom && !top && Char2ReferenceAVLTreeMap.this.compare(from, to) > 0)
/* 1366 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Char2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1389 */       return ((this.bottom || Char2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ReferenceAVLTreeMap.this
/* 1390 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
/* 1394 */       if (this.entries == null)
/* 1395 */         this.entries = (ObjectSortedSet<Char2ReferenceMap.Entry<V>>)new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator() {
/* 1398 */               return (ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>>)new Char2ReferenceAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> from) {
/* 1403 */               return (ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>>)new Char2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2ReferenceMap.Entry<V>> comparator() {
/* 1407 */               return Char2ReferenceAVLTreeMap.this.char2ReferenceEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1416 */                 return false; 
/* 1417 */               Char2ReferenceAVLTreeMap.Entry<V> f = Char2ReferenceAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1418 */               return (f != null && Char2ReferenceAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1427 */                 return false; 
/* 1428 */               Char2ReferenceAVLTreeMap.Entry<V> f = Char2ReferenceAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1429 */               if (f != null && Char2ReferenceAVLTreeMap.Submap.this.in(f.key))
/* 1430 */                 Char2ReferenceAVLTreeMap.Submap.this.remove(f.key); 
/* 1431 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1435 */               int c = 0;
/* 1436 */               for (ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1437 */                 c++; 
/* 1438 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1442 */               return !(new Char2ReferenceAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1446 */               Char2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2ReferenceMap.Entry<V> first() {
/* 1450 */               return Char2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2ReferenceMap.Entry<V> last() {
/* 1454 */               return Char2ReferenceAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> from, Char2ReferenceMap.Entry<V> to) {
/* 1459 */               return Char2ReferenceAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> to) {
/* 1463 */               return Char2ReferenceAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2ReferenceEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> from) {
/* 1467 */               return Char2ReferenceAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2ReferenceEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2ReferenceSortedMap<V>.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1475 */         return new Char2ReferenceAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1479 */         return new Char2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1494 */               return (ObjectIterator<V>)new Char2ReferenceAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1498 */               return Char2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1502 */               return Char2ReferenceAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1506 */               Char2ReferenceAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1514 */       return (in(k) && Char2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(char k) {
/* 1531 */       char kk = k; Char2ReferenceAVLTreeMap.Entry<V> e;
/* 1532 */       return (in(kk) && (e = Char2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(char k, V v) {
/* 1536 */       Char2ReferenceAVLTreeMap.this.modified = false;
/* 1537 */       if (!in(k))
...
/* 1540 */       V oldValue = Char2ReferenceAVLTreeMap.this.put(k, v);
/* 1541 */       return Char2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(char k) {
/* 1546 */       Char2ReferenceAVLTreeMap.this.modified = false;
/* 1547 */       if (!in(k))
/* 1548 */         return this.defRetValue; 
/* 1549 */       V oldValue = Char2ReferenceAVLTreeMap.this.remove(k);
/* 1550 */       return Char2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1568 */       return Char2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2ReferenceSortedMap<V> headMap(char to) {
/* 1572 */       if (this.top)
/* 1573 */         return new Submap(this.from, this.bottom, to, false); 
/* 1574 */       return (Char2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2ReferenceSortedMap<V> tailMap(char from) {
/* 1578 */       if (this.bottom)
/* 1579 */         return new Submap(from, false, this.to, this.top); 
/* 1580 */       return (Char2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2ReferenceSortedMap<V> subMap(char from, char to) {
...
/* 1586 */       if (!this.top)
/* 1587 */         to = (Char2ReferenceAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1588 */       if (!this.bottom)
/* 1589 */         from = (Char2ReferenceAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1601 */       if (Char2ReferenceAVLTreeMap.this.tree == null) {
/* 1602 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1606 */       if (this.bottom) {
/* 1607 */         e = Char2ReferenceAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1609 */         e = Char2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1611 */         if (Char2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1612 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1616 */       if (e == null || (!this.top && Char2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1617 */         return null; 
/* 1618 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2ReferenceAVLTreeMap.Entry<V> e;
/* 1627 */       if (Char2ReferenceAVLTreeMap.this.tree == null) {
/* 1628 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1632 */       if (this.top) {
/* 1633 */         e = Char2ReferenceAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1635 */         e = Char2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1637 */         if (Char2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1638 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1642 */       if (e == null || (!this.bottom && Char2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1643 */         return null; 
/* 1644 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1648 */       Char2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
/* 1649 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1655 */       Char2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
/* 1656 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1671 */         this.next = Char2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1674 */         this();
/* 1675 */         if (this.next != null)
/* 1676 */           if (!Char2ReferenceAVLTreeMap.Submap.this.bottom && Char2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1677 */             this.prev = null;
/* 1678 */           } else if (!Char2ReferenceAVLTreeMap.Submap.this.top && Char2ReferenceAVLTreeMap.this.compare(k, (this.prev = Char2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1679 */             this.next = null;
/*      */           } else {
/* 1681 */             this.next = Char2ReferenceAVLTreeMap.this.locateKey(k);
/* 1682 */             if (Char2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1693 */         if (!Char2ReferenceAVLTreeMap.Submap.this.bottom && this.prev != null && Char2ReferenceAVLTreeMap.this.compare(this.prev.key, Char2ReferenceAVLTreeMap.Submap.this.from) < 0)
/* 1694 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1698 */         this.next = this.next.next();
/* 1699 */         if (!Char2ReferenceAVLTreeMap.Submap.this.top && this.next != null && Char2ReferenceAVLTreeMap.this.compare(this.next.key, Char2ReferenceAVLTreeMap.Submap.this.to) >= 0)
/* 1700 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1782 */       c = (Char2ReferenceAVLTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ReferenceAVLTreeMap.class
