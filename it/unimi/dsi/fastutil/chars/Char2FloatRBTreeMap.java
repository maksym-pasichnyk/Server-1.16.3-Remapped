...
/*  910 */         return false; 
/*  911 */       Map.Entry<Character, Float> e = (Map.Entry<Character, Float>)o;
...
/*  999 */     int index = 0;
/*      */     TreeIterator() {
/* 1001 */       this.next = Char2FloatRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1004 */       if ((this.next = Char2FloatRBTreeMap.this.locateKey(k)) != null)
/* 1005 */         if (Char2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1056 */       updatePrevious();
/* 1057 */       updateNext();
/* 1058 */       Char2FloatRBTreeMap.this.remove(this.curr.key);
/* 1059 */       this.curr = null;
/*      */     }
...
/* 1098 */       this.entries = (ObjectSortedSet<Char2FloatMap.Entry>)new AbstractObjectSortedSet<Char2FloatMap.Entry>()
/*      */         {
...
/* 1107 */             return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from) {
/* 1111 */             return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1122 */               return false; 
/* 1123 */             Char2FloatRBTreeMap.Entry f = Char2FloatRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1135 */               return false; 
/* 1136 */             Char2FloatRBTreeMap.Entry f = Char2FloatRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1137 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != 
/* 1138 */               Float.floatToIntBits(((Float)e.getValue()).floatValue()))
/* 1139 */               return false; 
/* 1140 */             Char2FloatRBTreeMap.this.remove(f.key);
/* 1141 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1145 */             return Char2FloatRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1149 */             Char2FloatRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2FloatMap.Entry first() {
/* 1153 */             return Char2FloatRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2FloatMap.Entry last() {
/* 1157 */             return Char2FloatRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry to) {
/* 1161 */             return Char2FloatRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry to) {
/* 1165 */             return Char2FloatRBTreeMap.this.headMap(to.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from) {
/* 1169 */             return Char2FloatRBTreeMap.this.tailMap(from.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1203 */       return new Char2FloatRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1207 */       return new Char2FloatRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1262 */             return (FloatIterator)new Char2FloatRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(float k) {
/* 1266 */             return Char2FloatRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1270 */             return Char2FloatRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1274 */             Char2FloatRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1289 */     return new Submap(from, false, false, true);
/*      */   }
/*      */   
...
/* 1337 */       if (!bottom && !top && Char2FloatRBTreeMap.this.compare(from, to) > 0)
/* 1338 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1339 */       this.from = from;
/* 1340 */       this.bottom = bottom;
/* 1341 */       this.to = to;
/* 1342 */       this.top = top;
/* 1343 */       this.defRetValue = Char2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1361 */       return ((this.bottom || Char2FloatRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2FloatRBTreeMap.this
/* 1362 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
/* 1366 */       if (this.entries == null)
/* 1367 */         this.entries = (ObjectSortedSet<Char2FloatMap.Entry>)new AbstractObjectSortedSet<Char2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator() {
/* 1370 */               return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from) {
/* 1374 */               return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2FloatMap.Entry> comparator() {
/* 1378 */               return Char2FloatRBTreeMap.this.char2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1386 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1387 */                 return false; 
/* 1388 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1389 */                 return false; 
/* 1390 */               Char2FloatRBTreeMap.Entry f = Char2FloatRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1391 */               return (f != null && Char2FloatRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1399 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1400 */                 return false; 
/* 1401 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1402 */                 return false; 
/* 1403 */               Char2FloatRBTreeMap.Entry f = Char2FloatRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1404 */               if (f != null && Char2FloatRBTreeMap.Submap.this.in(f.key))
/* 1405 */                 Char2FloatRBTreeMap.Submap.this.remove(f.key); 
/* 1406 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1410 */               int c = 0;
/* 1411 */               for (ObjectBidirectionalIterator<Char2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1412 */                 c++; 
/* 1413 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1417 */               return !(new Char2FloatRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1421 */               Char2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2FloatMap.Entry first() {
/* 1425 */               return Char2FloatRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2FloatMap.Entry last() {
/* 1429 */               return Char2FloatRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry to) {
/* 1434 */               return Char2FloatRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry to) {
/* 1438 */               return Char2FloatRBTreeMap.Submap.this.headMap(to.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from) {
/* 1442 */               return Char2FloatRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2FloatSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1450 */         return new Char2FloatRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1454 */         return new Char2FloatRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1469 */               return (FloatIterator)new Char2FloatRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(float k) {
/* 1473 */               return Char2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1477 */               return Char2FloatRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1481 */               Char2FloatRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1489 */       return (in(k) && Char2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(char k) {
/* 1506 */       char kk = k; Char2FloatRBTreeMap.Entry e;
/* 1507 */       return (in(kk) && (e = Char2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public float put(char k, float v) {
/* 1511 */       Char2FloatRBTreeMap.this.modified = false;
/* 1512 */       if (!in(k))
...
/* 1515 */       float oldValue = Char2FloatRBTreeMap.this.put(k, v);
/* 1516 */       return Char2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float remove(char k) {
/* 1521 */       Char2FloatRBTreeMap.this.modified = false;
/* 1522 */       if (!in(k))
/* 1523 */         return this.defRetValue; 
/* 1524 */       float oldValue = Char2FloatRBTreeMap.this.remove(k);
/* 1525 */       return Char2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1543 */       return Char2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2FloatSortedMap headMap(char to) {
/* 1547 */       if (this.top)
/* 1548 */         return new Submap(this.from, this.bottom, to, false); 
/* 1549 */       return (Char2FloatRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2FloatSortedMap tailMap(char from) {
/* 1553 */       if (this.bottom)
/* 1554 */         return new Submap(from, false, this.to, this.top); 
/* 1555 */       return (Char2FloatRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2FloatSortedMap subMap(char from, char to) {
...
/* 1561 */       if (!this.top)
/* 1562 */         to = (Char2FloatRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1563 */       if (!this.bottom)
/* 1564 */         from = (Char2FloatRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1576 */       if (Char2FloatRBTreeMap.this.tree == null) {
/* 1577 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1581 */       if (this.bottom) {
/* 1582 */         e = Char2FloatRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1584 */         e = Char2FloatRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1586 */         if (Char2FloatRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1587 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1591 */       if (e == null || (!this.top && Char2FloatRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1592 */         return null; 
/* 1593 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2FloatRBTreeMap.Entry e;
/* 1602 */       if (Char2FloatRBTreeMap.this.tree == null) {
/* 1603 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1607 */       if (this.top) {
/* 1608 */         e = Char2FloatRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1610 */         e = Char2FloatRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1612 */         if (Char2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1613 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1617 */       if (e == null || (!this.bottom && Char2FloatRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1618 */         return null; 
/* 1619 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1623 */       Char2FloatRBTreeMap.Entry e = firstEntry();
/* 1624 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1630 */       Char2FloatRBTreeMap.Entry e = lastEntry();
/* 1631 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1646 */         this.next = Char2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1649 */         this();
/* 1650 */         if (this.next != null)
/* 1651 */           if (!Char2FloatRBTreeMap.Submap.this.bottom && Char2FloatRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1652 */             this.prev = null;
/* 1653 */           } else if (!Char2FloatRBTreeMap.Submap.this.top && Char2FloatRBTreeMap.this.compare(k, (this.prev = Char2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1654 */             this.next = null;
/*      */           } else {
/* 1656 */             this.next = Char2FloatRBTreeMap.this.locateKey(k);
/* 1657 */             if (Char2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1668 */         if (!Char2FloatRBTreeMap.Submap.this.bottom && this.prev != null && Char2FloatRBTreeMap.this.compare(this.prev.key, Char2FloatRBTreeMap.Submap.this.from) < 0)
/* 1669 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1673 */         this.next = this.next.next();
/* 1674 */         if (!Char2FloatRBTreeMap.Submap.this.top && this.next != null && Char2FloatRBTreeMap.this.compare(this.next.key, Char2FloatRBTreeMap.Submap.this.to) >= 0)
/* 1675 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1755 */       c = (Char2FloatRBTreeMap)super.clone();
...
/* 1836 */     if (n == 1) {
/* 1837 */       Entry entry = new Entry(s.readChar(), s.readFloat());
...
/*      */ 
/*      */       
/* 1848 */       Entry entry = new Entry(s.readChar(), s.readFloat());
/* 1849 */       entry.black(true);
/* 1850 */       entry.right(new Entry(s.readChar(), s.readFloat()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatRBTreeMap.class
