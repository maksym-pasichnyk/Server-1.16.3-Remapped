...
/* 1135 */     float[] value = this.value;
/* 1136 */     int mask = newN - 1;
/* 1137 */     char[] newKey = new char[newN + 1];
/* 1138 */     float[] newValue = new float[newN + 1];
/* 1139 */     int i = this.n;
...
/*      */     try {
/* 1169 */       c = (Char2FloatOpenHashMap)super.clone();
...
/* 1178 */     c.value = (float[])this.value.clone();
/* 1179 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1195 */         i++; 
/* 1196 */       t = this.key[i];
/* 1197 */       t ^= HashCommon.float2int(this.value[i]);
/* 1198 */       h += t;
/* 1199 */       i++;
/*      */     } 
/*      */     
/* 1202 */     if (this.containsNullKey)
/* 1203 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1204 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1207 */     char[] key = this.key;
/* 1208 */     float[] value = this.value;
...
/* 1224 */     float[] value = this.value = new float[this.n + 1];
/*      */ 
/*      */     
/* 1227 */     for (int i = this.size; i-- != 0; ) {
/* 1228 */       int pos; char k = s.readChar();
/* 1229 */       float v = s.readFloat();
/* 1230 */       if (k == '\000') {
/* 1231 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatOpenHashMap.class
