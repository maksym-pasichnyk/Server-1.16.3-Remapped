...
/*  954 */         return false; 
/*  955 */       Map.Entry<Character, Integer> e = (Map.Entry<Character, Integer>)o;
/*  956 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Char2IntAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1047 */       if ((this.next = Char2IntAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Char2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Char2IntAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Char2IntMap.Entry>)new AbstractObjectSortedSet<Char2IntMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1186 */               return false; 
/* 1187 */             Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1188 */             if (f == null || f.getIntValue() != ((Integer)e.getValue()).intValue())
/* 1189 */               return false; 
/* 1190 */             Char2IntAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Char2IntAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Char2IntAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2IntMap.Entry first() {
/* 1203 */             return Char2IntAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2IntMap.Entry last() {
/* 1207 */             return Char2IntAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) {
/* 1211 */             return Char2IntAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2IntEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) {
/* 1215 */             return Char2IntAVLTreeMap.this.headMap(to.getCharKey()).char2IntEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) {
/* 1219 */             return Char2IntAVLTreeMap.this.tailMap(from.getCharKey()).char2IntEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Char2IntAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1257 */       return new Char2IntAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (IntIterator)new Char2IntAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(int k) {
/* 1316 */             return Char2IntAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Char2IntAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Char2IntAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Char2IntAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Char2IntAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Char2IntAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2IntAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Char2IntMap.Entry>)new AbstractObjectSortedSet<Char2IntMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Char2IntMap.Entry>)new Char2IntAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2IntMap.Entry> comparator() {
/* 1428 */               return Char2IntAVLTreeMap.this.char2IntEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1441 */               return (f != null && Char2IntAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1454 */               if (f != null && Char2IntAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Char2IntAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Char2IntMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Char2IntAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Char2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2IntMap.Entry first() {
/* 1475 */               return Char2IntAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2IntMap.Entry last() {
/* 1479 */               return Char2IntAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) {
/* 1483 */               return Char2IntAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2IntEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) {
/* 1487 */               return Char2IntAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2IntEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) {
/* 1491 */               return Char2IntAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2IntEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2IntSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1499 */         return new Char2IntAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1503 */         return new Char2IntAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public IntIterator iterator() {
/* 1518 */               return (IntIterator)new Char2IntAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(int k) {
/* 1522 */               return Char2IntAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Char2IntAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Char2IntAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1538 */       return (in(k) && Char2IntAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(int v) {
...
/*      */     
/*      */     public int get(char k) {
/* 1555 */       char kk = k; Char2IntAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Char2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int put(char k, int v) {
/* 1560 */       Char2IntAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       int oldValue = Char2IntAVLTreeMap.this.put(k, v);
/* 1565 */       return Char2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public int remove(char k) {
/* 1570 */       Char2IntAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       int oldValue = Char2IntAVLTreeMap.this.remove(k);
/* 1574 */       return Char2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1592 */       return Char2IntAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2IntSortedMap headMap(char to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Char2IntAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2IntSortedMap tailMap(char from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Char2IntAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2IntSortedMap subMap(char from, char to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Char2IntAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Char2IntAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Char2IntAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Char2IntAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Char2IntAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Char2IntAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Char2IntAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2IntAVLTreeMap.Entry e;
/* 1651 */       if (Char2IntAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Char2IntAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Char2IntAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Char2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Char2IntAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1672 */       Char2IntAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1679 */       Char2IntAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Char2IntAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Char2IntAVLTreeMap.Submap.this.bottom && Char2IntAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Char2IntAVLTreeMap.Submap.this.top && Char2IntAVLTreeMap.this.compare(k, (this.prev = Char2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Char2IntAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Char2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Char2IntAVLTreeMap.Submap.this.bottom && this.prev != null && Char2IntAVLTreeMap.this.compare(this.prev.key, Char2IntAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Char2IntAVLTreeMap.Submap.this.top && this.next != null && Char2IntAVLTreeMap.this.compare(this.next.key, Char2IntAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1804 */       c = (Char2IntAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readChar(), s.readInt());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readChar(), s.readInt());
/* 1897 */       entry.right(new Entry(s.readChar(), s.readInt()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2IntAVLTreeMap.class
