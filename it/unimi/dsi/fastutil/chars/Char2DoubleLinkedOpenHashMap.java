...
/* 1828 */     char[] newKey = new char[newN + 1];
...
/* 1835 */       int pos; if (key[i] == '\000') {
/* 1836 */         pos = newN;
/*      */       } else {
/* 1838 */         pos = HashCommon.mix(key[i]) & mask;
/* 1839 */         while (newKey[pos] != '\000')
/* 1840 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1883 */       c = (Char2DoubleLinkedOpenHashMap)super.clone();
...
/* 1891 */     c.key = (char[])this.key.clone();
...
/* 1938 */     char[] key = this.key = new char[this.n + 1];
...
/* 1946 */       int pos; char k = s.readChar();
/* 1947 */       double v = s.readDouble();
/* 1948 */       if (k == '\000') {
/* 1949 */         pos = this.n;
/* 1950 */         this.containsNullKey = true;
/*      */       } else {
/* 1952 */         pos = HashCommon.mix(k) & this.mask;
/* 1953 */         while (key[pos] != '\000')
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleLinkedOpenHashMap.class
