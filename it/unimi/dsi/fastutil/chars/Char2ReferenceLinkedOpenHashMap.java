...
/* 1735 */     char[] key = this.key;
/* 1736 */     V[] value = this.value;
/* 1737 */     int mask = newN - 1;
/* 1738 */     char[] newKey = new char[newN + 1];
...
/* 1745 */       int pos; if (key[i] == '\000') {
/* 1746 */         pos = newN;
/*      */       } else {
/* 1748 */         pos = HashCommon.mix(key[i]) & mask;
/* 1749 */         while (newKey[pos] != '\000')
/* 1750 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1793 */       c = (Char2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* 1801 */     c.key = (char[])this.key.clone();
...
/* 1849 */     char[] key = this.key = new char[this.n + 1];
...
/* 1857 */       int pos; char k = s.readChar();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ReferenceLinkedOpenHashMap.class
