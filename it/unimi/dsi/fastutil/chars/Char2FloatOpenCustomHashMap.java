...
/* 1180 */     float[] value = this.value;
/* 1181 */     int mask = newN - 1;
/* 1182 */     char[] newKey = new char[newN + 1];
/* 1183 */     float[] newValue = new float[newN + 1];
/* 1184 */     int i = this.n;
...
/*      */     try {
/* 1215 */       c = (Char2FloatOpenCustomHashMap)super.clone();
...
/* 1224 */     c.value = (float[])this.value.clone();
...
/* 1244 */       t ^= HashCommon.float2int(this.value[i]);
/* 1245 */       h += t;
/* 1246 */       i++;
/*      */     } 
/*      */     
/* 1249 */     if (this.containsNullKey)
/* 1250 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1251 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1254 */     char[] key = this.key;
/* 1255 */     float[] value = this.value;
...
/* 1271 */     float[] value = this.value = new float[this.n + 1];
/*      */ 
/*      */     
/* 1274 */     for (int i = this.size; i-- != 0; ) {
/* 1275 */       int pos; char k = s.readChar();
/* 1276 */       float v = s.readFloat();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatOpenCustomHashMap.class
