...
/*  74 */     this(refArray, capacity, (CharComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  97 */     this(refArray, refArray.length, (CharComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 175 */     char first = this.refArray[this.array[firstIndex]];
/* 176 */     if (this.c == null) {
/* 177 */       while (i-- != 0) {
...
/* 191 */     int i = this.size;
/* 192 */     int lastIndex = --i;
/* 193 */     char last = this.refArray[this.array[lastIndex]];
/* 194 */     if (this.c == null)
/* 195 */     { while (i-- != 0) {
...
/* 318 */     char top = this.refArray[this.array[findFirst()]];
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\CharArrayIndirectPriorityQueue.class
