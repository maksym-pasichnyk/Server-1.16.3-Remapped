...
/* 1767 */     char[] key = this.key;
/* 1768 */     boolean[] value = this.value;
/* 1769 */     int mask = newN - 1;
/* 1770 */     char[] newKey = new char[newN + 1];
...
/* 1777 */       int pos; if (key[i] == '\000') {
/* 1778 */         pos = newN;
/*      */       } else {
/* 1780 */         pos = HashCommon.mix(key[i]) & mask;
/* 1781 */         while (newKey[pos] != '\000')
/* 1782 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1825 */       c = (Char2BooleanLinkedOpenHashMap)super.clone();
...
/* 1833 */     c.key = (char[])this.key.clone();
...
/* 1880 */     char[] key = this.key = new char[this.n + 1];
...
/* 1888 */       int pos; char k = s.readChar();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanLinkedOpenHashMap.class
