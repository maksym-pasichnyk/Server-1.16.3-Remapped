...
/*  888 */         return false; 
/*  889 */       Map.Entry<Character, Boolean> e = (Map.Entry<Character, Boolean>)o;
/*  890 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  976 */     int index = 0;
/*      */     TreeIterator() {
/*  978 */       this.next = Char2BooleanRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/*  981 */       if ((this.next = Char2BooleanRBTreeMap.this.locateKey(k)) != null)
/*  982 */         if (Char2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1033 */       updatePrevious();
/* 1034 */       updateNext();
/* 1035 */       Char2BooleanRBTreeMap.this.remove(this.curr.key);
/* 1036 */       this.curr = null;
/*      */     }
...
/* 1075 */       this.entries = (ObjectSortedSet<Char2BooleanMap.Entry>)new AbstractObjectSortedSet<Char2BooleanMap.Entry>()
/*      */         {
...
/* 1084 */             return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1088 */             return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1096 */             if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1097 */               return false; 
/* 1098 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1099 */               return false; 
/* 1100 */             Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1109 */             if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1110 */               return false; 
/* 1111 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1112 */               return false; 
/* 1113 */             Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1114 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue())
/* 1115 */               return false; 
/* 1116 */             Char2BooleanRBTreeMap.this.remove(f.key);
/* 1117 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1121 */             return Char2BooleanRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1125 */             Char2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2BooleanMap.Entry first() {
/* 1129 */             return Char2BooleanRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2BooleanMap.Entry last() {
/* 1133 */             return Char2BooleanRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) {
/* 1138 */             return Char2BooleanRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) {
/* 1142 */             return Char2BooleanRBTreeMap.this.headMap(to.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) {
/* 1146 */             return Char2BooleanRBTreeMap.this.tailMap(from.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1180 */       return new Char2BooleanRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1184 */       return new Char2BooleanRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1239 */             return (BooleanIterator)new Char2BooleanRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1243 */             return Char2BooleanRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1247 */             return Char2BooleanRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1251 */             Char2BooleanRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1262 */     return new Submap(false, true, to, false);
/*      */   }
/*      */   
/*      */   public Char2BooleanSortedMap tailMap(char from) {
/* 1266 */     return new Submap(from, false, false, true);
/*      */   }
/*      */   
...
/* 1314 */       if (!bottom && !top && Char2BooleanRBTreeMap.this.compare(from, to) > 0)
/* 1315 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1316 */       this.from = from;
/* 1317 */       this.bottom = bottom;
/* 1318 */       this.to = to;
/* 1319 */       this.top = top;
/* 1320 */       this.defRetValue = Char2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1338 */       return ((this.bottom || Char2BooleanRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2BooleanRBTreeMap.this
/* 1339 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
/* 1343 */       if (this.entries == null)
/* 1344 */         this.entries = (ObjectSortedSet<Char2BooleanMap.Entry>)new AbstractObjectSortedSet<Char2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator() {
/* 1347 */               return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1352 */               return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2BooleanMap.Entry> comparator() {
/* 1356 */               return Char2BooleanRBTreeMap.this.char2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1364 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1365 */                 return false; 
/* 1366 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1367 */                 return false; 
/* 1368 */               Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1369 */               return (f != null && Char2BooleanRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1377 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1378 */                 return false; 
/* 1379 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1380 */                 return false; 
/* 1381 */               Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1382 */               if (f != null && Char2BooleanRBTreeMap.Submap.this.in(f.key))
/* 1383 */                 Char2BooleanRBTreeMap.Submap.this.remove(f.key); 
/* 1384 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1388 */               int c = 0;
/* 1389 */               for (ObjectBidirectionalIterator<Char2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1390 */                 c++; 
/* 1391 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1395 */               return !(new Char2BooleanRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1399 */               Char2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2BooleanMap.Entry first() {
/* 1403 */               return Char2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2BooleanMap.Entry last() {
/* 1407 */               return Char2BooleanRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) {
/* 1412 */               return Char2BooleanRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) {
/* 1416 */               return Char2BooleanRBTreeMap.Submap.this.headMap(to.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) {
/* 1420 */               return Char2BooleanRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2BooleanSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1428 */         return new Char2BooleanRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1432 */         return new Char2BooleanRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1447 */               return (BooleanIterator)new Char2BooleanRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1451 */               return Char2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1455 */               return Char2BooleanRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1459 */               Char2BooleanRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1467 */       return (in(k) && Char2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(char k) {
/* 1484 */       char kk = k; Char2BooleanRBTreeMap.Entry e;
/* 1485 */       return (in(kk) && (e = Char2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public boolean put(char k, boolean v) {
/* 1489 */       Char2BooleanRBTreeMap.this.modified = false;
/* 1490 */       if (!in(k))
...
/* 1493 */       boolean oldValue = Char2BooleanRBTreeMap.this.put(k, v);
/* 1494 */       return Char2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1499 */       Char2BooleanRBTreeMap.this.modified = false;
/* 1500 */       if (!in(k))
/* 1501 */         return this.defRetValue; 
/* 1502 */       boolean oldValue = Char2BooleanRBTreeMap.this.remove(k);
/* 1503 */       return Char2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1521 */       return Char2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2BooleanSortedMap headMap(char to) {
/* 1525 */       if (this.top)
/* 1526 */         return new Submap(this.from, this.bottom, to, false); 
/* 1527 */       return (Char2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2BooleanSortedMap tailMap(char from) {
/* 1531 */       if (this.bottom)
/* 1532 */         return new Submap(from, false, this.to, this.top); 
/* 1533 */       return (Char2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2BooleanSortedMap subMap(char from, char to) {
...
/* 1539 */       if (!this.top)
/* 1540 */         to = (Char2BooleanRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1541 */       if (!this.bottom)
/* 1542 */         from = (Char2BooleanRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1554 */       if (Char2BooleanRBTreeMap.this.tree == null) {
/* 1555 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1559 */       if (this.bottom) {
/* 1560 */         e = Char2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1562 */         e = Char2BooleanRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1564 */         if (Char2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1565 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1569 */       if (e == null || (!this.top && Char2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1570 */         return null; 
/* 1571 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2BooleanRBTreeMap.Entry e;
/* 1580 */       if (Char2BooleanRBTreeMap.this.tree == null) {
/* 1581 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1585 */       if (this.top) {
/* 1586 */         e = Char2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1588 */         e = Char2BooleanRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1590 */         if (Char2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1591 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1595 */       if (e == null || (!this.bottom && Char2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1596 */         return null; 
/* 1597 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1601 */       Char2BooleanRBTreeMap.Entry e = firstEntry();
/* 1602 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1608 */       Char2BooleanRBTreeMap.Entry e = lastEntry();
/* 1609 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1624 */         this.next = Char2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1627 */         this();
/* 1628 */         if (this.next != null)
/* 1629 */           if (!Char2BooleanRBTreeMap.Submap.this.bottom && Char2BooleanRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1630 */             this.prev = null;
/* 1631 */           } else if (!Char2BooleanRBTreeMap.Submap.this.top && Char2BooleanRBTreeMap.this.compare(k, (this.prev = Char2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1632 */             this.next = null;
/*      */           } else {
/* 1634 */             this.next = Char2BooleanRBTreeMap.this.locateKey(k);
/* 1635 */             if (Char2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1646 */         if (!Char2BooleanRBTreeMap.Submap.this.bottom && this.prev != null && Char2BooleanRBTreeMap.this.compare(this.prev.key, Char2BooleanRBTreeMap.Submap.this.from) < 0)
/* 1647 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1651 */         this.next = this.next.next();
/* 1652 */         if (!Char2BooleanRBTreeMap.Submap.this.top && this.next != null && Char2BooleanRBTreeMap.this.compare(this.next.key, Char2BooleanRBTreeMap.Submap.this.to) >= 0)
/* 1653 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1733 */       c = (Char2BooleanRBTreeMap)super.clone();
...
/* 1814 */     if (n == 1) {
/* 1815 */       Entry entry = new Entry(s.readChar(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1826 */       Entry entry = new Entry(s.readChar(), s.readBoolean());
/* 1827 */       entry.black(true);
/* 1828 */       entry.right(new Entry(s.readChar(), s.readBoolean()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanRBTreeMap.class
