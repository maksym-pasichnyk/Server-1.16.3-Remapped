...
/*  932 */         return false; 
/*  933 */       Map.Entry<Character, Boolean> e = (Map.Entry<Character, Boolean>)o;
/*  934 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1020 */     int index = 0;
/*      */     TreeIterator() {
/* 1022 */       this.next = Char2BooleanAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1025 */       if ((this.next = Char2BooleanAVLTreeMap.this.locateKey(k)) != null)
/* 1026 */         if (Char2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1077 */       updatePrevious();
/* 1078 */       updateNext();
/* 1079 */       Char2BooleanAVLTreeMap.this.remove(this.curr.key);
/* 1080 */       this.curr = null;
/*      */     }
...
/* 1127 */       this.entries = (ObjectSortedSet<Char2BooleanMap.Entry>)new AbstractObjectSortedSet<Char2BooleanMap.Entry>()
/*      */         {
...
/* 1136 */             return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1140 */             return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1148 */             if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1149 */               return false; 
/* 1150 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1151 */               return false; 
/* 1152 */             Char2BooleanAVLTreeMap.Entry f = Char2BooleanAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1161 */             if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1162 */               return false; 
/* 1163 */             if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1164 */               return false; 
/* 1165 */             Char2BooleanAVLTreeMap.Entry f = Char2BooleanAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1166 */             if (f == null || f.getBooleanValue() != ((Boolean)e.getValue()).booleanValue())
/* 1167 */               return false; 
/* 1168 */             Char2BooleanAVLTreeMap.this.remove(f.key);
/* 1169 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1173 */             return Char2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1177 */             Char2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2BooleanMap.Entry first() {
/* 1181 */             return Char2BooleanAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2BooleanMap.Entry last() {
/* 1185 */             return Char2BooleanAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) {
/* 1190 */             return Char2BooleanAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) {
/* 1194 */             return Char2BooleanAVLTreeMap.this.headMap(to.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) {
/* 1198 */             return Char2BooleanAVLTreeMap.this.tailMap(from.getCharKey()).char2BooleanEntrySet();
/*      */           }
/*      */         }; 
...
/* 1232 */       return new Char2BooleanAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1236 */       return new Char2BooleanAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1291 */             return (BooleanIterator)new Char2BooleanAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(boolean k) {
/* 1295 */             return Char2BooleanAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1299 */             return Char2BooleanAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1303 */             Char2BooleanAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1314 */     return new Submap(false, true, to, false);
/*      */   }
/*      */   
/*      */   public Char2BooleanSortedMap tailMap(char from) {
/* 1318 */     return new Submap(from, false, false, true);
/*      */   }
/*      */   
...
/* 1366 */       if (!bottom && !top && Char2BooleanAVLTreeMap.this.compare(from, to) > 0)
/* 1367 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1368 */       this.from = from;
/* 1369 */       this.bottom = bottom;
/* 1370 */       this.to = to;
/* 1371 */       this.top = top;
/* 1372 */       this.defRetValue = Char2BooleanAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1390 */       return ((this.bottom || Char2BooleanAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2BooleanAVLTreeMap.this
/* 1391 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
/* 1395 */       if (this.entries == null)
/* 1396 */         this.entries = (ObjectSortedSet<Char2BooleanMap.Entry>)new AbstractObjectSortedSet<Char2BooleanMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator() {
/* 1399 */               return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1404 */               return (ObjectBidirectionalIterator<Char2BooleanMap.Entry>)new Char2BooleanAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2BooleanMap.Entry> comparator() {
/* 1408 */               return Char2BooleanAVLTreeMap.this.char2BooleanEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1416 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1417 */                 return false; 
/* 1418 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1419 */                 return false; 
/* 1420 */               Char2BooleanAVLTreeMap.Entry f = Char2BooleanAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1421 */               return (f != null && Char2BooleanAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1429 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1430 */                 return false; 
/* 1431 */               if (e.getValue() == null || !(e.getValue() instanceof Boolean))
/* 1432 */                 return false; 
/* 1433 */               Char2BooleanAVLTreeMap.Entry f = Char2BooleanAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1434 */               if (f != null && Char2BooleanAVLTreeMap.Submap.this.in(f.key))
/* 1435 */                 Char2BooleanAVLTreeMap.Submap.this.remove(f.key); 
/* 1436 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1440 */               int c = 0;
/* 1441 */               for (ObjectBidirectionalIterator<Char2BooleanMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1442 */                 c++; 
/* 1443 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1447 */               return !(new Char2BooleanAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1451 */               Char2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2BooleanMap.Entry first() {
/* 1455 */               return Char2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2BooleanMap.Entry last() {
/* 1459 */               return Char2BooleanAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) {
/* 1464 */               return Char2BooleanAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) {
/* 1468 */               return Char2BooleanAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) {
/* 1472 */               return Char2BooleanAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2BooleanEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2BooleanSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1480 */         return new Char2BooleanAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1484 */         return new Char2BooleanAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public BooleanIterator iterator() {
/* 1499 */               return (BooleanIterator)new Char2BooleanAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(boolean k) {
/* 1503 */               return Char2BooleanAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1507 */               return Char2BooleanAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1511 */               Char2BooleanAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1519 */       return (in(k) && Char2BooleanAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(boolean v) {
...
/*      */     
/*      */     public boolean get(char k) {
/* 1536 */       char kk = k; Char2BooleanAVLTreeMap.Entry e;
/* 1537 */       return (in(kk) && (e = Char2BooleanAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public boolean put(char k, boolean v) {
/* 1541 */       Char2BooleanAVLTreeMap.this.modified = false;
/* 1542 */       if (!in(k))
...
/* 1545 */       boolean oldValue = Char2BooleanAVLTreeMap.this.put(k, v);
/* 1546 */       return Char2BooleanAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public boolean remove(char k) {
/* 1551 */       Char2BooleanAVLTreeMap.this.modified = false;
/* 1552 */       if (!in(k))
/* 1553 */         return this.defRetValue; 
/* 1554 */       boolean oldValue = Char2BooleanAVLTreeMap.this.remove(k);
/* 1555 */       return Char2BooleanAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1573 */       return Char2BooleanAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2BooleanSortedMap headMap(char to) {
/* 1577 */       if (this.top)
/* 1578 */         return new Submap(this.from, this.bottom, to, false); 
/* 1579 */       return (Char2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2BooleanSortedMap tailMap(char from) {
/* 1583 */       if (this.bottom)
/* 1584 */         return new Submap(from, false, this.to, this.top); 
/* 1585 */       return (Char2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2BooleanSortedMap subMap(char from, char to) {
...
/* 1591 */       if (!this.top)
/* 1592 */         to = (Char2BooleanAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1593 */       if (!this.bottom)
/* 1594 */         from = (Char2BooleanAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1606 */       if (Char2BooleanAVLTreeMap.this.tree == null) {
/* 1607 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1611 */       if (this.bottom) {
/* 1612 */         e = Char2BooleanAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1614 */         e = Char2BooleanAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1616 */         if (Char2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1617 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1621 */       if (e == null || (!this.top && Char2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1622 */         return null; 
/* 1623 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2BooleanAVLTreeMap.Entry e;
/* 1632 */       if (Char2BooleanAVLTreeMap.this.tree == null) {
/* 1633 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1637 */       if (this.top) {
/* 1638 */         e = Char2BooleanAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1640 */         e = Char2BooleanAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1642 */         if (Char2BooleanAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1643 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1647 */       if (e == null || (!this.bottom && Char2BooleanAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1648 */         return null; 
/* 1649 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1653 */       Char2BooleanAVLTreeMap.Entry e = firstEntry();
/* 1654 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1660 */       Char2BooleanAVLTreeMap.Entry e = lastEntry();
/* 1661 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1676 */         this.next = Char2BooleanAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1679 */         this();
/* 1680 */         if (this.next != null)
/* 1681 */           if (!Char2BooleanAVLTreeMap.Submap.this.bottom && Char2BooleanAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1682 */             this.prev = null;
/* 1683 */           } else if (!Char2BooleanAVLTreeMap.Submap.this.top && Char2BooleanAVLTreeMap.this.compare(k, (this.prev = Char2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1684 */             this.next = null;
/*      */           } else {
/* 1686 */             this.next = Char2BooleanAVLTreeMap.this.locateKey(k);
/* 1687 */             if (Char2BooleanAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1698 */         if (!Char2BooleanAVLTreeMap.Submap.this.bottom && this.prev != null && Char2BooleanAVLTreeMap.this.compare(this.prev.key, Char2BooleanAVLTreeMap.Submap.this.from) < 0)
/* 1699 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1703 */         this.next = this.next.next();
/* 1704 */         if (!Char2BooleanAVLTreeMap.Submap.this.top && this.next != null && Char2BooleanAVLTreeMap.this.compare(this.next.key, Char2BooleanAVLTreeMap.Submap.this.to) >= 0)
/* 1705 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1785 */       c = (Char2BooleanAVLTreeMap)super.clone();
...
/* 1866 */     if (n == 1) {
/* 1867 */       Entry entry = new Entry(s.readChar(), s.readBoolean());
...
/*      */ 
/*      */       
/* 1877 */       Entry entry = new Entry(s.readChar(), s.readBoolean());
/* 1878 */       entry.right(new Entry(s.readChar(), s.readBoolean()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanAVLTreeMap.class
