...
/*  50 */     return (entries instanceof Char2IntMap.FastEntrySet) ? (
/*  51 */       (Char2IntMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Char2IntMap.Entry> entries = map.char2IntEntrySet();
/*  71 */     if (entries instanceof Char2IntMap.FastEntrySet) {
/*  72 */       ((Char2IntMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Char2IntMap.Entry> entries = map.char2IntEntrySet();
/*  91 */     return (entries instanceof Char2IntMap.FastEntrySet) ? new ObjectIterable<Char2IntMap.Entry>() {
/*     */         public ObjectIterator<Char2IntMap.Entry> iterator() {
/*  93 */           return ((Char2IntMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Char2IntMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Char2IntMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractChar2IntMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)char2IntEntrySet();
/*     */     }
/*     */     
/*     */     public CharSet keySet() {
...
/* 300 */     return new Singleton(key.charValue(), value.intValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.char2IntEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, Integer>> entrySet() {
/* 361 */       return (ObjectSet)char2IntEntrySet();
/*     */     }
/*     */     
/*     */     public CharSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.char2IntEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, Integer>> entrySet() {
/* 674 */       return (ObjectSet)char2IntEntrySet();
/*     */     }
/*     */     
/*     */     public CharSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2IntMaps.class
