...
/*  910 */         return false; 
/*  911 */       Map.Entry<Character, Byte> e = (Map.Entry<Character, Byte>)o;
/*  912 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  998 */     int index = 0;
/*      */     TreeIterator() {
/* 1000 */       this.next = Char2ByteRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1003 */       if ((this.next = Char2ByteRBTreeMap.this.locateKey(k)) != null)
/* 1004 */         if (Char2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1055 */       updatePrevious();
/* 1056 */       updateNext();
/* 1057 */       Char2ByteRBTreeMap.this.remove(this.curr.key);
/* 1058 */       this.curr = null;
/*      */     }
...
/* 1097 */       this.entries = (ObjectSortedSet<Char2ByteMap.Entry>)new AbstractObjectSortedSet<Char2ByteMap.Entry>()
/*      */         {
...
/* 1106 */             return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from) {
/* 1110 */             return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1121 */               return false; 
/* 1122 */             Char2ByteRBTreeMap.Entry f = Char2ByteRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1134 */               return false; 
/* 1135 */             Char2ByteRBTreeMap.Entry f = Char2ByteRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1136 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue())
/* 1137 */               return false; 
/* 1138 */             Char2ByteRBTreeMap.this.remove(f.key);
/* 1139 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1143 */             return Char2ByteRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1147 */             Char2ByteRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2ByteMap.Entry first() {
/* 1151 */             return Char2ByteRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2ByteMap.Entry last() {
/* 1155 */             return Char2ByteRBTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to) {
/* 1159 */             return Char2ByteRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to) {
/* 1163 */             return Char2ByteRBTreeMap.this.headMap(to.getCharKey()).char2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from) {
/* 1167 */             return Char2ByteRBTreeMap.this.tailMap(from.getCharKey()).char2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1201 */       return new Char2ByteRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1205 */       return new Char2ByteRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1260 */             return (ByteIterator)new Char2ByteRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(byte k) {
/* 1264 */             return Char2ByteRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1268 */             return Char2ByteRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1272 */             Char2ByteRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1335 */       if (!bottom && !top && Char2ByteRBTreeMap.this.compare(from, to) > 0)
/* 1336 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1337 */       this.from = from;
/* 1338 */       this.bottom = bottom;
/* 1339 */       this.to = to;
/* 1340 */       this.top = top;
/* 1341 */       this.defRetValue = Char2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1359 */       return ((this.bottom || Char2ByteRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ByteRBTreeMap.this
/* 1360 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
/* 1364 */       if (this.entries == null)
/* 1365 */         this.entries = (ObjectSortedSet<Char2ByteMap.Entry>)new AbstractObjectSortedSet<Char2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator() {
/* 1368 */               return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from) {
/* 1372 */               return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2ByteMap.Entry> comparator() {
/* 1376 */               return Char2ByteRBTreeMap.this.char2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */                 return false; 
/* 1388 */               Char2ByteRBTreeMap.Entry f = Char2ByteRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1389 */               return (f != null && Char2ByteRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1400 */                 return false; 
/* 1401 */               Char2ByteRBTreeMap.Entry f = Char2ByteRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1402 */               if (f != null && Char2ByteRBTreeMap.Submap.this.in(f.key))
/* 1403 */                 Char2ByteRBTreeMap.Submap.this.remove(f.key); 
/* 1404 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1408 */               int c = 0;
/* 1409 */               for (ObjectBidirectionalIterator<Char2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1410 */                 c++; 
/* 1411 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1415 */               return !(new Char2ByteRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1419 */               Char2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2ByteMap.Entry first() {
/* 1423 */               return Char2ByteRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2ByteMap.Entry last() {
/* 1427 */               return Char2ByteRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to) {
/* 1431 */               return Char2ByteRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to) {
/* 1435 */               return Char2ByteRBTreeMap.Submap.this.headMap(to.getCharKey()).char2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from) {
/* 1439 */               return Char2ByteRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2ByteSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1447 */         return new Char2ByteRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1451 */         return new Char2ByteRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1466 */               return (ByteIterator)new Char2ByteRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(byte k) {
/* 1470 */               return Char2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1474 */               return Char2ByteRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1478 */               Char2ByteRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1486 */       return (in(k) && Char2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(char k) {
/* 1503 */       char kk = k; Char2ByteRBTreeMap.Entry e;
/* 1504 */       return (in(kk) && (e = Char2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public byte put(char k, byte v) {
/* 1508 */       Char2ByteRBTreeMap.this.modified = false;
/* 1509 */       if (!in(k))
...
/* 1512 */       byte oldValue = Char2ByteRBTreeMap.this.put(k, v);
/* 1513 */       return Char2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte remove(char k) {
/* 1518 */       Char2ByteRBTreeMap.this.modified = false;
/* 1519 */       if (!in(k))
/* 1520 */         return this.defRetValue; 
/* 1521 */       byte oldValue = Char2ByteRBTreeMap.this.remove(k);
/* 1522 */       return Char2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1540 */       return Char2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2ByteSortedMap headMap(char to) {
/* 1544 */       if (this.top)
/* 1545 */         return new Submap(this.from, this.bottom, to, false); 
/* 1546 */       return (Char2ByteRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2ByteSortedMap tailMap(char from) {
/* 1550 */       if (this.bottom)
/* 1551 */         return new Submap(from, false, this.to, this.top); 
/* 1552 */       return (Char2ByteRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2ByteSortedMap subMap(char from, char to) {
...
/* 1558 */       if (!this.top)
/* 1559 */         to = (Char2ByteRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1560 */       if (!this.bottom)
/* 1561 */         from = (Char2ByteRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1573 */       if (Char2ByteRBTreeMap.this.tree == null) {
/* 1574 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1578 */       if (this.bottom) {
/* 1579 */         e = Char2ByteRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1581 */         e = Char2ByteRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1583 */         if (Char2ByteRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1584 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1588 */       if (e == null || (!this.top && Char2ByteRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1589 */         return null; 
/* 1590 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2ByteRBTreeMap.Entry e;
/* 1599 */       if (Char2ByteRBTreeMap.this.tree == null) {
/* 1600 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1604 */       if (this.top) {
/* 1605 */         e = Char2ByteRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1607 */         e = Char2ByteRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1609 */         if (Char2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1610 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1614 */       if (e == null || (!this.bottom && Char2ByteRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1615 */         return null; 
/* 1616 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1620 */       Char2ByteRBTreeMap.Entry e = firstEntry();
/* 1621 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1627 */       Char2ByteRBTreeMap.Entry e = lastEntry();
/* 1628 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1643 */         this.next = Char2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1646 */         this();
/* 1647 */         if (this.next != null)
/* 1648 */           if (!Char2ByteRBTreeMap.Submap.this.bottom && Char2ByteRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1649 */             this.prev = null;
/* 1650 */           } else if (!Char2ByteRBTreeMap.Submap.this.top && Char2ByteRBTreeMap.this.compare(k, (this.prev = Char2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1651 */             this.next = null;
/*      */           } else {
/* 1653 */             this.next = Char2ByteRBTreeMap.this.locateKey(k);
/* 1654 */             if (Char2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1665 */         if (!Char2ByteRBTreeMap.Submap.this.bottom && this.prev != null && Char2ByteRBTreeMap.this.compare(this.prev.key, Char2ByteRBTreeMap.Submap.this.from) < 0)
/* 1666 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1670 */         this.next = this.next.next();
/* 1671 */         if (!Char2ByteRBTreeMap.Submap.this.top && this.next != null && Char2ByteRBTreeMap.this.compare(this.next.key, Char2ByteRBTreeMap.Submap.this.to) >= 0)
/* 1672 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1752 */       c = (Char2ByteRBTreeMap)super.clone();
...
/* 1833 */     if (n == 1) {
/* 1834 */       Entry entry = new Entry(s.readChar(), s.readByte());
...
/*      */ 
/*      */       
/* 1845 */       Entry entry = new Entry(s.readChar(), s.readByte());
/* 1846 */       entry.black(true);
/* 1847 */       entry.right(new Entry(s.readChar(), s.readByte()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ByteRBTreeMap.class
