...
/*     */   
/*     */   public boolean trim() {
/* 597 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 629 */     int l = HashCommon.nextPowerOfTwo((int)Math.ceil((n / this.f)));
/* 630 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 631 */       return true; 
/*     */     try {
/* 633 */       rehash(l);
/* 634 */     } catch (OutOfMemoryError cantDoIt) {
/* 635 */       return false;
/*     */     } 
/* 637 */     return true;
/*     */   }
...
/* 653 */     char[] key = this.key;
/* 654 */     int mask = newN - 1;
/* 655 */     char[] newKey = new char[newN + 1];
/* 656 */     int i = this.n;
/* 657 */     for (int j = realSize(); j-- != 0; ) {
/* 658 */       while (key[--i] == '\000'); int pos;
/* 659 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != '\000')
/*     */       {
/* 661 */         while (newKey[pos = pos + 1 & mask] != '\000'); } 
/* 662 */       newKey[pos] = key[i];
/*     */     } 
/* 664 */     this.n = newN;
/* 665 */     this.mask = mask;
/* 666 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 667 */     this.key = newKey;
/*     */   }
/*     */ 
/*     */ 
...
/*     */     try {
/* 684 */       c = (CharOpenCustomHashSet)super.clone();
/* 685 */     } catch (CloneNotSupportedException cantHappen) {
/* 686 */       throw new InternalError();
/*     */     } 
/* 688 */     c.key = (char[])this.key.clone();
/* 689 */     c.containsNull = this.containsNull;
/* 690 */     c.strategy = this.strategy;
/* 691 */     return c;
/*     */   }
/*     */ 
/*     */ 
...
/*     */   public int hashCode() {
/* 704 */     int h = 0;
/* 705 */     for (int j = realSize(), i = 0; j-- != 0; ) {
/* 706 */       while (this.key[i] == '\000')
/* 707 */         i++; 
/* 708 */       h += this.strategy.hashCode(this.key[i]);
/* 709 */       i++;
/*     */     } 
/*     */     
/* 712 */     return h;
...
/* 715 */     CharIterator i = iterator();
/* 716 */     s.defaultWriteObject();
/* 717 */     for (int j = this.size; j-- != 0;)
/* 718 */       s.writeChar(i.nextChar()); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 722 */     s.defaultReadObject();
/* 723 */     this.n = HashCommon.arraySize(this.size, this.f);
/* 724 */     this.maxFill = HashCommon.maxFill(this.n, this.f);
/* 725 */     this.mask = this.n - 1;
/* 726 */     char[] key = this.key = new char[this.n + 1];
/*     */     
/* 728 */     for (int i = this.size; i-- != 0; ) {
/* 729 */       int pos; char k = s.readChar();
/* 730 */       if (this.strategy.equals(k, false)) {
/* 731 */         pos = this.n;
/* 732 */         this.containsNull = true;
/*     */       }
/* 734 */       else if (key[pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask] != '\000') {
/* 735 */         while (key[pos = pos + 1 & this.mask] != '\000');
/*     */       } 
/* 737 */       key[pos] = k;
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\CharOpenCustomHashSet.class
