...
/*  61 */     return (entries instanceof Char2BooleanSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Char2BooleanSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Char2BooleanMap.Entry> entries = map.char2BooleanEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Char2BooleanSortedMap.FastSortedEntrySet)entries); return (entries instanceof Char2BooleanSortedMap.FastSortedEntrySet) ? (Char2BooleanSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Char2BooleanMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Char2BooleanMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Character, Boolean>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Char2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2BooleanSortedMap headMap(char to) {
/* 132 */       return Char2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2BooleanSortedMap tailMap(char from) {
/* 137 */       return Char2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Char2BooleanMap.Entry>)ObjectSortedSets.singleton(new AbstractChar2BooleanMap.BasicEntry(this.key, this.value), 
/* 237 */             Char2BooleanSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Char2BooleanMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Character, Boolean>> entrySet() {
/* 249 */       return (ObjectSortedSet)char2BooleanEntrySet();
/*     */     }
/*     */     
/*     */     public CharSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Char2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2BooleanSortedMap headMap(char to) {
...
/* 268 */         return this; 
/* 269 */       return Char2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2BooleanSortedMap tailMap(char from) {
...
/* 275 */         return this; 
/* 276 */       return Char2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public char firstCharKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.charValue(), value.booleanValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Char2BooleanMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.char2BooleanEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Char2BooleanMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Character, Boolean>> entrySet() {
/* 449 */       return (ObjectSortedSet)char2BooleanEntrySet();
/*     */     }
/*     */     
/*     */     public CharSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Char2BooleanMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.char2BooleanEntrySet()); 
/* 582 */       return (ObjectSortedSet<Char2BooleanMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanSortedMaps.class
