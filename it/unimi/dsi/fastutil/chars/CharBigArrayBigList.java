...
/* 130 */     this(a, 0L, CharBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 151 */     this(length);
/* 152 */     CharBigArrays.copy(a, offset, this.a, 0L, length);
...
/* 213 */     return wrap(a, CharBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       return; 
/* 226 */     this.a = CharBigArrays.forceCapacity(this.a, capacity, this.size);
/* 227 */     assert this.size <= CharBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 239 */     long oldLength = CharBigArrays.length(this.a);
...
/* 245 */       capacity = 10L;
/* 246 */     }  this.a = CharBigArrays.forceCapacity(this.a, capacity, this.size);
/* 247 */     assert this.size <= CharBigArrays.length(this.a);
/*     */   }
/*     */   
...
/* 254 */       CharBigArrays.copy(this.a, index, this.a, index + 1L, this.size - index); 
/* 255 */     CharBigArrays.set(this.a, index, k);
/* 256 */     this.size++;
/* 257 */     assert this.size <= CharBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public boolean add(char k) {
/* 261 */     grow(this.size + 1L);
/* 262 */     CharBigArrays.set(this.a, this.size++, k);
/* 263 */     if (!$assertionsDisabled && this.size > CharBigArrays.length(this.a)) throw new AssertionError(); 
/* 264 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 271 */     return CharBigArrays.get(this.a, index);
/*     */   }
/*     */   
/*     */   public long indexOf(char k) {
/* 275 */     for (long i = 0L; i < this.size; i++) {
/* 276 */       if (k == CharBigArrays.get(this.a, i))
/* 277 */         return i; 
/* 278 */     }  return -1L;
/*     */   }
/*     */   
...
/* 283 */       if (k == CharBigArrays.get(this.a, i))
/* 284 */         return i; 
/* 285 */     }  return -1L;
/*     */   }
/*     */   
...
/*     */     }
/* 292 */     char old = CharBigArrays.get(this.a, index);
/* 293 */     this.size--;
/* 294 */     if (index != this.size)
/* 295 */       CharBigArrays.copy(this.a, index + 1L, this.a, index, this.size - index); 
/* 296 */     assert this.size <= CharBigArrays.length(this.a);
/* 297 */     return old;
/*     */   }
/*     */   
...
/* 305 */     assert this.size <= CharBigArrays.length(this.a);
/* 306 */     return true;
/*     */   }
/*     */   
...
/*     */     }
/* 313 */     char old = CharBigArrays.get(this.a, index);
/* 314 */     CharBigArrays.set(this.a, index, k);
/* 315 */     return old;
/*     */   }
/*     */   
...
/*     */   public void clear() {
/* 365 */     this.size = 0L;
/* 366 */     assert this.size <= CharBigArrays.length(this.a);
/*     */   }
/*     */   
/*     */   public long size64() {
...
/* 374 */     if (size > CharBigArrays.length(this.a))
/* 375 */       ensureCapacity(size); 
/* 376 */     if (size > this.size)
/* 377 */       CharBigArrays.fill(this.a, this.size, size, false); 
/* 378 */     this.size = size;
/*     */   }
/*     */   
...
/* 410 */     long arrayLength = CharBigArrays.length(this.a);
/* 411 */     if (n >= arrayLength || this.size == arrayLength)
/*     */       return; 
/* 413 */     this.a = CharBigArrays.trim(this.a, Math.max(n, this.size));
/* 414 */     assert this.size <= CharBigArrays.length(this.a);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 432 */     CharBigArrays.copy(this.a, from, a, offset, length);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 445 */     CharBigArrays.copy(this.a, to, this.a, from, this.size - to);
...
/* 463 */     CharBigArrays.ensureOffsetLength(a, offset, length);
/* 464 */     grow(this.size + length);
/* 465 */     CharBigArrays.copy(this.a, index, this.a, index + length, this.size - index);
/* 466 */     CharBigArrays.copy(a, offset, this.a, index, length);
...
/* 486 */           return CharBigArrays.get(CharBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public char previousChar() {
/* 490 */           if (!hasPrevious())
/* 491 */             throw new NoSuchElementException(); 
/* 492 */           return CharBigArrays.get(CharBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 531 */     CharBigArrays.copy(this.a, 0L, c.a, 0L, this.size);
...
/* 554 */     char[][] a2 = l.a;
/* 555 */     while (s-- != 0L) {
/* 556 */       if (CharBigArrays.get(a1, s) != CharBigArrays.get(a2, s))
/* 557 */         return false; 
/* 558 */     }  return true;
/*     */   }
/*     */ 
...
/* 579 */       char e1 = CharBigArrays.get(a1, i);
/* 580 */       char e2 = CharBigArrays.get(a2, i); int r;
...
/* 589 */       s.writeChar(CharBigArrays.get(this.a, i)); 
/*     */   }
/*     */   
...
/* 596 */       CharBigArrays.set(this.a, i, s.readChar()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\CharBigArrayBigList.class
