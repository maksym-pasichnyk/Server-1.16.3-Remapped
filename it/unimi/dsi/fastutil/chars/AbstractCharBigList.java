...
/* 157 */     return new CharBigListIterator() {
/* 158 */         long pos = index; long last = -1L;
/*     */         
/*     */         public boolean hasNext() {
/* 161 */           return (this.pos < AbstractCharBigList.this.size64());
/*     */         }
/*     */         
...
/* 171 */           return AbstractCharBigList.this.getChar(this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public char previousChar() {
/* 175 */           if (!hasPrevious())
/* 176 */             throw new NoSuchElementException(); 
/* 177 */           return AbstractCharBigList.this.getChar(this.last = --this.pos);
/*     */         }
/*     */         
...
/* 189 */           AbstractCharBigList.this.add(this.pos++, k);
/* 190 */           this.last = -1L;
/*     */         }
/*     */         
...
/* 196 */           AbstractCharBigList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 200 */           if (this.last == -1L)
/* 201 */             throw new IllegalStateException(); 
/* 202 */           AbstractCharBigList.this.removeChar(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 226 */     CharBigListIterator i = listIterator();
/*     */     
/* 228 */     while (i.hasNext()) {
...
/* 237 */     CharBigListIterator i = listIterator(size64());
/*     */     
...
/* 273 */     ensureIndex(to);
/* 274 */     CharBigListIterator i = listIterator(from);
/* 275 */     long n = to - from;
/* 276 */     if (n < 0L)
...
/* 306 */     addElements(index, a, 0L, CharBigArrays.length(a));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public int hashCode() {
/* 358 */     CharIterator i = iterator();
/* 359 */     int h = 1;
/* 360 */     long s = size64();
/* 361 */     while (s-- != 0L) {
/* 362 */       char k = i.nextChar();
/* 363 */       h = 31 * h + k;
/*     */     } 
/* 365 */     return h;
/*     */   }
...
/* 375 */     if (s != l.size64())
/* 376 */       return false; 
/* 377 */     if (l instanceof CharBigList) {
/* 378 */       CharBigListIterator charBigListIterator1 = listIterator(), charBigListIterator2 = ((CharBigList)l).listIterator();
/* 379 */       while (s-- != 0L) {
/* 380 */         if (charBigListIterator1.nextChar() != charBigListIterator2.nextChar())
/* 381 */           return false; 
/* 382 */       }  return true;
/*     */     } 
...
/* 406 */     if (l == this)
/* 407 */       return 0; 
/* 408 */     if (l instanceof CharBigList) {
/* 409 */       CharBigListIterator charBigListIterator1 = listIterator(), charBigListIterator2 = ((CharBigList)l).listIterator();
/*     */ 
/*     */       
/* 412 */       while (charBigListIterator1.hasNext() && charBigListIterator2.hasNext()) {
/* 413 */         char e1 = charBigListIterator1.nextChar();
/* 414 */         char e2 = charBigListIterator2.nextChar(); int r;
/* 415 */         if ((r = Character.compare(e1, e2)) != 0)
/* 416 */           return r; 
/*     */       } 
/* 418 */       return charBigListIterator2.hasNext() ? -1 : (charBigListIterator1.hasNext() ? 1 : 0);
/*     */     } 
/* 420 */     BigListIterator<? extends Character> i1 = listIterator(), i2 = l.listIterator();
/*     */     
...
/* 436 */     return removeChar(size64() - 1L);
/*     */   }
/*     */   
/*     */   public char topChar() {
/* 440 */     if (isEmpty())
/* 441 */       throw new NoSuchElementException(); 
/* 442 */     return getChar(size64() - 1L);
/*     */   }
/*     */   
/*     */   public char peekChar(int i) {
/* 446 */     return getChar(size64() - 1L - i);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 532 */     return Character.valueOf(set(index, ok.charValue()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 545 */     return Character.valueOf(getChar(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 558 */     return indexOf(((Character)ok).charValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 571 */     return lastIndexOf(((Character)ok).charValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 584 */     return Character.valueOf(removeChar(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 610 */     return Character.valueOf(popChar());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 623 */     return Character.valueOf(topChar());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 636 */     return Character.valueOf(peekChar(i));
/*     */   }
/*     */   
/*     */   public String toString() {
/* 640 */     StringBuilder s = new StringBuilder();
/* 641 */     CharIterator i = iterator();
/* 642 */     long n = size64();
/*     */     
...
/* 700 */       return this.l.getChar(this.from + index);
/*     */     }
/*     */     
/*     */     public char removeChar(long index) {
/* 704 */       ensureRestrictedIndex(index);
/* 705 */       this.to--;
/* 706 */       return this.l.removeChar(this.from + index);
/*     */     }
/*     */     
/*     */     public char set(long index, char k) {
...
/* 743 */       return new CharBigListIterator() {
/* 744 */           long pos = index; long last = -1L;
/*     */           
/*     */           public boolean hasNext() {
/* 747 */             return (this.pos < AbstractCharBigList.CharSubList.this.size64());
/*     */           }
/*     */           
/*     */           public boolean hasPrevious() {
...
/* 757 */             return AbstractCharBigList.CharSubList.this.l.getChar(AbstractCharBigList.CharSubList.this.from + (this.last = this.pos++));
/*     */           }
/*     */           
/*     */           public char previousChar() {
/* 761 */             if (!hasPrevious())
/* 762 */               throw new NoSuchElementException(); 
/* 763 */             return AbstractCharBigList.CharSubList.this.l.getChar(AbstractCharBigList.CharSubList.this.from + (this.last = --this.pos));
/*     */           }
/*     */           
/*     */           public long nextIndex() {
/* 767 */             return this.pos;
...
/* 777 */             AbstractCharBigList.CharSubList.this.add(this.pos++, k);
/* 778 */             this.last = -1L;
/* 779 */             if (!$assertionsDisabled && !AbstractCharBigList.CharSubList.this.assertRange()) throw new AssertionError(); 
/*     */           }
/*     */           
/*     */           public void set(char k) {
/* 783 */             if (this.last == -1L)
/* 784 */               throw new IllegalStateException(); 
/* 785 */             AbstractCharBigList.CharSubList.this.set(this.last, k);
/*     */           }
/*     */           
/*     */           public void remove() {
/* 789 */             if (this.last == -1L)
/* 790 */               throw new IllegalStateException(); 
/* 791 */             AbstractCharBigList.CharSubList.this.removeChar(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */             
...
/* 797 */               this.pos--; 
/* 798 */             this.last = -1L;
/* 799 */             assert AbstractCharBigList.CharSubList.this.assertRange();
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 809 */       return new CharSubList(this, from, to);
/*     */     }
/*     */     
/*     */     public boolean rem(char k) {
...
/* 815 */         return false; 
/* 816 */       this.to--;
/* 817 */       this.l.removeChar(this.from + index);
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\AbstractCharBigList.class
