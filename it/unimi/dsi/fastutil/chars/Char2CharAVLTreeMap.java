...
/*  954 */         return false; 
/*  955 */       Map.Entry<Character, Character> e = (Map.Entry<Character, Character>)o;
/*  956 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Char2CharAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1047 */       if ((this.next = Char2CharAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Char2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Char2CharAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Char2CharMap.Entry>)new AbstractObjectSortedSet<Char2CharMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Char2CharMap.Entry>)new Char2CharAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Char2CharMap.Entry>)new Char2CharAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Char2CharAVLTreeMap.Entry f = Char2CharAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1186 */               return false; 
/* 1187 */             Char2CharAVLTreeMap.Entry f = Char2CharAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1188 */             if (f == null || f.getCharValue() != ((Character)e.getValue()).charValue())
/* 1189 */               return false; 
/* 1190 */             Char2CharAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Char2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Char2CharAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2CharMap.Entry first() {
/* 1203 */             return Char2CharAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2CharMap.Entry last() {
/* 1207 */             return Char2CharAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry from, Char2CharMap.Entry to) {
/* 1211 */             return Char2CharAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry to) {
/* 1215 */             return Char2CharAVLTreeMap.this.headMap(to.getCharKey()).char2CharEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry from) {
/* 1219 */             return Char2CharAVLTreeMap.this.tailMap(from.getCharKey()).char2CharEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Char2CharAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1257 */       return new Char2CharAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1309 */       this.values = new AbstractCharCollection()
/*      */         {
/*      */           public CharIterator iterator() {
/* 1312 */             return new Char2CharAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(char k) {
/* 1316 */             return Char2CharAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Char2CharAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Char2CharAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Char2CharAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Char2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Char2CharAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2CharAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Char2CharMap.Entry>)new AbstractObjectSortedSet<Char2CharMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Char2CharMap.Entry>)new Char2CharAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Char2CharMap.Entry>)new Char2CharAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2CharMap.Entry> comparator() {
/* 1428 */               return Char2CharAVLTreeMap.this.char2CharEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Char2CharAVLTreeMap.Entry f = Char2CharAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1441 */               return (f != null && Char2CharAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Char2CharAVLTreeMap.Entry f = Char2CharAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1454 */               if (f != null && Char2CharAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Char2CharAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Char2CharMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Char2CharAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Char2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2CharMap.Entry first() {
/* 1475 */               return Char2CharAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2CharMap.Entry last() {
/* 1479 */               return Char2CharAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry from, Char2CharMap.Entry to) {
/* 1483 */               return Char2CharAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry to) {
/* 1487 */               return Char2CharAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2CharEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry from) {
/* 1491 */               return Char2CharAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2CharEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2CharSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1499 */         return new Char2CharAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1503 */         return new Char2CharAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/* 1515 */         this.values = new AbstractCharCollection()
/*      */           {
/*      */             public CharIterator iterator() {
/* 1518 */               return new Char2CharAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(char k) {
/* 1522 */               return Char2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Char2CharAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Char2CharAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1538 */       return (in(k) && Char2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(char v) {
...
/*      */     
/*      */     public char get(char k) {
/* 1555 */       char kk = k; Char2CharAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Char2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public char put(char k, char v) {
/* 1560 */       Char2CharAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       char oldValue = Char2CharAVLTreeMap.this.put(k, v);
/* 1565 */       return Char2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public char remove(char k) {
/* 1570 */       Char2CharAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       char oldValue = Char2CharAVLTreeMap.this.remove(k);
/* 1574 */       return Char2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1592 */       return Char2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2CharSortedMap headMap(char to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Char2CharAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2CharSortedMap tailMap(char from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Char2CharAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2CharSortedMap subMap(char from, char to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Char2CharAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Char2CharAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Char2CharAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Char2CharAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Char2CharAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Char2CharAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Char2CharAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2CharAVLTreeMap.Entry e;
/* 1651 */       if (Char2CharAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Char2CharAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Char2CharAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Char2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Char2CharAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1672 */       Char2CharAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1679 */       Char2CharAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Char2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Char2CharAVLTreeMap.Submap.this.bottom && Char2CharAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Char2CharAVLTreeMap.Submap.this.top && Char2CharAVLTreeMap.this.compare(k, (this.prev = Char2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Char2CharAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Char2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Char2CharAVLTreeMap.Submap.this.bottom && this.prev != null && Char2CharAVLTreeMap.this.compare(this.prev.key, Char2CharAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Char2CharAVLTreeMap.Submap.this.top && this.next != null && Char2CharAVLTreeMap.this.compare(this.next.key, Char2CharAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1804 */       c = (Char2CharAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readChar(), s.readChar());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readChar(), s.readChar());
/* 1897 */       entry.right(new Entry(s.readChar(), s.readChar()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2CharAVLTreeMap.class
