...
/*  626 */       return Char2ReferenceOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public V getValue() {
/*  630 */       return Char2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public V setValue(V v) {
/*  634 */       V oldValue = Char2ReferenceOpenCustomHashMap.this.value[this.index];
/*  635 */       Char2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/*  636 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  646 */       return Character.valueOf(Char2ReferenceOpenCustomHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */     
...
/*  654 */       return (Char2ReferenceOpenCustomHashMap.this.strategy.equals(Char2ReferenceOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue()) && Char2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  658 */       return Char2ReferenceOpenCustomHashMap.this.strategy.hashCode(Char2ReferenceOpenCustomHashMap.this.key[this.index]) ^ (
/*  659 */         (Char2ReferenceOpenCustomHashMap.this.value[this.index] == null) ? 0 : System.identityHashCode(Char2ReferenceOpenCustomHashMap.this.value[this.index]));
/*      */     }
/*      */     
/*      */     public String toString() {
/*  663 */       return Char2ReferenceOpenCustomHashMap.this.key[this.index] + "=>" + Char2ReferenceOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  673 */     int pos = Char2ReferenceOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  680 */     int last = -1;
/*      */     
/*  682 */     int c = Char2ReferenceOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  686 */     boolean mustReturnNullKey = Char2ReferenceOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  701 */         return this.last = Char2ReferenceOpenCustomHashMap.this.n;
/*      */       } 
/*  703 */       char[] key = Char2ReferenceOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  705 */         if (--this.pos < 0) {
/*      */           
/*  707 */           this.last = Integer.MIN_VALUE;
/*  708 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  709 */           int p = HashCommon.mix(Char2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ReferenceOpenCustomHashMap.this.mask;
/*  710 */           while (!Char2ReferenceOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  711 */             p = p + 1 & Char2ReferenceOpenCustomHashMap.this.mask; 
/*  712 */           return p;
/*      */         } 
...
/*  729 */       char[] key = Char2ReferenceOpenCustomHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  731 */         pos = (last = pos) + 1 & Char2ReferenceOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  733 */           if ((curr = key[pos]) == '\000') {
/*  734 */             key[last] = Character.MIN_VALUE;
/*  735 */             Char2ReferenceOpenCustomHashMap.this.value[last] = null;
/*      */             return;
/*      */           } 
/*  738 */           int slot = HashCommon.mix(Char2ReferenceOpenCustomHashMap.this.strategy.hashCode(curr)) & Char2ReferenceOpenCustomHashMap.this.mask;
/*  739 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  741 */           pos = pos + 1 & Char2ReferenceOpenCustomHashMap.this.mask;
/*      */         } 
/*  743 */         if (pos < last) {
...
/*      */         } 
/*  748 */         key[last] = curr;
/*  749 */         Char2ReferenceOpenCustomHashMap.this.value[last] = Char2ReferenceOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  753 */       if (this.last == -1)
/*  754 */         throw new IllegalStateException(); 
/*  755 */       if (this.last == Char2ReferenceOpenCustomHashMap.this.n) {
/*  756 */         Char2ReferenceOpenCustomHashMap.this.containsNullKey = false;
/*  757 */         Char2ReferenceOpenCustomHashMap.this.value[Char2ReferenceOpenCustomHashMap.this.n] = null;
/*  758 */       } else if (this.pos >= 0) {
/*  759 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  762 */         Char2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  763 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  766 */       Char2ReferenceOpenCustomHashMap.this.size--;
/*  767 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Char2ReferenceMap.Entry<V>> { private Char2ReferenceOpenCustomHashMap<V>.MapEntry entry;
/*      */     
/*      */     public Char2ReferenceOpenCustomHashMap<V>.MapEntry next() {
/*  782 */       return this.entry = new Char2ReferenceOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  791 */       this.entry = new Char2ReferenceOpenCustomHashMap.MapEntry();
...
/*  801 */       return new Char2ReferenceOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Char2ReferenceMap.Entry<V>> fastIterator() {
/*  805 */       return new Char2ReferenceOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  817 */       if (Char2ReferenceOpenCustomHashMap.this.strategy.equals(k, false)) {
/*  818 */         return (Char2ReferenceOpenCustomHashMap.this.containsNullKey && Char2ReferenceOpenCustomHashMap.this.value[Char2ReferenceOpenCustomHashMap.this.n] == v);
/*      */       }
/*  820 */       char[] key = Char2ReferenceOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/*  823 */       if ((curr = key[pos = HashCommon.mix(Char2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ReferenceOpenCustomHashMap.this.mask]) == '\000')
/*  824 */         return false; 
/*  825 */       if (Char2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  826 */         return (Char2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  829 */         if ((curr = key[pos = pos + 1 & Char2ReferenceOpenCustomHashMap.this.mask]) == '\000')
/*  830 */           return false; 
/*  831 */         if (Char2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  832 */           return (Char2ReferenceOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  845 */       if (Char2ReferenceOpenCustomHashMap.this.strategy.equals(k, false)) {
/*  846 */         if (Char2ReferenceOpenCustomHashMap.this.containsNullKey && Char2ReferenceOpenCustomHashMap.this.value[Char2ReferenceOpenCustomHashMap.this.n] == v) {
/*  847 */           Char2ReferenceOpenCustomHashMap.this.removeNullEntry();
/*  848 */           return true;
/*      */         } 
/*  850 */         return false;
/*      */       } 
/*      */       
/*  853 */       char[] key = Char2ReferenceOpenCustomHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/*  856 */       if ((curr = key[pos = HashCommon.mix(Char2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ReferenceOpenCustomHashMap.this.mask]) == '\000')
/*  857 */         return false; 
/*  858 */       if (Char2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  859 */         if (Char2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/*  860 */           Char2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/*  861 */           return true;
/*      */         } 
/*  863 */         return false;
/*      */       } 
/*      */       while (true) {
/*  866 */         if ((curr = key[pos = pos + 1 & Char2ReferenceOpenCustomHashMap.this.mask]) == '\000')
/*  867 */           return false; 
/*  868 */         if (Char2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  869 */           Char2ReferenceOpenCustomHashMap.this.value[pos] == v) {
/*  870 */           Char2ReferenceOpenCustomHashMap.this.removeEntry(pos);
/*  871 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  878 */       return Char2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  882 */       Char2ReferenceOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
/*  887 */       if (Char2ReferenceOpenCustomHashMap.this.containsNullKey)
/*  888 */         consumer.accept(new AbstractChar2ReferenceMap.BasicEntry<>(Char2ReferenceOpenCustomHashMap.this.key[Char2ReferenceOpenCustomHashMap.this.n], Char2ReferenceOpenCustomHashMap.this.value[Char2ReferenceOpenCustomHashMap.this.n])); 
/*  889 */       for (int pos = Char2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) {
/*  890 */         if (Char2ReferenceOpenCustomHashMap.this.key[pos] != '\000')
/*  891 */           consumer.accept(new AbstractChar2ReferenceMap.BasicEntry<>(Char2ReferenceOpenCustomHashMap.this.key[pos], Char2ReferenceOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
/*  896 */       AbstractChar2ReferenceMap.BasicEntry<V> entry = new AbstractChar2ReferenceMap.BasicEntry<>();
/*  897 */       if (Char2ReferenceOpenCustomHashMap.this.containsNullKey) {
/*  898 */         entry.key = Char2ReferenceOpenCustomHashMap.this.key[Char2ReferenceOpenCustomHashMap.this.n];
/*  899 */         entry.value = Char2ReferenceOpenCustomHashMap.this.value[Char2ReferenceOpenCustomHashMap.this.n];
/*  900 */         consumer.accept(entry);
/*      */       } 
/*  902 */       for (int pos = Char2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) {
/*  903 */         if (Char2ReferenceOpenCustomHashMap.this.key[pos] != '\000') {
/*  904 */           entry.key = Char2ReferenceOpenCustomHashMap.this.key[pos];
/*  905 */           entry.value = Char2ReferenceOpenCustomHashMap.this.value[pos];
...
/*  931 */       return Char2ReferenceOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractCharSet { private KeySet() {}
/*      */     
/*      */     public CharIterator iterator() {
/*  937 */       return new Char2ReferenceOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  942 */       if (Char2ReferenceOpenCustomHashMap.this.containsNullKey)
/*  943 */         consumer.accept(Char2ReferenceOpenCustomHashMap.this.key[Char2ReferenceOpenCustomHashMap.this.n]); 
/*  944 */       for (int pos = Char2ReferenceOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  945 */         char k = Char2ReferenceOpenCustomHashMap.this.key[pos];
/*  946 */         if (k != '\000')
...
/*      */     
/*      */     public int size() {
/*  952 */       return Char2ReferenceOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(char k) {
/*  956 */       return Char2ReferenceOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(char k) {
/*  960 */       int oldSize = Char2ReferenceOpenCustomHashMap.this.size;
/*  961 */       Char2ReferenceOpenCustomHashMap.this.remove(k);
/*  962 */       return (Char2ReferenceOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/*  966 */       Char2ReferenceOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/*      */   {
/*      */     public V next() {
/*  990 */       return Char2ReferenceOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/*  999 */             return new Char2ReferenceOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1003 */             return Char2ReferenceOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(Object v) {
/* 1007 */             return Char2ReferenceOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1011 */             Char2ReferenceOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(Consumer<? super V> consumer)
/*      */           {
/* 1016 */             if (Char2ReferenceOpenCustomHashMap.this.containsNullKey)
/* 1017 */               consumer.accept(Char2ReferenceOpenCustomHashMap.this.value[Char2ReferenceOpenCustomHashMap.this.n]); 
/* 1018 */             for (int pos = Char2ReferenceOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1019 */               if (Char2ReferenceOpenCustomHashMap.this.key[pos] != '\000')
/* 1020 */                 consumer.accept(Char2ReferenceOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1096 */     char[] key = this.key;
/* 1097 */     V[] value = this.value;
/* 1098 */     int mask = newN - 1;
/* 1099 */     char[] newKey = new char[newN + 1];
/* 1100 */     V[] newValue = (V[])new Object[newN + 1];
/* 1101 */     int i = this.n;
/* 1102 */     for (int j = realSize(); j-- != 0; ) {
/* 1103 */       while (key[--i] == '\000'); int pos;
/* 1104 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != '\000')
/*      */       {
/* 1106 */         while (newKey[pos = pos + 1 & mask] != '\000'); } 
...
/*      */     try {
/* 1132 */       c = (Char2ReferenceOpenCustomHashMap<V>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ReferenceOpenCustomHashMap.class
