...
/*  62 */     this.array = new char[Math.max(1, capacity)];
...
/*  85 */     char t = this.array[this.start];
...
/* 109 */     char[] newArray = new char[newLength];
...
/*     */   public void trim() {
/* 171 */     int size = size();
/* 172 */     char[] newArray = new char[size + 1];
...
/* 202 */     this.array = new char[this.length = HashCommon.nextPowerOfTwo(this.end + 1)];
/* 203 */     for (int i = 0; i < this.end; i++)
/* 204 */       this.array[i] = s.readChar(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\CharArrayFIFOQueue.class
