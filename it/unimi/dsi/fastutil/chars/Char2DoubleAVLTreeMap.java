...
/*  954 */         return false; 
/*  955 */       Map.Entry<Character, Double> e = (Map.Entry<Character, Double>)o;
/*  956 */       return (this.key == ((Character)e.getKey()).charValue() && 
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Char2DoubleAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1048 */       if ((this.next = Char2DoubleAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Char2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Char2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Char2DoubleMap.Entry>)new AbstractObjectSortedSet<Char2DoubleMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1171 */             if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1172 */               return false; 
/* 1173 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1174 */               return false; 
/* 1175 */             Char2DoubleAVLTreeMap.Entry f = Char2DoubleAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1184 */             if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1185 */               return false; 
/* 1186 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1187 */               return false; 
/* 1188 */             Char2DoubleAVLTreeMap.Entry f = Char2DoubleAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1189 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != 
/* 1190 */               Double.doubleToLongBits(((Double)e.getValue()).doubleValue()))
/* 1191 */               return false; 
/* 1192 */             Char2DoubleAVLTreeMap.this.remove(f.key);
/* 1193 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1197 */             return Char2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1201 */             Char2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2DoubleMap.Entry first() {
/* 1205 */             return Char2DoubleAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2DoubleMap.Entry last() {
/* 1209 */             return Char2DoubleAVLTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry from, Char2DoubleMap.Entry to) {
/* 1214 */             return Char2DoubleAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry to) {
/* 1218 */             return Char2DoubleAVLTreeMap.this.headMap(to.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry from) {
/* 1222 */             return Char2DoubleAVLTreeMap.this.tailMap(from.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1256 */       return new Char2DoubleAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1260 */       return new Char2DoubleAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1315 */             return (DoubleIterator)new Char2DoubleAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(double k) {
/* 1319 */             return Char2DoubleAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1323 */             return Char2DoubleAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1327 */             Char2DoubleAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1338 */     return new Submap(false, true, to, false);
/*      */   }
/*      */   
/*      */   public Char2DoubleSortedMap tailMap(char from) {
/* 1342 */     return new Submap(from, false, false, true);
/*      */   }
/*      */   
...
/* 1390 */       if (!bottom && !top && Char2DoubleAVLTreeMap.this.compare(from, to) > 0)
/* 1391 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1392 */       this.from = from;
/* 1393 */       this.bottom = bottom;
/* 1394 */       this.to = to;
/* 1395 */       this.top = top;
/* 1396 */       this.defRetValue = Char2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1414 */       return ((this.bottom || Char2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2DoubleAVLTreeMap.this
/* 1415 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
/* 1419 */       if (this.entries == null)
/* 1420 */         this.entries = (ObjectSortedSet<Char2DoubleMap.Entry>)new AbstractObjectSortedSet<Char2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator() {
/* 1423 */               return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry from) {
/* 1427 */               return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2DoubleMap.Entry> comparator() {
/* 1431 */               return Char2DoubleAVLTreeMap.this.char2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1440 */                 return false; 
/* 1441 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1442 */                 return false; 
/* 1443 */               Char2DoubleAVLTreeMap.Entry f = Char2DoubleAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1444 */               return (f != null && Char2DoubleAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1453 */                 return false; 
/* 1454 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1455 */                 return false; 
/* 1456 */               Char2DoubleAVLTreeMap.Entry f = Char2DoubleAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1457 */               if (f != null && Char2DoubleAVLTreeMap.Submap.this.in(f.key))
/* 1458 */                 Char2DoubleAVLTreeMap.Submap.this.remove(f.key); 
/* 1459 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1463 */               int c = 0;
/* 1464 */               for (ObjectBidirectionalIterator<Char2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1465 */                 c++; 
/* 1466 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1470 */               return !(new Char2DoubleAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1474 */               Char2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2DoubleMap.Entry first() {
/* 1478 */               return Char2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2DoubleMap.Entry last() {
/* 1482 */               return Char2DoubleAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry from, Char2DoubleMap.Entry to) {
/* 1487 */               return Char2DoubleAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry to) {
/* 1491 */               return Char2DoubleAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry from) {
/* 1495 */               return Char2DoubleAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2DoubleSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1503 */         return new Char2DoubleAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1507 */         return new Char2DoubleAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1522 */               return (DoubleIterator)new Char2DoubleAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(double k) {
/* 1526 */               return Char2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1530 */               return Char2DoubleAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1534 */               Char2DoubleAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1542 */       return (in(k) && Char2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(char k) {
/* 1559 */       char kk = k; Char2DoubleAVLTreeMap.Entry e;
/* 1560 */       return (in(kk) && (e = Char2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public double put(char k, double v) {
/* 1564 */       Char2DoubleAVLTreeMap.this.modified = false;
/* 1565 */       if (!in(k))
...
/* 1568 */       double oldValue = Char2DoubleAVLTreeMap.this.put(k, v);
/* 1569 */       return Char2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double remove(char k) {
/* 1574 */       Char2DoubleAVLTreeMap.this.modified = false;
/* 1575 */       if (!in(k))
/* 1576 */         return this.defRetValue; 
/* 1577 */       double oldValue = Char2DoubleAVLTreeMap.this.remove(k);
/* 1578 */       return Char2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1596 */       return Char2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2DoubleSortedMap headMap(char to) {
/* 1600 */       if (this.top)
/* 1601 */         return new Submap(this.from, this.bottom, to, false); 
/* 1602 */       return (Char2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2DoubleSortedMap tailMap(char from) {
/* 1606 */       if (this.bottom)
/* 1607 */         return new Submap(from, false, this.to, this.top); 
/* 1608 */       return (Char2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2DoubleSortedMap subMap(char from, char to) {
...
/* 1614 */       if (!this.top)
/* 1615 */         to = (Char2DoubleAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1616 */       if (!this.bottom)
/* 1617 */         from = (Char2DoubleAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1629 */       if (Char2DoubleAVLTreeMap.this.tree == null) {
/* 1630 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1634 */       if (this.bottom) {
/* 1635 */         e = Char2DoubleAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1637 */         e = Char2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1639 */         if (Char2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1640 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1644 */       if (e == null || (!this.top && Char2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1645 */         return null; 
/* 1646 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2DoubleAVLTreeMap.Entry e;
/* 1655 */       if (Char2DoubleAVLTreeMap.this.tree == null) {
/* 1656 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1660 */       if (this.top) {
/* 1661 */         e = Char2DoubleAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1663 */         e = Char2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1665 */         if (Char2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1666 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1670 */       if (e == null || (!this.bottom && Char2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1671 */         return null; 
/* 1672 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1676 */       Char2DoubleAVLTreeMap.Entry e = firstEntry();
/* 1677 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1683 */       Char2DoubleAVLTreeMap.Entry e = lastEntry();
/* 1684 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1699 */         this.next = Char2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1702 */         this();
/* 1703 */         if (this.next != null)
/* 1704 */           if (!Char2DoubleAVLTreeMap.Submap.this.bottom && Char2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1705 */             this.prev = null;
/* 1706 */           } else if (!Char2DoubleAVLTreeMap.Submap.this.top && Char2DoubleAVLTreeMap.this.compare(k, (this.prev = Char2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1707 */             this.next = null;
/*      */           } else {
/* 1709 */             this.next = Char2DoubleAVLTreeMap.this.locateKey(k);
/* 1710 */             if (Char2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1721 */         if (!Char2DoubleAVLTreeMap.Submap.this.bottom && this.prev != null && Char2DoubleAVLTreeMap.this.compare(this.prev.key, Char2DoubleAVLTreeMap.Submap.this.from) < 0)
/* 1722 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1726 */         this.next = this.next.next();
/* 1727 */         if (!Char2DoubleAVLTreeMap.Submap.this.top && this.next != null && Char2DoubleAVLTreeMap.this.compare(this.next.key, Char2DoubleAVLTreeMap.Submap.this.to) >= 0)
/* 1728 */           this.next = null; 
/*      */       } }
/*      */     
/*      */     private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Char2DoubleMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1808 */       c = (Char2DoubleAVLTreeMap)super.clone();
...
/* 1889 */     if (n == 1) {
/* 1890 */       Entry entry = new Entry(s.readChar(), s.readDouble());
...
/*      */ 
/*      */       
/* 1900 */       Entry entry = new Entry(s.readChar(), s.readDouble());
/* 1901 */       entry.right(new Entry(s.readChar(), s.readDouble()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleAVLTreeMap.class
