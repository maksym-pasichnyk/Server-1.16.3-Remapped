...
/*  548 */     Byte newValue = remappingFunction.apply(Character.valueOf(k), Byte.valueOf(this.value[pos]));
...
/*  563 */     int pos = find(k);
/*  564 */     Byte newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*  640 */       return Char2ByteOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/*  644 */       return Char2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/*  648 */       byte oldValue = Char2ByteOpenHashMap.this.value[this.index];
/*  649 */       Char2ByteOpenHashMap.this.value[this.index] = v;
/*  650 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  660 */       return Character.valueOf(Char2ByteOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  670 */       return Byte.valueOf(Char2ByteOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */         return false; 
/*  687 */       Map.Entry<Character, Byte> e = (Map.Entry<Character, Byte>)o;
/*  688 */       return (Char2ByteOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  692 */       return Char2ByteOpenHashMap.this.key[this.index] ^ Char2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  696 */       return Char2ByteOpenHashMap.this.key[this.index] + "=>" + Char2ByteOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  706 */     int pos = Char2ByteOpenHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  713 */     int last = -1;
/*      */     
/*  715 */     int c = Char2ByteOpenHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  719 */     boolean mustReturnNullKey = Char2ByteOpenHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  734 */         return this.last = Char2ByteOpenHashMap.this.n;
/*      */       } 
/*  736 */       char[] key = Char2ByteOpenHashMap.this.key;
/*      */       while (true) {
/*  738 */         if (--this.pos < 0) {
/*      */           
/*  740 */           this.last = Integer.MIN_VALUE;
/*  741 */           char k = this.wrapped.getChar(-this.pos - 1);
/*  742 */           int p = HashCommon.mix(k) & Char2ByteOpenHashMap.this.mask;
/*  743 */           while (k != key[p])
/*  744 */             p = p + 1 & Char2ByteOpenHashMap.this.mask; 
/*  745 */           return p;
/*      */         } 
...
/*  762 */       char[] key = Char2ByteOpenHashMap.this.key; while (true) {
/*      */         char curr; int last;
/*  764 */         pos = (last = pos) + 1 & Char2ByteOpenHashMap.this.mask;
/*      */         while (true) {
/*  766 */           if ((curr = key[pos]) == '\000') {
/*  767 */             key[last] = Character.MIN_VALUE;
/*      */             return;
/*      */           } 
/*  770 */           int slot = HashCommon.mix(curr) & Char2ByteOpenHashMap.this.mask;
/*  771 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  773 */           pos = pos + 1 & Char2ByteOpenHashMap.this.mask;
/*      */         } 
/*  775 */         if (pos < last) {
...
/*      */         } 
/*  780 */         key[last] = curr;
/*  781 */         Char2ByteOpenHashMap.this.value[last] = Char2ByteOpenHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  785 */       if (this.last == -1)
/*  786 */         throw new IllegalStateException(); 
/*  787 */       if (this.last == Char2ByteOpenHashMap.this.n) {
/*  788 */         Char2ByteOpenHashMap.this.containsNullKey = false;
/*  789 */       } else if (this.pos >= 0) {
/*  790 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  793 */         Char2ByteOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 1));
/*  794 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  797 */       Char2ByteOpenHashMap.this.size--;
/*  798 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*      */     private MapIterator() {} }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectIterator<Char2ByteMap.Entry> { private Char2ByteOpenHashMap.MapEntry entry;
/*      */     
/*      */     public Char2ByteOpenHashMap.MapEntry next() {
/*  813 */       return this.entry = new Char2ByteOpenHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  822 */       this.entry = new Char2ByteOpenHashMap.MapEntry();
...
/*  832 */       return new Char2ByteOpenHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Char2ByteMap.Entry> fastIterator() {
/*  836 */       return new Char2ByteOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  850 */       if (k == '\000') {
/*  851 */         return (Char2ByteOpenHashMap.this.containsNullKey && Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n] == v);
/*      */       }
/*  853 */       char[] key = Char2ByteOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/*  856 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ByteOpenHashMap.this.mask]) == '\000')
/*  857 */         return false; 
/*  858 */       if (k == curr) {
/*  859 */         return (Char2ByteOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  862 */         if ((curr = key[pos = pos + 1 & Char2ByteOpenHashMap.this.mask]) == '\000')
/*  863 */           return false; 
/*  864 */         if (k == curr) {
/*  865 */           return (Char2ByteOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  880 */       if (k == '\000') {
/*  881 */         if (Char2ByteOpenHashMap.this.containsNullKey && Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n] == v) {
/*  882 */           Char2ByteOpenHashMap.this.removeNullEntry();
/*  883 */           return true;
/*      */         } 
/*  885 */         return false;
/*      */       } 
/*      */       
/*  888 */       char[] key = Char2ByteOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/*  891 */       if ((curr = key[pos = HashCommon.mix(k) & Char2ByteOpenHashMap.this.mask]) == '\000')
/*  892 */         return false; 
/*  893 */       if (curr == k) {
/*  894 */         if (Char2ByteOpenHashMap.this.value[pos] == v) {
/*  895 */           Char2ByteOpenHashMap.this.removeEntry(pos);
/*  896 */           return true;
/*      */         } 
/*  898 */         return false;
/*      */       } 
/*      */       while (true) {
/*  901 */         if ((curr = key[pos = pos + 1 & Char2ByteOpenHashMap.this.mask]) == '\000')
/*  902 */           return false; 
/*  903 */         if (curr == k && 
/*  904 */           Char2ByteOpenHashMap.this.value[pos] == v) {
/*  905 */           Char2ByteOpenHashMap.this.removeEntry(pos);
/*  906 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  913 */       return Char2ByteOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  917 */       Char2ByteOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2ByteMap.Entry> consumer) {
/*  922 */       if (Char2ByteOpenHashMap.this.containsNullKey)
/*  923 */         consumer.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.n], Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n])); 
/*  924 */       for (int pos = Char2ByteOpenHashMap.this.n; pos-- != 0;) {
/*  925 */         if (Char2ByteOpenHashMap.this.key[pos] != '\000')
/*  926 */           consumer.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenHashMap.this.key[pos], Char2ByteOpenHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2ByteMap.Entry> consumer) {
/*  931 */       AbstractChar2ByteMap.BasicEntry entry = new AbstractChar2ByteMap.BasicEntry();
/*  932 */       if (Char2ByteOpenHashMap.this.containsNullKey) {
/*  933 */         entry.key = Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.n];
/*  934 */         entry.value = Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n];
/*  935 */         consumer.accept(entry);
/*      */       } 
/*  937 */       for (int pos = Char2ByteOpenHashMap.this.n; pos-- != 0;) {
/*  938 */         if (Char2ByteOpenHashMap.this.key[pos] != '\000') {
/*  939 */           entry.key = Char2ByteOpenHashMap.this.key[pos];
/*  940 */           entry.value = Char2ByteOpenHashMap.this.value[pos];
...
/*  966 */       return Char2ByteOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractCharSet { private KeySet() {}
/*      */     
/*      */     public CharIterator iterator() {
/*  972 */       return new Char2ByteOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/*  977 */       if (Char2ByteOpenHashMap.this.containsNullKey)
/*  978 */         consumer.accept(Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.n]); 
/*  979 */       for (int pos = Char2ByteOpenHashMap.this.n; pos-- != 0; ) {
/*  980 */         char k = Char2ByteOpenHashMap.this.key[pos];
/*  981 */         if (k != '\000')
...
/*      */     
/*      */     public int size() {
/*  987 */       return Char2ByteOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(char k) {
/*  991 */       return Char2ByteOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(char k) {
/*  995 */       int oldSize = Char2ByteOpenHashMap.this.size;
/*  996 */       Char2ByteOpenHashMap.this.remove(k);
/*  997 */       return (Char2ByteOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1001 */       Char2ByteOpenHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1025 */       return Char2ByteOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1034 */             return new Char2ByteOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1038 */             return Char2ByteOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1042 */             return Char2ByteOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1046 */             Char2ByteOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1051 */             if (Char2ByteOpenHashMap.this.containsNullKey)
/* 1052 */               consumer.accept(Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n]); 
/* 1053 */             for (int pos = Char2ByteOpenHashMap.this.n; pos-- != 0;) {
/* 1054 */               if (Char2ByteOpenHashMap.this.key[pos] != '\000')
/* 1055 */                 consumer.accept(Char2ByteOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1131 */     char[] key = this.key;
/* 1132 */     byte[] value = this.value;
/* 1133 */     int mask = newN - 1;
/* 1134 */     char[] newKey = new char[newN + 1];
/* 1135 */     byte[] newValue = new byte[newN + 1];
/* 1136 */     int i = this.n;
/* 1137 */     for (int j = realSize(); j-- != 0; ) {
/* 1138 */       while (key[--i] == '\000'); int pos;
/* 1139 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != '\000')
...
/*      */     try {
/* 1166 */       c = (Char2ByteOpenHashMap)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ByteOpenHashMap.class
