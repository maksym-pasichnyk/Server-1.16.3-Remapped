...
/*  954 */         return false; 
/*  955 */       Map.Entry<Character, Float> e = (Map.Entry<Character, Float>)o;
...
/* 1043 */     int index = 0;
/*      */     TreeIterator() {
/* 1045 */       this.next = Char2FloatAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1048 */       if ((this.next = Char2FloatAVLTreeMap.this.locateKey(k)) != null)
/* 1049 */         if (Char2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1100 */       updatePrevious();
/* 1101 */       updateNext();
/* 1102 */       Char2FloatAVLTreeMap.this.remove(this.curr.key);
/* 1103 */       this.curr = null;
/*      */     }
...
/* 1150 */       this.entries = (ObjectSortedSet<Char2FloatMap.Entry>)new AbstractObjectSortedSet<Char2FloatMap.Entry>()
/*      */         {
...
/* 1159 */             return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from) {
/* 1163 */             return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1174 */               return false; 
/* 1175 */             Char2FloatAVLTreeMap.Entry f = Char2FloatAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1187 */               return false; 
/* 1188 */             Char2FloatAVLTreeMap.Entry f = Char2FloatAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1189 */             if (f == null || Float.floatToIntBits(f.getFloatValue()) != 
/* 1190 */               Float.floatToIntBits(((Float)e.getValue()).floatValue()))
/* 1191 */               return false; 
/* 1192 */             Char2FloatAVLTreeMap.this.remove(f.key);
/* 1193 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1197 */             return Char2FloatAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1201 */             Char2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2FloatMap.Entry first() {
/* 1205 */             return Char2FloatAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2FloatMap.Entry last() {
/* 1209 */             return Char2FloatAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry to) {
/* 1213 */             return Char2FloatAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry to) {
/* 1217 */             return Char2FloatAVLTreeMap.this.headMap(to.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from) {
/* 1221 */             return Char2FloatAVLTreeMap.this.tailMap(from.getCharKey()).char2FloatEntrySet();
/*      */           }
/*      */         }; 
...
/* 1255 */       return new Char2FloatAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1259 */       return new Char2FloatAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1314 */             return (FloatIterator)new Char2FloatAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(float k) {
/* 1318 */             return Char2FloatAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1322 */             return Char2FloatAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1326 */             Char2FloatAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1337 */     return new Submap(false, true, to, false);
/*      */   }
/*      */   
/*      */   public Char2FloatSortedMap tailMap(char from) {
/* 1341 */     return new Submap(from, false, false, true);
/*      */   }
/*      */   
...
/* 1389 */       if (!bottom && !top && Char2FloatAVLTreeMap.this.compare(from, to) > 0)
/* 1390 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1391 */       this.from = from;
/* 1392 */       this.bottom = bottom;
/* 1393 */       this.to = to;
/* 1394 */       this.top = top;
/* 1395 */       this.defRetValue = Char2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1413 */       return ((this.bottom || Char2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2FloatAVLTreeMap.this
/* 1414 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
/* 1418 */       if (this.entries == null)
/* 1419 */         this.entries = (ObjectSortedSet<Char2FloatMap.Entry>)new AbstractObjectSortedSet<Char2FloatMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator() {
/* 1422 */               return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from) {
/* 1426 */               return (ObjectBidirectionalIterator<Char2FloatMap.Entry>)new Char2FloatAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2FloatMap.Entry> comparator() {
/* 1430 */               return Char2FloatAVLTreeMap.this.char2FloatEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1438 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1439 */                 return false; 
/* 1440 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1441 */                 return false; 
/* 1442 */               Char2FloatAVLTreeMap.Entry f = Char2FloatAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1443 */               return (f != null && Char2FloatAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1451 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1452 */                 return false; 
/* 1453 */               if (e.getValue() == null || !(e.getValue() instanceof Float))
/* 1454 */                 return false; 
/* 1455 */               Char2FloatAVLTreeMap.Entry f = Char2FloatAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1456 */               if (f != null && Char2FloatAVLTreeMap.Submap.this.in(f.key))
/* 1457 */                 Char2FloatAVLTreeMap.Submap.this.remove(f.key); 
/* 1458 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1462 */               int c = 0;
/* 1463 */               for (ObjectBidirectionalIterator<Char2FloatMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1464 */                 c++; 
/* 1465 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1469 */               return !(new Char2FloatAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1473 */               Char2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2FloatMap.Entry first() {
/* 1477 */               return Char2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2FloatMap.Entry last() {
/* 1481 */               return Char2FloatAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry to) {
/* 1486 */               return Char2FloatAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry to) {
/* 1490 */               return Char2FloatAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from) {
/* 1494 */               return Char2FloatAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2FloatEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2FloatSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1502 */         return new Char2FloatAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1506 */         return new Char2FloatAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public FloatIterator iterator() {
/* 1521 */               return (FloatIterator)new Char2FloatAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(float k) {
/* 1525 */               return Char2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1529 */               return Char2FloatAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1533 */               Char2FloatAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1541 */       return (in(k) && Char2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(float v) {
...
/*      */     
/*      */     public float get(char k) {
/* 1558 */       char kk = k; Char2FloatAVLTreeMap.Entry e;
/* 1559 */       return (in(kk) && (e = Char2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public float put(char k, float v) {
/* 1563 */       Char2FloatAVLTreeMap.this.modified = false;
/* 1564 */       if (!in(k))
...
/* 1567 */       float oldValue = Char2FloatAVLTreeMap.this.put(k, v);
/* 1568 */       return Char2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public float remove(char k) {
/* 1573 */       Char2FloatAVLTreeMap.this.modified = false;
/* 1574 */       if (!in(k))
/* 1575 */         return this.defRetValue; 
/* 1576 */       float oldValue = Char2FloatAVLTreeMap.this.remove(k);
/* 1577 */       return Char2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1595 */       return Char2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2FloatSortedMap headMap(char to) {
/* 1599 */       if (this.top)
/* 1600 */         return new Submap(this.from, this.bottom, to, false); 
/* 1601 */       return (Char2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2FloatSortedMap tailMap(char from) {
/* 1605 */       if (this.bottom)
/* 1606 */         return new Submap(from, false, this.to, this.top); 
/* 1607 */       return (Char2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2FloatSortedMap subMap(char from, char to) {
...
/* 1613 */       if (!this.top)
/* 1614 */         to = (Char2FloatAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1615 */       if (!this.bottom)
/* 1616 */         from = (Char2FloatAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1628 */       if (Char2FloatAVLTreeMap.this.tree == null) {
/* 1629 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1633 */       if (this.bottom) {
/* 1634 */         e = Char2FloatAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1636 */         e = Char2FloatAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1638 */         if (Char2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1639 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1643 */       if (e == null || (!this.top && Char2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1644 */         return null; 
/* 1645 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2FloatAVLTreeMap.Entry e;
/* 1654 */       if (Char2FloatAVLTreeMap.this.tree == null) {
/* 1655 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1659 */       if (this.top) {
/* 1660 */         e = Char2FloatAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1662 */         e = Char2FloatAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1664 */         if (Char2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1665 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1669 */       if (e == null || (!this.bottom && Char2FloatAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1670 */         return null; 
/* 1671 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1675 */       Char2FloatAVLTreeMap.Entry e = firstEntry();
/* 1676 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1682 */       Char2FloatAVLTreeMap.Entry e = lastEntry();
/* 1683 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1698 */         this.next = Char2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1701 */         this();
/* 1702 */         if (this.next != null)
/* 1703 */           if (!Char2FloatAVLTreeMap.Submap.this.bottom && Char2FloatAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1704 */             this.prev = null;
/* 1705 */           } else if (!Char2FloatAVLTreeMap.Submap.this.top && Char2FloatAVLTreeMap.this.compare(k, (this.prev = Char2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1706 */             this.next = null;
/*      */           } else {
/* 1708 */             this.next = Char2FloatAVLTreeMap.this.locateKey(k);
/* 1709 */             if (Char2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1720 */         if (!Char2FloatAVLTreeMap.Submap.this.bottom && this.prev != null && Char2FloatAVLTreeMap.this.compare(this.prev.key, Char2FloatAVLTreeMap.Submap.this.from) < 0)
/* 1721 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1725 */         this.next = this.next.next();
/* 1726 */         if (!Char2FloatAVLTreeMap.Submap.this.top && this.next != null && Char2FloatAVLTreeMap.this.compare(this.next.key, Char2FloatAVLTreeMap.Submap.this.to) >= 0)
/* 1727 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1807 */       c = (Char2FloatAVLTreeMap)super.clone();
...
/* 1888 */     if (n == 1) {
/* 1889 */       Entry entry = new Entry(s.readChar(), s.readFloat());
...
/*      */ 
/*      */       
/* 1899 */       Entry entry = new Entry(s.readChar(), s.readFloat());
/* 1900 */       entry.right(new Entry(s.readChar(), s.readFloat()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatAVLTreeMap.class
