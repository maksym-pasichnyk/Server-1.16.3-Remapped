...
/* 1178 */     char[] key = this.key;
/* 1179 */     short[] value = this.value;
/* 1180 */     int mask = newN - 1;
/* 1181 */     char[] newKey = new char[newN + 1];
/* 1182 */     short[] newValue = new short[newN + 1];
/* 1183 */     int i = this.n;
/* 1184 */     for (int j = realSize(); j-- != 0; ) {
/* 1185 */       while (key[--i] == '\000'); int pos;
/* 1186 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != '\000')
/*      */       {
/* 1188 */         while (newKey[pos = pos + 1 & mask] != '\000'); } 
...
/*      */     try {
/* 1214 */       c = (Char2ShortOpenCustomHashMap)super.clone();
...
/* 1222 */     c.key = (char[])this.key.clone();
/* 1223 */     c.value = (short[])this.value.clone();
...
/* 1269 */     char[] key = this.key = new char[this.n + 1];
/* 1270 */     short[] value = this.value = new short[this.n + 1];
/*      */ 
/*      */     
/* 1273 */     for (int i = this.size; i-- != 0; ) {
/* 1274 */       int pos; char k = s.readChar();
/* 1275 */       short v = s.readShort();
/* 1276 */       if (this.strategy.equals(k, false)) {
/* 1277 */         pos = this.n;
/* 1278 */         this.containsNullKey = true;
/*      */       } else {
/* 1280 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1281 */         while (key[pos] != '\000')
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ShortOpenCustomHashMap.class
