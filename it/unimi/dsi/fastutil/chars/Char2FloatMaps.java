...
/*  50 */     return (entries instanceof Char2FloatMap.FastEntrySet) ? (
/*  51 */       (Char2FloatMap.FastEntrySet)entries).fastIterator() : 
/*  52 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  70 */     ObjectSet<Char2FloatMap.Entry> entries = map.char2FloatEntrySet();
/*  71 */     if (entries instanceof Char2FloatMap.FastEntrySet) {
/*  72 */       ((Char2FloatMap.FastEntrySet)entries).fastForEach(consumer);
/*     */     } else {
...
/*  90 */     final ObjectSet<Char2FloatMap.Entry> entries = map.char2FloatEntrySet();
/*  91 */     return (entries instanceof Char2FloatMap.FastEntrySet) ? new ObjectIterable<Char2FloatMap.Entry>() {
/*     */         public ObjectIterator<Char2FloatMap.Entry> iterator() {
/*  93 */           return ((Char2FloatMap.FastEntrySet)entries).fastIterator();
/*     */         }
...
/* 136 */       return (ObjectSet<Char2FloatMap.Entry>)ObjectSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/*     */     
/*     */     public Object clone() {
/* 150 */       return Char2FloatMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 216 */         this.entries = ObjectSets.singleton(new AbstractChar2FloatMap.BasicEntry(this.key, this.value)); 
...
/* 228 */       return (ObjectSet)char2FloatEntrySet();
/*     */     }
/*     */     
/*     */     public CharSet keySet() {
...
/* 300 */     return new Singleton(key.charValue(), value.floatValue());
/*     */   }
/*     */   
...
/* 348 */           this.entries = ObjectSets.synchronize(this.map.char2FloatEntrySet(), this.sync); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, Float>> entrySet() {
/* 361 */       return (ObjectSet)char2FloatEntrySet();
/*     */     }
/*     */     
/*     */     public CharSet keySet() {
...
/* 662 */         this.entries = ObjectSets.unmodifiable(this.map.char2FloatEntrySet()); 
...
/*     */     @Deprecated
/*     */     public ObjectSet<Map.Entry<Character, Float>> entrySet() {
/* 674 */       return (ObjectSet)char2FloatEntrySet();
/*     */     }
/*     */     
/*     */     public CharSet keySet() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatMaps.class
