...
/*  65 */     this(refArray, capacity, (CharComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  88 */     this(refArray, refArray.length, (CharComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 116 */       this.inv[a[i]] = i;
/*     */     } 
/* 118 */     CharIndirectHeaps.makeHeap(refArray, a, this.inv, size, c);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 155 */     this(refArray, a, size, (CharComparator)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 180 */     CharIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, this.size - 1, this.c);
/*     */   }
/*     */   
...
/* 194 */     if (this.size != 0)
/* 195 */       CharIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.c); 
/* 196 */     return result;
/*     */   }
/*     */   
/*     */   public void changed() {
/* 200 */     CharIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.c);
/*     */   }
/*     */   
...
/* 207 */     int newPos = CharIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, pos, this.c);
/* 208 */     CharIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.c);
/*     */   }
/*     */ 
/*     */   
/*     */   public void allChanged() {
/* 213 */     CharIndirectHeaps.makeHeap(this.refArray, this.heap, this.inv, this.size, this.c);
/*     */   }
/*     */   
...
/* 223 */       int newPos = CharIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, result, this.c);
/* 224 */       CharIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.c);
/*     */     } 
/* 226 */     return true;
/*     */   }
/*     */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\CharHeapIndirectPriorityQueue.class
