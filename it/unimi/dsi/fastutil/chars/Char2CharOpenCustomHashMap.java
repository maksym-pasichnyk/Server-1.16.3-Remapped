...
/*      */   
/*      */   public boolean trim() {
/* 1069 */     int l = HashCommon.arraySize(this.size, this.f);
...
/* 1102 */     if (l >= n || this.size > HashCommon.maxFill(l, this.f))
/* 1103 */       return true; 
/*      */     try {
/* 1105 */       rehash(l);
...
/* 1125 */     char[] key = this.key;
/* 1126 */     char[] value = this.value;
/* 1127 */     int mask = newN - 1;
/* 1128 */     char[] newKey = new char[newN + 1];
/* 1129 */     char[] newValue = new char[newN + 1];
/* 1130 */     int i = this.n;
/* 1131 */     for (int j = realSize(); j-- != 0; ) {
/* 1132 */       while (key[--i] == '\000'); int pos;
/* 1133 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != '\000')
/*      */       {
...
/*      */     try {
/* 1161 */       c = (Char2CharOpenCustomHashMap)super.clone();
...
/* 1170 */     c.value = (char[])this.value.clone();
/* 1171 */     c.strategy = this.strategy;
/* 1172 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public int hashCode() {
/* 1185 */     int h = 0;
/* 1186 */     for (int j = realSize(), i = 0, t = 0; j-- != 0; ) {
/* 1187 */       while (this.key[i] == '\000')
/* 1188 */         i++; 
/* 1189 */       t = this.strategy.hashCode(this.key[i]);
/* 1190 */       t ^= this.value[i];
/* 1191 */       h += t;
/* 1192 */       i++;
/*      */     } 
/*      */     
/* 1195 */     if (this.containsNullKey)
/* 1196 */       h += this.value[this.n]; 
/* 1197 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1200 */     char[] key = this.key;
/* 1201 */     char[] value = this.value;
/* 1202 */     MapIterator i = new MapIterator();
/* 1203 */     s.defaultWriteObject();
/* 1204 */     for (int j = this.size; j-- != 0; ) {
/* 1205 */       int e = i.nextEntry();
/* 1206 */       s.writeChar(key[e]);
/* 1207 */       s.writeChar(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1216 */     char[] key = this.key = new char[this.n + 1];
/* 1217 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1220 */     for (int i = this.size; i-- != 0; ) {
/* 1221 */       int pos; char k = s.readChar();
/* 1222 */       char v = s.readChar();
/* 1223 */       if (this.strategy.equals(k, false)) {
/* 1224 */         pos = this.n;
/* 1225 */         this.containsNullKey = true;
/*      */       } else {
/* 1227 */         pos = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
/* 1228 */         while (key[pos] != '\000')
/* 1229 */           pos = pos + 1 & this.mask; 
/*      */       } 
/* 1231 */       key[pos] = k;
/* 1232 */       value[pos] = v;
/*      */     } 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2CharOpenCustomHashMap.class
