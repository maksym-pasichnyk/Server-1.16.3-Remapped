...
/*  954 */         return false; 
/*  955 */       Map.Entry<Character, Byte> e = (Map.Entry<Character, Byte>)o;
/*  956 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Char2ByteAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1047 */       if ((this.next = Char2ByteAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Char2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Char2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Char2ByteMap.Entry>)new AbstractObjectSortedSet<Char2ByteMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Char2ByteAVLTreeMap.Entry f = Char2ByteAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1186 */               return false; 
/* 1187 */             Char2ByteAVLTreeMap.Entry f = Char2ByteAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1188 */             if (f == null || f.getByteValue() != ((Byte)e.getValue()).byteValue())
/* 1189 */               return false; 
/* 1190 */             Char2ByteAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Char2ByteAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Char2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2ByteMap.Entry first() {
/* 1203 */             return Char2ByteAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2ByteMap.Entry last() {
/* 1207 */             return Char2ByteAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to) {
/* 1211 */             return Char2ByteAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to) {
/* 1215 */             return Char2ByteAVLTreeMap.this.headMap(to.getCharKey()).char2ByteEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from) {
/* 1219 */             return Char2ByteAVLTreeMap.this.tailMap(from.getCharKey()).char2ByteEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Char2ByteAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1257 */       return new Char2ByteAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (ByteIterator)new Char2ByteAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(byte k) {
/* 1316 */             return Char2ByteAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Char2ByteAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Char2ByteAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Char2ByteAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Char2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Char2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ByteAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Char2ByteMap.Entry>)new AbstractObjectSortedSet<Char2ByteMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Char2ByteMap.Entry>)new Char2ByteAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2ByteMap.Entry> comparator() {
/* 1428 */               return Char2ByteAVLTreeMap.this.char2ByteEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Char2ByteAVLTreeMap.Entry f = Char2ByteAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1441 */               return (f != null && Char2ByteAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Char2ByteAVLTreeMap.Entry f = Char2ByteAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1454 */               if (f != null && Char2ByteAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Char2ByteAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Char2ByteMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Char2ByteAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Char2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2ByteMap.Entry first() {
/* 1475 */               return Char2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2ByteMap.Entry last() {
/* 1479 */               return Char2ByteAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to) {
/* 1483 */               return Char2ByteAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to) {
/* 1487 */               return Char2ByteAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2ByteEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from) {
/* 1491 */               return Char2ByteAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2ByteEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2ByteSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1499 */         return new Char2ByteAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1503 */         return new Char2ByteAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public ByteIterator iterator() {
/* 1518 */               return (ByteIterator)new Char2ByteAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(byte k) {
/* 1522 */               return Char2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Char2ByteAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Char2ByteAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1538 */       return (in(k) && Char2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(byte v) {
...
/*      */     
/*      */     public byte get(char k) {
/* 1555 */       char kk = k; Char2ByteAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Char2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public byte put(char k, byte v) {
/* 1560 */       Char2ByteAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       byte oldValue = Char2ByteAVLTreeMap.this.put(k, v);
/* 1565 */       return Char2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public byte remove(char k) {
/* 1570 */       Char2ByteAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       byte oldValue = Char2ByteAVLTreeMap.this.remove(k);
/* 1574 */       return Char2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1592 */       return Char2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2ByteSortedMap headMap(char to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Char2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2ByteSortedMap tailMap(char from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Char2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2ByteSortedMap subMap(char from, char to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Char2ByteAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Char2ByteAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Char2ByteAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Char2ByteAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Char2ByteAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Char2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Char2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2ByteAVLTreeMap.Entry e;
/* 1651 */       if (Char2ByteAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Char2ByteAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Char2ByteAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Char2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Char2ByteAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1672 */       Char2ByteAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1679 */       Char2ByteAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Char2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Char2ByteAVLTreeMap.Submap.this.bottom && Char2ByteAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Char2ByteAVLTreeMap.Submap.this.top && Char2ByteAVLTreeMap.this.compare(k, (this.prev = Char2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Char2ByteAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Char2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Char2ByteAVLTreeMap.Submap.this.bottom && this.prev != null && Char2ByteAVLTreeMap.this.compare(this.prev.key, Char2ByteAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Char2ByteAVLTreeMap.Submap.this.top && this.next != null && Char2ByteAVLTreeMap.this.compare(this.next.key, Char2ByteAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1804 */       c = (Char2ByteAVLTreeMap)super.clone();
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readChar(), s.readByte());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readChar(), s.readByte());
/* 1897 */       entry.right(new Entry(s.readChar(), s.readByte()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ByteAVLTreeMap.class
