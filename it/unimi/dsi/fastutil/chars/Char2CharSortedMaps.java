...
/*  61 */     return (entries instanceof Char2CharSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Char2CharSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Char2CharMap.Entry> entries = map.char2CharEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Char2CharSortedMap.FastSortedEntrySet)entries); return (entries instanceof Char2CharSortedMap.FastSortedEntrySet) ? (Char2CharSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Char2CharMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Char2CharMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Character, Character>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Char2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2CharSortedMap headMap(char to) {
/* 132 */       return Char2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2CharSortedMap tailMap(char from) {
/* 137 */       return Char2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Char2CharMap.Entry>)ObjectSortedSets.singleton(new AbstractChar2CharMap.BasicEntry(this.key, this.value), 
/* 237 */             Char2CharSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Char2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Character, Character>> entrySet() {
/* 249 */       return (ObjectSortedSet)char2CharEntrySet();
/*     */     }
/*     */     
/*     */     public CharSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Char2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2CharSortedMap headMap(char to) {
...
/* 268 */         return this; 
/* 269 */       return Char2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2CharSortedMap tailMap(char from) {
...
/* 275 */         return this; 
/* 276 */       return Char2CharSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public char firstCharKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.charValue(), value.charValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Char2CharMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.char2CharEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Char2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Character, Character>> entrySet() {
/* 449 */       return (ObjectSortedSet)char2CharEntrySet();
/*     */     }
/*     */     
/*     */     public CharSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Char2CharMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.char2CharEntrySet()); 
/* 582 */       return (ObjectSortedSet<Char2CharMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2CharSortedMaps.class
