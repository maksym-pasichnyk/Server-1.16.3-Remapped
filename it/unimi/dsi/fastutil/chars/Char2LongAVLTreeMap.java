...
/*  954 */         return false; 
/*  955 */       Map.Entry<Character, Long> e = (Map.Entry<Character, Long>)o;
/*  956 */       return (this.key == ((Character)e.getKey()).charValue() && this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/* 1042 */     int index = 0;
/*      */     TreeIterator() {
/* 1044 */       this.next = Char2LongAVLTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1047 */       if ((this.next = Char2LongAVLTreeMap.this.locateKey(k)) != null)
/* 1048 */         if (Char2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1099 */       updatePrevious();
/* 1100 */       updateNext();
/* 1101 */       Char2LongAVLTreeMap.this.remove(this.curr.key);
/* 1102 */       this.curr = null;
/*      */     }
...
/* 1149 */       this.entries = (ObjectSortedSet<Char2LongMap.Entry>)new AbstractObjectSortedSet<Char2LongMap.Entry>()
/*      */         {
...
/* 1158 */             return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongAVLTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator(Char2LongMap.Entry from) {
/* 1162 */             return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongAVLTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1173 */               return false; 
/* 1174 */             Char2LongAVLTreeMap.Entry f = Char2LongAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1186 */               return false; 
/* 1187 */             Char2LongAVLTreeMap.Entry f = Char2LongAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1188 */             if (f == null || f.getLongValue() != ((Long)e.getValue()).longValue())
/* 1189 */               return false; 
/* 1190 */             Char2LongAVLTreeMap.this.remove(f.key);
/* 1191 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1195 */             return Char2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1199 */             Char2LongAVLTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2LongMap.Entry first() {
/* 1203 */             return Char2LongAVLTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2LongMap.Entry last() {
/* 1207 */             return Char2LongAVLTreeMap.this.lastEntry;
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry from, Char2LongMap.Entry to) {
/* 1211 */             return Char2LongAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry to) {
/* 1215 */             return Char2LongAVLTreeMap.this.headMap(to.getCharKey()).char2LongEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry from) {
/* 1219 */             return Char2LongAVLTreeMap.this.tailMap(from.getCharKey()).char2LongEntrySet();
/*      */           }
/*      */         }; 
...
/* 1253 */       return new Char2LongAVLTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1257 */       return new Char2LongAVLTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1312 */             return (LongIterator)new Char2LongAVLTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(long k) {
/* 1316 */             return Char2LongAVLTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1320 */             return Char2LongAVLTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1324 */             Char2LongAVLTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1387 */       if (!bottom && !top && Char2LongAVLTreeMap.this.compare(from, to) > 0)
/* 1388 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1389 */       this.from = from;
/* 1390 */       this.bottom = bottom;
/* 1391 */       this.to = to;
/* 1392 */       this.top = top;
/* 1393 */       this.defRetValue = Char2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1411 */       return ((this.bottom || Char2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2LongAVLTreeMap.this
/* 1412 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
/* 1416 */       if (this.entries == null)
/* 1417 */         this.entries = (ObjectSortedSet<Char2LongMap.Entry>)new AbstractObjectSortedSet<Char2LongMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator() {
/* 1420 */               return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongAVLTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator(Char2LongMap.Entry from) {
/* 1424 */               return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongAVLTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2LongMap.Entry> comparator() {
/* 1428 */               return Char2LongAVLTreeMap.this.char2LongEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1439 */                 return false; 
/* 1440 */               Char2LongAVLTreeMap.Entry f = Char2LongAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1441 */               return (f != null && Char2LongAVLTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1452 */                 return false; 
/* 1453 */               Char2LongAVLTreeMap.Entry f = Char2LongAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1454 */               if (f != null && Char2LongAVLTreeMap.Submap.this.in(f.key))
/* 1455 */                 Char2LongAVLTreeMap.Submap.this.remove(f.key); 
/* 1456 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1460 */               int c = 0;
/* 1461 */               for (ObjectBidirectionalIterator<Char2LongMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1462 */                 c++; 
/* 1463 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1467 */               return !(new Char2LongAVLTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1471 */               Char2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2LongMap.Entry first() {
/* 1475 */               return Char2LongAVLTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2LongMap.Entry last() {
/* 1479 */               return Char2LongAVLTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry from, Char2LongMap.Entry to) {
/* 1483 */               return Char2LongAVLTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry to) {
/* 1487 */               return Char2LongAVLTreeMap.Submap.this.headMap(to.getCharKey()).char2LongEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry from) {
/* 1491 */               return Char2LongAVLTreeMap.Submap.this.tailMap(from.getCharKey()).char2LongEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2LongSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1499 */         return new Char2LongAVLTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1503 */         return new Char2LongAVLTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/* 1515 */         this.values = (LongCollection)new AbstractLongCollection()
/*      */           {
/*      */             public LongIterator iterator() {
/* 1518 */               return (LongIterator)new Char2LongAVLTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(long k) {
/* 1522 */               return Char2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1526 */               return Char2LongAVLTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1530 */               Char2LongAVLTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1538 */       return (in(k) && Char2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(long v) {
...
/* 1545 */         long ev = (i.nextEntry()).value;
/* 1546 */         if (ev == v)
/* 1547 */           return true; 
/*      */       } 
/* 1549 */       return false;
...
/*      */     
/*      */     public long get(char k) {
/* 1555 */       char kk = k; Char2LongAVLTreeMap.Entry e;
/* 1556 */       return (in(kk) && (e = Char2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public long put(char k, long v) {
/* 1560 */       Char2LongAVLTreeMap.this.modified = false;
/* 1561 */       if (!in(k))
...
/* 1564 */       long oldValue = Char2LongAVLTreeMap.this.put(k, v);
/* 1565 */       return Char2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public long remove(char k) {
/* 1570 */       Char2LongAVLTreeMap.this.modified = false;
/* 1571 */       if (!in(k))
/* 1572 */         return this.defRetValue; 
/* 1573 */       long oldValue = Char2LongAVLTreeMap.this.remove(k);
/* 1574 */       return Char2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1592 */       return Char2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2LongSortedMap headMap(char to) {
/* 1596 */       if (this.top)
/* 1597 */         return new Submap(this.from, this.bottom, to, false); 
/* 1598 */       return (Char2LongAVLTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2LongSortedMap tailMap(char from) {
/* 1602 */       if (this.bottom)
/* 1603 */         return new Submap(from, false, this.to, this.top); 
/* 1604 */       return (Char2LongAVLTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2LongSortedMap subMap(char from, char to) {
...
/* 1610 */       if (!this.top)
/* 1611 */         to = (Char2LongAVLTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1612 */       if (!this.bottom)
/* 1613 */         from = (Char2LongAVLTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1625 */       if (Char2LongAVLTreeMap.this.tree == null) {
/* 1626 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1630 */       if (this.bottom) {
/* 1631 */         e = Char2LongAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1633 */         e = Char2LongAVLTreeMap.this.locateKey(this.from);
/*      */         
/* 1635 */         if (Char2LongAVLTreeMap.this.compare(e.key, this.from) < 0) {
/* 1636 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1640 */       if (e == null || (!this.top && Char2LongAVLTreeMap.this.compare(e.key, this.to) >= 0))
/* 1641 */         return null; 
/* 1642 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2LongAVLTreeMap.Entry e;
/* 1651 */       if (Char2LongAVLTreeMap.this.tree == null) {
/* 1652 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1656 */       if (this.top) {
/* 1657 */         e = Char2LongAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1659 */         e = Char2LongAVLTreeMap.this.locateKey(this.to);
/*      */         
/* 1661 */         if (Char2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1662 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1666 */       if (e == null || (!this.bottom && Char2LongAVLTreeMap.this.compare(e.key, this.from) < 0))
/* 1667 */         return null; 
/* 1668 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1672 */       Char2LongAVLTreeMap.Entry e = firstEntry();
/* 1673 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1679 */       Char2LongAVLTreeMap.Entry e = lastEntry();
/* 1680 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1695 */         this.next = Char2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1698 */         this();
/* 1699 */         if (this.next != null)
/* 1700 */           if (!Char2LongAVLTreeMap.Submap.this.bottom && Char2LongAVLTreeMap.this.compare(k, this.next.key) < 0) {
/* 1701 */             this.prev = null;
/* 1702 */           } else if (!Char2LongAVLTreeMap.Submap.this.top && Char2LongAVLTreeMap.this.compare(k, (this.prev = Char2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1703 */             this.next = null;
/*      */           } else {
/* 1705 */             this.next = Char2LongAVLTreeMap.this.locateKey(k);
/* 1706 */             if (Char2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1717 */         if (!Char2LongAVLTreeMap.Submap.this.bottom && this.prev != null && Char2LongAVLTreeMap.this.compare(this.prev.key, Char2LongAVLTreeMap.Submap.this.from) < 0)
/* 1718 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1722 */         this.next = this.next.next();
/* 1723 */         if (!Char2LongAVLTreeMap.Submap.this.top && this.next != null && Char2LongAVLTreeMap.this.compare(this.next.key, Char2LongAVLTreeMap.Submap.this.to) >= 0)
/* 1724 */           this.next = null; 
/*      */       } }
/*      */     
/*      */     private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Char2LongMap.Entry> {
/*      */       SubmapEntryIterator() {}
/*      */       
...
/*      */     try {
/* 1804 */       c = (Char2LongAVLTreeMap)super.clone();
...
/* 1863 */       s.writeChar(e.key);
/* 1864 */       s.writeLong(e.value);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1885 */     if (n == 1) {
/* 1886 */       Entry entry = new Entry(s.readChar(), s.readLong());
...
/*      */ 
/*      */       
/* 1896 */       Entry entry = new Entry(s.readChar(), s.readLong());
/* 1897 */       entry.right(new Entry(s.readChar(), s.readLong()));
...
/* 1908 */     top.key = s.readChar();
/* 1909 */     top.value = s.readLong();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2LongAVLTreeMap.class
