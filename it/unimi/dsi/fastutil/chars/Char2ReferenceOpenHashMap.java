...
/* 1055 */     char[] key = this.key;
/* 1056 */     V[] value = this.value;
/* 1057 */     int mask = newN - 1;
/* 1058 */     char[] newKey = new char[newN + 1];
/* 1059 */     V[] newValue = (V[])new Object[newN + 1];
/* 1060 */     int i = this.n;
/* 1061 */     for (int j = realSize(); j-- != 0; ) {
/* 1062 */       while (key[--i] == '\000'); int pos;
/* 1063 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != '\000')
/* 1064 */         while (newKey[pos = pos + 1 & mask] != '\000'); 
...
/*      */     try {
/* 1090 */       c = (Char2ReferenceOpenHashMap<V>)super.clone();
...
/* 1098 */     c.key = (char[])this.key.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ReferenceOpenHashMap.class
