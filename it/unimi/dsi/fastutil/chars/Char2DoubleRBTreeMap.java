...
/*  910 */         return false; 
/*  911 */       Map.Entry<Character, Double> e = (Map.Entry<Character, Double>)o;
/*  912 */       return (this.key == ((Character)e.getKey()).charValue() && 
...
/*  999 */     int index = 0;
/*      */     TreeIterator() {
/* 1001 */       this.next = Char2DoubleRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/* 1004 */       if ((this.next = Char2DoubleRBTreeMap.this.locateKey(k)) != null)
/* 1005 */         if (Char2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1056 */       updatePrevious();
/* 1057 */       updateNext();
/* 1058 */       Char2DoubleRBTreeMap.this.remove(this.curr.key);
/* 1059 */       this.curr = null;
/*      */     }
...
/* 1098 */       this.entries = (ObjectSortedSet<Char2DoubleMap.Entry>)new AbstractObjectSortedSet<Char2DoubleMap.Entry>()
/*      */         {
...
/* 1107 */             return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleRBTreeMap.EntryIterator();
/*      */           }
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry from) {
/* 1111 */             return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1119 */             if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1120 */               return false; 
/* 1121 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1122 */               return false; 
/* 1123 */             Char2DoubleRBTreeMap.Entry f = Char2DoubleRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1132 */             if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1133 */               return false; 
/* 1134 */             if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1135 */               return false; 
/* 1136 */             Char2DoubleRBTreeMap.Entry f = Char2DoubleRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1137 */             if (f == null || Double.doubleToLongBits(f.getDoubleValue()) != 
/* 1138 */               Double.doubleToLongBits(((Double)e.getValue()).doubleValue()))
/* 1139 */               return false; 
/* 1140 */             Char2DoubleRBTreeMap.this.remove(f.key);
/* 1141 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1145 */             return Char2DoubleRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1149 */             Char2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2DoubleMap.Entry first() {
/* 1153 */             return Char2DoubleRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2DoubleMap.Entry last() {
/* 1157 */             return Char2DoubleRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry from, Char2DoubleMap.Entry to) {
/* 1162 */             return Char2DoubleRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry to) {
/* 1166 */             return Char2DoubleRBTreeMap.this.headMap(to.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry from) {
/* 1170 */             return Char2DoubleRBTreeMap.this.tailMap(from.getCharKey()).char2DoubleEntrySet();
/*      */           }
/*      */         }; 
...
/* 1204 */       return new Char2DoubleRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1208 */       return new Char2DoubleRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1263 */             return (DoubleIterator)new Char2DoubleRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(double k) {
/* 1267 */             return Char2DoubleRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1271 */             return Char2DoubleRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1275 */             Char2DoubleRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1286 */     return new Submap(false, true, to, false);
/*      */   }
/*      */   
...
/* 1338 */       if (!bottom && !top && Char2DoubleRBTreeMap.this.compare(from, to) > 0)
/* 1339 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1340 */       this.from = from;
/* 1341 */       this.bottom = bottom;
/* 1342 */       this.to = to;
/* 1343 */       this.top = top;
/* 1344 */       this.defRetValue = Char2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1362 */       return ((this.bottom || Char2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2DoubleRBTreeMap.this
/* 1363 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
/* 1367 */       if (this.entries == null)
/* 1368 */         this.entries = (ObjectSortedSet<Char2DoubleMap.Entry>)new AbstractObjectSortedSet<Char2DoubleMap.Entry>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator() {
/* 1371 */               return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry from) {
/* 1375 */               return (ObjectBidirectionalIterator<Char2DoubleMap.Entry>)new Char2DoubleRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2DoubleMap.Entry> comparator() {
/* 1379 */               return Char2DoubleRBTreeMap.this.char2DoubleEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1387 */               if (e.getKey() == null || !(e.getKey() instanceof Character))
/* 1388 */                 return false; 
/* 1389 */               if (e.getValue() == null || !(e.getValue() instanceof Double))
/* 1390 */                 return false; 
/* 1391 */               Char2DoubleRBTreeMap.Entry f = Char2DoubleRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1392 */               return (f != null && Char2DoubleRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1403 */                 return false; 
/* 1404 */               Char2DoubleRBTreeMap.Entry f = Char2DoubleRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1405 */               if (f != null && Char2DoubleRBTreeMap.Submap.this.in(f.key))
/* 1406 */                 Char2DoubleRBTreeMap.Submap.this.remove(f.key); 
/* 1407 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1411 */               int c = 0;
/* 1412 */               for (ObjectBidirectionalIterator<Char2DoubleMap.Entry> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1413 */                 c++; 
/* 1414 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1418 */               return !(new Char2DoubleRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1422 */               Char2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2DoubleMap.Entry first() {
/* 1426 */               return Char2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2DoubleMap.Entry last() {
/* 1430 */               return Char2DoubleRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry from, Char2DoubleMap.Entry to) {
/* 1435 */               return Char2DoubleRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry to) {
/* 1439 */               return Char2DoubleRBTreeMap.Submap.this.headMap(to.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry from) {
/* 1443 */               return Char2DoubleRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2DoubleEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2DoubleSortedMap.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1451 */         return new Char2DoubleRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1455 */         return new Char2DoubleRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public DoubleIterator iterator() {
/* 1470 */               return (DoubleIterator)new Char2DoubleRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(double k) {
/* 1474 */               return Char2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1478 */               return Char2DoubleRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1482 */               Char2DoubleRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1490 */       return (in(k) && Char2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(double v) {
...
/*      */     
/*      */     public double get(char k) {
/* 1507 */       char kk = k; Char2DoubleRBTreeMap.Entry e;
/* 1508 */       return (in(kk) && (e = Char2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public double put(char k, double v) {
/* 1512 */       Char2DoubleRBTreeMap.this.modified = false;
/* 1513 */       if (!in(k))
...
/* 1516 */       double oldValue = Char2DoubleRBTreeMap.this.put(k, v);
/* 1517 */       return Char2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public double remove(char k) {
/* 1522 */       Char2DoubleRBTreeMap.this.modified = false;
/* 1523 */       if (!in(k))
/* 1524 */         return this.defRetValue; 
/* 1525 */       double oldValue = Char2DoubleRBTreeMap.this.remove(k);
/* 1526 */       return Char2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1544 */       return Char2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2DoubleSortedMap headMap(char to) {
/* 1548 */       if (this.top)
/* 1549 */         return new Submap(this.from, this.bottom, to, false); 
/* 1550 */       return (Char2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2DoubleSortedMap tailMap(char from) {
/* 1554 */       if (this.bottom)
/* 1555 */         return new Submap(from, false, this.to, this.top); 
/* 1556 */       return (Char2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2DoubleSortedMap subMap(char from, char to) {
...
/* 1562 */       if (!this.top)
/* 1563 */         to = (Char2DoubleRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1564 */       if (!this.bottom)
/* 1565 */         from = (Char2DoubleRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1577 */       if (Char2DoubleRBTreeMap.this.tree == null) {
/* 1578 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1582 */       if (this.bottom) {
/* 1583 */         e = Char2DoubleRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1585 */         e = Char2DoubleRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1587 */         if (Char2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1588 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1592 */       if (e == null || (!this.top && Char2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1593 */         return null; 
/* 1594 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2DoubleRBTreeMap.Entry e;
/* 1603 */       if (Char2DoubleRBTreeMap.this.tree == null) {
/* 1604 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1608 */       if (this.top) {
/* 1609 */         e = Char2DoubleRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1611 */         e = Char2DoubleRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1613 */         if (Char2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1614 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1618 */       if (e == null || (!this.bottom && Char2DoubleRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1619 */         return null; 
/* 1620 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1624 */       Char2DoubleRBTreeMap.Entry e = firstEntry();
/* 1625 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1631 */       Char2DoubleRBTreeMap.Entry e = lastEntry();
/* 1632 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1647 */         this.next = Char2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1650 */         this();
/* 1651 */         if (this.next != null)
/* 1652 */           if (!Char2DoubleRBTreeMap.Submap.this.bottom && Char2DoubleRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1653 */             this.prev = null;
/* 1654 */           } else if (!Char2DoubleRBTreeMap.Submap.this.top && Char2DoubleRBTreeMap.this.compare(k, (this.prev = Char2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1655 */             this.next = null;
/*      */           } else {
/* 1657 */             this.next = Char2DoubleRBTreeMap.this.locateKey(k);
/* 1658 */             if (Char2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1669 */         if (!Char2DoubleRBTreeMap.Submap.this.bottom && this.prev != null && Char2DoubleRBTreeMap.this.compare(this.prev.key, Char2DoubleRBTreeMap.Submap.this.from) < 0)
/* 1670 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1674 */         this.next = this.next.next();
/* 1675 */         if (!Char2DoubleRBTreeMap.Submap.this.top && this.next != null && Char2DoubleRBTreeMap.this.compare(this.next.key, Char2DoubleRBTreeMap.Submap.this.to) >= 0)
/* 1676 */           this.next = null; 
/*      */       } }
/*      */     
...
/*      */     try {
/* 1756 */       c = (Char2DoubleRBTreeMap)super.clone();
...
/* 1837 */     if (n == 1) {
/* 1838 */       Entry entry = new Entry(s.readChar(), s.readDouble());
...
/*      */ 
/*      */       
/* 1849 */       Entry entry = new Entry(s.readChar(), s.readDouble());
/* 1850 */       entry.black(true);
/* 1851 */       entry.right(new Entry(s.readChar(), s.readDouble()));
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleRBTreeMap.class
