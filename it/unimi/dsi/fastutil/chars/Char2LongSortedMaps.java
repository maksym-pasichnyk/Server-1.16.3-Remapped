...
/*  61 */     return (entries instanceof Char2LongSortedMap.FastSortedEntrySet) ? (
/*  62 */       (Char2LongSortedMap.FastSortedEntrySet)entries).fastIterator() : 
/*  63 */       entries.iterator();
/*     */   }
/*     */ 
/*     */ 
...
/*  79 */     ObjectSortedSet<Char2LongMap.Entry> entries = map.char2LongEntrySet();
/*     */     
/*  81 */     Objects.requireNonNull((Char2LongSortedMap.FastSortedEntrySet)entries); return (entries instanceof Char2LongSortedMap.FastSortedEntrySet) ? (Char2LongSortedMap.FastSortedEntrySet)entries::fastIterator : 
/*  82 */       (ObjectBidirectionalIterable<Char2LongMap.Entry>)entries;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 106 */       return (ObjectSortedSet<Char2LongMap.Entry>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 117 */       return (ObjectSortedSet<Map.Entry<Character, Long>>)ObjectSortedSets.EMPTY_SET;
/*     */     }
/*     */ 
/*     */     
...
/* 127 */       return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2LongSortedMap headMap(char to) {
/* 132 */       return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2LongSortedMap tailMap(char from) {
/* 137 */       return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
...
/* 236 */         this.entries = (ObjectSet<Char2LongMap.Entry>)ObjectSortedSets.singleton(new AbstractChar2LongMap.BasicEntry(this.key, this.value), 
/* 237 */             Char2LongSortedMaps.entryComparator(this.comparator)); 
/* 238 */       return (ObjectSortedSet<Char2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Character, Long>> entrySet() {
/* 249 */       return (ObjectSortedSet)char2LongEntrySet();
/*     */     }
/*     */     
/*     */     public CharSortedSet keySet() {
...
/* 261 */         return this; 
/* 262 */       return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2LongSortedMap headMap(char to) {
...
/* 268 */         return this; 
/* 269 */       return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */ 
/*     */     
/*     */     public Char2LongSortedMap tailMap(char from) {
...
/* 275 */         return this; 
/* 276 */       return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     
/*     */     public char firstCharKey() {
/* 280 */       return this.key;
...
/* 373 */     return new Singleton(key.charValue(), value.longValue(), comparator);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 437 */         this.entries = (ObjectSet<Char2LongMap.Entry>)ObjectSortedSets.synchronize(this.sortedMap.char2LongEntrySet(), this.sync); 
/* 438 */       return (ObjectSortedSet<Char2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     @Deprecated
/*     */     public ObjectSortedSet<Map.Entry<Character, Long>> entrySet() {
/* 449 */       return (ObjectSortedSet)char2LongEntrySet();
/*     */     }
/*     */     
/*     */     public CharSortedSet keySet() {
...
/* 581 */         this.entries = (ObjectSet<Char2LongMap.Entry>)ObjectSortedSets.unmodifiable(this.sortedMap.char2LongEntrySet()); 
/* 582 */       return (ObjectSortedSet<Char2LongMap.Entry>)this.entries;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2LongSortedMaps.class
