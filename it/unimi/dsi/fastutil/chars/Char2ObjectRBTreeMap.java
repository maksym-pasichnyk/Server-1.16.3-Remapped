...
/*  892 */       return (this.key == ((Character)e.getKey()).charValue() && Objects.equals(this.value, e.getValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
...
/*  978 */     int index = 0;
/*      */     TreeIterator() {
/*  980 */       this.next = Char2ObjectRBTreeMap.this.firstEntry;
/*      */     }
/*      */     TreeIterator(char k) {
/*  983 */       if ((this.next = Char2ObjectRBTreeMap.this.locateKey(k)) != null)
/*  984 */         if (Char2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1035 */       updatePrevious();
/* 1036 */       updateNext();
/* 1037 */       Char2ObjectRBTreeMap.this.remove(this.curr.key);
/* 1038 */       this.curr = null;
/*      */     }
...
/* 1077 */       this.entries = (ObjectSortedSet<Char2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>()
/*      */         {
...
/* 1086 */             return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectRBTreeMap.EntryIterator();
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from) {
/* 1091 */             return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectRBTreeMap.EntryIterator(from.getCharKey());
/*      */           }
/*      */ 
/*      */           
...
/* 1100 */               return false; 
/* 1101 */             Char2ObjectRBTreeMap.Entry<V> f = Char2ObjectRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1111 */               return false; 
/* 1112 */             Char2ObjectRBTreeMap.Entry<V> f = Char2ObjectRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1113 */             if (f == null || !Objects.equals(f.getValue(), e.getValue()))
/* 1114 */               return false; 
/* 1115 */             Char2ObjectRBTreeMap.this.remove(f.key);
/* 1116 */             return true;
/*      */           }
/*      */           
/*      */           public int size() {
/* 1120 */             return Char2ObjectRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1124 */             Char2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */           
/*      */           public Char2ObjectMap.Entry<V> first() {
/* 1128 */             return Char2ObjectRBTreeMap.this.firstEntry;
/*      */           }
/*      */           
/*      */           public Char2ObjectMap.Entry<V> last() {
/* 1132 */             return Char2ObjectRBTreeMap.this.lastEntry;
/*      */           }
/*      */ 
/*      */           
/*      */           public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> to) {
/* 1137 */             return Char2ObjectRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> to) {
/* 1141 */             return Char2ObjectRBTreeMap.this.headMap(to.getCharKey()).char2ObjectEntrySet();
/*      */           }
/*      */           
/*      */           public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from) {
/* 1145 */             return Char2ObjectRBTreeMap.this.tailMap(from.getCharKey()).char2ObjectEntrySet();
/*      */           }
/*      */         }; 
...
/* 1179 */       return new Char2ObjectRBTreeMap.KeyIterator();
/*      */     }
/*      */     
/*      */     public CharBidirectionalIterator iterator(char from) {
/* 1183 */       return new Char2ObjectRBTreeMap.KeyIterator(from);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1238 */             return (ObjectIterator<V>)new Char2ObjectRBTreeMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public boolean contains(Object k) {
/* 1242 */             return Char2ObjectRBTreeMap.this.containsValue(k);
/*      */           }
/*      */           
/*      */           public int size() {
/* 1246 */             return Char2ObjectRBTreeMap.this.count;
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1250 */             Char2ObjectRBTreeMap.this.clear();
/*      */           }
/*      */         }; 
...
/* 1313 */       if (!bottom && !top && Char2ObjectRBTreeMap.this.compare(from, to) > 0)
/* 1314 */         throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")"); 
/* 1315 */       this.from = from;
/* 1316 */       this.bottom = bottom;
/* 1317 */       this.to = to;
/* 1318 */       this.top = top;
/* 1319 */       this.defRetValue = Char2ObjectRBTreeMap.this.defRetValue;
/*      */     }
/*      */     
/*      */     public void clear() {
...
/* 1337 */       return ((this.bottom || Char2ObjectRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ObjectRBTreeMap.this
/* 1338 */         .compare(k, this.to) < 0));
/*      */     }
/*      */     
/*      */     public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
/* 1342 */       if (this.entries == null)
/* 1343 */         this.entries = (ObjectSortedSet<Char2ObjectMap.Entry<V>>)new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>()
/*      */           {
/*      */             public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator() {
/* 1346 */               return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectRBTreeMap.Submap.SubmapEntryIterator();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from) {
/* 1351 */               return (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>>)new Char2ObjectRBTreeMap.Submap.SubmapEntryIterator(from.getCharKey());
/*      */             }
/*      */             
/*      */             public Comparator<? super Char2ObjectMap.Entry<V>> comparator() {
/* 1355 */               return Char2ObjectRBTreeMap.this.char2ObjectEntrySet().comparator();
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean contains(Object o) {
...
/* 1364 */                 return false; 
/* 1365 */               Char2ObjectRBTreeMap.Entry<V> f = Char2ObjectRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1366 */               return (f != null && Char2ObjectRBTreeMap.Submap.this.in(f.key) && e.equals(f));
/*      */             }
/*      */ 
/*      */             
/*      */             public boolean remove(Object o) {
...
/* 1375 */                 return false; 
/* 1376 */               Char2ObjectRBTreeMap.Entry<V> f = Char2ObjectRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1377 */               if (f != null && Char2ObjectRBTreeMap.Submap.this.in(f.key))
/* 1378 */                 Char2ObjectRBTreeMap.Submap.this.remove(f.key); 
/* 1379 */               return (f != null);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1383 */               int c = 0;
/* 1384 */               for (ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> objectBidirectionalIterator = iterator(); objectBidirectionalIterator.hasNext(); objectBidirectionalIterator.next())
/* 1385 */                 c++; 
/* 1386 */               return c;
/*      */             }
/*      */             
/*      */             public boolean isEmpty() {
/* 1390 */               return !(new Char2ObjectRBTreeMap.Submap.SubmapIterator()).hasNext();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1394 */               Char2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */             
/*      */             public Char2ObjectMap.Entry<V> first() {
/* 1398 */               return Char2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */             }
/*      */             
/*      */             public Char2ObjectMap.Entry<V> last() {
/* 1402 */               return Char2ObjectRBTreeMap.Submap.this.lastEntry();
/*      */             }
/*      */ 
/*      */             
/*      */             public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> to) {
/* 1407 */               return Char2ObjectRBTreeMap.Submap.this.subMap(from.getCharKey(), to.getCharKey()).char2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> to) {
/* 1411 */               return Char2ObjectRBTreeMap.Submap.this.headMap(to.getCharKey()).char2ObjectEntrySet();
/*      */             }
/*      */             
/*      */             public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from) {
/* 1415 */               return Char2ObjectRBTreeMap.Submap.this.tailMap(from.getCharKey()).char2ObjectEntrySet();
/*      */             }
/*      */           }; 
...
/*      */     private class KeySet extends AbstractChar2ObjectSortedMap<V>.KeySet {
/*      */       public CharBidirectionalIterator iterator() {
/* 1423 */         return new Char2ObjectRBTreeMap.Submap.SubmapKeyIterator();
/*      */       }
/*      */       private KeySet() {}
/*      */       public CharBidirectionalIterator iterator(char from) {
/* 1427 */         return new Char2ObjectRBTreeMap.Submap.SubmapKeyIterator(from);
/*      */       }
/*      */     }
/*      */     
/*      */     public CharSortedSet keySet() {
...
/*      */           {
/*      */             public ObjectIterator<V> iterator() {
/* 1442 */               return (ObjectIterator<V>)new Char2ObjectRBTreeMap.Submap.SubmapValueIterator();
/*      */             }
/*      */             
/*      */             public boolean contains(Object k) {
/* 1446 */               return Char2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */             }
/*      */             
/*      */             public int size() {
/* 1450 */               return Char2ObjectRBTreeMap.Submap.this.size();
/*      */             }
/*      */             
/*      */             public void clear() {
/* 1454 */               Char2ObjectRBTreeMap.Submap.this.clear();
/*      */             }
/*      */           }; 
...
/*      */     
/*      */     public boolean containsKey(char k) {
/* 1462 */       return (in(k) && Char2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     
/*      */     public boolean containsValue(Object v) {
...
/*      */     
/*      */     public V get(char k) {
/* 1479 */       char kk = k; Char2ObjectRBTreeMap.Entry<V> e;
/* 1480 */       return (in(kk) && (e = Char2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     
/*      */     public V put(char k, V v) {
/* 1484 */       Char2ObjectRBTreeMap.this.modified = false;
/* 1485 */       if (!in(k))
...
/* 1488 */       V oldValue = Char2ObjectRBTreeMap.this.put(k, v);
/* 1489 */       return Char2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     
/*      */     public V remove(char k) {
/* 1494 */       Char2ObjectRBTreeMap.this.modified = false;
/* 1495 */       if (!in(k))
/* 1496 */         return this.defRetValue; 
/* 1497 */       V oldValue = Char2ObjectRBTreeMap.this.remove(k);
/* 1498 */       return Char2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     
/*      */     public int size() {
...
/*      */     
/*      */     public CharComparator comparator() {
/* 1516 */       return Char2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */     
/*      */     public Char2ObjectSortedMap<V> headMap(char to) {
/* 1520 */       if (this.top)
/* 1521 */         return new Submap(this.from, this.bottom, to, false); 
/* 1522 */       return (Char2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? new Submap(this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     
/*      */     public Char2ObjectSortedMap<V> tailMap(char from) {
/* 1526 */       if (this.bottom)
/* 1527 */         return new Submap(from, false, this.to, this.top); 
/* 1528 */       return (Char2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? new Submap(from, false, this.to, this.top) : this;
/*      */     }
/*      */     
/*      */     public Char2ObjectSortedMap<V> subMap(char from, char to) {
...
/* 1534 */       if (!this.top)
/* 1535 */         to = (Char2ObjectRBTreeMap.this.compare(to, this.to) < 0) ? to : this.to; 
/* 1536 */       if (!this.bottom)
/* 1537 */         from = (Char2ObjectRBTreeMap.this.compare(from, this.from) > 0) ? from : this.from; 
...
/* 1549 */       if (Char2ObjectRBTreeMap.this.tree == null) {
/* 1550 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1554 */       if (this.bottom) {
/* 1555 */         e = Char2ObjectRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1557 */         e = Char2ObjectRBTreeMap.this.locateKey(this.from);
/*      */         
/* 1559 */         if (Char2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) {
/* 1560 */           e = e.next();
/*      */         }
/*      */       } 
/*      */       
/* 1564 */       if (e == null || (!this.top && Char2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0))
/* 1565 */         return null; 
/* 1566 */       return e;
/*      */     }
/*      */ 
...
/*      */       Char2ObjectRBTreeMap.Entry<V> e;
/* 1575 */       if (Char2ObjectRBTreeMap.this.tree == null) {
/* 1576 */         return null;
/*      */       }
/*      */ 
/*      */       
/* 1580 */       if (this.top) {
/* 1581 */         e = Char2ObjectRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1583 */         e = Char2ObjectRBTreeMap.this.locateKey(this.to);
/*      */         
/* 1585 */         if (Char2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) {
/* 1586 */           e = e.prev();
/*      */         }
/*      */       } 
/*      */       
/* 1590 */       if (e == null || (!this.bottom && Char2ObjectRBTreeMap.this.compare(e.key, this.from) < 0))
/* 1591 */         return null; 
/* 1592 */       return e;
/*      */     }
/*      */     
/*      */     public char firstCharKey() {
/* 1596 */       Char2ObjectRBTreeMap.Entry<V> e = firstEntry();
/* 1597 */       if (e == null)
...
/*      */     
/*      */     public char lastCharKey() {
/* 1603 */       Char2ObjectRBTreeMap.Entry<V> e = lastEntry();
/* 1604 */       if (e == null)
...
/*      */     {
/*      */       SubmapIterator() {
/* 1619 */         this.next = Char2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1622 */         this();
/* 1623 */         if (this.next != null)
/* 1624 */           if (!Char2ObjectRBTreeMap.Submap.this.bottom && Char2ObjectRBTreeMap.this.compare(k, this.next.key) < 0) {
/* 1625 */             this.prev = null;
/* 1626 */           } else if (!Char2ObjectRBTreeMap.Submap.this.top && Char2ObjectRBTreeMap.this.compare(k, (this.prev = Char2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0) {
/* 1627 */             this.next = null;
/*      */           } else {
/* 1629 */             this.next = Char2ObjectRBTreeMap.this.locateKey(k);
/* 1630 */             if (Char2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1641 */         if (!Char2ObjectRBTreeMap.Submap.this.bottom && this.prev != null && Char2ObjectRBTreeMap.this.compare(this.prev.key, Char2ObjectRBTreeMap.Submap.this.from) < 0)
/* 1642 */           this.prev = null; 
/*      */       }
/*      */       
/*      */       void updateNext() {
/* 1646 */         this.next = this.next.next();
/* 1647 */         if (!Char2ObjectRBTreeMap.Submap.this.top && this.next != null && Char2ObjectRBTreeMap.this.compare(this.next.key, Char2ObjectRBTreeMap.Submap.this.to) >= 0)
/* 1648 */           this.next = null; 
/*      */       }
/*      */     }
/*      */     
...
/*      */     try {
/* 1730 */       c = (Char2ObjectRBTreeMap<V>)super.clone();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ObjectRBTreeMap.class
