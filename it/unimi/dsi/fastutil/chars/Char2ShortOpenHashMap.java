...
/* 1132 */     char[] key = this.key;
/* 1133 */     short[] value = this.value;
/* 1134 */     int mask = newN - 1;
/* 1135 */     char[] newKey = new char[newN + 1];
/* 1136 */     short[] newValue = new short[newN + 1];
/* 1137 */     int i = this.n;
/* 1138 */     for (int j = realSize(); j-- != 0; ) {
/* 1139 */       while (key[--i] == '\000'); int pos;
/* 1140 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != '\000')
/* 1141 */         while (newKey[pos = pos + 1 & mask] != '\000'); 
...
/*      */     try {
/* 1167 */       c = (Char2ShortOpenHashMap)super.clone();
...
/* 1175 */     c.key = (char[])this.key.clone();
/* 1176 */     c.value = (short[])this.value.clone();
/* 1177 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1222 */     short[] value = this.value = new short[this.n + 1];
/*      */ 
/*      */     
/* 1225 */     for (int i = this.size; i-- != 0; ) {
/* 1226 */       int pos; char k = s.readChar();
/* 1227 */       short v = s.readShort();
/* 1228 */       if (k == '\000') {
/* 1229 */         pos = this.n;
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ShortOpenHashMap.class
