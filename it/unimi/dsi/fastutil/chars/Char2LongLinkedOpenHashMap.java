...
/*  903 */     Long newValue = remappingFunction.apply(Character.valueOf(k), Long.valueOf(this.value[pos]));
...
/*  918 */     int pos = find(k);
/*  919 */     Long newValue = remappingFunction.apply(Character.valueOf(k), (pos >= 0) ? Long.valueOf(this.value[pos]) : null);
...
/*  996 */       return Char2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public long getLongValue() {
/* 1000 */       return Char2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public long setValue(long v) {
/* 1004 */       long oldValue = Char2LongLinkedOpenHashMap.this.value[this.index];
/* 1005 */       Char2LongLinkedOpenHashMap.this.value[this.index] = v;
...
/* 1016 */       return Character.valueOf(Char2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1026 */       return Long.valueOf(Char2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1042 */         return false; 
/* 1043 */       Map.Entry<Character, Long> e = (Map.Entry<Character, Long>)o;
/* 1044 */       return (Char2LongLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1048 */       return Char2LongLinkedOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Char2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1052 */       return Char2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Char2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1215 */       this.next = Char2LongLinkedOpenHashMap.this.first;
/* 1216 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(char from) {
/* 1219 */       if (from == '\000') {
/* 1220 */         if (Char2LongLinkedOpenHashMap.this.containsNullKey) {
/* 1221 */           this.next = (int)Char2LongLinkedOpenHashMap.this.link[Char2LongLinkedOpenHashMap.this.n];
/* 1222 */           this.prev = Char2LongLinkedOpenHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1225 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1227 */       if (Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.last] == from) {
/* 1228 */         this.prev = Char2LongLinkedOpenHashMap.this.last;
/* 1229 */         this.index = Char2LongLinkedOpenHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1233 */       int pos = HashCommon.mix(from) & Char2LongLinkedOpenHashMap.this.mask;
/*      */       
/* 1235 */       while (Char2LongLinkedOpenHashMap.this.key[pos] != '\000') {
/* 1236 */         if (Char2LongLinkedOpenHashMap.this.key[pos] == from) {
/*      */           
/* 1238 */           this.next = (int)Char2LongLinkedOpenHashMap.this.link[pos];
/* 1239 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1242 */         pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1259 */       if (this.next == -1) {
/* 1260 */         this.index = Char2LongLinkedOpenHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1263 */       int pos = Char2LongLinkedOpenHashMap.this.first;
/* 1264 */       this.index = 1;
/* 1265 */       while (pos != this.prev) {
/* 1266 */         pos = (int)Char2LongLinkedOpenHashMap.this.link[pos];
/* 1267 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1292 */       this.prev = (int)(Char2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1307 */         this.index--;
/* 1308 */         this.prev = (int)(Char2LongLinkedOpenHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1310 */         this.next = (int)Char2LongLinkedOpenHashMap.this.link[this.curr];
/* 1311 */       }  Char2LongLinkedOpenHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1316 */       if (this.prev == -1) {
/* 1317 */         Char2LongLinkedOpenHashMap.this.first = this.next;
/*      */       } else {
/* 1319 */         Char2LongLinkedOpenHashMap.this.link[this.prev] = Char2LongLinkedOpenHashMap.this.link[this.prev] ^ (Char2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1320 */       }  if (this.next == -1) {
/* 1321 */         Char2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       } else {
/* 1323 */         Char2LongLinkedOpenHashMap.this.link[this.next] = Char2LongLinkedOpenHashMap.this.link[this.next] ^ (Char2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1324 */       }  int pos = this.curr;
/* 1325 */       this.curr = -1;
/* 1326 */       if (pos == Char2LongLinkedOpenHashMap.this.n) {
/* 1327 */         Char2LongLinkedOpenHashMap.this.containsNullKey = false;
/*      */       } else {
/*      */         
/* 1330 */         char[] key = Char2LongLinkedOpenHashMap.this.key;
/*      */         while (true) {
/*      */           char curr;
/*      */           int last;
/* 1334 */           pos = (last = pos) + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*      */           while (true) {
/* 1336 */             if ((curr = key[pos]) == '\000') {
/* 1337 */               key[last] = Character.MIN_VALUE;
/*      */               return;
/*      */             } 
/* 1340 */             int slot = HashCommon.mix(curr) & Char2LongLinkedOpenHashMap.this.mask;
/* 1341 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1343 */             pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*      */           } 
/* 1345 */           key[last] = curr;
/* 1346 */           Char2LongLinkedOpenHashMap.this.value[last] = Char2LongLinkedOpenHashMap.this.value[pos];
/* 1347 */           if (this.next == pos)
/* 1348 */             this.next = last; 
/* 1349 */           if (this.prev == pos)
/* 1350 */             this.prev = last; 
/* 1351 */           Char2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     } }
/*      */   
/*      */   private class EntryIterator extends MapIterator implements ObjectListIterator<Char2LongMap.Entry> { private Char2LongLinkedOpenHashMap.MapEntry entry;
/*      */     
...
/* 1383 */       return this.entry = new Char2LongLinkedOpenHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Char2LongLinkedOpenHashMap.MapEntry previous() {
/* 1387 */       return this.entry = new Char2LongLinkedOpenHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1391 */       super.remove();
...
/*      */ 
/*      */   
/* 1396 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Char2LongMap.Entry> { final Char2LongLinkedOpenHashMap.MapEntry entry = new Char2LongLinkedOpenHashMap.MapEntry();
/*      */ 
/*      */     
...
/*      */   
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Char2LongMap.Entry> implements Char2LongSortedMap.FastSortedEntrySet { public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator() {
/* 1416 */       return (ObjectBidirectionalIterator<Char2LongMap.Entry>)new Char2LongLinkedOpenHashMap.EntryIterator();
/*      */     }
/*      */     private MapEntrySet() {}
...
/* 1437 */       if (Char2LongLinkedOpenHashMap.this.size == 0)
/* 1438 */         throw new NoSuchElementException(); 
/* 1439 */       return new Char2LongLinkedOpenHashMap.MapEntry(Char2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Char2LongMap.Entry last() {
/* 1443 */       if (Char2LongLinkedOpenHashMap.this.size == 0)
/* 1444 */         throw new NoSuchElementException(); 
/* 1445 */       return new Char2LongLinkedOpenHashMap.MapEntry(Char2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1459 */       if (k == '\000') {
/* 1460 */         return (Char2LongLinkedOpenHashMap.this.containsNullKey && Char2LongLinkedOpenHashMap.this.value[Char2LongLinkedOpenHashMap.this.n] == v);
/*      */       }
/* 1462 */       char[] key = Char2LongLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1465 */       if ((curr = key[pos = HashCommon.mix(k) & Char2LongLinkedOpenHashMap.this.mask]) == '\000')
/* 1466 */         return false; 
/* 1467 */       if (k == curr) {
/* 1468 */         return (Char2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1471 */         if ((curr = key[pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask]) == '\000')
/* 1472 */           return false; 
/* 1473 */         if (k == curr) {
/* 1474 */           return (Char2LongLinkedOpenHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1489 */       if (k == '\000') {
/* 1490 */         if (Char2LongLinkedOpenHashMap.this.containsNullKey && Char2LongLinkedOpenHashMap.this.value[Char2LongLinkedOpenHashMap.this.n] == v) {
/* 1491 */           Char2LongLinkedOpenHashMap.this.removeNullEntry();
/* 1492 */           return true;
/*      */         } 
/* 1494 */         return false;
/*      */       } 
/*      */       
/* 1497 */       char[] key = Char2LongLinkedOpenHashMap.this.key;
/*      */       char curr;
/*      */       int pos;
/* 1500 */       if ((curr = key[pos = HashCommon.mix(k) & Char2LongLinkedOpenHashMap.this.mask]) == '\000')
/* 1501 */         return false; 
/* 1502 */       if (curr == k) {
/* 1503 */         if (Char2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1504 */           Char2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1505 */           return true;
/*      */         } 
/* 1507 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1510 */         if ((curr = key[pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask]) == '\000')
/* 1511 */           return false; 
/* 1512 */         if (curr == k && 
/* 1513 */           Char2LongLinkedOpenHashMap.this.value[pos] == v) {
/* 1514 */           Char2LongLinkedOpenHashMap.this.removeEntry(pos);
/* 1515 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1522 */       return Char2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1526 */       Char2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1541 */       return new Char2LongLinkedOpenHashMap.EntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1552 */       return new Char2LongLinkedOpenHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1567 */       return new Char2LongLinkedOpenHashMap.FastEntryIterator(from.getCharKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
/* 1572 */       for (int i = Char2LongLinkedOpenHashMap.this.size, next = Char2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1573 */         int curr = next;
/* 1574 */         next = (int)Char2LongLinkedOpenHashMap.this.link[curr];
/* 1575 */         consumer.accept(new AbstractChar2LongMap.BasicEntry(Char2LongLinkedOpenHashMap.this.key[curr], Char2LongLinkedOpenHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Char2LongMap.Entry> consumer) {
/* 1581 */       AbstractChar2LongMap.BasicEntry entry = new AbstractChar2LongMap.BasicEntry();
/* 1582 */       for (int i = Char2LongLinkedOpenHashMap.this.size, next = Char2LongLinkedOpenHashMap.this.first; i-- != 0; ) {
/* 1583 */         int curr = next;
/* 1584 */         next = (int)Char2LongLinkedOpenHashMap.this.link[curr];
/* 1585 */         entry.key = Char2LongLinkedOpenHashMap.this.key[curr];
/* 1586 */         entry.value = Char2LongLinkedOpenHashMap.this.value[curr];
...
/* 1612 */       return Char2LongLinkedOpenHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
...
/* 1619 */       return Char2LongLinkedOpenHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractCharSortedSet { private KeySet() {}
/*      */     
/*      */     public CharListIterator iterator(char from) {
/* 1625 */       return new Char2LongLinkedOpenHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public CharListIterator iterator() {
/* 1629 */       return new Char2LongLinkedOpenHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(IntConsumer consumer) {
/* 1634 */       if (Char2LongLinkedOpenHashMap.this.containsNullKey)
/* 1635 */         consumer.accept(Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.n]); 
/* 1636 */       for (int pos = Char2LongLinkedOpenHashMap.this.n; pos-- != 0; ) {
/* 1637 */         char k = Char2LongLinkedOpenHashMap.this.key[pos];
/* 1638 */         if (k != '\000')
...
/*      */     
/*      */     public int size() {
/* 1644 */       return Char2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(char k) {
/* 1648 */       return Char2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(char k) {
/* 1652 */       int oldSize = Char2LongLinkedOpenHashMap.this.size;
/* 1653 */       Char2LongLinkedOpenHashMap.this.remove(k);
/* 1654 */       return (Char2LongLinkedOpenHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1658 */       Char2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public char firstChar() {
/* 1662 */       if (Char2LongLinkedOpenHashMap.this.size == 0)
/* 1663 */         throw new NoSuchElementException(); 
/* 1664 */       return Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     
/*      */     public char lastChar() {
/* 1668 */       if (Char2LongLinkedOpenHashMap.this.size == 0)
/* 1669 */         throw new NoSuchElementException(); 
/* 1670 */       return Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.last];
/*      */     }
/*      */     
/*      */     public CharComparator comparator() {
/* 1674 */       return null;
...
/* 1707 */       return Char2LongLinkedOpenHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1714 */       return Char2LongLinkedOpenHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1723 */             return (LongIterator)new Char2LongLinkedOpenHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1727 */             return Char2LongLinkedOpenHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(long v) {
/* 1731 */             return Char2LongLinkedOpenHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1735 */             Char2LongLinkedOpenHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(LongConsumer consumer)
/*      */           {
/* 1740 */             if (Char2LongLinkedOpenHashMap.this.containsNullKey)
/* 1741 */               consumer.accept(Char2LongLinkedOpenHashMap.this.value[Char2LongLinkedOpenHashMap.this.n]); 
/* 1742 */             for (int pos = Char2LongLinkedOpenHashMap.this.n; pos-- != 0;) {
/* 1743 */               if (Char2LongLinkedOpenHashMap.this.key[pos] != '\000')
/* 1744 */                 consumer.accept(Char2LongLinkedOpenHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1820 */     char[] key = this.key;
/* 1821 */     long[] value = this.value;
/* 1822 */     int mask = newN - 1;
/* 1823 */     char[] newKey = new char[newN + 1];
...
/* 1830 */       int pos; if (key[i] == '\000') {
/* 1831 */         pos = newN;
/*      */       } else {
/* 1833 */         pos = HashCommon.mix(key[i]) & mask;
/* 1834 */         while (newKey[pos] != '\000')
/* 1835 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1878 */       c = (Char2LongLinkedOpenHashMap)super.clone();
...
/* 1886 */     c.key = (char[])this.key.clone();
...
/* 1933 */     char[] key = this.key = new char[this.n + 1];
...
/* 1941 */       int pos; char k = s.readChar();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2LongLinkedOpenHashMap.class
