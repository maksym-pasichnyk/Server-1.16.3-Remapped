...
/*     */     
/*     */     public Object clone() {
/*  64 */       return Char2IntFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/*  68 */       return 0;
...
/*  81 */       return Char2IntFunctions.EMPTY_FUNCTION;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 161 */     return new Singleton(key.charValue(), value.intValue());
/*     */   }
/*     */   
/*     */   public static class SynchronizedFunction implements Char2IntFunction, Serializable { private static final long serialVersionUID = -7046029254386353129L;
...
/*     */   }
/*     */   
/*     */   public static class UnmodifiableFunction extends AbstractChar2IntFunction implements Serializable { private static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Char2IntFunction function;
/*     */     
...
/* 468 */       Integer v = this.function.apply(Character.valueOf(key));
/* 469 */       if (v == null)
...
/* 512 */     if (f instanceof Char2IntFunction)
/* 513 */       return (Char2IntFunction)f; 
/* 514 */     if (f instanceof IntUnaryOperator) {
/* 515 */       Objects.requireNonNull((IntUnaryOperator)f); return (IntUnaryOperator)f::applyAsInt;
/* 516 */     }  return new PrimitiveFunction(f);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2IntFunctions.class
