...
/* 1823 */     char[] key = this.key;
/* 1824 */     float[] value = this.value;
/* 1825 */     int mask = newN - 1;
/* 1826 */     char[] newKey = new char[newN + 1];
...
/* 1833 */       int pos; if (key[i] == '\000') {
/* 1834 */         pos = newN;
/*      */       } else {
/* 1836 */         pos = HashCommon.mix(key[i]) & mask;
/* 1837 */         while (newKey[pos] != '\000')
/* 1838 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1881 */       c = (Char2FloatLinkedOpenHashMap)super.clone();
...
/* 1889 */     c.key = (char[])this.key.clone();
...
/* 1936 */     char[] key = this.key = new char[this.n + 1];
...
/* 1944 */       int pos; char k = s.readChar();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2FloatLinkedOpenHashMap.class
