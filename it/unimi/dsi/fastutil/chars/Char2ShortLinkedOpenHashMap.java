...
/* 1821 */     char[] key = this.key;
/* 1822 */     short[] value = this.value;
/* 1823 */     int mask = newN - 1;
/* 1824 */     char[] newKey = new char[newN + 1];
/* 1825 */     short[] newValue = new short[newN + 1];
...
/* 1831 */       int pos; if (key[i] == '\000') {
/* 1832 */         pos = newN;
/*      */       } else {
/* 1834 */         pos = HashCommon.mix(key[i]) & mask;
/* 1835 */         while (newKey[pos] != '\000')
/* 1836 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1879 */       c = (Char2ShortLinkedOpenHashMap)super.clone();
...
/* 1887 */     c.key = (char[])this.key.clone();
/* 1888 */     c.value = (short[])this.value.clone();
...
/* 1934 */     char[] key = this.key = new char[this.n + 1];
/* 1935 */     short[] value = this.value = new short[this.n + 1];
...
/* 1942 */       int pos; char k = s.readChar();
/* 1943 */       short v = s.readShort();
/* 1944 */       if (k == '\000') {
/* 1945 */         pos = this.n;
/* 1946 */         this.containsNullKey = true;
/*      */       } else {
/* 1948 */         pos = HashCommon.mix(k) & this.mask;
/* 1949 */         while (key[pos] != '\000')
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\i\\unimi\dsi\fastutil\chars\Char2ShortLinkedOpenHashMap.class
