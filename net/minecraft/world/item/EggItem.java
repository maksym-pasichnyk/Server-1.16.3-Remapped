...
/*    */   public EggItem(Item.Properties debug1) {
/* 14 */     super(debug1);
/*    */   }
/*    */ 
/*    */   
...
/* 20 */     debug1.playSound(null, debug2.getX(), debug2.getY(), debug2.getZ(), SoundEvents.EGG_THROW, SoundSource.PLAYERS, 0.5F, 0.4F / (random.nextFloat() * 0.4F + 0.8F));
/* 21 */     if (!debug1.isClientSide) {
/* 22 */       ThrownEgg debug5 = new ThrownEgg(debug1, (LivingEntity)debug2);
