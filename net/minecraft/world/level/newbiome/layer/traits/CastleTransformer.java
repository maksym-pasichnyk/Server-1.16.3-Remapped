...
/*    */         
/* 14 */         .get(getParentX(debug3 + 1), getParentY(debug4 + 0)), debug2
/* 15 */         .get(getParentX(debug3 + 2), getParentY(debug4 + 1)), debug2
/* 16 */         .get(getParentX(debug3 + 1), getParentY(debug4 + 2)), debug2
/* 17 */         .get(getParentX(debug3 + 0), getParentY(debug4 + 1)), debug2
/* 18 */         .get(getParentX(debug3 + 1), getParentY(debug4 + 1)));
/*    */   }
/*    */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\net\minecraft\world\level\newbiome\layer\traits\CastleTransformer.class
