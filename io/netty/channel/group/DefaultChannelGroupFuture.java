...
/*  50 */         boolean callSetDone, success = future.isSuccess();
/*     */         
/*  52 */         synchronized (DefaultChannelGroupFuture.this) {
/*  53 */           if (success) {
/*  54 */             DefaultChannelGroupFuture.this.successCount++;
/*     */           } else {
/*  56 */             DefaultChannelGroupFuture.this.failureCount++;
/*     */           } 
/*     */           
...
/*  60 */           assert DefaultChannelGroupFuture.this.successCount + DefaultChannelGroupFuture.this.failureCount <= DefaultChannelGroupFuture.this.futures.size();
/*     */         } 
/*     */         
/*  63 */         if (callSetDone) {
/*  64 */           if (DefaultChannelGroupFuture.this.failureCount > 0) {
/*     */             
/*  66 */             List<Map.Entry<Channel, Throwable>> failed = new ArrayList<Map.Entry<Channel, Throwable>>(DefaultChannelGroupFuture.this.failureCount);
/*  67 */             for (ChannelFuture f : DefaultChannelGroupFuture.this.futures.values()) {
/*  68 */               if (!f.isSuccess()) {
/*  69 */                 failed.add(new DefaultChannelGroupFuture.DefaultEntry<Channel, Throwable>(f.channel(), f.cause()));
/*     */               }
/*     */             } 
...
/* 102 */       f.addListener((GenericFutureListener)this.childListener);
/*     */     }
/*     */ 
/*     */     
...
/* 116 */       f.addListener((GenericFutureListener)this.childListener);
/*     */     }
/*     */ 
/*     */     
...
/* 132 */     return this.futures.get(channel);
/*     */   }
/*     */ 
/*     */   
...
/* 158 */     super.addListeners((GenericFutureListener[])listeners);
/* 159 */     return this;
/*     */   }
/*     */ 
/*     */   
...
/* 171 */     super.removeListeners((GenericFutureListener[])listeners);
/* 172 */     return this;
/*     */   }
/*     */ 
/*     */   
...
/* 209 */     super.setFailure((Throwable)cause);
/*     */   }
/*     */ 
/*     */   
