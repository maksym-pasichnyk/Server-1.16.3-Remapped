...
/*     */     try {
/* 194 */       return this.channel.socket.isReusePort();
...
/*     */     try {
/* 209 */       this.channel.socket.setReusePort(reusePort);
/* 210 */       return this;
...
/*     */     try {
/* 222 */       return this.channel.socket.isIpFreeBind();
...
/*     */     try {
/* 234 */       this.channel.socket.setIpFreeBind(freeBind);
/* 235 */       return this;
...
/*     */     try {
/* 247 */       return this.channel.socket.isIpTransparent();
...
/*     */     try {
/* 259 */       this.channel.socket.setIpTransparent(transparent);
/* 260 */       return this;
...
/*     */     try {
/* 271 */       this.channel.socket.setTcpDeferAccept(deferAccept);
/* 272 */       return this;
...
/*     */     try {
/* 283 */       return this.channel.socket.getTcpDeferAccept();
