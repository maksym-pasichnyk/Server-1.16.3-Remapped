...
/*     */     {
/*     */       
/*  96 */       this.queue = (T[])Arrays.<PriorityQueueNode>copyOf((PriorityQueueNode[])this.queue, this.queue.length + ((this.queue.length < 64) ? (this.queue.length + 2) : (this.queue.length >>> 1)));
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 198 */       return (X[])Arrays.<Object, T>copyOf(this.queue, this.size, (Class)a.getClass());
/*     */     }
