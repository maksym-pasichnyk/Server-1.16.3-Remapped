...
/*     */         case START:
/*  63 */           version = in.readUnsignedByte();
...
/*     */         
/*     */         case SUCCESS:
/*  86 */           readableBytes = actualReadableBytes();
/*  87 */           if (readableBytes > 0) {
/*  88 */             out.add(in.readRetainedSlice(readableBytes));
/*     */           }
/*     */           break;
/*     */         
/*     */         case FAILURE:
...
/* 104 */       decoderException = new DecoderException(cause);
/*     */     }
/*     */     
...
/*     */ 
/*     */     
/* 113 */     m.setDecoderResult(DecoderResult.failure((Throwable)decoderException));
/* 114 */     out.add(m);
/*     */     
...
/* 124 */     if (length < 0) {
/* 125 */       throw new DecoderException("field '" + fieldName + "' longer than " + 'ÿ' + " chars");
/*     */     }
/*     */     
