...
/*     */ {
/*  40 */   private static final InternalLogger logger = InternalLoggerFactory.getInstance(SocksPortUnificationServerHandler.class);
/*     */ 
/*     */   
...
/*  77 */         p.addAfter(ctx.name(), null, (ChannelHandler)Socks4ServerEncoder.INSTANCE);
/*  78 */         p.addAfter(ctx.name(), null, (ChannelHandler)new Socks4ServerDecoder());
/*     */         break;
/*     */       case SOCKS5:
/*  81 */         logKnownVersion(ctx, version);
/*  82 */         p.addAfter(ctx.name(), null, (ChannelHandler)this.socks5encoder);
/*  83 */         p.addAfter(ctx.name(), null, (ChannelHandler)new Socks5InitialRequestDecoder());
/*     */         break;
/*     */       default:
...
/*     */     } 
/*     */     
/*  92 */     p.remove((ChannelHandler)this);
/*     */   }
/*     */   
