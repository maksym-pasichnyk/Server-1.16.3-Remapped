...
/*  92 */       throw new ClassCastException("Cannot compare " + getHttpDataType() + " with " + o
/*  93 */           .getHttpDataType());
/*     */     }
...
/* 116 */     return (ByteBuf)Unpooled.compositeBuffer().addComponents(this.value).writerIndex(size()).readerIndex(0);
/*     */   }
/*     */ 
/*     */   
