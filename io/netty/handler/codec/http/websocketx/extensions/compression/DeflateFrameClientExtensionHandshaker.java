...
/*  61 */     return new WebSocketExtensionData(this.useWebkitExtensionName ? "x-webkit-deflate-frame" : "deflate-frame", 
/*     */         
...
/*  68 */     if (!"x-webkit-deflate-frame".equals(extensionData.name()) && 
/*  69 */       !"deflate-frame".equals(extensionData.name())) {
/*  70 */       return null;
/*     */     }
/*     */     
