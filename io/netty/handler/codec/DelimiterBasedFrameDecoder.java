...
/* 116 */     this(maxFrameLength, stripDelimiter, failFast, new ByteBuf[] { delimiter
/* 117 */           .slice(delimiter.readerIndex(), delimiter.readableBytes()) });
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 200 */       b = delimiters[0];
/*     */     } 
/* 202 */     return (a.capacity() == 2 && b.capacity() == 1 && a
/* 203 */       .getByte(0) == 13 && a.getByte(1) == 10 && b
/* 204 */       .getByte(0) == 10);
/*     */   }
/*     */ 
/*     */ 
...
/* 271 */         frame = buffer.readRetainedSlice(minFrameLength);
/* 272 */         buffer.skipBytes(minDelimLength);
/*     */       } else {
/* 274 */         frame = buffer.readRetainedSlice(minFrameLength + minDelimLength);
/*     */       } 
/*     */       
/* 277 */       return frame;
/*     */     } 
...
/*     */       int needleIndex;
/* 319 */       for (needleIndex = 0; needleIndex < needle.capacity() && 
/* 320 */         haystack.getByte(haystackIndex) == needle.getByte(needleIndex); needleIndex++) {
/*     */ 
/*     */         
/* 323 */         haystackIndex++;
/* 324 */         if (haystackIndex == haystack.writerIndex() && needleIndex != needle
/* 325 */           .capacity() - 1) {
/* 326 */           return -1;
/*     */         }
/*     */       } 
