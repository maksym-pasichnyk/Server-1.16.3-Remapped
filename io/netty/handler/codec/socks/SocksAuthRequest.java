...
/* 44 */       throw new IllegalArgumentException("username: " + username + " or password: **** values should be in pure ascii");
/*    */     }
/*    */     
...
/* 79 */     byteBuf.writeCharSequence(this.username, CharsetUtil.US_ASCII);
/* 80 */     byteBuf.writeByte(this.password.length());
/* 81 */     byteBuf.writeCharSequence(this.password, CharsetUtil.US_ASCII);
/*    */   }
/*    */ }
