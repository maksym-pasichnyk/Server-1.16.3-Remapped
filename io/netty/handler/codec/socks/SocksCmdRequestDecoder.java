...
/* 50 */         this.cmdType = SocksCmdType.valueOf(byteBuf.readByte());
...
/* 60 */             out.add(new SocksCmdRequest(this.cmdType, this.addressType, host, port));
/*    */             break;
/*    */           
/*    */           case READ_CMD_HEADER:
...
/* 67 */             out.add(new SocksCmdRequest(this.cmdType, this.addressType, str1, i));
/*    */             break;
/*    */           
/*    */           case READ_CMD_ADDRESS:
...
/* 75 */             out.add(new SocksCmdRequest(this.cmdType, this.addressType, str1, i));
/*    */             break;
/*    */           
/*    */           case null:
/* 79 */             out.add(SocksCommonUtils.UNKNOWN_SOCKS_REQUEST);
/*    */             break;
/*    */         } 
/*    */         
/* 83 */         throw new Error();
