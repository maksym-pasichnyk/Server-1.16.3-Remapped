...
/*  55 */   private final int[] mtfSymbolFrequencies = new int[258];
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  84 */     byte[] huffmanSymbolMap = new byte[256];
...
/*  97 */     int totalRunAs = 0;
/*  98 */     int totalRunBs = 0;
/*  99 */     for (int j = 0; j < bwtLength; j++) {
/*     */       
/* 101 */       int mtfPosition = symbolMTF.valueToFront(huffmanSymbolMap[bwtBlock[j] & 0xFF]);
/*     */       
...
/* 110 */               mtfBlock[mtfIndex++] = Character.MIN_VALUE;
/* 111 */               totalRunAs++;
/*     */             } else {
...
/* 125 */         mtfSymbolFrequencies[mtfPosition + 1] = mtfSymbolFrequencies[mtfPosition + 1] + 1;
/*     */       } 
/*     */     } 
/*     */     
...
/* 133 */           mtfBlock[mtfIndex++] = Character.MIN_VALUE;
/* 134 */           totalRunAs++;
/*     */         } else {
...
/* 148 */     mtfSymbolFrequencies[endOfBlockSymbol] = mtfSymbolFrequencies[endOfBlockSymbol] + 1;
/* 149 */     mtfSymbolFrequencies[0] = mtfSymbolFrequencies[0] + totalRunAs;
/* 150 */     mtfSymbolFrequencies[1] = mtfSymbolFrequencies[1] + totalRunBs;
/*     */     
