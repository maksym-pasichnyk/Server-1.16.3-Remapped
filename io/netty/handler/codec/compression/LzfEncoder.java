...
/* 101 */       throw new IllegalArgumentException("totalLength: " + totalLength + " (expected: " + '\020' + '-' + Character.MAX_VALUE + ')');
/*     */     }
/*     */ 
/*     */     
/* 105 */     this
/*     */       
/* 107 */       .encoder = safeInstance ? ChunkEncoderFactory.safeNonAllocatingInstance(totalLength) : ChunkEncoderFactory.optimalNonAllocatingInstance(totalLength);
/*     */     
...
/*     */     byte[] input;
/* 114 */     int inputPtr, length = in.readableBytes();
