...
/*     */ 
/*     */     
/* 142 */     int resultCode = this.z.init(compressionLevel, windowBits, memLevel, 
/*     */         
...
/* 345 */     f.addListener((GenericFutureListener)new ChannelFutureListener()
/*     */         {
...
/* 366 */       return (ChannelFuture)promise;
/*     */     } 
...
/* 386 */         promise.setFailure((Throwable)ZlibUtil.deflaterException(this.z, "compression failure", resultCode));
/* 387 */         return (ChannelFuture)promise;
/* 388 */       }  if (this.z.next_out_index != 0) {
