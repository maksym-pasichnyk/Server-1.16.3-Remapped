...
/* 108 */     this.codeSymbols = new int[totalTables][258];
/* 109 */     this.tableCodeLengths = new byte[totalTables][258];
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 136 */       for (i = 0; i < alphabetSize; i++)
/* 137 */         tableBases[codeLengths[i] + 1] = tableBases[codeLengths[i] + 1] + 1; 
/*     */       int b;
/* 139 */       for (i = 1, b = tableBases[0]; i < 25; i++) {
/* 140 */         b += tableBases[i];
/* 141 */         tableBases[i] = b;
/*     */       } 
/*     */       
/*     */       int code;
/*     */       
/* 146 */       for (i = minimumLength, code = 0; i <= maximumLength; i++) {
/* 147 */         int base = code;
