...
/*  90 */       throw new IllegalArgumentException(String.format("level: %d (expected: %d or %d or %d)", new Object[] {
/*  91 */               Integer.valueOf(level), Integer.valueOf(0), Integer.valueOf(1), Integer.valueOf(2)
/*     */             })); 
/*  93 */     this.level = level;
...
/*  99 */     Checksum checksum = this.checksum; while (true) {
/*     */       byte blockType;
/*     */       int chunkLength;
