...
/* 244 */     return (buf.getByte(offset) & 0xFF) << 8 | buf
/* 245 */       .getByte(offset + 1) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 252 */     return (buf.getByte(offset) & 0xFF) << 16 | (buf
/* 253 */       .getByte(offset + 1) & 0xFF) << 8 | buf
/* 254 */       .getByte(offset + 2) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 261 */     return (buf.getByte(offset) & Byte.MAX_VALUE) << 24 | (buf
/* 262 */       .getByte(offset + 1) & 0xFF) << 16 | (buf
/* 263 */       .getByte(offset + 2) & 0xFF) << 8 | buf
/* 264 */       .getByte(offset + 3) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 271 */     return (buf.getByte(offset) & 0xFF) << 24 | (buf
/* 272 */       .getByte(offset + 1) & 0xFF) << 16 | (buf
/* 273 */       .getByte(offset + 2) & 0xFF) << 8 | buf
/* 274 */       .getByte(offset + 3) & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
