...
/*  42 */     this(proxyAddress, (String)null);
/*     */   }
/*     */   
...
/*  73 */     p.addBefore(name, null, (ChannelHandler)decoder);
/*     */     
/*  75 */     this.decoderName = p.context((ChannelHandler)decoder).name();
/*  76 */     this.encoderName = this.decoderName + ".encoder";
/*     */     
/*  78 */     p.addBefore(name, this.encoderName, (ChannelHandler)Socks4ClientEncoder.INSTANCE);
/*     */   }
/*     */ 
/*     */   
...
/*     */     } 
/* 102 */     return new DefaultSocks4CommandRequest(Socks4CommandType.CONNECT, rhost, raddr
/* 103 */         .getPort(), (this.username != null) ? this.username : "");
/*     */   }
/*     */ 
/*     */   
