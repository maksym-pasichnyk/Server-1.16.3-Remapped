...
/*  82 */     return (T)this.destinationAddress;
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 101 */     StringBuilder buf = (new StringBuilder(128)).append(StringUtil.simpleClassName(this)).append('(').append(this.protocol).append(", ").append(this.authScheme).append(", ").append(this.proxyAddress).append(" => ").append(this.destinationAddress).append(')');
/*     */     
