...
/*     */                 public Unsafe run() throws Exception { Class<Unsafe> k = Unsafe.class; for (Field f : k.getDeclaredFields()) { f.setAccessible(true); Object x = f.get(null); if (k.isInstance(x))
...
/* 212 */         return Longs.fromBytes(source[offset + 7], source[offset + 6], source[offset + 5], source[offset + 4], source[offset + 3], source[offset + 2], source[offset + 1], source[offset]);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/* 225 */         long mask = 255L;
/* 226 */         for (int i = 0; i < 8; mask <<= 8L, i++) {
/* 227 */           sink[offset + i] = (byte)(int)((value & mask) >> i * 8);
/*     */         }
/*     */       }
/*     */     };
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\common\hash\LittleEndianByteArray.class
