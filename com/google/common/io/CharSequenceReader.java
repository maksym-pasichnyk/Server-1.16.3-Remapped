...
/*  97 */     Preconditions.checkArgument((n >= 0L), "n (%s) may not be negative", n);
/*  98 */     checkOpen();
...
/* 117 */     Preconditions.checkArgument((readAheadLimit >= 0), "readAheadLimit (%s) may not be negative", readAheadLimit);
/* 118 */     checkOpen();
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\common\io\CharSequenceReader.class
