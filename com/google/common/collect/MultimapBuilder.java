...
/*  99 */           return Maps.newHashMapWithExpectedSize(expectedKeys);
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/*     */       {
/*     */         <K, V> Map<K, Collection<V>> createMap() {
/* 130 */           return Maps.newLinkedHashMapWithExpectedSize(expectedKeys);
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/*     */         <K extends K0, V> Map<K, Collection<V>> createMap()
/*     */         {
/* 185 */           return (Map)new EnumMap<>(keyClass);
/*     */         }
/*     */       };
/*     */   }
/*     */   
...
/* 319 */                 .createMap(), (Supplier)MultimapBuilder.LinkedListSupplier.instance());
/*     */           }
/*     */         };
/*     */     }
/*     */ 
...
/* 339 */       return new MultimapBuilder.SetMultimapBuilder<K0, Object>()
/*     */         {
...
/* 364 */       return new MultimapBuilder.SetMultimapBuilder<K0, Object>()
/*     */         {
/*     */           public <K extends K0, V> SetMultimap<K, V> build() {
...
/* 390 */       return new MultimapBuilder.SortedSetMultimapBuilder<K0, V0>()
/*     */         {
...
/* 405 */       return new MultimapBuilder.SetMultimapBuilder<K0, V0>()
/*     */         {
/*     */ 
/*     */           
/*     */           public <K extends K0, V extends V0> SetMultimap<K, V> build()
/*     */           {
/* 411 */             Supplier<Set<V>> factory = (Supplier)new MultimapBuilder.EnumSetSupplier<>(valueClass);
...
/* 446 */       return (ListMultimap<K, V>)super.<K, V>build(multimap);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 478 */       return (SortedSetMultimap<K, V>)super.<K, V>build(multimap);
/*     */     }
/*     */     
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\common\collect\MultimapBuilder.class
