...
/* 395 */               .removeEntriesIf(new Predicate<Map.Entry<K, Collection<V>>>()
/*     */                 {
/*     */                   public boolean apply(Map.Entry<K, Collection<V>> entry)
/*     */                   {
/* 399 */                     return predicate.apply(
/* 400 */                         Multisets.immutableEntry(entry.getKey(), ((Collection)entry.getValue()).size()));
/*     */                   }
/*     */                 });
/*     */           }
/*     */ 
/*     */           
/*     */           public boolean removeAll(Collection<?> c) {
/* 407 */             return removeEntriesIf(Predicates.in(c));
/*     */           }
/*     */ 
/*     */           
/*     */           public boolean retainAll(Collection<?> c) {
/* 412 */             return removeEntriesIf(Predicates.not(Predicates.in(c)));
/*     */           }
/*     */         };
/*     */     }
/*     */   }
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\common\collect\FilteredEntryMultimap.class
