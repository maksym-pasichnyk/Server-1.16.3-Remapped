...
/*  546 */     long result = a + b;
/*  547 */     MathPreconditions.checkNoOverflow((((a ^ b) < 0L)) | (((a ^ result) >= 0L)));
/*  548 */     return result;
/*      */   }
/*      */ 
/*      */ 
...
/*  558 */     long result = a - b;
/*  559 */     MathPreconditions.checkNoOverflow((((a ^ b) >= 0L)) | (((a ^ result) >= 0L)));
/*  560 */     return result;
/*      */   }
/*      */ 
/*      */ 
...
/*  590 */     MathPreconditions.checkNoOverflow(((a >= 0L)) | ((b != Long.MIN_VALUE)));
/*  591 */     long result = a * b;
...
/*      */ 
/*      */   
/*  886 */   static final int[] biggestBinomials = new int[] { Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, 206, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66 };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */   
/*      */   @VisibleForTesting
/*  928 */   static final int[] biggestSimpleBinomials = new int[] { Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, 169, 139, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61 };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 1113 */         long aHi = a >>> 32L;
/* 1114 */         long bHi = b >>> 32L;
/* 1115 */         long aLo = a & 0xFFFFFFFFL;
/* 1116 */         long bLo = b & 0xFFFFFFFFL;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */         
/* 1126 */         long result = times2ToThe32Mod(aHi * bHi, m);
/* 1127 */         result += aHi * bLo;
/* 1128 */         if (result < 0L) {
...
/*      */         
/* 1132 */         result += aLo * bHi;
/* 1133 */         result = times2ToThe32Mod(result, m);
/* 1134 */         return plusMod(result, 
/*      */             
/* 1136 */             UnsignedLongs.remainder(aLo * bLo, m), m);
/*      */       }
/*      */ 
/*      */ 
/*      */       
...
/*      */ 
/*      */         
/* 1152 */         long result = times2ToThe32Mod(aHi * aHi, m);
/* 1153 */         long hiLo = aHi * aLo * 2L;
/* 1154 */         if (hiLo < 0L) {
...
/* 1160 */         return plusMod(result, 
/*      */             
/* 1162 */             UnsignedLongs.remainder(aLo * aLo, m), m);
/*      */       }
/*      */     };
/*      */ 
/*      */ 
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\common\math\LongMath.class
