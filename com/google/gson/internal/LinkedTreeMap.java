...
/*     */       
/*     */       while (true) {
/* 136 */         comparison = (comparableKey != null) ? comparableKey.compareTo(nearest.key) : comparator.compare(key, nearest.key);
/*     */ 
/*     */         
/* 139 */         if (comparison == 0) {
/* 140 */           return nearest;
...
/* 484 */         return (((this.key == null) ? (other.getKey() == null) : this.key.equals(other.getKey())) && ((this.value == null) ? (other
/* 485 */           .getValue() == null) : this.value.equals(other.getValue())));
/*     */       } 
/* 487 */       return false;
/*     */     }
/*     */     
...
/* 539 */       LinkedTreeMap.Node<K, V> e = this.next;
/* 540 */       if (e == LinkedTreeMap.this.header) {
...
/*     */       }
/* 546 */       this.next = e.next;
/* 547 */       return this.lastReturned = e;
/*     */     }
/*     */     
...
/* 574 */       return (o instanceof Map.Entry && LinkedTreeMap.this.findByEntry((Map.Entry<?, ?>)o) != null);
/*     */     }
/*     */     
...
/*     */       }
/*     */       
/* 582 */       LinkedTreeMap.Node<K, V> node = LinkedTreeMap.this.findByEntry((Map.Entry<?, ?>)o);
/* 583 */       if (node == null) {
/* 584 */         return false;
/*     */       }
...
/*     */     
/*     */     public boolean contains(Object o) {
/* 609 */       return LinkedTreeMap.this.containsKey(o);
/*     */     }
/*     */     
/*     */     public boolean remove(Object key) {
/* 613 */       return (LinkedTreeMap.this.removeInternalByKey(key) != null);
/*     */     }
/*     */     
/*     */     public void clear() {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\gson\internal\LinkedTreeMap.class
