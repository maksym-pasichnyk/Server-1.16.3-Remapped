...
/*     */     }
/*     */     
/* 154 */     if (this.version != -1.0D && 
/* 155 */       !isValidVersion(field.<Since>getAnnotation(Since.class), field.<Until>getAnnotation(Until.class))) {
/* 156 */       return true;
/*     */     }
/*     */     
...
/* 192 */     if (this.version != -1.0D && 
/* 193 */       !isValidVersion(clazz.<Since>getAnnotation(Since.class), clazz.<Until>getAnnotation(Until.class))) {
/* 194 */       return true;
/*     */     }
/*     */     
...
/* 216 */     return (!Enum.class.isAssignableFrom(clazz) && (clazz
/* 217 */       .isAnonymousClass() || clazz.isLocalClass()));
/*     */   }
/*     */   
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\gson\internal\Excluder.class
