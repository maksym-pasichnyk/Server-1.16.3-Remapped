...
/*     */       
/*     */       while (true) {
/* 149 */         comparison = (comparableKey != null) ? comparableKey.compareTo(nearest.key) : comparator.compare(key, nearest.key);
/*     */ 
/*     */         
/* 152 */         if (comparison == 0) {
/* 153 */           return nearest;
...
/* 515 */         return (((this.key == null) ? (other.getKey() == null) : this.key.equals(other.getKey())) && ((this.value == null) ? (other
/* 516 */           .getValue() == null) : this.value.equals(other.getValue())));
/*     */       } 
/* 518 */       return false;
/*     */     }
/*     */     
...
/* 773 */       LinkedHashTreeMap.Node<K, V> e = this.next;
/* 774 */       if (e == LinkedHashTreeMap.this.header) {
...
/*     */       }
/* 780 */       this.next = e.next;
/* 781 */       return this.lastReturned = e;
/*     */     }
/*     */     
...
/* 808 */       return (o instanceof Map.Entry && LinkedHashTreeMap.this.findByEntry((Map.Entry<?, ?>)o) != null);
/*     */     }
/*     */     
...
/*     */       }
/*     */       
/* 816 */       LinkedHashTreeMap.Node<K, V> node = LinkedHashTreeMap.this.findByEntry((Map.Entry<?, ?>)o);
/* 817 */       if (node == null) {
/* 818 */         return false;
/*     */       }
...
/*     */     
/*     */     public boolean contains(Object o) {
/* 843 */       return LinkedHashTreeMap.this.containsKey(o);
/*     */     }
/*     */     
/*     */     public boolean remove(Object key) {
/* 847 */       return (LinkedHashTreeMap.this.removeInternalByKey(key) != null);
/*     */     }
/*     */     
/*     */     public void clear() {
...
/* 862 */     return new LinkedHashMap<K, V>(this);
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\gson\internal\LinkedHashTreeMap.class
