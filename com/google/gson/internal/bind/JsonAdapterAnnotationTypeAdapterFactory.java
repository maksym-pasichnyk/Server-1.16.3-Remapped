...
/* 63 */       JsonSerializer<?> serializer = (instance instanceof JsonSerializer) ? (JsonSerializer)instance : null;
/*    */ 
/*    */       
/* 66 */       JsonDeserializer<?> deserializer = (instance instanceof JsonDeserializer) ? (JsonDeserializer)instance : null;
/*    */ 
/*    */       
/* 69 */       typeAdapter = new TreeTypeAdapter(serializer, deserializer, gson, type, null);
/*    */     } else {
/* 71 */       throw new IllegalArgumentException("@JsonAdapter value must be TypeAdapter, TypeAdapterFactory, JsonSerializer or JsonDeserializer reference.");
/*    */     } 
/*    */ 
/*    */ 
/*    */     
/* 76 */     if (typeAdapter != null && annotation.nullSafe()) {
/* 77 */       typeAdapter = typeAdapter.nullSafe();
/*    */     }
/*    */     
/* 80 */     return typeAdapter;
/*    */   }
/*    */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\gson\internal\bind\JsonAdapterAnnotationTypeAdapterFactory.class
