...
/* 137 */       return (this.rawType.isAssignableFrom(.Gson.Types.getRawType(from)) && 
/* 138 */         isAssignableFrom(from, (GenericArrayType)this.type));
/*     */     }
...
/* 273 */     return (to.equals(from) || (from instanceof TypeVariable && to
/*     */       
/* 275 */       .equals(typeMap.get(((TypeVariable)from).getName()))));
/*     */   }
/*     */ 
/*     */   
...
/* 285 */       .Gson.Types.equals(this.type, ((TypeToken)o).type));
/*     */   }
/*     */   
...
/* 311 */     return new TypeToken(.Gson.Types.newParameterizedTypeWithOwner(null, rawType, typeArguments));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 318 */     return new TypeToken(.Gson.Types.arrayOf(componentType));
/*     */   }
/*     */ }


/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\gson\reflect\TypeToken.class
