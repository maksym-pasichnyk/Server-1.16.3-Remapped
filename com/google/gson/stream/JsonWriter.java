...
/* 481 */     beforeValue();
/* 482 */     this.out.write(value.booleanValue() ? "true" : "false");
/* 483 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 498 */     beforeValue();
/* 499 */     this.out.append(Double.toString(value));
/* 500 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 510 */     beforeValue();
/* 511 */     this.out.write(Long.toString(value));
/* 512 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 529 */     if (!this.lenient && (string
/* 530 */       .equals("-Infinity") || string.equals("Infinity") || string.equals("NaN"))) {
/* 531 */       throw new IllegalArgumentException("Numeric values must be finite, but was " + value);
/*     */     }
/* 533 */     beforeValue();
/* 534 */     this.out.append(string);
/* 535 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 555 */     this.out.close();
/*     */     
/* 557 */     int size = this.stackSize;
/* 558 */     if (size > 1 || (size == 1 && this.stack[size - 1] != 7)) {
...
/* 565 */     String[] replacements = this.htmlSafe ? HTML_SAFE_REPLACEMENT_CHARS : REPLACEMENT_CHARS;
/* 566 */     this.out.write("\"");
/* 567 */     int last = 0;
/* 568 */     int length = value.length();
/* 569 */     for (int i = 0; i < length; i++) {
/* 570 */       String replacement; char c = value.charAt(i);
/*     */       
/* 572 */       if (c < '') {
...
/*     */       } 
/* 584 */       if (last < i) {
/* 585 */         this.out.write(value, last, i - last);
/*     */       }
/* 587 */       this.out.write(replacement);
/* 588 */       last = i + 1; continue;
/*     */     } 
/* 590 */     if (last < length) {
/* 591 */       this.out.write(value, last, length - last);
/*     */     }
/* 593 */     this.out.write("\"");
/*     */   }
/*     */   
...
/*     */     
/* 601 */     this.out.write("\n");
/* 602 */     for (int i = 1, size = this.stackSize; i < size; i++) {
...
/* 612 */     int context = peek();
/* 613 */     if (context == 5) {
/* 614 */       this.out.write(44);
/* 615 */     } else if (context != 3) {
...
/* Location:              C:\Users\Josep\Downloads\Decompile Minecraft\deobfuscated.jar!\com\google\gson\stream\JsonWriter.class
